  ...
  (
    ...
    return (
      ...
      >
        ...
        {/* backdrop, inset by --cut; its radius must shrink by --cut too to
            stay concentric with the outer border (full --radius reads rounder
            than the edge, giving an uneven shimmer ring at the corners). */}
        <div
          className={cn(
