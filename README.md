...
[**dataslope.com**](https://dataslope.com) &nbsp;·&nbsp;
[Courses](https://dataslope.com/courses) &nbsp;·&nbsp;
[Interview Prep](https://dataslope.com/interview-prep) &nbsp;·&nbsp;
[Playgrounds](https://dataslope.com/playground) &nbsp;·&nbsp;
[Pricing](https://dataslope.com/pricing)
...
- **Playgrounds** — full editors for fourteen languages and database engines,
  one click from the nav bar.
...
**with no account**. Not a trial, not a preview, not the first three chapters — all
of it. Anonymous readers get the same statically served pages a signed-in member
does.
...
| :---: | --- | --- | --- |
| <img src="https://cdn.simpleicons.org/python/3776ab" width="18" alt=""> | **Python** | 3.14 | Pyodide (CPython → WASM), with NumPy, pandas, Plotly, Matplotlib |
...
| <img src="https://cdn.simpleicons.org/c/a8b9cc" width="18" alt=""> | **C** | C17 | Clang → WASM, in the tab |
| <img src="https://cdn.simpleicons.org/cplusplus/00599c" width="18" alt=""> | **C++** | C++20 | Clang → WASM, in the tab |
| <img src="https://cdn.simpleicons.org/openjdk/ed8b00" width="18" alt=""> | **Java** | 8 | CheerpJ (OpenJDK) |
| <img src="https://cdn.simpleicons.org/sharp/9b4f96" width="18" alt=""> | **C#** | 13 · .NET 10 | Roslyn on .NET WebAssembly |
...
- **Code editors** for the general-purpose languages — file tabs, a real
  multi-file project, autocomplete, formatting, and an output pane that
  understands text, data frames, charts, and figures.
...
**C++** — Clang compiles to WebAssembly in the tab; the binary never leaves your machine.
...
<img src="public/images/python-basics-thumbnail-cutout.webp" alt="" width="128">
<img src="public/images/data-analysis-python-pandas-thumbnail-cutout.webp" alt="" width="128">
<img src="public/images/intro-sql-postgres-thumbnail-cutout.webp" alt="" width="128">
<img src="public/images/sql-analytics-duckdb-thumbnail-cutout.webp" alt="" width="128">
<img src="public/images/interview-data-scientist-thumbnail-cutout.webp" alt="" width="128">

Courses are prose first — the explanation matters more than the widget — but the
page is live wherever being live helps.
...
in the lesson, not in a separate tab.
