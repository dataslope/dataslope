...
For what the site *is*, see [`README.md`](./README.md); for day-to-day
conventions and content-authoring rules, see [`AGENTS.md`](./AGENTS.md).
...
| what each *active* branch preview serves *now* | probed at that branch's preview alias, `https://<branch-slug>-dataslope.…workers.dev` |
| what each *active* branch preview is *about to* serve | that branch's head commit |
