...
> - New unit tests: `valueFormat.test.ts` (**11**), `exportOrder.test.ts` (**10**); editing/read-only checks verified live (10/10); SQL-dump round-trip verified live on all 3 engines. `tsc`/ESLint: 0 errors.
>
