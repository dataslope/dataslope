...
> - **[in progress]** read-only/generated column edit toast.
> - New unit tests: `valueFormat.test.ts` (**11**), `exportOrder.test.ts` (**10**); editing checks verified live (7/7); SQL-dump round-trip verified live on all 3 engines. `tsc`/ESLint: 0 errors.
>
