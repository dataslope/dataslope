...
>
> **Still open / deferred** (see §12): UX-08 multi-statement error attribution, UX-11/UX-16 index/trigger/CHECK UI + live DDL preview, UX-17 DuckDB `UPDATE` param-binding, UX-24 card-per-column structure editor, UX-Q1 SSR tab-id hydration (its own PR), enum/array inline editors, and query cancellation.
