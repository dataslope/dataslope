 ...
 *
 * Pure function (no D1, no network). The webhook route itself (signature
 * verification → D1 plan write) is exercised end-to-end against a dev server
 * with a standardwebhooks-signed payload.
 */
