// Branded not-found for custom-item links (expired guest items, deleted
// items, or mistyped /c/ URLs land here via the page's notFound()).
...
export default function CustomItemNotFound() {
  return (
    <>
          ...
          <section className="px-4 pb-20 pt-12 sm:px-6 sm:pt-16">
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-4 text-sm leading-relaxed text-[var(--ds-gray-500)] dark:text-[var(--ds-gray-400)]">
                ...
                created it, or the address may be mistyped. Challenges created
                by guests last about 30 days; members can delete theirs at any
                time.
              </p>
