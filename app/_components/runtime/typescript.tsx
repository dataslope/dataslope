...
const PACKAGES: PackageInfo[] = [
  { cat: "Compiler", icon: "🛠️", color: "#3178c6", name: "typescript", ver: "5.7", desc: "The official TypeScript compiler — used here in the browser to transpile your code to JavaScript." },
