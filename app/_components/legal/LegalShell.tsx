    ...
    <>
      ...
      >
        ...
        <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
          ...
          {/* `h3`/`pre`/`table` are for the License page. Tables keep a
              `min-w`; wrap each in an `overflow-x-auto` div at the call site
              so wide rows scroll instead of widening the page. */}
