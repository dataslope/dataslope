...
export const caption = `Real counts with a mean of ${OBS_MEAN.toFixed(1)} and a variance of ${OBS_VAR.toFixed(1)}, against the Poisson fitted to them. Past ${THRESHOLD} the fit gives ${(FIT_TAIL * 100).toFixed(2)}% of days and the data has ${(OBS_TAIL * 100).toFixed(1)}%, about ${TAIL_RATIO} times as many.`;
