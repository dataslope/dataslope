...
export const caption = `The same ${N} trials as independent draws and as ${CLUSTERS} clusters. Both have the same mean, because clustering does not change how many successes you expect; the clustered version has a standard deviation of ${SD_CLU.toFixed(1)} against ${SD_IND.toFixed(1)}.`;
