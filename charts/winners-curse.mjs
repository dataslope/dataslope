...
export const caption = `The average published effect against the study's power, where publishing filters on significance. At ${(HIGH.power * 100).toFixed(0)}% power the published estimate averages ${HIGH.ratio.toFixed(2)} times the truth; at ${(LOW.power * 100).toFixed(0)}% power it averages ${LOW.ratio.toFixed(1)} times.`;
