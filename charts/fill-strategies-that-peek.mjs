...
export const caption = `A gap of ${MISSING} days filled four ways. Forward fill needs the observation at day ${LAST.t}, which anything standing inside the gap already has; the other ${PEEKERS} need day ${NEXT.t} or later.`;
