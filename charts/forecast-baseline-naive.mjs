...
export const caption = `A seasonal-naive baseline and a trend-plus-weekday regression on the same ${HOLDOUT}-day holdout. The baseline scores ${MAIN.maeNaive.toFixed(1)} and the model ${MAIN.maeModel.toFixed(1)}, an improvement of ${MAIN.gain}%.`;
