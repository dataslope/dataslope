...
export const caption = `One 95% confidence interval beside the intervals each common misreading would actually require: a credible interval, a prediction interval ${PRED_RATIO} times wider, an interval √2 times wider for a future sample mean, and a compatibility curve with no cliff in it.`;
