...
export const caption = `The same five values on the same five spokes, in the two orderings that enclose the least and the most area. The second is about ${DIFF}% larger.`;
