...
export const caption = `Random k-fold against a chronological backtest on the same series. In the top block an average of ${FUTURE_SHARE}% of each fold's training data comes from after its own first test month.`;
