...
export const caption = `Total error against response rate under two amounts of self-selection. With strong bias the error is ${BAD.error.toFixed(1)} points at a 5% response rate, and ${BAD_BIG.error.toFixed(1)} at ten times that.`;
