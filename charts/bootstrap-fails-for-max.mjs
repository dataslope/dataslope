...
export const caption = `The bootstrap applied to a mean and to a maximum. The maximum is not a distribution at all but ${DISTINCT} spikes, and ${(AT_TOP * 100).toFixed(0)}% of resamples return the sample maximum exactly.`;
