...
export const caption = `Five doses of 1, 2, 5, 10 and 50 mg, plotted one slot each and then where their numbers actually are. Even spacing draws ${REAL_SHARE}% of the real range in ${EVEN_SHARE}% of the width.`;
