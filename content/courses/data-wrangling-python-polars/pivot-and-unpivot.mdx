...
<Figure
  ...
  alt="A tall narrow blue block standing on one platform beside a wide low green block of the same volume on a second platform, joined by a curved yellow ramp turning from one to the other"
/>
