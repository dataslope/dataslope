...
<Figure
  ...
  alt="A friendly polar bear with warm cream fur and soft grey shading lowering a thick blue block into one of three deep open bins on a wide platform, six thick blocks in blue, green and yellow sorted into the bins by color and one small block of each color resting on a raised tray beyond them"
/>
...
<Figure
  ...
  alt="A scatter of colored chips swept into three trays, each tray tipped into a small press that leaves one summary block on top of it"
...
<Figure
  ...
  alt="Chips sorted first into rows by color and then into columns by shape, each cell of the resulting grid its own small tray"
