...
<Figure
  ...
  alt="A wide platform where six thick blocks in blue, green and yellow are sorted into three deep open bins by colour, with one small block of each colour resting on a raised tray beyond the bins"
/>
