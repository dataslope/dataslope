...
<Figure
  ...
  alt="A friendly polar bear with warm cream fur and soft grey shading resting one paw on a low blue bar lying across the tops of three blue columns on a wide platform, a low green bar lying across the tops of three green columns beside them"
/>
...
<Figure
  slug="pl-window-expressions-one-line-version-inline-cutout"
  alt="A sliding frame moving along a rail of blocks, each position leaving one summary chip beside the block it covered"
  caption="`over()` computes per group and hands the answer back to every row in it."
/>
...
What a rolling window costs as it widens: more smoothing, and more lag behind
any turn in the series.

<Chart slug="rolling-window-lag" />

<Figure
  slug="pl-window-expressions-inline-cutout"
  alt="A long row of blocks with a sliding frame over three of them, a small summary tile appearing beneath the frame as it moves right"
  caption="A window slides along the rows and leaves one summary at each position."
/>
