...
<Figure
  slug="rlang-writing-your-own-functions-anatomy-function-inline-cutout"
  alt="A machine in cross-section with its input opening, inner works and output chute visible"
  caption="A function has three parts: what goes in, what happens, what comes back."
/>
...
<Figure
  ...
  caption="Write it once as a function and the repeated steps become one call."
/>
