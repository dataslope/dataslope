...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A yellow dot and a green dot ride thin gray arrows into a named blue machine card, and a single larger green dot comes out the other side — a function is a reusable machine you name once and call many times"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="164" cy="88" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="164" cy="132" r="9" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="184" y="86.5" width="50" height="3" rx="1.5" />
    <polygon points="232,82.5 243,88 232,93.5" />
    <rect x="184" y="130.5" width="50" height="3" rx="1.5" />
    <polygon points="232,126.5 243,132 232,137.5" />
    <rect x="436" y="108.5" width="54" height="3" rx="1.5" />
    <polygon points="488,104.5 499,110 488,115.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="250" y="60" width="180" height="100" rx="16" fillOpacity="0.15" />
    <rect x="274" y="84" width="132" height="18" rx="9" />
    <rect x="274" y="114" width="100" height="10" rx="5" fillOpacity="0.45" />
    <rect x="274" y="132" width="76" height="10" rx="5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="522" cy="110" r="12" />
  </g>
</svg>
