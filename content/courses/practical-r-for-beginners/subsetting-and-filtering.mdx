...
<Figure
  slug="rlang-subsetting-and-filtering-mental-model-rows-inline-cutout"
  alt="A board with one bracket clamped across its rows and another down its columns"
  caption="Rows and columns are selected separately, which is what the comma means."
/>
...
<Figure
  ...
  caption="A logical condition passes some rows and holds the rest back."
/>
