...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A translucent window marks a small block of rows and columns inside a faint table, and the lifted copy reappears as its own small table to the right — keep some rows, keep some columns, ignore the rest"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <rect x="460" y="80" width="30" height="22" rx="5" fillOpacity="0.75" />
    <rect x="496" y="80" width="30" height="22" rx="5" fillOpacity="0.75" />
    <rect x="532" y="80" width="30" height="22" rx="5" fillOpacity="0.75" />
    <rect x="460" y="108" width="30" height="22" rx="5" fillOpacity="0.75" />
    <rect x="496" y="108" width="30" height="22" rx="5" fillOpacity="0.75" />
    <rect x="532" y="108" width="30" height="22" rx="5" fillOpacity="0.75" />
  </g>
</svg>
