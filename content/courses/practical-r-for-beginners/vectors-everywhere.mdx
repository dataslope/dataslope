...
<Figure
  slug="rlang-vectors-cutout"
  alt="A single long tray of identical adjacent cells, a lone one-cell tray of the same design resting beside it"
/>
...
<Figure
  slug="rlang-vectors-everywhere-creating-vectors-c-inline-cutout"
  alt="Loose blocks gathered by a scoop into a single clamped rail"
  caption="`c()` gathers loose values into a single vector."
/>
...
<Figure
  slug="rlang-vectors-everywhere-inline-cutout"
  alt="A tray of identical blank tiles passing under one wide stamp that marks every tile in a single press, beside a second tray where a small stamp marks one tile at a time"
  caption="Everything in R is a vector, which is why whole columns move at once."
/>
