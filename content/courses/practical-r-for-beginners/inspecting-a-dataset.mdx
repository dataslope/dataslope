...
<Figure
  slug="rlang-inspecting-a-dataset-five-minute-ritual-inline-cutout"
  alt="A crate opened and five quick checks made along a bench, each leaving a small card"
  caption="The same few checks, in order, before you ask a dataset anything."
/>
...
<Figure
  slug="rlang-inspecting-a-dataset-step-1-shape-inline-cutout"
  alt="A crate measured by a caliper across and down before anything is taken out"
  caption="Shape first: how many rows and columns decides what is even feasible."
/>
...
<Figure
  slug="rlang-inspecting-a-dataset-inline-cutout"
  alt="A crate opened with its first rows lifted out, a gauge on its side reading how many rows and columns remain"
  caption="Inspecting tells you what is there before you decide what to keep."
/>
