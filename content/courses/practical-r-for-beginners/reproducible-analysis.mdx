...
<Figure
  ...
  caption="Reproducible means someone else runs your steps and gets your numbers."
/>
...
<Figure
  slug="rlang-reproducible-analysis-r-markdown-quarto-weaving-inline-cutout"
  alt="One sheet where written passages, worked steps and their outputs are set in alternating bands"
  caption="Prose, code and output in one document, so the numbers cannot drift from the words."
/>
...
<Figure
  ...
  caption="A hand-edited cell leaves no record of what was changed or why."
/>
