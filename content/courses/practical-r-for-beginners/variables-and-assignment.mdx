...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <polygon points="260,73 280,65 280,81" />
    <rect x="276" y="71" width="164" height="4" rx="2" />
    <circle cx="478" cy="73" r="15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="130" y="103" width="110" height="30" rx="15" fillOpacity="0.15" />
    <polygon points="260,118 280,110 280,126" />
    <rect x="276" y="116" width="164" height="4" rx="2" />
    <rect x="462" y="102" width="30" height="30" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="130" y="148" width="110" height="30" rx="15" fillOpacity="0.15" />
    <polygon points="260,163 280,155 280,171" />
    <rect x="276" y="161" width="164" height="4" rx="2" />
