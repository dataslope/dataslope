...
<Figure
  slug="rlang-reshaping-data-wide-vs-long-inline-cutout"
  alt="A wide short board and a narrow tall board of the same squares, a hinge between them"
  caption="Wide and long hold the same values folded two different ways."
/>
...
<Figure
  slug="rlang-reshaping-data-inline-cutout"
  alt="A wide short grid on the left being folded into a narrow tall one on the right, with an arrow showing the fold running both ways"
  caption="`pivot_longer()` folds columns into rows, and `pivot_wider()` unfolds them."
/>
