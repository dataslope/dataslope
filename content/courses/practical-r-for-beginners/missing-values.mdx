...
<Figure
  slug="rlang-missing-values-cutout"
  alt="A tray of filled cells with three cells left as empty holes, a small question-mark shaped marker resting in one"
/>
...
<Figure
  slug="rlang-missing-values-na-propagates-inline-cutout"
  alt="One covered cell entering a machine and the machine's whole output coming out covered"
  caption="One `NA` going in makes the whole result `NA`, unless you say otherwise."
/>
...
<Figure
  slug="rlang-missing-values-inline-cutout"
  alt="A board where three cells hold a small cover instead of a chip, and a switch beside it that decides whether to skip them or stop"
  caption="Fill it, drop it, or keep it: the fact that a value is missing is information."
/>
