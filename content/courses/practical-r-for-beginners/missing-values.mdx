...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A column of solid blue value chips has one dashed empty slot, and the solid gray arrow to the yellow result panel ends in another dashed empty chip, one NA in the input leaves a hole in the answer"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="25" width="140" height="160" rx="14" fillOpacity="0.1" />
    <rect x="142" y="41" width="96" height="18" rx="9" />
    <rect x="142" y="69" width="96" height="18" rx="9" />
    <rect x="142" y="125" width="96" height="18" rx="9" />
    <rect x="142" y="153" width="96" height="18" rx="9" />
  </g>
  <rect x="142" y="97" width="96" height="18" rx="9" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
  <g fill="var(--ds-gray-400)">
    <rect x="290" y="103.5" width="130" height="3" rx="1.5" />
    <polygon points="418,99.5 429,105 418,110.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="470" y="78" width="110" height="54" rx="14" fillOpacity="0.18" />
  </g>
  <rect x="486" y="96" width="78" height="18" rx="9" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
</svg>
