...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Four test tubes of identical height stand side by side, each filled to the same level with a different colored liquid — a data frame is equal-length column vectors standing side by side"
