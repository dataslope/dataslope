...
<Figure
  slug="rlang-rise-of-computing-cutout"
  alt="A room-sized mainframe cabinet with a tape reel spinning, a small punched-card tray feeding into its front slot"
/>
...
<Figure
  slug="rlang-rise-of-statistical-computing-catch-computers-spoke-inline-cutout"
  alt="A statistician's written notes on one bench and a machine on the next accepting only punched cards"
  caption="Early statistical computing meant writing FORTRAN and feeding in punched cards."
/>
...
<Figure
  slug="rlang-rise-of-stat-computing-bell-labs-cutout"
  alt="A figure at a 1970s terminal with a card punch beside them and a printout unspooling into a plotted curve"
  caption="Bell Labs, 1976: statisticians whose tools did not fit how they worked, so they wrote S."
/>
...
<Figure
  slug="rlang-rise-of-statistical-computing-was-different-about-s-inline-cutout"
  alt="Data lifted out of a special back room and set on the open bench alongside every other object"
  caption="In S the data set is an ordinary object, not something a special procedure operates on."
/>
...
<Figure
  slug="rlang-rise-of-statistical-computing-first-specialized-statistical-software-inline-cutout"
  alt="A large institutional machine installed in a university room with a queue of punched jobs waiting beside it"
  caption="SAS, 1976: statistics leaves the hand-worked table for a machine in the university basement."
/>
