...
<Figure
  slug="rlang-uncertainty-cutout"
  alt="A weighing scale on a platform showing five slightly different readings as stacked ghosted needles"
/>
...
<Figure
  slug="rlang-uncertainty-and-variability-two-kinds-variability-inline-cutout"
  alt="Two mounds side by side, one wide from the thing itself and one wide from the measuring"
  caption="Some spread is in the thing measured, and some is in the measuring."
/>
...
Pure noise, drawn several times. Every panel has a story you could tell about
it, and none of them is real:
...
<Figure
  slug="rlang-uncertainty-and-variability-signal-vs-noise-does-inline-cutout"
  alt="A heap of differences thrown up by chance with one observed difference marked against them, far out at the edge"
  caption="Compare the observed difference against the differences chance alone produces."
/>
...
How fast the spread of a sample mean shrinks: as the square root of n, so
four times the data halves the uncertainty.

<Chart slug="standard-error-vs-n" />

<Figure
  slug="rlang-uncertainty-and-variability-inline-cutout"
  alt="One measured mark on a rail with a soft band drawn either side of it rather than a single hard line"
  caption="Report the band, not the single mark, because the mark would move next time."
/>
