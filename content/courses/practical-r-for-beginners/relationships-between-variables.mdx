...
<Figure
  ...
  caption="A scatterplot puts one dot per observation and lets the pattern show."
/>
...
<Figure
  ...
  caption="Correlation compresses a whole scatter into one number, so plot it first."
/>
...
The numbers say the three species differ, but not by how much relative
to the spread within each one. A picture answers that at a glance:
