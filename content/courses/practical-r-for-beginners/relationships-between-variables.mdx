...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two light blue panels of blue dots, on the left the dots hug a faint rising diagonal band, on the right the same number of dots drift as a shapeless cloud, strong correlation beside none at all"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="30" width="220" height="170" rx="14" fillOpacity="0.08" />
    <rect x="350" y="30" width="220" height="170" rx="14" fillOpacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-blue-300)" }} fill="currentColor">
    <rect x="80" y="107" width="210" height="16" rx="8" transform="rotate(-35 185 115)" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="100" cy="170" r="3.5" />
    <circle cx="118" cy="158" r="3.5" />
    <circle cx="133" cy="149" r="3.5" />
    <circle cx="150" cy="137" r="3.5" />
    <circle cx="163" cy="131" r="3.5" />
    <circle cx="178" cy="117" r="3.5" />
    <circle cx="194" cy="105" r="3.5" />
    <circle cx="210" cy="97" r="3.5" />
    <circle cx="226" cy="83" r="3.5" />
    <circle cx="241" cy="73" r="3.5" />
    <circle cx="256" cy="62" r="3.5" />
    <circle cx="380" cy="62" r="3.5" />
    <circle cx="414" cy="148" r="3.5" />
    <circle cx="448" cy="80" r="3.5" />
    <circle cx="396" cy="118" r="3.5" />
    <circle cx="468" cy="168" r="3.5" />
    <circle cx="500" cy="56" r="3.5" />
    <circle cx="520" cy="128" r="3.5" />
    <circle cx="544" cy="90" r="3.5" />
    <circle cx="482" cy="114" r="3.5" />
    <circle cx="416" cy="76" r="3.5" />
    <circle cx="534" cy="164" r="3.5" />
  </g>
</svg>
