...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A four-row table card passes along solid gray arrows through three more stages: rows drop away, bars narrow, and the survivors settle longest-first — filter, select, and arrange transforming one data frame verb by verb"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="40" y="48" width="110" height="104" rx="12" fillOpacity="0.12" />
    <rect x="56" y="64" width="78" height="10" rx="5" />
    <rect x="56" y="86" width="78" height="10" rx="5" />
    <rect x="56" y="108" width="78" height="10" rx="5" />
    <rect x="56" y="130" width="78" height="10" rx="5" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="152" y="98.5" width="22" height="3" rx="1.5" />
    <polygon points="172,94.5 183,100 172,105.5" />
    <rect x="302" y="98.5" width="22" height="3" rx="1.5" />
    <polygon points="322,94.5 333,100 322,105.5" />
    <rect x="452" y="98.5" width="22" height="3" rx="1.5" />
    <polygon points="472,94.5 483,100 472,105.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="190" y="48" width="110" height="104" rx="12" fillOpacity="0.12" />
    <rect x="206" y="75" width="78" height="10" rx="5" />
    <rect x="206" y="115" width="78" height="10" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="340" y="48" width="110" height="104" rx="12" fillOpacity="0.16" />
    <rect x="356" y="75" width="48" height="10" rx="5" />
    <rect x="356" y="115" width="48" height="10" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="490" y="48" width="110" height="104" rx="12" fillOpacity="0.12" />
    <rect x="506" y="75" width="64" height="10" rx="5" />
    <rect x="506" y="115" width="40" height="10" rx="5" />
  </g>
</svg>
