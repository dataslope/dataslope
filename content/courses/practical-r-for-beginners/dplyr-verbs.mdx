...
<Figure
  slug="rlang-dplyr-verbs-five-core-verbs-inline-cutout"
  alt="Five hand tools hanging above a bench, each taking a different bite out of the same board"
  caption="Five verbs, chained by the pipe, read as one sentence about the data."
/>
