...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A data dot races through four relay tubes, handed across each gap above a small pipe symbol, and emerges transformed and green — a dplyr pipeline passes one data frame from verb to verb"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="78" width="90" height="44" rx="22" fillOpacity="0.16" />
    <circle cx="125" cy="100" r="9" fillOpacity="0.25" />
    <circle cx="320" cy="100" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="220" y="78" width="90" height="44" rx="22" fillOpacity="0.16" />
    <circle cx="614" cy="100" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="360" y="78" width="90" height="44" rx="22" fillOpacity="0.16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="500" y="78" width="90" height="44" rx="22" fillOpacity="0.16" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="184" cy="78" r="3" />
    <circle cx="195" cy="72" r="3" />
    <circle cx="206" cy="78" r="3" />
    <circle cx="464" cy="78" r="3" />
    <circle cx="475" cy="72" r="3" />
    <circle cx="486" cy="78" r="3" />
    <circle cx="298" cy="100" r="3" />
