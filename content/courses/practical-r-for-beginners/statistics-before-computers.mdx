---
title: "Deeper History: Statistics Before Computers"
...
You have finished the working part of the course, you can now load,
clean, transform, summarize, visualize, and reason about data in R.
These last few chapters before the wrap-up are an *optional* history:
where statistics, statistical computing, and R itself came from. They
are good stories, and they explain *why* R looks the way it does, but
nothing later depends on them. Read them when you are curious.
</Callout>
...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A worksheet fills with hand-drawn tally strokes, two blue rows already crossed off, a yellow row still growing, while a pencil rests at its corner: statistics done by human computers, one line at a time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="120" y="28" width="280" height="170" rx="10" fill="currentColor" opacity="0.06" />
  <polygon points="372,28 400,28 400,56" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="56" width="4" height="26" rx="2" />
    <rect x="162" y="56" width="4" height="26" rx="2" />
    <rect x="174" y="56" width="4" height="26" rx="2" />
    <rect x="186" y="56" width="4" height="26" rx="2" />
    <rect x="143" y="67" width="56" height="4" rx="2" transform="rotate(-24 171 69)" />
    <rect x="222" y="56" width="4" height="26" rx="2" />
    <rect x="234" y="56" width="4" height="26" rx="2" />
    <rect x="246" y="56" width="4" height="26" rx="2" />
    <rect x="150" y="106" width="4" height="26" rx="2" />
    <rect x="162" y="106" width="4" height="26" rx="2" />
    <rect x="174" y="106" width="4" height="26" rx="2" />
    <rect x="186" y="106" width="4" height="26" rx="2" />
    <rect x="143" y="117" width="56" height="4" rx="2" transform="rotate(-24 171 119)" />
    <rect x="222" y="106" width="4" height="26" rx="2" />
    <rect x="234" y="106" width="4" height="26" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="150" y="156" width="4" height="26" rx="2" />
    <rect x="162" y="156" width="4" height="26" rx="2" />
    <rect x="174" y="156" width="4" height="26" rx="2" />
  </g>
  <g transform="rotate(-28 500 150)">
    <rect x="452" y="142" width="18" height="16" rx="4" fill="var(--ds-blue-500)" />
    <rect x="470" y="142" width="90" height="16" rx="3" fill="var(--ds-yellow-500)" />
    <polygon points="560,142 584,150 560,158" fill="var(--ds-gray-400)" />
  </g>
</svg>
