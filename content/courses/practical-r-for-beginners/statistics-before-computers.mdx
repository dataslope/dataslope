...
<Figure
  slug="rlang-stats-before-computers-cutout"
  alt="A long shared desk with three hand-crank calculating machines and neat columns of paper sheets stacked between them"
/>
...
<Figure
  slug="rlang-statistics-before-computers-craft-built-around-inline-cutout"
  alt="A desk holding a mechanical adding machine and one guarded column of solid filled cells"
  caption="Statistics was shaped by a time when every sum cost real effort."
/>
...
<Figure
  slug="rlang-statistics-before-computers-tables-slides-human-computers-inline-cutout"
  alt="A hall of desks each working one part of a long calculation by hand, their sheets stacked into printed tables"
  caption="Before the machines, a computer was a person, and a distribution was a printed book."
/>
...
<Figure
  slug="rlang-statistics-before-computers-inline-cutout"
  alt="A desk of ruled paper, a mechanical adding machine and a long column of hand-entered figures"
  caption="Methods were designed for small samples because that is all anyone could compute."
/>
