...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A worksheet of faint hand-computed rows with the current line marked in yellow, beside a large mechanical calculating wheel with a crank handle — statistics done by human computers, one line at a time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="150" y="30" width="210" height="160" rx="8" fill="currentColor" opacity="0.07" />
  <polygon points="332,30 360,30 360,58" fill="currentColor" opacity="0.14" />
  <rect x="170" y="54" width="150" height="6" rx="3" fill="currentColor" opacity="0.28" />
  <rect x="170" y="74" width="120" height="6" rx="3" fill="currentColor" opacity="0.24" />
  <rect x="170" y="94" width="160" height="6" rx="3" fill="currentColor" opacity="0.28" />
  <rect x="170" y="134" width="140" height="6" rx="3" fill="currentColor" opacity="0.12" />
  <rect x="170" y="154" width="155" height="6" rx="3" fill="currentColor" opacity="0.1" />
  <rect x="170" y="174" width="110" height="6" rx="3" fill="currentColor" opacity="0.08" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="170" y="112" width="95" height="8" rx="4" />
    <circle cx="276" cy="116" r="4" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="475" cy="120" r="46" fillOpacity="0.15" />
    <circle cx="475" cy="120" r="32" fillOpacity="0.15" />
    <circle cx="475" cy="120" r="9" />
    <rect x="471" y="58" width="8" height="56" rx="4" transform="rotate(38 475 120)" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="513" cy="71" r="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="475" cy="82" r="3" />
    <circle cx="513" cy="120" r="3" />
    <circle cx="475" cy="158" r="3" />
    <circle cx="437" cy="120" r="3" />
  </g>
</svg>
