...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One small blue square ringed in yellow stands beside bars that swell rapidly taller toward the right — data growing from a single precious observation into a flood"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="172" width="18" height="18" rx="5" />
  </g>
  <circle cx="109" cy="181" r="22" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="190" y="154" width="56" height="36" rx="8" fillOpacity="0.45" />
    <rect x="280" y="114" width="56" height="76" rx="8" fillOpacity="0.65" />
    <rect x="370" y="70" width="56" height="120" rx="8" fillOpacity="0.85" />
    <rect x="460" y="26" width="56" height="164" rx="8" />
  </g>
</svg>
