...
<Figure
  ...
  caption="Once the data is tidy, every tool in the tidyverse fits it without argument."
/>
...
One row per observation, one column per variable. The same numbers can
also be arranged the other way, with years spread across columns:
...
<Figure
  ...
  caption="Tidy data means one row per observation and one column per variable."
/>
