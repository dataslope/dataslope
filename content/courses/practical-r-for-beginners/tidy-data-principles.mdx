...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Circles, squares, and triangles each settle into their own labeled column while one stray triangle waits below for the single empty slot, every variable a column, every observation a row"
