...
length, an angle, an area, and a colour:
...
<Figure
  ...
  caption="A chart encodes numbers as position, size or colour, and position wins."
/>
...
One in twelve men has a red-green colour deficiency. The same chart in a
default palette and a colourblind-safe one, each as they see it:
