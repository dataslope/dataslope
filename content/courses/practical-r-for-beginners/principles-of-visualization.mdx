...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two chart cards hold the same four bars: on the left they sit buried under gridlines and a heavy frame; past a solid gray arrow the right card keeps only clean green bars — declutter until the story is all that remains"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="30" width="220" height="160" rx="14" fill="currentColor" opacity="0.05" />
  <g stroke="var(--ds-gray-300)" strokeWidth="1.5">
    <line x1="86" y1="60" x2="274" y2="60" />
    <line x1="86" y1="90" x2="274" y2="90" />
    <line x1="86" y1="120" x2="274" y2="120" />
    <line x1="86" y1="150" x2="274" y2="150" />
    <line x1="133" y1="46" x2="133" y2="174" />
    <line x1="180" y1="46" x2="180" y2="174" />
    <line x1="227" y1="46" x2="227" y2="174" />
  </g>
  <rect x="86" y="46" width="188" height="128" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="122" width="28" height="52" fillOpacity="0.75" />
    <rect x="147" y="86" width="28" height="88" fillOpacity="0.75" />
    <rect x="194" y="62" width="28" height="112" fillOpacity="0.75" />
    <rect x="241" y="106" width="28" height="68" fillOpacity="0.75" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="298" y="108.5" width="32" height="3" rx="1.5" />
    <polygon points="328,104.5 339,110 328,115.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="350" y="30" width="220" height="160" rx="14" fillOpacity="0.08" />
    <rect x="380" y="122" width="28" height="52" rx="5" />
    <rect x="427" y="86" width="28" height="88" rx="5" />
    <rect x="474" y="62" width="28" height="112" rx="5" />
    <rect x="521" y="106" width="28" height="68" rx="5" />
  </g>
</svg>
