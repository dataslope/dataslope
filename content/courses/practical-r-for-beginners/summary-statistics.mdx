...
<Figure
  slug="rlang-summary-stats-cutout"
  alt="A column of tiles funnelling down into three small dials showing centre, spread and range"
/>
...
2. **How spread out are the values?** (dispersion: standard deviation,
...
Where the mean, median and mode land depends on the shape. On a symmetric
distribution they coincide; on a skewed one they separate, and the mean moves
furthest:
...
<Figure
  slug="rlang-summary-statistics-measures-center-inline-cutout"
  alt="A plank on a fulcrum with blocks along it and a marker standing at the middle block"
  caption="The mean balances the plank; the median just marks the middle value."
/>
...
Three samples with the same center and nothing else in common, which is the
reason a center alone is never a summary:
...
In one table, you can see that *Gentoo* penguins are much heavier
than the others, while *Adelie* and *Chinstrap* sit closer together
and lighter.
...
<Figure
  slug="rlang-summary-statistics-inline-cutout"
  alt="One tray of chips feeding a small gauge that reads a single number, with the emptied tray beside it"
  caption="A summary is a lossy compression, and different data can compress alike."
/>
