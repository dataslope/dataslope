...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A translucent green hump rises over a rug of small green dots that trail off to the right, a long-tailed distribution's center and spread at a glance"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.6">
    ...
    <circle cx="177" cy="162" r="3" />
    <circle cx="189" cy="162" r="3" />
    <circle cx="200" cy="162" r="3" />
    <circle cx="211" cy="162" r="3" />
    <circle cx="222" cy="162" r="3" />
    <circle cx="233" cy="162" r="3" />
    <circle cx="245" cy="162" r="3" />
    <circle cx="258" cy="162" r="3" />
    <circle cx="272" cy="162" r="3" />
    <circle cx="290" cy="162" r="3" />
    <circle cx="312" cy="162" r="3" />
    <circle cx="340" cy="162" r="3" />
    <circle cx="378" cy="162" r="3" />
    <circle cx="425" cy="162" r="3" />
    <circle cx="478" cy="162" r="3" />
    <circle cx="183" cy="150" r="3" />
    <circle cx="205" cy="150" r="3" />
    <circle cx="227" cy="150" r="3" />
