...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An abacus with three rods of colored beads, some slid left and some right mid-calculation — before R is the language of data science it is a very good calculator"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="140" y="28" width="360" height="10" rx="5" fill="currentColor" opacity="0.2" />
  <rect x="140" y="174" width="360" height="10" rx="5" fill="currentColor" opacity="0.2" />
  <rect x="140" y="28" width="12" height="156" rx="6" fill="currentColor" opacity="0.2" />
  <rect x="488" y="28" width="12" height="156" rx="6" fill="currentColor" opacity="0.2" />
  <rect x="152" y="66" width="336" height="6" rx="3" fill="currentColor" opacity="0.15" />
  <rect x="152" y="103" width="336" height="6" rx="3" fill="currentColor" opacity="0.15" />
  <rect x="152" y="140" width="336" height="6" rx="3" fill="currentColor" opacity="0.15" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="69" r="11" />
    <circle cx="206" cy="69" r="11" />
    <circle cx="232" cy="69" r="11" />
    <circle cx="258" cy="69" r="11" />
    <circle cx="450" cy="69" r="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="180" cy="106" r="11" />
    <circle cx="206" cy="106" r="11" />
    <circle cx="398" cy="106" r="11" />
    <circle cx="424" cy="106" r="11" />
    <circle cx="450" cy="106" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="180" cy="143" r="11" />
    <circle cx="206" cy="143" r="11" />
    <circle cx="232" cy="143" r="11" />
    <circle cx="424" cy="143" r="11" />
    <circle cx="450" cy="143" r="11" />
  </g>
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.r",
      starterCode: `# Each line produces an answer
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.r",
      starterCode: `# These two expressions are NOT the same
print(2 + 3 * 4) # 2 + 12 = 14
print((2 + 3) * 4) # 5 * 4  = 20
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.r",
      starterCode: `x <- 42 # double (the default in R!)
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.r",
      starterCode: `# The "is it basically equal?" check
...
- \`(0.1 + 0.2) ~ 0.3\`
  > \`~\` builds a model formula; it does not test approximate equality.
...
- 100
  > This treats the expression left to right (\`((2 + 3) * 4)... \`) instead of honoring precedence.`}
/>
