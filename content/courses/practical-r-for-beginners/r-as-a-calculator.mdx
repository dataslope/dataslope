...
<Figure
  slug="rlang-calculator-cutout"
  alt="A chunky isometric desk calculator on a platform with a short paper tape curling out of its top"
/>
...
<Figure
  slug="rlang-r-as-a-calculator-basic-arithmetic-operators-inline-cutout"
  alt="A small machine on a bench with four differently shaped input slots"
  caption="Comparison operators ask questions and answer `TRUE` or `FALSE`."
/>
...
<Figure
  slug="rlang-r-as-a-calculator-inline-cutout"
  alt="A small machine on a bench taking a short slip and returning a single result on a printed strip"
  caption="Type an expression, press run, and R prints the value back."
/>
