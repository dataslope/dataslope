...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three small panels show the same skewed column three ways — histogram bars, a smooth density hump, and a horizontal boxplot — one distribution, three lenses"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="102" y="127" width="18" height="32" rx="4" fillOpacity="0.8" />
    <rect x="124" y="91" width="18" height="68" rx="4" fillOpacity="0.8" />
    <rect x="146" y="71" width="18" height="88" rx="4" fillOpacity="0.8" />
    <rect x="168" y="103" width="18" height="56" rx="4" fillOpacity="0.8" />
    <rect x="190" y="135" width="18" height="24" rx="4" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M268,159 C292,69 320,71 342,124 C354,149 362,156 372,159 Z" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="441" y="113" width="88" height="4" rx="2" fillOpacity="0.5" />
    <rect x="441" y="105" width="4" height="20" rx="2" fillOpacity="0.7" />
    <rect x="525" y="105" width="4" height="20" rx="2" fillOpacity="0.7" />
    <rect x="463" y="100" width="37" height="30" rx="7" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="477" y="100" width="4" height="30" fillOpacity="0.9" />
  </g>
</svg>
