...
<Figure
  slug="rlang-exploring-distributions-histograms-inline-cutout"
  alt="Chips poured into a row of adjacent bins, the bins filling to different heights"
  caption="A histogram pours the values into bins and lets the shape appear."
/>
...
<Figure
  slug="rlang-exploring-distributions-density-plots-inline-cutout"
  alt="A row of solid inked bins with a single smooth arched cap of contrasting ink laid over their tops, the bins fully inked beneath it"
  caption="A density curve is the histogram with the bin edges smoothed away."
/>
...
<Figure
  ...
  caption="A boxplot is the five-number summary drawn as a box and two whiskers."
/>
...
- **Dots** beyond the whiskers are conventional outliers (more
  than 1.5 times the interquartile range past Q1 or Q3).
...
A histogram shows one distribution. When you want to compare several,
stacking histograms gets unreadable fast, and a boxplot per group is the
usual answer:
