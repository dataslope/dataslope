...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A signpost with three colored blades points toward different onward paths while a dotted trail arrives at a green you-are-here dot at its base — the course ends where several roads begin"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="314" y="64" width="12" height="146" rx="6" fill="currentColor" opacity="0.25" />
  <rect x="288" y="206" width="64" height="8" rx="4" fill="currentColor" opacity="0.15" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="326" y="64" width="150" height="26" rx="8" fillOpacity="0.85" />
    <polygon points="474,64 496,77 474,90" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="164" y="102" width="150" height="26" rx="8" fillOpacity="0.85" />
    <polygon points="166,102 144,115 166,128" fillOpacity="0.85" />
    <circle cx="296" cy="206" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="326" y="140" width="130" height="26" rx="8" fillOpacity="0.85" />
    <polygon points="454,140 476,153 454,166" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="352" cy="83" r="3.5" fillOpacity="0.9" />
    <circle cx="376" cy="77" r="3.5" fillOpacity="0.9" />
    <circle cx="400" cy="71" r="3.5" fillOpacity="0.9" />
    <rect x="208" y="109" width="12" height="12" rx="3" fillOpacity="0.9" />
    <circle cx="364" cy="153" r="4" fillOpacity="0.9" />
    <circle cx="382" cy="153" r="4" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="160" cy="222" r="3" />
    <circle cx="196" cy="218" r="3" />
    <circle cx="232" cy="214" r="3" />
    <circle cx="268" cy="210" r="3" />
  </g>
</svg>
