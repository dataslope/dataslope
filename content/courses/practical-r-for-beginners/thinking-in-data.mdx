...
<Figure
  slug="rlang-thinking-in-data-cutout"
  alt="The Dataslope marmot mascot turning a crank that applies one operation to an entire row of tiles at once"
/>
...
<Figure
  slug="rlang-thinking-in-data-different-way-thinking-inline-cutout"
  alt="A hand moving one chip at a time beside a whole tray lifted in one motion"
  caption="Working one number at a time does not survive contact with real data."
/>
...
<Figure
  slug="rlang-thinking-in-data-inline-cutout"
  alt="A hand moving one chip at a time beside a tray being lifted and treated as one thing"
  caption="The shift is treating a whole column as one thing you act on at once."
/>
