...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Five loose blue squares scattered at odd angles pass along a solid gray arrow and line up as one tidy stacked column inside a rounded card, thinking in whole collections instead of single values"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="60" width="14" height="14" rx="4" transform="rotate(12 87 67)" />
    <rect x="146" y="98" width="14" height="14" rx="4" transform="rotate(-18 153 105)" />
    <rect x="98" y="148" width="14" height="14" rx="4" transform="rotate(25 105 155)" />
    <rect x="186" y="52" width="14" height="14" rx="4" transform="rotate(-10 193 59)" />
    <rect x="204" y="142" width="14" height="14" rx="4" transform="rotate(15 211 149)" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="260" y="103.5" width="100" height="3" rx="1.5" />
    <polygon points="358,99.5 369,105 358,110.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="420" y="30" width="76" height="154" rx="16" fillOpacity="0.1" />
    <rect x="451" y="46" width="14" height="14" rx="4" />
    <rect x="451" y="74" width="14" height="14" rx="4" />
    <rect x="451" y="102" width="14" height="14" rx="4" />
    <rect x="451" y="130" width="14" height="14" rx="4" />
    <rect x="451" y="158" width="14" height="14" rx="4" />
  </g>
</svg>
