...
<Figure
  slug="rlang-scripts-projects-cutout"
  alt="An open folder platform holding three tidy labelled sub-trays for code, data and outputs, connected by short arrows"
/>
...
<Figure
  slug="rlang-scripts-and-projects-inline-cutout"
  alt="Loose slips scattered on one bench, and on the next the same slips filed in order inside a labelled case"
  caption="The script is the source of truth; the console is a scratchpad."
/>
...
<Figure
  slug="rlang-scripts-and-projects-minimal-project-layout-inline-cutout"
  alt="A labelled case holding three separate folders, each with its own kind of card"
  caption="Data, scripts and outputs in their own folders keeps a project findable."
/>
