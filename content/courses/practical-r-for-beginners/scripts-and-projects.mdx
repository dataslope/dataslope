...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One folder holds three tidy cards, a blue script of code lines, a yellow card of data cells, and a green card of result bars, an analysis organized as a project anyone can re-run"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="40" width="140" height="32" rx="10" fillOpacity="0.08" />
    <rect x="90" y="60" width="460" height="140" rx="14" fillOpacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="88" width="120" height="86" rx="10" fillOpacity="0.15" />
    <rect x="134" y="104" width="72" height="8" rx="4" />
    <rect x="134" y="122" width="90" height="8" rx="4" />
    <rect x="134" y="140" width="56" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="260" y="88" width="120" height="86" rx="10" fillOpacity="0.16" />
    <rect x="284" y="106" width="14" height="14" rx="3" />
    <rect x="306" y="106" width="14" height="14" rx="3" />
    <rect x="328" y="106" width="14" height="14" rx="3" />
    <rect x="284" y="128" width="14" height="14" rx="3" />
    <rect x="306" y="128" width="14" height="14" rx="3" />
    <rect x="328" y="128" width="14" height="14" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="400" y="88" width="120" height="86" rx="10" fillOpacity="0.12" />
    <rect x="418" y="146" width="14" height="16" rx="3" />
    <rect x="440" y="132" width="14" height="30" rx="3" />
    <rect x="462" y="118" width="14" height="44" rx="3" />
    <rect x="484" y="104" width="14" height="58" rx="3" />
  </g>
</svg>
