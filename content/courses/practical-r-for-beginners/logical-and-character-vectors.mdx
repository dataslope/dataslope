...
<Figure
  slug="rlang-logical-character-cutout"
  alt="One tray of two-state toggle switches beside a second tray of blank name plates on a shared platform"
/>
...
<Figure
  slug="rlang-logical-and-character-vectors-logical-vectors-inline-cutout"
  alt="A rail of two-position switches, some up and some down"
  caption="A logical vector is one switch per element, and it can index another vector."
/>
...
<Figure
  slug="rlang-logical-and-character-vectors-inline-cutout"
  alt="One rail of two-position switches and another rail of letter ribbons, standing side by side"
  caption="Logicals and character vectors are two more vector types, handled the same way."
/>
