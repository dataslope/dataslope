...
<Figure
  slug="rlang-from-s-to-r-cutout"
  alt="Two connected workbenches on stepped platforms, a small teaching bench feeding a larger open one built from the same parts"
/>
...
<Figure
  slug="rlang-from-s-to-r-auckland-cutout"
  alt="Two figures sharing one desk under a window, a seedling between them, and a plotted curve on a screen"
  caption="University of Auckland, 1991: two statistics colleagues wanted a language for teaching, and started one."
/>
...
<Figure
  slug="rlang-from-s-to-r-cran-cutout"
  alt="A wide shelving rack packed with identical crates, a figure on a ladder sliding one more into place"
  caption="CRAN, 1997: one shared shelf for R packages, and most of the reason R spread beyond its authors."
/>
...
<Figure
  slug="rlang-from-s-to-r-r-was-always-inline-cutout"
  alt="Two machines side by side built to the same plan, one older and worn, one new"
  caption="R was built to the same plan as S, so decades of S knowledge carried over."
/>
...
<Figure
  slug="rlang-from-s-to-r-r-inherited-from-inline-cutout"
  alt="An older machine's parts being lifted into a new frame, with two extra fittings added"
  caption="R kept S's semantics and added the things S lacked, starting with being free."
/>
