...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A console window with a green prompt chevron and a blue typed line, and a thin gray arrow dropping to the green line printed below — type a line, run it, see the result"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="120" y="30" width="400" height="160" rx="14" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="146" cy="54" r="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="166" cy="54" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="186" cy="54" r="5" />
  </g>
  <polyline points="146,86 158,96 146,106" fill="none" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="172" y="91" width="150" height="10" rx="5" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="198.5" y="112" width="3" height="22" rx="1.5" />
    <polygon points="194.5,132 205.5,132 200,143" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="172" y="152" width="110" height="10" rx="5" />
  </g>
</svg>
