...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Inside a console window, a typed line after the prompt travels a dotted route through three small processing stations and comes back as a green line of output — what one click of Run really does"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="120" y="28" width="400" height="170" rx="14" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="146" cy="52" r="5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="166" cy="52" r="5" fillOpacity="0.8" />
    <circle cx="424" cy="112" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="186" cy="52" r="5" fillOpacity="0.8" />
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="344" cy="93" r="3" />
    <circle cx="368" cy="97" r="3" />
    <circle cx="394" cy="103" r="3" />
    <circle cx="444" cy="122" r="3" />
    <circle cx="446" cy="158" r="3" />
    <circle cx="398" cy="174" r="3" />
    <circle cx="372" cy="176" r="3" />
    <circle cx="346" cy="176" r="3" />
  </g>
</svg>
