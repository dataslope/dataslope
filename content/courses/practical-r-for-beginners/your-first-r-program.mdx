...
<Figure
  slug="rlang-your-first-r-program-prompt-inline-cutout"
  alt="A small panel with one waiting slot and a blinking marker beside it"
  caption="The prompt waits, runs exactly what you type, and reports what happened."
/>
...
<Figure
  slug="rlang-your-first-r-program-inline-cutout"
  alt="A short strip of instructions clipped to a board and a small printed result pinned beneath it"
  caption="A program is instructions written down, with the result printed beneath."
/>
