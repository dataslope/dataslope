...
<Figure
  slug="rlang-ggplot-grammar-cutout"
  alt="Five translucent chart plates stacked in order on a platform, each adding one more element to the figure below"
/>
...
<Figure
  slug="rlang-ggplot-grammar-first-ggplot-inline-cutout"
  alt="A plain board with one layer of bright chips laid across it and two more layers stacked ready beside it"
  caption="A ggplot is layers stacked on one set of data and one mapping."
/>
...
<Figure
  slug="rlang-ggplot-grammar-inline-cutout"
  alt="A set of interchangeable parts on a rack, data, marks, scales and frame, assembled into one plot"
  caption="Data, marks, scales and frame are separate parts you assemble into a plot."
/>
...
<Figure
  slug="rlang-ggplot-grammar-mapping-vs-setting-inline-cutout"
  alt="One dial wired to a data column beside another dial turned by hand with no cord"
  caption="Mapping wires a dial to a column; setting turns the dial by hand."
/>
...
The reason it works: the same lines, tangled and then split.
