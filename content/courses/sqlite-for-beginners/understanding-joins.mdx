...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue row card and a green row card sit apart, each holding a yellow key dot on its facing edge; below a solid arrow they have clicked into one long card sharing a single yellow key at the seam, a join snaps two rows together where their key values meet"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="36" width="180" height="52" rx="10" fillOpacity="0.15" />
    <rect x="110" y="54" width="90" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="370" y="36" width="180" height="52" rx="10" fillOpacity="0.15" />
    <rect x="440" y="54" width="90" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="262" cy="62" r="9" />
    <circle cx="378" cy="62" r="9" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="318.5" y="100" width="3" height="22" rx="1.5" />
    <polygon points="314.5,120 325.5,120 320,131" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="152" width="180" height="52" rx="10" fillOpacity="0.15" />
    <rect x="160" y="170" width="90" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="320" y="152" width="180" height="52" rx="10" fillOpacity="0.15" />
    <rect x="390" y="170" width="90" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="178" r="9" />
  </g>
</svg>
