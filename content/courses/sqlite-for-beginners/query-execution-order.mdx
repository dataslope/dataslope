...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="Five blue stations ride one line in fixed order, each marked with one to five white pips and an arrowhead at the end, a query runs as an ordered assembly line, not in the order it is written"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="70" y1="80" x2="576" y2="80" stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round" />
  <polygon points="574,74.5 574,85.5 585,80" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="83" y="63" width="34" height="34" rx="9" />
    <rect x="193" y="63" width="34" height="34" rx="9" />
    <rect x="303" y="63" width="34" height="34" rx="9" />
    <rect x="413" y="63" width="34" height="34" rx="9" />
    <rect x="523" y="63" width="34" height="34" rx="9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="100" cy="80" r="3" />
    <circle cx="204" cy="86" r="3" />
    <circle cx="216" cy="74" r="3" />
    <circle cx="312" cy="88" r="3" />
    <circle cx="320" cy="80" r="3" />
    <circle cx="328" cy="72" r="3" />
    <circle cx="423" cy="73" r="3" />
    <circle cx="437" cy="73" r="3" />
    <circle cx="423" cy="87" r="3" />
    <circle cx="437" cy="87" r="3" />
    <circle cx="533" cy="73" r="3" />
    <circle cx="547" cy="73" r="3" />
    <circle cx="540" cy="80" r="3" />
    <circle cx="533" cy="87" r="3" />
    <circle cx="547" cy="87" r="3" />
  </g>
</svg>
