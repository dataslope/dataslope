...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A yellow compass star beside a blue magnifying glass whose lens holds four crisp green value dots — exploring an unfamiliar database"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M 225 106 L 233 126 L 225 146 L 217 126 Z" />
    <path d="M 205 126 L 225 119 L 245 126 L 225 133 Z" fillOpacity="0.6" />
    <circle cx="225" cy="126" r="4" style={{ color: "var(--ds-white)" }} />
  </g>
</svg>
