...
>
  ...
  <g fill="var(--ds-gray-500)">
    <rect x="284" y="110" width="56" height="4" rx="2" />
    <polygon points="338,103 338,121 358,112" />
  </g>
...
<svg
  viewBox="0 0 640 150"
  role="img"
  aria-label="A row of light blue bars of different heights on a thin baseline, with the shortest bar solid green and the tallest solid red — MIN and MAX walk the whole column and point at its two extremes"
  style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="96" y="66" width="34" height="52" rx="5" fillOpacity="0.45" />
    <rect x="248" y="44" width="34" height="74" rx="5" fillOpacity="0.45" />
    <rect x="324" y="78" width="34" height="40" rx="5" fillOpacity="0.45" />
    <rect x="476" y="88" width="34" height="30" rx="5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="172" y="98" width="34" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="400" y="22" width="34" height="96" rx="5" />
  </g>
  <rect x="70" y="118" width="500" height="3" rx="1.5" fill="var(--ds-gray-400)" />
</svg>
