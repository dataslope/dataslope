...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three joined rows inside one result card: two complete blue-and-green pairs, and a third where the blue dot sits beside a dashed empty circle — LEFT JOIN keeps every left row and fills the missing side with NULL"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="170" y="32" width="300" height="140" rx="14" fillOpacity="0.15" />
  </g>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="282" y1="64" x2="318" y2="64" />
    <line x1="282" y1="102" x2="318" y2="102" />
    <line x1="282" y1="140" x2="318" y2="140" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="270" cy="64" r="11" />
    <circle cx="270" cy="102" r="11" />
    <circle cx="270" cy="140" r="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="330" cy="64" r="11" />
    <circle cx="330" cy="102" r="11" />
  </g>
  <circle cx="330" cy="140" r="11" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2.5" strokeDasharray="4 5" />
</svg>
