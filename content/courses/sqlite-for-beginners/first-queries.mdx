...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="A yellow query capsule flows along a solid arrow into a round blue SQLite engine and out the other side as a small green one-cell result card, your first query is a short conversation with the database"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="56" y="64" width="130" height="34" rx="17" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="200" y="79.5" width="34" height="3" rx="1.5" />
    <polygon points="232,75.5 243,81 232,86.5" />
    <rect x="352" y="79.5" width="34" height="3" rx="1.5" />
    <polygon points="384,75.5 395,81 384,86.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="300" cy="81" r="36" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="300" cy="81" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="416" y="52" width="170" height="58" rx="12" fillOpacity="0.15" />
    <rect x="438" y="72" width="60" height="18" rx="6" />
  </g>
</svg>
