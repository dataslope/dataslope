...
<Figure
  slug="lite-first-queries-cutout"
  alt="The Dataslope marmot mascot beside a small console panel returning a single value tile, a tiny two-row table resting nearby"
/>
...
<Figure
  slug="lite-first-queries-inline-cutout"
  alt="A slip pushed into a slot on a small box, and a short tray of rows sliding out beneath it"
  caption="You send a statement in and a result table comes back out."
/>
...
<Figure
  slug="lite-first-queries-sql-can-give-inline-cutout"
  alt="A slip pushed into a machine with no board loaded and a single small block returning"
  caption="A query needs no table at all if all you want is a calculation."
/>
...
INSERT INTO snacks (name, kind, calories) VALUES
  ('Apple', 'fruit', 95), ('Pretzels', 'snack', 110), ('Yogurt', 'dairy', 150),
  ('Banana', 'fruit', 105), ('Almonds', 'nuts', 170), ('Cheese stick', 'dairy', 80),
  ('Popcorn', 'snack', 120), ('Orange', 'fruit', 62), ('Walnuts', 'nuts', 185),
  ('Granola bar', 'snack', 190), ('Milk', 'dairy', 103), ('Grapes', 'fruit', 62),
  ('Rice cakes', 'snack', 70), ('Cashews', 'nuts', 157), ('Cottage cheese', 'dairy', 98),
  ('Pear', 'fruit', 101), ('Trail mix', 'snack', 230), ('Peanuts', 'nuts', 166),
  ('Kefir', 'dairy', 110), ('Blueberries', 'fruit', 84), ('Crackers', 'snack', 130),
  ('Pistachios', 'nuts', 159), ('Greek yogurt', 'dairy', 130), ('Mango', 'fruit', 99);`}
  starterCode={`SELECT
  name,
  calories
FROM
