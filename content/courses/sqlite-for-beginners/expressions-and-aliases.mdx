...
<Figure
  ...
  caption="An expression makes a new column out of the columns already in the row."
/>
...
INSERT INTO sales (item, category, price, quantity) VALUES
  ...
  ('Ruler', 'School', 1.80, 10),
  ('Glue stick', 'School', 2.95, 5),
  ('Mixing bowl', 'Kitchen', 14.50, 1),
  ('Oven mitt', 'Kitchen', 6.40, 2),
  ('Desk lamp', 'Office', 22.00, 1),
  ('Stapler', 'Office', 9.25, 3),
  ('Paper ream', 'Office', 4.60, 8),
  ('Whiteboard pen', 'Office', 1.95, 12),
  ('Backpack', 'School', 34.00, 1),
  ('Lunch box', 'School', 11.20, 3),
  ('Chopping board', 'Kitchen', 17.75, 2),
  ('Kettle', 'Kitchen', 29.99, 1),
  ('Sticky notes', 'Office', 3.15, 7),
  ('Binder', 'Office', 5.50, 4),
  ('Water bottle', 'School', 12.60, 2),
  ('Eraser', 'School', 0.85, 15),
  ('Tea pot', 'Kitchen', 19.40, 1),
  ('Dish towel', 'Kitchen', 4.25, 6),
  ('Desk mat', 'Office', 15.80, 2),
  ('Pen refill', 'Office', 2.40, 9);`}
  starterCode={`SELECT
  item,
  price,
  quantity,
...
<Figure
  ...
  caption="The usual arithmetic works inside a query, one row at a time."
/>
...
<Figure
  ...
  caption="`AS` clips a readable name onto a column the query just computed."
/>
...
`SUBSTR` goes the other way from `||`: instead of gluing text
together, it cuts a piece out. The arguments are the starting position
(counting from 1, not 0) and how many characters to take:
