...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="A mixed row of blue, green, and yellow dots fans along thin lines into three tinted cards sorted by color, and each card condenses into one solid bar sized to its contents, GROUP BY sorts rows into piles first, then summarizes each pile"
