...
<Figure
  slug="lite-why-sqlite-makes-sqlite-ideal-learning-inline-cutout"
  alt="A single file lifted straight onto the bench and worked on, with no scaffolding raised around it first"
  caption="No server, no configuration, so the attention goes to tables and queries instead."
/>
...
<Figure
  slug="lite-why-sqlite-honest-tradeoff-inline-cutout"
  alt="One small sealed box that fits in a pocket, set beside a large machine with many hands working on it at once"
  caption="One file and no server is the strength and the limit in the same sentence."
/>
