...
<Figure
  slug="lite-primary-keys-identity-problem-inline-cutout"
  alt="A rack of near-identical cards, one gaining a punched tab no other card has"
  caption="A primary key is the one value that names this row and no other."
/>
...
INSERT INTO customers (name, city) VALUES
  ('Ada', 'London'), ('Grace', 'Arlington'), ('Lin', 'Taipei'),
  ('Omar', 'Cairo'), ('Priya', 'Mumbai'), ('Rosa', 'Madrid'),
  ('Sam', 'Toronto'), ('Tariq', 'Amman'), ('Uma', 'Delhi'),
  ('Viktor', 'Prague'), ('Wen', 'Taipei'), ('Xenia', 'Athens'),
  ('Yusuf', 'Istanbul'), ('Zara', 'Lagos'), ('Bruno', 'Sao Paulo'),
  ('Chidi', 'Lagos'), ('Dara', 'Dublin'), ('Elif', 'Izmir'),
  ('Farid', 'Rabat'), ('Ivan', 'Sofia'), ('Nadia', 'Tunis'),
  ('Quinn', 'London'), ('Ruth', 'Cape Town'), ('Theo', 'Athens');`}
  starterCode={`SELECT
  id,
  name,
  city
...
<Figure
  slug="lite-primary-keys-inline-cutout"
  alt="A ribbon of identical blank cards feeding through a small press that punches one more round hole into each card than into the card before it, and a single card being drawn straight out of the middle of the run"
  caption="Because the key is unique, another table can point at exactly one row."
/>
