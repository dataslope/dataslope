...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="An app window with a blue save button sends a solid arrow straight down into a small yellow file holding green rows, the database file is the room under the app where facts keep living after the screen closes"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="170" y="20" width="300" height="130" rx="12" fillOpacity="0.1" />
    <rect x="170" y="20" width="300" height="26" rx="12" fillOpacity="0.25" />
    <rect x="170" y="34" width="300" height="12" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="188" cy="33" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="204" cy="33" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="220" cy="33" r="4.5" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="190" y="62" width="150" height="8" rx="4" />
    <rect x="190" y="78" width="110" height="8" rx="4" />
    <rect x="190" y="94" width="170" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="190" y="114" width="80" height="22" rx="11" />
    <circle cx="230" cy="125" r="5" style={{ color: "var(--ds-white)" }} />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="318.5" y="158" width="3" height="26" rx="1.5" />
    <polygon points="314.5,182 325.5,182 320,193" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M 250 204 H 352 L 376 228 V 248 H 250 Z" fillOpacity="0.25" />
    <polygon points="352,204 376,228 352,228" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="266" y="222" width="52" height="7" rx="3.5" />
    <rect x="266" y="234" width="38" height="7" rx="3.5" />
  </g>
</svg>
