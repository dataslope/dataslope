...
Before the definitions, here is how the four words fit together. A
database holds tables, a table holds rows and columns, and a cell is
where one row meets one column:
