...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A table card with a solid header and faint gray rows, where the middle row slides out to the right on a yellow band carrying its blue, green, and yellow values — a single row is one complete record"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="32" width="420" height="170" rx="12" fillOpacity="0.08" />
    <rect x="104" y="48" width="372" height="18" rx="6" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="104" y="80" width="84" height="24" rx="5" />
    <rect x="196" y="80" width="140" height="24" rx="5" />
    <rect x="344" y="80" width="132" height="24" rx="5" />
    <rect x="104" y="156" width="84" height="24" rx="5" />
    <rect x="196" y="156" width="140" height="24" rx="5" />
    <rect x="344" y="156" width="132" height="24" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="140" y="112" width="372" height="34" rx="8" fillOpacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="168" cy="129" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="192" y="122" width="120" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="324" y="122" width="80" height="14" rx="7" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="416" y="122" width="72" height="14" rx="7" />
  </g>
</svg>
