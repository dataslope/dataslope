...
<Figure
  slug="lite-inserting-data-cutout"
  alt="A hopper above a grid platform dropping three complete row strips into place one after another"
/>
...
<Figure
  slug="lite-inserting-data-insert-adds-rows-inline-cutout"
  alt="A fresh row of blocks slid into the open end of a board already holding rows"
  caption="`INSERT` adds rows to the end; the columns were fixed when the table was made."
/>
...
<Figure
  slug="lite-inserting-data-inline-cutout"
  alt="A new row of blocks slid into the open end of a board that already holds several rows"
  caption="Name the columns you are filling and the rest take their defaults."
/>
