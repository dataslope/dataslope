...
<Figure
  slug="lite-data-organization-problem-one-big-inline-cutout"
  alt="One enormously wide board with the same block repeated across several rows"
  caption="The same customer written out again on every order they ever placed."
/>
...
<Figure
  slug="lite-data-organization-three-problems-duplication-inline-cutout"
  alt="The same block repeated in three drawers, one of them visibly a different color from the others"
  caption="Store a fact twice and one copy will eventually disagree with the other."
/>
...
<Figure
  ...
  caption="One kind of thing per table is the rule that prevents most of the trouble."
/>
