...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A table card holds four columns, and past a solid gray arrow the result card carries copies of just the chosen blue and yellow columns while the table keeps them all — SELECT chooses columns to look at without changing the stored table"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="52" y="32" width="280" height="150" rx="12" fillOpacity="0.08" />
    <rect x="72" y="48" width="50" height="118" rx="6" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="134" y="48" width="50" height="118" rx="6" />
    <rect x="258" y="48" width="50" height="118" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="196" y="48" width="50" height="118" rx="6" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="348" y="103.5" width="32" height="3" rx="1.5" />
    <polygon points="378,99.5 389,105 378,110.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="410" y="52" width="178" height="110" rx="12" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="434" y="68" width="56" height="78" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="506" y="68" width="56" height="78" rx="6" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Five stamps in a row include the same blue design three times; below, each design appears exactly once — DISTINCT keeps one copy of every different value"
