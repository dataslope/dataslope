...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Five pantry jars on a shelf hold SQLite's storage classes, whole-number dots, decimal dot pairs, text bars, one raw blob, and a jar holding nothing at all, each jar's glass tinted to match what it stores"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="62" y="94" width="92" height="96" rx="12" fillOpacity="0.12" />
    <rect x="72" y="72" width="72" height="15" rx="7" fillOpacity="0.9" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="172" y="94" width="92" height="96" rx="12" fillOpacity="0.12" />
    <rect x="182" y="72" width="72" height="15" rx="7" fillOpacity="0.9" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="282" y="94" width="92" height="96" rx="12" fillOpacity="0.15" />
    <rect x="292" y="72" width="72" height="15" rx="7" fillOpacity="0.9" />
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="392" y="94" width="92" height="96" rx="12" fillOpacity="0.1" />
    <rect x="402" y="72" width="72" height="15" rx="7" fillOpacity="0.9" />
  ...
  <g fill="currentColor" opacity="0.35">
    <rect x="512" y="72" width="72" height="15" rx="7" />
  </g>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Three display pedestals: one holds a solid blue zero ring, one holds a real but empty green pill outline, and the third holds only a dashed gray circle, zero and empty string are known values, NULL is the absence of a value"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path fillRule="evenodd" d="M 165 60 A 24 24 0 1 0 165 108 A 24 24 0 1 0 165 60 Z M 165 73 A 11 11 0 1 1 165 95 A 11 11 0 1 1 165 73 Z" />
  </g>
  <rect x="286" y="70" width="72" height="28" rx="14" fill="none" stroke="var(--ds-green-500)" strokeWidth="4" />
  <circle cx="477" cy="84" r="22" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2.5" strokeDasharray="6 6" />
</svg>
