...
<Figure
  slug="lite-data-types-sqlite-odd-one-inline-cutout"
  alt="A rack of sockets where a mismatched block is quietly reshaped to fit rather than refused"
  caption="Other databases refuse the wrong type; SQLite converts where it reasonably can."
/>
