...
<Figure
  slug="lite-foreign-keys-referential-integrity-inline-cutout"
  alt="A gate latched shut across a crate while a cord still runs from that crate to another"
  caption="A foreign key stops you deleting a row something else still points at."
/>
...
<Figure
  ...
  caption="In SQLite the check is there but has to be switched on for each connection."
/>
