...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One blue customer card with a solid key dot connects by thin lines to the matching small blue key dots inside two green order cards, tables become a story when key values connect their rows"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="126" y1="104" x2="400" y2="68" />
    <line x1="126" y1="116" x2="400" y2="162" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="70" width="180" height="90" rx="12" fillOpacity="0.12" />
    <circle cx="110" cy="110" r="16" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="140" y="96" width="80" height="9" rx="4.5" />
    <rect x="140" y="114" width="60" height="9" rx="4.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="380" y="32" width="190" height="74" rx="12" fillOpacity="0.12" />
    <rect x="430" y="62" width="110" height="10" rx="5" />
    <rect x="380" y="126" width="190" height="74" rx="12" fillOpacity="0.12" />
    <rect x="430" y="156" width="110" height="10" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="408" cy="68" r="8" />
    <circle cx="408" cy="162" r="8" />
  </g>
</svg>
