...
<Figure
  slug="lite-relationships-intro-not-one-giant-inline-cutout"
  alt="One crowded crate spilling mixed items beside three tidy crates joined by cords"
  caption="Several small related tables beat one crate holding everything."
/>
...
<Figure
  ...
  caption="A relationship is a value in one table matching a key in another."
/>
...
INSERT INTO customers (name, phone) VALUES
  ('Ada', '555-0101'), ('Grace', '555-0102'), ('Linus', '555-0103'),
  ('Mae', '555-0104'), ('Rosa', '555-0105'), ('Ivan', '555-0106'),
  ('Nadia', '555-0107'), ('Omar', '555-0108'), ('Priya', '555-0109'),
  ('Quinn', '555-0110'), ('Ruth', '555-0111'), ('Sam', '555-0112'),
  ('Tariq', '555-0113'), ('Uma', '555-0114'), ('Viktor', '555-0115'),
  ('Wen', '555-0116'), ('Xenia', '555-0117'), ('Yusuf', '555-0118'),
  ('Zara', '555-0119'), ('Bruno', '555-0120'), ('Chidi', '555-0121'),
  ('Dara', '555-0122'), ('Elif', '555-0123'), ('Farid', '555-0124');

INSERT INTO orders (customer_id, total) VALUES
  (1, 42.00), (1, 18.00), (2, 99.00), (2, 15.00), (5, 30.00),
  (5, 76.00), (6, 22.00), (7, 64.00), (8, 12.00), (8, 48.00),
  (9, 91.00), (11, 27.00), (11, 55.00), (12, 38.00), (13, 19.00),
  (13, 83.00), (14, 45.00), (15, 61.00), (16, 24.00), (16, 70.00),
  (17, 33.00), (18, 88.00), (20, 16.00), (20, 52.00), (21, 29.00),
  (22, 74.00), (23, 95.00), (24, 36.00);`}
  starterCode={`SELECT
  customers.name,
