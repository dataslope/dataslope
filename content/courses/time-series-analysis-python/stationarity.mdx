...
<Figure
  ...
  caption="Stationarity is the difference between these two tracks. The wobbling one keeps returning to the same centre, so its mean and spread are properties you can quote; the drifting one has no fixed level to quote in the first place."
/>
...
<Figure
  ...
  caption="The test is a formal way of asking which of these two tracks you have. Your eyes can usually separate them on a chart; the point of running a test is to answer the same question with a number you can defend."
/>
