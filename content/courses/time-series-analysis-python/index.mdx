...
<Figure
  slug="time-series-analysis-python-thumbnail-cutout"
  alt="A long ribbon of a wavy line chart running across a platform with a forecast segment continuing past a marker"
  priority
/>
...
## This is a reasoning course, not a function reference
...
- Read **autocorrelation** and **partial autocorrelation** plots well enough
  to propose model orders by eye.
- Fit and interpret **autoregressive**, **moving-average**, and **ARIMA**
  models with statsmodels.
- Evaluate forecasts with the **mean absolute error**, the **root mean
  squared error**, and the **mean absolute percentage error**, each coded by
  hand in NumPy.
...
| **matplotlib** | Line charts, component subplots, autocorrelation plots |
| **statsmodels** | Decomposition, the Augmented Dickey-Fuller test, autocorrelation, ARIMA models |
