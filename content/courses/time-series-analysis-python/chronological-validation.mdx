...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two timelines: on top, a solid blue training stretch is separated from the green test stretch by one yellow divider and earns a green check; below, blue and green pieces interleave at random and earn a red cross, validation must split time in order, never shuffled"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="50" width="240" height="26" rx="8" />
    <rect x="80" y="120" width="40" height="26" rx="8" />
    <rect x="168" y="120" width="40" height="26" rx="8" />
    <rect x="256" y="120" width="40" height="26" rx="8" />
    <rect x="344" y="120" width="40" height="26" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="330" y="42" width="6" height="42" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="346" y="50" width="180" height="26" rx="8" />
    <rect x="124" y="120" width="40" height="26" rx="8" />
    <rect x="212" y="120" width="40" height="26" rx="8" />
    <rect x="300" y="120" width="40" height="26" rx="8" />
    <rect x="388" y="120" width="40" height="26" rx="8" />
  </g>
  <g
  ...
  >
    <path d="M556 64 L 566 74 L 584 48" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M556 120 L 582 146" />
    <path d="M582 120 L 556 146" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two error buckets: the left holds a handful of small, even green squares, while the right is dominated by one huge red square beside two tiny blue ones, squaring errors makes a single blunder dominate the RMSE score"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="140" y="60" width="6" height="100" rx="3" />
    <rect x="300" y="60" width="6" height="100" rx="3" />
    <rect x="140" y="154" width="166" height="6" rx="3" />
    <rect x="380" y="60" width="6" height="100" rx="3" />
    <rect x="540" y="60" width="6" height="100" rx="3" />
    <rect x="380" y="154" width="166" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="160" y="134" width="16" height="16" rx="4" />
    <rect x="182" y="134" width="16" height="16" rx="4" />
    <rect x="204" y="134" width="16" height="16" rx="4" />
    <rect x="226" y="134" width="16" height="16" rx="4" />
    <rect x="170" y="114" width="16" height="16" rx="4" />
    <rect x="196" y="114" width="16" height="16" rx="4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="400" y="96" width="54" height="54" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="464" y="138" width="12" height="12" rx="3" />
    <rect x="482" y="138" width="12" height="12" rx="3" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="The yellow divider guards the split above the ground, but a red pipe siphons from the green future side, dips beneath the timeline, and surfaces with an arrow inside the blue training side, preprocessing computed on the whole series leaks the future even when the split looks correct"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="44" y="130" width="552" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="100" width="220" height="26" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="324" y="66" width="8" height="64" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="356" y="100" width="220" height="26" rx="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }}>
    <path
      d="M470 134 C 470 182, 180 192, 180 142"
      fill="none"
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="180,128 173,142 187,142" />
  </g>
</svg>
