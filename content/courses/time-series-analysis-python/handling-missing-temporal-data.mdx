...
<Figure
  ...
  caption="The sleepers are the complete calendar and the bare ones are the days your data never mentions. Laying the full rail down first is what turns an absent row into a visible gap, and only a visible gap can be bridged deliberately."
/>
...
<Figure
  ...
  caption="Three bridging pieces for one gap. Choosing between them is choosing an assumption about what happened while nobody was measuring, which is why the right answer depends on what the series records rather than on which fill looks tidiest."
/>
