...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="A regular row of blue reading squares has two torn gaps: one is repaired with solid green squares, the other is left as dashed empty outlines — every fill method is a belief about what happened in the gap, and sometimes the honest answer is to leave it empty"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="70" width="22" height="22" rx="5" />
    <rect x="94" y="70" width="22" height="22" rx="5" />
    <rect x="128" y="70" width="22" height="22" rx="5" />
    <rect x="162" y="70" width="22" height="22" rx="5" />
    <rect x="264" y="70" width="22" height="22" rx="5" />
    <rect x="298" y="70" width="22" height="22" rx="5" />
    <rect x="332" y="70" width="22" height="22" rx="5" />
    <rect x="434" y="70" width="22" height="22" rx="5" />
    <rect x="468" y="70" width="22" height="22" rx="5" />
    <rect x="502" y="70" width="22" height="22" rx="5" />
    <rect x="536" y="70" width="22" height="22" rx="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="196" y="70" width="22" height="22" rx="5" />
    <rect x="230" y="70" width="22" height="22" rx="5" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <rect x="366" y="70" width="22" height="22" rx="5" />
    <rect x="400" y="70" width="22" height="22" rx="5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three copies of the same gap between a low blue dot and a high blue dot: the yellow line holds the last value flat until the very end, the red line drags the next value all the way back, and the green line glides evenly between them — forward-fill, back-fill, and interpolation are three different beliefs about the unseen"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M116 210 L 464 190" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="110" cy="66" r="6" />
    <circle cx="470" cy="42" r="6" />
    <circle cx="110" cy="142" r="6" />
    <circle cx="470" cy="118" r="6" />
    <circle cx="110" cy="212" r="6" />
    <circle cx="470" cy="188" r="6" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A blue sales line runs through six days and truly drops to a green zero dot on the closed day, while a red dashed segment floats straight across at the height interpolation would invent — a closed shop is a real zero, not a gap to fill"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="56" y="170" width="528" height="4" rx="2" />
  </g>
  <g
    ...
    strokeLinejoin="round"
  >
    <path d="M70 110 L 140 118 L 210 102 L 280 112 L 350 88 L 420 70 L 490 164" />
  </g>
