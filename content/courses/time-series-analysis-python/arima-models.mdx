...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three colored strands, blue, yellow, and green, braid together into a single forecasting line that flies onward as an arrow inside a widening pale band of uncertainty: AR, I, and MA meshing into ARIMA"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M390 106 L 520 82 L 520 138 L 390 114 Z" fillOpacity="0.15" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M80 70 C 180 70, 240 100, 300 110" />
    <path d="M300 110 H 466" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M80 110 C 180 110, 240 110, 296 110" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M80 150 C 180 150, 240 120, 300 110" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="484,110 466,102 466,118" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A blue trail of observations climbs to a thin yellow post where the data ends, and a green cone fans wider and wider around the forecast dots beyond it, uncertainty compounds with every step ahead, and an honest forecast admits it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="44" y="175" width="552" height="3" rx="1.5" fill="currentColor" opacity="0.2" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="56" cy="130" r="3.5" />
    <circle cx="86" cy="138" r="3.5" />
    <circle cx="116" cy="122" r="3.5" />
    <circle cx="146" cy="130" r="3.5" />
    <circle cx="176" cy="112" r="3.5" />
    <circle cx="206" cy="120" r="3.5" />
    <circle cx="236" cy="104" r="3.5" />
    <circle cx="266" cy="112" r="3.5" />
    <circle cx="296" cy="98" r="3.5" />
    <circle cx="320" cy="102" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="334" y="56" width="3" height="118" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M 346 98 L 596 26 L 596 178 Z" fillOpacity="0.1" />
    <path d="M 346 98 L 596 60 L 596 136 Z" fillOpacity="0.16" />
    <circle cx="386" cy="94" r="3.5" fillOpacity="0.95" />
    <circle cx="428" cy="91" r="3.5" fillOpacity="0.8" />
    <circle cx="470" cy="89" r="3.5" fillOpacity="0.65" />
    <circle cx="512" cy="87" r="3.5" fillOpacity="0.5" />
    <circle cx="554" cy="85" r="3.5" fillOpacity="0.4" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="A residual line jitters quietly along the zero line until it leaps into one sharp red peak at the twelfth lag, the model confessing that it is missing a seasonal term"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="50" y="106" width="540" height="4" rx="2" />
  </g>
  <g
  ...
  >
    <path d="M70 102 L 104 114 L 138 100 L 172 112 L 206 98 L 240 114 L 274 102 L 308 112 L 342 98 L 376 112 L 410 102 L 448 108" />
    <path d="M484 108 L 512 100 L 540 112 L 572 104" />
  </g>
  <g
    ...
    strokeLinejoin="round"
  >
    <path d="M448 108 L 466 38 L 484 108" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="466" cy="38" r="6" />
  </g>
</svg>
