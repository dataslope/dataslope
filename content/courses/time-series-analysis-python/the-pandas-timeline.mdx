...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="50" y="173" width="540" height="3" rx="1.5" />
    <circle cx="86" cy="174" r="4" />
    <circle cx="138" cy="174" r="4" />
    <circle cx="190" cy="174" r="4" />
    <circle cx="242" cy="174" r="4" />
    <circle cx="294" cy="174" r="4" />
    <circle cx="346" cy="174" r="4" />
    <circle cx="450" cy="174" r="4" />
    <circle cx="502" cy="174" r="4" />
    <circle cx="554" cy="174" r="4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="336" y="92" width="66" height="13" rx="6.5" transform="rotate(-16 369 98)" fillOpacity="0.85" />
    <circle cx="398" cy="174" r="4.5" fill="none" stroke="currentColor" strokeWidth="2.5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 150"
  role="img"
  aria-label="A yellow selection frame with corner handles encloses a run of solid blue squares on the timeline while the squares outside it stay gray — partial-string slicing selects the whole span you name, inclusive of both ends"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="52" y="78" width="16" height="16" rx="4" />
    <rect x="92" y="78" width="16" height="16" rx="4" />
    <rect x="132" y="78" width="16" height="16" rx="4" />
    <rect x="172" y="78" width="16" height="16" rx="4" />
    <rect x="452" y="78" width="16" height="16" rx="4" />
    <rect x="492" y="78" width="16" height="16" rx="4" />
    <rect x="532" y="78" width="16" height="16" rx="4" />
    <rect x="572" y="78" width="16" height="16" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="212" y="78" width="16" height="16" rx="4" />
    <rect x="252" y="78" width="16" height="16" rx="4" />
    <rect x="292" y="78" width="16" height="16" rx="4" />
    <rect x="332" y="78" width="16" height="16" rx="4" />
    <rect x="372" y="78" width="16" height="16" rx="4" />
    <rect x="412" y="78" width="16" height="16" rx="4" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="195" y="57" width="10" height="10" rx="3" />
    <rect x="435" y="57" width="10" height="10" rx="3" />
    <rect x="195" y="105" width="10" height="10" rx="3" />
    <rect x="435" y="105" width="10" height="10" rx="3" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="One solid blue timestamp capsule fans out along three thin arrows into green, blue, and yellow tiles — the dt accessor splits a single datetime into calendar parts like year, month, and weekday"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M206 100 L 300.6 48" />
    <path d="M206 100 H 296" />
    <path d="M206 100 L 300.6 152" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="295.3,45.6 300,57 306.3,46.4" />
    <polygon points="310,100 296,93 296,107" />
    <polygon points="306.3,153.6 300,143 295.3,154.4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="82" width="130" height="36" rx="18" />
    <rect x="322" y="87" width="72" height="26" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="322" y="30" width="72" height="26" rx="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="322" y="144" width="72" height="26" rx="9" />
  </g>
</svg>
