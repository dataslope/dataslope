...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A glowing yellow pane slides along a row of yellow noisy dots, lighting the few inside it blue — a rolling window summarizes a sliding stretch of the recent past"
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="A smooth blue average line glides upward through yellow data dots and stops dead at a red post where the data ends; the dashed continuation beyond the post is crossed out in red — a moving average describes the past and cannot step into the future"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="44" y="156" width="552" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="70" cy="122" r="3.5" />
    <circle cx="106" cy="106" r="3.5" />
    <circle cx="142" cy="118" r="3.5" />
    <circle cx="178" cy="92" r="3.5" />
    <circle cx="214" cy="104" r="3.5" />
    <circle cx="250" cy="80" r="3.5" />
    <circle cx="286" cy="92" r="3.5" />
    <circle cx="322" cy="70" r="3.5" />
    <circle cx="358" cy="82" r="3.5" />
    <circle cx="394" cy="62" r="3.5" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M64 126 C 150 112, 300 88, 424 64" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="424" cy="64" r="6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="438" y="44" width="7" height="112" rx="3.5" />
  </g>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M494 42 L 514 62" />
    <path d="M514 42 L 494 62" />
  </g>
</svg>
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="102" cy="92" r="3.5" />
    <circle cx="134" cy="112" r="3.5" />
    <circle cx="166" cy="96" r="3.5" />
    <circle cx="198" cy="116" r="3.5" />
    <circle cx="230" cy="100" r="3.5" />
    <circle cx="262" cy="88" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="404" cy="108" r="3.5" />
    <circle cx="436" cy="94" r="3.5" />
    <circle cx="468" cy="114" r="3.5" />
    <circle cx="500" cy="98" r="3.5" />
    <circle cx="532" cy="118" r="3.5" />
    <circle cx="564" cy="102" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
