...
<Figure
  ...
  caption="Autocorrelation is a series compared against a shifted copy of itself. Slide the copy k steps along, ask how well the two still line up, and the gauge reading you get is the correlation at lag k. One reading per shift is what the whole plot is made of."
/>
...
<Figure
  ...
  caption="Reading a plot means matching its shape against a small set of known signatures. The four reference shapes are the ones the cheat-sheet below names, and identifying a model comes down to seeing which one your plot is."
/>
...
<Figure
  ...
  caption="The card pinned above the bench is the cheat-sheet, and the wave patterns below it are the series we are about to build. Because we choose the coefficients ourselves, we know which shape each one should match before we plot it, which is what turns the table from a claim into something you can check."
/>
