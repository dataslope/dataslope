...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two rows of echoes spread from the same starting dot: the blue top row fades gradually lag by lag while the green bottom row sounds once and then falls silent into small solid gray dots — an ACF that tails off and a PACF that cuts off, the paired fingerprint that names a model"
...
>
  ...
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    ...
    <circle cx="252" cy="160" r="5" />
    <circle cx="308" cy="160" r="5" />
    <circle cx="364" cy="160" r="5" />
    <circle cx="420" cy="160" r="5" />
    <circle cx="476" cy="160" r="5" />
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Lollipop spikes around a shaded zero band: the first two rise clear of it in blue, the rest hide inside as small gray stems, and one lone red spike pokes far out down the row — only the overall pattern, not a single stray spike, names a model"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="94" width="520" height="52" rx="10" fill="currentColor" opacity="0.08" />
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M100 118 V 56" />
    <path d="M140 118 V 72" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="100" cy="50" r="5.5" />
    <circle cx="140" cy="66" r="5.5" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M180 118 V 106" />
    <path d="M220 122 V 134" />
    <path d="M260 118 V 110" />
    <path d="M300 122 V 130" />
    <path d="M340 118 V 104" />
    <path d="M380 122 V 136" />
    <path d="M420 118 V 108" />
    <path d="M460 122 V 132" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <circle cx="180" cy="102" r="4" />
    <circle cx="220" cy="138" r="4" />
    <circle cx="260" cy="106" r="4" />
    <circle cx="300" cy="134" r="4" />
    <circle cx="340" cy="100" r="4" />
    <circle cx="380" cy="140" r="4" />
    <circle cx="420" cy="104" r="4" />
