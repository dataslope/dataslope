---
title: "Reading ACF and PACF Plots"
...
each value is $0.7 \times$ the previous one. Then $y(t)$ is directly tied to
...
Every ACF/PACF plot draws a shaded band, roughly $\pm 1.96/\sqrt{n}$. Spikes *inside*
