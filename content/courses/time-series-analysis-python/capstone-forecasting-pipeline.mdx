...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A thin path climbs in three straight legs from a blue starting dot through blue and yellow stations to a green flag planted at the summit, while a red pitfall dot sits just off the trail — the forecasting pipeline as one journey from raw data to a validated forecast"
...
>
  ...
  >
    <path d="M70 200 L 240 160 L 410 110 L 540 64" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="70" cy="200" r="9" />
    <circle cx="155" cy="180" r="7" />
    <circle cx="240" cy="160" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="325" cy="135" r="7" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="330" cy="185" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="475" cy="87" r="7" />
    <polygon points="540,20 574,28 540,36" />
  </g>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three horizontal error bars grow from the same wall toward a yellow baseline mark: the gray baseline bar reaches it exactly, the blue model stops just short of it, and the green seasonal model is much shorter — an error score only means something when it beats the baseline on the same honest test"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="100" y="40" width="6" height="140" rx="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="380" y="36" width="4" height="148" rx="2" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="106" y="52" width="274" height="28" rx="9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="106" y="96" width="250" height="28" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="106" y="140" width="150" height="28" rx="9" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three production stages — a blue model box, a green monitoring dot, and a yellow retraining tile — joined in a loop by thin curved arrows, while a red drift dot escapes the cycle along a thin line — a deployed forecast lives in a monitor, detect, and refit cycle"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g
    style={{ color: "var(--ds-gray-400)" }}
    ...
    strokeLinecap="round"
  >
    <path d="M348 48 A 76 76 0 0 1 390.4 135.1" />
    <path d="M364 160 A 76 76 0 0 1 275.1 157.8" />
    <path d="M250 130 A 76 76 0 0 1 290.9 51.1" />
    <path d="M402 168 L 448 196" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="384.7,134.1 392,144 395.5,132.2" />
    <polygon points="277.1,163.3 282,152 270,154.8" />
    <polygon points="285.2,49.8 292,60 296.1,48.4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="302" y="20" width="36" height="36" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="386" cy="148" r="13" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="232" y="134" width="42" height="26" rx="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="458" cy="202" r="6" />
  </g>
</svg>
