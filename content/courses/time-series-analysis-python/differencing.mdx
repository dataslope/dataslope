...
<Figure
  ...
  caption="Differencing measures gaps rather than heights. A steadily rising row of blocks has gaps of roughly constant size, so the bars on the right settle around a flat centre: the trend is gone, and what is left is the part worth modelling."
/>
...
<Figure
  ...
  caption="One difference already flattens this row. Differencing again would work on the flat bars themselves, adding noise without any trend left to remove, and that is precisely the over-differencing trap below."
/>
