...
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="60" y="60" width="140" height="100" rx="12" fillOpacity="0.14" />
  </g>
  <g style={{ color: "var(--ds-yellow-300)" }} fill="currentColor">
    <rect x="88" y="70" width="4" height="80" rx="2" />
    <rect x="128" y="70" width="4" height="80" rx="2" />
    <rect x="168" y="70" width="4" height="80" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
