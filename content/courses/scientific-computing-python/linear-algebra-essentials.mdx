...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A square grid of dots and its sheared copy joined by dotted tethers, with one dark blue arrow pointing the same way in both, a matrix as a transformation of space, and the direction it preserves"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.08">
    <rect x="100" y="60" width="120" height="120" rx="10" />
    <polygon points="428,60 548,60 500,180 380,180" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.8">
    ...
    <circle cx="464" cy="120" r="6" />
    <circle cx="504" cy="120" r="6" />
    <circle cx="408" cy="160" r="6" />
    <circle cx="448" cy="160" r="6" />
    <circle cx="488" cy="160" r="6" />
  </g>
  <g style={{ color: "var(--ds-blue-700)" }} fill="currentColor">
    <rect x="160" y="118.5" width="38" height="3" rx="1.5" />
    <polygon points="196,114.5 207,120 196,125.5" />
    <rect x="464" y="118.5" width="38" height="3" rx="1.5" />
    <polygon points="500,114.5 511,120 500,125.5" />
  </g>
</svg>
