...
description: LU, QR, Cholesky and the singular value decomposition, the factorizations behind every numerical linear algebra routine
---
...
<Figure
  slug="scipy-decompositions-cutout"
  alt="One solid matrix cube splitting apart into three structured slab factors arranged in a row on a platform"
/>
...
<Figure
  slug="scipy-matrix-decompositions-lu-decomposition-inline-cutout"
  alt="One grid separated into a lower stepped grid and an upper stepped grid that stack back together"
  caption="Factor once into two triangular pieces and every later solve is cheap."
/>
...
<Figure
  slug="scipy-matrix-decompositions-five-factorizations-at-inline-cutout"
  alt="One solid block shown separated five different ways along a bench"
  caption="Five ways to take a matrix apart, each answering a different question."
/>
...
<Figure
  slug="scipy-matrix-decompositions-inline-cutout"
  alt="One solid block being separated into three simpler blocks that stack back together to the same shape"
  caption="A decomposition rewrites one matrix as simpler ones that multiply back to it."
/>
