...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Six small panels from a parameter sweep, each tracing a different predator-prey cycle: one flatlines in red, one stable green orbit stands out — a simulation explored across its parameters"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.08">
    <rect x="70" y="25" width="170" height="90" rx="10" />
    <rect x="250" y="25" width="170" height="90" rx="10" />
    <rect x="70" y="125" width="170" height="90" rx="10" />
    <rect x="430" y="125" width="170" height="90" rx="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor" fillOpacity="0.08">
    <rect x="430" y="25" width="170" height="90" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="250" y="125" width="170" height="90" rx="10" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.7">
    <circle cx="90" cy="70" r="3.5" />
    <circle cx="114" cy="82" r="3.5" />
    <circle cx="138" cy="70" r="3.5" />
    <circle cx="162" cy="58" r="3.5" />
    <circle cx="186" cy="70" r="3.5" />
    <circle cx="210" cy="82" r="3.5" />
    <circle cx="270" cy="70" r="3.5" />
    <circle cx="294" cy="94" r="3.5" />
    <circle cx="318" cy="70" r="3.5" />
    <circle cx="342" cy="46" r="3.5" />
    <circle cx="366" cy="70" r="3.5" />
    <circle cx="390" cy="94" r="3.5" />
    <circle cx="90" cy="170" r="3.5" />
    <circle cx="114" cy="150" r="3.5" />
    <circle cx="138" cy="170" r="3.5" />
    <circle cx="162" cy="190" r="3.5" />
    <circle cx="186" cy="170" r="3.5" />
    <circle cx="210" cy="150" r="3.5" />
    <circle cx="450" cy="170" r="3.5" />
    <circle cx="474" cy="162" r="3.5" />
    <circle cx="498" cy="170" r="3.5" />
    <circle cx="522" cy="178" r="3.5" />
    <circle cx="546" cy="170" r="3.5" />
    <circle cx="570" cy="162" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor" fillOpacity="0.6">
    <circle cx="450" cy="70" r="3.5" />
    <circle cx="474" cy="88" r="3.5" />
    <circle cx="498" cy="98" r="3.5" />
    <circle cx="522" cy="102" r="3.5" />
    <circle cx="546" cy="103" r="3.5" />
    <circle cx="570" cy="103" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.85">
    <circle cx="270" cy="170" r="3.5" />
    <circle cx="294" cy="186" r="3.5" />
    <circle cx="318" cy="170" r="3.5" />
    <circle cx="342" cy="154" r="3.5" />
    <circle cx="366" cy="170" r="3.5" />
    <circle cx="390" cy="186" r="3.5" />
  </g>
</svg>
