...
<Figure
  slug="scipy-capstone-simulation-phase-portrait-inline-cutout"
  alt="Two axes with a closed loop drawn across them, one marker travelling round the loop and arriving back where it began"
  caption="Plot predator against prey and a sustained oscillation shows up as a closed orbit."
/>
...
<Figure
  slug="scipy-capstone-simulation-quantifying-sensitivity-inline-cutout"
  alt="A dial turned slowly past a row of marks while a gate stays shut, then swings wide open at one particular mark"
  caption="A sweep tells you not just that a parameter matters but where it starts to matter."
/>
