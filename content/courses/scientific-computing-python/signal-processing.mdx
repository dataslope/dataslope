...
<Figure
  slug="scipy-signal-processing-discrete-fourier-transform-fft-inline-cutout"
  alt="One wavering track fed into a prism and leaving as a row of separate bars, one bar much taller than the rest"
  caption="The transform splits a signal into the frequencies it is made of, and one stands out."
/>
