...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A dotted wave enters a box marked with a function glyph and comes out as a few descending frequency bars — the Fourier transform turning a signal in time into a spectrum in frequency"
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.8">
    ...
    <circle cx="90" cy="134" r="4" />
    <circle cx="105" cy="124" r="4" />
    <circle cx="120" cy="100" r="4" />
    <circle cx="135" cy="76" r="4" />
    <circle cx="150" cy="66" r="4" />
    <circle cx="165" cy="76" r="4" />
    <circle cx="180" cy="100" r="4" />
    <circle cx="195" cy="124" r="4" />
    <circle cx="210" cy="134" r="4" />
    <circle cx="225" cy="124" r="4" />
    <circle cx="240" cy="100" r="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="280" y="60" width="90" height="80" rx="14" fillOpacity="0.12" />
  </g>
  <g fill="var(--ds-blue-500)">
    <text x="325" y="112" textAnchor="middle" fontFamily="var(--font-sans), Georgia, serif" fontStyle="italic" fontSize="32">ƒ</text>
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="440" y="60" width="18" height="90" rx="4" fillOpacity="0.85" />
    <rect x="470" y="96" width="18" height="54" rx="4" fillOpacity="0.7" />
    <rect x="500" y="118" width="18" height="32" rx="4" fillOpacity="0.55" />
    <rect x="530" y="132" width="18" height="18" rx="4" fillOpacity="0.45" />
    <rect x="560" y="140" width="18" height="10" rx="4" fillOpacity="0.35" />
  </g>
</svg>
