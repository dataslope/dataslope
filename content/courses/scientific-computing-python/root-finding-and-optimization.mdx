...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A bold blue curve dips twice, a yellow ball rests in the shallow dip while a green ball sits at the true floor marked by a dashed line, optimization can settle for a local minimum or find the global one"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="100" y1="185" x2="540" y2="185" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="7 6" strokeLinecap="round" />
  <path d="M70 45 C 110 140, 150 185, 200 185 C 250 185, 270 130, 320 115 C 360 103, 380 108, 420 130 C 450 146, 480 150, 510 135 C 550 115, 570 75, 585 50" fill="none" stroke="var(--ds-blue-500)" strokeWidth="4" strokeLinecap="round" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="200" cy="172" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="463" cy="137" r="9" />
  </g>
</svg>
