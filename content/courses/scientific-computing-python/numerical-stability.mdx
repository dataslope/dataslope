...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two chains of operation boxes process the same tiny blue error dot: in the top chain it stays tiny, in the bottom chain it doubles at every step until it bursts out of the last box"
