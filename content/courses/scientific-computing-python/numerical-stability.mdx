...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two chains of operation boxes process the same tiny red error dot: in the top chain it stays tiny, in the bottom chain it doubles at every step until it bursts out of the last box"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.14">
    <rect x="150" y="40" width="46" height="46" rx="10" />
    <rect x="260" y="40" width="46" height="46" rx="10" />
    <rect x="370" y="40" width="46" height="46" rx="10" />
    <rect x="480" y="40" width="46" height="46" rx="10" />
    <rect x="150" y="140" width="46" height="46" rx="10" />
    <rect x="260" y="140" width="46" height="46" rx="10" />
    <rect x="370" y="140" width="46" height="46" rx="10" />
    <rect x="480" y="140" width="46" height="46" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="216" cy="63" r="3" />
    <circle cx="238" cy="63" r="3" />
    <circle cx="326" cy="63" r="3" />
    <circle cx="348" cy="63" r="3" />
    <circle cx="436" cy="63" r="3" />
    <circle cx="458" cy="63" r="3" />
    <circle cx="216" cy="163" r="3" />
    <circle cx="238" cy="163" r="3" />
    <circle cx="326" cy="163" r="3" />
    <circle cx="348" cy="163" r="3" />
    <circle cx="436" cy="163" r="3" />
    <circle cx="458" cy="163" r="3" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="173" cy="63" r="4" />
    <circle cx="283" cy="63" r="4.5" />
    <circle cx="393" cy="63" r="5" />
    <circle cx="503" cy="63" r="5" />
    <circle cx="173" cy="163" r="4" />
    <circle cx="283" cy="163" r="8" />
    <circle cx="393" cy="163" r="14" />
    <circle cx="503" cy="163" r="26" fillOpacity="0.85" />
  </g>
</svg>
