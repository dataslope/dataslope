...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A perfect green circle in one card faces its computed twin in the next, the same shape rebuilt from straight blue segments, mathematics is exact, computation approximates"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="70" y="30" width="210" height="150" rx="14" fillOpacity="0.1" />
  </g>
  <circle cx="175" cy="105" r="52" fill="none" stroke="var(--ds-green-500)" strokeWidth="4" />
  <g fill="var(--ds-gray-400)">
    <rect x="300" y="103.5" width="40" height="3" rx="1.5" />
    <polygon points="338,99.5 349,105 338,110.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="370" y="30" width="210" height="150" rx="14" fillOpacity="0.08" />
  </g>
  <polygon points="527,105 511.8,141.8 475,157 438.2,141.8 423,105 438.2,68.2 475,53 511.8,68.2" fill="none" stroke="var(--ds-blue-500)" strokeWidth="4" strokeLinejoin="round" />
</svg>
