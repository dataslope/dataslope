...
<Figure
  slug="scipy-python-in-science-cutout"
  alt="Three stepped platforms carrying a punched-card reader, a matrix calculator panel, and a small modern console"
/>
...
<Figure
  slug="scipy-python-in-science-numpy-cutout"
  alt="Two small toolboxes emptied into one larger shared toolbox, with a row of tall instruments standing beside it"
  caption="NumPy, 2005 to 2006: two rival array packages folded into one, which is what the rest could then be built on."
/>
...
<Figure
  slug="scipy-python-in-science-matlab-calculator-thought-inline-cutout"
  alt="A machine whose input slot takes a whole grid of blocks rather than one at a time"
  caption="MATLAB let scientists work on whole matrices instead of element by element."
/>
