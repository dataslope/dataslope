...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="An abstract composition — three tilted bars in blue, green, and yellow sweep across a pale green disc, with a blue dot and a yellow dot floating at opposite corners — a bright send-off for the course"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="110" r="90" fillOpacity="0.1" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="170" y="62" width="300" height="16" rx="8" transform="rotate(-24 320 70)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="150" y="110" width="340" height="16" rx="8" transform="rotate(-24 320 118)" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="190" y="158" width="260" height="16" rx="8" transform="rotate(-24 320 166)" />
    <circle cx="530" cy="55" r="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="118" cy="172" r="10" />
  </g>
</svg>
