...
<Figure
  slug="scipy-next-steps-cutout"
  alt="The Dataslope marmot mascot beside a workbench of numerical tools with a signpost pointing toward larger floating machines"
/>
...
# Solve an equation symbolically. Constraints go on the *symbols*, not into
# the system: x real and y positive is what makes solve() drop the negative
# root and return one branch.
y = sp.symbols("y", positive=True)
print("solutions to x² + y² = 1, y > 0:", sp.solve(x**2 + y**2 - 1, y))
