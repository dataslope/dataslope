...
<Figure
  slug="scipy-approximation-and-error-truncation-vs-round-inline-cutout"
  alt="A curve cut short at one end beside a measurement whose last mark is fractionally off"
  caption="Truncation is the maths you cut short; round-off is what the machine loses."
/>
...
<Figure
  slug="scipy-approximation-and-error-convergence-order-inline-cutout"
  alt="Three curves closing on a line at visibly different rates"
  caption="A higher order means the error falls away far faster as the step shrinks."
/>
...
<Figure
  slug="scipy-approximation-and-error-inline-cutout"
  alt="A curved rail with a straight rod laid against it, small gaps visible between rod and rail at both ends"
  caption="An adaptive method shortens the step where the answer is changing fastest."
/>
