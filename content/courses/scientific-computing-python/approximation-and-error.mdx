...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two translucent error wedges crossing in an X, truncation falling as round-off rises, with a dotted total-error curve and a green dot marking the sweet spot at the crossing"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="80" y="40" width="3" height="135" rx="1.5" opacity="0.2" />
    <rect x="80" y="172" width="480" height="3" rx="1.5" opacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="100,50 540,150 540,155 100,55" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="100,150 540,50 540,55 100,155" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="64" r="3.5" />
    <circle cx="200" cy="78" r="3.5" />
    <circle cx="260" cy="92" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="380" cy="92" r="3.5" />
    <circle cx="440" cy="78" r="3.5" />
    <circle cx="500" cy="64" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="103" r="14" fillOpacity="0.25" />
    <circle cx="320" cy="103" r="7" />
  </g>
</svg>
