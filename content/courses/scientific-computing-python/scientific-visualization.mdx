...
<Figure
  ...
  alt="A raised plotting panel showing a contour field and a small color ramp bar standing on the platform beside it"
/>
...
<Figure
  ...
  caption="A scientific figure needs its scale and its uncertainty, not decoration."
/>
...
<Figure
  slug="scipy-scientific-visualization-matplotlib-object-model-inline-cutout"
  alt="A framed board lifted apart into its separate pieces, the outer frame, the inner panel and the marks"
  caption="Figure, axes and artists are separate pieces you address separately."
/>
...
A quiver plot draws the field as arrows, one per grid point, which works
up to a few hundred points and then turns into a thicket. For a scalar
field, a filled contour carries far more resolution per pixel:
