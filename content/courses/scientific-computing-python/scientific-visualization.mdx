...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A clean chart of blue data points scattered around a smooth light blue trend band, with a fading colorbar at the side — a figure built carefully enough to serve as evidence"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="110" y="30" width="3" height="160" rx="1.5" opacity="0.25" />
    <rect x="110" y="187" width="420" height="3" rx="1.5" opacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-blue-300)" }} fill="currentColor">
    <path d="M130 160 C240 140 340 80 510 60 L510 74 C340 94 240 154 130 174 Z" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.85">
    <circle cx="150" cy="158" r="5.5" />
    <circle cx="190" cy="152" r="5.5" />
    <circle cx="225" cy="140" r="5.5" />
    <circle cx="255" cy="148" r="5.5" />
    <circle cx="290" cy="118" r="5.5" />
    <circle cx="325" cy="112" r="5.5" />
    <circle cx="360" cy="96" r="5.5" />
    <circle cx="395" cy="102" r="5.5" />
    <circle cx="430" cy="80" r="5.5" />
    <circle cx="465" cy="84" r="5.5" />
    <circle cx="495" cy="62" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="560" y="40" width="18" height="28" />
    <rect x="560" y="68" width="18" height="28" fillOpacity="0.75" />
    <rect x="560" y="96" width="18" height="28" fillOpacity="0.5" />
    <rect x="560" y="124" width="18" height="28" fillOpacity="0.3" />
    <rect x="560" y="152" width="18" height="28" fillOpacity="0.12" />
  </g>
</svg>
