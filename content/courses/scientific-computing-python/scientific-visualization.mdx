...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A clean chart of blue data points scattered around a smooth green trend band, with a fading colorbar at the side — a figure built carefully enough to serve as evidence"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="110" y="30" width="5" height="160" rx="2.5" opacity="0.25" />
    <rect x="110" y="185" width="420" height="5" rx="2.5" opacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M130 160 C240 140 340 80 510 60 L510 74 C340 94 240 154 130 174 Z" fillOpacity="0.3" />
  </g>
