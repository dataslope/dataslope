...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One blue experiment card holding a code chip, a data dot, and a yellow seed feeds two thin arrows into two bar charts that match bar for bar, marked equal — the same inputs rerun give the same result every time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="60" width="180" height="100" rx="16" fillOpacity="0.1" />
    <circle cx="110" cy="125" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="95" y="85" width="60" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="200" cy="120" r="8" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="266" y="68.5" width="60" height="3" rx="1.5" />
    <polygon points="324,64.5 335,70 324,75.5" />
    <rect x="266" y="148.5" width="60" height="3" rx="1.5" />
    <polygon points="324,144.5 335,150 324,155.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="360" y="30" width="200" height="76" rx="12" fillOpacity="0.1" />
    <rect x="380" y="74" width="18" height="20" rx="4" />
    <rect x="408" y="56" width="18" height="38" rx="4" />
    <rect x="436" y="66" width="18" height="28" rx="4" />
    <rect x="464" y="46" width="18" height="48" rx="4" />
    <rect x="360" y="114" width="200" height="76" rx="12" fillOpacity="0.1" />
    <rect x="380" y="158" width="18" height="20" rx="4" />
    <rect x="408" y="140" width="18" height="38" rx="4" />
    <rect x="436" y="150" width="18" height="28" rx="4" />
    <rect x="464" y="130" width="18" height="48" rx="4" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="584" y="101" width="26" height="5" rx="2.5" />
    <rect x="584" y="113" width="26" height="5" rx="2.5" />
  </g>
</svg>
