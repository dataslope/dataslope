...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A contiguous strip of memory cells reappears below as a three-by-four grid of the same cells, with a small shape tag reading 3 by 4 — one block of memory viewed as a multidimensional array"
