...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="The same rounded container shown three times, each wider and holding more dots, with a green plus where the next item lands — an elastic vector stretches to fit its contents"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="180" y="30" width="160" height="44" rx="22" />
    <rect x="180" y="95" width="240" height="44" rx="22" />
    <rect x="180" y="160" width="330" height="44" rx="22" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="210" cy="52" r="8" />
    <circle cx="240" cy="52" r="8" />
    <circle cx="270" cy="52" r="8" />
    <circle cx="210" cy="117" r="8" />
    <circle cx="240" cy="117" r="8" />
    <circle cx="270" cy="117" r="8" />
    <circle cx="300" cy="117" r="8" />
    <circle cx="330" cy="117" r="8" />
    <circle cx="210" cy="182" r="8" />
    <circle cx="240" cy="182" r="8" />
    <circle cx="270" cy="182" r="8" />
    <circle cx="300" cy="182" r="8" />
    <circle cx="330" cy="182" r="8" />
    <circle cx="360" cy="182" r="8" />
    <circle cx="390" cy="182" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="420" cy="182" r="8" />
    <rect x="540" y="178" width="22" height="8" rx="4" />
    <rect x="547" y="171" width="8" height="22" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="455" cy="182" r="3" />
    <circle cx="475" cy="182" r="3" />
    <circle cx="495" cy="182" r="3" />
  </g>
</svg>
