...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A heavy grid of blue dots stays exactly where it is while a thin handle arcs from a faded old box to a crisp green one — moving transfers ownership of the buffer instead of copying its contents"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <path
      d="M452 98 C 426 110, 400 118, 376 126"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M196 38 C 260 14, 380 14, 444 36" />
    <path d="M184 98 C 204 110, 224 118, 246 126" />
  </g>
</svg>
