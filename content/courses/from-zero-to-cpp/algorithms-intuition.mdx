...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three cost curves rise from one origin: a green line stays flat, a blue line climbs steadily, and a red one rockets off the top of the chart, how different algorithms feel as input grows"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="60" y="190" width="520" height="4" rx="2" />
    <rect x="60" y="20" width="4" height="174" rx="2" />
  </g>
  ...
  <g style={{ color: "var(--ds-red-500)" }}>
    <path
      d="M100 166 C 220 158, 310 116, 375 30"
      fill="none"
      stroke="currentColor"
      strokeWidth="3.5"
      strokeLinecap="round"
