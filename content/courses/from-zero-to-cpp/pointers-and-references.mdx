...
<Figure
  slug="cpp-pointers-null-mistake-cutout"
  alt="A row of six pigeonholes, five holding a solid shape and the middle one empty, with a small figure reaching into the empty one"
  caption="Tony Hoare added the null reference to ALGOL W in 1965, and called it his billion-dollar mistake in 2009."
/>
...
<Figure
  slug="cpp-pointers-and-references-pointer-address-type-inline-cutout"
  alt="A card carrying an arrow to another slot, the card cut to a shape matching only one kind of block"
  caption="A pointer holds an address and knows what kind of thing lives there."
/>
