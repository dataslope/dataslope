...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two name tags tether down to one blue dot while a small pointer box on the left stores its address and aims a thin arrow at it — references alias an object, pointers hold where it lives"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M340 62 C 356 80, 374 98, 388 112" />
    <path d="M460 62 C 450 80, 436 98, 416 112" />
    <path d="M152 130 H 356" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="358,122 358,138 372,130" fillOpacity="0.7" />
  </g>
</svg>
