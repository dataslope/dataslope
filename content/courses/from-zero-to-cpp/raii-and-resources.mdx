...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Inside a translucent scope bubble a blue dot holds a green resource on a thin leash; where the bubble has closed on the right, the resource is gone and only green sparks remain — acquisition tied to lifetime, release guaranteed at the end"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      d="M196 102 C 214 116, 230 128, 246 140"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
