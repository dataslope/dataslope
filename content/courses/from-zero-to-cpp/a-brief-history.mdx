...
<Figure
  slug="cpp-brief-history-cutout"
  alt="A brief history of programming, an isometric illustration"
/>
...
<Figure
  slug="cpp-a-brief-history-assembly-small-step-inline-cutout"
  alt="A board of hand-thrown switches beside a card of short written marks, the card feeding a small translating machine"
...
<Figure
  slug="cpp-a-brief-history-first-programs-were-inline-cutout"
  alt="A board of switches thrown by hand and a card punched with holes, both feeding the same machine"
  caption="The first programs were switches and punched cards, entered by hand."
/>
...
<Figure
  slug="cpp-brief-history-c-with-classes-cutout"
  alt="A figure at a 1970s terminal pressing two blocks together into one taller block at the end of the bench"
  caption="Bell Labs, 1979: Simula's classes pressed onto C, without giving up C's speed."
/>
...
- [o] C++ began as an extension of C, and although most C programs still compile as C++, idiomatic modern C++ looks very different from idiomatic C.
  > C++ grew classes, templates, automatic resource management, and a large standard library on top of C's core model.`}
/>
