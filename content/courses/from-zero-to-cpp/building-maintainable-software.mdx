...
<Figure
  slug="cpp-maintainable-software-cutout"
  alt="Building maintainable software, an isometric illustration"
/>
...
<Figure
  slug="cpp-building-maintainable-software-names-carry-most-inline-cutout"
  alt="A wall of unlabelled tins beside the same wall with clear blank-shaped tags, a hand reaching straight to one"
  caption="A good name spares the reader the comment you would otherwise write."
/>
...
<Figure
  slug="cpp-building-maintainable-software-one-thing-per-inline-cutout"
  alt="One crowded machine doing four jobs beside four small machines each doing one and clipping together"
  caption="One job per function, and the pieces can be read and tested separately."
/>
...
- Keep changes small. A 100-line pull request gets thoughtful feedback; a
  10,000-line one gets a thumbs-up.
