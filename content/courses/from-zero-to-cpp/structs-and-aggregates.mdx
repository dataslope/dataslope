...
<Figure
  slug="cpp-structs-and-aggregates-cutout"
  alt="Structs and aggregates, an isometric illustration"
/>
...
<Figure
  slug="cpp-structs-and-aggregates-inline-cutout"
  alt="Several loose parts on a bench being set into one fitted case, the case then lifted and carried by a single handle"
  caption="A struct bundles loose values into one thing you can pass by name."
/>
...
<Figure
  slug="cpp-structs-and-aggregates-struct-named-bundle-inline-cutout"
  alt="Several loose parts set into one fitted case that is then lifted by a single handle"
  caption="`struct` is for plain data; `class` is for data with invariants to protect."
/>
