...
<Figure
  slug="cpp-types-and-values-types-inline-cutout"
  alt="A rack of shaped sockets with each block held above the only socket it fits"
  caption="Every value has a type, and the type decides what fits where."
/>
...
<Figure
  slug="cpp-types-and-values-ariane-5-cutout"
  alt="A launcher climbing away from its tower, breaking apart at the top of its arc while a ground station tracks it"
  caption="Ariane 5 Flight 501, 4 June 1996: a 64-bit velocity that no longer fit in 16 bits."
/>
