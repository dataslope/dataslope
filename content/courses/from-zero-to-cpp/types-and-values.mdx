...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A sorting panel with circle, square, and triangle holes; matching colored pieces drop toward their own openings while a red square that fits nowhere rests on top, a type only accepts values of the right shape"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <path fillRule="evenodd" d="M156 120 h328 a16 16 0 0 1 16 16 v48 a16 16 0 0 1 -16 16 h-328 a16 16 0 0 1 -16 -16 v-48 a16 16 0 0 1 16 -16 Z M192 160 a18 18 0 1 0 36 0 a18 18 0 1 0 -36 0 Z M303 143 h34 v34 h-34 Z M430 142 L448 178 L412 178 Z" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="210" cy="52" r="16" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="304" y="38" width="32" height="32" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="430,36 448,72 412,72" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="210" cy="86" r="3" />
    <circle cx="210" cy="104" r="3" />
    <circle cx="320" cy="86" r="3" />
    <circle cx="320" cy="104" r="3" />
    <circle cx="430" cy="90" r="3" />
    <circle cx="430" cy="106" r="3" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="160" y="98" width="22" height="22" rx="5" fillOpacity="0.9" />
  </g>
</svg>
