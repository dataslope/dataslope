...
<Figure
  ...
  caption="`unique_ptr` allows exactly one owner, and moving is how ownership travels."
/>
...
<Figure
  ...
  caption="The pointer frees what it owns the moment the last owner lets go."
/>
