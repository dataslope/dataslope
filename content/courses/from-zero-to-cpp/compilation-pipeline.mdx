...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A shape descends through four canal locks, changing form at each yellow gate until it leaves as one solid green pill — source code stepping down through preprocessing, compiling, assembling, and linking"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="40" y="60" width="132" height="150" rx="6" fillOpacity="0.13" />
    <rect x="182" y="95" width="130" height="115" rx="6" fillOpacity="0.13" />
    <rect x="322" y="130" width="130" height="80" rx="6" fillOpacity="0.13" />
    <rect x="462" y="165" width="138" height="45" rx="6" fillOpacity="0.13" />
    <circle cx="100" cy="49" r="11" />
    <rect x="228" y="73" width="24" height="22" rx="6" fillOpacity="0.9" />
    <rect x="358" y="114" width="16" height="16" rx="4" fillOpacity="0.9" />
    <rect x="382" y="114" width="16" height="16" rx="4" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="172" y="50" width="10" height="160" rx="4" fillOpacity="0.8" />
    <rect x="312" y="86" width="10" height="124" rx="4" fillOpacity="0.8" />
    <rect x="452" y="122" width="10" height="88" rx="4" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="495" y="147" width="64" height="18" rx="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="140" cy="62" r="3" />
    <circle cx="160" cy="74" r="3" />
    <circle cx="282" cy="100" r="3" />
    <circle cx="302" cy="112" r="3" />
    <circle cx="420" cy="136" r="3" />
    <circle cx="442" cy="150" r="3" />
  </g>
</svg>
