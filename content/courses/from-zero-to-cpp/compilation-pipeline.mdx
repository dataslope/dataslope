...
<Figure
  slug="cpp-compilation-pipeline-cutout"
  alt="The compilation pipeline, an isometric illustration"
/>
...
<Figure
  slug="cpp-compilation-pipeline-inline-cutout"
  alt="A card passing through four machines and leaving as a running unit, each stage's output visibly different"
  caption="Source goes in one end and a runnable program comes out the other."
/>
...
<Figure
  slug="cpp-compilation-pipeline-step-1-preprocessor-inline-cutout"
  alt="A card passing a first machine that pastes extra strips onto it before it continues"
  caption="The preprocessor pastes in headers before the compiler sees anything."
/>
...
<Figure
  slug="cpp-compilation-pipeline-four-step-pipeline-inline-cutout"
  alt="A card passing through four machines in a row, leaving each visibly changed"
  caption="Each pass hands its output to the next, and only the last one emits assembly."
/>
