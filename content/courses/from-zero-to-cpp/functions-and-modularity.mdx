...
<Figure
  slug="cpp-functions-and-modularity-cutout"
  alt="Functions and modularity, an isometric illustration"
/>
...
<Figure
  slug="cpp-functions-and-modularity-anatomy-function-inline-cutout"
  alt="A machine in cross-section with its input opening, inner works and output chute all visible"
  caption="A function has an input, a body and a return, and only the middle is hidden."
/>
...
<Figure
  slug="cpp-functions-and-modularity-inline-cutout"
  alt="One large machine on the left drawn as a single welded lump, and the same machine on the right built from four separate boxes that unclip"
  caption="Four small parts that unclip beat one welded lump."
/>
