...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Four vessels on a shelf: a tray of dots in a row, a chain of linked beads, a branching tree of dots, and a grid of pigeonholes — each container shapes its costs differently"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="50" y="190" width="540" height="6" rx="3" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="70" y="150" width="110" height="34" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="88" cy="167" r="7" />
    <circle cx="112" cy="167" r="7" />
    <circle cx="136" cy="167" r="7" />
    <circle cx="160" cy="167" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="230" cy="166" r="8" />
    <circle cx="262" cy="166" r="8" />
    <circle cx="294" cy="166" r="8" />
    <rect x="240" y="163" width="14" height="6" rx="3" fillOpacity="0.5" />
    <rect x="272" y="163" width="14" height="6" rx="3" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="390" cy="118" r="8" />
    <circle cx="366" cy="150" r="7" />
    <circle cx="414" cy="150" r="7" />
    <circle cx="354" cy="180" r="5" />
    <circle cx="378" cy="180" r="5" />
    <circle cx="402" cy="180" r="5" />
    <circle cx="426" cy="180" r="5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="378" cy="134" r="2.5" />
    <circle cx="402" cy="134" r="2.5" />
    <circle cx="360" cy="165" r="2.5" />
    <circle cx="372" cy="165" r="2.5" />
    <circle cx="408" cy="165" r="2.5" />
    <circle cx="420" cy="165" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="480" y="138" width="24" height="24" rx="5" />
    <rect x="510" y="138" width="24" height="24" rx="5" />
    <rect x="540" y="138" width="24" height="24" rx="5" />
    <rect x="480" y="166" width="24" height="24" rx="5" />
    <rect x="510" y="166" width="24" height="24" rx="5" />
    <rect x="540" y="166" width="24" height="24" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="492" cy="150" r="6" />
    <circle cx="552" cy="178" r="6" />
  </g>
</svg>
