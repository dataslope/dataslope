...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A thin footpath forks at a yellow diamond: one branch arcs over the top, the other circles a small loop before both rejoin and reach a green flag — decisions and repetition along a program's single path"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M64 110 H 138" />
    <path d="M176 94 C 230 70, 328 68, 376 98" />
    <path d="M176 126 C 208 138, 234 146, 254 150" />
    <circle cx="286" cy="158" r="22" />
    <path d="M308 148 C 330 140, 352 126, 372 112" />
    <path d="M386 110 H 446" />
  </g>
