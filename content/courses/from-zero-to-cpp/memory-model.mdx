...
<Figure
  slug="cpp-memory-model-cutout"
  alt="The memory model, an isometric illustration"
/>
...
<Figure
  slug="cpp-memory-model-four-regions-one-inline-cutout"
...
<Figure
  slug="cpp-memory-model-inline-cutout"
  alt="One long strip running the width of the frame divided into three zones of different sizes, each zone a different flat color with its own kind of block resting in it"
  caption="Where a value lives decides who is responsible for freeing it."
/>
