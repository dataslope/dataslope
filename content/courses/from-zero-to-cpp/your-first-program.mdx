...
<Figure
  ...
  caption="Variables, input, a function and a loop: a whole program in miniature."
/>
...
<Figure
  slug="cpp-your-first-program-line-1-include-inline-cutout"
  alt="A short strip being pasted onto the top of a card before the card enters a machine"
  caption="`#include` pastes a header in before the compiler reads a single line."
/>
