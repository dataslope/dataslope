...
<Figure
  slug="cpp-constructors-and-destructors-destructor-releases-resources-inline-cutout"
  alt="A crate being emptied and folded flat as it leaves the bench, its tap closed behind it"
  caption="The destructor runs on the way out and hands back whatever was held."
/>
...
cleanup is what makes **RAII** (Resource Acquisition Is
Initialization) possible, the idea a later chapter is built on.
...
<Figure
  slug="cpp-constructors-and-destructors-inline-cutout"
  alt="A workbench where a crate is assembled and filled at the left, used in the middle, and emptied and folded flat at the right"
  caption="Constructed, used, destroyed: an object's whole life in one pass."
/>
...
<Figure
  slug="cpp-constructors-and-destructors-constructors-put-fields-inline-cutout"
  alt="A crate whose compartments are all filled before its lid will close, one empty compartment holding the lid open"
  caption="The constructor's job is to leave the object in a state its methods can trust."
/>
