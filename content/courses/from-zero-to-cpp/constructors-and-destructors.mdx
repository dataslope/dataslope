...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A green disc emerges from a yellow mold, travels along a thin line, then gently dissolves into smaller and fainter dots — a constructor builds the object and a destructor unmakes it at the end"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M180 105 H 270" />
    <path d="M330 105 H 400" />
  </g>
</svg>
