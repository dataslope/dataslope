...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A green disc emerges from a yellow mold, travels along a dotted line, then gently dissolves into smaller and fainter dots — a constructor builds the object and a destructor unmakes it at the end"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="70" y="48" width="100" height="30" rx="8" />
    <rect x="70" y="132" width="100" height="30" rx="8" />
    <rect x="60" y="48" width="24" height="114" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="150" cy="105" r="22" />
    <circle cx="300" cy="105" r="22" />
    <circle cx="430" cy="105" r="22" fillOpacity="0.45" />
    <circle cx="470" cy="90" r="5" fillOpacity="0.3" />
    <circle cx="488" cy="112" r="4" fillOpacity="0.25" />
    <circle cx="506" cy="95" r="3" fillOpacity="0.2" />
    <circle cx="522" cy="108" r="2.5" fillOpacity="0.15" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="200" cy="105" r="3" />
    <circle cx="228" cy="105" r="3" />
    <circle cx="256" cy="105" r="3" />
    <circle cx="344" cy="105" r="3" />
    <circle cx="368" cy="105" r="3" />
  </g>
</svg>
