...
<Figure
  slug="cpp-inheritance-polymorphism-cutout"
...
<Figure
  slug="cpp-inheritance-and-polymorphism-first-hierarchy-inline-cutout"
  alt="One base cabinet with two cabinets standing behind it, each keeping the base frame and adding one part"
  caption="A derived class keeps the base frame and adds or refines one part."
/>
...
<Figure
  slug="cpp-inheritance-and-polymorphism-inline-cutout"
  alt="One plain base cabinet at the left, and to its right three cabinets built on the same frame with a different top fitted to each"
  caption="Inheritance says is-a; composition says has-a, and it is often the better fit."
/>
