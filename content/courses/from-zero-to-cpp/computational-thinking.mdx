...
<Figure
  slug="cpp-computational-thinking-computational-thinking-inline-cutout"
  alt="A working machine with its casing lowered over it so only its handle and chute remain visible"
  caption="Abstraction hides the works and leaves you the handle and the chute."
/>
