...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Four quadrants: a block split into small pieces, two matching circles highlighted around an odd triangle, a noisy cluster reduced to one clean circle, and numbered steps in a row, the four ingredients of computational thinking"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="318" y="24" width="4" height="192" rx="2" />
    <rect x="60" y="118" width="520" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="84" y="40" width="52" height="52" rx="10" />
    <rect x="160" y="40" width="22" height="22" rx="6" fillOpacity="0.55" />
    <rect x="188" y="40" width="22" height="22" rx="6" fillOpacity="0.55" />
    <rect x="160" y="68" width="22" height="22" rx="6" fillOpacity="0.55" />
    <rect x="188" y="68" width="22" height="22" rx="6" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="408" cy="65" r="13" />
    <circle cx="552" cy="65" r="13" />
    <circle cx="408" cy="90" r="3" fillOpacity="0.6" />
    <circle cx="552" cy="90" r="3" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <polygon points="468,78 480,52 492,78" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="96" cy="168" r="7" />
    <circle cx="114" cy="186" r="6" />
    <circle cx="102" cy="200" r="5" />
    <circle cx="126" cy="166" r="5" />
    <circle cx="130" cy="196" r="4" />
    <circle cx="160" cy="182" r="3" />
    <circle cx="180" cy="182" r="3" />
    <circle cx="446" cy="182" r="2.5" />
    <circle cx="454" cy="182" r="2.5" />
    <circle cx="506" cy="182" r="2.5" />
    <circle cx="514" cy="182" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="224" cy="182" r="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="420" cy="182" r="13" />
