...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A blue CPU disc exchanges thin read and write arrows with a column of memory pills while clock ticks pulse beneath it — processor, memory, and the beat that drives them"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      ...
      strokeLinecap="round"
    />
    <polygon points="362,70 362,86 378,78" fill="currentColor" />
    <path
      d="M378 132 H 294"
      fill="none"
      stroke="currentColor"
      ...
      strokeLinecap="round"
    />
    <polygon points="294,124 294,140 278,132" fill="currentColor" />
  </g>
