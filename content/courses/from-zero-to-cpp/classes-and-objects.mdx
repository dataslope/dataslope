...
<Figure
  slug="cpp-classes-and-objects-from-struct-class-inline-cutout"
  alt="An open compartmented tray beside the same tray with a hinged lid and two handles fitted to it"
  caption="A class adds a lid: the interface is public, the state behind it is not."
/>
...
<Figure
  slug="cpp-classes-and-objects-anatomy-class-inline-cutout"
  alt="A cabinet shown in cross-section, its inner compartments hidden behind a front panel carrying two handles"
  caption="The class is the description; an object is one thing built to it."
/>
