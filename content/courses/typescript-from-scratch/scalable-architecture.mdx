...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A temple in cross-section: the yellow roof of infrastructure rests on blue application columns standing on a deep green domain foundation; one column is only a dashed outline, a port, with its solid green implementation sliding in from the side along a thin arrow, layers depend downward and the foundation knows nothing above it"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="386,151 398,145 398,157" />
  </g>
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="Three thin blue lines pour from separate export dots into one gray barrel with a single tap, and one solid green line with an arrowhead flows out, a barrel file gathers a module's public surface into one import path and keeps internals inside"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M88 44 C 150 52, 190 66, 232 78" />
    <path d="M88 90 H 232" />
    <path d="M88 136 C 150 128, 190 114, 232 102" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="80" cy="44" r="7" />
    <circle cx="80" cy="90" r="7" />
    <circle cx="80" cy="136" r="7" />
  </g>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M392 89 H 508" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="522,89 508,82 508,96" />
  </g>
</svg>
