...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three very different shapes all connect to the same rail through an identical small plug, while a red shape with no plug sits apart beneath a red cross — a constraint admits any type as long as it brings the required part"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="80" y="60" width="380" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="136" y="76" width="8" height="26" rx="3" />
    <rect x="246" y="76" width="8" height="26" rx="3" />
    <rect x="344" y="76" width="8" height="26" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="122" r="20" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="230" y="102" width="40" height="40" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="330" y="102" width="36" height="62" rx="10" />
  </g>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M528 96 L 552 120" />
    <path d="M552 96 L 528 120" />
  </g>
</svg>
