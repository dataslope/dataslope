...
<Figure
  ...
  caption="A union covers either set; an intersection covers only where they overlap."
/>
...
<Figure
  ...
  caption="A value of a union type may be any one member, so only shared operations are safe."
/>
