...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Five colored property squares pass through one wide blue transform bar: each comes out below wearing a small white badge, and the last thread simply stops at the bar, a mapped type transforms every property uniformly and can drop keys as it goes"
...
>
  ...
  >
    ...
    <path d="M393 66 V 96" />
    <path d="M473 66 V 96" />
    <path d="M153 136 V 148" />
    <path d="M233 136 V 148" />
    <path d="M313 136 V 148" />
    <path d="M393 136 V 148" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="40" width="26" height="26" rx="6" />
    <rect x="380" y="40" width="26" height="26" rx="6" />
    <rect x="110" y="100" width="420" height="32" rx="16" />
    <rect x="140" y="152" width="26" height="26" rx="6" />
    <rect x="380" y="152" width="26" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="220" y="40" width="26" height="26" rx="6" />
    <rect x="460" y="40" width="26" height="26" rx="6" />
    <rect x="220" y="152" width="26" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="40" width="26" height="26" rx="6" />
    <rect x="300" y="152" width="26" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="166" cy="152" r="5" />
    <circle cx="246" cy="152" r="5" />
    <circle cx="326" cy="152" r="5" />
    <circle cx="406" cy="152" r="5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A rail reaches a blue gate with a diamond window and splits in two: the small yellow diamond that fits the window rides the upper branch toward the green terminal, while the lower branch leads to the yellow terminal, a conditional type picks one of two branches with an extends test"
...
>
  ...
  >
    <path d="M60 95 H 216" />
    <path d="M297 95 C 340 78, 390 60, 443.6 47.2" />
    <path d="M297 95 C 340 112, 390 130, 443.6 142.8" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="443.6,53 452,44 439.8,42.7" />
    <polygon points="439.8,147.3 452,146 443.6,137" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M360 54 L370 64 L360 74 L350 64 Z" />
    <rect x="470" y="128" width="26" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="486" cy="40" r="13" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="A small gray crane grips the green pearl it has just lifted out of a blue capsule, leaving a hollow white ring behind, infer names the type packed inside a wrapper so you can carry it away"
  style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="90" width="150" height="54" rx="27" />
  </g>
  <g style={{ color: "var(--ds-white)" }}>
    <circle cx="215" cy="117" r="12" fill="none" stroke="currentColor" strokeWidth="4" />
  </g>
  <g
    style={{ color: "var(--ds-gray-400)" }}
    fill="none"
  ...
  >
    <path d="M420 12 V 50" />
    <path d="M404 54 C 400 72, 408 86, 418 92" />
    <path d="M436 54 C 440 72, 432 86, 422 92" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="402" y="48" width="36" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="420" cy="80" r="13" />
  </g>
</svg>
