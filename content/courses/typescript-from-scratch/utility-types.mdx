...
<Figure
  slug="tsx-utility-types-cutout"
  alt="A rack of six labelled ready-made transformer blocks on a platform, one lifted out and opened to show simpler parts inside"
/>
...
<Figure
  slug="tsx-utility-types-object-transformation-utilities-inline-cutout"
  alt="One crate passing through three presses that leave it partial, then sealed, then narrower"
  caption="The utility types are ready-made presses for the reshapings you keep needing."
/>
...
<Figure
  slug="tsx-utility-types-inline-cutout"
  alt="One crate passing through three small presses that make it partial, then read-only, then narrower, each leaving a visibly changed crate"
  caption="`Partial`, `Readonly` and `Pick` each hand back a changed version of a type."
/>
