...
<Figure
  slug="tsx-aliases-literals-cutout"
  alt="A blank name plate attached to a shape template beside a socket that accepts only one single exact token"
/>
...
<Figure
  slug="tsx-type-aliases-and-literals-inline-cutout"
  alt="A socket cut to accept one exact block and nothing else, three near-identical blocks refused beside it"
  caption="A literal type accepts one exact value and refuses every neighbour."
/>
...
<Figure
  slug="tsx-type-aliases-and-literals-type-aliases-naming-inline-cutout"
  alt="A blank name plate being clipped onto a shaped socket that already existed"
  caption="An alias is a name for a type that already exists, not a new type."
/>
