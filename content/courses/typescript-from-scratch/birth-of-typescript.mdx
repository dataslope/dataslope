...
<Figure
  slug="tsx-birth-of-typescript-early-experiments-inline-cutout"
  alt="Several part-built gates on a bench, each a different attempt at checking the same block"
  caption="Several attempts at typing JavaScript came before the one that stuck."
/>
...
<Figure
  slug="tsx-birth-of-typescript-design-constraints-inline-cutout"
  alt="A new gate being built that must still let every existing card through unchanged"
  caption="The hard constraint: every existing JavaScript program had to keep working."
/>
...
Adoption didn't explode overnight. In 2013 and 2014, TypeScript was a curiosity. Most JavaScript developers stuck with plain JavaScript or Closure Compiler. Flow launched in 2014 and briefly looked like it might win the "types for JavaScript" race, it was backed by Facebook, used in React Native, and felt lighter-weight.
...
<Figure
  slug="tsx-birth-typescript-team-cutout"
  alt="A leaning stack of loose sheets clamped square by a bracket and marked with three coloured tabs"
  caption="Microsoft, 2010: types for a language already deployed everywhere, so it had to extend rather than replace."
/>
