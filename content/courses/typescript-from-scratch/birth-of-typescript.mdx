...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A green outlined region encloses the solid blue JavaScript region whole, adding its own green blocks in the margin while every blue block stays in place, TypeScript as a strict superset that leaves everything where it was"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="200" y="70" width="240" height="90" rx="14" fillOpacity="0.25" />
    <rect x="228" y="93" width="30" height="20" rx="5" />
    <rect x="280" y="108" width="32" height="18" rx="5" />
    <rect x="330" y="88" width="24" height="24" rx="5" />
    <rect x="382" y="104" width="28" height="18" rx="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="148" y="54" width="20" height="20" rx="5" />
    <rect x="470" y="58" width="20" height="20" rx="5" />
    <rect x="150" y="146" width="20" height="20" rx="5" />
    <rect x="468" y="142" width="20" height="20" rx="5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three lanes race toward a finish flag: the yellow and red lines stop partway while the blue line runs all the way to the pole, earlier attempts at typing JavaScript pointed the way, and TypeScript reached the top"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="540,36 574,46 540,56" />
  </g>
</svg>
