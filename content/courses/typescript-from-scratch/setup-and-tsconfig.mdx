...
<Figure
  slug="tsx-setup-tsconfig-cutout"
  alt="A control panel of strictness toggles on a platform, most switches flipped to their tightest position"
/>
...
<Figure
  slug="tsx-setup-and-tsconfig-essential-compiler-options-inline-cutout"
  alt="A panel of switches where throwing the leftmost one flips several of the switches beside it at the same moment"
  caption="Turning on `strict` turns on every individual check that it stands for."
/>
...
<Figure
  slug="tsx-setup-and-tsconfig-installing-typescript-inline-cutout"
  alt="A new tool being clipped onto a bench rail before any work begins"
  caption="`tsconfig.json` is the settings the compiler reads before it does anything."
/>
...
<Figure
  slug="tsx-setup-and-tsconfig-use-strict-mode-always-inline-cutout"
  alt="A gate that stops a questionable part at the entrance rather than letting it through to be found at the far end"
  caption="Strict mode costs a few annotations and buys the errors at the entrance instead of at runtime."
/>
