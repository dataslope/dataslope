...
<Figure
  slug="tsx-next-steps-cutout"
  alt="The Dataslope marmot mascot on a platform beside a typed block assembly and a signpost with four arrows pointing outward"
/>
...
## Choosing a Framework (If You're Building Interfaces)

TypeScript shines in interface development, where the shape of data and component props matters. If you want to build web applications, pick a framework:
