...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A rail turntable seen from above: inside the gray ring, the blue bridge is swung into position with a green engine riding it, the course ends at a junction where you choose the next line"
