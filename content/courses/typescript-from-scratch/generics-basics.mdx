...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A queue of shapes waits at a gray machine marked with angle brackets: the blue triangle that goes in comes out the other side exactly the same shape — one generic mechanism works for any type without forgetting which one it was given"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M238 114 H 258" />
    <path d="M378 114 H 398" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="270,114 258,108 258,120" />
    <polygon points="410,114 398,108 398,120" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="276" y="70" width="88" height="88" rx="14" />
  </g>
  <g
  ...
  >
    <path d="M306 96 L 294 114 L 306 132" />
    <path d="M334 96 L 346 114 L 334 132" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="90" cy="114" r="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="134" y="102" width="24" height="24" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="196,127 210,101 224,127" />
    <polygon points="426,127 440,101 454,127" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Two runs of the same gray capsule: a blue circle enters and a blue thread runs through to a blue circle on the far side, while a yellow square enters below and a yellow thread ties it to a yellow square — the type parameter threads the output type to the input type"
