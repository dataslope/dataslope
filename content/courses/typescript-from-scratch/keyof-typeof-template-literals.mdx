...
<Figure
  ...
  caption="`typeof` traces the type of a value you already have."
/>
...
<Figure
  ...
  caption="The keys come off as their own union, separate from the values behind them."
/>
...
<Figure
  ...
  caption="`keyof` gives the property names, and mapping over them can filter which survive."
/>
