...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="339,115.5 350,110 339,104.5" />
  </g>
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }}>
    ...
    />
    <path
      d="M288 126 C 330 100, 342 78, 363.6 50.4"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="366.1,55.7 370,44 358.3,47.9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <path d="M338 84 L358 84 A12 12 0 0 1 358 108 L341 110 Z" />
