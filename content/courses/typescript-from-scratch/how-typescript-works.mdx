...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Twin block towers: the left one is wrapped in green scaffolding, the right one stands identical but bare beside a yellow play button, joined by a thin arrow — types support the build, then erase completely before the code runs"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="90" y="190" width="470" height="5" rx="2.5" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M262 128 H 340" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="354,128 340,121 340,135" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="540,155 562,168 540,181" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="One continuous gray strip of source text is marked with white cut lines, and below it the same strip has been chopped into separate colored token chips — the scanner turning raw characters into discrete tokens"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="100" y="40" width="440" height="22" rx="11" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="180" y="38" width="4" height="26" rx="2" />
    <rect x="260" y="38" width="4" height="26" rx="2" />
    <rect x="340" y="38" width="4" height="26" rx="2" />
    <rect x="420" y="38" width="4" height="26" rx="2" />
  </g>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="320,106 313,94 327,94" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="120" width="70" height="22" rx="11" />
    <rect x="342" y="120" width="50" height="22" rx="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="186" y="120" width="58" height="22" rx="11" />
    <rect x="408" y="120" width="62" height="22" rx="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="260" y="120" width="66" height="22" rx="11" />
    <rect x="486" y="120" width="54" height="22" rx="11" />
  </g>
</svg>
