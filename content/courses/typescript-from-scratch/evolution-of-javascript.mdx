...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Geological cross-section: blue sediment layers laid down era by era thicken into a tall wedge, JavaScript growing far beyond its scripting-toy origins"
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="The blue function bar has grown a third yellow socket, but each gray caller card below still supplies only two blue pins, with the empty third slot ringed in red, call sites silently broken by a signature change"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="220" y="24" width="200" height="40" rx="12" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="262" cy="44" r="7" />
    <circle cx="312" cy="44" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="366" cy="44" r="8" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="90" y="110" width="120" height="44" rx="10" />
    <rect x="260" y="110" width="120" height="44" rx="10" />
    <rect x="430" y="110" width="120" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="132" r="6" />
    <circle cx="148" cy="132" r="6" />
    <circle cx="290" cy="132" r="6" />
    <circle cx="318" cy="132" r="6" />
    <circle cx="460" cy="132" r="6" />
    <circle cx="488" cy="132" r="6" />
  </g>
  <g
    ...
    strokeWidth="2.5"
  >
    <circle cx="180" cy="132" r="6.5" />
    <circle cx="350" cy="132" r="6.5" />
    <circle cx="520" cy="132" r="6.5" />
  </g>
</svg>
