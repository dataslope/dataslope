...
## The first decade: scripting toy to document-model workhorse
...
<Figure
  slug="tsx-evolution-of-javascript-first-decade-scripting-inline-cutout"
  alt="A small hand tool on a bench beside the same tool grown into a full machine"
  caption="A language written for small scripts ended up carrying whole applications."
/>
...
<Figure
  slug="tsx-evolution-of-javascript-maintainability-crisis-inline-cutout"
  alt="A tidy frame on one bench and the same frame on the next after many additions, cords crossing everywhere"
  caption="The same flexibility that made JavaScript easy made large codebases hard."
/>
