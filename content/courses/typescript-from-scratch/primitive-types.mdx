...
<Figure
  slug="tsx-primitive-types-type-inference-vs-inline-cutout"
  alt="A socket closing around a block to take its shape beside a socket cut to a stated shape beforehand"
  caption="Inference takes the shape from the value; an annotation states it up front."
/>
...
<Figure
  slug="tsx-primitive-types-seven-primitive-types-inline-cutout"
  alt="Seven small blocks of clearly different kinds resting in their own moulded recesses"
  caption="Seven primitives, each with its own set of values and its own operations."
/>
...
<Figure
  ...
  caption="A type stops the wrong kind of value long before the program runs."
/>
