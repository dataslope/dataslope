...
<Figure
  ...
  caption="An interface names a shape, so the same contract can be reused and read."
/>
...
<Figure
  slug="tsx-objects-and-interfaces-optional-properties-inline-cutout"
  alt="A compartmented case where two compartments carry hinged covers that may be left closed"
  caption="An optional property may be absent, so the type includes `undefined`."
/>
...
<Figure
  slug="tsx-objects-and-interfaces-object-type-literals-inline-cutout"
  alt="A contract card showing a panel of shaped sockets held beside the crate that matches it"
  caption="The type describes the shape; anything with that shape satisfies it."
/>
