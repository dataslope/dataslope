...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="On a small shadow board two outlines hold their green and blue tools while a third spot simply stays empty and raises no alarm — optional properties may be filled or left absent"
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A wall of identical pigeonholes accepts only green discs: one green-tinted slot is reserved by name, several wait empty, and a red triangle hovering outside fits none — an index signature gives every key the same value type"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M212 90 L 276 122" />
    <path d="M428 90 L 364 122" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
