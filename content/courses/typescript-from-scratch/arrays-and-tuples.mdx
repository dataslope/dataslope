...
<Figure
  slug="tsx-arrays-tuples-cutout"
  alt="A long tray of identical sockets beside a short fixed tray whose three sockets each have a different shape"
/>
...
<Figure
  slug="tsx-arrays-and-tuples-array-types-homogeneous-inline-cutout"
  alt="A rail holding any number of blocks that are all the same shape"
  caption="An array holds any number of values, all of the same type."
/>
...
<Figure
  slug="tsx-arrays-and-tuples-type-inference-arrays-inline-cutout"
  alt="An empty rail closing around the first blocks set on it to admit only that shape after"
  caption="The compiler reads the element type from what you first put in."
/>
...
<Figure
  slug="tsx-arrays-and-tuples-inline-cutout"
  alt="A rail that takes any number of identical blocks beside a fixed strip with three shaped slots in a set order"
  caption="An array varies in length; a tuple fixes both length and the type of each slot."
/>
