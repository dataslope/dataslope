...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Two completely different builds, one stacked from blocks, one molded in a single piece, leave exactly the same notched footprint, joined by a thin double-headed arrow, while a third object's plain footprint matches nothing, the compiler compares the shapes things cast, not what they are called"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M222 204 H 390" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="210,204 224,198 224,210" />
    <polygon points="402,204 388,198 388,210" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="548" y="158" width="52" height="32" rx="6" />
    <path d="M544 198 L606 198 L606 210 L544 210 Z" fillOpacity="0.35" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="The same green parcel with a yellow ribbon takes two journeys: handed straight to the blue portal it is stopped by a red bar, but after first resting on a gray pallet it passes through and earns a check, fresh object literals get strict excess-property checks while stored variables do not"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M194 70 H 386" />
    <path d="M154 150 H 218" />
    <path d="M300 150 H 400" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="398,70 386,64 386,76" />
    <polygon points="230,150 218,144 218,156" />
    <polygon points="412,150 400,144 400,156" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="150" y="52" width="36" height="36" rx="6" />
    <rect x="110" y="132" width="36" height="36" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="150" y="64" width="36" height="8" rx="4" />
    <rect x="110" y="144" width="36" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="240" y="140" width="52" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="408" y="48" width="6" height="44" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }}>
    <circle cx="452" cy="70" r="24" fill="none" stroke="currentColor" strokeWidth="7" />
    <circle cx="452" cy="150" r="24" fill="none" stroke="currentColor" strokeWidth="7" />
  </g>
  <g
  ...
  >
    <path d="M498 150 L 508 160 L 526 134" />
  </g>
</svg>
