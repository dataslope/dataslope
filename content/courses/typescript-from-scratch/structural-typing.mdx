...
<Figure
  slug="tsx-structural-typing-shape-based-compatibility-inline-cutout"
  alt="Two plugs with identical pins from different makers, both seating in the same socket"
  caption="The same shape from a different source still fits, because names do not count."
/>
...
<Figure
  slug="tsx-structural-typing-inline-cutout"
  alt="Two differently coloured plugs with identical pin patterns, both fitting the same socket"
  caption="Two types match if their shapes match, whatever they are called."
/>
