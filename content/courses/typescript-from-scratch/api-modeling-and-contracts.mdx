...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A blue module and a green module each point a thin arrow into the same yellow contract capsule between them, beneath a small green check, a shared type contract makes both sides meet exactly"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M234 105 H 264" />
    <path d="M406 105 H 376" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="276,105 264,99 264,111" />
    <polygon points="364,105 376,99 376,111" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="80" width="140" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="410" y="80" width="140" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="280" y="88" width="80" height="34" rx="17" />
  </g>
  <g
  ...
  >
    <path d="M306 52 L 316 62 L 334 36" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Two identical envelopes differ only in the seal at the tip of the flap: one sealed green, one sealed red, a single generic envelope wraps every response with a success-or-error status the caller must inspect"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="120" y="50" width="170" height="90" rx="10" />
    <rect x="350" y="50" width="170" height="90" rx="10" />
  </g>
  <g
    style={{ color: "var(--ds-gray-400)" }}
    fill="none"
    ...
    strokeLinejoin="round"
  >
    <path d="M122 54 L 205 106 L 288 54" />
    <path d="M352 54 L 435 106 L 518 54" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="205" cy="106" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="435" cy="106" r="9" />
  </g>
</svg>
