...
<Figure
  slug="tsx-branded-types-problem-structural-typing-inline-cutout"
  alt="Two blocks of exactly the same shape sitting in each other's sockets without complaint"
  caption="Structural typing means same shape, same type, however different the meaning."
/>
...
<Figure
  slug="tsx-branded-types-solution-branding-phantom-inline-cutout"
  alt="Two identical blocks, one carrying a small stamped mark, only the marked one accepted by the slot"
  caption="A brand exists only in the type, and it is what makes two numbers different."
/>
...
<Figure
  slug="tsx-branded-types-inline-cutout"
  alt="Two blocks of the same shape, one carrying a small stamped mark, only the marked one accepted by the slot"
  caption="Only the stamped value is accepted, even though both are numbers at runtime."
/>
