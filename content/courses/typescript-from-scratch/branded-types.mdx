...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two identical blue cards differ only by the small tag on their corner: the green-tagged card's arrow passes the gate and earns a check, while the yellow-tagged one is stopped with a red cross, a brand makes look-alike values distinguishable to the checker"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M262 80 H 442" />
    <path d="M262 165 H 414" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="456,80 442,73 442,87" />
    <polygon points="428,165 414,158 414,172" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="466" y="40" width="14" height="150" rx="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="55" width="130" height="50" rx="10" />
    <rect x="120" y="140" width="130" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="238" y="45" width="20" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="238" y="130" width="20" height="20" rx="5" />
  </g>
  <g
  ...
  >
    <path d="M498 80 L 508 90 L 526 64" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M498 153 L 522 177" />
    <path d="M522 153 L 498 177" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Plain blue values ride a conveyor into a yellow stamping press: the one that passes leaves wearing a small green seal, while a bad one drops off below in red, a smart constructor validates first and only then applies the brand"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="60" y="100" width="520" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="288" y="24" width="64" height="18" rx="6" />
    <rect x="310" y="42" width="20" height="34" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="110" cy="86" r="13" />
    <circle cx="180" cy="86" r="13" />
    <circle cx="470" cy="86" r="13" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="480" cy="74" r="6" />
  </g>
