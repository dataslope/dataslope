...
<svg
  viewBox="0 0 640 260"
  role="img"
  aria-label="A mixed batch of shapes falls through two sieve trays: the green triangle and red pentagon rest on the first, the yellow square is caught by the second, and only the blue circle reaches the cup at the bottom — each type guard lets fewer possibilities through"
...
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="140" y="90" width="80" height="10" rx="5" />
    <rect x="260" y="90" width="90" height="10" rx="5" />
    <rect x="390" y="90" width="110" height="10" rx="5" />
    <rect x="140" y="170" width="100" height="10" rx="5" />
    <rect x="280" y="170" width="70" height="10" rx="5" />
    <rect x="410" y="170" width="90" height="10" rx="5" />
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="Shapes ride a belt beneath a gray magnifying lens: the circle past the lens emerges wearing a green certification ring while squares pass unmarked — a user-defined type predicate teaches the compiler which values to trust as the narrowed type"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <circle cx="300" cy="98" r="27" />
    <path d="M320 118 L 344 142" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }}>
    <circle cx="430" cy="107" r="16" fill="none" stroke="currentColor" strokeWidth="4" />
  </g>
</svg>
