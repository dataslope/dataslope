...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three shapes standing in low sunlight cast their exact silhouettes onto the ground without anyone drawing them, and one square additionally wears a dashed hand-drawn outline — the compiler infers a type from each value, and annotations are simply drawn on top"
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="A gray jar holds blue circles and a yellow square, and its lid label shows one small chip of each kind; a green triangle standing outside appears nowhere on the label — the inferred element type is the union of exactly what the array was given"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="262" y="38" width="116" height="20" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="290" cy="128" r="13" />
    <circle cx="352" cy="132" r="12" />
    <circle cx="306" cy="48" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="320" y="100" width="26" height="26" rx="5" />
    <rect x="326" y="42" width="12" height="12" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
