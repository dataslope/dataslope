...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="Two corridors: in the top one the blue path drops through a hidden gap in the floor to a red cross below, while in the bottom one the path forks openly into a green success box and a red failure box, exceptions hide failure in the floor, Result puts both outcomes in plain sight"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="80" y="80" width="200" height="5" rx="2.5" />
    <rect x="320" y="80" width="160" height="5" rx="2.5" />
    <rect x="80" y="190" width="200" height="5" rx="2.5" />
  </g>
  <g
  ...
  >
    <path d="M100 68 H 296 V 118" />
    <path d="M100 178 H 300" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M300 178 C 350 168, 385 160, 430 152" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M300 178 C 350 188, 385 198, 430 206" />
    <path d="M286 132 L 306 152" />
    <path d="M306 132 L 286 152" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="438" y="138" width="46" height="28" rx="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="438" y="192" width="46" height="28" rx="8" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A green line threads the first two blue stations on the success rail, then turns red mid-chain and slides down a bypass past the last station straight to the red exit ring, andThen short-circuits the rest of the chain on the first failure"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M300 70 C 340 80, 370 110, 400 130 C 440 156, 500 150, 546 150" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="50" width="80" height="40" rx="12" />
    <rect x="260" y="50" width="80" height="40" rx="12" fillOpacity="0.45" />
    <rect x="420" y="50" width="80" height="40" rx="12" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="62" cy="70" r="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }}>
    <circle cx="562" cy="150" r="10" fill="none" stroke="currentColor" strokeWidth="4" />
  </g>
</svg>
