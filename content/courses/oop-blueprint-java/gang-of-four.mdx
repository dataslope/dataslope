...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three tinted panels from different domains each hold the same three-dot structure joined by thin solid lines, and in the last panel a yellow ring finally circles it, recurring design solutions appearing everywhere, waiting to be named"
...
>
  ...
  <g stroke="var(--ds-gray-400)" strokeWidth="2">
    <line x1="125" y1="74" x2="95" y2="124" />
    <line x1="125" y1="74" x2="155" y2="124" />
    <line x1="320" y1="74" x2="290" y2="124" />
    <line x1="320" y1="74" x2="350" y2="124" />
    <line x1="515" y1="74" x2="485" y2="124" />
    <line x1="515" y1="74" x2="545" y2="124" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="125" cy="68" r="6" />
    <circle cx="95" cy="130" r="6" />
    <circle cx="155" cy="130" r="6" />
    <circle cx="320" cy="68" r="6" />
    <circle cx="290" cy="130" r="6" />
    <circle cx="350" cy="130" r="6" />
    <circle cx="515" cy="68" r="6" />
    <circle cx="485" cy="130" r="6" />
    <circle cx="545" cy="130" r="6" />
  </g>
  <circle cx="515" cy="100" r="48" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" />
</svg>
