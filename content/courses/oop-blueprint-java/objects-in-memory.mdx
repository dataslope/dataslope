...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three blue reference pills in a stack strip send thin lines toward a heap card: two lines meet the same green object, and the third stops at a dashed ring crossed in red, references can share one object or point to null"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.06">
    <rect x="70" y="40" width="120" height="150" rx="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="298" y="32" width="282" height="166" rx="18" fillOpacity="0.08" />
  </g>
  <g stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round">
    <line x1="162" y1="71" x2="384" y2="88" />
    <line x1="162" y1="113" x2="385" y2="92" />
    <line x1="162" y1="155" x2="248" y2="155" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="98" y="62" width="64" height="18" rx="9" />
    <rect x="98" y="104" width="64" height="18" rx="9" />
    <rect x="98" y="146" width="64" height="18" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="410" cy="90" r="26" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="480" y="122" width="58" height="54" rx="12" />
  </g>
  <circle cx="270" cy="155" r="11" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="4 4" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="254" y="152.5" width="32" height="5" rx="2.5" transform="rotate(-40 270 155)" />
  </g>
</svg>
