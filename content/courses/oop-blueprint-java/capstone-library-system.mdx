...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A shelf of colored book spines connects by a thin line carrying a yellow loan tag to a member card with a blue person and detail bars — the capstone library system, where books, members, and loans interlock"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="233" y1="76" x2="420" y2="100" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="36" width="260" height="160" rx="12" fillOpacity="0.1" />
    <rect x="92" y="76" width="26" height="90" rx="4" />
    <rect x="188" y="90" width="26" height="76" rx="4" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="124" y="86" width="26" height="80" rx="4" />
    <rect x="252" y="92" width="26" height="74" rx="4" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="156" y="70" width="26" height="96" rx="4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="220" y="80" width="26" height="86" rx="4" />
  </g>
  <rect x="78" y="166" width="224" height="4" rx="2" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="78" width="54" height="18" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="420" y="60" width="170" height="110" rx="12" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="460" cy="98" r="12" />
    <rect x="438" y="116" width="44" height="26" rx="13" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="496" y="96" width="70" height="9" rx="4.5" />
    <rect x="496" y="114" width="52" height="9" rx="4.5" />
  </g>
</svg>
