...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A dotted line feeds three meshing gears of different sizes and colors — the capstone library system, where every class from the course interlocks into one working machine"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <circle cx="110" cy="120" r="3.5" />
    <circle cx="150" cy="117" r="3.5" />
    <circle cx="190" cy="113" r="3.5" />
    <circle cx="225" cy="109" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="302" y="35" width="16" height="20" rx="4" />
    <rect x="302" y="155" width="16" height="20" rx="4" />
    <rect x="238" y="97" width="20" height="16" rx="4" />
    <rect x="362" y="97" width="20" height="16" rx="4" />
    <g transform="rotate(45 310 105)">
      <rect x="302" y="35" width="16" height="20" rx="4" />
      <rect x="302" y="155" width="16" height="20" rx="4" />
      <rect x="238" y="97" width="20" height="16" rx="4" />
      <rect x="362" y="97" width="20" height="16" rx="4" />
    </g>
    <circle cx="310" cy="105" r="52" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="422" y="96" width="16" height="14" rx="4" />
    <rect x="422" y="190" width="16" height="14" rx="4" />
    <rect x="376" y="142" width="14" height="16" rx="4" />
    <rect x="470" y="142" width="14" height="16" rx="4" />
    <g transform="rotate(45 430 150)">
      <rect x="422" y="96" width="16" height="14" rx="4" />
      <rect x="422" y="190" width="16" height="14" rx="4" />
      <rect x="376" y="142" width="14" height="16" rx="4" />
      <rect x="470" y="142" width="14" height="16" rx="4" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="512" y="52" width="16" height="12" rx="4" />
    <rect x="512" y="132" width="16" height="12" rx="4" />
    <rect x="474" y="90" width="12" height="16" rx="4" />
    <rect x="554" y="90" width="12" height="16" rx="4" />
    <g transform="rotate(45 520 98)">
      <rect x="512" y="52" width="16" height="12" rx="4" />
      <rect x="512" y="132" width="16" height="12" rx="4" />
      <rect x="474" y="90" width="12" height="16" rx="4" />
      <rect x="554" y="90" width="12" height="16" rx="4" />
    </g>
    <circle cx="520" cy="98" r="34" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="310" cy="105" r="9" fillOpacity="0.9" />
    <circle cx="430" cy="150" r="8" fillOpacity="0.9" />
    <circle cx="520" cy="98" r="7" fillOpacity="0.9" />
  </g>
</svg>
