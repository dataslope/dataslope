...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One large green ring emblem joined by thin lines to a light green circle, square, and triangle that each wear a small copy of it, an interface as a capability badge worn by otherwise unrelated classes"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path fillRule="evenodd" d="M294,52 a26,26 0 1 0 52,0 a26,26 0 1 0 -52,0 M305,52 a15,15 0 1 0 30,0 a15,15 0 1 0 -30,0" />
    <circle cx="320" cy="52" r="6" />
  </g>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="293" y1="69" x2="196" y2="130" />
    <line x1="320" y1="84" x2="320" y2="110" />
    <line x1="348" y1="67" x2="460" y2="129" />
  </g>
  <g style={{ color: "var(--ds-green-300)" }} fill="currentColor">
    <circle cx="160" cy="152" r="36" />
    <rect x="284" y="116" width="72" height="72" rx="14" />
    <polygon points="480,116 444,188 516,188" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path fillRule="evenodd" d="M150,152 a10,10 0 1 0 20,0 a10,10 0 1 0 -20,0 M154.5,152 a5.5,5.5 0 1 0 11,0 a5.5,5.5 0 1 0 -11,0" />
    <circle cx="160" cy="152" r="3" />
    <path fillRule="evenodd" d="M310,152 a10,10 0 1 0 20,0 a10,10 0 1 0 -20,0 M314.5,152 a5.5,5.5 0 1 0 11,0 a5.5,5.5 0 1 0 -11,0" />
    <circle cx="320" cy="152" r="3" />
    <path fillRule="evenodd" d="M470,170 a10,10 0 1 0 20,0 a10,10 0 1 0 -20,0 M474.5,170 a5.5,5.5 0 1 0 11,0 a5.5,5.5 0 1 0 -11,0" />
