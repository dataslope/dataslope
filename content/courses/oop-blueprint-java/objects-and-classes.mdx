...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A stencil sheet with a circular cut-out beside three solid circles printed from it, each carrying its own small state dot — the class is the description, objects are the things built from it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path fillRule="evenodd" fillOpacity="0.18" d="M86,40 h188 a16,16 0 0 1 16,16 v108 a16,16 0 0 1 -16,16 h-188 a16,16 0 0 1 -16,-16 v-108 a16,16 0 0 1 16,-16 z M146,110 a34,34 0 1 0 68,0 a34,34 0 1 0 -68,0" />
  </g>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="310" cy="108" r="3" />
    <circle cx="334" cy="118" r="3" />
    <circle cx="356" cy="130" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="390" cy="148" r="24" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="458" cy="148" r="24" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="526" cy="148" r="24" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="384" cy="142" r="4" fillOpacity="0.85" />
    <circle cx="464" cy="154" r="4" fillOpacity="0.85" />
    <circle cx="520" cy="142" r="4" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="352" y="182" width="212" height="4" rx="2" />
  </g>
</svg>
