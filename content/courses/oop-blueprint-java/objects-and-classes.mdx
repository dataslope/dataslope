...
<Figure
  slug="oopj-objects-classes-cutout"
  alt="A single plan card standing upright on a platform with three identical small houses built from it lined up beside it"
/>
...
<Figure
  slug="oopj-objects-and-classes-inline-cutout"
  alt="A metal template hanging on a wall and three finished parts stamped from it standing on the bench below, each finished differently"
  caption="One class, many objects, each stamped from it and filled differently."
/>
...
<Figure
  slug="oopj-objects-and-classes-class-description-object-inline-cutout"
  alt="A paper template pinned above a bench and one finished crate stamped from it below"
  caption="The class is the description; the object is one thing made to it."
/>
