...
<Figure
  slug="oopj-static-utility-cutout"
  alt="One shared toolbench fixed to the platform floor with three separate small objects drawing from it along thin arrows"
/>
...
<Figure
  slug="oopj-static-and-utility-inline-cutout"
  alt="One shared tool bolted to the wall of a workshop, used by three separate benches without any bench owning it"
  caption="A static member belongs to the class, not to any one instance."
/>
...
<Figure
  slug="oopj-static-and-utility-static-belongs-class-inline-cutout"
  alt="One tool bolted to a workshop wall, used by three benches without any bench owning it"
  caption="A utility class is a namespace for helpers, with no state of its own."
/>
