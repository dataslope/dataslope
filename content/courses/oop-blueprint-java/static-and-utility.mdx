...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three object cells each hold their own state dot but all tether up to a single shared plaque holding one yellow dot and one green method bar — static members live once, on the class itself"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="245" y="30" width="150" height="52" rx="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="282" cy="56" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="306" y="49" width="66" height="14" rx="7" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="165" cy="128" r="3" />
    <circle cx="205" cy="108" r="3" />
    <circle cx="248" cy="90" r="3" />
    <circle cx="320" cy="125" r="3" />
    <circle cx="320" cy="103" r="3" />
    <circle cx="475" cy="128" r="3" />
    <circle cx="435" cy="108" r="3" />
    <circle cx="392" cy="90" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="140" width="90" height="56" rx="12" fillOpacity="0.15" />
    <rect x="275" y="140" width="90" height="56" rx="12" fillOpacity="0.15" />
    <rect x="440" y="140" width="90" height="56" rx="12" fillOpacity="0.15" />
    <circle cx="140" cy="170" r="7" fillOpacity="0.85" />
    <circle cx="308" cy="166" r="7" fillOpacity="0.85" />
    <circle cx="486" cy="172" r="7" fillOpacity="0.85" />
  </g>
</svg>
...
`,
    },
    {
      ...
      starterCode: `public final class StringTools {
  private StringTools() {
...
`,
    },
    {
      ...
      starterCode: `public final class MyMath {
  // TODO: private constructor + the three static methods
}
`,
      solutionCode: `public final class MyMath {
