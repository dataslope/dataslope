...
<Figure
  slug="oopj-polymorphism-two-level-thinking-inline-cutout"
  alt="A crate wearing one standard front plate with a differently shaped body visible behind it"
  caption="The declared type says what you may call; the actual type says what runs."
/>
...
<Figure
  ...
  caption="One call, and each subtype answers it in its own way."
/>
...
Worth being precise about what that buys and what it sells, because the
