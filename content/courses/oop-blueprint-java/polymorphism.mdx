...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three identical yellow message capsules ride solid gray arrows into three receiver cards, and each card answers with a different shape, a blue circle, a green square, a yellow triangle, the same call dispatching to different behavior at runtime"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="90" y="35" width="64" height="22" rx="11" />
    <rect x="90" y="104" width="64" height="22" rx="11" />
    <rect x="90" y="173" width="64" height="22" rx="11" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="186" y="44.5" width="120" height="3" rx="1.5" />
    <polygon points="304,40.5 315,46 304,51.5" />
    <rect x="186" y="113.5" width="120" height="3" rx="1.5" />
    <polygon points="304,109.5 315,115 304,120.5" />
    <rect x="186" y="182.5" width="120" height="3" rx="1.5" />
    <polygon points="304,178.5 315,184 304,189.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="350" y="20" width="200" height="52" rx="12" fillOpacity="0.12" />
    <circle cx="450" cy="46" r="13" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="350" y="89" width="200" height="52" rx="12" fillOpacity="0.12" />
    <rect x="437" y="102" width="26" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="350" y="158" width="200" height="52" rx="12" fillOpacity="0.16" />
    <polygon points="450,170 464,197 436,197" />
  </g>
</svg>
