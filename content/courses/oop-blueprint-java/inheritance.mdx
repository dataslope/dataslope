...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three concentric translucent blue rings with one green dot at the very center — a Dog is a Mammal is an Animal, inheritance as nested membership"
