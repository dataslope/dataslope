...
<Figure
  slug="oopj-next-steps-cutout"
  alt="The Dataslope marmot mascot on a platform beside a stack of bound volumes and a signpost with three arrows pointing outward"
/>
