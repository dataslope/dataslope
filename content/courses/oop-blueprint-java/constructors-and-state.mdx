...
<Figure
  slug="oopj-constructors-cutout"
  alt="An assembly cradle on a platform releasing one fully formed sealed object, a rejected half-built shell set aside"
/>
...
<Figure
  slug="oopj-constructors-and-state-default-constructor-happens-inline-cutout"
  alt="A crate leaving a press with all its compartments empty, no filling station fitted"
  caption="With no constructor of your own, objects can be built empty."
/>
...
<Figure
  slug="oopj-constructors-and-state-constructor-inline-cutout"
  alt="A crate filled and sealed at the moment it leaves the press, never appearing empty"
  caption="A constructor fills the object before anyone can hold it."
/>
