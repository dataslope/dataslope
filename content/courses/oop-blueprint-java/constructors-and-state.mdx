...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Constructor arguments fall into an open vessel, and past a solid arrow the same vessel stands sealed with a green cap and every value settled — while a faint cracked vessel apart from them shows the half-built object a constructor prevents"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="112" width="90" height="78" rx="14" fillOpacity="0.12" />
    <circle cx="112" cy="44" r="6" />
  </g>
  ...
  <g fill="var(--ds-gray-400)">
    <rect x="196" y="148.5" width="28" height="3" rx="1.5" />
    <polygon points="222,144.5 222,155.5 233,150" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="260" y="112" width="90" height="78" rx="14" fillOpacity="0.22" />
    <circle cx="285" cy="168" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="256" y="98" width="98" height="14" rx="7" />
    <circle cx="305" cy="146" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="325" cy="168" r="6" />
  </g>
  <rect x="450" y="112" width="90" height="78" rx="14" fill="currentColor" opacity="0.08" />
  <circle cx="480" cy="170" r="6" fill="var(--ds-gray-300)" />
  <polyline points="500,112 510,136 495,152 507,176" fill="none" stroke="var(--ds-red-500)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
</svg>
