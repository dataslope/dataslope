...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three wide translucent layers, blue, green, and yellow, each holding its own small cluster of class shapes, packages grouped into a layered architecture"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <rect x="268" y="120" width="16" height="16" rx="4" fillOpacity="0.7" />
    <rect x="312" y="120" width="16" height="16" rx="4" fillOpacity="0.7" />
    <rect x="356" y="120" width="16" height="16" rx="4" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="110" y="180" width="420" height="48" rx="12" fillOpacity="0.14" />
    <circle cx="374" cy="204" r="8" fillOpacity="0.75" />
    <circle cx="422" cy="204" r="8" fillOpacity="0.75" />
    <circle cx="470" cy="204" r="8" fillOpacity="0.75" />
  </g>
</svg>
