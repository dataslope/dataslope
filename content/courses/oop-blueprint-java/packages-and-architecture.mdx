...
<Figure
  slug="oopj-packages-cutout"
  alt="Three horizontal tiers of grouped boxes stacked on a platform, each tier neatly bundled and connected downward by short arrows"
/>
...
<Figure
  slug="oopj-packages-and-architecture-package-inline-cutout"
  alt="A labelled folder holding cards of one kind, standing in a rack of such folders"
  caption="A package groups the classes that belong to one part of the system."
/>
...
<Figure
  slug="oopj-packages-and-architecture-tiny-many-classes-example-inline-cutout"
  alt="A set of parts kept in one flat tray but grouped by colour into the layers they would otherwise live in"
  caption="Even flat in one folder, the classes still sort into the layers they belong to."
/>
