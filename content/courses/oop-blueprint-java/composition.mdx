...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A large light blue object card holds solid green, yellow, and blue part blocks, with one slot still a dashed outline while its yellow part waits outside on a thin line pointing in — an object composed of smaller objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="490" y1="70" x2="401" y2="80" stroke="var(--ds-gray-400)" strokeWidth="2" />
  <polygon points="399,74.5 399,85.5 388,80" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="36" width="340" height="150" rx="14" fillOpacity="0.12" />
    <rect x="268" y="124" width="120" height="40" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="124" y="60" width="120" height="48" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="124" y="124" width="90" height="40" rx="8" />
    <rect x="490" y="48" width="92" height="44" rx="8" />
  </g>
  <rect x="268" y="60" width="120" height="48" rx="8" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
</svg>
