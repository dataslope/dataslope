---
title: Composition
description: The "has-a" relationship, building rich objects out of smaller ones, and why composition is the most important relationship in object-oriented design
---
...
<Figure
  slug="oopj-composition-cutout"
  alt="A car body on a platform opened to show an engine block, wheels and a seat nested inside as separate assembled parts"
/>
...
<Figure
  slug="oopj-composition-has-relationship-inline-cutout"
  alt="A machine with a smaller machine bolted inside it, still recognisable through an opening"
  caption="Has-a is composition, and it usually beats reaching for inheritance."
/>
...
<Figure
  slug="oopj-composition-first-example-car-inline-cutout"
  alt="A vehicle body with an engine block fitted inside it, the two joined permanently"
  caption="Composition is strong ownership: the part belongs to the whole."
/>
...
`,
    },
    {
      ...
      starterCode: `public class Engine {
...
<Figure
  slug="oopj-composition-inline-cutout"
  alt="One machine assembled from four smaller machines bolted into a frame, each smaller one still recognisable inside it"
  caption="Big objects are assembled from small ones that each hold their own state."
/>
...
`,
    },
    {
      ...
      starterCode: `public class Address {
...
There is a countable version of the argument, too. Two independent axes
of variation need a subclass per *combination* but only one component per
*behaviour*, and products outgrow sums fast:

<Chart slug="inheritance-vs-composition" />
...
`,
    },
    {
      ...
      starterCode: `public class Computer {
...
`,
    },
    {
      ...
      starterCode: `public class Author {
  // TODO
}
`,
      solutionCode: `public class Author {
