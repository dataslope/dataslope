...
<Figure
  slug="oopj-software-crisis-was-so-painful-inline-cutout"
  alt="A bench of loose tools and loose tins with cords running everywhere between them"
  caption="Shared global data and loose procedures is what objects were a reaction to."
/>
...
<Figure
  slug="oopj-software-crisis-nato-cutout"
  ...
  caption="Garmisch, 1968: a NATO conference where the industry admitted in public that it could not build large software reliably."
/>
...
Whatever it is, it has to move the finding of mistakes earlier. The cost
of a defect is the fix plus everything that happened between writing it
and noticing it, and that is not a linear scale:
