...
<Figure
  slug="oopj-methods-messages-cutout"
  alt="Two capsule objects on a platform with a rounded token travelling along a curved arrow from one to the other"
/>
...
<Figure
  slug="oopj-methods-and-messages-method-call-message-inline-cutout"
  alt="A folded note pushed into a slot in a sealed crate, and a small hatch on the crate's far side swinging open"
  caption="A call is a message to a receiver, and the answer comes back out."
/>
