...
<Figure
  slug="oopj-birth-of-oop-smalltalk-alan-kay-inline-cutout"
  alt="A bench where every item, tool, tray and crate alike, wears the same standard fitting"
  caption="If everything is an object, one standard fitting serves the whole system."
/>
