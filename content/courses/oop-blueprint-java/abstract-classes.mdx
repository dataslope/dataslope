...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A translucent disc missing one wedge beside two solid discs where the wedge is filled in, a darker blue in one and a lighter blue in the other, an abstract class completed differently by each subclass"
