...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A translucent disc missing one dotted-out wedge connects to two solid discs where the wedge is filled in green in one and yellow in the other — an abstract class completed differently by each subclass"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path fillOpacity="0.25" d="M170,105 L234,105 A64,64 0 1 1 170,41 Z" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="232" cy="88" r="2.5" />
    <circle cx="215" cy="60" r="2.5" />
    <circle cx="187" cy="43" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="260" cy="85" r="3" />
    <circle cx="310" cy="72" r="3" />
    <circle cx="360" cy="62" r="3" />
    <circle cx="260" cy="125" r="3" />
    <circle cx="310" cy="138" r="3" />
    <circle cx="360" cy="148" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path fillOpacity="0.85" d="M470,58 L512,58 A42,42 0 1 1 470,16 Z" />
    <path fillOpacity="0.85" d="M470,152 L512,152 A42,42 0 1 1 470,110 Z" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M470,58 L512,58 A42,42 0 0 0 470,16 Z" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M470,152 L512,152 A42,42 0 0 0 470,110 Z" />
  </g>
</svg>
...
Many modern OOP designs use interfaces by default and reach for
