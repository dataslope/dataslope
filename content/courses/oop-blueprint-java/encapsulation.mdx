...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A cell with a translucent membrane keeps its state dots inside; a yellow message enters only through a blue gate — state hidden, methods exposed"
