...
*holds a reference to* another that exists independently. The modelling
tradition gives these weaker relationships names: **aggregation**
and **dependency**.
...
<Figure
  slug="oopj-aggregation-cutout"
  alt="A container frame loosely holding two independent objects that rest on their own small bases, a third object passing by on a track"
/>
...
<Figure
  slug="oopj-aggregation-and-dependency-aggregation-library-has-inline-cutout"
  alt="A large crate holding smaller crates that can be lifted out and still stand on their own"
  caption="Aggregation means the parts can be lifted out and still exist on their own."
/>
...
<Figure
  slug="oopj-aggregation-and-dependency-spectrum-relationships-inline-cutout"
  alt="Three pairs of parts joined differently, one welded, one clipped, one merely resting side by side"
  caption="Composed, aggregated or merely depended on: three strengths of relationship."
/>
