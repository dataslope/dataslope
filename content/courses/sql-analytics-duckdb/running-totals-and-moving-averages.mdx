...
VALUES
  ...
  ('West', DATE '2024-01-04', 200),
  ('West', DATE '2024-01-05', 120),
  ('West', DATE '2024-01-06', 160),
  ('West', DATE '2024-01-07', 75),
  ('West', DATE '2024-01-08', 210),
  ('East', DATE '2024-01-01', 130),
  ('East', DATE '2024-01-02', 185),
  ('East', DATE '2024-01-03', 65),
  ('East', DATE '2024-01-04', 240),
  ('East', DATE '2024-01-05', 110),
  ('East', DATE '2024-01-06', 175),
  ('East', DATE '2024-01-07', 95),
  ('East', DATE '2024-01-08', 225),
  ('North', DATE '2024-01-01', 145),
  ('North', DATE '2024-01-02', 80),
  ('North', DATE '2024-01-03', 195),
  ('North', DATE '2024-01-04', 155),
  ('North', DATE '2024-01-05', 105),
  ('North', DATE '2024-01-06', 230),
  ('North', DATE '2024-01-07', 70),
  ('North', DATE '2024-01-08', 165);`}
  starterCode={`SELECT
  region,
  day,
  revenue,
...
<Figure
  ...
  caption="The frame decides how much of the past each row sees, and a fixed frame is a moving average."
/>
