...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A wide field of faint blue rows runs past both edges of the frame with one red dot hiding inside, while a small card above holds four crisp colored summary chips — a dataset too big to see, held in mind as a handful of numbers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="-24" y="128" width="688" height="112" fillOpacity="0.08" />
    <rect x="8" y="146" width="90" height="10" rx="5" fillOpacity="0.25" />
    <rect x="114" y="146" width="140" height="10" rx="5" fillOpacity="0.25" />
    <rect x="270" y="146" width="110" height="10" rx="5" fillOpacity="0.25" />
    <rect x="396" y="146" width="150" height="10" rx="5" fillOpacity="0.25" />
    <rect x="562" y="146" width="90" height="10" rx="5" fillOpacity="0.25" />
    <rect x="-10" y="170" width="120" height="10" rx="5" fillOpacity="0.25" />
    <rect x="126" y="170" width="90" height="10" rx="5" fillOpacity="0.25" />
    <rect x="232" y="170" width="160" height="10" rx="5" fillOpacity="0.25" />
    <rect x="408" y="170" width="100" height="10" rx="5" fillOpacity="0.25" />
    <rect x="524" y="170" width="130" height="10" rx="5" fillOpacity="0.25" />
    <rect x="30" y="194" width="130" height="10" rx="5" fillOpacity="0.25" />
    <rect x="176" y="194" width="100" height="10" rx="5" fillOpacity="0.25" />
    <rect x="292" y="194" width="150" height="10" rx="5" fillOpacity="0.25" />
    <rect x="458" y="194" width="120" height="10" rx="5" fillOpacity="0.25" />
    <rect x="594" y="194" width="60" height="10" rx="5" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="430" cy="175" r="5" />
  </g>
  <line x1="320" y1="100" x2="320" y2="128" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <rect x="190" y="24" width="260" height="76" rx="16" fill="currentColor" opacity="0.06" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="210" y="44" width="50" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="272" y="44" width="64" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="210" y="68" width="74" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="296" y="68" width="40" height="14" rx="7" />
  </g>
</svg>
