...
<Figure
  slug="duck-thinking-in-datasets-loop-question-query-look-inline-cutout"
  alt="Four benches arranged in a ring with one tray going round them, each pass leaving a sharper note on it"
  caption="Each answer suggests the sharper question, which is what makes analysis a loop."
/>
