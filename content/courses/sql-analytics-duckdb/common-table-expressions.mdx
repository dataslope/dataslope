...
<Figure
  slug="duck-common-table-expressions-problem-queries-nest-inline-cutout"
  alt="A machine inside a machine inside a machine, the innermost barely reachable"
  caption="Nesting subqueries inside subqueries is how a query becomes unreadable."
/>
...
<Figure
  slug="duck-common-table-expressions-inline-cutout"
  alt="Four small named trays along a bench, each built from the one before it, with the last feeding a machine"
  caption="Each named step is built from the one before it, and reads in order."
/>
