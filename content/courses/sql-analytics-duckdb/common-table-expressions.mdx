...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Three stacked query cards form a pipeline, two named CTE steps in blue and green joined by solid downward arrows into one wider yellow final query, building the result step by step instead of nesting it inside out"
  style={{ display: "block", width: "100%", maxWidth: "600px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="220" y="20" width="200" height="38" rx="10" fillOpacity="0.15" />
    <rect x="238" y="33" width="92" height="12" rx="6" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="220" y="88" width="200" height="38" rx="10" fillOpacity="0.15" />
    <rect x="238" y="101" width="120" height="12" rx="6" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="318.5" y="126" width="3" height="18" rx="1.5" />
    <polygon points="314.5,142 325.5,142 320,153" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="170" y="156" width="300" height="52" rx="12" fillOpacity="0.2" />
    <rect x="192" y="176" width="148" height="12" rx="6" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 165"
  role="img"
  aria-label="One solid green step is echoed by matching green sockets inside two waiting queries downstream, a CTE is computed once and referenced as many times as the query needs"
