...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="The same five rows take two paths: down the left line they collapse into a single green summary dot, down the right line all five survive and each carries an identical small green badge, GROUP BY summarizes instead of the rows, a window function summarizes alongside them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="320" y1="58" x2="164" y2="152" />
    <line x1="320" y1="58" x2="456" y2="152" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="366" cy="170" r="5" />
    <circle cx="418" cy="170" r="5" />
    <circle cx="470" cy="170" r="5" />
    <circle cx="522" cy="170" r="5" />
    <circle cx="574" cy="170" r="5" />
  </g>
</svg>
