...
<Figure
  ...
  caption="No one can read a million rows; an aggregate turns them into one number."
/>
...
VALUES
  ...
  (7, 13, 'google'), (8, 13, 'reddit'), (9, 14, NULL),
  (10, 12, 'google'), (11, 15, 'twitter'), (12, 11, 'reddit'),
  (13, 16, NULL), (14, 14, 'google'), (15, 15, 'google'),
  (16, 17, 'twitter'), (17, 13, NULL), (18, 18, 'reddit'),
  (19, 16, 'google'), (20, 17, 'google'), (21, 19, NULL),
  (22, 18, 'twitter'), (23, 20, 'reddit'), (24, 19, 'google');`}
  starterCode={`SELECT
...
<Figure
  ...
  caption="Several aggregates in one pass read the same rows different ways."
/>
...
VALUES
  ...
  ('A', 4), ('A', 2), ('B', 5), ('B', 3), ('B', 4),
  ('C', 5), ('C', NULL), ('C', 4), ('C', 3), ('C', 5),
  ('D', 2), ('D', 1), ('D', NULL), ('D', 3), ('D', 2),
  ('E', 5), ('E', 4), ('E', 5), ('E', NULL);`}
  starterCode={`SELECT
  product,
  COUNT(*) AS rows,
