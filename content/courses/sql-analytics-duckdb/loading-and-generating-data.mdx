...
<Figure
  slug="duck-loading-and-generating-data-four-ways-data-inline-cutout"
  alt="Four differently shaped cartons feeding one hopper and arriving inside as identical rows"
  caption="Whatever the file format, it arrives inside DuckDB as ordinary rows."
/>
...
<Figure
  ...
  caption="CSV, Parquet or a generated range: all four routes end in a table."
/>
