...
<Figure
  slug="duck-sorting-and-top-n-sorting-surfaces-extremes-inline-cutout"
  alt="A jumbled row of blocks pushed into a rising staircase, the tallest and the shortest now at the two ends"
  caption="Sorting puts the extremes at the two ends, which is often the whole question."
/>
...
INSERT INTO
  snacks
VALUES
  ('Almonds', 6.00, 200), ('Chips', 3.50, 150), ('Trail Mix', 8.00, 400),
  ('Pretzels', 2.00, 100), ('Jerky', 9.00, 90), ('Cashews', 7.25, 180),
  ('Popcorn', 2.75, 120), ('Granola bar', 1.80, 60), ('Rice cakes', 2.40, 110),
  ('Peanuts', 4.50, 250), ('Crackers', 3.10, 140), ('Pistachios', 9.50, 175),
  ('Dried mango', 5.60, 130), ('Walnuts', 8.40, 210), ('Seaweed', 3.90, 40),
  ('Oat cookies', 4.20, 190), ('Corn nuts', 2.60, 160), ('Beef sticks', 7.80, 85),
  ('Banana chips', 3.30, 145), ('Sunflower seeds', 2.90, 170),
  ('Yogurt raisins', 5.10, 155), ('Pumpkin seeds', 6.70, 165),
  ('Fruit leather', 1.95, 45), ('Wasabi peas', 4.80, 135);`}
  starterCode={`SELECT
  name,
...
<Figure
  slug="duck-sorting-and-top-n-inline-cutout"
  alt="A staircase of blocks with a bracket clamped over the highest four, the rest of the staircase outside the bracket"
  caption="Without a tiebreaker, a top-N over ties returns some N, not the same N."
/>
...
<Figure
  ...
  caption="`LIMIT` takes the top of the whole table; `QUALIFY` takes the top of each group."
/>
