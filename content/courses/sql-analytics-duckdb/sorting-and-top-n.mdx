...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Six horizontal bars sorted longest to shortest along a thin rail: the top three are solid green above a dashed yellow cut line, and the rest fade out in light blue below it, ORDER BY sorts, LIMIT keeps only the top of the list"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="132" y1="32" x2="132" y2="222" stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="36" width="380" height="20" rx="10" />
    <rect x="140" y="66" width="330" height="20" rx="10" />
    <rect x="140" y="96" width="290" height="20" rx="10" />
  </g>
  <line x1="120" y1="131" x2="540" y2="131" stroke="var(--ds-yellow-500)" strokeWidth="3" strokeDasharray="12 8" strokeLinecap="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="142" width="230" height="20" rx="10" fillOpacity="0.3" />
    <rect x="140" y="172" width="170" height="20" rx="10" fillOpacity="0.3" />
    <rect x="140" y="202" width="110" height="20" rx="10" fillOpacity="0.3" />
  </g>
</svg>
...
>
  <g fill="currentColor" opacity="0.06">
    <rect x="98" y="24" width="92" height="170" rx="16" />
    <rect x="274" y="24" width="92" height="170" rx="16" />
    <rect x="450" y="24" width="92" height="170" rx="16" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
