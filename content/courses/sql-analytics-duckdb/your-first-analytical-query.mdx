...
<Figure
  slug="duck-first-query-cutout"
  alt="A grid platform with a slim viewing window showing only its first few rows, a small sort arrow on its edge"
/>
...
<Figure
  slug="duck-your-first-analytical-query-reading-table-analyst-inline-cutout"
  alt="A board of rows with a first small window cut into it, a figure looking through"
  caption="The first query is a small window: read a few rows before asking anything harder."
/>
...
VALUES
  ...
  (9, 'Seattle', 'Fay', 17, 12.80),
  (10, 'Boise', 'Gus', 9, 7.10),
  (11, 'Portland', 'Hana', 28, 20.40),
  (12, 'Seattle', 'Iris', 41, 29.95),
  (13, 'Boise', 'Jonas', 13, 10.25),
  (14, 'Portland', 'Kira', 5, 4.75),
  (15, 'Seattle', 'Leo', 23, 17.60),
  (16, 'Boise', 'Mona', 34, 24.30),
  (17, 'Portland', 'Nils', 11, 8.90),
  (18, 'Seattle', 'Otto', 7, 6.40),
  (19, 'Boise', 'Pia', 26, 19.15),
  (20, 'Portland', 'Quinn', 38, 27.50),
  (21, 'Seattle', 'Rui', 15, 11.70),
  (22, 'Boise', 'Sara', 20, 14.85),
  (23, 'Portland', 'Theo', 30, 21.60),
  (24, 'Seattle', 'Ulla', 10, 8.05);`}
...
<Figure
  slug="duck-your-first-analytical-query-inline-cutout"
  alt="A wide board of rows feeding one machine that leaves a single small summary block on the bench"
  caption="Many rows in, one summary out: the shape of every analytical query."
/>
