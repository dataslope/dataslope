...
<Figure
  slug="duck-filtering-and-slicing-slice-question-disguise-inline-cutout"
  alt="A long board with a section cut out by two blades and lifted away on its own"
  caption="A filter cuts one band out of the data and lifts it away for the question you asked."
/>
