...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="A mixed row of blue, green, and yellow dots fans along thin lines into three tinted cards sorted by color, and each card condenses into one solid bar sized to its contents, GROUP BY bins the rows, then summarizes every bin once"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="300" y1="50" x2="161" y2="88" />
    <line x1="300" y1="50" x2="321" y2="88" />
    <line x1="300" y1="50" x2="481" y2="88" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="32" r="6" />
    <circle cx="220" cy="32" r="6" />
    <circle cx="340" cy="32" r="6" />
    <circle cx="460" cy="32" r="6" />
    <rect x="96" y="88" width="130" height="76" rx="12" fillOpacity="0.12" />
    <circle cx="128" cy="120" r="6.5" />
    <circle cx="152" cy="114" r="6.5" />
    <circle cx="176" cy="122" r="6.5" />
    <circle cx="140" cy="140" r="6.5" />
    <rect x="116" y="182" width="88" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="260" cy="32" r="6" />
    <circle cx="380" cy="32" r="6" />
    <rect x="256" y="88" width="130" height="76" rx="12" fillOpacity="0.12" />
    <circle cx="300" cy="124" r="6.5" />
    <circle cx="330" cy="118" r="6.5" />
    <rect x="290" y="182" width="48" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="180" cy="32" r="6" />
    <circle cx="300" cy="32" r="6" />
    <circle cx="420" cy="32" r="6" />
    <rect x="416" y="88" width="130" height="76" rx="12" fillOpacity="0.15" />
    <circle cx="448" cy="120" r="6.5" />
    <circle cx="474" cy="114" r="6.5" />
    <circle cx="500" cy="124" r="6.5" />
    <rect x="444" y="182" width="68" height="14" rx="7" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 175"
  role="img"
  aria-label="Six tinted pill tiles form a small grid: three region colors run down the rows, and a gray square or triangle product mark alternates across the columns, grouping by two columns yields one summary row per combination that appears"
  style={{ display: "block", width: "100%", maxWidth: "440px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="116" y="28" width="190" height="36" rx="18" fillOpacity="0.12" />
    <rect x="334" y="28" width="190" height="36" rx="18" fillOpacity="0.12" />
    <circle cx="148" cy="46" r="9" />
    <circle cx="366" cy="46" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="116" y="78" width="190" height="36" rx="18" fillOpacity="0.12" />
    <rect x="334" y="78" width="190" height="36" rx="18" fillOpacity="0.12" />
    <circle cx="148" cy="96" r="9" />
    <circle cx="366" cy="96" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="116" y="128" width="190" height="36" rx="18" fillOpacity="0.15" />
    <rect x="334" y="128" width="190" height="36" rx="18" fillOpacity="0.15" />
    <circle cx="148" cy="146" r="9" />
    <circle cx="366" cy="146" r="9" />
  </g>
  <g fill="var(--ds-gray-500)">
    <rect x="258" y="39" width="14" height="14" rx="3" />
    <rect x="258" y="89" width="14" height="14" rx="3" />
    <rect x="258" y="139" width="14" height="14" rx="3" />
    <polygon points="483,38 492,54 474,54" />
    <polygon points="483,88 492,104 474,104" />
    <polygon points="483,138 492,154 474,154" />
  </g>
</svg>
