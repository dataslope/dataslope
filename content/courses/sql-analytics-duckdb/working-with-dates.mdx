...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A timeline of day ticks sits inside three light blue month bands, each band dropping a thin line to one solid blue month chip below, while the same tick in every band glows yellow — dates truncated into periods, and a weekday extracted that repeats across them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="64" y="70" width="160" height="36" rx="10" fillOpacity="0.12" />
    <rect x="240" y="70" width="160" height="36" rx="10" fillOpacity="0.12" />
    <rect x="416" y="70" width="160" height="36" rx="10" fillOpacity="0.12" />
  </g>
  <g fill="var(--ds-gray-500)">
    <rect x="80" y="81" width="3" height="14" rx="1.5" />
    <rect x="100" y="81" width="3" height="14" rx="1.5" />
    <rect x="120" y="81" width="3" height="14" rx="1.5" />
    <rect x="160" y="81" width="3" height="14" rx="1.5" />
    <rect x="180" y="81" width="3" height="14" rx="1.5" />
    <rect x="200" y="81" width="3" height="14" rx="1.5" />
    <rect x="256" y="81" width="3" height="14" rx="1.5" />
    <rect x="276" y="81" width="3" height="14" rx="1.5" />
    <rect x="296" y="81" width="3" height="14" rx="1.5" />
    <rect x="336" y="81" width="3" height="14" rx="1.5" />
    <rect x="356" y="81" width="3" height="14" rx="1.5" />
    <rect x="376" y="81" width="3" height="14" rx="1.5" />
    <rect x="432" y="81" width="3" height="14" rx="1.5" />
    <rect x="452" y="81" width="3" height="14" rx="1.5" />
    <rect x="472" y="81" width="3" height="14" rx="1.5" />
    <rect x="512" y="81" width="3" height="14" rx="1.5" />
    <rect x="532" y="81" width="3" height="14" rx="1.5" />
    <rect x="552" y="81" width="3" height="14" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="139" y="78" width="5" height="20" rx="2.5" />
    <rect x="315" y="78" width="5" height="20" rx="2.5" />
    <rect x="491" y="78" width="5" height="20" rx="2.5" />
  </g>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="144" y1="106" x2="144" y2="136" />
    <line x1="320" y1="106" x2="320" y2="136" />
    <line x1="496" y1="106" x2="496" y2="136" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="104" y="138" width="80" height="18" rx="9" />
    <rect x="280" y="138" width="80" height="18" rx="9" />
    <rect x="456" y="138" width="80" height="18" rx="9" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 175"
  role="img"
  aria-label="Green day bars stand on one continuous light blue date spine of seven dots, and the two silent days keep dashed placeholder bars instead of disappearing — a generated date spine keeps empty periods visible in the series"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="84" y="62" width="26" height="68" rx="7" />
    <rect x="228" y="42" width="26" height="88" rx="7" />
    <rect x="372" y="76" width="26" height="54" rx="7" />
    <rect x="444" y="54" width="26" height="76" rx="7" />
    <rect x="516" y="88" width="26" height="42" rx="7" />
  </g>
  <g fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="5 5">
    <rect x="156" y="84" width="26" height="46" rx="7" />
    <rect x="300" y="84" width="26" height="46" rx="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="64" y="140" width="492" height="16" rx="8" fillOpacity="0.15" />
    <circle cx="97" cy="148" r="4.5" />
    <circle cx="169" cy="148" r="4.5" />
    <circle cx="241" cy="148" r="4.5" />
    <circle cx="313" cy="148" r="4.5" />
    <circle cx="385" cy="148" r="4.5" />
    <circle cx="457" cy="148" r="4.5" />
    <circle cx="529" cy="148" r="4.5" />
  </g>
</svg>
