...
<Figure
  slug="duck-dates-cutout"
  alt="A calendar ribbon on a platform with day tiles snapping together into month blocks, a small gap being filled by a spare tile"
/>
...
<Figure
  ...
  caption="Truncating a timestamp is what turns rows into days, weeks or months."
/>
...
SELECT
  DATE '2024-01-01' + (i * 5)::INTEGER AS order_date,
...
<SqlCodeBlock
  ...
  initSql={`CREATE TABLE orders AS
SELECT
  DATE '2024-01-01' + i::INTEGER AS order_date
FROM
  range(0, 60) t (i);`}
  starterCode={`SELECT
  EXTRACT (
...
INSERT INTO
  users
VALUES
  (1, DATE '2024-05-01'), (2, DATE '2024-05-20'), (3, DATE '2024-04-10'),
  (4, DATE '2024-05-28'), (5, DATE '2024-03-15'), (6, DATE '2024-05-12'),
  (7, DATE '2024-04-22'), (8, DATE '2024-05-30'), (9, DATE '2024-02-08'),
  (10, DATE '2024-05-05'), (11, DATE '2024-04-01'), (12, DATE '2024-05-25'),
  (13, DATE '2024-03-27'), (14, DATE '2024-05-18'), (15, DATE '2024-01-19'),
  (16, DATE '2024-05-09'), (17, DATE '2024-04-14'), (18, DATE '2024-05-31'),
  (19, DATE '2024-02-26'), (20, DATE '2024-05-03'), (21, DATE '2024-03-06'),
  (22, DATE '2024-05-22'), (23, DATE '2024-04-29'), (24, DATE '2024-05-16');`}
  starterCode={`SELECT
  id,
  signup_date,
...
<Figure
  slug="duck-working-with-dates-inline-cutout"
  alt="A calendar strip being cut into months by a small guillotine, and the pieces stacked into three labelled trays"
  caption="Dates are cut into periods, and each period becomes a group."
/>
...
INSERT INTO
  orders
VALUES
  (DATE '2024-03-01', 100), (DATE '2024-03-01', 50), (DATE '2024-03-03', 80),
  (DATE '2024-03-05', 120), (DATE '2024-03-05', 45), (DATE '2024-03-06', 175),
  (DATE '2024-03-08', 90),  (DATE '2024-03-08', 210), (DATE '2024-03-11', 65),
  (DATE '2024-03-12', 140), (DATE '2024-03-12', 30),  (DATE '2024-03-14', 195),
  (DATE '2024-03-15', 110), (DATE '2024-03-18', 250), (DATE '2024-03-19', 70),
  (DATE '2024-03-19', 160), (DATE '2024-03-21', 85),  (DATE '2024-03-22', 205),
  (DATE '2024-03-25', 55),  (DATE '2024-03-26', 130), (DATE '2024-03-26', 240),
  (DATE '2024-03-28', 95),  (DATE '2024-03-29', 185), (DATE '2024-03-29', 40);`}
