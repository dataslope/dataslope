...
<Figure
  slug="duck-conditional-logic-cutout"
  alt="A sorting gate on a platform routing incoming tiles down three labelled chutes into separate bracket bins"
/>
...
<Figure
  slug="duck-conditional-logic-inline-cutout"
  alt="A chute with a three-way sorter, each block dropping into the branch whose condition it satisfies and the rest falling to a default tray"
  caption="A `CASE` inside an aggregate computes several filtered totals at once."
/>
...
VALUES
  ...
  (4, 45, 3, 2), (5, 220, 0, NULL), (6, 15, 1, 1),
  (7, 175, 5, NULL), (8, 90, 2, 10), (9, 30, 0, NULL),
  (10, 310, 6, 25), (11, 55, 1, NULL), (12, 140, 4, 5),
  (13, 20, 0, NULL), (14, 265, 3, 15), (15, 70, 2, NULL),
  (16, 195, 5, 8), (17, 35, 0, NULL), (18, 120, 3, 4),
  (19, 250, 7, NULL), (20, 65, 1, 3), (21, 105, 0, NULL),
  (22, 180, 4, 12), (23, 40, 2, NULL), (24, 290, 6, 20);`}
  starterCode={`SELECT
  id,
