...
<Figure
  slug="duck-conditional-logic-case-if-else-inline-cutout"
  alt="A chute with a three-way sorter, each block dropping into the branch whose gauge it satisfies"
  caption="`CASE` sorts each row down the branch whose condition it satisfies."
/>
