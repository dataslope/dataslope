...
<Figure
  slug="duck-next-steps-cutout"
  alt="The Dataslope marmot mascot beside a small duck on a platform of stacked query pipelines, a signpost pointing outward"
/>
...
1. **Analytical mindset**, analytical against transactional work,
...
SELECT
  DATE '2024-01-01' + (i * 6)::INTEGER AS order_date,
  CASE
