...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue table card with one missing cell outlined in dashed red flows through a solid gray arrow into a profile card of quick stats — a range bar, distinct-value dots, and a red ring beside the missing value — profiling a dataset before trusting it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="52" y="36" width="240" height="160" rx="12" fillOpacity="0.1" />
    <rect x="84" y="56" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="148" y="56" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="212" y="56" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="84" y="88" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="148" y="88" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="212" y="88" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="84" y="120" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="212" y="120" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="84" y="152" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="148" y="152" width="56" height="24" rx="5" fillOpacity="0.4" />
    <rect x="212" y="152" width="56" height="24" rx="5" fillOpacity="0.4" />
  </g>
  <rect x="148" y="120" width="56" height="24" rx="5" fill="none" stroke="var(--ds-red-500)" strokeWidth="2" strokeDasharray="5 5" />
  <g fill="var(--ds-gray-400)">
    <rect x="306" y="112.5" width="32" height="3" rx="1.5" />
    <polygon points="336,108.5 347,114 336,119.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="368" y="36" width="220" height="160" rx="12" fillOpacity="0.12" />
    <circle cx="398" cy="116" r="6" />
    <circle cx="422" cy="116" r="6" />
    <circle cx="446" cy="116" r="6" />
    <circle cx="470" cy="116" r="6" fillOpacity="0.35" />
  </g>
  <rect x="392" y="64" width="172" height="8" rx="4" fill="var(--ds-gray-300)" />
  <rect x="424" y="64" width="90" height="8" rx="4" fill="var(--ds-blue-500)" />
  <circle cx="400" cy="164" r="8" fill="none" stroke="var(--ds-red-500)" strokeWidth="4" />
  <rect x="422" y="160" width="80" height="8" rx="4" fill="var(--ds-gray-300)" />
</svg>
