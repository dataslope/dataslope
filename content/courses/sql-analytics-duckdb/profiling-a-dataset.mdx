...
VALUES
  ...
  (7, 'g@x.com', 'GB'), (8, NULL, 'GB'), (9, 'i@x.com', 'US'),
  (10, 'j@x.com', 'CA'), (11, NULL, NULL), (12, 'l@x.com', 'DE'),
  (13, 'm@x.com', 'US'), (14, NULL, 'FR'), (15, 'o@x.com', 'GB'),
  (16, 'p@x.com', NULL), (17, 'q@x.com', 'CA'), (18, NULL, 'US'),
  (19, 's@x.com', 'DE'), (20, 't@x.com', 'US'), (21, NULL, 'JP'),
  (22, 'v@x.com', 'GB'), (23, 'w@x.com', NULL), (24, 'x@x.com', 'US');`}
  starterCode={`SELECT
  COUNT(*) AS rows,
