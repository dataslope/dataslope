...
<Figure
  slug="aida-context-cost-drift-cutout"
  alt="A growing spiral of stacked conversation cards where the earliest cards at the centre are faded and contradictory, and a small fresh clean card sits on a separate empty platform nearby"
/>
