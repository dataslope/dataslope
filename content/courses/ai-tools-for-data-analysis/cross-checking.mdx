...
<Figure
  slug="aida-cross-checking-cutout"
  alt="Two entirely separate pipelines built of different shaped parts, running from opposite sides of the scene and meeting at a central balance scale that holds one identical number tile from each"
/>
