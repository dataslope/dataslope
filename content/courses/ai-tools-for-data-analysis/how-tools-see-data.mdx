...
<Figure
  slug="aida-how-tools-see-data-cutout"
  alt="Four stacked viewing windows onto the same small dataset block, the first almost opaque and fogged, each next one clearer, the last fully transparent with a pipe connecting it to a database cylinder"
/>
