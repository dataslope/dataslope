...
<Figure
  slug="aida-where-ai-wins-cutout"
  alt="A balance scale where a tall stack labelled by a heavy anvil of production effort clearly outweighs a single light feather of checking effort, with a green tick above the scale"
/>
