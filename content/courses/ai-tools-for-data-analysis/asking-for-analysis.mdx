...
<Figure
  slug="aida-asking-for-analysis-cutout"
  alt="A chart on a pedestal with several speech bubbles floating above it, one bubble solid and anchored to the chart by a chain, the others drifting free and untethered"
/>
