...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three short labeled columns beside one long two-column table where their colors stack block over block next to a value column — a wide table melting into tidy long form"
