...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three short labeled columns stream along dotted trails into one long two-column table where their colors stack block over block beside a value column — a wide table melting into tidy long form"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="42" width="52" height="16" rx="5" />
    <circle cx="292" cy="110" r="3" fillOpacity="0.5" />
    <circle cx="332" cy="92" r="3" fillOpacity="0.5" />
    <circle cx="372" cy="72" r="3" fillOpacity="0.5" />
    <rect x="420" y="36" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="54" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="72" width="16" height="14" rx="4" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="148" y="42" width="52" height="16" rx="5" />
    <circle cx="292" cy="128" r="3" fillOpacity="0.5" />
    <circle cx="332" cy="131" r="3" fillOpacity="0.5" />
    <circle cx="372" cy="134" r="3" fillOpacity="0.5" />
    <rect x="420" y="90" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="108" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="126" width="16" height="14" rx="4" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="216" y="42" width="52" height="16" rx="5" />
    <circle cx="292" cy="144" r="3" fillOpacity="0.5" />
    <circle cx="332" cy="160" r="3" fillOpacity="0.5" />
    <circle cx="372" cy="176" r="3" fillOpacity="0.5" />
    <rect x="420" y="144" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="162" width="16" height="14" rx="4" fillOpacity="0.85" />
    <rect x="420" y="180" width="16" height="14" rx="4" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.13">
    <rect x="80" y="64" width="52" height="14" rx="4" />
    <rect x="80" y="82" width="52" height="14" rx="4" />
    <rect x="80" y="100" width="52" height="14" rx="4" />
    <rect x="148" y="64" width="52" height="14" rx="4" />
    <rect x="148" y="82" width="52" height="14" rx="4" />
    <rect x="148" y="100" width="52" height="14" rx="4" />
    <rect x="216" y="64" width="52" height="14" rx="4" />
    <rect x="216" y="82" width="52" height="14" rx="4" />
    <rect x="216" y="100" width="52" height="14" rx="4" />
    <rect x="442" y="36" width="64" height="14" rx="4" />
    <rect x="442" y="54" width="64" height="14" rx="4" />
    <rect x="442" y="72" width="64" height="14" rx="4" />
    <rect x="442" y="90" width="64" height="14" rx="4" />
    <rect x="442" y="108" width="64" height="14" rx="4" />
    <rect x="442" y="126" width="64" height="14" rx="4" />
    <rect x="442" y="144" width="64" height="14" rx="4" />
    <rect x="442" y="162" width="64" height="14" rx="4" />
    <rect x="442" y="180" width="64" height="14" rx="4" />
  </g>
</svg>
