...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two smooth translucent density humps, one blue and one green, overlap along one shared baseline — comparing two distributions where bars would collide"
