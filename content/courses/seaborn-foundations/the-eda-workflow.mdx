...
<Figure
  slug="sns-the-eda-workflow-running-example-getting-know-inline-cutout"
  alt="A penguin resting one flipper on a board of measured marks, the marks separating into three clear groups across it"
  caption="Heavier penguins have longer flippers, and the cloud splits into species as you look."
/>
...
<Figure
  slug="sns-the-eda-workflow-practical-5-step-inline-cutout"
  alt="A ring of five benches with one tray travelling round and returning changed"
  caption="Exploration is a loop, and each lap leaves you knowing more than the last."
/>
