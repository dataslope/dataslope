...
<svg
  viewBox="0 0 640 224"
  role="img"
  aria-label="Three solid dots in blue, green, and yellow ride a thin circular loop whose gray arrowhead marks the direction of travel, all circling one small red point at the center, plot, notice, sharpen, and loop again until the unexpected shows itself"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <circle cx="320" cy="116" r="80" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2.5" />
  <polygon points="394.5,110 405.5,110 400,121" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="36" r="15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="389" cy="156" r="15" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="251" cy="156" r="15" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="320" cy="116" r="14" fillOpacity="0.25" />
    <circle cx="320" cy="116" r="7" />
  </g>
</svg>
