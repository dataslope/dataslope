...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A slider whose knob can rest anywhere along one continuous blue track, above three separate solid pills in green, yellow, and red that each name a discrete group — a number on a scale versus a label for a group"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="58" width="480" height="16" rx="8" fillOpacity="0.2" />
    <rect x="80" y="58" width="300" height="16" rx="8" />
    <circle cx="380" cy="66" r="13" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="380" cy="66" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="110" y="142" width="120" height="44" rx="22" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="260" y="142" width="120" height="44" rx="22" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="410" y="142" width="120" height="44" rx="22" />
  </g>
</svg>
