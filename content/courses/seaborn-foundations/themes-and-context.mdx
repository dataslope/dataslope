...
<Figure
  slug="sns-themes-context-cutout"
  alt="One chart panel shown at three sizes on stepped platforms, its frame and gridlines lightening at each step"
/>
...
<Figure
  slug="sns-themes-and-context-style-canvas-behind-inline-cutout"
  alt="The same marks shown on three differently finished panels, the marks identical in each"
  caption="The style changes the canvas, never the marks the data drew."
/>
...
<Figure
  slug="sns-themes-and-context-context-scaling-everything-medium-inline-cutout"
  alt="The same figure drawn once for a page and once for a hall, its marks and rules thickened for the larger room"
  caption="A figure for a slide is shrunk and then projected, so everything on it starts larger."
/>
