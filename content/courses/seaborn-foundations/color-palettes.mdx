...
<Figure
  ...
  alt="Three swatch strips, one grading in one ink, one grading between two, one of distinct colours"
...
<Figure
  ...
  alt="Three strips of swatches, one running pale to deep in one hue, one running between two hues, one of separate distinct colours"
