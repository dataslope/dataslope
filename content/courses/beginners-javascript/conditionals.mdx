...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A dotted path reaching a yellow diamond where it forks: one dotted branch leads to a green circle, the other to a red circle"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="70" cy="110" r="3.5" />
    <circle cx="100" cy="110" r="3.5" />
    <circle cx="130" cy="110" r="3.5" />
    <circle cx="160" cy="110" r="3.5" />
    <circle cx="190" cy="110" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="270,78 314,110 270,142 226,110" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="322" cy="92" r="4" fillOpacity="0.7" />
    <circle cx="354" cy="78" r="4" fillOpacity="0.7" />
    <circle cx="386" cy="64" r="4" fillOpacity="0.7" />
    <circle cx="418" cy="50" r="4" fillOpacity="0.7" />
    <circle cx="456" cy="42" r="18" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="322" cy="128" r="4" fillOpacity="0.7" />
    <circle cx="354" cy="142" r="4" fillOpacity="0.7" />
    <circle cx="386" cy="156" r="4" fillOpacity="0.7" />
    <circle cx="418" cy="170" r="4" fillOpacity="0.7" />
    <circle cx="456" cy="178" r="18" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="492" cy="42" r="3" />
    <circle cx="518" cy="42" r="3" />
    <circle cx="492" cy="178" r="3" />
    <circle cx="518" cy="178" r="3" />
  </g>
</svg>
