...
There is no parallelism happening inside your JavaScript code. If a
...
<Figure
  slug="js-how-javascript-runs-javascript-single-threaded-inline-cutout"
  alt="One pair of hands at a bench holding a single block while four more blocks wait in a line beside them, none of the four being touched"
  caption="JavaScript runs one thing at a time; everything else waits its turn."
/>
...
the page, the browser also can't process clicks while the stack is
...
<Figure
  slug="js-how-javascript-runs-inline-cutout"
  alt="A single worker at a bench with a queue of trays beside them, taking one tray at a time and never two at once"
  caption="The event loop hands the single worker one queued job at a time."
/>
...
<Figure
  slug="js-how-javascript-runs-call-stack-inline-cutout"
  alt="A column of trays growing upward as each new job starts and coming apart from the top as each finishes"
  caption="Each call stacks a frame on top, and returning takes it off again."
/>
