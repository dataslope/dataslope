...
<Figure
  slug="js-modular-organization-cutout"
  alt="Modular organization, an isometric illustration"
/>
...
<Figure
  slug="js-modular-organization-inline-cutout"
  alt="One large workshop divided into four small booths, each booth's parts staying inside it and a hatch joining them"
  caption="A module keeps its own parts inside and offers a small hatch to the rest."
/>
...
<Figure
  slug="js-modular-organization-module-inline-cutout"
  alt="One workshop booth lifted whole off a bench, its tools still inside, and set down on another bench"
  caption="A module moves as one piece because everything it needs travels with it."
/>
