...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Translucent rounded boxes nested inside one another, with smaller shapes tucked away at every level, structure inside structure"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="30" width="500" height="170" rx="24" fillOpacity="0.08" />
    <circle cx="534" cy="54" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="100" y="62" width="190" height="106" rx="16" fillOpacity="0.16" />
    <rect x="320" y="62" width="220" height="106" rx="16" fillOpacity="0.16" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="132" y="84" width="24" height="24" rx="7" />
    <rect x="346" y="84" width="80" height="62" rx="12" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="142" cy="136" r="11" />
    <circle cx="178" cy="136" r="11" />
    <circle cx="214" cy="136" r="11" />
    <circle cx="488" cy="115" r="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="386" cy="115" r="10" />
  </g>
</svg>
