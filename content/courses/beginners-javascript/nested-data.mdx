...
<Figure
  slug="js-nested-data-cutout"
  alt="Nested data structures, an isometric illustration"
/>
...
<Figure
  slug="js-nested-data-reading-deep-paths-inline-cutout"
  alt="A chain of hooks reached down one at a time, one hook missing halfway and the reach stopping there"
  caption="One missing link partway down is what makes a deep path throw."
/>
...
<Figure
  slug="js-nested-data-inline-cutout"
  alt="A crate holding smaller crates, one of which holds a rail of blocks, all opened out on a bench"
  caption="Nested data is containers inside containers, opened one level at a time."
/>
...
<Figure
  slug="js-nested-data-mental-model-shapes-inline-cutout"
  alt="A crate opened to show a smaller crate inside, and that one opened to show a rail of blocks"
  caption="Arrays of objects and objects of arrays cover almost every response you meet."
/>
...
<CodeBlock
  ...
  files={[
    {
      filename: "index.js",
      starterCode: `const { ordersByCustomer, lineTotal } = require("./orders");
...
`,
    ...
    {
      filename: "orders.js",
      starterCode: `function lineTotal(item) {
