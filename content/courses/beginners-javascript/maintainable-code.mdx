...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A messy pile of tilted red and yellow blocks, an arrow, and the same blocks arranged as a tidy green and blue grid"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor" fillOpacity="0.85">
    <rect x="70" y="60" width="80" height="32" rx="9" transform="rotate(-16 110 76)" />
    <rect x="88" y="128" width="62" height="26" rx="8" transform="rotate(-7 119 141)" />
    <rect x="158" y="138" width="46" height="22" rx="7" transform="rotate(-28 181 149)" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="118" y="92" width="70" height="28" rx="8" transform="rotate(10 153 106)" />
    <rect x="150" y="52" width="54" height="24" rx="8" transform="rotate(24 177 64)" />
  </g>
  <polygon points="282,86 282,124 318,105" fill="currentColor" opacity="0.25" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="360" y="50" width="62" height="30" rx="8" />
    <rect x="516" y="50" width="62" height="30" rx="8" />
    <rect x="438" y="94" width="62" height="30" rx="8" />
    <rect x="360" y="138" width="62" height="30" rx="8" />
    <rect x="516" y="138" width="62" height="30" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="438" y="50" width="62" height="30" rx="8" />
    <rect x="360" y="94" width="62" height="30" rx="8" />
    <rect x="516" y="94" width="62" height="30" rx="8" />
    <rect x="438" y="138" width="62" height="30" rx="8" />
  </g>
</svg>
