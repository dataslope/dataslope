...
<Figure
  slug="js-variables-and-state-cutout"
  alt="Variables and program state, an isometric illustration"
/>
...
<Figure
  slug="js-variables-and-state-variable-really-inline-cutout"
  alt="A tin on a shelf with a blank tag tied to it, its contents being swapped while the tag stays put"
  caption="The name stays put while the value inside it is swapped."
/>
...
<Figure
  slug="js-variables-and-state-inline-cutout"
  alt="A row of four labelled storage tins on a shelf, one open with a colored block being swapped for a different one, the tin itself unchanged"
  caption="State is every variable's current value, and it changes as the program runs."
/>
...
| After line | `x` | `y` | `z` |
| ---: | ---: | ---: | ---: |
| 1 | 5 | not yet declared | not yet declared |
| 2 | 5 | 10 | not yet declared |
| 3 | 5 | 10 | 15 |
| 4 | 15 | 10 | 15 |
| 5 | 15 | 14 | 15 |
