...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Three labelled boxes holding colored balls; in the last box a faded ball gives way to a new one arriving along a curved path — reassigning a variable"
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    ...
    <path
      d="M584 24 C 568 46, 552 62, 538 76"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeOpacity="0.45"
    />
    <polygon points="532,86 545,82 537,70" fillOpacity="0.45" />
  </g>
</svg>
