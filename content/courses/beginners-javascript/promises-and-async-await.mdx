...
<Figure
  slug="js-promises-async-await-cutout"
  alt="Promises and async/await, an isometric illustration"
/>
...
<Figure
  slug="js-promises-and-async-await-promise-placeholder-inline-cutout"
  alt="An empty tray set on a bench with a plain blank ticket clipped to it, the tray filled later by a chute above"
  caption="A promise is a ticket for a value that has not arrived yet."
/>
...
<Figure
  slug="js-promises-and-async-await-inline-cutout"
  alt="A ticket counter on the left handing over one plain blank stub, a figure walking away to do other work in the middle, and the finished parcel waiting in a pickup hatch on the right"
  caption="`await` lets you walk away and pick the value up when it is ready."
/>
