...
<Figure
  slug="js-birth-of-javascript-machine-underneath-inline-cutout"
  alt="A page panel lifted like a lid to show a small engine turning underneath it"
  caption="Every page has an engine under it, running the script the page carries."
/>
...
<Figure
  slug="js-birth-of-javascript-run-first-program-inline-cutout"
  alt="A hand pressing one button on a small panel, a single short strip of type appearing in the tray below"
  caption="Press run and a runtime turns plain text into something that happens."
/>
...
<Figure
  slug="js-birth-ten-days-cutout"
  alt="A figure at a keyboard beside a large hourglass, a pile of loose sheets, and a browser window opening with one gear turning inside"
  caption="Netscape, May 1995: design a language, embed it in HTML, and have it demo-ready in ten days."
/>
