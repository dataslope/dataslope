...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two large blue blocks joined by a single flowing green line with a small bead travelling along it — a script gluing big systems together"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="58" width="140" height="92" rx="16" />
    <rect x="440" y="50" width="140" height="100" rx="16" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }}>
    <path
      d="M202 114 C 268 156, 316 52, 380 86 C 402 97, 420 101, 438 102"
      fill="none"
      stroke="currentColor"
      strokeWidth="10"
      strokeLinecap="round"
