...
<Figure
  slug="js-scripting-and-glue-two-language-pattern-inline-cutout"
  alt="A heavy engine bolted down to a bench with light removable cards slotted along its top edge, easy to swap while it runs"
  caption="A fast core built once, with the rules on top written in something quick to change."
/>
...
<Figure
  slug="js-scripting-and-glue-scripting-language-action-inline-cutout"
  alt="A small hand tool reading a stack of loose slips, reordering them, and handing back one tidy card"
  caption="Read some data, reshape it, print a result: the job scripting languages were made for."
/>
