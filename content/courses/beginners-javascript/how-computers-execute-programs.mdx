...
<Figure
  slug="js-how-computers-execute-cutout"
...
<Figure
  slug="js-how-computers-execute-programs-fetch-decode-execute-inline-cutout"
  alt="A small unit repeating a three-station circuit, taking a card, reading it, acting on it, and returning for the next"
  caption="Fetch, decode, execute, repeat: the loop under every program you write."
/>
...
<Figure
  slug="js-how-computers-execute-programs-inline-cutout"
  alt="A card of instructions feeding a machine one line at a time, each line dropping into a slot as it is consumed"
  caption="A program is instructions consumed one at a time, in an order you control."
/>
...
<Figure
  slug="js-how-computers-execute-programs-three-things-computer-inline-cutout"
  alt="Three parts standing side by side on one bench, a small engine, a wall of identical small slots, and a tray of cards feeding both"
  caption="A processor, memory, and a program: everything else is built on those three."
/>
