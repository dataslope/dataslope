...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A dotted trail winding through five numbered colored milestones, the five steps of solving a problem"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.28">
    <circle cx="110" cy="137" r="3.5" />
    <circle cx="140" cy="125" r="3.5" />
    <circle cx="170" cy="112" r="3.5" />
    <circle cx="230" cy="110" r="3.5" />
    <circle cx="260" cy="120" r="3.5" />
    <circle cx="290" cy="130" r="3.5" />
    <circle cx="350" cy="125" r="3.5" />
    <circle cx="380" cy="110" r="3.5" />
    <circle cx="410" cy="95" r="3.5" />
    <circle cx="470" cy="87" r="3.5" />
    <circle cx="500" cy="95" r="3.5" />
    <circle cx="530" cy="102" r="3.5" />
  </g>
  ...
  <g style={{ fill: "var(--ds-white)" }} fontFamily="var(--font-mono), ui-monospace, monospace" fontSize="16" fontWeight="700" textAnchor="middle">
    ...
    <text x="440" y="86">4</text>
    <text x="560" y="116">5</text>
  </g>
</svg>
