...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A green capsule carrying a blue and a yellow dot away from a faded scope box where ghost copies of the same dots remain — a function remembering the variables it was born with"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="45" width="230" height="130" rx="20" fillOpacity="0.08" />
    <circle cx="128" cy="92" r="9" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="168" cy="128" r="9" fillOpacity="0.3" />
  </g>
  <path
    d="M296 112 C 318 78, 344 78, 364 104"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="372" y="80" width="150" height="60" rx="30" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="424" cy="110" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="462" cy="110" r="9" />
  </g>
</svg>
