...
<Figure
  slug="c-pointers-and-arrays-cutout"
  alt="Pointers and arrays, an isometric illustration"
/>
...
<Figure
  slug="c-pointers-and-arrays-array-name-as-inline-cutout"
  alt="A strip of cells with a marker resting on the first cell, a tag on the marker matching the tag on the strip itself"
  caption="An array name decays to a pointer to its first element."
/>
...
<Figure
  slug="c-pointers-and-arrays-inline-cutout"
  alt="A strip of equal cells with a marker resting on the first, and the same marker two cells further along having jumped exactly two cell widths"
  caption="Adding one to a pointer moves it by one element, not one byte."
/>
