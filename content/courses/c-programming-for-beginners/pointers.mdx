...
<svg
  viewBox="0 0 640 175"
  role="img"
  aria-label="A small box holding a blue dot, with a single curved arrow reaching over to land on one highlighted green cell in a row of memory cells, a pointer and the box it points at"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <path
      d="M168 62 C 230 18, 350 14, 436 54"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeOpacity="0.6"
    />
    <polygon points="448,60 433,61 439,47" fillOpacity="0.6" />
  </g>
