...
<Figure
  slug="c-pointers-cutout"
  alt="Pointers, an isometric illustration"
/>
...
<Figure
  slug="c-pointers-inline-cutout"
  alt="A long row of mail slots, one slot holding a small card whose arrow points at another slot further down the row, and a figure following that arrow"
  caption="A pointer holds the address of another variable, and following it reaches the value."
/>
...
<Figure
  slug="c-pointers-pointer-inline-cutout"
  alt="A card in one slot whose arrow reaches across to another slot further along the row"
  caption="`NULL` is the address that points at nothing, and checking for it is a habit."
/>
