...
<svg
  viewBox="0 0 640 175"
  role="img"
  aria-label="A small box holding a blue dot, with a dotted arc reaching over to land on one highlighted green cell in a row of memory cells — a pointer and the box it points at"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="120" y="60" width="70" height="70" rx="12" fill="currentColor" opacity="0.08" />
  <g fill="currentColor" opacity="0.08">
    <rect x="340" y="60" width="70" height="70" rx="12" />
    <rect x="480" y="60" width="70" height="70" rx="12" />
    <rect x="550" y="60" width="70" height="70" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="155" cy="95" r="14" />
    <polygon points="438,60 420,44 416,58" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="230" cy="52" r="3.5" />
    <circle cx="270" cy="36" r="3.5" />
    <circle cx="312" cy="28" r="3.5" />
    <circle cx="354" cy="30" r="3.5" />
    <circle cx="392" cy="40" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="410" y="60" width="70" height="70" rx="12" fillOpacity="0.2" />
    <circle cx="445" cy="95" r="14" />
  </g>
</svg>
