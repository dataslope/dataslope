...
<Figure
  slug="c-compilation-and-execution-cutout"
  alt="Compilation and execution, an isometric illustration"
/>
...
<Figure
  slug="c-compilation-and-execution-four-stages-inline-cutout"
  alt="A card passing through four machines in a row, leaving each one visibly changed"
  caption="Four stages turn one source file into something the machine can run."
/>
...
<Figure
  slug="c-compilation-and-execution-stage-1-preprocessor-inline-cutout"
  alt="A card passing a first machine that pastes extra strips onto it before it goes on"
  caption="The preprocessor pastes headers in before the compiler reads anything."
/>
...
<Figure
  slug="c-compilation-and-execution-inline-cutout"
  alt="A source card fed into a machine, an object block leaving it, and that block driving a second machine"
  caption="Each source file compiles on its own, and the linker joins the pieces into one program."
/>
