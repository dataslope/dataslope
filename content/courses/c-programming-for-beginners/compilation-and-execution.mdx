...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An assembly line: a source document, a toothed gear, a chip, and finally a runnable pill with a play triangle, joined by thin arrows"
...
>
  <g
    ...
    opacity="0.3"
  >
    <path d="M150 105 H 188" />
    <path d="M284 105 H 322" />
    <path d="M427 105 H 448" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="188,98 188,112 200,105" />
    <polygon points="322,98 322,112 334,105" />
    <polygon points="448,98 448,112 460,105" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="60" width="70" height="90" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.45">
    <rect x="82" y="78" width="46" height="8" rx="4" />
    <rect x="82" y="94" width="34" height="8" rx="4" />
    <rect x="82" y="110" width="40" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="232" y="63" width="16" height="84" rx="6" />
    <rect x="198" y="97" width="84" height="16" rx="6" />
    <rect x="232" y="63" width="16" height="84" rx="6" transform="rotate(45 240 105)" />
    <rect x="232" y="63" width="16" height="84" rx="6" transform="rotate(-45 240 105)" />
    <circle cx="240" cy="105" r="30" />
  </g>
  <circle cx="240" cy="105" r="8" fill="currentColor" opacity="0.35" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="345" y="75" width="60" height="60" rx="10" />
    <rect x="335" y="88" width="10" height="10" rx="2" />
    <rect x="335" y="112" width="10" height="10" rx="2" />
    <rect x="405" y="88" width="10" height="10" rx="2" />
    <rect x="405" y="112" width="10" height="10" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="470" y="85" width="100" height="40" rx="20" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="510,95 510,115 528,105" />
  </g>
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.c",
      starterCode: `#include "greetings.h"
#include <stdio.h>
...
`,
    },
    {
      ...
      starterCode: `#ifndef GREETINGS_H
#define GREETINGS_H
...
\`Goodbye, Bell Labs!\``}
  ...
  files={[
    {
      filename: "main.c",
      starterCode: `#include "farewell.h"
...
#endif
`,
      solutionCode: `#ifndef FAREWELL_H
#define FAREWELL_H
...
`,
      solutionCode: `#include "farewell.h"
#include <stdio.h>
