...
<Figure
  slug="c-your-first-program-cutout"
...
<Figure
  slug="c-your-first-program-hello-world-inline-cutout"
  alt="A plain card fed into a machine and one short strip of type leaving its printer"
  caption="Break it deliberately and the compiler tells you what each part was for."
/>
...
<Figure
  slug="c-your-first-program-inline-cutout"
  alt="A plain card fed into a machine, and a single short strip of type emerging from its printer"
  caption="Every character in the smallest C program is there for a reason."
/>
