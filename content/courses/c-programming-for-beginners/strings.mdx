...
<Figure
  ...
  caption="A C string is characters followed by a null byte that marks the end."
/>
...
<Figure
  slug="c-strings-null-terminated-string-inline-cutout"
  alt="A ribbon of tiles ending in one small stop block, and a second ribbon with no stop block running off the bench edge"
  caption="Without the terminator, nothing tells a function where the string stops."
/>
