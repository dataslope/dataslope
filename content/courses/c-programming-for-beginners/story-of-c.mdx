...
<Figure
  slug="c-story-of-c-cutout"
  alt="From counting machines to C, an isometric illustration"
/>
...
<Figure
  slug="c-story-of-c-long-road-just-inline-cutout"
  alt="A long bench where instructions start as punched holes, become switch settings, and finally become plain written cards"
  caption="Each layer moved instructions further from the machine and closer to something a person could read."
/>
...
<Figure
  slug="c-story-of-c-pdp7-unix-cutout"
  alt="Two figures beside a cabinet-sized computer with tape reels, a round screen showing a planet and a spacecraft, and a teletype"
  caption="Bell Labs, 1969: Space Travel on a cast-off PDP-7, and the operating system written so it would run."
/>
