...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A lineage of circles growing from faint to solid along a thin trail, small languages evolving into C, with two companion dots and a spark beside the largest circle"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g
    fill="none"
    ...
    opacity="0.25"
  >
    <path d="M144 130 H 244" />
    <path d="M316 128 C 350 125, 380 122, 418 120" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
