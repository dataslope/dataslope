...
<Figure
  slug="c-data-types-fundamental-types-inline-cutout"
  alt="Four blocks of clearly different widths, each sitting in a recess cut exactly to its size"
  caption="A type says how many bytes, how the bits are read, and what you may do."
/>
...
<Figure
  slug="c-data-types-signed-unsigned-inline-cutout"
  alt="One rule running from a centre mark in both directions, beside another rule of the same length starting at one end"
  caption="Signed spends a bit on the sign; unsigned spends it on twice the range."
/>
...
<Figure
  ...
  caption="Same memory, different widths, and the type decides which is which."
/>
