...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="Four rounded boxes of increasing width with one, two, four, and eight byte dots beneath them, types as differently sized containers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="80" y="60" width="30" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="130" y="60" width="60" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="210" y="60" width="120" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="350" y="60" width="240" height="44" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <circle cx="95" cy="130" r="3.5" />
    <circle cx="153" cy="130" r="3.5" />
    <circle cx="167" cy="130" r="3.5" />
    <circle cx="249" cy="130" r="3.5" />
    <circle cx="263" cy="130" r="3.5" />
    <circle cx="277" cy="130" r="3.5" />
    <circle cx="291" cy="130" r="3.5" />
    <circle cx="421" cy="130" r="3.5" />
    <circle cx="435" cy="130" r="3.5" />
    <circle cx="449" cy="130" r="3.5" />
    <circle cx="463" cy="130" r="3.5" />
    <circle cx="477" cy="130" r="3.5" />
    <circle cx="491" cy="130" r="3.5" />
    <circle cx="505" cy="130" r="3.5" />
    <circle cx="519" cy="130" r="3.5" />
  </g>
</svg>
