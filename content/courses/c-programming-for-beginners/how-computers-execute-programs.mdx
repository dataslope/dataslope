...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Three colored circles riding a single thin ring, the endless fetch, decode, execute cycle, fed by a queue of instruction squares from the left"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="70" y="45" width="16" height="16" rx="4" />
    <rect x="70" y="69" width="16" height="16" rx="4" />
    <rect x="70" y="93" width="16" height="16" rx="4" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      d="M96 60 C 165 56, 225 54, 288 52"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    ...
    <circle
      ...
      strokeWidth="2.5"
    />
    <polygon points="388,126 402,126 395,140" fill="currentColor" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="55" r="24" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="385" cy="167" r="24" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="255" cy="167" r="24" />
  </g>
</svg>
