...
<Figure
  slug="control-flow"
  alt="Branching arrows tracing control flow through a program, the paths execution can take"
  priority
/>
...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Abstract circuit-board composition: a large blue quarter disc, a yellow chip with pins, and thin right-angled traces ending in small pads"
...
>
  ...
  <g
    ...
    strokeOpacity="0.6"
  >
    <path d="M284 115 H 240 L 205 150 H 180" />
    <path d="M406 94 H 448 L 476 66 H 510" />
    <path d="M406 136 H 460 L 490 166 H 528" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="180" cy="150" r="4.5" />
    <circle cx="510" cy="66" r="4.5" />
    <circle cx="528" cy="166" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="552" cy="44" r="10" />
  </g>
</svg>
