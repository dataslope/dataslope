...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A long row of dots whose three-color motif repeats four times, each repetition softly grouped — and below, the single abstracted motif that generates them all"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="60" y="48" width="124" height="44" rx="22" opacity="0.07" />
    <rect x="186" y="48" width="124" height="44" rx="22" opacity="0.07" />
    <rect x="312" y="48" width="124" height="44" rx="22" opacity="0.07" />
    <rect x="438" y="48" width="124" height="44" rx="22" opacity="0.07" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="80" cy="70" r="9" />
    <circle cx="206" cy="70" r="9" />
    <circle cx="332" cy="70" r="9" />
    <circle cx="458" cy="70" r="9" />
    <circle cx="282" cy="156" r="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="122" cy="70" r="9" />
    <circle cx="248" cy="70" r="9" />
    <circle cx="374" cy="70" r="9" />
    <circle cx="500" cy="70" r="9" />
    <circle cx="320" cy="156" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="164" cy="70" r="9" />
    <circle cx="290" cy="70" r="9" />
    <circle cx="416" cy="70" r="9" />
    <circle cx="542" cy="70" r="9" />
    <circle cx="358" cy="156" r="11" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
