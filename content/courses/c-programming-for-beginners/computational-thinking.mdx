...
<Figure
  slug="c-computational-thinking-cutout"
...
<Figure
  slug="c-computational-thinking-four-habits-computational-inline-cutout"
  alt="Four small tools hanging above a bench, each one shown taking a different bite out of the same awkward slab"
  caption="Four habits, and each one takes a different bite out of the problem."
/>
...
<Figure
  slug="c-computational-thinking-example-tell-me-inline-cutout"
  alt="A row of blocks of different heights with a hand sweeping along keeping only the tallest seen so far"
  caption="Keep the best seen so far and the whole list needs only one pass."
/>
...
<Figure
  slug="c-computational-thinking-inline-cutout"
  alt="A bench of mixed parts where three identical shapes are being lifted out and set together, the odd ones left behind"
  caption="Recognising the same shape twice is what saves you solving it twice."
/>
