...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A railway track of dots reaching a yellow switch lever, where the line diverges toward a green signal light or a red one"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="262" y="60" width="16" height="60" rx="8" transform="rotate(25 270 120)" />
    <circle cx="270" cy="120" r="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="310" cy="105" r="4" fillOpacity="0.7" />
    <circle cx="345" cy="88" r="4" fillOpacity="0.7" />
    <circle cx="380" cy="71" r="4" fillOpacity="0.7" />
    <circle cx="415" cy="54" r="4" fillOpacity="0.7" />
    <circle cx="450" cy="46" r="14" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="310" cy="135" r="4" fillOpacity="0.7" />
    <circle cx="345" cy="152" r="4" fillOpacity="0.7" />
    <circle cx="380" cy="169" r="4" fillOpacity="0.7" />
    <circle cx="415" cy="186" r="4" fillOpacity="0.7" />
    <circle cx="450" cy="194" r="14" />
  </g>
</svg>
