...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A single track reaching a yellow switch lever, then splitting into two smooth diverging lines toward a green light and a red light, a program choosing a branch"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }}>
    <path
      d="M290 110 C 345 90, 395 72, 434 58"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeOpacity="0.55"
    />
    <circle cx="456" cy="50" r="14" fill="currentColor" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }}>
    <path
      d="M290 130 C 345 150, 395 168, 434 182"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeOpacity="0.55"
    />
    <circle cx="456" cy="190" r="14" fill="currentColor" />
  </g>
</svg>
