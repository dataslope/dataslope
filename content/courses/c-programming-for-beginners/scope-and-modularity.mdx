...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Two translucent panels, each keeping its own dots private, with a single shared dot sitting on a dotted bridge between them"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <circle cx="470" cy="140" r="7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="296" cy="100" r="3" />
