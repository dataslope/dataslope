...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Two translucent panels, each keeping its own dots private, joined by a thin bridge line carrying a single shared yellow dot between them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="50" width="200" height="140" rx="18" fillOpacity="0.12" />
    <circle cx="132" cy="100" r="9" />
    <circle cx="184" cy="142" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="360" y="50" width="200" height="140" rx="18" fillOpacity="0.12" />
    <circle cx="422" cy="100" r="9" />
    <circle cx="474" cy="142" r="7" />
  </g>
  <path
    d="M282 100 H 358"
    fill="none"
