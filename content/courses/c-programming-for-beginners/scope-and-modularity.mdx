...
<Figure
  slug="c-scope-and-modularity-cutout"
  alt="Scope and modularity, an isometric illustration"
/>
...
<Figure
  slug="c-scope-and-modularity-inline-cutout"
  alt="Two workshops side by side, each with its own bench and tools, and one shared shelf on the wall between them"
  caption="A scope is a workshop: names declared inside it are reachable only from inside."
/>
...
<Figure
  slug="c-scope-and-modularity-scope-inline-cutout"
  alt="A bench inside a walled booth, its tools reachable from inside and not from the corridor outside"
  caption="A name is visible inside its block and invisible outside it."
/>
