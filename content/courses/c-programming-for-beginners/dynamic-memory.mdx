...
<svg
  viewBox="0 0 640 245"
  role="img"
  aria-label="A translucent memory pool holding allocated green chunks, one chunk fading as it is freed, and a red chunk drifting outside the pool along a thin trail — a leak"
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path
      d="M516 180 C 538 190, 554 198, 566 208"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
