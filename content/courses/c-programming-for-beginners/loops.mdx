...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="The same two-shape motif stamped five times along a dotted line, ending at a red octagon, repeat until the condition says stop"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="82" cy="100" r="12" />
    <circle cx="170" cy="100" r="12" />
    <circle cx="258" cy="100" r="12" />
    <circle cx="346" cy="100" r="12" />
    <circle cx="434" cy="100" r="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="102" y="88" width="24" height="24" rx="6" />
    <rect x="190" y="88" width="24" height="24" rx="6" />
    <rect x="278" y="88" width="24" height="24" rx="6" />
    <rect x="366" y="88" width="24" height="24" rx="6" />
    <rect x="454" y="88" width="24" height="24" rx="6" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="144" cy="100" r="2.5" />
    <circle cx="232" cy="100" r="2.5" />
    <circle cx="320" cy="100" r="2.5" />
    <circle cx="408" cy="100" r="2.5" />
    <circle cx="496" cy="100" r="2.5" />
    <circle cx="516" cy="100" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="585,110 570,125 550,125 535,110 535,90 550,75 570,75 585,90" />
  </g>
</svg>
