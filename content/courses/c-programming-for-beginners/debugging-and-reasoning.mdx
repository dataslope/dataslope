...
<Figure
  slug="c-debugging-and-reasoning-step-2-form-inline-cutout"
  alt="A written guess pinned above a stopped machine, a hand held back from the machine until the guess is written"
  caption="Write the guess down before you change anything, or you lose track of what you tested."
/>
...
<Figure
  slug="c-debugging-and-reasoning-step-1-read-inline-cutout"
  alt="A machine stopped with a printed slip hanging from it, a figure reading the slip rather than opening the machine"
  caption="Read what the program actually reports before opening it up."
/>
...
<Figure
  slug="c-debugging-and-reasoning-inline-cutout"
  alt="A long chain folded in half and tested, then folded again, the search closing on one bad link"
  caption="Halve the search each time and one bad link is found in a few steps."
/>
...
- \`p\` is \`NULL\`.
  > Dereferencing \`NULL\` is the most common cause of a segmentation fault; the operating system refuses the access and the program is killed.
