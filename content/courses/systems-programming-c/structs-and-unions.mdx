...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two rows of byte boxes for the same struct: declared char-int-char, the top row needs six gray padding boxes and runs twelve bytes long, while the reordered row below packs into eight — a yellow bracket marks the four bytes saved"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="48" width="24" height="36" rx="5" />
    <rect x="344" y="48" width="24" height="36" rx="5" />
    <rect x="232" y="130" width="24" height="36" rx="5" />
    <rect x="260" y="130" width="24" height="36" rx="5" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="148" y="48" width="24" height="36" rx="5" />
    <rect x="176" y="48" width="24" height="36" rx="5" />
    <rect x="204" y="48" width="24" height="36" rx="5" />
    <rect x="372" y="48" width="24" height="36" rx="5" />
    <rect x="400" y="48" width="24" height="36" rx="5" />
    <rect x="428" y="48" width="24" height="36" rx="5" />
    <rect x="288" y="130" width="24" height="36" rx="5" />
    <rect x="316" y="130" width="24" height="36" rx="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="232" y="48" width="108" height="36" rx="5" />
    <rect x="120" y="130" width="108" height="36" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }}>
    <path
      d="M372 158 H 452 M372 158 V 138 M452 158 V 138"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Three members of different widths — a wide blue, a medium green, and a small yellow — funnel along thin lines into one storage box sized for the largest, and only the green one currently sits inside — a union holds any one member at a time"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M218 66 L 300 104" />
    <path d="M349 66 L 324 104" />
    <path d="M436 66 L 346 104" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="28" width="136" height="32" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="412" y="28" width="48" height="32" rx="6" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="240" y="110" width="160" height="60" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="306" y="28" width="86" height="32" rx="6" fillOpacity="0.4" />
    <rect x="252" y="122" width="86" height="36" rx="6" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 150"
  role="img"
  aria-label="A row of eight tiny toggle switches: the blue, green, and yellow ones are flipped up while the unused gray ones rest down — bitfields packing single-bit flags into one integer"
  style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="160" y="45" width="10" height="60" rx="5" />
    <rect x="200" y="45" width="10" height="60" rx="5" />
    <rect x="240" y="45" width="10" height="60" rx="5" />
    <rect x="280" y="45" width="10" height="60" rx="5" />
    <rect x="320" y="45" width="10" height="60" rx="5" />
    <rect x="360" y="45" width="10" height="60" rx="5" />
    <rect x="400" y="45" width="10" height="60" rx="5" />
    <rect x="440" y="45" width="10" height="60" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="165" cy="52" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="285" cy="52" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="365" cy="52" r="8" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <circle cx="205" cy="98" r="8" />
    <circle cx="245" cy="98" r="8" />
    <circle cx="325" cy="98" r="8" />
    <circle cx="405" cy="98" r="8" />
    <circle cx="445" cy="98" r="8" />
  </g>
</svg>
