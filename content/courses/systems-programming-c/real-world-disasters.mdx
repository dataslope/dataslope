...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A network of machines joined by thin lines: one red source node has already turned its neighbours red, the frontier nodes are yellow, and the distant green nodes still wait, the 1988 Morris worm crossing the early internet"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M150 110 L 230 70" />
    <path d="M150 110 L 240 150" />
    <path d="M230 70 L 320 40" />
    <path d="M230 70 L 330 110" />
    <path d="M240 150 L 330 110" />
    <path d="M330 110 L 430 80" />
    <path d="M330 110 L 440 160" />
    <path d="M320 40 L 430 80" />
    <path d="M430 80 L 540 50" />
    <path d="M430 80 L 530 130" />
    <path d="M440 160 L 530 130" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="150" cy="110" r="11" />
    <circle cx="230" cy="70" r="7" />
    <circle cx="240" cy="150" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="40" r="7" />
    <circle cx="330" cy="110" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="430" cy="80" r="7" />
    <circle cx="440" cy="160" r="7" />
    <circle cx="540" cy="50" r="7" />
    <circle cx="530" cy="130" r="7" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A blue vault of memory rows leaks a stream of byte squares, yellow keys and green session secrets among the gray filler, out through a small red heart-shaped opening in its wall: Heartbleed"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="46" width="220" height="110" rx="12" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="122" y="68" width="130" height="8" rx="4" />
    <rect x="122" y="96" width="176" height="8" rx="4" />
    <rect x="122" y="124" width="96" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path d="M340 122 C328 108 320 102 320 90 C320 80 328 74 336 76 C339 77 340 80 340 82 C340 80 341 77 344 76 C352 74 360 80 360 90 C360 102 352 108 340 122 Z" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="376" y="92" width="14" height="14" rx="3" />
    <rect x="428" y="92" width="14" height="14" rx="3" />
    <rect x="480" y="92" width="14" height="14" rx="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="402" y="92" width="14" height="14" rx="3" />
    <rect x="532" y="92" width="14" height="14" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="454" y="92" width="14" height="14" rx="3" />
    <rect x="506" y="92" width="14" height="14" rx="3" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A blue launch line climbs smoothly from the pad until it must pass through a narrow yellow slot, the 64-to-16-bit conversion, where it kinks red and breaks into drifting shards: Ariane 5, flight 501"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="60" y="186" width="180" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }}>
    <path
      d="M90 182 C 160 152, 220 110, 308 88"
      fill="none"
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="316" y="24" width="42" height="50" rx="6" />
    <rect x="316" y="102" width="42" height="50" rx="6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }}>
    <path
      d="M358 86 L 394 72 L 410 98 L 430 84"
      fill="none"
      stroke="currentColor"
      strokeWidth="3"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path d="M444 96 L 460 92 L 451 108 Z" />
    <path d="M458 122 L 474 118 L 465 134 Z" fillOpacity="0.7" />
  </g>
</svg>
