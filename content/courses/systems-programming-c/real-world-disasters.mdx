...
<Figure
  ...
  alt="A request slip far longer than the slot it is being pushed into, spilling past the machine's edge"
  caption="Input longer than the buffer it was written into is the classic overflow."
/>
...
<Figure
  slug="sysc-real-world-disasters-5-cloudbleed-2017-inline-cutout"
  alt="A machine whose feed runs past the end of its own tape and draws a neighbour’s tape in with it"
  caption="Reading one byte past the end is how a neighbour's data ends up in your output."
/>
