...
<Figure
  slug="sysc-why-c-cutout"
  alt="A small lean engine block bolted directly onto a bare machine floor, no insulating layers between them"
/>
...
<Figure
  slug="sysc-why-c-for-systems-language-named-after-inline-cutout"
  alt="Two machines side by side, the second built directly from the first's parts with one more fitting"
  caption="C grew straight out of B, keeping the same shape and adding types."
/>
...
<Figure
  slug="sysc-why-c-for-systems-portable-assembly-inline-cutout"
  alt="One short instruction card driving a single machine stroke, beside a card that sets off a long chain of smaller machines"
  caption="In C one line usually becomes one instruction, which is what makes the cost visible."
/>
