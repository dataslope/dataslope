...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A wall of storage lockers, several claimed in green: a small yellow key floats beside the brightest locker ready to open it, while a red key lies lost at the bottom, its locker latched forever — malloc hands out space that only free can return"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <circle cx="363" cy="110" r="7" />
    <path d="M356 110 H 330" />
    <path d="M334 110 V 118" />
    <path d="M342 110 V 116" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <circle cx="414" cy="208" r="7" />
    <path d="M421 208 H 447" />
    <path d="M441 208 V 216" />
    <path d="M433 208 V 214" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Four dots sit in a snug container, and the same four dots reappear in a roomier container with four hollow slots still waiting — realloc copies the contents to a bigger block and retires the old one"
...
>
  ...
  <g
    ...
    strokeOpacity="0.9"
  >
    <circle cx="462" cy="90" r="7.5" />
    <circle cx="488" cy="90" r="7.5" />
    <circle cx="514" cy="90" r="7.5" />
    <circle cx="540" cy="90" r="7.5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Capacity columns double from two to four to eight slots as green pushes fill them — doubling keeps the copy-everything resizes rare, so pushes stay cheap on average"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
