...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A well of stacked call frames, each blue tray carrying green locals and a yellow return token, while the top tray tilts and lifts away along a thin upward arrow as its function returns"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="210" y="70" width="10" height="130" rx="4" />
    <rect x="420" y="70" width="10" height="130" rx="4" />
    <rect x="210" y="194" width="220" height="10" rx="5" />
  </g>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="470,32 463,46 477,46" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="230" y="164" width="180" height="24" rx="7" />
    <rect x="230" y="134" width="180" height="24" rx="7" />
    <rect x="230" y="104" width="180" height="24" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="252" cy="176" r="5" />
    <circle cx="270" cy="176" r="5" />
    <circle cx="252" cy="146" r="5" />
    <circle cx="252" cy="116" r="5" />
    <circle cx="270" cy="116" r="5" />
    <circle cx="288" cy="116" r="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="386" y="170" width="12" height="12" rx="3" />
    <rect x="386" y="140" width="12" height="12" rx="3" />
    <rect x="386" y="110" width="12" height="12" rx="3" />
  </g>
  <g transform="rotate(-7 320 62)">
    <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
      <rect x="230" y="50" width="180" height="24" rx="7" />
    </g>
    <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
      <circle cx="252" cy="62" r="5" />
      <circle cx="270" cy="62" r="5" />
    </g>
    <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
      <rect x="386" y="56" width="12" height="12" rx="3" />
    </g>
  </g>
</svg>
...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Call-frame trays fill a well past the dashed red stack-limit line, and the trays above the line turn red and tip over, recursion deep enough to overflow the stack"
  style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="250" y="30" width="8" height="170" rx="4" />
    <rect x="382" y="30" width="8" height="170" rx="4" />
    <rect x="250" y="194" width="140" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="265" y="172" width="110" height="16" rx="5" />
    <rect x="265" y="152" width="110" height="16" rx="5" />
    <rect x="265" y="132" width="110" height="16" rx="5" />
    <rect x="265" y="112" width="110" height="16" rx="5" />
    <rect x="265" y="92" width="110" height="16" rx="5" />
    <rect x="265" y="72" width="110" height="16" rx="5" />
  </g>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="265" y="42" width="110" height="16" rx="5" transform="rotate(5 320 50)" />
    <rect x="396" y="18" width="110" height="16" rx="5" transform="rotate(20 451 26)" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A green pointer card still aims its thin arrow at a faded local inside a dashed scope that has already ended, and a red cross blocks the way in, a dangling pointer to a returned function's local"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <polygon points="318,100 306,94 306,106" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="410" y="80" width="44" height="40" rx="8" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="110" y="80" width="64" height="40" rx="8" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M322 88 L 338 104" />
    <path d="M338 88 L 322 104" />
  </g>
</svg>
