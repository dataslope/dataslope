...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two rows of byte squares: the top row ends in a solid gray terminator square where the green read line stops, while the bottom row has no terminator and its read line runs past the end into tilted junk shapes and a red cross"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="40" width="30" height="30" rx="6" />
    <rect x="136" y="40" width="30" height="30" rx="6" />
    <rect x="172" y="40" width="30" height="30" rx="6" />
    <rect x="208" y="40" width="30" height="30" rx="6" />
    <rect x="244" y="40" width="30" height="30" rx="6" />
    <rect x="100" y="120" width="30" height="30" rx="6" />
    <rect x="136" y="120" width="30" height="30" rx="6" />
    <rect x="172" y="120" width="30" height="30" rx="6" />
    <rect x="208" y="120" width="30" height="30" rx="6" />
    <rect x="244" y="120" width="30" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="280" y="40" width="30" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="288" y="124" width="22" height="22" rx="4" transform="rotate(12 299 135)" />
    <rect x="352" y="126" width="18" height="18" rx="4" transform="rotate(-15 361 135)" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <polygon points="322,148 333,128 344,148" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M100 86 H 295" />
    <path d="M100 166 H 386" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M400 158 L 416 174" />
    <path d="M416 158 L 400 174" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Two bars cut at the same gray limit line: the snprintf bar ends with a solid green cap just inside the line, while the strncpy bar is cut raw at the line and a thin red arrow shows reads running on past it"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="378" y="32" width="4" height="116" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="52" width="244" height="24" rx="12" />
    <rect x="100" y="116" width="280" height="24" rx="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="350" y="52" width="24" height="24" rx="6" />
  </g>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="464,128 452,122 452,134" />
  </g>
</svg>
