...
<svg
  viewBox="0 0 640 160"
  role="img"
  aria-label="One horizontal strip of memory: a gray code segment, blue data and bss segments, then a green heap and a yellow stack whose arrows grow toward each other across the shrinking gap between them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="60" y="60" width="90" height="44" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="154" y="60" width="70" height="44" rx="8" />
    <rect x="228" y="60" width="56" height="44" rx="8" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="288" y="60" width="110" height="44" rx="8" />
    <path
      d="M402 74 H 420"
      fill="none"
      stroke="currentColor"
      ...
      strokeLinecap="round"
    />
    <polygon points="432,74 418,67 418,81" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="470" y="60" width="110" height="44" rx="8" />
    <path
      d="M466 90 H 448"
      fill="none"
      stroke="currentColor"
      ...
      strokeLinecap="round"
    />
    <polygon points="436,90 450,83 450,97" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="Initialized globals travel as solid blue crates with real contents, while the zeroed globals' spot is only a dashed outline carrying a small yellow manifest tag, BSS ships as metadata, not bytes"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="96" width="52" height="52" rx="8" />
    <rect x="198" y="96" width="52" height="52" rx="8" />
    <rect x="168" y="40" width="52" height="52" rx="8" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="470" y="36" width="54" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="478" y="48" width="38" height="5" rx="2.5" />
  </g>
</svg>
