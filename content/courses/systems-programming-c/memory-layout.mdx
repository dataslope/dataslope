...
<Figure
  ...
  alt="One long horizontal bar running the full width of the frame, divided end to end into four bands of different colors, a small arrow above the third band pointing right and a small arrow above the fourth pointing left so the two grow toward each other, and three loose crates resting inside the third band"
...
<Figure
  ...
  alt="One long horizontal bar divided end to end into four bands of different colors"
