...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Six array cells measured by a teal bracket that spans their full length; past a gray function boundary the same cells reappear in gray, and only a bare blue arrow marks the first one, the length is lost when an array decays to a pointer"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-teal-500)" }}>
    <path
      d="M70 100 V 90 H 280 V 100"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="112" width="30" height="30" rx="6" />
    <rect x="106" y="112" width="30" height="30" rx="6" />
    <rect x="142" y="112" width="30" height="30" rx="6" />
    <rect x="178" y="112" width="30" height="30" rx="6" />
    <rect x="214" y="112" width="30" height="30" rx="6" />
    <rect x="250" y="112" width="30" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="317" y="60" width="6" height="120" rx="3" />
    <rect x="396" y="112" width="30" height="30" rx="6" />
    <rect x="432" y="112" width="30" height="30" rx="6" />
    <rect x="468" y="112" width="30" height="30" rx="6" />
    <rect x="504" y="112" width="30" height="30" rx="6" />
    <rect x="540" y="112" width="30" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="360" y="112" width="30" height="30" rx="6" />
    <path
      d="M375 68 V 92"
      fill="none"
      stroke="currentColor"
      ...
      strokeLinecap="round"
    />
    <polygon points="375,106 368,92 382,92" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Four blue array cells end at a gray fence post, but a tilted red block has slammed down one slot past the end, half covering the green value that lives in the neighbouring memory, an out-of-bounds write"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="96" y="90" width="44" height="44" rx="6" />
    <rect x="148" y="90" width="44" height="44" rx="6" />
    <rect x="200" y="90" width="44" height="44" rx="6" />
    <rect x="252" y="90" width="44" height="44" rx="6" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }} fill="currentColor">
    <rect x="308" y="78" width="6" height="66" rx="3" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="328" y="90" width="196" height="44" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="368" cy="112" r="11" />
    <circle cx="478" cy="112" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="330" y="82" width="44" height="44" rx="6" transform="rotate(-9 352 104)" />
  </g>
</svg>
