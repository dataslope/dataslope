...
<Figure
  slug="db-what-are-constraints-cutout"
  alt="What constraints are, an isometric illustration"
/>
...
<Figure
  slug="db-what-are-constraints-constraints-are-enforced-inline-cutout"
  alt="A chute with three gauges fitted across it, each stopping a block that fails its measure"
  caption="Constraints make bad data impossible to store rather than merely discouraged."
/>
...
<Figure
  slug="db-what-are-constraints-inline-cutout"
  alt="A chute with three gauges fitted across it, each stopping a block that fails to meet its measure"
  caption="A rule enforced at write time surfaces the error while it is still cheap."
/>
