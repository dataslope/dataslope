...
<Figure
  slug="db-what-are-relationships-cutout"
  alt="What relationships are, an isometric illustration"
/>
...
INSERT INTO orders VALUES
  ...
  (103, 3, DATE '2025-03-03'),
  (104, 4, DATE '2025-03-04'),
  (105, 5, DATE '2025-03-05'),
  (106, 6, DATE '2025-03-06'),
  (107, 7, DATE '2025-03-07'),
  (108, 8, DATE '2025-03-08'),
  (109, 9, DATE '2025-03-09'),
  (110, 10, DATE '2025-03-10'),
  (111, 11, DATE '2025-03-11'),
  (112, 12, DATE '2025-03-12'),
  (113, 13, DATE '2025-03-13'),
  (114, 14, DATE '2025-03-14'),
  (115, 15, DATE '2025-03-15'),
  (116, 16, DATE '2025-03-16'),
  (117, 17, DATE '2025-03-17'),
  (118, 18, DATE '2025-03-18'),
  (119, 19, DATE '2025-03-19'),
  (120, 20, DATE '2025-03-20'),
  (121, 21, DATE '2025-03-21'),
  (122, 22, DATE '2025-03-22'),
  (123, 23, DATE '2025-03-23'),
  (124, 24, DATE '2025-03-24'),
  (125, 1, DATE '2025-03-25'),
  (126, 2, DATE '2025-03-26'),
  (127, 3, DATE '2025-03-27'),
  (128, 4, DATE '2025-03-28'),
  (129, 5, DATE '2025-03-29'),
  (130, 6, DATE '2025-03-30');`}
  starterCode={`SELECT
  c.name,
  o.id AS order_id,
  o.placed_on
...
<Figure
  slug="db-what-are-relationships-inline-cutout"
  alt="Two crates on a bench joined by a cord, with the cord's ends fitting sockets that only accept that cord"
  caption="A relationship is what lets one table's rows answer questions about another's."
/>
...
<Figure
  slug="db-what-are-relationships-relationships-are-verbs-inline-cutout"
  alt="Two crates joined by a cord with a small blank plate hanging from the middle of the cord"
  caption="When the link itself carries facts, the relationship becomes an entity too."
/>
