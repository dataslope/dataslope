...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Two entity containers joined by a dotted bridge with a yellow verb diamond at its center — the relationship is the connection itself"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="55" width="140" height="80" rx="16" fillOpacity="0.3" />
    <circle cx="96" cy="85" r="8" />
    <rect x="84" y="106" width="92" height="10" rx="5" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="440" y="55" width="140" height="80" rx="16" fillOpacity="0.3" />
    <circle cx="476" cy="85" r="8" />
    <rect x="464" y="106" width="92" height="10" rx="5" fillOpacity="0.4" />
  </g>
  <g fill="currentColor" opacity="0.32">
    <circle cx="222" cy="95" r="3.5" />
    <circle cx="248" cy="95" r="3.5" />
    <circle cx="274" cy="95" r="3.5" />
    <circle cx="366" cy="95" r="3.5" />
    <circle cx="392" cy="95" r="3.5" />
    <circle cx="418" cy="95" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="320,67 348,95 320,123 292,95" />
    <polygon points="320,79 336,95 320,111 304,95" fillOpacity="0.4" />
  </g>
</svg>
