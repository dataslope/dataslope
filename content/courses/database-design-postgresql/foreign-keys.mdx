...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A child row holds a small yellow dot that matches the parent's yellow key, with a dotted arc tracing the reference back home — a foreign key saying belongs to"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="42" width="180" height="100" rx="16" fillOpacity="0.16" />
    <rect x="136" y="66" width="100" height="10" rx="5" fillOpacity="0.4" />
    <rect x="106" y="106" width="110" height="10" rx="5" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="380" y="42" width="180" height="100" rx="16" fillOpacity="0.16" />
    <rect x="406" y="66" width="100" height="10" rx="5" fillOpacity="0.4" />
    <rect x="442" y="106" width="92" height="10" rx="5" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="112" cy="71" r="9" />
    <circle cx="416" cy="111" r="7" />
    <circle cx="394" cy="146" r="3.5" fillOpacity="0.6" />
    <circle cx="354" cy="166" r="3.5" fillOpacity="0.6" />
    <circle cx="308" cy="176" r="3.5" fillOpacity="0.6" />
    <circle cx="260" cy="176" r="3.5" fillOpacity="0.6" />
    <circle cx="214" cy="166" r="3.5" fillOpacity="0.6" />
    <circle cx="176" cy="146" r="3.5" fillOpacity="0.6" />
    <circle cx="150" cy="120" r="3.5" fillOpacity="0.6" />
    <polygon points="134,104 122,84 144,88" fillOpacity="0.9" />
  </g>
</svg>
