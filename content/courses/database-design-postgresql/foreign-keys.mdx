...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A child row holds a small yellow dot that matches the parent's yellow key, with a thin arc tracing the reference back home — a foreign key saying belongs to"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <path
      d="M410 120 C 340 184, 204 178, 138 100"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
