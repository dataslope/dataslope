...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A clear tile pattern repeats across the canvas and fades toward tiles not yet built, a clean structure that can keep extending as the product grows"
...
>
  ...
  <g fill="currentColor" opacity="0.05">
    <rect x="440" y="28" width="72" height="72" rx="14" />
    <rect x="440" y="110" width="72" height="72" rx="14" />
  </g>
</svg>
