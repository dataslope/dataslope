...
<Figure
  slug="db-design-and-scale-designs-scale-meaning-inline-cutout"
  alt="The same cabinet built small and built very large, its fittings identical at both sizes"
  caption="A design that scales keeps the same fittings whether it holds thousands or millions."
/>
...
<Figure
  slug="db-design-and-scale-avoid-wide-god-inline-cutout"
  alt="One enormously wide board sagging under its own length beside four narrow boards standing square"
  caption="One table trying to hold everything sags where several narrow ones stand."
/>
...
<Figure
  ...
  caption="Good design preserves meaning at the size you expect to grow to."
/>
