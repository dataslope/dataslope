...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three child squares point up at their parents along thin lines, but one line ends at a dashed ghost outline crossed in red — an orphan reference to a parent that does not exist"
