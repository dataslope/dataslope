...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three child squares point up at their parents along thin lines, but one line ends at a red cross where its parent should be — an orphan reference to a parent that does not exist"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M170 132 V 78" />
    <path d="M320 132 V 78" />
  </g>
