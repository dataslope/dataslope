...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Non-key squares connect by thin lines straight to the yellow key circle at the center, except one square whose red line leans on another square instead — the transitive dependency third normal form removes"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M200 64 L 302 98" />
    <path d="M200 146 L 302 112" />
    <path d="M440 64 L 338 98" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="105" r="15" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="170" y="44" width="24" height="24" rx="7" />
    <rect x="446" y="44" width="24" height="24" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="170" y="142" width="24" height="24" rx="7" />
    <rect x="446" y="142" width="24" height="24" rx="7" />
  </g>
</svg>
