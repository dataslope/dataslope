...
<Figure
  slug="db-third-normal-form-transitive-dependency-problem-inline-cutout"
  alt="A chain of three cards where the third hangs off the second rather than off the first, the second being lifted out with it"
  caption="When a column depends on another non-key column, both belong somewhere else."
/>
...
<Figure
  ...
  caption="The dependent pair moves out to its own table, keyed by what it depends on."
/>
