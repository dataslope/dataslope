...
<Figure
  ...
  caption="Skip the dividers and everything stored afterwards slumps into everything else."
/>
...
<Figure
  ...
  caption="Design is deciding which parts exist and how they fit before you build."
/>
...
<Figure
  slug="db-what-is-database-design-three-levels-design-inline-cutout"
  alt="The same store drawn three times, first as ideas on paper, then as a plan of tables, then as a built cabinet"
  caption="Conceptual, logical, physical: the same store described three times, in three registers."
/>
...
<Figure
  slug="db-what-is-database-design-schema-shapes-everything-built-inline-cutout"
  alt="A base plate of fixed slots with a tall assembly rising from it, every piece above cut to the width of a slot"
  caption="Application code hardens around the tables, so the schema decides what can be built on it."
/>
