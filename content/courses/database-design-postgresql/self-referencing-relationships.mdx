...
<Figure
  slug="db-self-referencing-relationships-one-table-two-inline-cutout"
  alt="One crate with a cord that leaves it and returns to another crate of exactly the same kind"
  caption="A self-reference is an ordinary foreign key that happens to point home."
/>
