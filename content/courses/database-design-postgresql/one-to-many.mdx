...
<Figure
  slug="db-one-to-many-basic-shape-inline-cutout"
  alt="One large crate with four smaller crates fanned to its right, a cord from each small crate back to the large one"
  caption="One parent, many children, and one cord home from each child."
/>
