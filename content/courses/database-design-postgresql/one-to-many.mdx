...
<Figure
  slug="db-one-to-many-cutout"
  alt="One-to-many relationships, an isometric illustration"
/>
...
<Figure
  slug="db-one-to-many-inline-cutout"
  alt="One large parent crate on the left with four smaller crates fanned out to its right, a single cord running from each small crate back to the parent"
  caption="The foreign key lives on the many side, because that is where it fits once."
/>
...
INSERT INTO customers (name, email) VALUES
  ...
  ('Elif', 'elif@example.com'),
  ('Farid', 'farid@example.com');

INSERT INTO orders (customer_id, placed_on, total) VALUES
  (1, DATE '2025-01-10', 12.00),
  (2, DATE '2025-01-11', 49.00),
  (3, DATE '2025-01-12', 86.00),
  (4, DATE '2025-01-13', 33.00),
  (5, DATE '2025-01-14', 70.00),
  (6, DATE '2025-01-15', 17.00),
  (7, DATE '2025-01-16', 54.00),
  (8, DATE '2025-01-17', 91.00),
  (9, DATE '2025-01-18', 38.00),
  (10, DATE '2025-01-19', 75.00),
  (11, DATE '2025-01-20', 22.00),
  (12, DATE '2025-01-21', 59.00),
  (13, DATE '2025-01-22', 96.00),
  (14, DATE '2025-01-23', 43.00),
  (15, DATE '2025-01-24', 80.00),
  (16, DATE '2025-01-25', 27.00),
  (17, DATE '2025-01-26', 64.00),
  (18, DATE '2025-01-27', 101.00),
  (19, DATE '2025-01-28', 48.00),
  (20, DATE '2025-01-29', 85.00),
  (21, DATE '2025-01-30', 32.00),
  (22, DATE '2025-01-31', 69.00),
  (23, DATE '2025-02-01', 16.00),
  (24, DATE '2025-02-02', 53.00),
  (1, DATE '2025-02-03', 90.00),
  (2, DATE '2025-02-04', 37.00),
  (3, DATE '2025-02-05', 74.00),
  (4, DATE '2025-02-06', 21.00),
  (5, DATE '2025-02-07', 58.00),
  (6, DATE '2025-02-08', 95.00);`}
  starterCode={`SELECT
  c.name,
  o.id AS order_id,
  o.placed_on,
