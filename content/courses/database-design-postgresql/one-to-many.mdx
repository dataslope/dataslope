...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="One large blue dot fans out along thin lines to many small green dots — a single parent row connected to many child rows"
...
>
  ...
  <g
    ...
    opacity="0.3"
  >
    <path d="M160 92 L 496 37" />
    <path d="M162 96 L 506 70" />
    <path d="M164 100 L 510 109" />
    <path d="M162 104 L 506 148" />
    <path d="M160 108 L 496 177" />
  </g>
