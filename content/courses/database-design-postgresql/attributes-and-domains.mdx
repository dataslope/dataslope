...
<Figure
  slug="db-attributes-and-domains-domains-say-values-inline-cutout"
  alt="A tag slot cut to accept only a narrow range of tag widths, wider and narrower tags refused beside it"
  caption="A domain is the set of values a column will accept, and nothing outside it."
/>
...
<Figure
  slug="db-attributes-and-domains-inline-cutout"
  alt="One crate with four labelled compartments, each compartment cut to accept only one shape of block"
  caption="Every compartment admits one shape only, which is what a data type really is."
/>
...
<Figure
  slug="db-attributes-and-domains-attributes-describe-entity-inline-cutout"
  alt="One crate with four blank tags clipped along its side, each tag naming a different face of the same crate"
  caption="Attributes are the separate facts one entity carries, and each becomes a column."
/>
