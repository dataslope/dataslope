...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two entity boxes joined by a relationship line carrying a small yellow label chip, with a double bar on one end and a crow's-foot on the other — an ER diagram stating one-to-many before any SQL exists"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M240 102 H 376" />
    <path d="M252 90 V 114" />
    <path d="M262 90 V 114" />
    <path d="M376 102 L 400 88" />
    <path d="M376 102 L 400 102" />
    <path d="M376 102 L 400 116" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="70" width="140" height="64" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="400" y="70" width="140" height="64" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="296" y="92" width="48" height="20" rx="10" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="116" y="88" width="72" height="9" rx="4.5" />
    <rect x="116" y="106" width="52" height="9" rx="4.5" />
    <rect x="416" y="88" width="72" height="9" rx="4.5" />
    <rect x="416" y="106" width="52" height="9" rx="4.5" />
  </g>
</svg>
