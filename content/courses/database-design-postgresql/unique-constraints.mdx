...
<Figure
  slug="db-unique-constraints-cutout"
  alt="Unique constraints, an isometric illustration"
/>
...
<Figure
  slug="db-unique-constraints-uniqueness-beyond-primary-inline-cutout"
  alt="A rack whose slots each accept one tag, a second identical tag turned away even though it carries a different punched tab"
  caption="Uniqueness on a foreign key is what makes a relationship one to one."
/>
...
<Figure
  slug="db-unique-constraints-inline-cutout"
  alt="A rack where each slot accepts one tag only, an identical second tag being turned away at the slot's mouth"
  caption="A unique constraint turns away the second identical value at the slot's mouth."
/>
