...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A green fact from one table is copied into another, but the copy wears a yellow badge ring and a sync trail back to its source — duplication done deliberately, with eyes open"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="172" cy="170" r="3.5" fillOpacity="0.5" />
    <circle cx="240" cy="182" r="3.5" fillOpacity="0.5" />
    <circle cx="320" cy="186" r="3.5" fillOpacity="0.5" />
    <circle cx="400" cy="182" r="3.5" fillOpacity="0.5" />
    <circle cx="462" cy="166" r="3.5" fillOpacity="0.5" />
    <polygon points="487,140 478,158 496,156" fillOpacity="0.7" />
  </g>
</svg>
