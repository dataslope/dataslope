...
<Figure
  slug="db-denormalization-cutout"
  alt="When to denormalize, an isometric illustration"
/>
...
<Figure
  slug="db-denormalization-normalize-first-inline-cutout"
  alt="A tidy set of small cabinets built first, and only then a wider copy assembled beside them"
  caption="Normalise first; the wider copy is added afterwards, on purpose."
/>
...
<Figure
  slug="db-denormalization-denormalize-at-all-inline-cutout"
  alt="A stopwatch beside two benches, the one with a single wide table finishing before the one with four small tables"
  caption="Denormalising buys read speed, and the price is paid on every write."
/>
...
<Figure
  slug="db-denormalization-inline-cutout"
  alt="Two tidy tables being deliberately copied into one wider table, with a duplicate block visible in two places and a stopwatch resting beside it"
  caption="A derived copy is a deliberate duplicate you now have to keep in step."
/>
