...
<Figure
  slug="db-thinking-in-entities-cutout"
...
<Figure
  slug="db-thinking-in-entities-inline-cutout"
  alt="A heap of mixed facts sorted into three crates, each crate holding one kind of thing and nothing else"
  caption="An entity is one kind of thing, and a crate holds that kind and nothing else."
/>
...
<Figure
  slug="db-thinking-in-entities-entity-inline-cutout"
  alt="One crate lifted out of a heap of mixed facts and set alone on a bench, its own facts placed inside it"
  caption="One entity type gets one table, with rows that are all the same kind of thing."
/>
