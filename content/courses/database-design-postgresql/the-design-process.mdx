...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Thin nested rings tighten toward a solid green center, with a small yellow marker riding the outer ring, each pass of the design process refining the schema until it settles"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="none" stroke="currentColor">
    <circle cx="320" cy="105" r="88" strokeWidth="2.5" strokeOpacity="0.2" />
    <circle cx="320" cy="105" r="58" strokeWidth="2.5" strokeOpacity="0.35" />
    <circle cx="320" cy="105" r="30" strokeWidth="2.5" strokeOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="105" r="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="382" cy="43" r="6" />
  </g>
</svg>
