...
<Figure
  slug="db-why-schemas-change-requirements-evolve-inline-cutout"
  alt="A rack of fixed shelves being re-cut, a new taller shelf slotted into the middle while the old ones shift aside"
  caption="Schemas change because the world they describe does, not because you got it wrong."
/>
...
<Figure
  ...
  caption="A new kind of fact arrives, and the cabinet has to make room for it."
/>
