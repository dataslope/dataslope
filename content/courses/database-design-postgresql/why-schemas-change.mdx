...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Translucent growth rings spread outward from a solid core, the newest ring still forming as a dotted arc with a fresh green bud — a schema growing as the software learns"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="110" r="92" fillOpacity="0.07" />
    <circle cx="320" cy="110" r="70" fillOpacity="0.12" />
    <circle cx="320" cy="110" r="46" fillOpacity="0.22" />
    <circle cx="320" cy="110" r="24" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="230" cy="162" r="3.5" />
    <circle cx="216" cy="110" r="3.5" />
    <circle cx="230" cy="58" r="3.5" />
    <circle cx="268" cy="20" r="3.5" />
    <circle cx="320" cy="6" r="3.5" />
    <circle cx="372" cy="20" r="3.5" />
    <circle cx="410" cy="58" r="3.5" />
    <circle cx="424" cy="110" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="410" cy="162" r="7" />
  </g>
</svg>
