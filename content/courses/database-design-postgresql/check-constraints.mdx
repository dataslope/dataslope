...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A translucent green band marks the allowed range on a ticked number line; values inside it sit safely while a red value outside the band falls away"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="70" y="130" width="500" height="5" rx="2.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="380" cy="145" r="2" />
    <circle cx="420" cy="145" r="2" />
    <circle cx="460" cy="145" r="2" />
    <circle cx="500" cy="145" r="2" />
    <circle cx="540" cy="145" r="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="260" y="54" width="220" height="106" rx="14" fillOpacity="0.12" />
    <rect x="260" y="54" width="220" height="8" rx="4" fillOpacity="0.4" />
    <circle cx="300" cy="112" r="9" />
    <circle cx="370" cy="92" r="9" />
    <circle cx="436" cy="112" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="150" cy="108" r="9" />
    <circle cx="150" cy="138" r="3" fillOpacity="0.5" />
    <circle cx="152" cy="158" r="3" fillOpacity="0.4" />
    <circle cx="156" cy="176" r="3" fillOpacity="0.3" />
  </g>
</svg>
