...
<Figure
  slug="db-first-normal-form-cutout"
  alt="First normal form, an isometric illustration"
/>
...
<Figure
  slug="db-first-normal-form-1nf-protects-from-inline-cutout"
  alt="A cell stuffed with three items being emptied so each takes its own row, the crowded cell left holding one"
  caption="Repeating values move into rows of their own, often in a child table."
/>
...
<Figure
  slug="db-first-normal-form-inline-cutout"
  alt="A table cell stuffed with three items being emptied so each item gets its own row beneath, the cell left holding exactly one"
  caption="First normal form means one value per cell, so a crowded cell splits into rows."
/>
