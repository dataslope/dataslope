...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Three values squeezed into a single crowded cell separate along a thin arrow into three cells holding one value each — first normal form making cells atomic"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      ...
      strokeLinecap="round"
    />
    <polygon points="336,87 336,103 350,95" fill="currentColor" />
  </g>
