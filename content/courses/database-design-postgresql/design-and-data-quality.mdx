...
<Figure
  slug="db-design-and-data-quality-data-quality-designed-inline-cutout"
  alt="A cabinet whose slots physically refuse a misshapen part, beside an open shelf holding several"
  caption="A slot shaped to refuse the wrong part is worth more than a rule in a document."
/>
...
<Figure
  slug="db-design-and-data-quality-keys-protect-identity-inline-cutout"
  alt="A rack of cards each with a distinct punched tab, one hand lifting exactly one card without disturbing the rest"
  caption="A key gives every row a handle nothing else in the table can claim."
/>
...
<Figure
  slug="db-design-and-data-quality-inline-cutout"
  alt="Two cabinets side by side, one whose slots enforce shape and one whose open shelves hold a mess of wrong parts"
  caption="Whatever the schema allows, every query and screen afterwards has to handle."
/>
