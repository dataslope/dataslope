...
<Figure
  slug="db-case-study-ecommerce-start-requirements-inline-cutout"
  alt="A bench of loose plain cards being grouped into four clusters before any frame is cut"
  caption="Requirements are grouped into candidate entities before any table is written."
/>
...
<Figure
  slug="db-case-study-ecommerce-find-entities-relationships-inline-cutout"
  alt="Four crates set on a bench with cords being run between them one at a time"
  caption="Entities first, then one relationship at a time between them."
/>
...
<Figure
  ...
  caption="Orders reach products through a table in the middle, one line per item."
/>
