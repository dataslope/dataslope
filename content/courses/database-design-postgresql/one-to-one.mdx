...
<Figure
  slug="db-one-to-one-cutout"
  alt="One-to-one relationships, an isometric illustration"
/>
...
<Figure
  slug="db-one-to-one-split-one-one-inline-cutout"
  alt="One very deep crate cut into two shallower crates joined by a single short bar"
  caption="A one-to-one split is one entity's facts held in two tables instead of one."
/>
...
<Figure
  slug="db-one-to-one-inline-cutout"
  alt="Two crates facing each other joined by a single short bar, with no free sockets left on either side"
  caption="Uniqueness on the joining column is what keeps the pairing exactly one to one."
/>
...
-- Only some users have filled in a profile, which is exactly why the
-- optional side lives in its own table.
INSERT INTO user_profiles (user_id, display_name, bio) VALUES
  (1, 'Ada', 'Profile for Ada.'),
  (2, 'Grace', 'Profile for Grace.'),
  (4, 'Mae', 'Profile for Mae.'),
  (5, 'Rosa', 'Profile for Rosa.'),
  (7, 'Nadia', 'Profile for Nadia.'),
  (9, 'Priya', 'Profile for Priya.'),
  (10, 'Quinn', 'Profile for Quinn.'),
  (12, 'Sam', 'Profile for Sam.'),
  (14, 'Uma', 'Profile for Uma.'),
  (15, 'Viktor', 'Profile for Viktor.'),
  (17, 'Xenia', 'Profile for Xenia.'),
  (19, 'Zara', 'Profile for Zara.'),
  (20, 'Bruno', 'Profile for Bruno.'),
  (22, 'Dara', 'Profile for Dara.'),
  (24, 'Farid', 'Profile for Farid.');`}
  starterCode={`SELECT
  u.email,
  p.display_name,
  p.bio
