...
description: Practice reading entities, attributes, keys, relationships, and cardinalities from a small entity-relationship model.
---
...
<Figure
  slug="db-reading-er-diagrams-cutout"
  alt="Reading an ER diagram, an isometric illustration"
/>
...
<Figure
  slug="db-reading-er-diagrams-full-model-inline-cutout"
  alt="A pinned board of five plain boxes joined by cords, some cords ending in a single peg and some splitting into prongs"
  caption="The foreign keys in a diagram predict exactly which joins a query will need."
/>
...
<Figure
  slug="db-reading-er-diagrams-inline-cutout"
  alt="A pinned board of boxes and cords with a hand following one cord and a magnifier over its end fitting"
  caption="Read the diagram one cord at a time, and check what each end is telling you."
/>
...
<Figure
  slug="db-reading-er-diagrams-read-real-schema-chinook-inline-cutout"
  alt="Four crates joined in a line by cords, artist to album to track, with a genre tag hanging off the side"
  caption="One artist, many albums, many tracks: read the crow's feet and the joins follow."
/>
