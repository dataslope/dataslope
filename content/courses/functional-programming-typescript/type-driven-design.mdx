...
<Figure
  slug="fp-type-driven-design-cutout"
  alt="Type-driven design, an isometric illustration"
/>
...
functional programming's most quoted design principles.
...
<Figure
  slug="fp-type-driven-design-inline-cutout"
  alt="A set of shaped sockets cut first, with the parts made afterwards to fit them"
  caption="Design the types first and the implementation has fewer ways to be wrong."
/>
...
<Figure
  slug="fp-type-driven-design-slogan-1-make-inline-cutout"
  alt="A set of shaped sockets cut so that an impossible pairing physically cannot be assembled"
  caption="Model the domain so that an illegal state cannot be constructed at all."
/>
