...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two grids of state cells: the left grid contains three red illegal cells among the blue, the right grid simply has gaps where those cells would be — tight types make illegal states unrepresentable instead of merely flagged"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="35" width="40" height="40" rx="8" fillOpacity="0.4" />
    <rect x="140" y="35" width="40" height="40" rx="8" fillOpacity="0.4" />
    <rect x="90" y="85" width="40" height="40" rx="8" fillOpacity="0.4" />
    <rect x="90" y="135" width="40" height="40" rx="8" fillOpacity="0.4" />
    <rect x="140" y="135" width="40" height="40" rx="8" fillOpacity="0.4" />
    <rect x="190" y="135" width="40" height="40" rx="8" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="190" y="35" width="40" height="40" rx="8" fillOpacity="0.6" />
    <rect x="140" y="85" width="40" height="40" rx="8" fillOpacity="0.6" />
    <rect x="190" y="85" width="40" height="40" rx="8" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="285" cy="105" r="3.5" />
    <circle cx="305" cy="105" r="3.5" />
    <polygon points="325,97 339,105 325,113" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="380" y="35" width="40" height="40" rx="8" fillOpacity="0.55" />
    <rect x="430" y="35" width="40" height="40" rx="8" fillOpacity="0.55" />
    <rect x="380" y="85" width="40" height="40" rx="8" fillOpacity="0.55" />
    <rect x="380" y="135" width="40" height="40" rx="8" fillOpacity="0.55" />
    <rect x="430" y="135" width="40" height="40" rx="8" fillOpacity="0.55" />
    <rect x="480" y="135" width="40" height="40" rx="8" fillOpacity="0.55" />
  </g>
  <g fill="currentColor" opacity="0.06">
    <rect x="480" y="35" width="40" height="40" rx="8" />
    <rect x="430" y="85" width="40" height="40" rx="8" />
    <rect x="480" y="85" width="40" height="40" rx="8" />
  </g>
</svg>

## Slogan 1 — "Make illegal states unrepresentable"

The phrase comes from Yaron Minsky of Jane Street, the trading firm
that famously runs its entire business on OCaml — an environment
where a software bug can lose millions of dollars before a human
notices. His advice for surviving that environment became one of
FP's most quoted design principles.

The idea: if your data model can *express* a state that should never
exist, sooner or later your program will get into that state. The
fix is to redesign the type so the bad state cannot be written.
...
This slogan is the title of a 2019 essay by Alexis King that became
one of the most-shared pieces of writing in the typed-FP world —
required reading in many teams' onboarding documents. The essay's
insight fits in one sentence:
...
\`\`\``}
  ...
  files={[
    {
      filename: "main.ts",
      starterCode: `import { Checkout, next } from "./checkout";
...
`,
    },
    {
      ...
      starterCode: `type Item = { sku: string; qty: number };
...
`,
      solutionCode: `type Item = { sku: string; qty: number };
