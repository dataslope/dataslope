...
JavaScript's `Promise` is a good citizen of the functional world,
*almost*.
...
<Figure
  slug="fp-async-workflows-cutout"
  alt="Functional async workflows, an isometric illustration"
/>
...
<Figure
  slug="fp-functional-async-workflows-tasks-their-three-inline-cutout"
  alt="Three kettles started together with three small tools hanging above them, one to start, one to chain, one to gather"
  caption="Three operators carry all of it: one to start, one to chain, one to gather."
/>
...
<Figure
  slug="fp-functional-async-workflows-inline-cutout"
  alt="Several slow kettles started at once along a bench, their results collected into one tray as each finishes"
  caption="Parallel work is collected into one result as each piece completes."
/>
