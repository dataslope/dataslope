...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="On the left a capsule welds a circle and a square together into one value; on the right two dotted trails fork into a single socket bay where a triangle sits while a circle waits, products mean and, sums mean or"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="80" width="170" height="70" rx="35" fillOpacity="0.12" />
    <circle cx="150" cy="115" r="20" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="168" y="97" width="36" height="36" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <circle cx="320" cy="70" r="3.5" />
    <circle cx="320" cy="110" r="3.5" />
    <circle cx="320" cy="150" r="3.5" />
    <rect x="478" y="118" width="116" height="54" rx="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="390" cy="52" r="14" />
    <circle cx="424" cy="72" r="3" fillOpacity="0.45" />
    <circle cx="456" cy="92" r="3" fillOpacity="0.45" />
    <circle cx="488" cy="112" r="3" fillOpacity="0.45" />
    <circle cx="514" cy="128" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="376,160 404,176 376,192" fillOpacity="0.5" />
    <circle cx="428" cy="168" r="3" fillOpacity="0.45" />
    <circle cx="458" cy="158" r="3" fillOpacity="0.45" />
    <circle cx="488" cy="150" r="3" fillOpacity="0.45" />
    <polygon points="520,128 552,145 520,162" />
  </g>
</svg>
