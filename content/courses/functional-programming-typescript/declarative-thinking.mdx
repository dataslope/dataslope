...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A card of numbered step bars next to a card holding one finished flower of circles — imperative code lists the steps, declarative code states the result"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="70" y="35" width="200" height="140" rx="14" />
    <rect x="375" y="35" width="200" height="140" rx="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="98" cy="64" r="4.5" fillOpacity="0.7" />
    <circle cx="98" cy="92" r="4.5" fillOpacity="0.7" />
    <circle cx="98" cy="120" r="4.5" fillOpacity="0.7" />
    <circle cx="98" cy="148" r="4.5" fillOpacity="0.7" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="114" y="59" width="118" height="10" rx="5" />
    <rect x="114" y="87" width="92" height="10" rx="5" />
    <rect x="114" y="115" width="130" height="10" rx="5" />
    <rect x="114" y="143" width="78" height="10" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="300" cy="105" r="3.5" />
    <circle cx="318" cy="105" r="3.5" />
    <polygon points="338,97 352,105 338,113" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="475" cy="105" r="20" />
    <circle cx="511" cy="105" r="9" fillOpacity="0.65" />
    <circle cx="493" cy="136" r="9" fillOpacity="0.65" />
    <circle cx="457" cy="136" r="9" fillOpacity="0.65" />
    <circle cx="439" cy="105" r="9" fillOpacity="0.65" />
    <circle cx="457" cy="74" r="9" fillOpacity="0.65" />
    <circle cx="493" cy="74" r="9" fillOpacity="0.65" />
  </g>
</svg>
...
| --- | --- | --- |
| Building blocks | loop variables, accumulators, `for`/`if` | data and named transformations |
| The result | emerges from executing the steps | *is* the expression you wrote |
| To understand it | simulate the steps in your head | read the pipeline like a sentence |
...
const ranked = Object.entries(byCustomer).sort(([, a], [, b]) => b - a);
...
const errors = Object.entries(fields)
  .map(([name, rule]) =>
    validate(
      name,
      (
        { email: "x", password: "short", bio: undefined } as Record<
          string,
          string
        >
      )[name],
...
\`\`\``}
  ...
  files={[
    {
      filename: "main.ts",
      starterCode: `import { avgPerCategory, type Sale } from "./stats";
...
`,
    ...
    {
      filename: "stats.ts",
      starterCode: `export type Sale = { readonly category: string; readonly amount: number };
...
`,
      solutionCode: `export type Sale = { readonly category: string; readonly amount: number };
