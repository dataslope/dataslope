...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A plate with a circular and a square socket: a circle glides toward its hole, a square already sits snugly, and a triangle bounces away — types as shaped sockets that admit only matching values"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <path d="M360 25 H480 V185 H360 Z M442 75 A22 22 0 1 0 398 75 A22 22 0 1 0 442 75 Z M398 125 H442 V169 H398 Z" fillRule="evenodd" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="150" cy="75" r="3.5" fillOpacity="0.3" />
    <circle cx="180" cy="75" r="3.5" fillOpacity="0.4" />
    <circle cx="210" cy="75" r="3.5" fillOpacity="0.5" />
    <circle cx="252" cy="75" r="20" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="402" y="129" width="36" height="36" rx="6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="296,126 330,146 298,162" />
    <circle cx="264" cy="138" r="3.5" fillOpacity="0.5" />
    <circle cx="240" cy="132" r="3" fillOpacity="0.35" />
  </g>
</svg>

## Try it: the same problem, two shapes

Everything in this course runs in your browser — every code block
is type-checked, transpiled, and executed on the page, with nothing
to install. Here are two programs that solve the same problem:
*"From a list of orders, keep the paid ones, take their totals, and
sum them."* The first is classic imperative style. Run it:
...
Now the functional version — same data, same answer:
...
Both print `100`. But the second reads like the English sentence we
started from: *"From orders, keep the paid ones, take their totals,
sum them."* Try changing `"paid"` to `"draft"` in either block and
re-running. That alignment between intention and code is what this
entire course is about — and the coming chapters give you the
principles and the type-level vocabulary to achieve it for problems
much harder than a sum of integers.
