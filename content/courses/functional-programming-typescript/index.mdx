...
<Figure
  slug="functional-programming-typescript-thumbnail-cutout"
  alt="Functional Programming with TypeScript, an isometric illustration"
/>

This course is intentionally **not** a tour of functional programming
libraries. We
