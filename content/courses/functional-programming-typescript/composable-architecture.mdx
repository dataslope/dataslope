...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A walled keep holds orderly blue dots inside; scattered effect shapes wait outside and a dotted queue passes through the single gate in the wall, a pure core that touches the world through one controlled opening"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="180" y="40" width="280" height="10" rx="5" fillOpacity="0.3" />
    <rect x="180" y="180" width="280" height="10" rx="5" fillOpacity="0.3" />
    <rect x="180" y="40" width="10" height="150" rx="5" fillOpacity="0.3" />
    <rect x="450" y="40" width="10" height="55" rx="5" fillOpacity="0.3" />
    <rect x="450" y="135" width="10" height="55" rx="5" fillOpacity="0.3" />
    <circle cx="240" cy="95" r="9" fillOpacity="0.8" />
    <circle cx="300" cy="95" r="9" fillOpacity="0.8" />
    <circle cx="360" cy="95" r="9" fillOpacity="0.8" />
    <circle cx="240" cy="140" r="9" fillOpacity="0.8" />
    <circle cx="300" cy="140" r="9" fillOpacity="0.8" />
    <circle cx="360" cy="140" r="9" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="544" cy="115" r="3.5" />
    <circle cx="514" cy="115" r="3.5" />
    <circle cx="484" cy="115" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="556" y="52" width="22" height="22" rx="6" />
    <circle cx="538" cy="186" r="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="586,140 608,152 586,164" />
  </g>
</svg>
