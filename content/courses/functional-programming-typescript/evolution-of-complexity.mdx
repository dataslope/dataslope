...
way. The constraints that drove functional programming into the mainstream
were not
...
<Figure
  ...
  caption="Software grew from single scripts into systems of interacting parts."
/>
...
<Figure
  ...
  caption="Complexity arrives through additions, each reasonable on its own."
/>
