...
<Figure
  ...
  alt="A translator mechanism with raw numeric tokens entering one side and pixel positions and colour swatches leaving the other"
/>
...
<Figure
  ...
  alt="A raw block of data on the left passing through a gauge in the middle that converts it into a position, a size and a colour on the right"
  caption="A scale converts data values into the position, size or colour drawn."
/>
