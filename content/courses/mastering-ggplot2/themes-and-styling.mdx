...
<Figure
  slug="gg-themes-cutout"
  alt="A chart on a platform with its gridlines, background panel and border lifting away as separate skins, the data marks untouched"
/>
...
That grey panel is ggplot2's signature, and also the thing people most
often want to change. `theme_minimal()` strips it out:
...
Lighter, and the data now sits on white rather than grey. If you want
something closer to a printed journal figure, drop the grid as well:
...
<Figure
  slug="gg-themes-and-styling-inline-cutout"
  alt="The same finished plot shown three times in three different framings, the data marks identical in each"
  caption="A theme restyles everything around the data and leaves the marks alone."
/>
...
<Figure
  slug="gg-themes-and-styling-theme-inheritance-inline-cutout"
  alt="One setting at the top of a tree of fittings, changed once and taking effect in every fitting below it"
  caption="Theme elements inherit, which is why one small call changes so much at once."
/>
