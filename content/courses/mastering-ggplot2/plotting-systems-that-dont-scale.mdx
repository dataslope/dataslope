...
<Figure
  slug="gg-plotting-systems-that-dont-scale-draw-one-thing-inline-cutout"
  alt="A figure setting one solid block at a time onto a deeply inked panel, with a long queue of blocks still waiting in a tray on the bench beside them"
  caption="Drawing one thing at a time does not scale to a chart with many groups."
/>
...
<Figure
  slug="gg-plotting-systems-that-dont-scale-we-actually-want-inline-cutout"
  alt="One written specification naming a tray, a set of mappings and two kinds of mark, with the picture assembling itself beside it"
  caption="Name the data, the mappings and the marks, and the picture follows from the sentence."
/>
