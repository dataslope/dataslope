...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two single-purpose chart widgets branch into four, then into eight ever-smaller widgets, one per chart type, ending in a red dashed empty slot for the chart no function covers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="246" y1="72" x2="163" y2="84" />
    <line x1="246" y1="72" x2="271" y2="84" />
    <line x1="394" y1="72" x2="379" y2="84" />
    <line x1="394" y1="72" x2="487" y2="84" />
    <line x1="163" y1="132" x2="75" y2="144" />
    <line x1="163" y1="132" x2="145" y2="144" />
    <line x1="271" y1="132" x2="215" y2="144" />
    <line x1="271" y1="132" x2="285" y2="144" />
    <line x1="379" y1="132" x2="355" y2="144" />
    <line x1="379" y1="132" x2="425" y2="144" />
    <line x1="487" y1="132" x2="495" y2="144" />
    <line x1="487" y1="132" x2="565" y2="144" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="186" y="24" width="120" height="48" rx="9" fillOpacity="0.08" />
    <circle cx="216" cy="56" r="4.5" />
    <circle cx="242" cy="40" r="4.5" />
    <circle cx="268" cy="50" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="334" y="24" width="120" height="48" rx="9" fillOpacity="0.08" />
    <rect x="366" y="44" width="10" height="20" rx="2" />
    <rect x="384" y="36" width="10" height="28" rx="2" />
    <rect x="402" y="50" width="10" height="14" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="118" y="84" width="90" height="48" rx="9" fillOpacity="0.12" />
    <rect x="140" y="105.5" width="46" height="5" rx="2.5" transform="rotate(-16 163 108)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="226" y="84" width="90" height="48" rx="9" fillOpacity="0.08" />
    <circle cx="271" cy="108" r="12" fill="none" stroke="currentColor" strokeWidth="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="334" y="84" width="90" height="48" rx="9" fillOpacity="0.08" />
    <circle cx="357" cy="116" r="4" />
    <circle cx="379" cy="102" r="4" />
    <circle cx="401" cy="112" r="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="442" y="84" width="90" height="48" rx="9" fillOpacity="0.08" />
    <rect x="466" y="100" width="9" height="20" rx="2" />
    <rect x="482" y="94" width="9" height="26" rx="2" />
    <rect x="498" y="106" width="9" height="14" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="45" y="144" width="60" height="44" rx="9" fillOpacity="0.08" />
    <circle cx="75" cy="166" r="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="115" y="144" width="60" height="44" rx="9" fillOpacity="0.08" />
    <rect x="140" y="154" width="10" height="24" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="185" y="144" width="60" height="44" rx="9" fillOpacity="0.12" />
    <rect x="196" y="164" width="38" height="4" rx="2" transform="rotate(-15 215 166)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="255" y="144" width="60" height="44" rx="9" fillOpacity="0.08" />
    <circle cx="285" cy="166" r="9" fill="none" stroke="currentColor" strokeWidth="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="325" y="144" width="60" height="44" rx="9" fillOpacity="0.08" />
    <circle cx="345" cy="170" r="3.5" />
    <circle cx="365" cy="160" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="395" y="144" width="60" height="44" rx="9" fillOpacity="0.12" />
    <rect x="420" y="152" width="10" height="26" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="465" y="144" width="60" height="44" rx="9" fillOpacity="0.08" />
    <polygon points="495,156 486,176 504,176" />
  </g>
  <rect x="535" y="144" width="60" height="44" rx="9" fill="none" stroke="var(--ds-red-500)" strokeWidth="2" strokeDasharray="6 5" />
</svg>
