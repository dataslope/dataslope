...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two variable chips send thin lines down to a shelf of five small geom cards, dots, a line, bars, a boxplot, and an area, with the bar card ringed in yellow: the variables choose the geom"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="252" y1="47" x2="310" y2="86" />
    <line x1="358" y1="47" x2="330" y2="86" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="210" y="25" width="70" height="20" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="330" y="25" width="70" height="20" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.06">
    <rect x="54" y="88" width="92" height="80" rx="10" />
    <rect x="164" y="88" width="92" height="80" rx="10" />
    <rect x="384" y="88" width="92" height="80" rx="10" />
    <rect x="494" y="88" width="92" height="80" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="274" y="88" width="92" height="80" rx="10" fillOpacity="0.1" />
    <circle cx="78" cy="140" r="4" />
    <circle cx="96" cy="120" r="4" />
    <circle cx="114" cy="132" r="4" />
    <rect x="290" y="128" width="14" height="32" rx="3" />
    <rect x="310" y="112" width="14" height="48" rx="3" />
    <rect x="330" y="138" width="14" height="22" rx="3" />
  </g>
  <rect x="274" y="88" width="92" height="80" rx="10" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" />
  <polyline points="182,142 204,118 226,130 244,108" fill="none" stroke="var(--ds-green-500)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="414" y="112" width="34" height="26" rx="5" />
    <rect x="429.5" y="96" width="3" height="16" rx="1.5" />
    <rect x="429.5" y="138" width="3" height="16" rx="1.5" />
  </g>
  <path d="M500 158 C 520 120, 550 136, 580 114 L580 158 Z" fill="var(--ds-green-500)" fillOpacity="0.35" />
</svg>
