...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A solid blue square, the founding grammar, branches along thin gray lines into three cards holding the primitives it defined: a point, a bar, and a sloped line"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="320" y1="74" x2="172" y2="128" />
    <line x1="320" y1="74" x2="320" y2="128" />
    <line x1="320" y1="74" x2="468" y2="128" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="48" r="44" fillOpacity="0.08" />
    <rect x="294" y="22" width="52" height="52" rx="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="128" width="104" height="64" rx="12" fillOpacity="0.08" />
    <circle cx="172" cy="160" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="268" y="128" width="104" height="64" rx="12" fillOpacity="0.08" />
    <rect x="313" y="146" width="14" height="32" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="416" y="128" width="104" height="64" rx="12" fillOpacity="0.12" />
    <rect x="444" y="157.5" width="48" height="5" rx="2.5" transform="rotate(-18 468 160)" />
  </g>
</svg>
