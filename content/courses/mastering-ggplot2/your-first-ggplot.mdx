...
<Figure
  slug="gg-first-plot-cutout"
  alt="The Dataslope marmot mascot slotting three component blocks into the base of an empty plotting frame as a scatter of dots appears on it"
/>
...
<Figure
  slug="gg-your-first-ggplot-inline-cutout"
  alt="A bare framed board with one layer of chips laid onto it, the frame otherwise empty"
  caption="Data and mappings alone give you a frame; the geom is what draws on it."
/>
