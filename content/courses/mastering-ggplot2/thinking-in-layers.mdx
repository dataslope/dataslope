...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="An exploded isometric stack of three layer planes — blue points at the bottom, a green trend in the middle, a yellow title bar on top — threaded by a thin gray axis, with a small gray arrow to the flat combined chart they produce"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="250" y1="14" x2="250" y2="216" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="140,178 250,138 360,178 250,218" fillOpacity="0.25" />
    <circle cx="215" cy="180" r="5" />
    <circle cx="250" cy="170" r="5" />
    <circle cx="285" cy="184" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="140,116 250,76 360,116 250,156" fillOpacity="0.25" />
    <path d="M 196 124 C 224 112 278 118 306 104" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="140,54 250,14 360,54 250,94" fillOpacity="0.3" />
    <rect x="222" y="50.5" width="56" height="7" rx="3.5" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="376" y="123.5" width="36" height="3" rx="1.5" />
    <polygon points="410,119.5 421,125 410,130.5" />
  </g>
  <rect x="440" y="70" width="170" height="110" rx="12" fill="currentColor" opacity="0.06" />
  <rect x="456" y="84" width="52" height="7" rx="3.5" fill="var(--ds-yellow-500)" />
  <path d="M 458 158 C 490 150 540 132 594 116" fill="none" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="478" cy="150" r="4.5" />
    <circle cx="516" cy="140" r="4.5" />
    <circle cx="554" cy="126" r="4.5" />
  </g>
</svg>
