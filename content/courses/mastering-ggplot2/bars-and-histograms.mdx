...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="The same two-color bars three ways — side by side (dodge), stacked, and stretched to a common full height (fill) — three position adjustments of one data set"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="40" y="30" width="170" height="150" rx="10" opacity="0.07" />
    <rect x="235" y="30" width="170" height="150" rx="10" opacity="0.07" />
    <rect x="430" y="30" width="170" height="150" rx="10" opacity="0.07" />
    <rect x="55" y="158" width="140" height="3" rx="1.5" opacity="0.2" />
    <rect x="250" y="158" width="140" height="3" rx="1.5" opacity="0.2" />
    <rect x="445" y="158" width="140" height="3" rx="1.5" opacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="72" y="104" width="16" height="54" rx="3" />
    <rect x="132" y="123" width="16" height="35" rx="3" />
    <rect x="285" y="74" width="24" height="54" rx="3" />
    <rect x="337" y="68" width="24" height="35" rx="3" />
    <rect x="482" y="58" width="24" height="62" rx="3" />
    <rect x="532" y="58" width="24" height="39" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="90" y="128" width="16" height="30" rx="3" />
    <rect x="150" y="103" width="16" height="55" rx="3" />
    <rect x="285" y="128" width="24" height="30" rx="3" />
    <rect x="337" y="103" width="24" height="55" rx="3" />
    <rect x="482" y="120" width="24" height="38" rx="3" />
    <rect x="532" y="97" width="24" height="61" rx="3" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="470" cy="50" r="2.5" />
    <circle cx="496" cy="50" r="2.5" />
    <circle cx="522" cy="50" r="2.5" />
    <circle cx="548" cy="50" r="2.5" />
    <circle cx="574" cy="50" r="2.5" />
  </g>
</svg>
