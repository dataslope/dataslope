...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="The same two-color bars three ways, side by side (dodge), stacked, and stretched to a common full height under a dashed line (fill), three position adjustments of one data set"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="72" y="100" width="18" height="60" rx="3" />
    <rect x="134" y="118" width="18" height="42" rx="3" />
    <rect x="283" y="76" width="26" height="48" rx="3" />
    <rect x="337" y="64" width="26" height="42" rx="3" />
    <rect x="478" y="40" width="26" height="72" rx="3" />
    <rect x="532" y="40" width="26" height="45" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="94" y="124" width="18" height="36" rx="3" />
    <rect x="156" y="94" width="18" height="66" rx="3" />
    <rect x="283" y="124" width="26" height="36" rx="3" />
    <rect x="337" y="106" width="26" height="54" rx="3" />
    <rect x="478" y="112" width="26" height="48" rx="3" />
    <rect x="532" y="85" width="26" height="75" rx="3" />
  </g>
  <line x1="445" y1="40" x2="585" y2="40" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="6 6" strokeLinecap="round" />
</svg>
