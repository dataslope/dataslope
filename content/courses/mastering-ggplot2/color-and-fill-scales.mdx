...
<Figure
  ...
  alt="A palette wheel of discrete brand-colored chips beside a smooth continuous gradient ramp rising from a platform"
/>
...
<Figure
  ...
  alt="An outline shape with its edge inked one color and its interior inked another, with two separate legend strips of graded swatches standing beside it"
...
survive a red-green color deficiency:
