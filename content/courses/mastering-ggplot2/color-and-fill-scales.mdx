...
<Figure
  slug="gg-color-and-fill-scales-discrete-vs-continuous-inline-cutout"
  alt="A strip of separate distinct swatches beside a strip grading smoothly from pale to deep"
  caption="Categorical data wants distinct hues; continuous data wants a gradient."
/>
...
<Figure
  slug="gg-color-and-fill-scales-inline-cutout"
  alt="An outline shape with its edge inked one colour and its interior inked another, with two separate legend strips of graded swatches standing beside it"
  caption="`color` inks the outline and `fill` inks the interior, with a legend for each."
/>
