...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="An abstract arrangement of brand shapes — a pale blue disc, a bold green ring overlapping it, a solid yellow circle, a small blue dot, and a tilted yellow bar — closing the course on a playful, open-ended note"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="250" cy="110" r="85" fillOpacity="0.12" />
  </g>
  <circle cx="350" cy="110" r="60" fill="none" stroke="var(--ds-green-500)" strokeWidth="10" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="452" cy="66" r="24" />
    <rect x="120" y="160" width="140" height="10" rx="5" transform="rotate(-18 190 165)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="438" cy="152" r="14" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="175" cy="56" r="8" />
  </g>
</svg>
