...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="From one solid trunk, three bright limbs fan upward to green, yellow, and blue branch tips whose dots keep climbing off the top of the picture — the foundation is planted; now pick a direction and keep growing"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="240" y="218" width="160" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="312" y="150" width="16" height="70" rx="8" fillOpacity="0.85" />
    <rect x="166" y="108" width="162" height="12" rx="6" fillOpacity="0.45" transform="rotate(26.4 247 114)" />
    <rect x="259" y="93" width="102" height="12" rx="6" fillOpacity="0.45" transform="rotate(78.9 310 99)" />
    <rect x="312" y="110" width="160" height="12" rx="6" fillOpacity="0.45" transform="rotate(-25.1 392 116)" />
    <circle cx="470" cy="76" r="15" />
    <circle cx="498" cy="52" r="6" fillOpacity="0.4" />
    <circle cx="520" cy="34" r="4" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="170" cy="70" r="15" />
    <circle cx="140" cy="46" r="6" fillOpacity="0.4" />
    <circle cx="116" cy="28" r="4" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="298" cy="40" r="15" />
    <circle cx="282" cy="14" r="6" fillOpacity="0.4" />
  </g>
</svg>
