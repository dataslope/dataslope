...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Along one thin timeline, a tiny blue dot grows into a green dot, then a yellow disc, and finally a large haloed blue circle, a holiday hobby project growing into Python"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="80" y1="110" x2="560" y2="110" stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="130" cy="110" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="250" cy="110" r="13" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="380" cy="110" r="19" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="510" cy="110" r="42" fillOpacity="0.12" />
    <circle cx="510" cy="110" r="28" />
  </g>
</svg>
