...
Python did not begin as a product, a research grant, or a committee
specification. It began because one person had a quiet fortnight and an
itch to scratch.
...
<Figure
  ...
  caption="Python holds a block together with indentation where other languages use braces."
/>
...
<Figure
  ...
  caption="Mixing tabs and spaces gives two step sizes that will not stack together."
/>
...
## From Benevolent Dictator to Steering Council
...
## The Global Interpreter Lock: Python's longest-running debate
