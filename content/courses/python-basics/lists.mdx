...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A tray of ordered slots holds a blue circle, a green square, a yellow triangle, and a blue bar, while a new green dot drops down a thin arrow into the one dashed empty slot mid-row, a list keeps order, holds anything, and accepts change anywhere"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="316" cy="40" r="11" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="314.5" y="60" width="3" height="34" rx="1.5" />
    <polygon points="310.5,92 321.5,92 316,103" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="110" width="480" height="70" rx="16" fillOpacity="0.1" />
  </g>
  <g fill="currentColor" opacity="0.06">
    <rect x="100" y="122" width="72" height="46" rx="10" />
    <rect x="190" y="122" width="72" height="46" rx="10" />
    <rect x="370" y="122" width="72" height="46" rx="10" />
    <rect x="460" y="122" width="72" height="46" rx="10" />
  </g>
  <rect x="280" y="122" width="72" height="46" rx="10" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="136" cy="145" r="11" />
    <rect x="478" y="139" width="36" height="12" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="214" y="133" width="24" height="24" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="406,134 420,158 392,158" />
  </g>
</svg>
