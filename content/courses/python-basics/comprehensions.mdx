...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A blue capsule of four dots feeds through one solid green machine and emerges as a green capsule of three squares, a comprehension loops, filters, and transforms in a single expression"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="70" width="170" height="50" rx="25" fillOpacity="0.12" />
    <circle cx="92" cy="95" r="8" />
    <circle cx="130" cy="95" r="8" />
    <circle cx="168" cy="95" r="8" />
    <circle cx="206" cy="95" r="8" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="246" y="93.5" width="40" height="3" rx="1.5" />
    <polygon points="284,89.5 295,95 284,100.5" />
    <rect x="358" y="93.5" width="40" height="3" rx="1.5" />
    <polygon points="396,89.5 407,95 396,100.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="300" y="65" width="44" height="60" rx="12" />
    <rect x="412" y="70" width="168" height="50" rx="25" fillOpacity="0.12" />
    <rect x="440" y="87" width="16" height="16" rx="5" />
    <rect x="478" y="87" width="16" height="16" rx="5" />
    <rect x="516" y="87" width="16" height="16" rx="5" />
  </g>
</svg>
