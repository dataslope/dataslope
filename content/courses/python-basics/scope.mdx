...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A seeker dot walks under ever-larger arches and stops at the third, where its green match waits — Python checks Local, Enclosing, Global, then Built-in, and the first name found wins"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="80" y="166" width="500" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="138" y="110" width="10" height="50" rx="4" fillOpacity="0.3" />
    <rect x="172" y="110" width="10" height="50" rx="4" fillOpacity="0.3" />
    <rect x="134" y="100" width="52" height="12" rx="6" fillOpacity="0.3" />
    <rect x="240" y="90" width="10" height="70" rx="4" fillOpacity="0.25" />
    <rect x="292" y="90" width="10" height="70" rx="4" fillOpacity="0.25" />
    <rect x="236" y="80" width="72" height="12" rx="6" fillOpacity="0.25" />
    <rect x="356" y="72" width="11" height="88" rx="4" fillOpacity="0.2" />
    <rect x="420" y="72" width="11" height="88" rx="4" fillOpacity="0.2" />
    <rect x="352" y="60" width="85" height="13" rx="6" fillOpacity="0.2" />
    <rect x="488" y="55" width="12" height="105" rx="4" fillOpacity="0.1" />
    <rect x="556" y="55" width="12" height="105" rx="4" fillOpacity="0.1" />
    <rect x="484" y="42" width="90" height="14" rx="7" fillOpacity="0.1" />
    <circle cx="336" cy="152" r="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="92" cy="152" r="3" />
    <circle cx="120" cy="152" r="3" />
    <circle cx="160" cy="152" r="3" />
    <circle cx="196" cy="152" r="3" />
    <circle cx="232" cy="152" r="3" />
    <circle cx="266" cy="152" r="3" />
    <circle cx="310" cy="152" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="393" cy="148" r="17" fillOpacity="0.15" />
    <circle cx="393" cy="148" r="11" />
  </g>
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `list = [1, 2, 3]  # bad: list() no longer works in this scope
print(list)
try:
    print(list((4, 5, 6)))
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `def multiplier(factor):
    def inner(x):
...
<ChallengeCard
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `def make_multipliers():
    multipliers = []
    for i in range(1, 4):
...
- [o] Local, Enclosing, Global, Built-in (LEGB)
  > Local first, then any enclosing functions, then the module's globals, then the built-ins.
- Local, Global only
...
- [o] \`outer: 3\\nmodule: 1\`
  > \`inner\` rebinds \`outer\`'s \`x\` to 3; the module-level \`x\` is untouched.
- \`outer: 3\\nmodule: 3\`
...
- [o] Because \`count += 1\` creates a local variable, which is read before it's assigned.
  > Python sees an assignment to \`count\` and makes it local. Then it tries to read \`count\` for the \`+=\`, but there's no local value yet.
...
- [o] A function that captures variables from its enclosing scope.
  > A closure remembers variables from the scope in which it was created, even after that scope exits.
...
- [o] Use the \`nonlocal\` keyword.
  > \`nonlocal\` tells Python to rebind a variable in the nearest enclosing function scope.
