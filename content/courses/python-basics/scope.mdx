...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four nested translucent panels shrink toward the innermost local box, where a blue dot starts looking; its green match sits one layer out — Python searches local, enclosing, global, then built-in, and the first name found wins"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="20" width="480" height="180" rx="18" fillOpacity="0.06" />
    <rect x="130" y="45" width="380" height="130" rx="16" fillOpacity="0.1" />
    <rect x="180" y="70" width="280" height="80" rx="14" fillOpacity="0.15" />
    <rect x="230" y="90" width="150" height="40" rx="12" fillOpacity="0.22" />
    <circle cx="280" cy="110" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="422" cy="110" r="9" />
  </g>
</svg>
