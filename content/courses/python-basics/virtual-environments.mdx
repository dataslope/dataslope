...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two rooms hold their own copies of the same packages, the blue circle small in one and much larger in the other, the yellow dot present only on the left, with a solid wall between them: each project keeps its own isolated installs"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="40" width="210" height="130" rx="16" fillOpacity="0.1" />
    <circle cx="130" cy="105" r="14" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="190" y="90" width="26" height="26" rx="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="238" cy="140" r="8" />
  </g>
  <rect x="316" y="40" width="8" height="130" rx="4" fill="var(--ds-gray-300)" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="360" y="40" width="210" height="130" rx="16" fillOpacity="0.1" />
    <rect x="490" y="92" width="26" height="26" rx="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="430" cy="105" r="22" />
  </g>
</svg>
