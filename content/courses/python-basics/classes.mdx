...
<Figure
  slug="python-basics-classes-cutout"
  alt="An architect's blueprint of a small robot pinned to a drafting board, with a finished toy robot standing beside it"
/>

<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A faint master disc presses three records below it, identical grooves, each finished with a white center label, a class is the master, and every instance is pressed from it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <circle cx="320" cy="64" r="46" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <circle cx="320" cy="64" r="33" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <circle cx="320" cy="64" r="20" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="320" cy="64" r="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="150" cy="170" r="34" fillOpacity="0.3" />
    <circle cx="150" cy="170" r="25" fillOpacity="0.3" />
    <circle cx="150" cy="170" r="16" fillOpacity="0.3" />
    <circle cx="320" cy="170" r="34" fillOpacity="0.3" />
    <circle cx="320" cy="170" r="25" fillOpacity="0.3" />
    <circle cx="320" cy="170" r="16" fillOpacity="0.3" />
    <circle cx="490" cy="170" r="34" fillOpacity="0.3" />
    <circle cx="490" cy="170" r="25" fillOpacity="0.3" />
    <circle cx="490" cy="170" r="16" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="150" cy="170" r="9" fillOpacity="0.9" />
    <circle cx="320" cy="170" r="9" fillOpacity="0.9" />
    <circle cx="490" cy="170" r="9" fillOpacity="0.9" />
  </g>
</svg>
...
\`main.py\` uses your class. Do not edit \`main.py\`.`}
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `from account import BankAccount
...
\`main.py\` uses both. Do not edit \`main.py\`.`}
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `from product import Product
...
\`main.py\` uses your class. Do not edit \`main.py\`.`}
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `from geometry import Point
...
- [o] It is the conventional name for the first parameter, which receives the instance.
  > Python passes the instance automatically; we name it \`self\` by convention.
...
- [o] \`__init__\`, \`__repr__\`, and \`__eq__\` (and optionally \`__hash__\` if \`frozen=True\`).
  > Dataclasses reduce boilerplate for data-holding classes by generating these methods from the annotated fields.
...
- [o] \`__repr__\` is unambiguous for developers; \`__str__\` is user-friendly.
  > \`__repr__\` should ideally let you reconstruct the object; \`__str__\` is what \`print()\` uses.
...
- [o] When the method needs to access the class itself, often for alternative constructors.
  > \`@classmethod\` is commonly used for factory methods that return \`cls(...)\`.
...
- [o] Instances become unhashable and cannot be used as dict keys or in sets.
  > If \`__eq__\` is defined but \`__hash__\` is not, \`__hash__\` is set to \`None\`, making instances unhashable.
...
- [o] The change is visible in all instances because they share the same list object.
  > Mutable class attributes are a common gotcha. Always initialize mutable per-instance data in \`__init__\`.
