...
>
  <g fill="currentColor" opacity="0.25">
    ...
    <circle cx="106" cy="92" r="3" />
    <circle cx="237" cy="92" r="3" />
    <circle cx="392" cy="92" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="160" cy="92" r="30" fillOpacity="0.14" />
    <circle cx="160" cy="92" r="10" />
    <circle cx="205" cy="92" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="92" r="30" fillOpacity="0.14" />
    <circle cx="320" cy="92" r="10" />
    <circle cx="262" cy="92" r="3.5" fillOpacity="0.5" />
    <circle cx="365" cy="92" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="480" cy="92" r="30" fillOpacity="0.14" />
    <circle cx="480" cy="92" r="10" />
    <circle cx="422" cy="92" r="3.5" fillOpacity="0.5" />
    <circle cx="525" cy="92" r="3" fillOpacity="0.4" />
    <circle cx="552" cy="92" r="2.5" fillOpacity="0.3" />
    <circle cx="578" cy="92" r="2" fillOpacity="0.2" />
  </g>
