...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three module cards sit above a program card, and thin lines carry down only the blue circle and the yellow triangle while the green square stays put, import brings in just the pieces your program asks for"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="145" y1="88" x2="272" y2="138" />
    <line x1="495" y1="88" x2="368" y2="138" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="28" width="110" height="56" rx="12" fillOpacity="0.12" />
    <circle cx="145" cy="56" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="265" y="28" width="110" height="56" rx="12" fillOpacity="0.12" />
    <rect x="309" y="45" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="440" y="28" width="110" height="56" rx="12" fillOpacity="0.16" />
    <polygon points="495,46 508,68 482,68" />
  </g>
  <rect x="170" y="138" width="300" height="62" rx="14" fill="currentColor" opacity="0.06" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="285" cy="169" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="355,158 368,180 342,180" />
  </g>
</svg>
