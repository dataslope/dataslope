...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A blue capsule crowded with pale dots releases through a small slot onto a thin gray arrow, where solid green dots line up one after another — an iterator hands over one value per next call and keeps the rest waiting"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="45" width="190" height="100" rx="18" fillOpacity="0.1" />
  </g>
  ...
  <rect x="254" y="78" width="8" height="34" rx="4" fill="var(--ds-gray-300)" />
  <g fill="var(--ds-gray-400)">
    <rect x="272" y="93.5" width="46" height="3" rx="1.5" />
    <polygon points="316,89.5 327,95 316,100.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="352" cy="95" r="9" />
    <circle cx="404" cy="95" r="9" />
    <circle cx="456" cy="95" r="9" />
    <circle cx="508" cy="95" r="9" />
  </g>
</svg>
