...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two thin yellow cut lines drop at positions two and six along a loaf of character cells and the span between them lifts out as a fresh green copy, slicing reads from the first cut up to, not including, the second"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="188" y="20" width="4" height="96" rx="2" />
    <rect x="364" y="20" width="4" height="96" rx="2" />
  </g>
