...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A blue caller dot sends a small yellow argument along a thin arrow into a named function card, and a green result dot rides the lower arrow back — call a function, get a value back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="110" cy="100" r="14" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="140" y="76.5" width="180" height="3" rx="1.5" />
    <polygon points="318,72.5 329,78 318,83.5" />
    <rect x="160" y="123" width="180" height="3" rx="1.5" />
    <polygon points="162,119 162,130 151,124.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="230" cy="58" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="250" cy="144" r="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="350" y="45" width="150" height="110" rx="16" fillOpacity="0.15" />
    <rect x="372" y="68" width="106" height="16" rx="8" />
    <rect x="372" y="98" width="80" height="9" rx="4.5" fillOpacity="0.45" />
    <rect x="372" y="115" width="58" height="9" rx="4.5" fillOpacity="0.45" />
  </g>
</svg>
