...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A blue dot running along a thin line meets a red break, drops onto a soft green catch pad below, and the path continues along a thin gray arrow, an exception raised, caught by except, and the program moves on"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="70" y1="70" x2="302" y2="70" />
    <line x1="326" y1="82" x2="352" y2="118" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="256" cy="70" r="10" />
    <circle cx="360" cy="128" r="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="316" y="48" width="6" height="44" rx="3" transform="rotate(28 319 70)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="308" y="140" width="144" height="30" rx="15" fillOpacity="0.25" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="462" y="153.5" width="84" height="3" rx="1.5" />
    <polygon points="544,149.5 555,155 544,160.5" />
  </g>
</svg>
