...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A bottle on its side pops its cork and the message inside unrolls into clean separate green lines — opening a file pours its contents out line by line"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="80" width="150" height="58" rx="29" fillOpacity="0.14" />
    <rect x="222" y="93" width="44" height="30" rx="15" fillOpacity="0.14" />
    <circle cx="268" cy="108" r="15" fillOpacity="0.18" />
    <circle cx="140" cy="120" r="3" fillOpacity="0.3" />
    <circle cx="168" cy="114" r="2.5" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="296" y="52" width="18" height="28" rx="8" transform="rotate(24 305 66)" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="284" cy="86" r="2.5" />
    <circle cx="291" cy="72" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="302" cy="108" r="12" fillOpacity="0.35" />
    <circle cx="302" cy="108" r="5" fillOpacity="0.5" />
    <rect x="340" y="76" width="150" height="10" rx="5" fillOpacity="0.85" />
    <rect x="340" y="98" width="180" height="10" rx="5" fillOpacity="0.65" />
    <rect x="340" y="120" width="120" height="10" rx="5" fillOpacity="0.75" />
    <rect x="340" y="142" width="160" height="10" rx="5" fillOpacity="0.55" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="60" y="150" width="220" height="5" rx="2.5" />
  </g>
</svg>
...
body-mass column, skip the blank cells that real data always contains, and
average what's left:
