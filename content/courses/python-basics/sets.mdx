...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two overlapping translucent circles, blue and green, each hold one dot per member, and the two dots shared by both sit in the yellow-dotted lens between them, sets keep only unique items and make overlaps cheap to find"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="260" cy="105" r="80" fillOpacity="0.14" />
    <circle cx="205" cy="80" r="9" />
    <circle cx="220" cy="135" r="9" />
    <circle cx="255" cy="55" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="380" cy="105" r="80" fillOpacity="0.14" />
    <circle cx="435" cy="80" r="9" />
    <circle cx="420" cy="135" r="9" />
    <circle cx="385" cy="55" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="88" r="9" />
