...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Yellow sticky-note names stuck straight onto objects — one object wearing two notes — while an unlabeled object fades as its note drifts away: Python variables are labels on values, not boxes that contain them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="60" y="168" width="520" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="132" r="34" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="270" y="100" width="64" height="64" rx="14" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="440" y="128" width="84" height="38" rx="19" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="108" y="80" width="38" height="28" rx="4" transform="rotate(-8 127 94)" />
    <rect x="256" y="82" width="38" height="28" rx="4" transform="rotate(-10 275 96)" />
    <rect x="300" y="74" width="38" height="28" rx="4" fillOpacity="0.85" transform="rotate(8 319 88)" />
    <rect x="508" y="46" width="38" height="28" rx="4" fillOpacity="0.45" transform="rotate(18 527 60)" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="502" cy="118" r="2.5" />
    <circle cx="514" cy="102" r="2.5" />
    <circle cx="524" cy="86" r="2.5" />
  </g>
</svg>
