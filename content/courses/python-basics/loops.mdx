...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Three green squares already filled, a blue square under the marker being handled now, and a dashed slot still waiting, while a thin gray loop line sweeps from the end of the row back to the start, a loop repeats until every item is done"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="120" y="60" width="44" height="44" rx="10" />
    <rect x="196" y="60" width="44" height="44" rx="10" />
    <rect x="272" y="60" width="44" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="348" y="60" width="44" height="44" rx="10" />
    <polygon points="364.5,38 375.5,38 370,49" />
  </g>
  <rect x="424" y="60" width="44" height="44" rx="10" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
  <path d="M446 118 C 446 160, 142 160, 142 133" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2.5" strokeLinecap="round" />
  <polygon points="136.5,131 147.5,131 142,120" fill="var(--ds-gray-400)" />
</svg>
