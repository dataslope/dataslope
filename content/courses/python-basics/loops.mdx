...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A water wheel dips into a channel of waiting dots and lifts one per paddle up over the top, setting each down green on the far side — a loop takes the items one at a time until the queue is done"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="110" r="58" fillOpacity="0.15" />
    <circle cx="320" cy="110" r="10" />
    <rect x="365" y="105" width="26" height="10" rx="5" fillOpacity="0.5" />
    <rect x="336" y="155" width="26" height="10" rx="5" fillOpacity="0.5" transform="rotate(60 349 160)" />
    <rect x="278" y="155" width="26" height="10" rx="5" fillOpacity="0.5" transform="rotate(120 291 160)" />
    <rect x="249" y="105" width="26" height="10" rx="5" fillOpacity="0.5" />
    <rect x="278" y="55" width="26" height="10" rx="5" fillOpacity="0.5" transform="rotate(240 291 60)" />
    <rect x="336" y="55" width="26" height="10" rx="5" fillOpacity="0.5" transform="rotate(300 349 60)" />
    <rect x="40" y="176" width="250" height="18" rx="9" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="70" cy="185" r="7" />
    <circle cx="105" cy="185" r="7" />
    <circle cx="140" cy="185" r="7" />
    <circle cx="175" cy="185" r="7" />
    <circle cx="248" cy="96" r="7" />
    <circle cx="285" cy="46" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="412" cy="84" r="7" />
    <circle cx="420" cy="108" r="3" fillOpacity="0.4" />
    <circle cx="424" cy="130" r="2.5" fillOpacity="0.4" />
    <circle cx="470" cy="192" r="8" />
    <circle cx="502" cy="192" r="8" />
    <circle cx="534" cy="192" r="8" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="430" y="204" width="170" height="5" rx="2.5" />
  </g>
</svg>
