...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue parent card holding a circle and a square links down a thin line to a green child card holding the same blue circle, the square redone in yellow, and a brand-new green triangle, inherit, override, extend"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="320" y1="95" x2="320" y2="125" stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="200" y="25" width="240" height="70" rx="12" fillOpacity="0.12" />
    <circle cx="250" cy="60" r="11" />
    <rect x="300" y="48" width="24" height="24" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="160" y="125" width="320" height="80" rx="12" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="230" cy="165" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="153" width="24" height="24" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="410,151 424,177 396,177" />
  </g>
</svg>
