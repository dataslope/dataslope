...
<Figure
  slug="python-decorators-minimal-decorator-inline-cutout"
  alt="A small machine lifted into a surrounding frame that wraps it and adds one extra stamp"
  caption="A decorator wraps the original function and adds one step around it."
/>
