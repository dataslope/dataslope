...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A solid blue square rides a thin gray arrow and reappears unchanged inside a bold green frame, a decorator wraps a function in new behavior without touching the function itself"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="70" width="70" height="70" rx="14" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="220" y="103.5" width="90" height="3" rx="1.5" />
    <polygon points="308,99.5 319,105 308,110.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="370" y="40" width="130" height="130" rx="20" fillOpacity="0.15" />
  </g>
  <rect x="370" y="40" width="130" height="130" rx="20" fill="none" stroke="var(--ds-green-500)" strokeWidth="5" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="400" y="70" width="70" height="70" rx="14" />
  </g>
</svg>
