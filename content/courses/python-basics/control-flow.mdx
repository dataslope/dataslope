...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A blue dot at the top fans out toward three branch cards, but only the green line is solid and only its card holds a landed dot, an if, elif, else chain runs exactly one branch"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round" strokeDasharray="5 5" fill="none">
    <line x1="312" y1="42" x2="176" y2="102" />
    <line x1="320" y1="46" x2="320" y2="102" />
  </g>
  <line x1="328" y1="42" x2="464" y2="102" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="34" r="11" />
  </g>
  <rect x="100" y="108" width="140" height="60" rx="12" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="6 5" />
  <rect x="250" y="108" width="140" height="60" rx="12" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="6 5" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="400" y="108" width="140" height="60" rx="12" fillOpacity="0.15" />
    <circle cx="470" cy="138" r="10" />
  </g>
</svg>
