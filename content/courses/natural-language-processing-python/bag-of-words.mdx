...
<Figure
  slug="nlp-bag-of-words-cutout"
  alt="An open sack tipping loose tiles onto a counting grid that fills into a sparse matrix of small numeric blocks"
/>
...
<Figure
  slug="nlp-bag-of-words-building-by-hand-inline-cutout"
  alt="A hand placing word tiles one at a time into labelled slots of a tally rack"
  caption="Each document becomes a row of counts, one column per vocabulary word."
/>
...
<Figure
  slug="nlp-bag-of-words-inline-cutout"
  alt="A bag tipped out onto a bench so the word tiles land in a heap with their order lost, and a tally rack counting each kind"
  caption="The bag keeps which words appeared and throws their order away."
/>
...
<Figure
  slug="nlp-bag-of-words-feature-extraction-process-inline-cutout"
  alt="A bag of word tiles tipped onto a bench and counted into a tally rack"
  caption="Counting is what turns text into the numbers a model can take."
/>
