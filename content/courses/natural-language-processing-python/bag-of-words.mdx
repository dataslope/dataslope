...
You can now turn documents into numeric features. But raw counts have the same
weakness we met when counting words: the most common words dominate and tell you
the least. The next page fixes that with **TF-IDF** — a way to weight each word
by how *distinctive* it is — before we assemble everything into a working
classifier.
