...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="One long sentence pill splits into word-sized token chips of different widths — most in varying blue shades, a red stopword, and a small gray chip for the token that carries no signal"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="40" width="460" height="30" rx="15" fillOpacity="0.22" />
  </g>
  <rect x="90" y="126" width="56" height="30" rx="15" fill="var(--ds-red-500)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="160" y="126" width="44" height="30" rx="15" />
    <rect x="218" y="126" width="88" height="30" rx="15" fillOpacity="0.7" />
    <rect x="320" y="126" width="70" height="30" rx="15" fillOpacity="0.5" />
    <rect x="404" y="126" width="110" height="30" rx="15" fillOpacity="0.85" />
  </g>
  <rect x="528" y="126" width="22" height="30" rx="11" fill="currentColor" opacity="0.25" />
</svg>
