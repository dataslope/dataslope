...
<Figure
  slug="nlp-stemming-and-lemmatization-shared-goal-reduce-inline-cutout"
  alt="Four tiles of clearly different lengths stacked on the left, each trimmed at the same point, and the four equal short pieces lined up on the right"
  caption="A stemmer chops at a fixed point, whatever the word actually is."
/>
...
<Figure
  ...
  caption="Both cut words back to a shared root; only one checks it is a real word."
/>
