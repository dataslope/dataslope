...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Left: a blade chops three word bars at the same point, leaving one rough-edged stem; right: three differently shaped word chips converge along dotted trails into one smooth dictionary capsule"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="36" width="70" height="22" rx="8" fillOpacity="0.8" />
    <rect x="60" y="68" width="70" height="22" rx="8" fillOpacity="0.8" />
    <rect x="139" y="68" width="18" height="22" rx="8" fillOpacity="0.25" />
    <rect x="60" y="100" width="70" height="22" rx="8" fillOpacity="0.8" />
    <rect x="139" y="100" width="58" height="22" rx="8" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="126,10 148,10 137,24" />
    <rect x="132" y="26" width="5" height="106" rx="2.5" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="95" cy="132" r="2.5" />
    <circle cx="95" cy="141" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="150" width="58" height="24" rx="8" fillOpacity="0.9" />
    <polygon points="112,150 126,154 117,159 128,164 119,169 112,174" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="318" y="30" width="3" height="150" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="370" y="40" width="104" height="22" rx="11" fillOpacity="0.35" />
    <rect x="370" y="86" width="66" height="22" rx="11" fillOpacity="0.5" />
    <rect x="370" y="132" width="88" height="22" rx="6" fillOpacity="0.35" />
    <rect x="540" y="86" width="88" height="30" rx="15" fillOpacity="0.95" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="492" cy="62" r="3" />
    <circle cx="509" cy="75" r="3" />
    <circle cx="526" cy="88" r="3" />
    <circle cx="462" cy="98" r="3" />
    <circle cx="488" cy="100" r="3" />
    <circle cx="514" cy="101" r="3" />
    <circle cx="482" cy="132" r="3" />
    <circle cx="504" cy="120" r="3" />
    <circle cx="526" cy="108" r="3" />
  </g>
</svg>
