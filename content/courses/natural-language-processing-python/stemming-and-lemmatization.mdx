...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Left: a thin yellow cut line slices three word capsules at the same spot, leaving faded endings behind; right: three word capsules of different shapes funnel along thin gray lines into one solid green dictionary lemma"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="64" y="40" width="86" height="24" rx="10" />
    <rect x="156" y="40" width="48" height="24" rx="10" fillOpacity="0.25" />
    <rect x="64" y="78" width="86" height="24" rx="10" />
    <rect x="156" y="78" width="104" height="24" rx="10" fillOpacity="0.25" />
    <rect x="64" y="116" width="86" height="24" rx="10" />
    <rect x="156" y="116" width="72" height="24" rx="10" fillOpacity="0.25" />
  </g>
  <rect x="150" y="28" width="4" height="124" rx="2" fill="var(--ds-yellow-500)" />
  <rect x="318" y="30" width="3" height="140" rx="1.5" fill="currentColor" opacity="0.1" />
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="460" y1="52" x2="540" y2="92" />
    <line x1="422" y1="90" x2="540" y2="92" />
    <line x1="444" y1="128" x2="540" y2="92" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="352" y="40" width="104" height="24" rx="10" fillOpacity="0.3" />
    <rect x="352" y="78" width="66" height="24" rx="10" fillOpacity="0.45" />
    <rect x="352" y="116" width="88" height="24" rx="10" fillOpacity="0.3" />
    <rect x="540" y="78" width="76" height="28" rx="14" />
  </g>
</svg>
