...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A sentence line where solid blue content chips stay in place over faint empty slots, while small stopword chips in fading red shades sink below the thin line"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="60" y="106" width="520" height="3" rx="1.5" opacity="0.12" />
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="76" y="128" width="52" height="24" rx="10" fillOpacity="0.55" transform="rotate(-7 102 140)" />
    <rect x="222" y="146" width="34" height="22" rx="9" fillOpacity="0.3" transform="rotate(6 239 157)" />
    <rect x="494" y="134" width="42" height="24" rx="10" fillOpacity="0.42" transform="rotate(-5 515 146)" />
    <rect x="350" y="152" width="58" height="24" rx="10" fillOpacity="0.68" transform="rotate(5 379 164)" />
  </g>
</svg>
