...
<Figure
  slug="nlp-stopwords-cutout"
  alt="A sieve on a platform catching a pile of tiny featureless pebbles while larger distinctive shapes pass through into a tray"
/>
...
<Figure
  slug="nlp-stopwords-are-stopwords-remove-inline-cutout"
  alt="A stream of tiles over a sieve that catches the smallest and most frequent"
  caption="Stopwords are the frequent, functional words that carry little on their own."
/>
...
<Figure
  slug="nlp-stopwords-inline-cutout"
  alt="A stream of word tiles passing a sieve that catches the smallest, most common tiles and lets the rest through"
  caption="The sieve catches `not` too, which is how removing stopwords flips a meaning."
/>
...
<Callout type="warn" title="Do not remove stopwords before sentiment analysis (at least not naively)">
