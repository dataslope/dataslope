...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A speech-bubble card full of uneven blue marks becomes a tidy grid of blue cells, turning human language into structure a program can count"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="84" y="62" width="58" height="9" rx="4.5" opacity="0.55" transform="rotate(-4 113 66)" />
    <rect x="152" y="58" width="34" height="9" rx="4.5" opacity="0.3" transform="rotate(3 169 62)" />
    <rect x="196" y="64" width="48" height="9" rx="4.5" opacity="0.45" transform="rotate(-2 220 68)" />
    <rect x="88" y="92" width="40" height="9" rx="4.5" opacity="0.35" transform="rotate(2 108 96)" />
    <rect x="138" y="88" width="66" height="9" rx="4.5" opacity="0.6" transform="rotate(-3 171 92)" />
    <rect x="214" y="94" width="30" height="9" rx="4.5" opacity="0.28" transform="rotate(4 229 98)" />
    <rect x="92" y="120" width="50" height="9" rx="4.5" opacity="0.4" transform="rotate(-2 117 124)" />
    <rect x="154" y="118" width="42" height="9" rx="4.5" opacity="0.5" transform="rotate(3 175 122)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <rect x="512" y="122" width="56" height="30" rx="9" fillOpacity="0.75" />
  </g>
</svg>
