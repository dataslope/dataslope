...
<Figure
  slug="natural-language-processing-python-thumbnail-cutout"
  alt="A ribbon of blank word tiles feeding into a sorting machine that stacks them into tidy piles"
  priority
/>
