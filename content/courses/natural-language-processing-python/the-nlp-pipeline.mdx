---
title: The Anatomy of a Text Pipeline
...
<Figure
  slug="nlp-pipeline-cutout"
  alt="A straight conveyor line passing through five distinct processing stations, the material growing tidier at each stop"
/>
...
<Figure
  slug="nlp-the-nlp-pipeline-standard-text-preprocessing-inline-cutout"
  alt="A paper ribbon passing five small machines in a row and leaving as a tray of clean chips"
  caption="Raw text passes through the same handful of stages before any model sees it."
/>
...
<Figure
  slug="nlp-the-nlp-pipeline-two-families-steps-cleaning-inline-cutout"
  alt="A bench in two halves, the first squaring and cleaning every piece and the second measuring the pieces it is handed"
  caption="Cleaning turns raw text into comparable units; analysis is what you do to them afterwards."
/>
...
<Figure
  slug="nlp-the-nlp-pipeline-order-matters-concrete-example-inline-cutout"
  alt="The same three steps run in two different orders, one order leaving stray pieces the other had already removed"
  caption="Lowercase before removing stopwords and all three thes go; reverse it and one survives."
/>
