...
description: The most important skill in classic natural language processing, choosing which preprocessing steps to apply. There is no universal pipeline; each step adds or destroys information, and the right choice depends entirely on the downstream task. A decision framework, a task-by-task table, and how to evaluate choices empirically.
---
...
<Figure
  slug="nlp-choosing-pipeline-cutout"
  alt="A modular conveyor with interchangeable station blocks, two stations lifted out and set aside on the platform"
/>
...
<Figure
  slug="nlp-choosing-your-pipeline-decision-framework-inline-cutout"
  alt="A branching chute with a small gauge at each fork, a task card dropping through it"
  caption="Each fork in the pipeline is a decision your task should be making."
/>
...
<Figure
  slug="nlp-choosing-your-pipeline-pipeline-menu-not-inline-cutout"
  alt="A rack of interchangeable pipe sections with three chosen and clipped together, the rest left hanging"
  caption="The steps are a menu, and you clip in only the ones your task needs."
/>
