...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue input dot branches along thin gray lines into three candidate pipelines of chained steps; the middle four-step track, ringed in yellow and built of solid green blocks, is the chosen one and ends in a green result dot"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="120" y1="115" x2="166" y2="48" />
    <line x1="120" y1="115" x2="166" y2="115" />
    <line x1="120" y1="115" x2="166" y2="182" />
  </g>
  <circle cx="110" cy="115" r="10" fill="var(--ds-blue-500)" />
  <g fill="currentColor" opacity="0.15">
    <rect x="170" y="36" width="34" height="24" rx="7" />
    <rect x="222" y="36" width="34" height="24" rx="7" />
    <rect x="204" y="47" width="18" height="2" />
    <rect x="170" y="170" width="34" height="24" rx="7" />
    <rect x="222" y="170" width="34" height="24" rx="7" />
    <rect x="274" y="170" width="34" height="24" rx="7" />
    <rect x="204" y="181" width="18" height="2" />
    <rect x="256" y="181" width="18" height="2" />
  </g>
  <rect x="158" y="91" width="252" height="48" rx="14" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="170" y="103" width="34" height="24" rx="7" />
    <rect x="222" y="103" width="34" height="24" rx="7" />
    <rect x="274" y="103" width="34" height="24" rx="7" />
    <rect x="326" y="103" width="34" height="24" rx="7" />
    <rect x="204" y="114" width="18" height="2" />
    <rect x="256" y="114" width="18" height="2" />
    <rect x="308" y="114" width="18" height="2" />
    <rect x="360" y="114" width="20" height="2" />
    <circle cx="390" cy="115" r="9" />
  </g>
</svg>
...
<Callout type="warn" title="The cardinal sin: copy-pasting someone else's pipeline">
