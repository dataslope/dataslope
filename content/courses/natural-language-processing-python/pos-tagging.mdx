...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A sentence of gray word chips with a small colored tag hanging from each on a thin thread, blue for nouns, green for the verb, yellow for an adjective, gray for function words"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.18">
    <rect x="92" y="44" width="42" height="26" rx="10" />
    <rect x="150" y="44" width="74" height="26" rx="10" />
    <rect x="240" y="44" width="58" height="26" rx="10" />
    <rect x="314" y="44" width="90" height="26" rx="10" />
    <rect x="420" y="44" width="48" height="26" rx="10" />
    <rect x="484" y="44" width="68" height="26" rx="10" />
  </g>
  <g stroke="var(--ds-gray-300)" strokeWidth="1.5">
    <line x1="113" y1="70" x2="109" y2="102" />
    <line x1="187" y1="70" x2="191" y2="102" />
    <line x1="269" y1="70" x2="265" y2="102" />
    <line x1="359" y1="70" x2="363" y2="102" />
    <line x1="444" y1="70" x2="440" y2="102" />
    <line x1="518" y1="70" x2="522" y2="102" />
  </g>
  <rect x="99" y="102" width="20" height="20" rx="6" fill="currentColor" opacity="0.25" transform="rotate(-8 109 112)" />
  <rect x="181" y="102" width="20" height="20" rx="6" fill="var(--ds-green-500)" transform="rotate(6 191 112)" />
  <rect x="255" y="102" width="20" height="20" rx="6" fill="var(--ds-blue-500)" transform="rotate(-5 265 112)" />
  <rect x="353" y="102" width="20" height="20" rx="6" fill="var(--ds-yellow-500)" transform="rotate(8 363 112)" />
  <rect x="430" y="102" width="20" height="20" rx="6" fill="currentColor" opacity="0.25" transform="rotate(-6 440 112)" />
  <rect x="512" y="102" width="20" height="20" rx="6" fill="var(--ds-blue-500)" transform="rotate(5 522 112)" />
</svg>
