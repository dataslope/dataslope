...
<Figure
  slug="nlp-pos-tagging-cutout"
  alt="A row of blank word tiles on a track, each receiving a small differently shaped coloured cap from an overhead sorter"
/>
...
<Figure
  slug="nlp-pos-tagging-inline-cutout"
  alt="A line of word tiles with a small coloured flag being clipped to each one, matching flags on matching kinds of word"
  caption="Tagging attaches a grammatical role to each word in context."
/>
...
<Figure
  slug="nlp-pos-tagging-problem-pos-tagging-inline-cutout"
  alt="One word tile held up with three differently shaped flags above it, only one able to clip on"
  caption="The same word takes a different tag depending on how it is used."
/>
