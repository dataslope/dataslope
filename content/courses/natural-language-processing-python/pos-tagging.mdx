...
<Figure
  ...
  alt="A row of blank word tiles on a track, each receiving a small differently shaped colored cap from an overhead sorter"
/>
...
<Figure
  ...
  alt="A line of word tiles with a small colored flag being clipped to each one, matching flags on matching kinds of word"
