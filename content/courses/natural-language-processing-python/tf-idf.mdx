...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two word bars start at equal raw height; a downward funnel labeled IDF shrinks the bar that appears in every document to almost nothing while leaving the rare, distinctive word's bar tall"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.16">
    <rect x="90" y="40" width="60" height="120" rx="8" />
    <rect x="430" y="40" width="60" height="120" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <text x="120" y="34" fontFamily="var(--font-sans), Georgia, serif" fontSize="13" textAnchor="middle">raw count</text>
    <text x="460" y="34" fontFamily="var(--font-sans), Georgia, serif" fontSize="13" textAnchor="middle">raw count</text>
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="150,60 250,90 250,110 150,140" fillOpacity="0.25" />
    <text x="205" y="84" fontFamily="var(--font-mono), monospace" fontSize="12" textAnchor="middle" fillOpacity="0.9">× IDF (low)</text>
    <polygon points="370,60 470,72 470,128 370,140" fillOpacity="0.25" />
    <text x="425" y="64" fontFamily="var(--font-mono), monospace" fontSize="12" textAnchor="middle" fillOpacity="0.9">× IDF (high)</text>
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="262" y="148" width="48" height="12" rx="4" fillOpacity="0.5" />
    <text x="286" y="184" fontFamily="var(--font-sans), Georgia, serif" fontSize="12" textAnchor="middle" fillOpacity="0.7">"the" — in every doc, faded</text>
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="540" y="46" width="48" height="114" rx="6" fillOpacity="0.85" />
    <text x="564" y="184" fontFamily="var(--font-sans), Georgia, serif" fontSize="12" textAnchor="middle" fillOpacity="0.7">"comet" — rare, kept tall</text>
  </g>
</svg>
