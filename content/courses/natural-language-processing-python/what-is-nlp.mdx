...
Does the period after "Dr" end a sentence? Is "\$2.5M" a word, or a symbol
and three numbers? Does the comma belong to "\$2.5M" or to the sentence? A
human reads this in a second and understands it perfectly. A
...
<Figure
  slug="nlp-what-is-nlp-hard-ambiguity-everywhere-inline-cutout"
  alt="One written slip that seats equally well in two differently shaped sockets, with no way to tell which was meant"
  caption="One sentence with two readings is ordinary in human language and fatal to a formal parser."
/>
...
<Figure
  slug="nlp-what-is-nlp-core-problem-text-inline-cutout"
  alt="A loose heap of paper ribbons beside a neat ruled board, an arrow from the heap toward the board"
  caption="The core problem is turning unstructured text into something structured."
/>
...
<Figure
  slug="nlp-what-is-nlp-first-look-split-not-inline-cutout"
  alt="A strip of writing pulled apart at every gap, leaving pieces with punctuation still stuck to their ends"
  caption="A real tokenizer peels off punctuation and splits contractions that a space never sees."
/>
...
<Figure
  slug="nlp-what-is-nlp-rules-versus-learning-brief-inline-cutout"
  alt="A hand-cut stencil beside a machine cutting its own stencil from a pile of worked examples"
  caption="Rules encode what somebody already knows; learning derives it from labelled examples."
/>
...
<Figure
  slug="nlp-what-is-nlp-where-nlp-shows-up-inline-cutout"
  alt="A loading bay of raw sacks emptied, sorted and squared into uniform pieces before the fine work begins"
  caption="Before any of the clever parts, the raw text has to become comparable units."
/>
