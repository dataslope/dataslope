...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A row of five blue word chips with staggered green and yellow outlined spans beneath, each span bracketing two neighboring words, the overlapping bigrams hiding in one sentence"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="40" width="64" height="28" rx="11" />
    <rect x="168" y="40" width="88" height="28" rx="11" />
    <rect x="270" y="40" width="72" height="28" rx="11" />
    <rect x="356" y="40" width="56" height="28" rx="11" />
    <rect x="426" y="40" width="76" height="28" rx="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="80" y="92" width="180" height="44" rx="16" fillOpacity="0.08" stroke="currentColor" strokeWidth="2.5" />
    <rect x="266" y="92" width="156" height="44" rx="16" fillOpacity="0.08" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="158" y="148" width="194" height="44" rx="16" fillOpacity="0.1" stroke="currentColor" strokeWidth="2.5" />
    <rect x="358" y="148" width="154" height="44" rx="16" fillOpacity="0.1" stroke="currentColor" strokeWidth="2.5" />
  </g>
</svg>
