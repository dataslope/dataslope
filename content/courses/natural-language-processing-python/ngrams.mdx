...
<Figure
  slug="nlp-ngrams-sliding-window-inline-cutout"
  alt="A two-tile window sliding along a strip of tiles, each pair it frames dropping into a tray"
  caption="Each window position becomes one n-gram, overlapping the last."
/>
...
<Figure
  ...
  caption="A sliding window of n words captures the order a bag of words loses."
/>
