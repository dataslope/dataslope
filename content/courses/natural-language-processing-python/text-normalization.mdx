...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Ragged chips of mixed heights, one with a punctuation dot stuck to its side, pass under a press bar and come out as one uniform row while the loose dot falls away"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="36" width="70" height="38" rx="11" fillOpacity="0.5" />
    <rect x="222" y="46" width="58" height="28" rx="10" fillOpacity="0.3" />
    <rect x="292" y="30" width="84" height="44" rx="12" fillOpacity="0.65" />
    <rect x="388" y="44" width="66" height="30" rx="10" fillOpacity="0.38" />
    <circle cx="463" cy="69" r="5" fillOpacity="0.38" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="128" y="96" width="350" height="14" rx="7" fillOpacity="0.9" />
    <polygon points="222,118 238,118 230,132" fillOpacity="0.8" />
    <polygon points="368,118 384,118 376,132" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="148" width="70" height="24" rx="10" fillOpacity="0.85" />
    <rect x="222" y="148" width="58" height="24" rx="10" fillOpacity="0.85" />
    <rect x="292" y="148" width="84" height="24" rx="10" fillOpacity="0.85" />
    <rect x="388" y="148" width="66" height="24" rx="10" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="463" cy="160" r="4.5" fillOpacity="0.45" />
  </g>
</svg>
