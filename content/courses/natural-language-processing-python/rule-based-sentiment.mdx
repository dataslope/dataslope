...
<Figure
  slug="nlp-sentiment-cutout"
  alt="A scoring machine reading a ribbon of tiles and tipping a needle gauge between a red end and a green end"
/>
...
<Figure
  slug="nlp-rule-based-sentiment-idea-score-words-inline-cutout"
  alt="Word tiles dropped onto a balance, some weighted to one side and some to the other"
  caption="Scoring each word and adding up the weights is sentiment at its simplest."
/>
...
<Figure
  slug="nlp-rule-based-sentiment-naive-first-attempt-fails-inline-cutout"
  alt="A tally counting one favourable word while the small reversing flag standing in front of it goes unread"
  caption="Counting positive words scores not good as positive, because it never reads the not."
/>
...
<Figure
  slug="nlp-rule-based-sentiment-adding-negation-handling-inline-cutout"
  alt="A small flag standing on a rail that flips the sign of every chip passing behind it"
  caption="One negation flag flips the score of everything it governs, and not bad becomes positive."
/>
...
<Figure
  slug="nlp-rule-based-sentiment-limits-rules-graduate-learning-inline-cutout"
  alt="A hand-written list of word cards failing on a phrase nobody anticipated, beside a machine reading its way through a stack of examples"
  caption="A hand-written lexicon meets a phrase nobody anticipated, which is where learning starts."
/>
