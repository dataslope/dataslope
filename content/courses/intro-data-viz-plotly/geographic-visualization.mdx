...
The other decision most people skip is where the **class breaks** go. A
choropleth has to turn a continuous variable into a handful of shades, and
...
Before any of the projection choices, the prior question:
