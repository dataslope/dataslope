...
<Figure
  slug="viz-introducing-plotly-cutout"
  alt="Introducing Plotly Express, an isometric illustration"
/>
...
<Figure
  slug="viz-introducing-plotly-express-standard-import-inline-cutout"
  alt="One short strip clipped to the top of a bench before any tool on it will run"
  caption="One import line, by convention named `px`, and every chart function is available."
/>
