...
<Figure
  slug="viz-bubble-charts-pitch-inline-cutout"
  alt="Chips pinned across a board where each chip's size carries a third measure"
  caption="Two positions and one size means three variables in a single mark."
/>
