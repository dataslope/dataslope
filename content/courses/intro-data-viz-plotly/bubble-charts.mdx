...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Translucent bubbles of many sizes drift across the scene, one green among the blue, with a nested size legend in the corner, area carrying a third variable"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="170" r="14" fillOpacity="0.4" />
    <circle cx="175" cy="82" r="6" fillOpacity="0.3" />
    <circle cx="200" cy="120" r="22" fillOpacity="0.32" />
    <circle cx="246" cy="64" r="8" fillOpacity="0.3" />
    <circle cx="280" cy="160" r="30" fillOpacity="0.28" />
    <circle cx="350" cy="95" r="18" fillOpacity="0.4" />
    <circle cx="420" cy="130" r="38" fillOpacity="0.25" />
    <circle cx="500" cy="80" r="26" fillOpacity="0.35" />
    <circle cx="540" cy="150" r="10" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="468" cy="184" r="16" fillOpacity="0.5" />
  </g>
  <g fill="currentColor">
    <circle cx="585" cy="197" r="18" opacity="0.12" />
    <circle cx="585" cy="204" r="11" opacity="0.18" />
    <circle cx="585" cy="210" r="5" opacity="0.25" />
  </g>
</svg>
