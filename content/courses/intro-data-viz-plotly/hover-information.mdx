...
<Figure
  slug="viz-hover-information-cutout"
  alt="Hover information, an isometric illustration"
/>
...
<Figure
  slug="viz-hover-information-inline-cutout"
  alt="A chart board with one mark raised slightly and a small panel of detail floating just beside it"
  caption="Hover carries the detail that would clutter the chart if it were printed on it."
/>
...
<Figure
  slug="viz-hover-information-default-tooltip-inline-cutout"
  alt="One mark on a chart raised slightly with a small panel of detail floating beside it"
  caption="The tooltip is a second layer of the chart, and it needs editing too."
/>
...
The alternative to a hover layer is printing everything, which is what it
looks like:

<Chart slug="hover-is-the-detail-layer" />
