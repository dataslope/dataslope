...
<Figure
  slug="viz-heatmaps-heatmap-right-inline-cutout"
  alt="A grid of tiles in graded shades with the deepest clustered in one corner, a key strip beside it"
  caption="A heatmap gives every cell of a grid a shade, so patterns show as blocks."
/>
...
<Figure
  ...
  caption="Without a key the shades mean nothing, and the wrong scale invents structure."
/>
