...
<Figure
  slug="viz-scatter-plots-use-scatter-plot-inline-cutout"
  alt="Two columns of chips pinned against each other on a board, a loose upward drift emerging"
  caption="A scatter plot is for the relationship between two numeric columns."
/>
...
<Figure
  ...
  caption="One dot per row, and the drift between them is the pattern you came for."
/>
