...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A constellation of blue dots rising together, joined by faint dotted edges, while one ringed red outlier sits far below the pattern"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="180" r="6" />
    <circle cx="160" cy="150" r="5" />
    <circle cx="150" cy="195" r="4.5" fillOpacity="0.7" />
    <circle cx="210" cy="160" r="7" />
    <circle cx="250" cy="130" r="5" />
    <circle cx="240" cy="175" r="4" fillOpacity="0.7" />
    <circle cx="300" cy="120" r="6" />
    <circle cx="330" cy="150" r="5" fillOpacity="0.7" />
    <circle cx="360" cy="100" r="7" />
    <circle cx="400" cy="125" r="5" fillOpacity="0.7" />
    <circle cx="430" cy="85" r="6" />
    <circle cx="470" cy="105" r="5" fillOpacity="0.7" />
    <circle cx="500" cy="70" r="7" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="150" cy="173" r="2" />
    <circle cx="180" cy="166" r="2" />
    <circle cx="240" cy="147" r="2" />
    <circle cx="270" cy="133" r="2" />
    <circle cx="330" cy="110" r="2" />
    <circle cx="395" cy="92" r="2" />
    <circle cx="465" cy="77" r="2" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="560" cy="190" r="8" />
    <path d="M544 190 a16 16 0 1 0 32 0 a16 16 0 1 0 -32 0 Z M548 190 a12 12 0 1 0 24 0 a12 12 0 1 0 -24 0 Z" fillRule="evenodd" fillOpacity="0.35" />
  </g>
</svg>
