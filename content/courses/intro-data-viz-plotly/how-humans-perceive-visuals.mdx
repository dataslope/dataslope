...
Three grids below, one odd mark in each. Two of them you find without
looking:
...
That last one has a hard edge worth seeing. Past the size of the palette a
library does not warn you, it starts the colors again:
