...
<Figure
  slug="viz-how-humans-perceive-visuals-inline-cutout"
  alt="The same difference shown three ways, as two bar heights, two circle sizes and two shades, the heights easiest to judge"
  caption="Some differences are seen instantly; others have to be worked out."
/>
...
<Figure
  slug="viz-how-humans-perceive-visuals-cleveland-mcgill-ranking-inline-cutout"
  alt="The same difference shown as two bar heights, two circle sizes and two shades, the heights easiest to judge"
  caption="Position is judged most accurately, then length, then area, then shade."
/>
