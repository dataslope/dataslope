...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="An even field of identical blue dots in which a single red dot pops out instantly, before you even decide to look for it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="130" y="25" width="380" height="200" rx="18" fill="currentColor" opacity="0.05" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.55">
    <circle cx="170" cy="60" r="8" />
    <circle cx="230" cy="60" r="8" />
    <circle cx="290" cy="60" r="8" />
    <circle cx="350" cy="60" r="8" />
    <circle cx="410" cy="60" r="8" />
    <circle cx="470" cy="60" r="8" />
    <circle cx="170" cy="105" r="8" />
    <circle cx="230" cy="105" r="8" />
    <circle cx="290" cy="105" r="8" />
    <circle cx="410" cy="105" r="8" />
    <circle cx="470" cy="105" r="8" />
    <circle cx="170" cy="150" r="8" />
    <circle cx="230" cy="150" r="8" />
    <circle cx="290" cy="150" r="8" />
    <circle cx="350" cy="150" r="8" />
    <circle cx="410" cy="150" r="8" />
    <circle cx="470" cy="150" r="8" />
    <circle cx="170" cy="195" r="8" />
    <circle cx="230" cy="195" r="8" />
    <circle cx="290" cy="195" r="8" />
    <circle cx="350" cy="195" r="8" />
    <circle cx="410" cy="195" r="8" />
    <circle cx="470" cy="195" r="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="350" cy="105" r="9" />
  </g>
</svg>
