...
<Figure
  slug="viz-debugging-viz-cutout"
  alt="Debugging visualizations, an isometric illustration"
/>
...
<Figure
  slug="viz-debugging-visualizations-mindset-chart-honest-inline-cutout"
  alt="A chart on a stand with its raw chips visible in a tray underneath, the two clearly agreeing"
  caption="The chart is usually right about the data; the data is what surprised you."
/>
...
<Figure
  slug="viz-debugging-visualizations-common-failure-modes-inline-cutout"
  alt="Four small charts in a row, each broken differently, one empty, one clipped, one flipped, one overplotted"
  caption="Empty, clipped, flipped or overplotted: most broken charts fail one of four ways."
/>

This one is worth seeing. The same fourteen points, connected in row
order and connected in x order:

<Chart slug="unsorted-line-scribble" />
