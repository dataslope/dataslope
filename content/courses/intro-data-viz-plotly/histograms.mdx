...
<Figure
  slug="viz-histograms-histogram-works-inline-cutout"
  alt="Loose chips dropping into a row of adjacent bins, the bins filling to different heights"
  caption="A histogram bins one numeric column and shows how the values are distributed."
/>
