...
<Figure
  slug="viz-why-plotly-express-cutout"
  alt="Why Python and Plotly Express, an isometric illustration"
/>
...
<Figure
  slug="viz-why-plotly-express-python-won-analytics-inline-cutout"
  alt="One bench fitted with every tool already in place, several other benches standing part-equipped"
  caption="Plotly Express is one line per chart because the defaults are already chosen."
/>
...
<Figure
  slug="viz-why-plotly-express-three-design-choices-make-inline-cutout"
  alt="A chart that responds when pointed at, beside a printed one that can only be read"
  caption="A static chart answers the question you asked; an interactive one answers the next."
/>
