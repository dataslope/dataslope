...
<Figure
  slug="viz-box-plots-anatomy-box-plot-inline-cutout"
  alt="An upright box with a line across its middle and a thin rod out of each end, two loose chips beyond"
  caption="Median, quartiles and outliers, all in one small shape."
/>
