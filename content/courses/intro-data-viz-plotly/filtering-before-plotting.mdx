...
<Figure
  slug="viz-filtering-before-plotting-inline-cutout"
  alt="A crowded board of marks passing through a grate, the thinned result laid out clearly on a second board"
  caption="Choosing what to leave out is part of making the chart readable."
/>
...
display(top[["country", 1952, 2007, "gain"]])
...
<Figure
  slug="viz-filtering-before-plotting-filter-at-all-inline-cutout"
  alt="A board so crowded its marks merge into a single mass, beside the same board thinned to a readable few"
  caption="Past a certain density every mark overlaps and the chart stops saying anything."
/>
...
Forty-two series in full, and the same forty-two under a stated rule:

<Chart slug="filter-beats-showing-everything" />
