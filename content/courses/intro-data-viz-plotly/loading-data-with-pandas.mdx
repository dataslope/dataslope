...
3. **A CSV file.** The real-world case, and the one you'll use most
   in your own work:
...
This course uses all three. On pages that need a friendlier dataset
than the built-ins offer, **Palmer Penguins** or **diamonds**, say,
the CSV is loaded for you and you read it with `pd.read_csv(...)`,
  ...
  files={[
    {
      ...
      starterCode: `# Read a real CSV, just like in your own work.
