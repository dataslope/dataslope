...
<Figure
  slug="viz-loading-data-cutout"
  alt="Loading data with pandas, an isometric illustration"
/>
...
<Figure
  slug="viz-loading-data-with-pandas-dataframe-inline-cutout"
  alt="Several columns of different kinds clamped side by side into one board"
  caption="Every chart starts from a DataFrame, whichever way the data arrived."
/>
...
<Figure
  slug="viz-loading-data-with-pandas-tidy-data-secret-easy-inline-cutout"
  alt="A wide board of many columns folded down into three narrow ones, one row per observation"
  caption="One row per observation is what makes a plotting call a single line."
/>
