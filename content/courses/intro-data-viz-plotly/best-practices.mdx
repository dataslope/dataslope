...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A checklist card with three green-checked rows and one yellow row still pending, the consolidated habits of clear and honest charts"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="170" y="30" width="300" height="195" rx="16" fill="currentColor" opacity="0.07" />
  <rect x="200" y="50" width="140" height="12" rx="6" fill="currentColor" opacity="0.25" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="215" cy="95" r="9" />
    <circle cx="215" cy="132" r="9" />
    <circle cx="215" cy="169" r="9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="209.5,95 212.5,92 214.5,95 219.5,88 222.5,91 214.5,101" />
    <polygon points="209.5,132 212.5,129 214.5,132 219.5,125 222.5,128 214.5,138" />
    <polygon points="209.5,169 212.5,166 214.5,169 219.5,162 222.5,165 214.5,175" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="215" cy="206" r="9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="210.5" cy="206" r="1.4" />
    <circle cx="215" cy="206" r="1.4" />
    <circle cx="219.5" cy="206" r="1.4" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="240" y="90" width="180" height="10" rx="5" />
    <rect x="240" y="127" width="150" height="10" rx="5" />
    <rect x="240" y="164" width="168" height="10" rx="5" />
    <rect x="240" y="201" width="130" height="10" rx="5" />
  </g>
</svg>
