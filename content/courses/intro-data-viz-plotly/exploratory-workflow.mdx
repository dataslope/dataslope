...
You are not tuning anything yet. This pass is looking for the handful of
shapes that mean "stop and deal with me", and a summary table reports every
one of them as a perfectly reasonable set of numbers:
