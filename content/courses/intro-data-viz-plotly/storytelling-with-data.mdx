...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A three-panel strip follows one blue dot: lost in the crowd, then falling, then rising to a green burst — context, conflict, resolution"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="60" y="60" width="150" height="130" rx="10" />
    <rect x="245" y="60" width="150" height="130" rx="10" />
    <rect x="430" y="60" width="150" height="130" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="222,118 222,132 238,125" />
    <polygon points="407,118 407,132 423,125" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="135" cy="148" r="7" />
    <circle cx="320" cy="160" r="7" />
    <circle cx="505" cy="90" r="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="285" cy="105" r="2.5" />
    <circle cx="300" cy="125" r="2.5" />
    <circle cx="312" cy="143" r="2.5" />
    <circle cx="460" cy="160" r="2.5" />
    <circle cx="475" cy="140" r="2.5" />
    <circle cx="490" cy="115" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="340,120 352,120 346,132" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="505" cy="66" r="3.5" />
    <circle cx="526" cy="77" r="3" />
    <circle cx="530" cy="95" r="3" />
    <circle cx="484" cy="77" r="3" />
    <circle cx="480" cy="95" r="3" />
  </g>
</svg>
