...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Three data-column chips flow along dotted paths into a chart: one to the vertical axis, one to a colored dot, one to the horizontal axis — columns mapped to visual channels"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.13">
    <rect x="70" y="40" width="46" height="30" rx="15" />
  ...
  <g fill="currentColor" opacity="0.28">
    ...
    <circle cx="185" cy="56" r="3" />
    <circle cx="220" cy="60" r="3" />
    <circle cx="255" cy="64" r="3" />
    <polygon points="272,62 272,74 288,68" />
    <circle cx="160" cy="108" r="3" />
    <circle cx="220" cy="112" r="3" />
    <circle cx="280" cy="115" r="3" />
    <circle cx="340" cy="118" r="3" />
    <polygon points="418,114 418,126 434,120" />
    <circle cx="150" cy="172" r="3" />
    <circle cx="185" cy="180" r="3" />
    <circle cx="220" cy="188" r="3" />
    <circle cx="255" cy="196" r="3" />
    <polygon points="272,196 272,208 288,202" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <rect x="300" y="60" width="4" height="144" rx="2" />
    <rect x="300" y="200" width="260" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.3">
    <circle cx="360" cy="160" r="6" />
    <circle cx="420" cy="135" r="6" />
    <circle cx="490" cy="100" r="6" />
    <circle cx="530" cy="155" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="450" cy="120" r="9" />
  </g>
</svg>
