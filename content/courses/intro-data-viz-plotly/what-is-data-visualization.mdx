...
<Figure
  slug="viz-what-is-dataviz-cutout"
  alt="What data visualization is, an isometric illustration"
/>
...
<Figure
  slug="viz-what-is-data-visualization-working-definition-inline-cutout"
  alt="A column of plain chips on the left and the same column drawn as a shape on the right"
  caption="Visualisation turns numbers into a shape the eye can judge directly."
/>
...
The test is whether some visual property is a function of a number. Below
are the same four figures on both sides of that line:

<Chart slug="chart-vs-decoration" />
...
<Figure
  slug="viz-what-is-data-visualization-not-data-visualization-inline-cutout"
  alt="A picture of relationships drawn with no scale anywhere beside a picture whose marks are pinned to a ruled scale"
  caption="A diagram shows relationships; a visualization pins marks to a scale you can read values off."
/>
...
<Figure
  slug="viz-what-is-data-visualization-live-example-same-data-inline-cutout"
  alt="Five values shown three times over, as bars, as a line and as parts of one whole"
  caption="The same five numbers, three encodings, and three different things made easy to see."
/>
...
The same summary statistics, four completely different datasets. This is
