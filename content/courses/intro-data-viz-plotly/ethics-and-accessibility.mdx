...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="The same two bars drawn twice: a truncated axis on the left exaggerates their gap and earns a red warning, while the zero-based version on the right earns a green check"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="80" y="50" width="210" height="160" rx="10" />
    <rect x="350" y="50" width="210" height="160" rx="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="120" y="86" width="44" height="96" rx="8" fillOpacity="0.5" />
    <rect x="196" y="146" width="44" height="36" rx="8" fillOpacity="0.5" />
    <polygon points="185,26 173,46 197,46" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="183" y="33" width="4" height="7" rx="2" />
    <circle cx="185" cy="43" r="1.8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor" fillOpacity="0.5">
    <circle cx="110" cy="184" r="2.5" />
    <circle cx="130" cy="184" r="2.5" />
    <circle cx="150" cy="184" r="2.5" />
    <circle cx="170" cy="184" r="2.5" />
    <circle cx="190" cy="184" r="2.5" />
    <circle cx="210" cy="184" r="2.5" />
    <circle cx="230" cy="184" r="2.5" />
    <circle cx="250" cy="184" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="390" y="118" width="44" height="64" rx="8" fillOpacity="0.6" />
    <rect x="466" y="134" width="44" height="48" rx="8" fillOpacity="0.6" />
    <circle cx="530" cy="36" r="10" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="524,36 527,33 529,36 534,29 537,32 529,43" />
  </g>
  <rect x="370" y="182" width="170" height="4" rx="2" fill="currentColor" opacity="0.3" />
</svg>
