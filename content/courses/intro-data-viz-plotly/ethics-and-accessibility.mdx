...
nobody has to match a colour to a swatch.
...
<Figure
  slug="viz-ethics-and-accessibility-visualization-ethics-its-inline-cutout"
  alt="Two charts of the same data side by side, one with its base rail cut away to exaggerate a gap"
  caption="The same numbers can be drawn honestly or persuasively, and you choose which."
/>
