...
<Chart slug="colour-scale-families" />
...
Lightness is what makes a colour scale readable, and it is exactly what the
...
<Chart slug="emphasis-one-colour" />
...
<Figure
  ...
  alt="Three swatch strips, one running pale to deep in one ink, one running between two inks, one of separate distinct colours"
