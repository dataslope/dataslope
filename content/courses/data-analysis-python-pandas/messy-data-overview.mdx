...
<Figure
  ...
  caption="Wrong types, empty cells and repeated rows are the faults you meet most."
/>
...
<Figure
  ...
  caption="Cleaning is a sequence of small fixes, each leaving the table a little better."
/>
...
<Figure
  ...
  caption="Messy means the table breaks its own rules, not that it looks untidy."
/>
