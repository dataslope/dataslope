...
<Figure
  ...
  caption="The chart type is chosen to fit the data, not the other way round."
/>
...
<Figure
  slug="pandas-choosing-the-right-chart-practical-anti-checklist-inline-cutout"
  alt="Four chart frames on a rack with three of them turned face to the wall and one left facing out"
  caption="Most chart types are wrong for a given question; usually one is left facing you."
/>
...
<Figure
  slug="pandas-choosing-the-right-chart-doubt-show-data-inline-cutout"
  alt="A summary gauge lifted away to reveal the raw scatter it was standing on"
  caption="Lift the summary away and the individual points are still the honest picture."
/>
