...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A teal decision diamond with a question mark fans out along thin lines to four small chart thumbnails, bars, a line, a scatter, and a histogram, pick the chart that answers the question"
...
>
  ...
  <g
    ...
    opacity="0.25"
  >
    <path d="M304 104 C 230 128, 162 145, 118 160" />
    <path d="M314 112 C 292 130, 270 146, 254 160" />
    <path d="M326 112 C 348 130, 370 146, 386 160" />
    <path d="M336 104 C 410 128, 478 145, 522 160" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="55" y="165" width="110" height="60" rx="10" />
    <rect x="195" y="165" width="110" height="60" rx="10" />
    <rect x="335" y="165" width="110" height="60" rx="10" />
    <rect x="475" y="165" width="110" height="60" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="72" y="195" width="14" height="22" rx="3" />
    <rect x="92" y="185" width="14" height="32" rx="3" />
    <rect x="112" y="203" width="14" height="14" rx="3" />
    <rect x="132" y="190" width="14" height="27" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }}>
    <path
      d="M211 210 L 240 190 L 265 198 L 294 178"
      fill="none"
      stroke="currentColor"
      strokeWidth="4"
      strokeLinecap="round"
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="352" cy="205" r="4" fillOpacity="0.8" />
    <circle cx="368" cy="192" r="4" fillOpacity="0.8" />
    <circle cx="384" cy="200" r="4" fillOpacity="0.8" />
    <circle cx="400" cy="183" r="4" fillOpacity="0.8" />
    <circle cx="416" cy="190" r="4" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="490" y="200" width="16" height="17" rx="2" fillOpacity="0.8" />
    <rect x="506" y="190" width="16" height="27" rx="2" fillOpacity="0.8" />
    <rect x="522" y="185" width="16" height="32" rx="2" fillOpacity="0.8" />
    <rect x="538" y="196" width="16" height="21" rx="2" fillOpacity="0.8" />
  </g>
</svg>
