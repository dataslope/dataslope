...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A spiral of dots circles inward, growing larger and bolder with each pass until it reaches a bright green center — exploratory analysis closing in on understanding"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <circle cx="420" cy="120" r="3" />
    <circle cx="393" cy="181" r="3" />
    <circle cx="336" cy="209" r="3" />
    <circle cx="277" cy="194" r="3" />
    <circle cx="244" cy="148" r="3" />
    <circle cx="249" cy="94" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="284" cy="58" r="4" fillOpacity="0.45" />
    <circle cx="332" cy="55" r="4" fillOpacity="0.45" />
    <circle cx="367" cy="80" r="4.5" fillOpacity="0.45" />
    <circle cx="377" cy="120" r="4.5" fillOpacity="0.45" />
    <circle cx="360" cy="153" r="5" fillOpacity="0.45" />
    <circle cx="328" cy="167" r="5" fillOpacity="0.45" />
    <circle cx="299" cy="157" r="5.5" fillOpacity="0.8" />
    <circle cx="285" cy="133" r="5.5" fillOpacity="0.8" />
    <circle cx="289" cy="109" r="6" fillOpacity="0.8" />
    <circle cx="306" cy="96" r="6" fillOpacity="0.8" />
    <circle cx="324" cy="97" r="6.5" fillOpacity="0.8" />
  </g>
