...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A magnifying glass hovering over a faint data grid, revealing a few bright colored dots inside its lens, exploratory analysis surfacing patterns"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="150" y="42" width="44" height="24" rx="5" />
    <rect x="202" y="42" width="44" height="24" rx="5" />
    <rect x="254" y="42" width="44" height="24" rx="5" />
    <rect x="150" y="76" width="44" height="24" rx="5" />
    <rect x="202" y="76" width="44" height="24" rx="5" />
    <rect x="150" y="110" width="44" height="24" rx="5" />
    <rect x="202" y="110" width="44" height="24" rx="5" />
    <rect x="254" y="110" width="44" height="24" rx="5" />
    <rect x="150" y="144" width="44" height="24" rx="5" />
    <rect x="202" y="144" width="44" height="24" rx="5" />
    <rect x="254" y="144" width="44" height="24" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="370" cy="100" r="52" fillOpacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="352" cy="90" r="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="386" cy="116" r="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="382" cy="76" r="7" />
  </g>
