  ...
  files={[
    {
      ...
      initCode: `import pandas as pd
df = pd.read_csv("diamonds.csv")`,
      starterCode: `display(df.head())
print()
display(df.sample(5, random_state=0))  # random rows often reveal weirdness
`,
    },
  ]}
/>
...
display(report[report["missing"] > 0].sort_values("missing", ascending=False))
print()
  ...
  files={[
    {
      ...
      initCode: `import pandas as pd
df = pd.read_csv("diamonds.csv")`,
      starterCode: `display(df.describe().T)
`,
    },
  ]}
/>
  ...
  files={[
    {
      ...
      initCode: `import pandas as pd
df = pd.read_csv("diamonds.csv")`,
      starterCode: `display(df.groupby("cut")["price"].describe().round(0))
`,
    },
  ]}
/>
