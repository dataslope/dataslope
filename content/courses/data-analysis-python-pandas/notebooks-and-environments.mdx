...
<Figure
  slug="pandas-notebooks-cutout"
  alt="Notebooks and environments, an isometric illustration"
/>
...
<Figure
  slug="pandas-notebooks-and-environments-inline-cutout"
  alt="A bench where each step is a separate small card, run in order and leaving its result pinned beneath it"
  caption="A notebook is only reproducible if the cells still work run in order."
/>
...
<Figure
  slug="pandas-notebooks-and-environments-python-environment-inline-cutout"
  alt="One interpreter with a library rack beside it, the pair standing together as a single unit"
  caption="An environment is an interpreter plus the library directory that belongs to it."
/>
...
<Figure
  slug="pandas-notebooks-and-environments-scripts-vs-notebooks-inline-cutout"
  alt="One sealed strip of instructions run end to end beside a bench of separate cards each leaving its own result pinned below"
  caption="A script runs start to finish; a notebook keeps each step and its output."
/>
