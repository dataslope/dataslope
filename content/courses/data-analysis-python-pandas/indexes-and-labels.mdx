...
<Figure
  slug="pandas-indexes-and-labels-cutout"
  alt="Indexes and labels, an isometric illustration"
/>
...
<Figure
  slug="pandas-indexes-and-labels-bother-labeled-index-inline-cutout"
  alt="A hand reaching straight to one tagged row in a tall board, ignoring the rows above and below"
  caption="A labelled index goes straight to the row you want, however tall the table."
/>
...
<Figure
  slug="pandas-indexes-and-labels-index-inline-cutout"
  alt="A board whose rows each carry a tag on the left edge, a hand pulling one row out by its tag alone"
  caption="The index labels every row, and a label lets you pull that row out by name."
/>
