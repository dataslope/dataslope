...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two rows of cells with little label tags between them; matching tags connect by straight vertical lines except one crossed pair, pandas lines values up by label, not by position"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M180 99 V 111" />
    <path d="M250 99 V 111" />
    <path d="M320 99 L 386 111" />
    <path d="M390 99 L 324 111" />
  </g>
