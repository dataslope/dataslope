...
<Figure
  slug="pandas-history-of-data-rows-columns-are-inline-cutout"
  alt="A clay tablet of pressed filled cells lying beside a modern board of coloured filled cells in the same arrangement"
  caption="Rows and columns are an accounting invention that computers only inherited."
/>
...
<Figure
  slug="pandas-history-of-data-visicalc-cutout"
  alt="A personal computer showing an empty grid with one cell lit, and blocks tipping into one another across the grid"
  caption="VisiCalc, 1979: change one cell and the change ripples, which is what made a personal computer worth buying."
/>
...
<Figure
  slug="pandas-history-of-data-then-data-outgrew-inline-cutout"
  alt="A ruled grid overflowing at every edge, records spilling past its borders onto the bench"
  caption="Cheap sensors and cheap storage produce more records than one grid can hold."
/>
