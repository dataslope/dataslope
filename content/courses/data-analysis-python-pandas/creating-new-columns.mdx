...
<Figure
  slug="pandas-creating-new-columns-simplest-case-arithmetic-inline-cutout"
  alt="Two standing columns feeding a small adding machine that sets a third column down beside them"
  caption="Arithmetic between two columns produces a third, aligned row for row."
/>
