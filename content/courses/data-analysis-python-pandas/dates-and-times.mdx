...
<Figure
  slug="pandas-dates-and-times-cutout"
...
<Figure
  slug="pandas-dates-and-times-dt-accessor-inline-cutout"
  alt="A dated card opened out to show three separate small cards inside it, one for each part"
  caption="Once a column is a datetime, `.dt` opens it into year, month and day."
/>

<Figure
  slug="pandas-dates-and-times-parsing-dates-inline-cutout"
  alt="A written slip fed into a small machine and leaving as a tidy dated card with three separate fields"
  caption="Parsing turns text that looks like a date into a value pandas can compute with."
/>

<Figure
  slug="pandas-dates-and-times-inline-cutout"
  alt="A calendar strip with a clock face at one end, a marker resting on one square and a caliper measuring to another"
  caption="Real dates let you measure the distance between two of them, not just print them."
/>
