...
df = pd.read_csv("diamonds.csv")`,
      starterCode: `display(df.describe().round(2).T)
`,
    },
  ]}
/>
  ...
  files={[
    {
      ...
      initCode: `import pandas as pd
df = pd.read_csv("diamonds.csv")`,
      starterCode: `display(df.describe(include="object"))
`,
    },
  ]}
/>
...
housing = pd.read_csv("housing.csv")`,
      starterCode: `display(housing.corr().round(2))
`,
    },
  ]}
/>
...
display(df.groupby("cut")["price"].describe().round(0))
`,
    },
  ]}
/>
