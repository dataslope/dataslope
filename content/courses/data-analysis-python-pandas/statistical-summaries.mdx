...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A scatter of many dots passes between two converging funnel walls and emerges as one large green circle linked by thin lines to small satellite values — a whole distribution compressed into a few summary numbers"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M464 90 L 500 74" />
    <path d="M466 116 L 506 126" />
    <path d="M460 134 L 476 162" />
  </g>
