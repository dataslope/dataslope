...
<Figure
  slug="pandas-selecting-data-cutout"
  alt="Selecting data, an isometric illustration"
/>
...
<Figure
  slug="pandas-selecting-data-five-access-methods-inline-cutout"
  alt="Five differently shaped keys hanging above one board, each fitting a different opening in its edge"
  caption="Pandas offers several ways in, each suited to a different kind of question."
/>
...
display(df.loc[["Aiko", "Chen", "Eve"], ["salary", "department"]])
print()

# A label-based slice (INCLUSIVE on both ends)
display(df.loc["Aiko":"Chen"])
`,
    },
  ]}
/>
...
<Figure
  slug="pandas-selecting-data-inline-cutout"
  alt="A wide board with a small window frame moved over it, only what shows through the window copied to a second board"
  caption="Selection copies the part of the table you framed and leaves the rest behind."
/>
