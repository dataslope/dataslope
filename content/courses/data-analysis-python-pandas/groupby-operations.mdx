...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Mixed colored dots in one box split along thin lines into three single-color boxes, and each box collapses into one summary row of its color, groupby's split, apply, combine"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M390 58 L 434 92" />
    <path d="M390 115 H 434" />
    <path d="M390 172 L 434 138" />
  </g>
