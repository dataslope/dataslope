...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A scattered pile of tilted colored files on the left becomes neat rows of upright files on two tidy shelves on the right — a little structure keeping a project survivable"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="110" y="76" width="36" height="24" rx="5" transform="rotate(-6 128 88)" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="140" y="100" width="40" height="26" rx="5" transform="rotate(10 160 113)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="95" y="120" width="46" height="30" rx="5" transform="rotate(-14 118 135)" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="165" y="132" width="44" height="28" rx="5" transform="rotate(18 187 146)" />
    <rect x="90" y="155" width="38" height="24" rx="5" transform="rotate(8 109 167)" />
  </g>
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      ...
      strokeLinecap="round"
    />
    <polygon points="316,118 302,111 302,125" fill="currentColor" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="360" y="112" width="180" height="7" rx="3.5" />
    <rect x="360" y="182" width="180" height="7" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="372" y="68" width="26" height="44" rx="4" />
    <rect x="404" y="72" width="26" height="40" rx="4" />
    <rect x="500" y="138" width="26" height="44" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="436" y="66" width="26" height="46" rx="4" />
    <rect x="468" y="70" width="26" height="42" rx="4" />
    <rect x="468" y="142" width="26" height="40" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="500" y="68" width="26" height="44" rx="4" />
    <rect x="372" y="140" width="26" height="42" rx="4" />
    <rect x="404" y="136" width="26" height="46" rx="4" />
  </g>
</svg>
