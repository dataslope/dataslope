...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue root folder with a small readme page branches into tidy green, yellow, and blue subfolders, each with its own little file bars beside it — a little structure keeping a project survivable"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="150,40 150,32 180,32 188,40" />
    <rect x="150" y="40" width="80" height="50" rx="6" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="260" y="48" width="40" height="28" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="266" y="56" width="28" height="4" rx="2" />
    <rect x="266" y="64" width="20" height="4" rx="2" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="186" y="90" width="4" height="108" rx="2" />
    <rect x="190" y="116" width="56" height="4" rx="2" />
    <rect x="190" y="156" width="56" height="4" rx="2" />
    <rect x="190" y="196" width="56" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="258,104 258,98 280,98 286,104" />
    <rect x="258" y="104" width="64" height="32" rx="5" fillOpacity="0.75" />
    <rect x="340" y="115" width="26" height="9" rx="4.5" fillOpacity="0.6" />
    <rect x="374" y="115" width="18" height="9" rx="4.5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="258,144 258,138 280,138 286,144" />
    <rect x="258" y="144" width="64" height="32" rx="5" fillOpacity="0.75" />
    <rect x="340" y="155" width="26" height="9" rx="4.5" fillOpacity="0.6" />
    <rect x="374" y="155" width="18" height="9" rx="4.5" fillOpacity="0.6" />
    <rect x="400" y="155" width="22" height="9" rx="4.5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="258,184 258,178 280,178 286,184" />
    <rect x="258" y="184" width="64" height="32" rx="5" fillOpacity="0.5" />
    <rect x="340" y="195" width="26" height="9" rx="4.5" fillOpacity="0.5" />
    <rect x="374" y="195" width="18" height="9" rx="4.5" fillOpacity="0.5" />
  </g>
</svg>
...
- `.gitignore` excludes `data/raw/` and `data/processed/`
  (data should not be in git for size/PII reasons).
