...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A clean data grid fans out along dotted paths into three folded-corner files — comma-separated text, striped columnar storage, and a small spreadsheet grid — results exported for handoff"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="60" width="42" height="22" rx="4" fillOpacity="0.5" />
    <rect x="130" y="60" width="42" height="22" rx="4" fillOpacity="0.5" />
    <rect x="180" y="60" width="42" height="22" rx="4" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="80" y="90" width="42" height="22" rx="4" />
    <rect x="130" y="90" width="42" height="22" rx="4" />
    <rect x="180" y="90" width="42" height="22" rx="4" />
    <rect x="80" y="120" width="42" height="22" rx="4" />
    <rect x="130" y="120" width="42" height="22" rx="4" />
    <rect x="180" y="120" width="42" height="22" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="255" cy="90" r="3" />
    <circle cx="300" cy="72" r="3" />
    <circle cx="345" cy="56" r="3" />
    <circle cx="255" cy="105" r="3" />
    <circle cx="300" cy="110" r="3" />
    <circle cx="345" cy="113" r="3" />
    <circle cx="255" cy="120" r="3" />
    <circle cx="300" cy="140" r="3" />
    <circle cx="345" cy="160" r="3" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <rect x="390" y="24" width="110" height="56" rx="8" />
    <rect x="390" y="96" width="110" height="56" rx="8" />
    <rect x="390" y="168" width="110" height="56" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <polygon points="478,24 500,46 478,46" />
    <polygon points="478,96 500,118 478,118" />
    <polygon points="478,168 500,190 478,190" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="404" y="44" width="22" height="8" rx="4" fillOpacity="0.7" />
    <rect x="438" y="44" width="18" height="8" rx="4" fillOpacity="0.7" />
  </g>
  <g fill="currentColor" opacity="0.45">
    <circle cx="432" cy="50" r="2.5" />
    <circle cx="462" cy="50" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <rect x="404" y="62" width="60" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="404" y="108" width="14" height="36" rx="3" fillOpacity="0.7" />
    <rect x="424" y="108" width="14" height="36" rx="3" fillOpacity="0.45" />
    <rect x="444" y="108" width="14" height="36" rx="3" fillOpacity="0.7" />
    <rect x="464" y="108" width="14" height="36" rx="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="404" y="180" width="20" height="14" rx="3" fillOpacity="0.6" />
    <rect x="428" y="180" width="20" height="14" rx="3" fillOpacity="0.4" />
    <rect x="404" y="198" width="20" height="14" rx="3" fillOpacity="0.4" />
    <rect x="428" y="198" width="20" height="14" rx="3" fillOpacity="0.6" />
  </g>
</svg>
