...
<Figure
  slug="pandas-exporting-cleaned-data-csv-universal-lowest-inline-cutout"
  alt="One plain carton fitting equally into four different machines' loading slots"
  caption="CSV fits everywhere because it carries nothing but the values themselves."
/>
...
<Figure
  slug="pandas-exporting-cleaned-data-excel-format-stakeholders-inline-cutout"
  alt="A cleaned board being sealed into a ruled green carton with a familiar handle"
  caption="Excel is the format most colleagues can open, which often decides it."
/>
...
<Figure
  ...
  caption="Exporting seals the cleaned table so the next person starts where you finished."
/>
...
- It hides personal data
  > The DataFrame's index is typically a numeric RangeIndex with no personal data; \`index=False\` avoids an unwanted extra column, not a privacy concern.
- It is required
