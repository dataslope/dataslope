...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A cleaned table wearing a green check badge pours down a thin arrow and fans into three destination cards — comma-separated blue text, green columnar bars, and a yellow spreadsheet grid — one result, exported three ways"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="320" y1="150" x2="160" y2="160" />
    <line x1="320" y1="150" x2="320" y2="160" />
    <line x1="320" y1="150" x2="480" y2="160" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="220" y="20" width="200" height="90" rx="12" fillOpacity="0.07" />
    <rect x="240" y="36" width="48" height="14" rx="4" />
    <rect x="296" y="36" width="48" height="14" rx="4" />
    <rect x="352" y="36" width="48" height="14" rx="4" />
    <rect x="240" y="58" width="160" height="14" rx="4" fillOpacity="0.18" />
    <rect x="240" y="80" width="160" height="14" rx="4" fillOpacity="0.18" />
  </g>
  <circle cx="424" cy="26" r="12" fill="var(--ds-green-500)" />
  <polyline points="418,26 422,30 430,19" fill="none" stroke="var(--ds-white)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
  <g fill="var(--ds-gray-400)">
    <rect x="318.5" y="118" width="3" height="22" rx="1.5" />
    <polygon points="314.5,138 325.5,138 320,149" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="85" y="160" width="150" height="70" rx="12" fillOpacity="0.08" />
    <rect x="105" y="182" width="36" height="7" rx="3.5" fillOpacity="0.6" />
    <rect x="152" y="182" width="26" height="7" rx="3.5" fillOpacity="0.6" />
    <circle cx="146" cy="188" r="2" />
    <rect x="105" y="200" width="28" height="7" rx="3.5" fillOpacity="0.6" />
    <rect x="144" y="200" width="34" height="7" rx="3.5" fillOpacity="0.6" />
    <circle cx="138" cy="206" r="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="245" y="160" width="150" height="70" rx="12" fillOpacity="0.08" />
    <rect x="267" y="176" width="12" height="38" rx="3" />
    <rect x="287" y="176" width="12" height="38" rx="3" fillOpacity="0.5" />
    <rect x="307" y="176" width="12" height="38" rx="3" />
    <rect x="327" y="176" width="12" height="38" rx="3" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="405" y="160" width="150" height="70" rx="12" fillOpacity="0.1" />
    <rect x="427" y="176" width="24" height="16" rx="3" />
    <rect x="457" y="176" width="24" height="16" rx="3" fillOpacity="0.5" />
    <rect x="427" y="198" width="24" height="16" rx="3" fillOpacity="0.5" />
    <rect x="457" y="198" width="24" height="16" rx="3" />
  </g>
</svg>
