...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A clean data grid fans out along thin lines into three folded-corner files — comma-separated text, striped columnar storage, and a small spreadsheet grid — results exported for handoff"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M232 90 C 290 72, 330 60, 384 52" />
    <path d="M232 101 C 290 104, 330 110, 384 118" />
    <path d="M232 112 C 290 140, 330 166, 384 190" />
  </g>
