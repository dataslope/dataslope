...
<Figure
  slug="pandas-data-disasters-cutout"
  alt="Famous data disasters, an isometric illustration"
/>
...
<Figure
  slug="pandas-data-disasters-vancouver-index-cutout"
  alt="A rising staircase of green blocks above a falling staircase of red ones, a crumb dropping off the edge of every red step"
  caption="Vancouver Stock Exchange, 1982 to 1983: the market rose, and a truncated third decimal walked the index down to 520."
/>
...
<Figure
  slug="pandas-data-disasters-mars-orbiter-cutout"
  alt="An orbiter passing low over a red planet's horizon, a ground antenna aimed at it, and two measuring rules of different lengths laid end to end"
  caption="Mars, September 1999: pound-force seconds on one side of the interface, newton-seconds on the other."
/>
...
<Figure
  slug="pandas-data-disasters-excel-genes-cutout"
  alt="A conveyor carrying plain tiles into a machine that stamps a calendar leaf onto each one, the changed tiles piling up"
  caption="By 2020 it was easier to rename the genes than to stop spreadsheets reading SEPT2 as a date."
/>
...
<Figure
  slug="pandas-data-disasters-london-whale-cutout"
  alt="Four blank spreadsheets pegged along a washing line, a figure carrying one tile by hand between them, and a whale's tail rising behind the last"
  caption="JPMorgan, 2012: a risk model that ran on copy-paste between sheets, and a formula dividing by a sum instead of an average."
/>
...
<Figure
  slug="pandas-data-disasters-museum-has-common-inline-cutout"
  alt="Four cracked exhibits on plinths in a row, each cracked in the same place"
  caption="Every disaster here broke at the same point: nothing checked the numbers."
/>
