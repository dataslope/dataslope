...
<Figure
  slug="pandas-spreadsheets-vs-code-austerity-cutout"
  alt="A spreadsheet whose selection bracket stops five rows short of the bottom, a figure pointing at the gap, an empty lectern nearby"
  caption="Reinhart and Rogoff, 2010: an average that stopped five countries short, quoted in budget debates on two continents."
/>
...
<Figure
  slug="pandas-spreadsheets-vs-code-five-row-error-inline-cutout"
  alt="A tall column of solid coloured row blocks stacked flush against each other, with a bracket clamped down one side that stops five blocks short of the bottom, those five blocks left outside it"
  caption="The classic spreadsheet error: the formula range stops short of the last rows."
/>
