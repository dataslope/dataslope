...
<Figure
  ...
  alt="A tall column of solid colored row blocks stacked flush against each other, with a bracket clamped down one side that stops five blocks short of the bottom, those five blocks left outside it"
