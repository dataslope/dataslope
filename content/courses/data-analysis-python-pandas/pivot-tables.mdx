...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A long three-column table beside a compact matrix with green row labels, yellow column labels, and blue dots sized by their value — a pivot table taking shape"
