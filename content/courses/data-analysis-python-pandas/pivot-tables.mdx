...
<Figure
  slug="pandas-pivot-tables-shape-pivot-inline-cutout"
  alt="A tall narrow stack of records unfolding into a wide flat board, one record landing in each square"
  caption="A pivot spreads one long column of records across a grid of rows and columns."
/>
