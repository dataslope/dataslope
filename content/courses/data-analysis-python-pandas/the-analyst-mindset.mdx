...
<Figure
  slug="pandas-analyst-mindset-cutout"
  alt="The analyst mindset, an isometric illustration"
/>
...
<Figure
  slug="pandas-the-analyst-mindset-inline-cutout"
  alt="A finding pinned to a board with a hand lifting it to check the raw rows stacked underneath"
  caption="Every finding should be traceable back to the rows that produced it."
/>
...
display(orders[(orders["amount"] <= 0) | (orders["amount"] > 100000)])
`,
    },
  ]}
/>
...
<Figure
  slug="pandas-the-analyst-mindset-common-cognitive-traps-inline-cutout"
  alt="Three covered pits along a bench, each with a plank laid over it and a figure stepping carefully"
  caption="The traps are covered over, so knowing where they lie is most of the defence."
/>
