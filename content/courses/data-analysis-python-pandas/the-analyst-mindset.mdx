...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A bar chart where one bar towers suspiciously above the rest, with a magnifying glass held over it — the analyst habit of questioning a surprising number instead of trusting it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="160" y="180" width="320" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="178" y="122" width="44" height="50" rx="6" />
    <rect x="258" y="97" width="44" height="75" rx="6" />
    <rect x="418" y="107" width="44" height="65" rx="6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="338" y="52" width="44" height="120" rx="6" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <circle cx="360" cy="64" r="34" strokeWidth="3.5" />
    <path d="M384 88 L 412 116" strokeWidth="5" />
  </g>
</svg>
