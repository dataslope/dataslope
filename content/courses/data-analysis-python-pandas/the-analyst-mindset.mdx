...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A bar chart where one red bar towers suspiciously above the calm blue rest, the analyst habit of questioning a surprising number instead of trusting it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="160" y="180" width="320" height="3" rx="1.5" />
  </g>
