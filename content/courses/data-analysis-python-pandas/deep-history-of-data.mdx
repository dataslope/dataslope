...
<Figure
  slug="pandas-deep-history-of-data-big-data-actually-means-inline-cutout"
  alt="One bench of familiar tools, and beside it the same tools mounted along a much longer line fed by many hoppers"
  caption="The concepts carry over unchanged; what changes is where the work runs."
/>
...
<Figure
  slug="pandas-deep-history-of-data-codd-s-relational-model-inline-cutout"
  alt="A set of ruled tables joined only by matching marks written in their own cells, every cord between them cut away"
  caption="Tables related by values in their own cells, with no pointers between records."
/>
