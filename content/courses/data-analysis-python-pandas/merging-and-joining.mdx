...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Two large overlapping circles share a glowing yellow lens, above four miniature circle pairs shaded differently for inner, left, right, and outer joins"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="270" cy="85" r="55" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="350" cy="85" r="55" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M310 47 A55 55 0 0 1 310 123 A55 55 0 0 1 310 47 Z" fillOpacity="0.75" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="122" cy="190" r="16" fillOpacity="0.15" />
    <circle cx="252" cy="190" r="16" fillOpacity="0.8" />
    <circle cx="382" cy="190" r="16" fillOpacity="0.15" />
    <circle cx="512" cy="190" r="16" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="138" cy="190" r="16" fillOpacity="0.15" />
    <circle cx="268" cy="190" r="16" fillOpacity="0.15" />
    <circle cx="398" cy="190" r="16" fillOpacity="0.8" />
    <circle cx="528" cy="190" r="16" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="130" cy="190" r="6" fillOpacity="0.9" />
  </g>
</svg>
