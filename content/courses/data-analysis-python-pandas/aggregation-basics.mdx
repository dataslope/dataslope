...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Six value rows converge along thin lines into a single large green circle marked with a sigma — an aggregation collapsing many numbers into one"
...
>
  ...
  <g
    ...
    opacity="0.25"
  >
    <path d="M244 35 C 310 45, 355 70, 396 93" />
    <path d="M244 62 C 310 68, 355 82, 396 97" />
    <path d="M244 89 C 310 92, 355 97, 396 101" />
    <path d="M244 116 C 310 114, 355 109, 396 105" />
    <path d="M244 143 C 310 138, 355 124, 396 109" />
    <path d="M244 170 C 310 161, 355 136, 396 113" />
  </g>
