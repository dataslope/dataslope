...
<Figure
  slug="pandas-hypothesis-intuition-core-question-noise-inline-cutout"
  alt="A wavering line with a faint steady rise drawn through it, the rise only visible once the wobble is set aside"
  caption="The real question is whether a signal survives once the wobble is set aside."
/>
...
<Figure
  slug="pandas-hypothesis-intuition-exploratory-feel-same-inline-cutout"
  alt="Three scoops taken from one bin, each poured out into a slightly different looking pile"
  caption="Samples from one source still differ, which is why small gaps prove little."
/>
...
<Figure
  ...
  caption="A hypothesis stands until enough evidence stacks up against it."
/>
