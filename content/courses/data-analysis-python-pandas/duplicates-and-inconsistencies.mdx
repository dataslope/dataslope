...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="In a stack of records one row is an exact twin slid out toward a red cross, while on the right two pills of the same shape but different shades sit around an approximately-equals sign, duplicates and inconsistent labels"
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }}>
    <path
      d="M299 104 L 313 118 M313 104 L 299 118"
      fill="none"
      stroke="currentColor"
      strokeWidth="3.5"
      strokeLinecap="round"
