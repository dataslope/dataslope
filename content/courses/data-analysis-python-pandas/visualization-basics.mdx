...
Six ways a chart can tell a story the data does not support:
...
The first one, drawn. Five scores within five points of each other, from
zero and then on a cropped axis:
