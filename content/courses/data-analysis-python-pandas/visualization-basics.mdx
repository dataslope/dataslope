...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A faint data grid flows along a line and becomes a chart — axes, blue scatter dots, a thin rising green trend line, and one yellow outlier suddenly visible to the eye"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="50" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="70" y="76" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="70" y="102" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="70" y="128" width="44" height="20" rx="4" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="122" y="50" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="122" y="76" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="122" y="102" width="44" height="20" rx="4" fillOpacity="0.25" />
    <rect x="122" y="128" width="44" height="20" rx="4" fillOpacity="0.25" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="174" y="50" width="44" height="20" rx="4" />
    <rect x="174" y="76" width="44" height="20" rx="4" />
    <rect x="174" y="102" width="44" height="20" rx="4" />
    <rect x="174" y="128" width="44" height="20" rx="4" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="238" y="98.5" width="42" height="3" rx="1.5" />
    <polygon points="278,94.5 289,100 278,105.5" />
  </g>
  <rect x="330" y="40" width="5" height="150" rx="2" fill="currentColor" opacity="0.3" />
  <rect x="330" y="185" width="250" height="5" rx="2" fill="currentColor" opacity="0.3" />
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="370" cy="150" r="4.5" fillOpacity="0.85" />
    <circle cx="400" cy="130" r="4.5" fillOpacity="0.85" />
    <circle cx="425" cy="140" r="4.5" fillOpacity="0.85" />
    <circle cx="455" cy="105" r="4.5" fillOpacity="0.85" />
    <circle cx="485" cy="92" r="4.5" fillOpacity="0.85" />
    <circle cx="515" cy="100" r="4.5" fillOpacity="0.85" />
    <circle cx="545" cy="70" r="4.5" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="520" cy="160" r="4.5" />
  </g>
</svg>
