...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A large faint territory scattered with pale dots contains one small bright green region where a handful of vivid dots cluster — the small, well-chosen slice of Python an analyst actually needs"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="30" width="520" height="160" rx="24" fill="currentColor" opacity="0.06" />
  <g fill="currentColor" opacity="0.15">
    ...
    <circle cx="380" cy="55" r="4" />
    <circle cx="460" cy="48" r="4" />
    <circle cx="540" cy="62" r="4" />
    <circle cx="552" cy="170" r="4" />
    <circle cx="300" cy="120" r="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="330" y="90" width="170" height="80" rx="16" fillOpacity="0.15" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="365" cy="115" r="7" />
    <circle cx="470" cy="145" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="405" cy="132" r="7" />
    <circle cx="360" cy="150" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="445" cy="112" r="7" />
  </g>
</svg>
