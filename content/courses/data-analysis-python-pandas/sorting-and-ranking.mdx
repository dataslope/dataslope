...
<Figure
  slug="pandas-sorting-and-ranking-cutout"
  alt="Sorting and ranking, an isometric illustration"
/>
...
display(df.sort_values(["dept", "salary"], ascending=[True, False]))
`,
    },
  ]}
/>
...
<Figure
  slug="pandas-sorting-and-ranking-sort-values-inline-cutout"
  alt="A jumbled row of blocks combed into a rising staircase by one wide comb"
  caption="Sorting rearranges the rows themselves into order."
/>
...
display(df.sort_values(["team", "score"]))
`,
    },
  ]}
/>
...
display(df.sort_values("x", na_position="first"))
`,
    },
  ]}
/>
...
<Figure
  slug="pandas-sorting-and-ranking-inline-cutout"
  alt="A row of blocks of different heights being combed into a rising staircase, with a small pennant planted on each of the tallest three"
  caption="Ranking records each row's place in that order without moving the rows."
/>
