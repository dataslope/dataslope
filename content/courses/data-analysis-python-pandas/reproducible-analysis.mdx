...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A blue script circled by a dotted replay loop produces three perfectly identical green results — rerunning a reproducible analysis gives the same answer every time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="257" cy="110" r="3" />
    <circle cx="249" cy="141" r="3" />
    <circle cx="226" cy="164" r="3" />
    <circle cx="195" cy="172" r="3" />
    <circle cx="164" cy="164" r="3" />
    <circle cx="141" cy="141" r="3" />
    <circle cx="133" cy="110" r="3" />
    <circle cx="141" cy="79" r="3" />
    <circle cx="164" cy="56" r="3" />
    <circle cx="226" cy="56" r="3" />
    <circle cx="249" cy="79" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="195,40 213,48 195,56" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="75" width="90" height="70" rx="14" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="165" y="92" width="55" height="8" rx="4" fillOpacity="0.85" />
    <rect x="165" y="108" width="40" height="8" rx="4" fillOpacity="0.65" />
    <rect x="165" y="124" width="48" height="8" rx="4" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="285" cy="110" r="3" />
    <circle cx="307" cy="110" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="350" cy="110" r="20" />
    <circle cx="430" cy="110" r="20" />
    <circle cx="510" cy="110" r="20" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="354" cy="106" r="6" fillOpacity="0.9" />
    <circle cx="434" cy="106" r="6" fillOpacity="0.9" />
    <circle cx="514" cy="106" r="6" fillOpacity="0.9" />
  </g>
</svg>
