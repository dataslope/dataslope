...
<Figure
  slug="pandas-wide-vs-long-cutout"
  alt="Wide vs long, an isometric illustration"
/>
...
<Figure
  slug="pandas-wide-vs-long-tidy-data-principles-inline-cutout"
  alt="A clean board where every row is one record and every column one measure, a card beside it stating the shape"
  caption="Tidy means one row per observation and one column per variable."
/>
...
<Figure
  slug="pandas-wide-vs-long-inline-cutout"
  alt="A wide short board and a narrow tall board of the same coloured squares standing side by side, with a folding hinge between them"
  caption="Wide and long hold the same values; only the folding is different."
/>
