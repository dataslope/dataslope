...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A wide table with blue, green, and yellow value columns melts through a double arrow into a tall narrow table where the same colors repeat down a single column — one dataset, two shapes"
...
>
  ...
  <g fill="currentColor" opacity="0.4">
    <polygon points="300,112 316,104 316,120" />
    <circle cx="328" cy="112" r="2.5" />
    <circle cx="342" cy="112" r="2.5" />
    <polygon points="354,104 370,112 354,120" />
  </g>
  <g fill="currentColor" opacity="0.2">
