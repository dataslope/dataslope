...
<Figure
  slug="pandas-what-is-data-analysis-working-definition-inline-cutout"
  alt="A crate of raw records at one end of a bench and one clear finding pinned at the other"
  caption="Analysis turns a pile of records into one finding somebody can act on."
/>
...
<Figure
  ...
  caption="The four kinds of analysis differ in how far along the bench they take you."
/>
...
<Figure
  slug="pandas-what-is-data-analysis-end-end-example-slowly-inline-cutout"
  alt="One load moved along a bench through four stations, each station leaving its own mark on the load before the next"
  caption="Load, clean, group, chart: the same four moves behind almost every analysis."
/>
