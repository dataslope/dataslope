...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Six colored station dots ride a thin circular loop whose small gray arrowhead shows the direction of travel, and a thin line exits the loop to a large green dot — the workflow is an ordered loop you repeat until it is honest to ship"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <circle cx="270" cy="110" r="78" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2.5" />
  <polygon points="342.5,104 353.5,104 348,115" fill="var(--ds-gray-400)" />
  <line x1="340" y1="152" x2="468" y2="167" stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round" />
  <polygon points="466,162 477,168 466,173.5" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="270" cy="32" r="9" />
    <circle cx="337.5" cy="149" r="9" />
    <circle cx="202.5" cy="149" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="337.5" cy="71" r="9" />
    <circle cx="270" cy="188" r="9" />
    <circle cx="202.5" cy="71" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="505" cy="168" r="16" />
  </g>
</svg>
