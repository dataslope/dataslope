...
<Figure
  slug="ml-why-ml-exists-cutout"
  alt="Why machine learning exists, an isometric illustration"
/>
...
<Figure
  slug="ml-why-machine-learning-exists-key-decision-prefer-inline-cutout"
  alt="A single short rule card doing a job cleanly beside an elaborate machine idle next to it"
  caption="When a simple rule does the job, it beats a model on every count."
/>
...
<Figure
  slug="ml-why-machine-learning-exists-rules-break-down-inline-cutout"
  alt="A tower of hand-cut rule cards leaning and starting to slip"
  caption="Hand-written rules multiply until nobody can keep the pile standing."
/>
...
<Figure
  slug="ml-why-machine-learning-exists-inline-cutout"
  alt="A bench of hand-cut rules stacked into an unstable tower, beside a machine learning the same rules from a tray of examples"
  caption="A model earns its cost where the rules would otherwise keep changing."
/>
