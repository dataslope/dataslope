...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Around a thin fitted line, one small green residual carries a tiny square while one far-off red miss carries a huge one — squared-error metrics punish big misses far more than small ones"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="80" y1="170" x2="560" y2="60" stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="280" y="120" width="20" height="20" fillOpacity="0.35" />
    <rect x="298.5" y="120" width="3" height="20" rx="1.5" />
    <circle cx="300" cy="140" r="6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="472" y="81" width="89" height="89" fillOpacity="0.12" />
    <rect x="468.5" y="81" width="3" height="89" rx="1.5" fillOpacity="0.7" />
    <circle cx="470" cy="170" r="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="158" r="5" />
    <circle cx="190" cy="136" r="5" />
    <circle cx="250" cy="122" r="5" />
    <circle cx="370" cy="90" r="5" />
    <circle cx="430" cy="88" r="5" />
    <circle cx="530" cy="52" r="5" />
  </g>
</svg>
