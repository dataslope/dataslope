...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A bold blue ROC curve bows high above the dashed diagonal of chance, the whole area beneath it washed light blue, the model judged at every threshold at once"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <rect x="80" y="25" width="3" height="168" rx="1.5" />
    <rect x="80" y="190" width="480" height="3" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M84 190 C 88 130, 100 80, 150 52 C 210 22, 340 24, 556 26 L556 190 Z" fillOpacity="0.1" />
  </g>
  <line x1="84" y1="190" x2="556" y2="26" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="8 7" strokeLinecap="round" />
  <path d="M84 190 C 88 130, 100 80, 150 52 C 210 22, 340 24, 556 26" fill="none" stroke="var(--ds-blue-500)" strokeWidth="4" strokeLinecap="round" />
</svg>
