...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two targets: on the left the shots cluster tightly but away from the bullseye (bias); on the right they scatter widely around it (variance) — the two distinct ways a model misses"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="170" cy="105" r="62" fillOpacity="0.08" />
    <circle cx="170" cy="105" r="42" fillOpacity="0.14" />
    <circle cx="170" cy="105" r="22" fillOpacity="0.22" />
    <circle cx="470" cy="105" r="62" fillOpacity="0.08" />
    <circle cx="470" cy="105" r="42" fillOpacity="0.14" />
    <circle cx="470" cy="105" r="22" fillOpacity="0.22" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="170" cy="105" r="5" />
    <circle cx="470" cy="105" r="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="206" cy="64" r="4.5" />
    <circle cx="218" cy="72" r="4.5" />
    <circle cx="208" cy="78" r="4.5" />
    <circle cx="216" cy="58" r="4.5" />
    <circle cx="222" cy="80" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="430" cy="60" r="4.5" />
    <circle cx="515" cy="75" r="4.5" />
    <circle cx="445" cy="150" r="4.5" />
    <circle cx="505" cy="140" r="4.5" />
    <circle cx="470" cy="55" r="4.5" />
  </g>
</svg>
