...
>
  <g fill="currentColor">
    <circle cx="170" cy="105" r="62" opacity="0.06" />
    <circle cx="170" cy="105" r="42" opacity="0.09" />
    <circle cx="170" cy="105" r="22" opacity="0.12" />
    <circle cx="470" cy="105" r="62" opacity="0.06" />
    <circle cx="470" cy="105" r="42" opacity="0.09" />
    <circle cx="470" cy="105" r="22" opacity="0.12" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="206" cy="64" r="6" />
    <circle cx="218" cy="72" r="6" />
    <circle cx="208" cy="78" r="6" />
    <circle cx="216" cy="58" r="6" />
    <circle cx="222" cy="80" r="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="430" cy="60" r="6" />
    <circle cx="515" cy="75" r="6" />
    <circle cx="445" cy="150" r="6" />
    <circle cx="505" cy="140" r="6" />
    <circle cx="470" cy="55" r="6" />
  </g>
</svg>
