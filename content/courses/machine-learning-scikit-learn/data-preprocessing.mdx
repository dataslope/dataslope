...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A huge blue circle, a tiny green square, and a small yellow dot cross a thin gray arrow and come out the same size on the other side — scaling puts wildly different feature ranges on one common footing"
...
>
  ...
  <g fill="var(--ds-gray-400)">
    <rect x="280" y="108.5" width="90" height="3" rx="1.5" />
    <polygon points="368,104.5 379,110 368,115.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
