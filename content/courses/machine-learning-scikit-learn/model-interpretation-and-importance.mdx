...
<Figure
  slug="ml-model-interpretation-and-importance-coefficients-as-importance-inline-cutout"
  alt="A machine with input pipes of visibly different widths, the widest carrying the most"
  caption="A coefficient's size and sign say how strongly a feature pushes the answer."
/>
...
<Figure
  ...
  caption="A forest can report which features its splits leaned on most."
/>
...
<Figure
  slug="ml-model-interpretation-and-importance-permutation-importance-model-agnostic-inline-cutout"
  alt="One column of a board shuffled at random while every other column stays put, and a gauge reading how much worse it now does"
  caption="Shuffle one column and measure the damage: importance without trusting the model's own story."
/>
...
<Figure
  slug="ml-model-interpretation-and-importance-interpretability-matters-inline-cutout"
  alt="A sealed machine beside the same machine with a glass panel showing which input pipes are widest"
  caption="Seeing which inputs matter is not the same as knowing what causes what."
/>
