...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A very thin gray line of best fit rises through scattered blue dots, with thin yellow residual ticks connecting each dot to the line — linear regression minimizes those gaps"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="98.5" y="150" width="3" height="22" rx="1.5" />
    <rect x="158.5" y="158" width="3" height="12" rx="1.5" />
    <rect x="218.5" y="128" width="3" height="14" rx="1.5" />
    <rect x="278.5" y="128" width="3" height="12" rx="1.5" />
    <rect x="338.5" y="98" width="3" height="14" rx="1.5" />
    <rect x="398.5" y="98" width="3" height="14" rx="1.5" />
    <rect x="458.5" y="68" width="3" height="14" rx="1.5" />
    <rect x="518.5" y="68" width="3" height="16" rx="1.5" />
  </g>
  <line x1="70" y1="180" x2="570" y2="55" stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round" />
