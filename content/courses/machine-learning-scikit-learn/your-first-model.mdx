...
<Figure
  ...
  caption="Learn from labelled examples, then answer for a penguin never seen before."
/>
...
<Figure
  slug="ml-your-first-model-move-1-load-inline-cutout"
  alt="A sealed carton opened on a bench with its first rows fanned out"
  caption="Every project starts the same way: load the table and look at it."
/>
...
k-nearest neighbors (KNN) that simply means it has stored the training penguins in a way it can
search quickly.
...
<Figure
  slug="ml-your-first-model-problem-this-workflow-inline-cutout"
  alt="A bench with five stations, examples entering at one end and a correct answer for a new block leaving at the other"
  caption="The same five stations, in the same order, for every model in the course."
/>
