...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="On the left, dots each wear a small green or blue answer tag; on the right, the same dots sit untagged beside a question mark — supervised data comes with labels, unsupervised data does not"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.4">
    <circle cx="95" cy="86" r="9" />
    <circle cx="170" cy="66" r="9" />
    <circle cx="125" cy="150" r="9" />
    <circle cx="205" cy="124" r="9" />
  ...
  <g fill="currentColor" opacity="0.12">
    <rect x="318" y="36" width="4" height="160" rx="2" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <circle cx="405" cy="86" r="9" />
    <circle cx="480" cy="66" r="9" />
    <circle cx="435" cy="150" r="9" />
    <circle cx="515" cy="124" r="9" />
