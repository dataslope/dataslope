...
<Figure
  ...
  alt="A machine whose inlet accepts only plain blocks, three colored tags waiting outside it"
...
<Figure
  ...
  alt="Three colored tags replaced by blocks of rising height, the heights implying an order the colors never had"
...
<Figure
  ...
  alt="Three colored tags each replaced by a small row of on-off switches, one switch raised in each row"
