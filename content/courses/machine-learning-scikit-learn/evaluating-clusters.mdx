...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A ringed blue dot floats between two soft cluster blobs, joined by a short line to its own blue group and a much longer line to the green neighbor, the silhouette score measures exactly that difference"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="170" cy="100" r="70" fillOpacity="0.1" />
    <circle cx="140" cy="80" r="8" />
    <circle cx="190" cy="65" r="8" />
    <circle cx="200" cy="115" r="8" />
    <circle cx="150" cy="130" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="490" cy="100" r="70" fillOpacity="0.1" />
    <circle cx="460" cy="85" r="8" />
    <circle cx="505" cy="70" r="8" />
    <circle cx="520" cy="120" r="8" />
    <circle cx="470" cy="138" r="8" />
  </g>
  <g stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round">
    <line x1="270" y1="103" x2="209" y2="113" />
    <line x1="290" y1="98" x2="450" y2="87" />
  </g>
  <circle cx="280" cy="100" r="16" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
