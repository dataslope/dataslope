...
<Figure
  slug="ml-logistic-regression-problem-solves-inline-cutout"
  alt="A board of two-colored chips with a smooth S-shaped ramp laid across it"
  caption="Logistic regression turns a linear score into a probability between 0 and 1."
/>
...
<Figure
  slug="ml-logistic-regression-intuition-linear-score-inline-cutout"
  alt="A straight rod producing a value that is then pressed through an S-shaped ramp into a narrow band"
  caption="The sigmoid squashes any score into the range a probability can occupy."
/>
...
<Figure
  slug="ml-logistic-regression-inline-cutout"
  alt="A board of two-colored chips with a smooth S-shaped ramp laid across it, chips low on the ramp reading one color and chips high on it the other"
  caption="Where the ramp crosses your threshold is where the predicted class flips."
/>
...
finish settling. (Scaling the features, covered in *Data Preprocessing*,
...
- **Nonlinear boundaries.** If the classes are separated by a curve or a
  ...
  bends, like a decision tree, a random forest, or a support vector machine
