...
<Figure
  slug="ml-what-is-machine-learning-three-words-will-use-inline-cutout"
  alt="A blank press fed a stack of worked examples until its shape settles, then stamping a new blank"
  caption="Training fits the model to examples; prediction applies it to something it has not seen."
/>
