...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two rows: classic programming feeds a yellow rule and blue data into a machine and gets green answers out, while machine learning feeds data and answers into the machine and gets the yellow rule out — the program inverted"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="60" y="53.5" width="44" height="13" rx="6.5" />
    <rect x="430" y="153.5" width="44" height="13" rx="6.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="124" cy="60" r="5.5" />
    <circle cx="142" cy="60" r="5.5" />
    <circle cx="160" cy="60" r="5.5" />
    <circle cx="64" cy="160" r="5.5" />
    <circle cx="82" cy="160" r="5.5" />
    <circle cx="100" cy="160" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="430" cy="60" r="5.5" />
    <circle cx="448" cy="60" r="5.5" />
    <circle cx="466" cy="60" r="5.5" />
    <circle cx="128" cy="160" r="5.5" />
    <circle cx="146" cy="160" r="5.5" />
    <circle cx="164" cy="160" r="5.5" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="180" y="58.5" width="38" height="3" rx="1.5" />
    <polygon points="216,54.5 227,60 216,65.5" />
    <rect x="362" y="58.5" width="38" height="3" rx="1.5" />
    <polygon points="398,54.5 409,60 398,65.5" />
    <rect x="184" y="158.5" width="34" height="3" rx="1.5" />
    <polygon points="216,154.5 227,160 216,165.5" />
    <rect x="362" y="158.5" width="38" height="3" rx="1.5" />
    <polygon points="398,154.5 409,160 398,165.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="240" y="35" width="110" height="50" rx="12" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="240" y="135" width="110" height="50" rx="12" fillOpacity="0.12" />
  </g>
</svg>
