...
Which of the two you have, read off the curves: a gap still closing
means more data is the cheapest fix, and two curves that met early and
levelled off high mean the model is too simple.
