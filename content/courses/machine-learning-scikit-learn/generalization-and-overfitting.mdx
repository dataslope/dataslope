...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two panels with the same blue and green dots: on the left a calm straight band accepts a little noise; on the right a frantic dotted boundary zigzags to thread every single dot, generalization versus overfitting"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="40" y="20" width="260" height="170" rx="16" />
    <rect x="340" y="20" width="260" height="170" rx="16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="370" cy="55" r="6" />
    <circle cx="400" cy="90" r="6" />
    <circle cx="385" cy="135" r="6" />
    <circle cx="430" cy="60" r="6" />
    <circle cx="450" cy="110" r="6" />
    <circle cx="535" cy="160" r="6" />
    <circle cx="70" cy="55" r="6" />
    <circle cx="100" cy="90" r="6" />
    <circle cx="85" cy="135" r="6" />
    <circle cx="130" cy="60" r="6" />
    <circle cx="150" cy="110" r="6" />
    <circle cx="235" cy="160" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="500" cy="70" r="6" />
    <circle cx="530" cy="120" r="6" />
    <circle cx="490" cy="150" r="6" />
    <circle cx="555" cy="55" r="6" />
    <circle cx="415" cy="40" r="6" />
    <circle cx="200" cy="70" r="6" />
    <circle cx="230" cy="120" r="6" />
    <circle cx="190" cy="150" r="6" />
    <circle cx="255" cy="55" r="6" />
    <circle cx="115" cy="40" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="468" cy="28" r="2.5" fillOpacity="0.85" />
    <circle cx="450" cy="42" r="2.5" fillOpacity="0.85" />
    <circle cx="428" cy="48" r="2.5" fillOpacity="0.85" />
    <circle cx="412" cy="62" r="2.5" fillOpacity="0.85" />
    <circle cx="424" cy="82" r="2.5" fillOpacity="0.85" />
    <circle cx="442" cy="96" r="2.5" fillOpacity="0.85" />
    <circle cx="432" cy="116" r="2.5" fillOpacity="0.85" />
    <circle cx="412" cy="132" r="2.5" fillOpacity="0.85" />
    <circle cx="426" cy="152" r="2.5" fillOpacity="0.85" />
    <circle cx="452" cy="158" r="2.5" fillOpacity="0.85" />
    <circle cx="478" cy="148" r="2.5" fillOpacity="0.85" />
    <circle cx="496" cy="132" r="2.5" fillOpacity="0.85" />
    <circle cx="510" cy="148" r="2.5" fillOpacity="0.85" />
    <circle cx="526" cy="162" r="2.5" fillOpacity="0.85" />
    <polygon points="162,20 188,20 170,190 144,190" fillOpacity="0.3" />
  </g>
</svg>
