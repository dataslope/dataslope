...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three panels: dots climbing along a fitted line, dots colored into two known groups, and unlabeled dots gathered in two loose groups — regression predicts numbers, classification predicts labels, clustering discovers groups"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="80" cy="148" r="4.5" />
    <circle cx="108" cy="132" r="4.5" />
    <circle cx="126" cy="140" r="4.5" />
    <circle cx="148" cy="104" r="4.5" />
    <circle cx="172" cy="88" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="262" cy="70" r="5" />
    <circle cx="288" cy="96" r="5" />
    <circle cx="258" cy="122" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="352" cy="98" r="5" />
    <circle cx="378" cy="124" r="5" />
    <circle cx="356" cy="154" r="5" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <circle cx="478" cy="76" r="4.5" />
    <circle cx="504" cy="70" r="4.5" />
    <circle cx="494" cy="98" r="4.5" />
    <circle cx="550" cy="136" r="4.5" />
    <circle cx="576" cy="130" r="4.5" />
    <circle cx="564" cy="158" r="4.5" />
  </g>
</svg>
