...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A dendrogram fuses six leaf dots into ever larger clusters while a translucent yellow band slices it partway up, revealing three groups — hierarchical clustering builds the whole tree and lets you cut afterward"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.35">
    <rect x="118" y="150" width="4" height="40" rx="2" />
    <rect x="178" y="150" width="4" height="40" rx="2" />
    <rect x="118" y="150" width="64" height="4" rx="2" />
    <rect x="148" y="96" width="4" height="54" rx="2" />
    <rect x="258" y="130" width="4" height="60" rx="2" />
    <rect x="338" y="130" width="4" height="60" rx="2" />
    <rect x="258" y="130" width="84" height="4" rx="2" />
    <rect x="298" y="96" width="4" height="34" rx="2" />
    <rect x="148" y="96" width="154" height="4" rx="2" />
    <rect x="223" y="52" width="4" height="48" rx="2" />
    <rect x="458" y="140" width="4" height="50" rx="2" />
    <rect x="518" y="140" width="4" height="50" rx="2" />
    <rect x="458" y="140" width="64" height="4" rx="2" />
    <rect x="488" y="52" width="4" height="88" rx="2" />
    <rect x="223" y="52" width="269" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="60" y="108" width="520" height="18" rx="9" fillOpacity="0.3" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="260" cy="198" r="6" />
    <circle cx="340" cy="198" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="460" cy="198" r="6" />
    <circle cx="520" cy="198" r="6" />
  </g>
</svg>
...
Second, agglomerative clustering is roughly *O(n²)*, so we draw a **random
