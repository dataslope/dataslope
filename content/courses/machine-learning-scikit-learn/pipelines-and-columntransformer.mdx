...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A blue input dot enters one long capsule holding three solid step blocks chained by thin arrows, and a single green prediction dot comes out the far end, a pipeline bundles every step into one object you fit once"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="70" cy="95" r="10" />
  </g>
  <rect x="140" y="45" width="360" height="100" rx="30" fill="currentColor" opacity="0.06" />
  <g fill="var(--ds-gray-400)">
    <rect x="92" y="93.5" width="28" height="3" rx="1.5" />
    <polygon points="118,89.5 129,95 118,100.5" />
    <rect x="244" y="93.5" width="26" height="3" rx="1.5" />
    <polygon points="268,89.5 279,95 268,100.5" />
    <rect x="359" y="93.5" width="26" height="3" rx="1.5" />
    <polygon points="383,89.5 394,95 383,100.5" />
    <rect x="506" y="93.5" width="28" height="3" rx="1.5" />
    <polygon points="532,89.5 543,95 532,100.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="170" y="70" width="70" height="50" rx="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="285" y="70" width="70" height="50" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="400" y="70" width="70" height="50" rx="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="568" cy="95" r="11" />
  </g>
</svg>
