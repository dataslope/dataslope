...
<Figure
  slug="ml-features-and-targets-cutout"
  alt="Features and targets, an isometric illustration"
/>
...
<Figure
  slug="ml-features-and-targets-two-pieces-every-inline-cutout"
  alt="A board of input columns separated by a clear gap from one marked answer column"
  caption="The features are what you know; the target is what you want to predict."
/>
...
<Figure
  slug="ml-features-and-targets-concrete-example-from-inline-cutout"
  alt="One board split by a clear gap, its left columns lifted as a group and its right column lifted alone"
  caption="Splitting a table into X and y is what frames any supervised problem."
/>
...
<Figure
  slug="ml-features-and-targets-reading-x-shape-inline-cutout"
  alt="A ruled board of rows and columns beside a single narrow strip of exactly the same height"
  caption="`X` is two-dimensional, samples by features; `y` is one-dimensional, one label per sample."
/>
...
<Figure
  slug="ml-features-and-targets-inline-cutout"
  alt="A board of input columns on the left separated by a clear gap from one marked answer column on the right"
  caption="Each kind of feature needs its own preparation before a model can use it."
/>
