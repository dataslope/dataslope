...
>
  <text x="243" y="24" textAnchor="middle" fontFamily="var(--font-mono), ui-monospace, monospace" fontSize="18" fontWeight="700" fill="var(--ds-blue-500)">X</text>
  <text x="447" y="24" textAnchor="middle" fontFamily="var(--font-mono), ui-monospace, monospace" fontSize="18" fontWeight="700" fill="var(--ds-green-500)">y</text>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <rect x="248" y="46" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="312" y="46" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="120" y="80" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="184" y="80" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="248" y="80" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="312" y="80" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="120" y="114" width="54" height="26" rx="6" fillOpacity="0.55" />
    <rect x="184" y="114" width="54" height="26" rx="6" fillOpacity="0.55" />
    <rect x="248" y="114" width="54" height="26" rx="6" fillOpacity="0.55" />
    <rect x="312" y="114" width="54" height="26" rx="6" fillOpacity="0.55" />
    <rect x="120" y="148" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="184" y="148" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="248" y="148" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="312" y="148" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="120" y="182" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="184" y="182" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="248" y="182" width="54" height="26" rx="6" fillOpacity="0.18" />
    <rect x="312" y="182" width="54" height="26" rx="6" fillOpacity="0.18" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="420" y="46" width="54" height="26" rx="6" fillOpacity="0.4" />
    <rect x="420" y="80" width="54" height="26" rx="6" fillOpacity="0.4" />
    <rect x="420" y="114" width="54" height="26" rx="6" fillOpacity="0.95" />
    <rect x="420" y="148" width="54" height="26" rx="6" fillOpacity="0.4" />
    <rect x="420" y="182" width="54" height="26" rx="6" fillOpacity="0.4" />
  </g>
</svg>
...
penguins = pd.read_csv("penguins.csv").dropna(subset=["bill_length_mm","bill_depth_mm","flipper_length_mm","body_mass_g","species"])`,
      starterCode: `# Four numeric measurements describe each penguin; species is the target.
...
<MultipleChoice
  markdown={`What does \`X.shape\` of \`(342, 4)\` tell you?

- 342 features describing 4 samples
  > In scikit-learn, the shape convention is \`(n_samples, n_features)\`: the first number is the number of rows (samples), the second is the number of columns (features). So 342 is the sample count, not the feature count.
- 342 target values and 4 predictions
  > Target values belong in the separate vector \`y\`, not in \`X\`. \`X.shape = (342, 4)\` tells you there are 342 samples and 4 features, with no information about predictions.
- [o] 342 samples (rows), each described by 4 features (columns)
...
- A 342-by-4 image
  > An image would require additional context about pixel layout and color channels. \`X.shape = (342, 4)\` describes a tabular feature matrix with 342 rows and 4 feature columns.

Shape is read rows-first: 342 examples, 4 features each.`}
/>
