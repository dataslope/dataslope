...
<Figure
  ...
  caption="Every estimator wears the same front plate: `fit()`, `predict()`, `score()`."
/>
...
<Figure
  slug="ml-the-scikit-learn-api-proof-same-shape-inline-cutout"
  alt="Three very different machines wearing the identical three-handle plate"
  caption="A regressor, a classifier and a clusterer are driven by the same calls."
/>
...
<Figure
  ...
  caption="One call returns a default quality number, whatever the model inside."
/>
