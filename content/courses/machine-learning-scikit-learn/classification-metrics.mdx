...
<svg
  viewBox="0 0 640 215"
  role="img"
  aria-label="A two-by-two confusion matrix: green diagonal cells collect the correct predictions while a few red dots sit in the faint red off-diagonal cells — the four outcomes hiding behind every accuracy number"
