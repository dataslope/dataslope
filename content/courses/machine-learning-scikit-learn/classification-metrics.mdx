...
<Figure
  slug="ml-classification-metrics-accuracy-trap-inline-cutout"
  alt="A gauge reading almost full beside a tray where ninety-nine chips are one colour and one is another"
  caption="Accuracy looks high when one class is rare, even if the model never finds it."
/>
...
<Figure
  slug="ml-classification-metrics-confusion-matrix-where-inline-cutout"
  alt="A two-by-two board of trays with correct calls in the diagonal and mistakes in the other two"
  caption="Four counts: correct calls on the diagonal, the two kinds of mistake off it."
/>
...
<Figure
  slug="ml-classification-metrics-precision-false-alarms-inline-cutout"
  alt="An alarm bell ringing over a tray where most of the flagged chips turn out to be ordinary"
  caption="Precision asks how many of the flagged cases really were positive."
/>
...
<Figure
  slug="ml-classification-metrics-inline-cutout"
  alt="A two-by-two board of trays with correct calls piled in the diagonal trays and mistakes in the other two, a small gauge reading each"
  caption="`classification_report()` reads every metric off the same four counts."
/>
