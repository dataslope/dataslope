...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A population of blue dots split by an empty gap: the large training side is solid, while the held-out test side waits ghosted until evaluation day"
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="225" cy="50" r="8" />
    <circle cx="280" cy="58" r="8" />
    <circle cx="335" cy="48" r="8" />
    <circle cx="95" cy="105" r="8" />
    <circle cx="150" cy="95" r="8" />
    <circle cx="205" cy="108" r="8" />
    <circle cx="260" cy="98" r="8" />
    <circle cx="315" cy="106" r="8" />
    <circle cx="365" cy="92" r="8" />
    <circle cx="115" cy="152" r="8" />
    <circle cx="185" cy="150" r="8" />
    <circle cx="250" cy="155" r="8" />
    <circle cx="320" cy="150" r="8" />
    <circle cx="370" cy="140" r="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="470" cy="55" r="8" fillOpacity="0.15" />
    <circle cx="530" cy="48" r="8" fillOpacity="0.15" />
    <circle cx="575" cy="70" r="8" fillOpacity="0.15" />
    <circle cx="490" cy="105" r="8" fillOpacity="0.15" />
    <circle cx="550" cy="110" r="8" fillOpacity="0.15" />
    <circle cx="505" cy="155" r="8" fillOpacity="0.15" />
    <circle cx="565" cy="150" r="8" fillOpacity="0.15" />
  </g>
</svg>
