...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A checklist card with two green-checked tasks, one solid blue task in progress, and two dashed empty slots, beside a progress ring whose green arc shows two of five tasks done"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="64" y="28" width="280" height="174" rx="14" fill="currentColor" opacity="0.05" />
  <g fill="none" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="86,52 92,58 102,46" />
    <polyline points="86,82 92,88 102,76" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="118" y="46" width="150" height="12" rx="6" fillOpacity="0.35" />
    <rect x="118" y="76" width="120" height="12" rx="6" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="94" cy="112" r="7" />
    <rect x="118" y="106" width="170" height="12" rx="6" />
  </g>
  <g fill="none" stroke="var(--ds-gray-400)" strokeWidth="1.5" strokeDasharray="4 3">
    <circle cx="94" cy="142" r="7" />
    <circle cx="94" cy="172" r="7" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="118" y="136" width="130" height="12" rx="6" />
    <rect x="118" y="166" width="100" height="12" rx="6" />
  </g>
  <circle cx="480" cy="115" r="56" fill="none" stroke="currentColor" strokeWidth="12" opacity="0.12" />
  <path d="M 480 59 A 56 56 0 0 1 512.9 160.3" fill="none" stroke="var(--ds-green-500)" strokeWidth="12" strokeLinecap="round" />
  <circle cx="480" cy="115" r="10" fill="var(--ds-blue-500)" />
</svg>
