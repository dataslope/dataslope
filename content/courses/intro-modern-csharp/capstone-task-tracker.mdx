...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A clipboard checklist with two tasks checked off in green, one pending, and a new entry still being typed beside a yellow cursor — the capstone task tracker taking shape"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="200" y="34" width="240" height="172" rx="14" fill="currentColor" opacity="0.08" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="290" y="22" width="60" height="20" rx="8" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="320" cy="32" r="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="222" y="64" width="20" height="20" rx="5" />
    <rect x="222" y="98" width="20" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="232" cy="74" r="4.5" />
    <circle cx="232" cy="108" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="254" y="68" width="130" height="12" rx="6" fillOpacity="0.5" />
    <rect x="254" y="102" width="110" height="12" rx="6" fillOpacity="0.4" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="222" y="132" width="20" height="20" rx="5" />
    <rect x="222" y="166" width="20" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="254" y="136" width="140" height="12" rx="6" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="254" y="170" width="60" height="12" rx="6" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="322" y="168" width="8" height="16" rx="2" fillOpacity="0.85" />
  </g>
</svg>
