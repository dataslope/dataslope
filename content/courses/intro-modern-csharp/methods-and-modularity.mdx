...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three leaning runner capsules spaced along a track pass a yellow baton dot from hand to hand, methods handing arguments and results to one another"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="158" width="520" height="4" rx="2" fill="currentColor" opacity="0.18" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="134" cy="62" r="9" />
    <rect x="110" y="80" width="24" height="72" rx="12" transform="rotate(12 122 116)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="324" cy="62" r="9" />
    <rect x="300" y="80" width="24" height="72" rx="12" transform="rotate(12 312 116)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="514" cy="62" r="9" fillOpacity="0.55" />
    <rect x="490" y="80" width="24" height="72" rx="12" transform="rotate(12 502 116)" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor" fillOpacity="0.7">
    <circle cx="168" cy="100" r="3" />
    <circle cx="192" cy="93" r="3" />
    <circle cx="242" cy="93" r="3" />
    <circle cx="266" cy="100" r="3" />
    <circle cx="358" cy="100" r="3" />
    <circle cx="382" cy="93" r="3" />
    <circle cx="432" cy="93" r="3" />
    <circle cx="456" cy="100" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="217" cy="90" r="8" />
    <circle cx="407" cy="90" r="8" fillOpacity="0.45" />
  </g>
</svg>
...
`,
    },
    {
      ...
      starterCode: `public static class MathUtils
{
...
`,
    ...
    {
      filename: "Stats.cs",
      starterCode: `public static class Stats
{
...
`,
      solutionCode: `public static class Stats
{
