...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A board with circle, square, and triangle cut-outs; matching shapes drop straight into their slots, every value matched to its type"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="302" y="44" width="36" height="36" />
