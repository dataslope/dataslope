...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A board with circle, square, and triangle cut-outs; matching shapes drop straight into their slots while a red square is turned away from the round hole — every value matched to its type"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <path d="M132 130 L508 130 Q520 130 520 142 L520 188 Q520 200 508 200 L132 200 Q120 200 120 188 L120 142 Q120 130 132 130 Z M222 165 A22 22 0 1 0 178 165 A22 22 0 1 0 222 165 Z M300 145 L340 145 L340 185 L300 185 Z M418 185 L462 185 L440 143 Z" fill="currentColor" fillRule="evenodd" opacity="0.15" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="200" cy="70" r="20" />
    <circle cx="200" cy="100" r="3" fillOpacity="0.45" />
    <circle cx="200" cy="114" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="302" y="44" width="36" height="36" rx="7" />
    <circle cx="320" cy="98" r="3" fillOpacity="0.45" />
    <circle cx="320" cy="112" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="420,86 460,86 440,50" />
    <circle cx="440" cy="104" r="3" fillOpacity="0.45" />
    <circle cx="440" cy="118" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="148" y="84" width="24" height="24" rx="5" transform="rotate(-15 160 96)" />
    <circle cx="138" cy="120" r="3" fillOpacity="0.55" />
    <circle cx="126" cy="136" r="3" fillOpacity="0.4" />
  </g>
</svg>
...
- [o] The compiler knows the type of every variable and refuses to compile code that uses values in a way that doesn't match their type
  > Type mismatches are caught at compile time, before the program ever runs.
