...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Green tokens leave a depot and ride a thin loop through a yellow work zone back home, while one red token slips off the bottom of the loop and never returns"
...
>
  <g style={{ color: "var(--ds-gray-400)" }}>
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <polygon points="374,42 374,56 388,49" fill="currentColor" fillOpacity="0.6" />
    <polygon points="326,164 326,178 312,171" fill="currentColor" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="70" width="116" height="80" rx="14" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="78" y="84" width="22" height="22" rx="5" fillOpacity="0.85" />
    <rect x="112" y="84" width="22" height="22" rx="5" fillOpacity="0.6" />
    <rect x="78" y="116" width="22" height="22" rx="5" fillOpacity="0.4" />
    <rect x="330" y="38" width="20" height="20" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="490" cy="110" r="27" fillOpacity="0.22" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="479" y="99" width="22" height="22" rx="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path
      d="M350 172 C 354 186, 360 196, 368 204"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeOpacity="0.5"
    />
    <rect x="368" y="200" width="20" height="20" rx="5" fillOpacity="0.75" transform="rotate(12 378 210)" />
  </g>
</svg>
