...
<Figure
  slug="mcs-resource-management-memory-handled-mostly-inline-cutout"
  alt="A yard of crates with a cart moving through collecting the ones nobody is holding"
  caption="The collector reclaims memory nobody is holding any more."
/>
...
<Figure
  slug="mcs-resource-management-inline-cutout"
  alt="A tap opened over a basin with a timer beside it, and the same tap shown closed with the basin empty and the timer stopped"
  caption="A file or socket must be closed explicitly; the collector will not do it."
/>
