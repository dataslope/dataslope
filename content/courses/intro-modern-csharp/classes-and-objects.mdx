...
<Figure
  slug="mcs-classes-and-objects-cutout"
...
<Figure
  slug="mcs-classes-and-objects-inline-cutout"
  alt="One paper template pinned to a board on the left, and three finished crates stamped from it standing on the right, each filled differently"
  caption="One class, many objects, each filled with its own values."
/>
...
<Figure
  slug="mcs-classes-and-objects-class-blueprint-inline-cutout"
  alt="A paper template pinned above a bench with three finished crates stamped from it below"
  caption="The class is the template; every instance is stamped from it."
/>
...
<Figure
  slug="mcs-classes-and-objects-program-just-variables-inline-cutout"
  alt="A bench strewn with loose tins and loose tools, none of them belonging to each other"
  caption="Without classes, data and the rules about it lie loose on the same bench."
/>
...
- It destroys the object when it's no longer needed
  > That's the garbage collector's job (and, conceptually, a finalizer).
