...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue cutter outline with a handle stamps out three solid squares below, each holding its white dot in a different spot — one class, many objects each with its own state"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }}>
    <rect x="305" y="18" width="30" height="10" rx="5" fill="currentColor" />
    <rect
      x="280"
      y="34"
      width="80"
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M296 120 L 190 138" />
    <path d="M320 120 V 138" />
    <path d="M344 120 L 450 138" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="144" width="64" height="64" rx="14" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="288" y="144" width="64" height="64" rx="14" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="436" y="144" width="64" height="64" rx="14" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.92">
    <circle cx="160" cy="164" r="7" />
    <circle cx="332" cy="188" r="7" />
    <circle cx="480" cy="170" r="7" />
  </g>
</svg>
