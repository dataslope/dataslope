...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A faint pinned blueprint card with placeholder slots is stamped into three solid cards, each holding its own colored dot and bar — one class, many objects each with its own state"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="50" width="150" height="110" rx="14" fillOpacity="0.1" />
    <circle cx="92" cy="62" r="2.5" fillOpacity="0.4" />
    <circle cx="218" cy="62" r="2.5" fillOpacity="0.4" />
    <circle cx="92" cy="148" r="2.5" fillOpacity="0.4" />
    <circle cx="218" cy="148" r="2.5" fillOpacity="0.4" />
    <circle cx="120" cy="90" r="10" fillOpacity="0.18" />
    <rect x="145" y="84" width="60" height="12" rx="6" fillOpacity="0.18" />
    <circle cx="120" cy="126" r="10" fillOpacity="0.18" />
    <rect x="145" y="120" width="44" height="12" rx="6" fillOpacity="0.18" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="262" cy="105" r="3" />
    <circle cx="282" cy="105" r="3" />
    <circle cx="302" cy="105" r="3" />
  </g>
  <polygon points="314,96 314,114 332,105" fill="currentColor" opacity="0.35" />
  <g fill="currentColor" opacity="0.1">
    <rect x="370" y="22" width="150" height="54" rx="12" />
    <rect x="370" y="80" width="150" height="54" rx="12" />
    <rect x="370" y="138" width="150" height="54" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="400" cy="49" r="8" />
    <rect x="422" y="43" width="56" height="12" rx="6" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="400" cy="107" r="8" />
    <rect x="422" y="101" width="56" height="12" rx="6" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="400" cy="165" r="8" />
    <rect x="422" y="159" width="56" height="12" rx="6" fillOpacity="0.7" />
  </g>
</svg>
