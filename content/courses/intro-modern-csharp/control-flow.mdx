...
<Figure
  slug="mcs-control-flow-boolean-expressions-inline-cutout"
  alt="Two levers feeding one gate that opens only in a single combination of their positions"
  caption="A compound condition opens only for the combination it was built for."
/>
...
<Figure
  slug="mcs-control-flow-inline-cutout"
  alt="A signal box with three levers, each lever opening a different one of three tracks leaving the frame"
  caption="Each loop form is a different lever, and two of them cover most work."
/>
...
<Figure
  slug="mcs-control-flow-if-else-if-inline-cutout"
  alt="A chute with three flaps in sequence, a block falling through the first that opens for it"
  caption="The first condition that matches takes the block; the rest are skipped."
/>
