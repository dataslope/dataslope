...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One blue dot fans out to three different pedestals, each topped by the same translucent green layer carrying an identical copy of the dot — write once, run anywhere on a virtual machine"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="42" r="13" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="266" cy="76" r="3" />
    <circle cx="224" cy="99" r="3" />
    <circle cx="186" cy="124" r="3" />
    <circle cx="320" cy="80" r="3" />
    <circle cx="320" cy="103" r="3" />
    <circle cx="320" cy="126" r="3" />
    <circle cx="374" cy="76" r="3" />
    <circle cx="416" cy="99" r="3" />
    <circle cx="454" cy="124" r="3" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="90" y="186" width="100" height="20" rx="4" />
    <rect x="270" y="186" width="100" height="20" rx="10" />
    <polygon points="450,206 550,206 536,186 464,186" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="100" y="164" width="80" height="14" rx="7" fillOpacity="0.4" />
    <rect x="280" y="164" width="80" height="14" rx="7" fillOpacity="0.4" />
    <rect x="460" y="164" width="80" height="14" rx="7" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="152" r="10" />
    <circle cx="320" cy="152" r="10" />
    <circle cx="500" cy="152" r="10" />
  </g>
</svg>
