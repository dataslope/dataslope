...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One blue square fans out along thin lines to three different pedestals, each topped by the same translucent green layer carrying an identical copy of the square, write once, run anywhere on a virtual machine"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="302" y="28" width="36" height="36" rx="9" />
  </g>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M306 68 C 240 94, 182 114, 150 130" />
    <path d="M320 68 V 128" />
    <path d="M334 68 C 400 94, 458 114, 490 130" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="128" y="134" width="24" height="24" rx="6" />
    <rect x="308" y="134" width="24" height="24" rx="6" />
    <rect x="488" y="134" width="24" height="24" rx="6" />
  </g>
</svg>
