...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Loose data dots and behavior bars are drawn along thin lines into a sealed green capsule that bundles one dot with its bar, a second capsule already formed below, data and functions becoming objects"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M162 146 C 220 138, 264 128, 316 118" />
    <path d="M204 60 C 252 70, 292 84, 324 96" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="95" cy="62" r="8" fillOpacity="0.55" />
    <circle cx="150" cy="150" r="8" fillOpacity="0.55" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }}>
    <rect
      ...
      strokeWidth="3.5"
    />
    <rect x="368" y="158" width="150" height="44" rx="22" fill="currentColor" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="380" cy="110" r="10" />
    <circle cx="402" cy="180" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="404" y="105" width="64" height="10" rx="5" />
    <rect x="420" y="175.5" width="48" height="9" rx="4.5" />
  </g>
</svg>
