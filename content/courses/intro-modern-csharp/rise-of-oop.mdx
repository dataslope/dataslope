...
<Figure
  slug="mcs-rise-of-oop-simula-simulating-real-inline-cutout"
  alt="Small models of a ship, a crane and a lorry set on a bench, each moving as its real counterpart would"
  caption="Objects began as simulations: each thing on the bench behaving as its real counterpart."
/>
...
<Figure
  slug="mcs-rise-of-oop-smalltalk-everything-object-inline-cutout"
  alt="A workshop where every object on every bench, down to the smallest, carries a small handle of its own"
  caption="Xerox PARC, 1970s: everything is an object, down to the numbers and the classes themselves."
/>
...
<Figure
  slug="mcs-rise-of-oop-object-actually-inline-cutout"
  alt="A small box carrying both its contents and the levers that work them, standing on a bench among others like it"
  caption="State and the operations on it, kept in one place. Everything else in OOP builds on that."
/>
...
<Figure
  slug="mcs-rise-of-oop-oop-became-dominant-inline-cutout"
  alt="A workshop where every job arrives already boxed with its own tools, and the benches are built to take boxes"
  caption="Bundling data with the operations on it became the default way to organise a program."
/>
