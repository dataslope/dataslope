...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A messy translucent blob resolving along a subtle thin line into four crisp shapes — a vague real-world problem broken into concrete, computer-sized pieces"
