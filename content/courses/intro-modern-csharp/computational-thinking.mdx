...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A messy translucent blue blob resolving along a subtle thin line into four crisp blue shapes, a vague real-world problem broken into concrete, computer-sized pieces"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M105 96 C95 62 140 38 178 50 C214 38 246 64 238 92 C260 116 226 152 192 144 C168 166 120 156 114 128 C92 122 96 108 105 96 Z" fillOpacity="0.22" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="522" cy="64" r="19" fillOpacity="0.7" />
    <polygon points="420,138 456,138 438,106" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
