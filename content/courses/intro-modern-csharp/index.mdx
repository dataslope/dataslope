...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="282" y="36" width="16" height="148" rx="8" fillOpacity="0.3" />
    <rect x="342" y="36" width="16" height="148" rx="8" fillOpacity="0.3" />
    <rect x="230" y="72" width="180" height="16" rx="8" fillOpacity="0.14" />
    <rect x="230" y="132" width="180" height="16" rx="8" fillOpacity="0.14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="290" cy="80" r="8" />
  </g>
...
Every code example in this course is live: it compiles with the real
C# compiler and runs **in your browser**, with nothing to install.
Prove it to yourself — press **Run**, then change `"world"` to your
...
string name = "world"; // <-- change this to your name, then Run again
...
You just wrote, compiled, and ran a C# program — and the program
even inspected your name's length for you. That edit–run loop is how
this whole course works: read a little, run a little, change a
little. (The very first run takes a few seconds while the .NET
runtime boots in your browser; after that it's quick.)
...
The course opens with a single **story chapter** — how programming
evolved from rewiring machines to the software crisis, why Java
forced Microsoft's hand, and how **Anders Hejlsberg** came to design
C#. From there the course is hands-on: variables, types, control
flow, methods, classes, objects, collections, errors, debugging, and
software organization, ending in a capstone project. (For history
lovers, four optional deep-dive chapters near the end of the course
tell the full versions of the stories the opening chapter
compresses.)
...
Start with [The Road to C#](./the-road-to-csharp) — the story of
how fifty years of hard lessons produced the language you'll be
learning. Then continue through the chapters in order using the
menu; each part builds on the one before it. When you reach the
[capstone](./capstone-task-tracker), you'll put every concept from
the course into one small, real program.
