...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three labeled jars on a shelf: two hold solid colored balls while the third is empty with only a dashed outline inside — variables as named boxes in memory, one not yet assigned"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="90" y="186" width="470" height="4" rx="2" fill="currentColor" opacity="0.15" />
  <g fill="currentColor" opacity="0.25">
    <rect x="140" y="56" width="40" height="12" rx="6" />
    <rect x="300" y="56" width="40" height="12" rx="6" />
    <rect x="460" y="56" width="40" height="12" rx="6" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <rect x="115" y="70" width="90" height="110" rx="16" />
    <rect x="275" y="70" width="90" height="110" rx="16" />
    <rect x="435" y="70" width="90" height="110" rx="16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="130" y="96" width="60" height="14" rx="7" fillOpacity="0.55" />
    <circle cx="160" cy="150" r="14" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="290" y="96" width="60" height="14" rx="7" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="150" r="14" />
    <rect x="450" y="96" width="60" height="14" rx="7" fillOpacity="0.55" />
  </g>
  <circle
    cx="480"
    cy="150"
