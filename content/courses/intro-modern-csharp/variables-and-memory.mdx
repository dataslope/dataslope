...
<Figure
  ...
  caption="The name can be pointed at a different slot; the slots stay where they are."
/>
...
<Figure
  slug="mcs-variables-and-memory-declaring-using-variables-inline-cutout"
  alt="An empty locker with a blank plate, then the same locker holding one block"
  caption="Declaring reserves the slot; assigning puts something in it."
/>
