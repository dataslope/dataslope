...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Bright shapes stand on a floor while faded ghost shapes linger further along; a green collector slides along a thin motion line toward the ghosts, the garbage collector tidying memory"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }}>
    <path
      ...
      strokeOpacity="0.5"
    />
    <rect x="374" y="138" width="44" height="28" rx="12" fill="currentColor" />
  </g>
