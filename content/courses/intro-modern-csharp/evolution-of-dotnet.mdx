...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A dot behind solid bars, then behind fading bars, then standing free and joined by thin lines to a ring of green community dots, .NET opening up from closed and Windows-only to open source"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M196 100 H 236" />
    <path d="M376 100 H 416" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="134" cy="100" r="11" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.5">
    <rect x="90" y="50" width="7" height="100" rx="3.5" />
    <rect x="118" y="50" width="7" height="100" rx="3.5" />
    <rect x="146" y="50" width="7" height="100" rx="3.5" />
    <rect x="174" y="50" width="7" height="100" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="306" cy="100" r="13" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="262" y="50" width="7" height="100" rx="3.5" />
    <rect x="344" y="50" width="7" height="100" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }}>
    <g
      ...
      strokeOpacity="0.45"
    >
      <path d="M514 90 L 542 74" />
      <path d="M515 108 L 546 117" />
      <path d="M486 90 L 470 66" />
      <path d="M486 110 L 460 127" />
    </g>
    <g fill="currentColor">
      <circle cx="550" cy="70" r="5" />
      <circle cx="554" cy="120" r="4.5" />
      <circle cx="464" cy="60" r="4.5" />
      <circle cx="452" cy="132" r="5" />
    </g>
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="500" cy="100" r="17" />
  </g>
</svg>
