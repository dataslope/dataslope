...
<Figure
  slug="mcs-road-to-csharp-cutout"
  alt="The road to C#, an isometric illustration"
/>
...
<Figure
  slug="mcs-road-to-csharp-dotnet-cutout"
  alt="A long conference table of seated figures with a half-built bridge model on it and a toppling pile of paper at one end"
  caption="Garmisch, 1968: the conference that named the software crisis."
/>
...
<Figure
  slug="mcs-the-road-to-csharp-from-wires-words-inline-cutout"
  alt="A bench where instructions begin as patched wires, become punched holes, and end as plain written cards"
  caption="Programming went from patched wires to punched cards to plain text."
/>
