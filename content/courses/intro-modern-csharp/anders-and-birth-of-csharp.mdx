...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three cards step upward along a thin connecting thread, from a faint yellow one through a red one to a bold blue card bearing a sharp sign — one designer's taste carried from Turbo Pascal through Delphi into C#"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M214 148 C 230 142, 240 136, 252 129" />
    <path d="M384 110 C 398 104, 406 98, 418 92" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="90" y="130" width="120" height="60" rx="12" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="250" y="95" width="130" height="66" rx="12" fillOpacity="0.65" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="420" y="50" width="150" height="80" rx="14" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.92">
    <rect x="478" y="64" width="8" height="52" rx="4" />
    <rect x="504" y="64" width="8" height="52" rx="4" />
    <rect x="462" y="76" width="66" height="8" rx="4" />
    <rect x="462" y="96" width="66" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="596,22 600,34 612,38 600,42 596,54 592,42 580,38 592,34" />
  </g>
</svg>
