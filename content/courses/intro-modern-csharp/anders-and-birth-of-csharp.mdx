...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three cards step upward in deepening shades of blue to a bold solid card bearing a sharp sign — one designer's taste carried from Turbo Pascal through Delphi into C#"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="130" width="120" height="60" rx="12" fillOpacity="0.3" />
    <rect x="250" y="95" width="130" height="66" rx="12" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="596,22 600,34 612,38 600,42 596,54 592,42 580,38 592,34" fillOpacity="0.55" />
  </g>
</svg>
