...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three stacked translation layers, blue source bars, yellow bytecode squares, green machine ticks, threaded top to bottom by one thin line that ends at a play triangle, code translated stage by stage"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="30" width="360" height="44" rx="10" fillOpacity="0.15" />
    <rect x="170" y="46" width="70" height="9" rx="4.5" fillOpacity="0.7" />
    <rect x="252" y="46" width="50" height="9" rx="4.5" fillOpacity="0.7" />
    <rect x="316" y="46" width="60" height="9" rx="4.5" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="140" y="92" width="360" height="44" rx="10" fillOpacity="0.15" />
    <rect x="170" y="105" width="18" height="18" rx="5" fillOpacity="0.85" />
    <rect x="196" y="105" width="18" height="18" rx="5" fillOpacity="0.85" />
    <rect x="222" y="105" width="18" height="18" rx="5" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="154" width="360" height="44" rx="10" fillOpacity="0.15" />
    <rect x="170" y="168" width="8" height="16" rx="3" fillOpacity="0.8" />
    <rect x="186" y="168" width="8" height="16" rx="3" fillOpacity="0.8" />
    <rect x="204" y="168" width="8" height="16" rx="3" fillOpacity="0.8" />
    <rect x="220" y="168" width="8" height="16" rx="3" fillOpacity="0.8" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="540,160 540,192 568,176" />
  </g>
</svg>
