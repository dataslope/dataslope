...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A dot bounces from a source document down three wide descending steps to a play triangle — code translated stage by stage into something the machine actually runs"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.22">
    <rect x="95" y="22" width="32" height="40" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="102" y="31" width="18" height="3" rx="1.5" />
    <rect x="102" y="39" width="18" height="3" rx="1.5" />
    <rect x="102" y="47" width="12" height="3" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="70" width="150" height="18" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="230" y="120" width="150" height="18" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="380" y="170" width="150" height="18" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="61" r="8" fillOpacity="0.4" />
    <circle cx="310" cy="111" r="8" fillOpacity="0.7" />
    <circle cx="460" cy="161" r="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="240" cy="84" r="3" />
    <circle cx="262" cy="98" r="3" />
    <circle cx="284" cy="108" r="3" />
    <circle cx="390" cy="134" r="3" />
    <circle cx="412" cy="148" r="3" />
    <circle cx="434" cy="158" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="560,148 560,180 588,164" />
  </g>
</svg>
