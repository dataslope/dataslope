...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three containers side by side — an ordered stack of colored squares, a card of key-to-value rows joined by thin lines, and a loose circle of unique dots — list, dictionary, and set"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="118" y="94" width="48" height="32" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="118" y="134" width="48" height="32" rx="8" />
    <rect x="258" y="76" width="36" height="16" rx="8" />
    <rect x="258" y="124" width="36" height="16" rx="8" />
  </g>
  <g
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="492" cy="88" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="356" cy="132" r="9" />
    <circle cx="508" cy="138" r="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="538" cy="102" r="10" />
  </g>
</svg>
