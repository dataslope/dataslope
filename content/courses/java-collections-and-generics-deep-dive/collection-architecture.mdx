...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="An architecture tree: a blue outlined interface card at the top branches over thin gray lines into three solid cards, blue, green, yellow, each backed by two lighter implementation chips below"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="320" y1="56" x2="160" y2="96" />
    <line x1="320" y1="56" x2="320" y2="96" />
    <line x1="320" y1="56" x2="480" y2="96" />
    <line x1="160" y1="132" x2="124" y2="170" />
    <line x1="160" y1="132" x2="196" y2="170" />
    <line x1="320" y1="132" x2="284" y2="170" />
    <line x1="320" y1="132" x2="356" y2="170" />
    <line x1="480" y1="132" x2="444" y2="170" />
    <line x1="480" y1="132" x2="516" y2="170" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }}>
    <rect x="272" y="20" width="96" height="36" rx="12" fill="currentColor" fillOpacity="0.06" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <rect x="112" y="96" width="96" height="36" rx="12" fill="var(--ds-blue-500)" />
  <rect x="272" y="96" width="96" height="36" rx="12" fill="var(--ds-green-500)" />
  <rect x="432" y="96" width="96" height="36" rx="12" fill="var(--ds-yellow-500)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="92" y="170" width="64" height="28" rx="9" fillOpacity="0.3" />
    <rect x="164" y="170" width="64" height="28" rx="9" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="252" y="170" width="64" height="28" rx="9" fillOpacity="0.3" />
    <rect x="324" y="170" width="64" height="28" rx="9" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="412" y="170" width="64" height="28" rx="9" fillOpacity="0.35" />
    <rect x="484" y="170" width="64" height="28" rx="9" fillOpacity="0.35" />
  </g>
</svg>
...
`,
    ...
    {
      filename: "Book.java",
      starterCode: `public record Book(String isbn, String title, String author) {}
`,
    },
    {
...
- \`ArrayList<String>\`
  > Too narrow; rejects \`HashSet\`, \`LinkedList\`, \`List.of(...)\`.
- \`HashMap<String,?>\`
