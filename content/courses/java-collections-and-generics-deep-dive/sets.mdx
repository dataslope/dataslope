...
<Figure
  slug="jcol-sets-set-interface-inline-cutout"
  alt="A bin with a narrow mouth that accepts a block once and rejects an identical second"
  caption="Membership is the only question a set is built to answer quickly."
/>
...
<Figure
  ...
  caption="A set takes each value once and turns the duplicate away."
/>
