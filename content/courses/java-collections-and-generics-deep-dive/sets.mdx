...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A stroked green membership circle holds four distinct dots; a new yellow dot rides a thin gray arrow inside, while a second copy of the blue dot is stopped at the boundary by a short red bar, a set keeps one of each"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="468" y1="64" x2="356" y2="86" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <g style={{ color: "var(--ds-green-500)" }}>
    <circle cx="260" cy="110" r="85" fill="currentColor" fillOpacity="0.08" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <circle cx="225" cy="80" r="9" fill="var(--ds-blue-500)" />
  <circle cx="300" cy="95" r="9" fill="var(--ds-green-500)" />
  <circle cx="245" cy="140" r="9" fill="var(--ds-yellow-500)" />
  <circle cx="295" cy="150" r="9" fill="var(--ds-blue-500)" fillOpacity="0.75" />
  <circle cx="480" cy="60" r="9" fill="var(--ds-blue-500)" />
  <rect x="340.4" y="79.2" width="5" height="24" rx="2.5" fill="var(--ds-red-500)" transform="rotate(-13 342.9 91.2)" />
  <circle cx="474" cy="110" r="9" fill="var(--ds-yellow-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="382" y="108.5" width="74" height="3" rx="1.5" />
    <polygon points="384,104.5 373,110 384,115.5" />
  </g>
</svg>
