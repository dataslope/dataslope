...
<Figure
  slug="jcol-birth-of-containers-cutout"
  alt="The birth of reusable containers, an isometric illustration"
/>
...
<Figure
  slug="jcol-birth-of-containers-containers-had-come-inline-cutout"
  alt="A bench of hand-built crates all slightly different beside one standard crate stamped from a mould"
  caption="Every project rolled its own container until the framework standardised them."
/>
...
<Figure
  slug="jcol-birth-of-containers-vector-first-growable-inline-cutout"
  alt="A rail that gains one more slot when a block is set down past its end"
  caption="`Vector` grew a slot when it needed one, which arrays never could."
/>
