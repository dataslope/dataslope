...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A blue circle, green square, and yellow triangle all funnel through a thin gray arrow into one container box where they become identical gray dots; the dot taken back out wears a dashed yellow ring — its original type forgotten"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <circle cx="90" cy="60" r="9" fill="var(--ds-blue-500)" />
  <rect x="81" y="87" width="18" height="18" rx="5" fill="var(--ds-green-500)" />
  <polygon points="90,118 80,136 100,136" fill="var(--ds-yellow-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="130" y="98.5" width="48" height="3" rx="1.5" />
    <polygon points="176,94.5 187,100 176,105.5" />
  </g>
  <rect x="220" y="40" width="180" height="120" rx="16" fill="var(--ds-blue-500)" fillOpacity="0.12" />
  <g fill="currentColor" opacity="0.4">
    <circle cx="262" cy="84" r="6" />
    <circle cx="310" cy="84" r="6" />
    <circle cx="358" cy="84" r="6" />
    <circle cx="262" cy="122" r="6" />
    <circle cx="310" cy="122" r="6" />
    <circle cx="358" cy="122" r="6" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="416" y="98.5" width="36" height="3" rx="1.5" />
    <polygon points="450,94.5 461,100 450,105.5" />
  </g>
  <circle cx="492" cy="100" r="8" fill="currentColor" opacity="0.4" />
  <circle cx="492" cy="100" r="16" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" strokeDasharray="5 4" />
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.java",
      starterCode: `import java.util.Enumeration;
