...
<Figure
  slug="jcol-tyranny-of-arrays-cutout"
  alt="The tyranny of arrays, an isometric illustration"
/>
...
<Figure
  slug="jcol-the-tyranny-of-arrays-short-history-code-inline-cutout"
  alt="A bench where storage begins as a fixed strip, becomes a growing rail, and ends as a wall of keyed drawers"
  caption="Every project reinvented the same containers before the library had them."
/>
...
<Figure
  slug="jcol-the-tyranny-of-arrays-inline-cutout"
  alt="A rail with exactly eight slots, all filled, and a ninth block waiting on the bench with nowhere to go"
  caption="An array's length is fixed, so the ninth element has nowhere to go."
/>
...
<Figure
  slug="jcol-the-tyranny-of-arrays-we-d-need-fix-inline-cutout"
  alt="A fixed rail of items with a list of missing fittings pinned beside it, each fitting sketched but not yet made"
  caption="The missing pieces on that list are the Collections Framework and generics."
/>
