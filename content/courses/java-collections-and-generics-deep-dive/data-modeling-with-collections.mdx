...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One large translucent container holds two keyed sub-containers, each holding a row of dots; a dotted query path hops from outside straight to one highlighted dot — the right shape makes lookups one call"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="40" width="410" height="165" rx="18" fillOpacity="0.07" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="155" y="85" width="150" height="95" rx="12" fillOpacity="0.13" />
    <circle cx="185" cy="140" r="7" />
    <circle cx="215" cy="140" r="7" />
    <circle cx="245" cy="140" r="7" />
    <circle cx="275" cy="140" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="345" y="85" width="150" height="95" rx="12" fillOpacity="0.13" />
    <circle cx="380" cy="140" r="7" />
    <circle cx="415" cy="140" r="7" />
    <circle cx="450" cy="140" r="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="230" cy="85" r="8" />
    <circle cx="420" cy="85" r="8" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="60" cy="46" r="3.5" />
    <circle cx="90" cy="52" r="3.5" />
    <circle cx="120" cy="60" r="3.5" />
    <circle cx="155" cy="68" r="3.5" />
    <circle cx="192" cy="76" r="3.5" />
    <circle cx="235" cy="103" r="3.5" />
    <circle cx="240" cy="121" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="245" cy="140" r="12" fillOpacity="0.35" />
  </g>
</svg>
