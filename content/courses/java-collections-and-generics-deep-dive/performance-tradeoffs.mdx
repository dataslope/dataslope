...
<Figure
  ...
  caption="Each container is fast at some operations and slow at others, by construction."
/>
...
<Figure
  slug="jcol-performance-tradeoffs-big-o-not-whole-inline-cutout"
  alt="One long unbroken shelf walked end to end, beside the same items scattered across a room joined by cords"
  caption="A contiguous walk beats pointer-chasing badly enough to overturn the complexity on paper."
/>
...
<Figure
  ...
  caption="Pick the container from the operation you do most, not the one you do once."
/>
