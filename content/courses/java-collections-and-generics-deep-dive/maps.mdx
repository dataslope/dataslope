...
<Figure
  slug="jcol-maps-hashmap-actually-works-inline-cutout"
  alt="A rack of identical bins with every item forced into one of them, the chain inside that bin folding into a small tree"
  caption="Force every key into one bucket and lookup degrades, which is why the chain became a tree."
/>
