...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A ledger card ties four blue diamond keys along thin gray lines to three green value capsules — two keys share one value — and a yellow ring lights one key, its line, and its value end to end"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="140" y="24" width="360" height="176" rx="16" fill="currentColor" opacity="0.05" />
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="196" y1="52" x2="378" y2="52" />
    <line x1="196" y1="128" x2="378" y2="113" />
    <line x1="196" y1="166" x2="378" y2="166" />
  </g>
  <line x1="196" y1="90" x2="378" y2="105" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="176" y="43" width="18" height="18" rx="5" transform="rotate(45 185 52)" />
    <rect x="176" y="81" width="18" height="18" rx="5" transform="rotate(45 185 90)" />
    <rect x="176" y="119" width="18" height="18" rx="5" transform="rotate(45 185 128)" />
    <rect x="176" y="157" width="18" height="18" rx="5" transform="rotate(45 185 166)" />
  </g>
  <circle cx="185" cy="90" r="16" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="380" y="41" width="84" height="22" rx="11" fillOpacity="0.7" />
    <rect x="380" y="98" width="84" height="22" rx="11" fillOpacity="0.7" />
    <rect x="380" y="155" width="84" height="22" rx="11" fillOpacity="0.7" />
  </g>
  <rect x="374" y="92" width="96" height="34" rx="17" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
</svg>
...
public class Main {
  public static void main(String[] args) {
    ...
    for (String name :
         List.of("Ada", "Alan", "Barbara", "Bjarne", "Ada", "Cathy")) {
