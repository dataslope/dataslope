...
<Figure
  ...
  caption="The type parameter is a blank tag until a caller fills it in."
/>
...
<Figure
  ...
  caption="One class definition serves every element type without being rewritten."
/>

## A multi-file generic class: a stack

This is the classic generic class to write next. `Stack<E>` is a
typed last-in-first-out container, `push()`, `pop()`, `peek()`, `size()`.
...
<Figure
  ...
  caption="The container is identical; only the type it is asked to hold changes."
/>
