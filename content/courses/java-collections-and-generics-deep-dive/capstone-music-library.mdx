...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A central blue library card of stacked record bars links by thin gray lines to four small views, an ordered blue row, a scattered green set, descending yellow ranks, and a key wired to its value"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="250" y1="105" x2="190" y2="62" />
    <line x1="390" y1="105" x2="450" y2="62" />
    <line x1="250" y1="145" x2="190" y2="182" />
    <line x1="390" y1="145" x2="450" y2="182" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="250" y="80" width="140" height="90" rx="16" fillOpacity="0.12" />
    <rect x="270" y="100" width="100" height="10" rx="5" fillOpacity="0.7" />
    <rect x="270" y="120" width="80" height="10" rx="5" fillOpacity="0.7" />
    <rect x="270" y="140" width="92" height="10" rx="5" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="30" width="120" height="64" rx="12" fillOpacity="0.08" />
    <rect x="88" y="54" width="16" height="16" rx="4" />
    <rect x="112" y="54" width="16" height="16" rx="4" />
    <rect x="136" y="54" width="16" height="16" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="450" y="30" width="120" height="64" rx="12" fillOpacity="0.08" />
    <circle cx="478" cy="52" r="6.5" />
    <circle cx="508" cy="66" r="6.5" />
    <circle cx="532" cy="46" r="6.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="70" y="150" width="120" height="64" rx="12" fillOpacity="0.1" />
    <rect x="92" y="172" width="14" height="28" rx="3" />
    <rect x="114" y="180" width="14" height="20" rx="3" fillOpacity="0.75" />
    <rect x="136" y="188" width="14" height="12" rx="3" fillOpacity="0.5" />
  </g>
  <rect x="450" y="150" width="120" height="64" rx="12" fill="currentColor" opacity="0.06" />
  <circle cx="480" cy="182" r="6" fill="var(--ds-blue-500)" />
  <line x1="488" y1="182" x2="512" y2="182" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <rect x="514" y="174" width="16" height="16" rx="4" fill="var(--ds-green-500)" />
</svg>
