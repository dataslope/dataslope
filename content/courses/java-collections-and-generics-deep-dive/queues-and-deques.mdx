...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two translucent pipes: the top admits dots only at the back and releases them only at the front, while the bottom pipe has entry and exit arrows at both ends — queue and deque"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="150" y="48" width="340" height="52" rx="26" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="215" cy="74" r="10" />
    <circle cx="275" cy="74" r="10" />
    <circle cx="335" cy="74" r="10" />
    <circle cx="395" cy="74" r="10" />
    <circle cx="455" cy="74" r="10" />
    <circle cx="105" cy="74" r="10" fillOpacity="0.6" />
    <circle cx="524" cy="74" r="10" fillOpacity="0.8" />
    <polygon points="542,64 542,84 560,74" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="122,64 122,84 140,74" />
  </g>
  <rect x="150" y="150" width="340" height="52" rx="26" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="270" cy="176" r="10" />
    <circle cx="320" cy="176" r="10" />
    <circle cx="370" cy="176" r="10" />
    <polygon points="118,160 118,176 136,168" />
    <polygon points="522,160 522,176 504,168" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="136,182 136,198 118,190" fillOpacity="0.7" />
    <polygon points="504,182 504,198 522,190" fillOpacity="0.7" />
  </g>
</svg>
