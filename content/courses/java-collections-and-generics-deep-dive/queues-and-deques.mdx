...
<Figure
  slug="jcol-queues-deques-cutout"
  alt="Queues and deques, an isometric illustration"
/>
...
public class Main {
  public static void main(String[] args) {
    ...
    g.put(3, Arrays.asList(4, 5));
    g.put(4, Collections.emptyList());
...
<Figure
  slug="jcol-queues-and-deques-interfaces-inline-cutout"
  alt="One channel with a gate at each end and another with gates that both open in either direction"
  caption="A queue admits at one end; a deque opens at both."
/>

<Figure
  slug="jcol-queues-and-deques-inline-cutout"
  alt="A straight channel with a gate at each end, a block entering at the left and leaving at the right, and one block being pushed back in at the end it came from"
  caption="A deque can push back in at the end an element just came out of."
/>
...
public final class Task {
  ...
  public boolean equals(Object o) {
    ...
    Task other = (Task)o;
    return Objects.equals(name, other.name) && deadline == other.deadline;
  }

  @Override
  public int hashCode() { return Objects.hash(name, deadline); }
