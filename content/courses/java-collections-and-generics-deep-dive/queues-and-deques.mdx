...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two rounded tracks: the top queue takes a green dot in through one thin gray arrow on the left and lets a blue dot out on the right, while the bottom deque wears a pair of opposite arrows at each end — both ends open"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="170" y="44" width="300" height="48" rx="24" fill="var(--ds-blue-500)" fillOpacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="212" cy="68" r="9" />
    <circle cx="272" cy="68" r="9" />
    <circle cx="332" cy="68" r="9" />
    <circle cx="392" cy="68" r="9" />
  </g>
  <circle cx="72" cy="68" r="9" fill="var(--ds-green-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="90" y="66.5" width="64" height="3" rx="1.5" />
    <polygon points="152,62.5 163,68 152,73.5" />
    <rect x="480" y="66.5" width="64" height="3" rx="1.5" />
    <polygon points="542,62.5 553,68 542,73.5" />
  </g>
  <circle cx="575" cy="68" r="9" fill="var(--ds-blue-500)" fillOpacity="0.8" />
  <rect x="170" y="150" width="300" height="48" rx="24" fill="var(--ds-green-500)" fillOpacity="0.1" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="270" cy="174" r="9" />
    <circle cx="320" cy="174" r="9" />
    <circle cx="370" cy="174" r="9" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="98" y="162.5" width="52" height="3" rx="1.5" />
    <polygon points="148,158.5 159,164 148,169.5" />
    <rect x="110" y="182.5" width="52" height="3" rx="1.5" />
    <polygon points="112,178.5 101,184 112,189.5" />
    <rect x="478" y="162.5" width="52" height="3" rx="1.5" />
    <polygon points="480,158.5 469,164 480,169.5" />
    <rect x="468" y="182.5" width="52" height="3" rx="1.5" />
    <polygon points="518,178.5 529,184 518,189.5" />
  </g>
</svg>
