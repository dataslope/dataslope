...
<Figure
  slug="jcol-generics-revolution-cutout"
  alt="The generics revolution, an isometric illustration"
/>
...
<Figure
  slug="jcol-the-generics-revolution-world-looked-like-inline-cutout"
  alt="A crate of mixed shapes with every item needing to be measured by hand as it comes out"
  caption="Before generics, everything came out as `Object` and had to be cast by hand."
/>
...
<Figure
  slug="jcol-generics-revolution-gj-cutout"
  alt="A box carried through a gate that clamps a coloured tag onto it, arriving on the far side with the tag gone"
  caption="GJ, 1998: check the types at compile time, then erase them, so every existing class file keeps working."
/>
