...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Left, a blue producer box: a gray arrow lifts a blue dot out while an incoming red dot is stopped by a red bar; right, a green consumer box: a green dot drops in freely but the arrow coming back out ends in a dashed outline, extends gives, super takes"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="90" width="180" height="90" rx="14" fillOpacity="0.12" />
    <circle cx="130" cy="135" r="7" />
    <circle cx="170" cy="152" r="7" />
    <circle cx="210" cy="128" r="7" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="178.5" y="46" width="3" height="44" rx="1.5" />
    <polygon points="173,48 184,48 178.5,37" />
  </g>
  <circle cx="178.5" cy="22" r="8" fill="var(--ds-blue-500)" />
  <circle cx="239" cy="12" r="7" fill="var(--ds-red-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="237.5" y="24" width="3" height="34" rx="1.5" />
    <polygon points="233.5,56 244.5,56 239,67" />
  </g>
  <rect x="222" y="70" width="34" height="5" rx="2.5" fill="var(--ds-red-500)" transform="rotate(-28 239 72.5)" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="370" y="90" width="180" height="90" rx="14" fillOpacity="0.12" />
    <circle cx="410" cy="150" r="7" />
    <circle cx="452" cy="132" r="7" />
  </g>
  <circle cx="440" cy="20" r="8" fill="var(--ds-green-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="438.5" y="32" width="3" height="40" rx="1.5" />
    <polygon points="434.5,70 445.5,70 440,81" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="497" y="46" width="3" height="44" rx="1.5" />
    <polygon points="493,48 504,48 498.5,37" />
  </g>
  <circle cx="498.5" cy="22" r="8" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="4 3" />
</svg>
