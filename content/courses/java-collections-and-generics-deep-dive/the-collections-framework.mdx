...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A stroked blue frame holds three tinted compartments, an ordered row of blue squares, scattered green dots, and a yellow flow strip with a tiny arrow, while the key-value map card sits just outside, tied on by a thin dashed gray line"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <line x1="480" y1="116" x2="516" y2="116" stroke="var(--ds-gray-300)" strokeWidth="2" strokeDasharray="5 4" />
  <g style={{ color: "var(--ds-blue-500)" }}>
    <rect x="60" y="36" width="420" height="160" rx="20" fill="currentColor" fillOpacity="0.04" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="84" y="64" width="120" height="104" rx="12" fillOpacity="0.1" />
    <rect x="98" y="106" width="18" height="18" rx="5" />
    <rect x="124" y="106" width="18" height="18" rx="5" />
    <rect x="150" y="106" width="18" height="18" rx="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="210" y="64" width="120" height="104" rx="12" fillOpacity="0.1" />
    <circle cx="240" cy="96" r="6.5" />
    <circle cx="268" cy="120" r="6.5" />
    <circle cx="296" cy="92" r="6.5" />
    <circle cx="252" cy="142" r="6.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="336" y="64" width="120" height="104" rx="12" fillOpacity="0.12" />
    <rect x="352" y="102" width="88" height="24" rx="12" fillOpacity="0.5" />
    <circle cx="372" cy="114" r="6" />
    <circle cx="394" cy="114" r="6" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="408" y="112.5" width="12" height="3" rx="1.5" />
    <polygon points="418,109.5 425,114 418,118.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="516" y="84" width="100" height="64" rx="12" fillOpacity="0.14" />
    <circle cx="538" cy="116" r="5.5" />
    <rect x="568" y="109" width="14" height="14" rx="4" />
  </g>
  <line x1="546" y1="116" x2="564" y2="116" stroke="var(--ds-gray-300)" strokeWidth="2" />
</svg>
