...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A code card with one solid green line among faint gray ones sends a thin arrow to a console card, where past the blue prompt chevron that same line appears as green output, your first program prints its first words"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="30" width="220" height="150" rx="14" fill="currentColor" opacity="0.05" />
  <g fill="currentColor" opacity="0.18">
    <rect x="92" y="52" width="120" height="9" rx="4.5" />
    <rect x="106" y="76" width="150" height="9" rx="4.5" />
    <rect x="106" y="124" width="100" height="9" rx="4.5" />
    <rect x="92" y="148" width="70" height="9" rx="4.5" />
  </g>
  <rect x="106" y="100" width="140" height="9" rx="4.5" fill="var(--ds-green-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="306" y="103.5" width="44" height="3" rx="1.5" />
    <polygon points="348,99.5 359,105 348,110.5" />
  </g>
  <rect x="376" y="30" width="200" height="150" rx="14" fill="var(--ds-blue-500)" fillOpacity="0.08" />
  <polyline points="398,96 410,105 398,114" fill="none" stroke="var(--ds-blue-500)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
  <rect x="422" y="100" width="110" height="10" rx="5" fill="var(--ds-green-500)" />
  <rect x="398" y="132" width="10" height="14" rx="2" fill="currentColor" opacity="0.25" />
</svg>
