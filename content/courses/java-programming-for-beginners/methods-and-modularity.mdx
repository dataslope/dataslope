...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="The same three-piece pattern repeats inside one long stretch of code, then collapses into a single named green capsule that each occurrence now points to — write it once, call it by name"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="70" y="60" width="500" height="46" rx="12" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="88" y="76" width="40" height="14" rx="5" />
    <rect x="240" y="76" width="34" height="14" rx="5" />
    <rect x="380" y="76" width="30" height="14" rx="5" />
    <rect x="520" y="76" width="28" height="14" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="152" cy="83" r="6" fillOpacity="0.45" />
    <circle cx="196" cy="83" r="6" fillOpacity="0.45" />
    <circle cx="296" cy="83" r="6" fillOpacity="0.45" />
    <circle cx="340" cy="83" r="6" fillOpacity="0.45" />
    <circle cx="436" cy="83" r="6" fillOpacity="0.45" />
    <circle cx="480" cy="83" r="6" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="167" y="76" width="14" height="14" rx="4" fillOpacity="0.45" />
    <rect x="311" y="76" width="14" height="14" rx="4" fillOpacity="0.45" />
    <rect x="451" y="76" width="14" height="14" rx="4" fillOpacity="0.45" />
    <rect x="250" y="150" width="140" height="44" rx="22" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="262" y="142" width="44" height="12" rx="6" fillOpacity="0.85" />
    <rect x="313" y="165" width="14" height="14" rx="4" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="298" cy="172" r="7" />
    <circle cx="342" cy="172" r="7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="196" cy="112" r="3" />
    <circle cx="216" cy="128" r="3" />
    <circle cx="238" cy="142" r="3" />
    <circle cx="320" cy="112" r="3" />
    <circle cx="320" cy="128" r="3" />
    <circle cx="444" cy="112" r="3" />
    <circle cx="422" cy="128" r="3" />
    <circle cx="398" cy="142" r="3" />
  </g>
</svg>
