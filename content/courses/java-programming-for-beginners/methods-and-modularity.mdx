...
<Figure
  slug="java-methods-and-modularity-methods-exist-inline-cutout"
  alt="The same three actions repeated on four benches, then boxed into one machine used four times"
  caption="Repeated steps become one method you can call wherever you need it."
/>
