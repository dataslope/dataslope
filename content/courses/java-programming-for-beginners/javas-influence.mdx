...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A large solid blue circle wearing a white ring passes thin gray lines to three smaller circles — green, yellow, and lighter blue — each carrying the same white ring at its heart: Java's mark on the languages that followed"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="200" y1="94" x2="420" y2="52" />
    <line x1="202" y1="110" x2="428" y2="124" />
    <line x1="198" y1="128" x2="418" y2="186" />
  </g>
  <circle cx="150" cy="110" r="52" fill="var(--ds-blue-500)" />
  <circle cx="150" cy="110" r="20" fill="none" stroke="var(--ds-white)" strokeWidth="5" strokeOpacity="0.85" />
  <circle cx="440" cy="52" r="26" fill="var(--ds-green-500)" />
  <circle cx="440" cy="52" r="10" fill="none" stroke="var(--ds-white)" strokeWidth="3.5" strokeOpacity="0.85" />
  <circle cx="450" cy="124" r="22" fill="var(--ds-yellow-500)" />
  <circle cx="450" cy="124" r="8.5" fill="none" stroke="var(--ds-white)" strokeWidth="3" strokeOpacity="0.85" />
  <circle cx="434" cy="186" r="18" fill="var(--ds-blue-500)" fillOpacity="0.65" />
  <circle cx="434" cy="186" r="7" fill="none" stroke="var(--ds-white)" strokeWidth="2.5" strokeOpacity="0.85" />
</svg>
