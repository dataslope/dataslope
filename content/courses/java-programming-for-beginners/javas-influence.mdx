...
<Figure
  ...
  caption="Automatic collection reclaims whatever nothing is holding any more."
/>
...
(You spent a full lesson on them in *Exception Handling*; the point
here is that the model you learned there is now a shared one.)
