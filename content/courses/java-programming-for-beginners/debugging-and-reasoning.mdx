...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A code card under diagnosis: the first three line bars already carry small green checks, the suspect line burns solid red inside a yellow ring, and the lines below wait untouched, debugging as calm elimination"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="150" y="24" width="340" height="182" rx="14" fill="currentColor" opacity="0.05" />
  <g fill="currentColor" opacity="0.18">
    <rect x="210" y="44" width="200" height="9" rx="4.5" />
    <rect x="210" y="72" width="160" height="9" rx="4.5" />
    <rect x="210" y="100" width="230" height="9" rx="4.5" />
    <rect x="210" y="156" width="150" height="9" rx="4.5" />
    <rect x="210" y="184" width="180" height="9" rx="4.5" />
  </g>
  <g fill="none" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="172,48 177,53 186,41" />
    <polyline points="172,76 177,81 186,69" />
    <polyline points="172,104 177,109 186,97" />
  </g>
  <rect x="210" y="128" width="190" height="9" rx="4.5" fill="var(--ds-red-500)" />
  <rect x="202" y="120" width="220" height="25" rx="12" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
</svg>
