...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A green book slides off a shelf along a dotted arc toward a lending card that has just taken a fresh check stamp, a yellow borrower dot waiting beside it — the capstone library checkout system"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <rect x="80" y="150" width="220" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="70" width="26" height="80" rx="4" fillOpacity="0.85" />
    <rect x="194" y="78" width="24" height="72" rx="4" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="132" y="80" width="22" height="70" rx="4" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="160" y="64" width="28" height="86" rx="4" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="224" y="72" width="26" height="78" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="266" cy="84" r="3" />
    <circle cx="292" cy="74" r="3" />
    <circle cx="318" cy="68" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="334" y="64" width="26" height="78" rx="4" fillOpacity="0.9" transform="rotate(14 347 103)" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <rect x="430" y="70" width="140" height="110" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="446" y="88" width="80" height="8" rx="4" fillOpacity="0.4" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="446" y="108" width="96" height="8" rx="4" />
    <rect x="446" y="128" width="70" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="452" cy="158" r="3.5" fillOpacity="0.6" />
    <circle cx="464" cy="158" r="3.5" fillOpacity="0.6" />
    <circle cx="476" cy="158" r="3.5" fillOpacity="0.6" />
    <circle cx="600" cy="160" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="532" cy="152" r="15" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="524,152 530,159 541,143 537,140 530,150 527,147" fillOpacity="0.95" />
  </g>
</svg>
