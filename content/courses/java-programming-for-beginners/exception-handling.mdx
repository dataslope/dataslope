...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A red exception diamond climbs a thin red line from the deepest frame of a blue call stack, slips past two dashed empty sockets, and is finally held by a solid green ring on the frame that handles it, marked with a green check"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="180" y="190" width="280" height="26" rx="10" fillOpacity="0.15" />
    <rect x="200" y="150" width="240" height="26" rx="10" fillOpacity="0.22" />
    <rect x="220" y="110" width="200" height="26" rx="10" fillOpacity="0.28" />
    <rect x="240" y="70" width="160" height="26" rx="10" fillOpacity="0.35" />
  </g>
  <path d="M 300 200 C 380 195 424 160 420 83" fill="none" stroke="var(--ds-red-500)" strokeWidth="2.5" strokeLinecap="round" />
  <circle cx="300" cy="200" r="5" fill="var(--ds-red-500)" />
  <g fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="4 3">
    <circle cx="398" cy="163" r="8" />
    <circle cx="412" cy="123" r="8" />
  </g>
  <rect x="412" y="75" width="16" height="16" rx="4" fill="var(--ds-red-500)" transform="rotate(45 420 83)" />
  <circle cx="420" cy="83" r="15" fill="none" stroke="var(--ds-green-500)" strokeWidth="3" />
  <polyline points="446,80 451,85 460,72" fill="none" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
</svg>
