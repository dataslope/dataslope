...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four memory cells, each hanging under its own colored name tag: one holds a blue dot, one a green square, one waits empty as a dashed outline, and a yellow value drops down a thin arrow into the last — variables are named places"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="1.5">
    <line x1="124" y1="78" x2="124" y2="104" />
    <line x1="264" y1="78" x2="264" y2="104" />
    <line x1="404" y1="78" x2="404" y2="104" />
    <line x1="544" y1="96" x2="544" y2="104" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="76" y="104" width="96" height="64" rx="14" />
    <rect x="216" y="104" width="96" height="64" rx="14" />
    <rect x="356" y="104" width="96" height="64" rx="14" />
    <rect x="496" y="104" width="96" height="64" rx="14" />
  </g>
  <rect x="98" y="64" width="52" height="14" rx="7" fill="var(--ds-blue-500)" />
  <rect x="238" y="64" width="52" height="14" rx="7" fill="var(--ds-green-500)" />
  <rect x="378" y="64" width="52" height="14" rx="7" fill="var(--ds-blue-500)" fillOpacity="0.55" />
  <circle cx="124" cy="136" r="13" fill="var(--ds-blue-500)" />
  <rect x="251" y="123" width="26" height="26" rx="7" fill="var(--ds-green-500)" />
  <circle cx="404" cy="136" r="12" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="4 3" />
  <rect x="518" y="86" width="52" height="14" rx="7" fill="var(--ds-yellow-500)" />
  <circle cx="544" cy="26" r="11" fill="var(--ds-yellow-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="542.5" y="42" width="3" height="26" rx="1.5" />
    <polygon points="538.5,66 549.5,66 544,77" />
  </g>
</svg>
