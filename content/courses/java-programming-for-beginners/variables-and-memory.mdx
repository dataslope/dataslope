...
<Figure
  slug="java-variables-and-memory-memory-as-row-inline-cutout"
  alt="A long strip of equal cells with a few holding blocks and the rest empty"
  caption="Memory is a long row of slots, and a variable is a name for one of them."
/>
...
<Figure
  slug="java-variables-and-memory-inline-cutout"
  alt="A small name plate joined by a cord to a crate standing in a yard, and a second plate joined by its own cord to the very same crate"
  caption="Two names can hold the same reference, and both point at one object."
/>
