...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Top row: a fixed five-slot blue array is full, and the sixth dot waiting outside is crossed out in red; bottom row: the green list simply grows a sixth outlined cell to welcome its new dot"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="40" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="190" y="40" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="240" y="40" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="290" y="40" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="340" y="40" width="44" height="44" rx="10" fillOpacity="0.15" />
    <circle cx="162" cy="62" r="8" />
    <circle cx="212" cy="62" r="8" />
    <circle cx="262" cy="62" r="8" />
    <circle cx="312" cy="62" r="8" />
    <circle cx="362" cy="62" r="8" />
    <circle cx="446" cy="62" r="8" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="470" y="59.5" width="20" height="5" rx="2.5" transform="rotate(45 480 62)" />
    <rect x="470" y="59.5" width="20" height="5" rx="2.5" transform="rotate(-45 480 62)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="140" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="190" y="140" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="240" y="140" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="290" y="140" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="340" y="140" width="44" height="44" rx="10" fillOpacity="0.15" />
    <rect x="390" y="140" width="44" height="44" rx="10" fillOpacity="0.15" stroke="currentColor" strokeWidth="2.5" />
    <circle cx="162" cy="162" r="8" />
    <circle cx="212" cy="162" r="8" />
    <circle cx="262" cy="162" r="8" />
    <circle cx="312" cy="162" r="8" />
    <circle cx="362" cy="162" r="8" />
