...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Six gray sockets on a board tangled together by crossing blue, green, and yellow cables, before objects, every part of a program wired directly to every other"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="100" y="32" width="440" height="160" rx="16" fill="currentColor" opacity="0.06" />
  <g fill="none" strokeLinecap="round">
    <path d="M 150 70 C 260 160 380 40 490 160" stroke="var(--ds-blue-500)" strokeWidth="2.5" />
    <path d="M 300 60 C 180 200 420 190 450 80" stroke="var(--ds-blue-500)" strokeWidth="2.5" strokeOpacity="0.55" />
    <path d="M 180 160 C 320 20 400 220 450 80" stroke="var(--ds-green-500)" strokeWidth="2.5" />
    <path d="M 150 70 C 400 100 200 220 340 150" stroke="var(--ds-yellow-500)" strokeWidth="2.5" />
    <path d="M 300 60 C 420 80 260 160 180 160" stroke="var(--ds-green-500)" strokeWidth="2.5" strokeOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="150" cy="70" r="6" />
    <circle cx="300" cy="60" r="6" />
    <circle cx="450" cy="80" r="6" />
...
method you will ever write, including in Java. Here is a recipe,
as a real Java program. Run it, and read the output top to bottom:
...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Four tidy objects, a blue circle, a green square, a yellow hexagon, and a pale capsule, linked by a few thin gray routes, with small colored message chips traveling between them: a program as a society of objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="150" y1="80" x2="430" y2="70" />
    <line x1="150" y1="80" x2="280" y2="170" />
    <line x1="280" y1="170" x2="520" y2="160" />
    <line x1="430" y1="70" x2="520" y2="160" />
  </g>
  <circle cx="150" cy="80" r="26" fill="var(--ds-blue-500)" />
  <rect x="404" y="44" width="52" height="52" rx="14" fill="var(--ds-green-500)" />
  <polygon points="280,142 305,156 305,184 280,198 255,184 255,156" fill="var(--ds-yellow-500)" />
  <rect x="480" y="142" width="80" height="36" rx="18" fill="var(--ds-blue-500)" fillOpacity="0.5" />
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="140" y="77" width="20" height="6" rx="3" />
    <rect x="420" y="67" width="20" height="6" rx="3" />
    <rect x="270" y="167" width="20" height="6" rx="3" />
    <rect x="510" y="157" width="20" height="6" rx="3" />
  </g>
  <rect x="281" y="70" width="18" height="10" rx="5" fill="var(--ds-green-500)" transform="rotate(-2 290 75)" />
  <rect x="391" y="160" width="18" height="10" rx="5" fill="var(--ds-yellow-500)" transform="rotate(-2 400 165)" />
