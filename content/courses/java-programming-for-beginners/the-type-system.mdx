...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three outlined type slots each hold a snugly matching solid shape, circle in circle, square in square, triangle in triangle, while a blue circle hovering over the last square slot is refused with a red cross: values only fit their declared type"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <circle cx="140" cy="130" r="28" fill="none" stroke="var(--ds-blue-500)" strokeWidth="2.5" />
  <circle cx="140" cy="130" r="17" fill="var(--ds-blue-500)" />
  <rect x="250" y="102" width="56" height="56" rx="12" fill="none" stroke="var(--ds-green-500)" strokeWidth="2.5" />
  <rect x="262" y="114" width="32" height="32" rx="8" fill="var(--ds-green-500)" />
  <polygon points="420,98 390,158 450,158" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="2.5" strokeLinejoin="round" />
  <polygon points="420,116 402,150 438,150" fill="var(--ds-yellow-500)" />
  <rect x="510" y="102" width="56" height="56" rx="12" fill="none" stroke="var(--ds-green-500)" strokeWidth="2.5" />
  <circle cx="538" cy="44" r="14" fill="var(--ds-blue-500)" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="529" y="75.5" width="18" height="5" rx="2.5" transform="rotate(45 538 78)" />
    <rect x="529" y="75.5" width="18" height="5" rx="2.5" transform="rotate(-45 538 78)" />
  </g>
</svg>
