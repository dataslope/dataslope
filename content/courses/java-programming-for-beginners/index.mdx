...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A steaming coffee cup assembled from stacked translucent bands with crescent wisps of steam rising — Java, the language we speak while learning to think like a programmer"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="230" y="110" width="180" height="26" rx="13" fillOpacity="0.25" />
    <rect x="240" y="138" width="160" height="26" rx="13" fillOpacity="0.45" />
    <rect x="258" y="166" width="124" height="26" rx="13" fillOpacity="0.75" />
    <path fillRule="evenodd" d="M460 138a26 26 0 1 1-52 0 26 26 0 1 1 52 0ZM448 138a14 14 0 1 1-28 0 14 14 0 1 1 28 0Z" fillOpacity="0.5" />
    <path d="M298 28A34 34 0 0 1 298 88A30 30 0 0 0 298 28Z" fillOpacity="0.35" />
    <path d="M344 20A34 34 0 0 1 344 80A30 30 0 0 0 344 20Z" fillOpacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="270" cy="96" r="5" fillOpacity="0.6" />
    <circle cx="376" cy="92" r="4" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="206" y="200" width="228" height="10" rx="5" />
    <circle cx="318" cy="56" r="3" />
    <circle cx="362" cy="46" r="3" />
  </g>
</svg>
