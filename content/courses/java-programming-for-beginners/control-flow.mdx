...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A marble drops onto a yellow peg that sends it left or right down a run, one channel even looping the marble around before both paths reach the green exit — branching and repetition as one falling path"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="200" y="20" width="240" height="212" rx="16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="36" r="9" />
    <circle cx="320" cy="56" r="3" fillOpacity="0.4" />
    <circle cx="320" cy="70" r="3" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="320,80 334,94 320,108 306,94" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="316" y="118" width="8" height="58" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="296" cy="112" r="3" fillOpacity="0.4" />
    <circle cx="276" cy="130" r="3" fillOpacity="0.4" />
    <circle cx="264" cy="152" r="3" fillOpacity="0.4" />
    <circle cx="262" cy="174" r="3" fillOpacity="0.4" />
    <circle cx="272" cy="194" r="3" fillOpacity="0.4" />
    <circle cx="290" cy="208" r="3" fillOpacity="0.4" />
    <circle cx="344" cy="112" r="3" fillOpacity="0.4" />
    <circle cx="364" cy="130" r="3" fillOpacity="0.4" />
    <circle cx="372" cy="150" r="3" fillOpacity="0.4" />
    <circle cx="392" cy="166" r="3" fillOpacity="0.4" />
    <circle cx="398" cy="180" r="3" fillOpacity="0.4" />
    <circle cx="390" cy="194" r="3" fillOpacity="0.4" />
    <circle cx="376" cy="200" r="3" fillOpacity="0.4" />
    <circle cx="362" cy="194" r="3" fillOpacity="0.4" />
    <circle cx="356" cy="180" r="3" fillOpacity="0.4" />
    <circle cx="362" cy="166" r="3" fillOpacity="0.4" />
    <circle cx="350" cy="214" r="3" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="296" y="218" width="48" height="16" rx="8" />
  </g>
</svg>
