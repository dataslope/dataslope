...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One flat sheet ruled with dotted fold lines becomes three folded paper boats of different colors and sizes floating on a dotted waterline — a class is the folding plan, objects are the boats"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="90" y="50" width="130" height="130" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="110" cy="70" r="2.5" />
    <circle cx="132" cy="92" r="2.5" />
    <circle cx="154" cy="114" r="2.5" />
    <circle cx="176" cy="136" r="2.5" />
    <circle cx="198" cy="158" r="2.5" />
    <circle cx="198" cy="70" r="2.5" />
    <circle cx="176" cy="92" r="2.5" />
    <circle cx="132" cy="136" r="2.5" />
    <circle cx="110" cy="158" r="2.5" />
    <circle cx="124" cy="114" r="2.5" />
    <circle cx="184" cy="114" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="240" cy="115" r="3" />
    <circle cx="262" cy="115" r="3" />
    <circle cx="284" cy="115" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="292,107 308,115 292,123" fillOpacity="0.55" />
    <polygon points="340,128 420,128 404,156 356,156" />
    <polygon points="380,76 380,124 412,124" fillOpacity="0.85" />
    <polygon points="380,96 380,124 356,124" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="458,106 522,106 510,128 470,128" />
    <polygon points="490,68 490,102 514,102" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="534,172 586,172 576,190 544,190" />
    <polygon points="560,144 560,168 580,168" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <circle cx="340" cy="196" r="3" />
    <circle cx="380" cy="196" r="3" />
    <circle cx="420" cy="196" r="3" />
    <circle cx="460" cy="196" r="3" />
    <circle cx="500" cy="196" r="3" />
    <circle cx="540" cy="196" r="3" />
    <circle cx="580" cy="196" r="3" />
  </g>
</svg>
