...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A blue stencil card with one circular cut-out links by thin gray lines to three solid circles of different colors and sizes, one class, pressed into many objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="250" y1="91" x2="374" y2="52" />
    <line x1="250" y1="91" x2="380" y2="118" />
    <line x1="250" y1="91" x2="386" y2="176" />
  </g>
  <rect x="90" y="36" width="160" height="110" rx="14" fill="var(--ds-blue-500)" fillOpacity="0.15" />
  <circle cx="170" cy="91" r="30" fill="var(--ds-white)" />
  <circle cx="170" cy="91" r="30" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2" strokeDasharray="6 5" />
  <circle cx="400" cy="52" r="24" fill="var(--ds-blue-500)" />
  <circle cx="400" cy="118" r="18" fill="var(--ds-green-500)" />
  <circle cx="400" cy="176" r="13" fill="var(--ds-yellow-500)" />
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <circle cx="392" cy="44" r="4" />
    <circle cx="394" cy="112" r="3" />
    <circle cx="396" cy="171" r="2.5" />
  </g>
</svg>
