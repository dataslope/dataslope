...
<Figure
  ...
  caption="The constructor fills every field before anyone can use the object."
/>
...
6. **Garbage collection.** Eventually the Java virtual machine's garbage collector
...
<Figure
  ...
  caption="Built, used, unreachable, collected: the whole life of an object."
/>
...
<Figure
  ...
  caption="Without a constructor an object can be handed over half-filled."
/>
...
look at one of object-oriented programming's most powerful, and most
over-used,
