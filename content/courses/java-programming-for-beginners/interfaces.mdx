...
<Figure
  slug="java-interfaces-cutout"
  alt="Interfaces, an isometric illustration"
/>
...
<Figure
  slug="java-interfaces-inline-cutout"
  alt="Three different machines each fitted with the identical front plate and handle, so one hand works all three the same way"
  caption="An interface is a shared front plate: same handles, different machines."
/>
...
<Figure
  slug="java-interfaces-interface-inline-cutout"
  alt="A standard front plate with two handles, shown detached on a bench beside the machines it fits"
  caption="Depend on the capability you need, not on the class that happens to provide it."
/>
