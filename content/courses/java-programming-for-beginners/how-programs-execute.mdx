...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A filmstrip of code frames feeds a projector whose cone of light throws a bright green result onto a screen — the stages between typing a program and seeing it run"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="40" width="54" height="150" rx="8" fillOpacity="0.15" />
    <rect x="102" y="58" width="28" height="6" rx="3" fillOpacity="0.55" />
    <rect x="102" y="68" width="20" height="6" rx="3" fillOpacity="0.55" />
    <rect x="102" y="98" width="26" height="6" rx="3" fillOpacity="0.55" />
    <rect x="102" y="108" width="18" height="6" rx="3" fillOpacity="0.55" />
    <rect x="102" y="142" width="24" height="6" rx="3" fillOpacity="0.55" />
    <rect x="102" y="152" width="28" height="6" rx="3" fillOpacity="0.55" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="96" y="86" width="42" height="4" rx="2" />
    <rect x="96" y="130" width="42" height="4" rx="2" />
    <rect x="96" y="172" width="42" height="4" rx="2" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="162" cy="112" r="3" />
    <circle cx="186" cy="106" r="3" />
    <circle cx="210" cy="100" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="224" y="78" width="120" height="70" rx="14" fillOpacity="0.25" />
    <circle cx="252" cy="64" r="22" fillOpacity="0.45" />
    <circle cx="316" cy="64" r="16" fillOpacity="0.35" />
    <rect x="338" y="100" width="16" height="24" rx="5" fillOpacity="0.7" />
  </g>
  <g fill="currentColor" opacity="0.5">
    <circle cx="252" cy="64" r="5" />
    <circle cx="316" cy="64" r="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="354,108 556,44 556,176 354,124" fillOpacity="0.15" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="556" y="36" width="14" height="150" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="544" y="82" width="20" height="60" rx="5" fillOpacity="0.85" />
    <circle cx="592" cy="70" r="4" fillOpacity="0.5" />
    <circle cx="600" cy="96" r="3" fillOpacity="0.5" />
  </g>
</svg>
