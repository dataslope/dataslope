...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Three steps of a staircase joined by thin gray elbow lines: a blue source card, a solid blue machine marked with a white run chevron, and a green output card where result bars appear — from typed code to running program"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="none" stroke="var(--ds-gray-300)" strokeWidth="2">
    <polyline points="145,104 145,140 242,140" />
    <polyline points="386,140 415,140 415,188 432,188" />
  </g>
  <g fill="var(--ds-gray-400)">
    <polygon points="240,134.5 251,140 240,145.5" />
    <polygon points="430,182.5 441,188 430,193.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="24" width="150" height="80" rx="12" fillOpacity="0.12" />
    <rect x="86" y="44" width="84" height="7" rx="3.5" fillOpacity="0.5" />
    <rect x="86" y="60" width="64" height="7" rx="3.5" fillOpacity="0.5" />
    <rect x="86" y="76" width="92" height="7" rx="3.5" fillOpacity="0.5" />
    <rect x="256" y="104" width="130" height="72" rx="14" />
  </g>
  <polyline points="308,124 324,140 308,156" fill="none" stroke="var(--ds-white)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" opacity="0.9" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="446" y="150" width="150" height="76" rx="12" fillOpacity="0.12" />
    <rect x="462" y="166" width="60" height="9" rx="4.5" />
    <rect x="462" y="184" width="90" height="9" rx="4.5" />
    <rect x="462" y="202" width="44" height="9" rx="4.5" />
  </g>
</svg>
