...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A pale green disc and a solid blue circle overlap while a thin yellow arc sweeps beneath them, two small dots floating free, an abstract closing note"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <circle cx="270" cy="112" r="85" fill="var(--ds-green-500)" fillOpacity="0.12" />
  <circle cx="350" cy="92" r="44" fill="var(--ds-blue-500)" />
  <path d="M 377.8 156.5 A 95 95 0 0 1 222.2 156.5" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3.5" strokeLinecap="round" />
  <circle cx="455" cy="58" r="6" fill="var(--ds-green-500)" />
  <circle cx="160" cy="48" r="4.5" fill="var(--ds-blue-500)" fillOpacity="0.5" />
</svg>
