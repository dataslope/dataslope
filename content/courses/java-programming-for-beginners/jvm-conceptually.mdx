...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A faint gray class file rides a thin arrow into a green-walled chamber where the same block turns solid blue inside a live green ring, and out the other side stream small colored results, the JVM bringing compiled code to life"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <rect x="70" y="76" width="56" height="56" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="82" y="92" width="32" height="6" rx="3" />
    <rect x="82" y="104" width="24" height="6" rx="3" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="142" y="102.5" width="44" height="3" rx="1.5" />
    <polygon points="184,98.5 195,104 184,109.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }}>
    <rect x="210" y="36" width="220" height="136" rx="24" fill="currentColor" fillOpacity="0.1" stroke="currentColor" strokeWidth="2.5" />
    <circle cx="320" cy="104" r="44" fill="none" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <rect x="292" y="76" width="56" height="56" rx="10" fill="var(--ds-blue-500)" />
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.85">
    <rect x="304" y="92" width="32" height="6" rx="3" />
    <rect x="304" y="104" width="24" height="6" rx="3" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="446" y="102.5" width="44" height="3" rx="1.5" />
    <polygon points="488,98.5 499,104 488,109.5" />
  </g>
  <circle cx="524" cy="124" r="6" fill="var(--ds-blue-500)" />
  <circle cx="544" cy="100" r="7" fill="var(--ds-green-500)" />
  <circle cx="564" cy="78" r="6" fill="var(--ds-yellow-500)" />
</svg>
