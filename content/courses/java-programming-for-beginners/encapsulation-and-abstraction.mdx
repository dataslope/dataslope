...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A vault with a combination dial keeps its contents faint and private, while requests pass in and answers come back only through two small green teller slots in the wall — data hidden, methods exposed"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="180" y="40" width="220" height="170" rx="18" fillOpacity="0.12" />
    <circle cx="290" cy="118" r="34" fillOpacity="0.3" />
    <circle cx="290" cy="118" r="22" fillOpacity="0.85" />
    <circle cx="220" cy="72" r="6" fillOpacity="0.25" />
    <circle cx="356" cy="66" r="7" fillOpacity="0.25" />
    <circle cx="224" cy="172" r="6" fillOpacity="0.25" />
    <rect x="338" y="170" width="26" height="14" rx="5" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="318" cy="118" r="3" fillOpacity="0.8" />
    <circle cx="290" cy="90" r="3" fillOpacity="0.8" />
    <circle cx="262" cy="118" r="3" fillOpacity="0.8" />
    <circle cx="290" cy="146" r="3" fillOpacity="0.8" />
    <rect x="286" y="96" width="8" height="44" rx="4" fillOpacity="0.85" transform="rotate(35 290 118)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="392" y="90" width="16" height="28" rx="6" />
    <rect x="392" y="150" width="16" height="28" rx="6" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="520" cy="104" r="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="498" cy="104" r="3" />
    <circle cx="476" cy="104" r="3" />
    <circle cx="454" cy="104" r="3" />
    <circle cx="432" cy="104" r="3" />
    <circle cx="424" cy="166" r="3" />
    <circle cx="448" cy="170" r="3" />
    <circle cx="472" cy="174" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="498" cy="178" r="8" />
  </g>
</svg>
