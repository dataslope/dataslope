...
**encapsulation** and **abstraction**, and they are the reason
object-oriented programming exists at all.
...
<Figure
  slug="java-encapsulation-and-abstraction-encapsulation-each-object-inline-cutout"
  alt="Three sealed crates on a bench, each holding its own parts and none reaching into another"
  caption="Each object guards its own state, and nothing reaches in from outside."
/>
...
<Figure
  slug="java-encapsulation-and-abstraction-does-matter-inline-cutout"
  alt="A sealed case with two levers on its face, a hand refused at the seam and directed to the levers"
  caption="With the field private, the class can refuse an operation that would break its rules."
/>
...
<Figure
  slug="java-encapsulation-and-abstraction-common-mistakes-beginners-make-inline-cutout"
  alt="A hand reaching straight through an open hatch to the parts inside a sealed box, past the controls on its front"
  caption="Returning the internal list hands out a hatch straight past the methods that guard it."
/>
