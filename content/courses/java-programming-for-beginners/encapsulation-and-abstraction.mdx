...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A blue capsule keeps its inner shapes faint behind a solid border with two green ports: a yellow caller's arrow enters the top port and a green answer leaves the lower one, while the arrow aimed straight at the innards is stopped at the wall by a red bar"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }}>
    <rect x="140" y="32" width="230" height="160" rx="18" fill="currentColor" fillOpacity="0.1" stroke="currentColor" strokeWidth="2.5" />
    <g fill="currentColor" fillOpacity="0.3">
      <circle cx="200" cy="84" r="9" />
      <rect x="246" y="72" width="26" height="18" rx="5" />
      <circle cx="222" cy="136" r="7" />
      <rect x="264" y="126" width="20" height="14" rx="4" />
    </g>
  </g>
  <rect x="361" y="70" width="18" height="30" rx="8" fill="var(--ds-green-500)" />
  <rect x="361" y="130" width="18" height="30" rx="8" fill="var(--ds-green-500)" fillOpacity="0.7" />
  <circle cx="520" cy="85" r="9" fill="var(--ds-yellow-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="404" y="83.5" width="96" height="3" rx="1.5" />
    <polygon points="406,79.5 395,85 406,90.5" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="390" y="143.5" width="80" height="3" rx="1.5" />
    <polygon points="468,139.5 479,145 468,150.5" />
  </g>
  <circle cx="500" cy="145" r="9" fill="var(--ds-green-500)" />
  <g fill="var(--ds-gray-400)">
    <rect x="420" y="43.5" width="60" height="3" rx="1.5" />
    <polygon points="422,39.5 411,45 422,50.5" />
  </g>
  <rect x="388" y="33" width="5" height="24" rx="2.5" fill="var(--ds-red-500)" />
</svg>
