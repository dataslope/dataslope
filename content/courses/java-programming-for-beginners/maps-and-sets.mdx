...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two panels: on the left each blue key dot ties by a thin gray line to its own colored value pill — a map; on the right a stroked green region holds one dot of each color while an identical green newcomer is crossed out in red at the border — a set"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="25" width="250" height="170" rx="14" fill="var(--ds-blue-500)" fillOpacity="0.05" />
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="112" y1="65" x2="180" y2="65" />
    <line x1="112" y1="110" x2="180" y2="110" />
    <line x1="112" y1="155" x2="180" y2="155" />
  </g>
  ...
  <rect x="184" y="54" width="70" height="22" rx="8" fill="var(--ds-green-500)" fillOpacity="0.8" />
  <rect x="184" y="99" width="70" height="22" rx="8" fill="var(--ds-yellow-500)" fillOpacity="0.85" />
  <rect x="184" y="144" width="70" height="22" rx="8" fill="var(--ds-blue-500)" fillOpacity="0.5" />
  <rect x="330" y="25" width="250" height="170" rx="14" fill="var(--ds-green-500)" fillOpacity="0.05" />
  <line x1="536" y1="68" x2="500" y2="90" stroke="var(--ds-gray-300)" strokeWidth="2" />
  <g style={{ color: "var(--ds-green-500)" }}>
    <circle cx="430" cy="115" r="52" fill="currentColor" fillOpacity="0.07" stroke="currentColor" strokeWidth="2.5" />
  </g>
  <circle cx="408" cy="95" r="8" fill="var(--ds-green-500)" />
  <circle cx="450" cy="105" r="8" fill="var(--ds-blue-500)" />
  <circle cx="425" cy="140" r="8" fill="var(--ds-yellow-500)" />
  <circle cx="545" cy="62" r="8" fill="var(--ds-green-500)" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="499" y="81.5" width="18" height="5" rx="2.5" transform="rotate(45 508 84)" />
    <rect x="499" y="81.5" width="18" height="5" rx="2.5" transform="rotate(-45 508 84)" />
  </g>
</svg>
