...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A solid blue parent block branches along thin gray lines into two children that keep the same blue body and white stripe but wear different crests; the same gray arrow call hits each one, and one answers with green squares, the other with yellow dots"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="320" y1="68" x2="200" y2="108" />
    <line x1="320" y1="68" x2="440" y2="108" />
  </g>
  <rect x="290" y="20" width="60" height="48" rx="12" fill="var(--ds-blue-500)" />
  <rect x="304" y="40" width="32" height="6" rx="3" fill="var(--ds-white)" fillOpacity="0.85" />
  <polygon points="222,98 210,118 234,118" fill="var(--ds-green-500)" />
  <rect x="170" y="108" width="60" height="48" rx="12" fill="var(--ds-blue-500)" />
  <rect x="184" y="128" width="32" height="6" rx="3" fill="var(--ds-white)" fillOpacity="0.85" />
  <circle cx="466" cy="108" r="9" fill="var(--ds-yellow-500)" />
  <rect x="410" y="108" width="60" height="48" rx="12" fill="var(--ds-blue-500)" />
  <rect x="424" y="128" width="32" height="6" rx="3" fill="var(--ds-white)" fillOpacity="0.85" />
  <g fill="var(--ds-gray-400)">
    <rect x="100" y="130.5" width="56" height="3" rx="1.5" />
    <polygon points="154,126.5 165,132 154,137.5" />
    <rect x="484" y="130.5" width="56" height="3" rx="1.5" />
    <polygon points="486,126.5 475,132 486,137.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="182" y="172" width="12" height="12" rx="3" />
    <rect x="204" y="188" width="12" height="12" rx="3" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="430" cy="178" r="6" />
    <circle cx="452" cy="194" r="6" fillOpacity="0.7" />
  </g>
</svg>
