...
<Figure
  slug="java-inheritance-and-polymorphism-relationships-inline-cutout"
  alt="One base cabinet with three cabinets behind it, each built on the same frame"
  caption="Subclasses share the base frame and refine what they need to."
/>
