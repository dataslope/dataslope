...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A stream of yellow user dots reaches a yellow coin-flip diamond and splits along two thin lines — a blue control panel and a green variant panel of identical crowds, the variant lighting up more converted dots and growing a longer result pill — randomize the split, and the only difference left to credit is the change itself"
...
>
  ...
  <g stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round">
    <line x1="228" y1="104" x2="292" y2="62" />
    <line x1="228" y1="120" x2="292" y2="162" />
  </g>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A thin blue p-value line wanders and dips below the red significance line exactly once, where a yellow stop flag is eagerly planted, while its fainter future climbs right back up — peek long enough and noise alone will hand you a lucky dip to stop on"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="130" width="500" height="4" rx="2" fill="var(--ds-red-500)" />
  <polyline
    points="90,60 120,84 150,70 180,96 210,110 240,122 270,144"
    fill="none"
  ...
  />
  <polyline
    points="270,144 300,120 330,98 360,108 390,86 420,96 450,76 480,88 510,70 540,80"
    fill="none"
    stroke="var(--ds-blue-500)"
    strokeWidth="3"
    strokeOpacity="0.35"
  ...
  />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="268" y="100" width="4" height="46" rx="2" />
    <polygon points="272,100 296,108 272,116" />
  </g>
</svg>
