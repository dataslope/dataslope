...
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="318" y="16" width="4" height="222" rx="2" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="100" y="80" width="440" height="3" rx="1.5" />
    <rect x="100" y="153" width="440" height="3" rx="1.5" />
    <rect x="100" y="226" width="440" height="3" rx="1.5" />
  </g>
...
>
  <g fill="var(--ds-gray-300)">
    <rect x="56" y="130" width="160" height="3" rx="1.5" />
    <rect x="240" y="130" width="160" height="3" rx="1.5" />
    <rect x="424" y="130" width="160" height="3" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
