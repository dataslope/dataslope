...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A tiny blue speck ringed by loud yellow broadcast circles stands on a long sample bar, while a massive green boulder with barely a whisper of a ring stands on a short one — a huge sample can make a microscopic effect scream with significance while a big effect on little data hardly registers"
  style={{ display: "block", width: "100%", maxWidth: "600px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="none" stroke="var(--ds-yellow-500)">
    <circle cx="180" cy="104" r="28" strokeWidth="4" strokeOpacity="0.9" />
    <circle cx="180" cy="104" r="46" strokeWidth="4" strokeOpacity="0.55" />
    <circle cx="180" cy="104" r="64" strokeWidth="4" strokeOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="104" r="5" />
  </g>
  <rect x="120" y="182" width="120" height="8" rx="4" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="470" cy="104" r="38" />
  </g>
  <circle cx="470" cy="104" r="52" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2.5" />
  <rect x="452" y="182" width="36" height="8" rx="4" fill="var(--ds-gray-400)" />
</svg>
...
### A real, genuinely large effect

In *T-Tests* we found that Adelie and Gentoo penguins have significantly
different flipper lengths (the p-value was vanishingly small). But "how
*different*?" is the effect-size question. Run Cohen's d on the same two
groups from the **Palmer penguins** dataset:
...
def cohens_d(a, b):
    ...
    return (a.mean() - b.mean()) / s_pooled`,
      starterCode: `adelie = penguins.loc[penguins["species"] == "Adelie", "flipper_length_mm"].dropna()
gentoo = penguins.loc[penguins["species"] == "Gentoo", "flipper_length_mm"].dropna()

print(f"Raw difference : {gentoo.mean() - adelie.mean():+.1f} mm")
print(f"Cohen's d      : {cohens_d(gentoo, adelie):.2f}")
print()
print("d > 4: the two species barely overlap on flipper length.")
print("This is what a genuinely huge real-world effect looks like —")
print("far beyond the '0.8 = large' guidepost.")
`,
    },
  ]}
/>

A Cohen's d above 4 is off the end of the usual table — the distributions
are almost completely separated. Biology hands you effects this clean;
product experiments almost never do, which is the whole reason the next
section matters.
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three panels with ever taller stacks of blue data dots: the green effect-size bar stays exactly the same height in every panel while the red p-value bar collapses to a sliver — more data sharpens the magnitude but makes significance nearly automatic"
  style={{ display: "block", width: "100%", maxWidth: "620px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="56" y="24" width="168" height="152" rx="12" fillOpacity="0.08" />
    <rect x="236" y="24" width="168" height="152" rx="12" fillOpacity="0.08" />
    <rect x="416" y="24" width="168" height="152" rx="12" fillOpacity="0.08" />
    <circle cx="118" cy="58" r="4.5" />
    <circle cx="298" cy="58" r="4.5" />
    <circle cx="310" cy="58" r="4.5" />
    <circle cx="304" cy="48" r="4.5" />
    <circle cx="478" cy="58" r="4.5" />
    <circle cx="490" cy="58" r="4.5" />
    <circle cx="502" cy="58" r="4.5" />
    <circle cx="484" cy="48" r="4.5" />
    <circle cx="496" cy="48" r="4.5" />
    <circle cx="490" cy="38" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="96" y="110" width="26" height="48" rx="5" />
    <rect x="276" y="110" width="26" height="48" rx="5" />
    <rect x="456" y="110" width="26" height="48" rx="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="136" y="82" width="26" height="76" rx="5" />
    <rect x="316" y="122" width="26" height="36" rx="5" />
    <rect x="496" y="150" width="26" height="8" rx="4" />
  </g>
  <g fill="var(--ds-gray-400)">
    <rect x="78" y="158" width="124" height="3" rx="1.5" />
    <rect x="258" y="158" width="124" height="3" rx="1.5" />
    <rect x="438" y="158" width="124" height="3" rx="1.5" />
  </g>
</svg>
