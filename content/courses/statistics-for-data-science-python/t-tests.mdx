...
>
  ...
  <rect x="452" y="106" width="106" height="4" rx="2" fill="var(--ds-gray-500)" />
...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Six people's before dots on the left connect by thin lines to their after dots on the right; the two columns overlap so much their group means almost match, yet every single trail tilts upward, pairing each unit with itself reveals the change that group comparison drowns in noise"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="210" y1="58" x2="430" y2="44" />
    <line x1="210" y1="86" x2="430" y2="72" />
    <line x1="210" y1="114" x2="430" y2="100" />
    <line x1="210" y1="142" x2="430" y2="128" />
    <line x1="210" y1="170" x2="430" y2="156" />
    <line x1="210" y1="198" x2="430" y2="184" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
