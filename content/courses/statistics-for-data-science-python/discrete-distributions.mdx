...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A single yes-or-no Bernoulli pair at the top branches down three thin lines into its children — a lollipop hill of success counts, a row of event ticks, and a run of gray misses ending in the first green hit — binomial, Poisson, and geometric all grown from one tiny atom"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="308" y1="60" x2="160" y2="140" />
    <line x1="320" y1="60" x2="320" y2="150" />
    <line x1="332" y1="60" x2="490" y2="140" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="304" cy="44" r="12" />
  </g>
  <circle cx="336" cy="44" r="12" fill="var(--ds-gray-300)" />
  <g fill="var(--ds-gray-300)">
    <rect x="64" y="200" width="180" height="3" rx="1.5" />
    <rect x="250" y="200" width="140" height="3" rx="1.5" />
    <rect x="430" y="200" width="160" height="3" rx="1.5" />
  </g>
  ...
  <g fill="var(--ds-gray-300)">
    <circle cx="448" cy="188" r="7" />
    <circle cx="480" cy="188" r="7" />
    <circle cx="512" cy="188" r="7" />
    <circle cx="544" cy="188" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="578" cy="188" r="8.5" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="One long timeline of irregularly arriving yellow event ticks sliced into three equal translucent windows, each topped by blue count dots for the two, five, and one events it captured — a fixed interval, a constant average rate, and a count that varies window to window is exactly the Poisson setting"
  style={{ display: "block", width: "100%", maxWidth: "620px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="110" width="520" height="3" rx="1.5" fill="var(--ds-gray-400)" />
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="288" cy="60" r="4" />
    <circle cx="304" cy="60" r="4" />
    <circle cx="320" cy="60" r="4" />
    <circle cx="336" cy="60" r="4" />
