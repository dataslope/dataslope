...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A frozen distribution sits inside a translucent ice cube at the center while four small tool tiles hang off it on thin solid spokes — a density hump, a rising accumulation ribbon, a yellow quantile cut post, and a spray of random draws — every scipy distribution answers the same four questions"
...
>
  ...
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="184" y1="78" x2="262" y2="104" />
    <line x1="456" y1="78" x2="378" y2="104" />
    <line x1="184" y1="170" x2="262" y2="144" />
    <line x1="456" y1="170" x2="378" y2="144" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
...
>
  <rect x="60" y="141" width="520" height="3" rx="1.5" fill="var(--ds-gray-300)" />
  ...
  <rect x="354" y="100" width="4" height="52" rx="2" fill="var(--ds-gray-500)" />
