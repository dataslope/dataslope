...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A messy playground of little charts on one side of a gray wall, a clean green interval with a stroked check on the other, and one yellow hypothesis arc jumping over the top, explore freely, then confirm on data that never saw the exploring"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="312" y="44" width="16" height="146" rx="8" fill="var(--ds-gray-300)" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <polygon points="384,88 400,88 392,104" />
  </g>
  <path d="M 254 94 C 284 24 360 24 392 88" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" strokeLinecap="round" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="420" y="130" width="130" height="8" rx="4" fillOpacity="0.4" />
    <rect x="418" y="124" width="5" height="20" rx="2.5" />
    <rect x="547" y="124" width="5" height="20" rx="2.5" />
    <circle cx="485" cy="134" r="5.5" />
  </g>
  <path d="M 466 84 L 480 98 L 504 68" fill="none" stroke="var(--ds-green-500)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
</svg>
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="475" y="28" width="40" height="120" rx="12" fillOpacity="0.14" />
  </g>
</svg>
...
assert best_pair[0] != best_pair[1]`,
    },
    {
      ...
      code: `import numpy as np
corr = tips.select_dtypes("number").corr().values
