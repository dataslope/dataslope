...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A six-wedge wheel with three faces lit blue under a yellow pointer, beside a fraction built from dots — three blue dots over a bar and six below it — probability as the share of the sample space an event covers"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="452" cy="76" r="7" />
    <circle cx="492" cy="76" r="7" />
    <circle cx="532" cy="76" r="7" />
  </g>
  <rect x="424" y="98" width="136" height="4" rx="2" fill="var(--ds-gray-500)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="436" cy="126" r="7" />
    <circle cx="476" cy="126" r="7" />
    <circle cx="516" cy="126" r="7" />
  </g>
  <g fill="var(--ds-gray-400)">
    <circle cx="456" cy="150" r="7" />
    <circle cx="496" cy="150" r="7" />
    <circle cx="536" cy="150" r="7" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A trail of coin-flip dots lurches far above and below the dark blue one-half line at first, then settles into a tight hug of it as the flips pile up — the Law of Large Numbers stabilizes the long run without ever fixing the short run"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-700)" }} fill="currentColor">
    <rect x="80" y="108" width="500" height="4" rx="2" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M 80 30 C 240 30 380 96 580 102 L 580 118 C 380 124 240 190 80 190 Z" fillOpacity="0.1" />
  </g>
</svg>
