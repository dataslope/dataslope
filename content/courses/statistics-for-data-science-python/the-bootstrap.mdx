...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One row of sample dots loops down a solid arrow into three resamples, where touching pairs reveal observations drawn twice while others vanish, and each resample sends a thin line to its green statistic dot piling into a small hump — resampling your own data with replacement fakes the sampling distribution you cannot collect"
...
>
  ...
  <path d="M 122 58 C 96 84 96 146 118 170" fill="none" stroke="var(--ds-gray-400)" strokeWidth="2.5" strokeLinecap="round" />
  <polygon points="110,162 126,178 128,158" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="348" y1="120" x2="394" y2="120" />
    <line x1="348" y1="152" x2="394" y2="152" />
    <line x1="348" y1="184" x2="394" y2="184" />
  </g>
  ...
  <rect x="450" y="197" width="140" height="3" rx="1.5" fill="var(--ds-gray-400)" />
</svg>
...
The bootstrap standard error and the `s / √n` formula match closely,
