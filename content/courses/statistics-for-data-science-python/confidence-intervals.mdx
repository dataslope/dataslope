...
roughly the 1% level, because the standard error of a difference is the square
root of the sum of squares rather than the sum. When the question is about a
