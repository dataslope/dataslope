...
<Figure
  slug="stat-measures-of-spread-same-center-different-inline-cutout"
  alt="Two rows of chips centred on the same mark, one clustered tightly and one spread end to end"
  caption="Two batches can share a centre and still be nothing alike."
/>
