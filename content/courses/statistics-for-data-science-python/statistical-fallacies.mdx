...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two dot clusters each climb upward along their own blue and green trend lines, yet one red line drawn through everything together slopes firmly downward — Simpson's paradox in miniature: the combined trend can contradict every group it contains"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-400)" strokeWidth="2" strokeLinecap="round">
    <line x1="82" y1="36" x2="82" y2="196" />
    <line x1="82" y1="196" x2="560" y2="196" />
  </g>
  <line x1="100" y1="62" x2="510" y2="158" stroke="var(--ds-red-500)" strokeWidth="4" strokeLinecap="round" strokeOpacity="0.55" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M 112 88 L 226 50" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeOpacity="0.6" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M 372 174 L 486 136" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeOpacity="0.6" />
...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Dots from a first measurement drift along thin lines toward a second column: the ringed high flyers sink back toward the yellow mean line and the ringed strugglers float up to it, with no intervention anywhere — extreme readings carry luck, and luck does not repeat"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="120" y="106" width="400" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <circle cx="180" cy="38" r="13" fill="none" stroke="var(--ds-blue-500)" strokeWidth="3" strokeOpacity="0.45" />
  <circle cx="180" cy="178" r="13" fill="none" stroke="var(--ds-blue-500)" strokeWidth="3" strokeOpacity="0.45" />
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="196" y1="42" x2="446" y2="80" />
    <line x1="196" y1="174" x2="446" y2="138" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
...
>
  ...
  <circle cx="452" cy="97" r="37" fill="none" stroke="var(--ds-red-500)" strokeWidth="6" />
  <circle cx="452" cy="97" r="19" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="5" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
