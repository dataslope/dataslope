...
>
  <rect x="40" y="24" width="400" height="176" rx="16" fill="var(--ds-blue-500)" fillOpacity="0.06" />
  ...
  <circle cx="128" cy="158" r="49" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="6" />
  <g fill="var(--ds-gray-400)">
    <rect x="448" y="110.5" width="26" height="3" rx="1.5" />
    <polygon points="472,106.5 483,112 472,117.5" />
  </g>
  <rect x="490" y="70" width="110" height="86" rx="14" fill="var(--ds-blue-500)" fillOpacity="0.08" />
  ...
  <rect x="490" y="176" width="110" height="3" rx="1.5" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
...
>
  <g fill="none" stroke="var(--ds-gray-300)" strokeWidth="2.5">
    <circle cx="180" cy="115" r="62" />
    <circle cx="180" cy="115" r="40" />
    <circle cx="460" cy="115" r="62" />
    <circle cx="460" cy="115" r="40" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
...
>
  ...
  <circle cx="320" cy="58" r="25" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="6" />
</svg>
