...
<Figure
  slug="stat-populations-samples-cutout"
  alt="An enormous crowd of tiny spheres on a wide platform with a small scoop lifting out a handful onto a tray"
/>
...
<Figure
  slug="stat-populations-and-samples-population-vs-sample-inline-cutout"
  alt="A very large bin of chips with a small scoop of them set on a tray beside it"
  caption="The sample is the scoop you can see; the population is the bin you cannot."
/>
...
<Figure
  slug="stat-populations-and-samples-inline-cutout"
  alt="A very large bin of chips with a small scoop of them set out on a tray beside it"
  caption="Every statistic you compute describes the scoop and only estimates the bin."
/>

Twenty samples from one unchanging population, and the twenty answers they
give:
