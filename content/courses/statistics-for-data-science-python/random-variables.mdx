...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Four coin-pair outcomes send thin lines into a solid blue function box with a white arrow, which maps them onto a number line of green mass dots, a random variable is the rule that turns whatever happened into a number you can do math on"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="128" y1="50" x2="266" y2="104" />
    <line x1="128" y1="95" x2="266" y2="112" />
    <line x1="128" y1="140" x2="266" y2="120" />
    <line x1="128" y1="185" x2="266" y2="128" />
    <line x1="338" y1="116" x2="396" y2="134" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="266" y="80" width="72" height="72" rx="14" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="292,104 292,128 316,116" />
  </g>
  <rect x="360" y="132.5" width="39" height="3" rx="1.5" fill="var(--ds-gray-400)" />
  <polygon points="397,128.5 397,139.5 408,134" fill="var(--ds-gray-400)" />
  <rect x="408" y="150" width="192" height="3" rx="1.5" fill="var(--ds-gray-400)" />
  <g fill="var(--ds-gray-400)">
    <rect x="435" y="158" width="3" height="10" rx="1.5" />
    <rect x="503" y="158" width="3" height="10" rx="1.5" />
    <rect x="571" y="158" width="3" height="10" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="436" cy="138" r="6" />
    <circle cx="504" cy="132" r="9" />
...
>
  <g fill="var(--ds-gray-400)">
    <rect x="56" y="148" width="220" height="3" rx="1.5" />
    <rect x="336" y="148" width="248" height="3" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
