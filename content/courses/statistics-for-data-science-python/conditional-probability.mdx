...
A stacked bar normalises every column to full height, so it shows the
conditional distribution and hides how many observations are behind each one.
A mosaic shows the joint distribution, and the flat divider is a chi-squared
test you can run with your eye.
