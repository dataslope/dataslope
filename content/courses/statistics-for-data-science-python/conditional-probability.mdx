...
The classic demonstration is a courtroom. Two sentences that sound
identical, and differ by four orders of magnitude:
...
Roughly 9%, from a test that is 99% accurate. That number is surprising
enough that it is worth checking by brute force rather than trusting the
algebra: simulate two million people and count.
