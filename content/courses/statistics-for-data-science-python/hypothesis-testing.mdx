...
<Figure
  slug="stat-hypothesis-testing-core-idea-assume-inline-cutout"
  alt="A plain assumption card standing upright with evidence chips stacking beside it until it tips"
  caption="Assume nothing is going on, then see how much evidence it takes to tip that over."
/>
...
<Figure
  slug="stat-hypothesis-testing-courtroom-analogy-inline-cutout"
  alt="A plain card standing upright presumed sound, with evidence chips stacked against it until it tips"
  caption="The null hypothesis stands until the evidence against it is strong enough."
/>
...
<Figure
  ...
  caption="A test answers one narrow question: could chance alone have produced this?"
/>
