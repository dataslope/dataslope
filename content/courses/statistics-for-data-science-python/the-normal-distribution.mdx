...
<Figure
  slug="stat-normal-distribution-cutout"
  alt="A symmetric bell mound on a platform divided into three nested shaded bands widening outward from its centre"
/>
...
<Figure
  slug="stat-the-normal-distribution-normal-shows-up-inline-cutout"
  alt="Many small unrelated nudges added along a rail, the total settling into a smooth mound"
  caption="Many small independent nudges add up to a bell, whatever each nudge looks like."
/>
...
Standardizing moves and rescales a distribution. It does not reshape one,
which is the part people quietly assume away:

<Chart slug="z-score-standardization" />
...
<Figure
  slug="stat-the-normal-distribution-inline-cutout"
  alt="A symmetric mound of chips with three widening bands marked outward from its centre, each band holding fewer chips"
  caption="The bands hold roughly 68, 95 and 99.7 per cent of a normal distribution."
/>
