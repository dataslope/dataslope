...
<Figure
  slug="stat-next-steps-cutout"
  alt="The Dataslope marmot mascot on a summit platform beside a signpost with five arrows pointing toward distant structures"
/>
...
9. **Applied: exploratory analysis and A/B testing**, put it all to work.
