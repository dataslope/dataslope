...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A thin path climbs through three small cards, a blue bell curve, a green confidence interval, and a yellow scatter, then continues past the last card as a solid green arrow pointing onward and upward"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <path d="M 122 180 C 136 180 138 148 150 148 C 162 148 164 180 178 180 Z" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="260" y="88" width="80" height="64" rx="10" fillOpacity="0.15" />
    <rect x="276" y="116" width="48" height="7" rx="3.5" fillOpacity="0.45" />
    <rect x="274" y="110" width="4" height="19" rx="2" />
    <rect x="322" y="110" width="4" height="19" rx="2" />
    <circle cx="300" cy="119" r="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="410" y="48" width="80" height="64" rx="10" fillOpacity="0.2" />
    <circle cx="432" cy="92" r="4" />
    <circle cx="450" cy="76" r="4" />
    <circle cx="468" cy="86" r="4" />
    <circle cx="458" cy="64" r="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
...
sp = np.sqrt(
    ((na - 1) * control.var(ddof=1) + (nb - 1) * treatment.var(ddof=1)) / (na + nb - 2)
)
