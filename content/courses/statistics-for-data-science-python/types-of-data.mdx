...
>
  ...
  <circle cx="180" cy="180" r="5" fill="none" stroke="var(--ds-red-500)" strokeWidth="2" strokeDasharray="3 4" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Four blue code tags pinned at scattered spots on a faint map, with thin lines converging on a red diamond in the middle of nowhere, averaging labels lands you at a point that means nothing"
  style={{ display: "block", width: "100%", maxWidth: "520px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="20" width="500" height="150" rx="16" fill="var(--ds-blue-500)" fillOpacity="0.06" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="160" y1="56" x2="302" y2="88" />
    <line x1="444" y1="66" x2="330" y2="88" />
    <line x1="196" y1="126" x2="302" y2="102" />
    <line x1="450" y1="132" x2="330" y2="102" />
  </g>
