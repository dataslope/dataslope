...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three wildly different parent shapes, a red skewed slide, a blue flat slab, and a yellow two-humped camel, funnel along thin solid lines into the same single green bell with its yellow center post, averaging washes out every parent's shape into one universal curve"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2">
    <line x1="166" y1="42" x2="410" y2="118" />
    <line x1="166" y1="110" x2="410" y2="118" />
    <line x1="166" y1="168" x2="410" y2="118" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path d="M 56 62 L 56 20 C 75 26 100 48 140 58 C 148 60 154 61 158 62 Z" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="58" y="96" width="130" height="28" rx="5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M 58 186 C 70 186 72 152 86 152 C 100 152 98 176 108 176 C 118 176 116 152 130 152 C 144 152 146 186 158 186 Z" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M 424 170 C 460 170 466 64 504 64 C 542 64 548 170 584 170 Z" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="501.5" y="70" width="5" height="100" rx="2.5" />
  </g>
</svg>
