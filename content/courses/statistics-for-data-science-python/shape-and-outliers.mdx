...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A dune-shaped distribution peaks on the left and drags a long tail to the right, while one red point sits far down the tail, skew is named for the tail, and an outlier is a question, not a verdict"
...
>
  <rect x="70" y="154" width="500" height="3" rx="1.5" fill="var(--ds-gray-400)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
...
<svg
  viewBox="0 0 640 180"
  role="img"
  aria-label="A cluster of ordinary green dots on the left and one red point far away on the right, held under a blue magnifying lens, an outlier is simply far away, which earns it an investigation, not a deletion"
