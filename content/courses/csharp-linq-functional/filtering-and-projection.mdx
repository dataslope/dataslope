...
<svg
  viewBox="0 0 640 260"
  role="img"
  aria-label="Shapes fall through two horizontal bars: the yellow bar catches some circles on top while others pass, and everything passing the blue bar comes out as squares, Where then Select"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="40" r="11" />
    <circle cx="420" cy="40" r="11" />
    <circle cx="180" cy="136" r="11" />
    <circle cx="420" cy="136" r="11" />
    <rect x="169" y="209" width="22" height="22" rx="6" />
    <rect x="409" y="209" width="22" height="22" rx="6" />
    <rect x="140" y="170" width="360" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="500" cy="40" r="11" />
    <circle cx="260" cy="79" r="11" />
    <circle cx="500" cy="136" r="11" />
    <rect x="489" y="209" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="340" cy="79" r="11" />
    <rect x="140" y="90" width="360" height="16" rx="8" />
  </g>
</svg>
