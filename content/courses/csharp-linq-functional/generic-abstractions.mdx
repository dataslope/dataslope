...
<Figure
  slug="cs-generic-abstractions-cutout"
  alt="Generic abstractions, an isometric illustration"
/>
...
<Figure
  slug="cs-generic-abstractions-interface-unifies-everything-inline-cutout"
  alt="One standard fitting shown on the front of five very different containers"
  caption="One generic interface fits containers that share nothing else."
/>
...
<Figure
  slug="cs-generic-abstractions-building-generic-key-grouped-inline-cutout"
  alt="A single press that stamps the same shape into wholly different materials without being re-cut for each"
  caption="One method, written once, running over strings keyed by length and ints keyed by parity."
/>
