...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A tangle of overlapping translucent loops with a dot lost inside, an arrow, and then the same journey as one straight green bar arriving at a blue dot"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="330" y="104" width="220" height="12" rx="6" />
  </g>
