...
<Figure
  slug="cs-side-effect-management-cutout"
  alt="Side-effect management, an isometric illustration"
/>
...
| --- | --- | --- |
| Needs mocks, fixtures or a filesystem to test | ✅ | ❌ |
| Can be tested by comparing one value to another | ❌ | ✅ |
| Can behave differently on two identical runs | ✅ | ❌ |
| Holds the business rules worth arguing about | ❌ | ✅ |
| Where LINQ shines | ❌ | ✅ |
...
<Figure
  slug="cs-side-effect-management-inline-cutout"
  alt="A clean line of machines with every hose and wire gathered to one end and plugged into a single marked panel"
  caption="Every hose and wire runs to one panel, and the line itself stays clean."
/>
...
<Figure
  slug="cs-side-effect-management-two-halves-program-inline-cutout"
  alt="A bench with a clean sealed line on one side and all the hoses, taps and wires gathered on the other"
  caption="A pure core with a thin shell around it is the shape to aim for."
/>
