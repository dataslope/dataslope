...
<Figure
  slug="cs-lambdas-and-delegates-cutout"
  alt="Lambdas and delegates, an isometric illustration"
/>
...
<Figure
  ...
  alt="A small hand tool being carried across a bench and slotted into a waiting bracket on a larger machine, which starts working the moment it clicks in"
  caption="A lambda is behaviour written inline and passed like any other value."
/>
...
Why does this matter? Because LINQ providers, Entity Framework Core, MongoDB
...
<Figure
  slug="cs-lambdas-and-delegates-delegates-type-function-inline-cutout"
  alt="A shaped socket on a panel with three small tools above it, only the tool of matching shape able to seat"
  caption="A delegate is a type for a function, and only a matching shape fits."
/>
