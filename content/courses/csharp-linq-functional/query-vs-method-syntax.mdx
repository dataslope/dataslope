...
<Figure
  slug="cs-query-vs-method-syntax-cutout"
  alt="Query vs method syntax, an isometric illustration"
/>
...
<Figure
  slug="cs-query-vs-method-syntax-side-by-side-inline-cutout"
  alt="Two differently written instruction cards feeding one machine and producing two identical trays"
  caption="Query syntax compiles to method calls, so both spell the same thing."
/>
...
<Figure
  slug="cs-query-vs-method-syntax-inline-cutout"
  alt="Two differently written instruction cards feeding the same machine and producing identical output trays"
  caption="Two ways to write it, one pipeline underneath."
/>
