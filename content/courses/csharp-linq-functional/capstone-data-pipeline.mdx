...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="The whole course in one line: a blue data block passes through a gate, a lens, and a funnel along a thin connecting line, and arrives as a small bar-chart report"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="78" width="70" height="64" rx="12" />
