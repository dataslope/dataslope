...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="Two identical runs through a blue box give identical outputs, while a third run through a red box gives a different shape and leaks sparks below — pure versus impure"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="135" cy="130" r="3" />
    <circle cx="158" cy="130" r="3" />
    <circle cx="135" cy="200" r="3" />
    <circle cx="158" cy="200" r="3" />
    <circle cx="295" cy="70" r="3" />
    <circle cx="318" cy="70" r="3" />
    <circle cx="295" cy="130" r="3" />
    <circle cx="318" cy="130" r="3" />
    <circle cx="295" cy="200" r="3" />
    <circle cx="318" cy="200" r="3" />
  </g>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    ...
    <circle cx="215" cy="238" r="3" fillOpacity="0.6" />
    <circle cx="232" cy="243" r="2.5" fillOpacity="0.5" />
  </g>
</svg>
