...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three small panels of miniature patterns: a dashed maybe-circle beside a solid one, a value forking along thin lines to success or failure, and three dots folding into one — Option, Result, and fold"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.06">
    <rect x="70" y="50" width="160" height="130" rx="16" />
    <rect x="250" y="50" width="160" height="130" rx="16" />
    <rect x="430" y="50" width="160" height="130" rx="16" />
  </g>
  <circle
    cx="115"
    cy="115"
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="172" cy="115" r="13" />
    <circle cx="300" cy="148" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="330" cy="80" r="10" />
  </g>
  <g
    fill="none"
    stroke="currentColor"
    ...
    opacity="0.3"
  >
    <path d="M322 89 C 312 106, 305 122, 301 136" />
    <path d="M338 89 C 348 106, 355 122, 359 136" />
    <path d="M470 90 C 477 106, 489 118, 496 127" />
    <path d="M500 88 V 124" />
    <path d="M530 90 C 523 106, 511 118, 504 127" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="360" cy="148" r="9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="470" cy="80" r="7" />
    <circle cx="500" cy="80" r="7" />
    <circle cx="530" cy="80" r="7" />
    <circle cx="500" cy="140" r="13" />
  </g>
</svg>
