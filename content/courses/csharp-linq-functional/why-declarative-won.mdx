...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two routes to the same destination: a thin zigzag of many small steps reaching a faded circle, and below it a single bold green bar arriving at the same circle, solid"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <path
    d="M80 70 L 110 56 L 138 72 L 164 56 L 190 72 L 216 56 L 242 72 L 268 56 L 294 72 L 320 56 L 346 72 L 372 58 L 400 66"
    fill="none"
    stroke="currentColor"
    strokeWidth="2.5"
    strokeLinecap="round"
