...
<Figure
  slug="cs-ordering-and-grouping-ordering-orderby-orderbydescending-inline-cutout"
  alt="A jumbled tray of blocks combed into a rising staircase, and the same staircase reversed into a falling one"
  caption="`OrderBy()` sorts by a key you extract from each element."
/>
...
<Figure
  slug="cs-ordering-and-grouping-inline-cutout"
  alt="A jumbled tray of blocks combed into a rising line by height, then that line cut into three separate trays by colour"
  caption="Grouping cuts one ordered sequence into a sequence of keyed groups."
/>
