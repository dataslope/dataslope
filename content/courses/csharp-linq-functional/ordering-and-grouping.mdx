...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A random scatter of dots in three colors and sizes, a thin arrow, and the same dots regrouped into tidy columns by color and sorted by size"
...
>
  ...
  <path
    ...
    opacity="0.3"
  />
  <polygon points="322,102 322,118 336,110" fill="currentColor" opacity="0.3" />
  <g fill="currentColor" opacity="0.06">
    <rect x="378" y="38" width="44" height="134" rx="22" />
    <rect x="458" y="38" width="44" height="134" rx="22" />
    <rect x="538" y="38" width="44" height="134" rx="22" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="400" cy="62" r="12" />
    <circle cx="400" cy="105" r="9" />
    <circle cx="400" cy="142" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="480" cy="62" r="11" />
    <circle cx="480" cy="105" r="8" />
    <circle cx="480" cy="142" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="560" cy="62" r="12" />
    <circle cx="560" cy="105" r="8" />
    <circle cx="560" cy="142" r="7" />
  </g>
</svg>
