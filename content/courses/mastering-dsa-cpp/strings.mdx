...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A yellow window highlights a span of characters inside a long string, and that span drops out below as its own small green string — slicing a substring"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="48" width="500" height="40" rx="20" fillOpacity="0.12" />
    <circle cx="100" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="136" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="172" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="208" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="388" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="424" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="460" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="496" cy="68" r="5" fillOpacity="0.55" />
    <circle cx="532" cy="68" r="5" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="226" y="42" width="144" height="52" rx="12" fillOpacity="0.22" />
    <circle cx="244" cy="68" r="5.5" />
    <circle cx="280" cy="68" r="5.5" />
    <circle cx="316" cy="68" r="5.5" />
    <circle cx="352" cy="68" r="5.5" />
  </g>
  <line x1="298" y1="102" x2="298" y2="132" stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="226" y="140" width="144" height="36" rx="18" fillOpacity="0.16" />
    <circle cx="244" cy="158" r="5.5" />
    <circle cx="280" cy="158" r="5.5" />
    <circle cx="316" cy="158" r="5.5" />
    <circle cx="352" cy="158" r="5.5" />
  </g>
</svg>
