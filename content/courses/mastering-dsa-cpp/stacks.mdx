---
title: Stacks
description: Learn the last-in-first-out stack interface, std::stack, vector-backed stacks, balanced parentheses, call stacks, and stack-based string reversal
---
...
<Figure
  slug="dsa-stacks-cutout"
  alt="A vertical column of stacked plates on a platform with the topmost plate lifted off on an arrow, the lower plates untouched"
/>
...
<Figure
  slug="dsa-stacks-std-stack-t-inline-cutout"
  alt="A column of trays where only the top one can be lifted or added to"
  caption="Only the top of a stack is reachable, which is what makes it a stack."
/>
...
<Figure
  slug="dsa-stacks-cellar-cutout"
  alt="An open cellar hatch in a floor taking plates one at a time, with the topmost plate being lifted back out"
  caption="Bauer and Samelson, 1950s: they called it the Keller, the cellar, because the last thing dropped in comes out first."
/>
