...
<Figure
  ...
  caption="Each node points to the next, so reaching item five means walking five links."
/>
...
<Figure
  ...
  caption="Nodes live anywhere in memory; the links are what put them in order."
/>
...
<Figure
  ...
  caption="Inserting means rerouting one link, not shifting everything along."
/>
