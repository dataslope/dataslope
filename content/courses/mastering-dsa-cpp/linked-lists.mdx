...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Four blue nodes scattered across memory are threaded in logical order by thin curving lines from a yellow head marker to a red null ring — a linked list's order lives in its pointers, not its memory layout"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round" fill="none">
    <path d="M124 84 C 200 72, 240 62, 286 58" />
    <path d="M292 69 C 265 105, 245 128, 224 142" />
    <path d="M224 152 C 300 152, 380 135, 436 118" />
    <path d="M464 110 C 500 96, 525 82, 546 70" />
  </g>
