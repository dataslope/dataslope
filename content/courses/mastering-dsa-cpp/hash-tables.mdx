...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three colored key dots feed a solid blue hash box, and thin lines drop them into indexed buckets, the green and yellow keys land in the same bucket and chain together as a collision"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="206" y1="42" x2="305" y2="74" />
    <line x1="320" y1="41" x2="320" y2="74" />
    <line x1="434" y1="42" x2="336" y2="74" />
    <line x1="330" y1="120" x2="416" y2="158" />
    <line x1="312" y1="120" x2="290" y2="158" />
    <line x1="303" y1="120" x2="278" y2="158" />
    <line x1="281" y1="176" x2="295" y2="190" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="200" cy="34" r="9" />
    <rect x="290" y="76" width="60" height="42" rx="12" />
    <circle cx="416" cy="182" r="7" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <circle cx="281" cy="176" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="440" cy="34" r="9" />
    <circle cx="295" cy="190" r="7" />
  </g>
