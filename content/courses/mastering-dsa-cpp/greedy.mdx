...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="From the same blue start, a bold yellow line grabs the biggest coin at every step while a thin gray route through smaller coins reaches the green goal too — the locally best choice is not always globally best"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <path d="M66 118 C 110 140, 130 148, 150 150 C 210 156, 240 132, 270 130 C 320 128, 360 156, 390 160 C 450 158, 520 130, 556 116" fill="none" stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round" />
  <path d="M68 106 C 100 88, 120 78, 150 70 C 200 61, 230 57, 270 60 C 320 64, 355 70, 390 80 C 450 92, 510 102, 556 108" fill="none" stroke="var(--ds-yellow-500)" strokeWidth="3" strokeLinecap="round" />
