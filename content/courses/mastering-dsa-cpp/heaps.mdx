...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A heap tree with the largest value glowing yellow at the apex and a new green node joined to its parent by a bold green edge, above the flat array row that actually stores the levels"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round">
    <line x1="320" y1="48" x2="220" y2="110" />
    <line x1="320" y1="48" x2="420" y2="110" />
    <line x1="220" y1="110" x2="160" y2="170" />
    <line x1="220" y1="110" x2="280" y2="170" />
    <line x1="420" y1="110" x2="380" y2="170" />
  </g>
  <line x1="420" y1="110" x2="460" y2="170" stroke="var(--ds-green-500)" strokeWidth="3" strokeLinecap="round" />
