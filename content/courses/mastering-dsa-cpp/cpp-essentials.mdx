...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="A blue toolbelt with four hanging pouches, each carrying its own simple geometric mark — the small reliable slice of C++ these lessons use"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="48" width="420" height="26" rx="13" fillOpacity="0.3" />
    <rect x="304" y="42" width="32" height="38" rx="9" />
    <rect x="313" y="51" width="14" height="20" rx="6" fillOpacity="0.35" />
  </g>
  <g fill="var(--ds-gray-300)">
    <rect x="166" y="72" width="8" height="14" rx="3" />
    <rect x="246" y="72" width="8" height="14" rx="3" />
    <rect x="386" y="72" width="8" height="14" rx="3" />
    <rect x="466" y="72" width="8" height="14" rx="3" />
  </g>
  ...
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="170" cy="106" r="7" />
    <polygon points="250,98 259,114 241,114" />
    <rect x="463" y="99" width="5" height="15" rx="2" />
    <rect x="472" y="99" width="5" height="15" rx="2" />
  </g>
  <circle cx="390" cy="106" r="8" fill="none" stroke="var(--ds-white)" strokeWidth="3" />
</svg>
...
`std::vector` is the default sequence container for DSA: fast indexing, compact storage, and amortized O(1) appends. Iterators mark ranges; STL algorithms operate on the half-open range `[begin, end)` — the end iterator points one past the last element, which makes empty ranges and loop bounds work out cleanly.
