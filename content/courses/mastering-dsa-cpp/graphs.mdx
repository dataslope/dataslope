...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Seven colored vertices scattered like a constellation and joined by thin solid edges into one connected graph — nodes and the relationships between them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round">
    <line x1="120" y1="70" x2="240" y2="45" />
    <line x1="240" y1="45" x2="370" y2="60" />
    <line x1="370" y1="60" x2="510" y2="50" />
    <line x1="120" y1="70" x2="180" y2="160" />
    <line x1="180" y1="160" x2="330" y2="150" />
    <line x1="240" y1="45" x2="330" y2="150" />
    <line x1="370" y1="60" x2="470" y2="160" />
    <line x1="330" y1="150" x2="470" y2="160" />
    <line x1="510" y1="50" x2="470" y2="160" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="70" r="10" />
    <circle cx="370" cy="60" r="10" />
    <circle cx="330" cy="150" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="240" cy="45" r="9" />
    <circle cx="470" cy="160" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="510" cy="50" r="9" />
...
An adjacency matrix is a `V × V` table. `matrix[u][v]` tells whether edge `u -> v` exists. It uses **O(V²)** space and supports **O(1)** edge lookup. Note how the undirected edges are written twice — `matrix[u][v]` and `matrix[v][u]` — making the matrix symmetric about its diagonal.
...
A graph is **sparse** when `E` is much smaller than `V²`. It is **dense** when the possible edges are mostly present. Almost every graph arising from the real world is sparse — road intersections connect to a handful of streets, people follow hundreds of accounts out of billions — which is why the adjacency list wins by default, and the matrix is reserved for small or genuinely dense graphs.
