...
<Figure
  slug="dsa-dynamic-programming-cutout"
  alt="A grid of small pigeonhole cells being filled one row at a time, each new cell drawing short arrows from two already-filled neighbours"
/>
...
<Figure
  slug="dsa-dynamic-programming-mindset-inline-cutout"
  alt="A wall of small pigeonholes filled left to right, each built from the two beside it rather than from scratch"
  caption="Each cell answers one subproblem, built from cells already filled."
/>
...
<Figure
  slug="dsa-dynamic-programming-fibonacci-four-ways-inline-cutout"
  alt="Four benches solving the same stack of blocks, each with visibly fewer repeated parts than the last"
  caption="The same problem, solved with less repeated work at each stage."
/>
...
<Figure
  slug="dsa-dynamic-programming-inline-cutout"
  alt="A wall of small pigeonholes being filled left to right, each new hole built from the two beside it rather than from scratch"
  caption="The table is filled once and read many times, which is the whole saving."
/>
