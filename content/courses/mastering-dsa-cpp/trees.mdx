...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A rooted tree laid over three faint level bands — a yellow root on level zero, blue inner nodes on level one, and green leaves resting on the deepest level"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="120" y="36" width="400" height="36" rx="10" opacity="0.05" />
  ...
  <g fill="currentColor" opacity="0.35">
    <circle cx="290" cy="73" r="2" />
    <circle cx="260" cy="92" r="2" />
    <circle cx="350" cy="73" r="2" />
    <circle cx="380" cy="92" r="2" />
    <circle cx="213" cy="129" r="2" />
    <circle cx="197" cy="147" r="2" />
    <circle cx="247" cy="129" r="2" />
    <circle cx="263" cy="147" r="2" />
    <circle cx="423" cy="129" r="2" />
    <circle cx="437" cy="147" r="2" />
  </g>
