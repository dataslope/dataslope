...
<Figure
  slug="dsa-recursion-call-stack-inline-cutout"
  alt="A column of trays growing as each nested job starts and unstacking from the top as each returns"
  caption="Each call stacks a frame, and returning unwinds them in reverse."
/>
...
<Figure
  slug="dsa-recursion-naive-fibonacci-inline-cutout"
  alt="A branching tree of small jobs where the same job turns up again and again on different branches"
  caption="The same subproblem is recomputed on branch after branch, which is where the time goes."
/>
...
<Figure
  ...
  caption="Recursion needs a base case, or the stack runs out before the work does."
/>
