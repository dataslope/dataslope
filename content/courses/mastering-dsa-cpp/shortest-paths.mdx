...
<Figure
  slug="dsa-shortest-paths-dijkstra-fails-inline-cutout"
  alt="Water flooding outward through a network of channels, one channel running uphill and the flood front stalling at it"
  caption="A negative edge breaks the assumption that the closest settled node is final."
/>
