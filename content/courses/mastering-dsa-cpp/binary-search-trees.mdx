...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A binary search tree of size-coded blue nodes joined by thin edges, every left child smaller, every right child larger, with the yellow comparison path descending from the root to a green target"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2.5" strokeLinecap="round">
    <line x1="320" y1="40" x2="440" y2="105" />
    <line x1="200" y1="105" x2="140" y2="170" />
    <line x1="440" y1="105" x2="380" y2="170" />
    <line x1="440" y1="105" x2="500" y2="170" />
  </g>
  <g stroke="var(--ds-yellow-500)" strokeWidth="3.5" strokeLinecap="round">
    <line x1="320" y1="40" x2="200" y2="105" />
    <line x1="200" y1="105" x2="260" y2="170" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="40" r="11" />
    <circle cx="200" cy="105" r="8" />
    <circle cx="440" cy="105" r="13" />
    <circle cx="140" cy="170" r="5" />
    <circle cx="380" cy="170" r="11" />
    <circle cx="500" cy="170" r="15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="260" cy="170" r="9" />
  </g>
</svg>
