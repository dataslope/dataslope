...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A row of bars mid bubble sort, two adjacent yellow bars are being swapped while the tallest bars already sit settled and green at the right end"
