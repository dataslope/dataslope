...
<Figure
  slug="dsa-queues-cutout"
  alt="A straight open channel with four rounded tokens queued inside, one leaving at the front and one entering at the back"
/>
...
<Figure
  slug="dsa-queues-queue-adt-inline-cutout"
  alt="A channel with an entry gate at one end and an exit gate at the other"
  caption="A queue takes at one end and gives at the other, first in first out."
/>
...
<Figure
  slug="dsa-queues-std-queue-t-inline-cutout"
  alt="A ready-made channel lifted off a shelf with its two gates already fitted"
  caption="`std::queue` is an adapter that exposes only the queue operations."
/>
...
<Figure
  slug="dsa-queues-inline-cutout"
  alt="A channel with an entry gate at one end and an exit gate at the other, blocks leaving strictly in the order they arrived"
  caption="Order of arrival is the only thing a queue promises."
/>
