...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="One cell of a memory strip is outlined in blue and expanded along thin lines into a large inset card showing its individual green and yellow bytes — C++ lets you see and control exactly how data sits in memory"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="282" y1="138" x2="212" y2="108" />
    <line x1="317" y1="138" x2="428" y2="108" />
  </g>
  <g fill="currentColor" opacity="0.14">
    <rect x="160" y="140" width="39" height="28" rx="5" />
    <rect x="200" y="140" width="39" height="28" rx="5" />
    <rect x="240" y="140" width="39" height="28" rx="5" />
    <rect x="280" y="140" width="39" height="28" rx="5" />
    <rect x="320" y="140" width="39" height="28" rx="5" />
    <rect x="360" y="140" width="39" height="28" rx="5" />
    <rect x="400" y="140" width="39" height="28" rx="5" />
    <rect x="440" y="140" width="39" height="28" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="280" y="140" width="39" height="28" rx="5" fillOpacity="0.25" />
  </g>
  <rect x="280" y="140" width="39" height="28" rx="5" fill="none" stroke="var(--ds-blue-500)" strokeWidth="2.5" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="210" y="30" width="220" height="76" rx="12" fillOpacity="0.1" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="232" y="57" width="22" height="22" rx="5" />
    <rect x="262" y="57" width="22" height="22" rx="5" />
    <rect x="292" y="57" width="22" height="22" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="330" y="57" width="22" height="22" rx="5" />
    <rect x="360" y="57" width="22" height="22" rx="5" />
    <rect x="390" y="57" width="22" height="22" rx="5" />
  </g>
</svg>
