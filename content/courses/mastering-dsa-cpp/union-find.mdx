...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two translucent sets whose members link up to their roots along thin lines merge across a thin gray arrow into one set, where the old green root now answers to the surviving blue one — union by attaching one tree under another"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g stroke="var(--ds-gray-300)" strokeWidth="2" strokeLinecap="round">
    <line x1="124" y1="114" x2="150" y2="76" />
    <line x1="172" y1="118" x2="150" y2="76" />
    <line x1="310" y1="124" x2="310" y2="80" />
    <line x1="500" y1="114" x2="530" y2="68" />
    <line x1="556" y1="108" x2="530" y2="68" />
    <line x1="548" y1="134" x2="556" y2="108" />
  </g>
  ...
  <g fill="var(--ds-gray-400)">
    <rect x="372" y="98.5" width="48" height="3" rx="1.5" />
    <polygon points="418,94.5 429,100 418,105.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
