...
<Figure
  slug="sql-what-is-a-database-stored-data-looks-like-inline-cutout"
  alt="A paragraph of writing beside the same facts ruled into a grid, with a gauge running straight down one column"
  caption="A grid makes questions answerable mechanically, which a paragraph never can be."
/>
...
INSERT INTO customers (id, name, city) VALUES
  (1, 'Ada', 'Toronto'), (2, 'Linus', 'Helsinki'), (3, 'Grace', 'New York'),
  (4, 'Mae', 'Toronto'), (5, 'Rosa', 'Madrid'), (6, 'Ivan', 'Sofia'),
  (7, 'Nadia', 'Tunis'), (8, 'Omar', 'Cairo'), (9, 'Priya', 'Mumbai'),
  (10, 'Quinn', 'London'), (11, 'Ruth', 'Cape Town'), (12, 'Sam', 'Toronto'),
  (13, 'Tariq', 'Amman'), (14, 'Uma', 'Delhi'), (15, 'Viktor', 'Prague'),
  (16, 'Wen', 'Taipei'), (17, 'Xenia', 'Athens'), (18, 'Yusuf', 'Istanbul'),
  (19, 'Zara', 'Lagos'), (20, 'Bruno', 'Sao Paulo'), (21, 'Chidi', 'Lagos'),
  (22, 'Dara', 'Dublin'), (23, 'Elif', 'Izmir'), (24, 'Farid', 'Rabat');`}
  starterCode={`SELECT
  *
FROM
  customers;`}
...
<Figure
  slug="sql-what-is-a-database-where-database-hides-app-inline-cutout"
  alt="A shopfront with a hatch at the back through which every order and answer quietly passes"
  caption="Every tap in the app is a query; the database is the part you never see."
/>
...
<Figure
  slug="sql-what-is-a-database-tiny-mental-model-carry-inline-cutout"
  alt="A cabinet of ruled drawers standing behind a shopfront, the two speaking through a single hatch"
  caption="The app is not the database; it talks to one through a narrow, well-defined opening."
/>
