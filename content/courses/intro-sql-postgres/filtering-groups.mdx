...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A bar chart of group totals measured against a thin yellow threshold line — only the groups whose summary clears the line stay colored"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="120" y="190" width="400" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="132" y="70" width="56" height="110" rx="8" fillOpacity="0.8" />
    <rect x="292" y="50" width="56" height="130" rx="8" fillOpacity="0.8" />
    <rect x="452" y="95" width="56" height="85" rx="8" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="212" y="120" width="56" height="60" rx="8" />
    <rect x="372" y="140" width="56" height="40" rx="8" />
  </g>
