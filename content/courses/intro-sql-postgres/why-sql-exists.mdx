...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A sturdy three-step stack of blue slabs, darkest at the base, carrying small green and yellow data dots on top, PostgreSQL as a dependable foundation"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="190" y="196" width="260" height="3" rx="1.5" fill="var(--ds-gray-300)" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="200" y="152" width="240" height="40" rx="12" fillOpacity="0.85" />
    <rect x="224" y="112" width="192" height="36" rx="11" fillOpacity="0.6" />
    <rect x="248" y="76" width="144" height="32" rx="10" fillOpacity="0.35" />
  </g>
  <circle cx="288" cy="62" r="7" fill="var(--ds-green-500)" />
  <circle cx="320" cy="54" r="7" fill="var(--ds-yellow-500)" />
  <circle cx="352" cy="62" r="7" fill="var(--ds-green-500)" fillOpacity="0.8" />
</svg>
