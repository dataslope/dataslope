...
<Figure
  slug="sql-why-sql-exists-cutout"
  alt="Why SQL and why PostgreSQL, an isometric illustration"
/>
...
<Figure
  ...
  alt="A nameplate filed blank on a working machine while a second, smaller workshop builds from its published drawings"
  caption="IBM published the papers; a small California company shipped the product first."
/>
...
<Figure
  slug="sql-why-sql-exists-1970-codd-s-inline-cutout"
  alt="A plain bound paper open on a bench beside a wall of welded pipes, the pipes being cut away"
  caption="SQL lets you state the result you want instead of the steps to get it."
/>
...
INSERT INTO products (name, price) VALUES
  ('Keyboard', 80), ('Monitor', 300), ('Mouse', 25), ('Desk', 220),
  ('Lamp', 45), ('Headphones', 130), ('Webcam', 65), ('Microphone', 95),
  ('Docking station', 180), ('Laptop stand', 40), ('USB hub', 30),
  ('External drive', 110), ('Chair', 260), ('Footrest', 35),
  ('Monitor arm', 90), ('Cable tray', 20), ('Desk mat', 28),
  ('Wrist rest', 15), ('Graphics tablet', 150), ('Label printer', 75),
  ('Router', 120), ('Surge protector', 22), ('Whiteboard', 55),
  ('Bookshelf', 140);`}
  starterCode={`SELECT
  name,
  price
...
<Figure
  slug="sql-why-sql-exists-postgres-cutout"
  alt="Two database drums on a bench, the second larger and fitted with extra parts, a figure adding one more"
  caption="Berkeley, 1986: Ingres was finished, so Stonebraker started the successor and called it post-Ingres."
/>
