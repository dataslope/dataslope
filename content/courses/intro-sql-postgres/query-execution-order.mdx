...
<Figure
  ...
  alt="Six machines standing in a row along a bench with one thick coloured cord threading between them out of order, entering at a machine in the middle, doubling back to the first, and leaving from the last"
