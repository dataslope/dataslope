...
<Figure
  ...
  alt="A numbered chain of six machines along a bench, the parcel entering at a middle machine rather than the first, and the numbers showing the true running order"
/>
