...
A junction table is the shape you will recognise everywhere once you
know it: tags on posts, students in courses, actors in films, users in
teams. Whenever two things relate many-to-many, look for the table in
between.
