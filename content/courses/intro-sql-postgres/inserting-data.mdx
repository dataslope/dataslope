...
<Figure
  slug="sql-inserting-data-cutout"
  alt="Inserting, updating, and deleting data, an isometric illustration"
/>
...
INSERT INTO tasks (title, done) VALUES
  ...
  ('Pay rent', true),
  ('Call plumber', false),
  ('Return library books', true),
  ('Fix bike tyre', false),
  ('Send invoice', true),
  ('Order printer ink', false),
  ('Clean gutters', false),
  ('File tax return', true),
  ('Buy birthday card', false),
  ('Cancel free trial', false),
  ('Update CV', true),
  ('Back up laptop', false),
  ('Post parcel', true),
  ('Book train tickets', false),
  ('Replace smoke alarm', false),
  ('Email landlord', true),
  ('Sort recycling', false),
  ('Photograph receipts', false),
  ('Defrost freezer', false);`}
...
<Figure
  slug="sql-inserting-data-inline-cutout"
  alt="A fresh row of blocks slid into an open board, taking its place at the bottom of the rows already there"
  caption="`UPDATE` changes the rows its `WHERE` selects, and no others."
/>
...
<Figure
  slug="sql-inserting-data-insert-adding-rows-inline-cutout"
  alt="A fresh row of blocks slid into the open end of a board already holding rows"
  caption="`INSERT` adds a row; the columns were decided when the table was created."
/>
