...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Many rows of dots pour into a funnel and come out as one large summary dot, an aggregate boils a whole column down to a single value"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="230" cy="30" r="7" />
    <circle cx="310" cy="30" r="7" fillOpacity="0.7" />
    <circle cx="390" cy="30" r="7" />
    <circle cx="270" cy="56" r="7" fillOpacity="0.7" />
    <circle cx="350" cy="56" r="7" />
    <circle cx="430" cy="56" r="7" fillOpacity="0.7" />
    <circle cx="250" cy="82" r="7" />
    <circle cx="330" cy="82" r="7" fillOpacity="0.7" />
    <circle cx="410" cy="82" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="270" cy="30" r="7" fillOpacity="0.8" />
    <circle cx="350" cy="30" r="7" />
    <circle cx="430" cy="30" r="7" fillOpacity="0.8" />
    <circle cx="230" cy="56" r="7" />
    <circle cx="310" cy="56" r="7" fillOpacity="0.8" />
    <circle cx="390" cy="56" r="7" />
    <circle cx="290" cy="82" r="7" fillOpacity="0.8" />
    <circle cx="370" cy="82" r="7" />
    <circle cx="430" cy="82" r="7" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="210,100 430,100 336,172 304,172" fillOpacity="0.12" />
  </g>
