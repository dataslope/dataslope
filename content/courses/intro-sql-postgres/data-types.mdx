...
INSERT INTO products (id, name, price, in_stock, added_on) VALUES
  ...
  (3, 'Mouse', 24.50, true, '2026-01-12'),
  (4, 'Desk', 219.00, true, '2026-02-14'),
  (5, 'Lamp', 45.00, false, '2026-01-23'),
  (6, 'Headphones', 129.99, true, '2026-03-01'),
  (7, 'Webcam', 64.95, true, '2026-02-19'),
  (8, 'Microphone', 94.50, false, '2026-03-07'),
  (9, 'Docking station', 179.00, true, '2026-01-30'),
  (10, 'Laptop stand', 39.99, true, '2026-02-05'),
  (11, 'USB hub', 29.95, false, '2026-03-11'),
  (12, 'External drive', 109.00, true, '2026-01-17'),
  (13, 'Chair', 259.00, true, '2026-02-26'),
  (14, 'Footrest', 34.50, false, '2026-03-15'),
  (15, 'Monitor arm', 89.99, true, '2026-01-08'),
  (16, 'Cable tray', 19.95, true, '2026-02-11'),
  (17, 'Desk mat', 27.50, true, '2026-03-19'),
  (18, 'Wrist rest', 14.99, false, '2026-01-27'),
  (19, 'Graphics tablet', 149.00, true, '2026-02-08'),
  (20, 'Label printer', 74.95, true, '2026-03-23'),
  (21, 'Router', 119.00, false, '2026-01-14'),
  (22, 'Surge protector', 21.99, true, '2026-02-22'),
  (23, 'Whiteboard', 54.50, true, '2026-03-04'),
  (24, 'Bookshelf', 139.00, false, '2026-01-20');`}
  starterCode={`SELECT
  name,
  price,
