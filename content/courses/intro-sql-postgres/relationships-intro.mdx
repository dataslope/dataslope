...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two table cards drift together like puzzle pieces, the knob on one carries a shared value dot that fits the notch waiting in the other"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M134 60 H276 Q290 60 290 74 V94 A16 16 0 0 1 290 126 V146 Q290 160 276 160 H134 Q120 160 120 146 V74 Q120 60 134 60 Z" fillOpacity="0.15" />
    <rect x="134" y="74" width="100" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M364 60 H536 Q550 60 550 74 V146 Q550 160 536 160 H364 Q350 160 350 146 V126 A16 16 0 0 0 350 94 V74 Q350 60 364 60 Z" fillOpacity="0.15" />
    <rect x="374" y="74" width="100" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="134" y="96" width="76" height="7" rx="3.5" />
    <rect x="134" y="110" width="58" height="7" rx="3.5" />
    <rect x="374" y="128" width="76" height="7" rx="3.5" />
    <rect x="374" y="142" width="58" height="7" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="296" cy="110" r="7" />
    <circle cx="366" cy="110" r="7" fillOpacity="0.35" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="318" cy="110" r="3" />
    <circle cx="330" cy="110" r="3" />
    <circle cx="342" cy="110" r="3" />
  </g>
</svg>
