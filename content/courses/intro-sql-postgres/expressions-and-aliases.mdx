...
<Figure
  ...
  caption="A calculated column is computed per row and stored nowhere."
/>
...
INSERT INTO people (first, last) VALUES
  ...
  ('Frances', 'Allen'), ('John', 'McCarthy'), ('Katherine', 'Johnson'),
  ('Dennis', 'Ritchie'), ('Radia', 'Perlman'), ('Ken', 'Thompson'),
  ('Adele', 'Goldberg'), ('Tony', 'Hoare'), ('Jean', 'Bartik'),
  ('Vint', 'Cerf'), ('Shafi', 'Goldwasser'), ('Leslie', 'Lamport'),
  ('Karen', 'Sparck Jones'), ('Peter', 'Naur'), ('Mary', 'Wilkes'),
  ('Niklaus', 'Wirth'), ('Sophie', 'Wilson'), ('Alan', 'Kay');`}
  starterCode={`SELECT
...
ORDER BY
  ...
  tests={[
    ...
    },
    {
      ...
      description: "Hot chocolate (24.00) first, down to Water (1.00).",
...
Everything on this page was computed rather than stored. That
distinction matters more than it first appears: a derived column is
always correct, where a stored copy of the same number can drift out of
date.
