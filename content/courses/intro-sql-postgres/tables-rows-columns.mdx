...
<Figure
  slug="sql-tables-rows-columns-three-words-inline-cutout"
  alt="One ruled board with one row drawn out sideways and one column lifted straight up"
  caption="A row is one record; a column is one fact about every record."
/>
...
<Figure
  ...
  caption="Table, row and column are the three words the rest of SQL is built on."
/>
...
INSERT INTO students (id, name, grade, gpa) VALUES
  (1, 'Ana', 9, 3.8), (2, 'Ben', 10, 3.4), (3, 'Cara', 11, 2.9),
  (4, 'Dev', 9, 3.1), (5, 'Elle', 12, 3.9), (6, 'Finn', 10, 2.7),
  (7, 'Gia', 11, 3.6), (8, 'Hugo', 12, 3.2), (9, 'Iris', 9, 2.5),
  (10, 'Jonas', 10, 3.7), (11, 'Kira', 11, 3.3), (12, 'Leo', 12, 2.8),
  (13, 'Mona', 9, 3.5), (14, 'Nils', 10, 3.0), (15, 'Otto', 11, 2.6),
  (16, 'Pia', 12, 3.85), (17, 'Quinn', 9, 3.25), (18, 'Rui', 10, 2.95),
  (19, 'Sara', 11, 3.45), (20, 'Theo', 12, 3.05), (21, 'Ulla', 9, 2.4),
  (22, 'Vik', 10, 3.75), (23, 'Wanda', 11, 3.15), (24, 'Yara', 12, 3.55);`}
  starterCode={`SELECT
  *
FROM
  students;`}
