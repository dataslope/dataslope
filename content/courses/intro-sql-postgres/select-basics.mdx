...
<Figure
  slug="sql-select-basics-choosing-columns-inline-cutout"
  alt="A wide board with three of its columns copied onto a smaller board, the original untouched"
  caption="`SELECT` chooses columns; every row still comes back until you filter."
/>
