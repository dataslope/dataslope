...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two translucent stencil windows laid over a faint table reveal only the chosen columns, whose value dots show in full color"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.06">
    <rect x="152" y="44" width="96" height="26" rx="6" />
    <rect x="264" y="44" width="96" height="26" rx="6" />
    <rect x="376" y="44" width="96" height="26" rx="6" />
    <rect x="488" y="44" width="96" height="26" rx="6" />
    <rect x="152" y="80" width="96" height="26" rx="6" />
    <rect x="264" y="80" width="96" height="26" rx="6" />
    <rect x="376" y="80" width="96" height="26" rx="6" />
    <rect x="488" y="80" width="96" height="26" rx="6" />
    <rect x="152" y="116" width="96" height="26" rx="6" />
    <rect x="264" y="116" width="96" height="26" rx="6" />
    <rect x="376" y="116" width="96" height="26" rx="6" />
    <rect x="488" y="116" width="96" height="26" rx="6" />
    <rect x="152" y="152" width="96" height="26" rx="6" />
    <rect x="264" y="152" width="96" height="26" rx="6" />
    <rect x="376" y="152" width="96" height="26" rx="6" />
    <rect x="488" y="152" width="96" height="26" rx="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="144" y="32" width="112" height="156" rx="12" fillOpacity="0.14" />
    <rect x="368" y="32" width="112" height="156" rx="12" fillOpacity="0.14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="200" cy="57" r="6" />
    <circle cx="200" cy="165" r="6" />
    <circle cx="424" cy="129" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="200" cy="93" r="6" />
    <circle cx="424" cy="57" r="6" />
    <circle cx="424" cy="165" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="200" cy="129" r="6" />
    <circle cx="424" cy="93" r="6" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <circle cx="312" cy="57" r="5" />
    <circle cx="312" cy="93" r="5" />
    <circle cx="312" cy="129" r="5" />
    <circle cx="312" cy="165" r="5" />
    <circle cx="536" cy="57" r="5" />
    <circle cx="536" cy="93" r="5" />
    <circle cx="536" cy="129" r="5" />
    <circle cx="536" cy="165" r="5" />
  </g>
</svg>
