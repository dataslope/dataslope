...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three equality tests: two known dots agree with a green check, but once a hazy unknown value is involved every answer becomes a yellow question mark"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="300" cy="110" r="10" fillOpacity="0.25" />
    <circle cx="300" cy="110" r="6" fillOpacity="0.35" />
    <circle cx="180" cy="170" r="14" fillOpacity="0.15" />
    <circle cx="180" cy="170" r="10" fillOpacity="0.25" />
    <circle cx="180" cy="170" r="6" fillOpacity="0.35" />
    <circle cx="300" cy="170" r="14" fillOpacity="0.15" />
    <circle cx="300" cy="170" r="10" fillOpacity="0.25" />
    <circle cx="300" cy="170" r="6" fillOpacity="0.35" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="350" cy="50" r="3" />
    <circle cx="370" cy="50" r="3" />
    <circle cx="390" cy="50" r="3" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="440" cy="50" r="12" />
  </g>
  <g style={{ color: "var(--ds-white)" }}>
    <polyline points="434.5,50.5 438.5,54.5 446,44.5" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
