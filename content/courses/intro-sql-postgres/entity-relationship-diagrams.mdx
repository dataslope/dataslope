...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A miniature Chen-style diagram: two entity boxes joined through a yellow relationship diamond by thin lines, with attribute circles hanging off each entity, the blueprint of a database"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M222 110 H 243" />
    <path d="M347 110 H 416" />
    <path d="M120 52 L 142 78" />
    <path d="M164 46 L 160 76" />
    <path d="M474 50 L 466 76" />
    <path d="M520 58 L 500 80" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="80" width="130" height="60" rx="8" fillOpacity="0.6" />
    <circle cx="114" cy="44" r="9" fillOpacity="0.55" />
    <circle cx="166" cy="36" r="9" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="295,85 347,110 295,135 243,110" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="418" y="80" width="130" height="60" rx="8" fillOpacity="0.6" />
    <circle cx="478" cy="42" r="9" fillOpacity="0.55" />
    <circle cx="524" cy="50" r="9" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="106" y="102" width="70" height="8" rx="4" />
    <rect x="106" y="118" width="52" height="8" rx="4" />
    <rect x="434" y="102" width="70" height="8" rx="4" />
    <rect x="434" y="118" width="52" height="8" rx="4" />
  </g>
</svg>
