...
vectors capturing analogies like $\text{king} - \text{man} + \text{woman} \approx \text{queen}$.
...
It helps to see what the pre-embedding baseline could and could not do,
...
Top-k and top-p are the two truncation rules, and they diverge exactly
