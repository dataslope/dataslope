...
Why a stage costs its slowest task rather than its average one: a small
per-task chance of being slow becomes near-certainty once there are
enough tasks to wait for.
