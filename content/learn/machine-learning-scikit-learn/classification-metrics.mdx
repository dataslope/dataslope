...
<svg
  viewBox="0 0 640 215"
  role="img"
  aria-label="A two-by-two confusion matrix: green diagonal cells collect the correct predictions while a few red dots sit in the faint off-diagonal cells — the four outcomes hiding behind every accuracy number"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="235" y="12" width="40" height="8" rx="4" />
    <rect x="375" y="12" width="40" height="8" rx="4" />
    <rect x="168" y="55" width="8" height="32" rx="4" />
    <rect x="168" y="145" width="8" height="32" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="190" y="30" width="130" height="80" rx="12" fillOpacity="0.18" />
    <rect x="330" y="120" width="130" height="80" rx="12" fillOpacity="0.18" />
    <circle cx="215" cy="55" r="6" />
    <circle cx="245" cy="70" r="6" />
    <circle cx="275" cy="50" r="6" />
    <circle cx="300" cy="68" r="6" />
    <circle cx="230" cy="90" r="6" />
    <circle cx="360" cy="150" r="6" />
    <circle cx="390" cy="140" r="6" />
    <circle cx="420" cy="165" r="6" />
    <circle cx="440" cy="142" r="6" />
  </g>
  <g fill="currentColor" opacity="0.06">
    <rect x="330" y="30" width="130" height="80" rx="12" />
    <rect x="190" y="120" width="130" height="80" rx="12" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="370" cy="60" r="6" />
    <circle cx="415" cy="82" r="6" />
    <circle cx="240" cy="165" r="6" />
  </g>
</svg>

## The accuracy trap

Imagine a disease that affects 2% of patients. Build a "model" that ignores
its inputs and predicts "healthy" for everyone. Its accuracy? 98%. It is
also completely worthless — it never catches a single sick patient. Let us
watch this happen for real.
...
# An imbalanced problem: only ~8% of cases are the positive class (1).
X, y = make_classification(
    n_samples=1000, n_features=8, weights=[0.92, 0.08], random_state=0
)
X_train, X_test, y_train, y_test = train_test_split(
    X, y, test_size=0.3, random_state=0, stratify=y
)

# A model that ALWAYS predicts the majority class "0".
dummy = DummyClassifier(strategy="most_frequent").fit(X_train, y_train)
y_pred = dummy.predict(X_test)

print(f"Accuracy: {accuracy_score(y_test, y_pred):.1%}")
print(f"Recall on the positive class: {recall_score(y_test, y_pred):.1%}")
print("Positives it actually caught:", int((y_pred[y_test == 1] == 1).sum()))
`,
    },
  ]}
/>

Over 90% accuracy, and it caught **zero** positive cases. The accuracy is
high only because the negative class is huge and easy. On any problem where
the rare class is the one you care about — fraud, disease, defaults,
...
print("                 pred 0   pred 1")
print(f"  actual 0 (neg)   {cm[0, 0]:4d}     {cm[0, 1]:4d}")
print(f"  actual 1 (pos)   {cm[1, 0]:4d}     {cm[1, 1]:4d}")
print()
