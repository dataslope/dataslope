...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A dotted trail climbs through four stations — a blue data dot with satellites, a split pair, a yellow training ring, and a green check — load, split, train, evaluate"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="125" cy="143" r="3" />
    <circle cx="155" cy="136" r="3" />
    <circle cx="185" cy="129" r="3" />
    <circle cx="285" cy="114" r="3" />
    <circle cx="315" cy="108" r="3" />
    <circle cx="345" cy="102" r="3" />
    <circle cx="425" cy="90" r="3" />
    <circle cx="455" cy="86" r="3" />
    <circle cx="485" cy="81" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="90" cy="150" r="18" />
    <circle cx="66" cy="130" r="5" fillOpacity="0.5" />
    <circle cx="114" cy="172" r="5" fillOpacity="0.5" />
    <circle cx="228" cy="120" r="13" />
    <circle cx="257" cy="120" r="9" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="390" cy="95" r="17" fillOpacity="0.3" />
    <circle cx="390" cy="95" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="540" cy="75" r="19" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="530,76 537,83 551,64 555,67 537,90 526,80" />
  </g>
</svg>
...
print(
    "New flower predicted as:", load_iris().target_names[model.predict(new_flower)[0]]
)
`,
    },
  ]}
