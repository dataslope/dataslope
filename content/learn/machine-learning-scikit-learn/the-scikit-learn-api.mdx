...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Three differently shaped machines all carry the same three colored buttons in the same place — every scikit-learn estimator exposes the same fit, predict, and score controls"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.1">
    <rect x="105" y="50" width="110" height="100" rx="20" />
    <circle cx="320" cy="100" r="55" />
    <polygon points="538,100 509,50 451,50 422,100 451,150 509,150" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="136" cy="92" r="7" />
    <circle cx="296" cy="92" r="7" />
    <circle cx="456" cy="92" r="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="160" cy="92" r="7" />
    <circle cx="320" cy="92" r="7" />
    <circle cx="480" cy="92" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="184" cy="92" r="7" />
    <circle cx="344" cy="92" r="7" />
    <circle cx="504" cy="92" r="7" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="138" y="116" width="44" height="6" rx="3" />
    <rect x="298" y="116" width="44" height="6" rx="3" />
    <rect x="458" y="116" width="44" height="6" rx="3" />
  </g>
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `from sklearn.datasets import make_regression, load_iris, make_blobs
...
print("Most likely class:           ", data.target_names[proba.argmax()])
`,
    },
  ]}
/>
