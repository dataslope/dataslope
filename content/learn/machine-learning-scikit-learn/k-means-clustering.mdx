...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three star centroids in blue, green, and yellow each tug nearby dots along faint dotted trails, one dot still migrating between groups — k-means alternates assigning points and moving centers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="170,66 175.5,74.5 184,80 175.5,85.5 170,94 164.5,85.5 156,80 164.5,74.5" />
    <circle cx="105" cy="55" r="7" fillOpacity="0.75" />
    <circle cx="120" cy="125" r="7" fillOpacity="0.75" />
    <circle cx="225" cy="50" r="7" fillOpacity="0.75" />
    <circle cx="245" cy="105" r="7" fillOpacity="0.75" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="430,56 435.5,64.5 444,70 435.5,75.5 430,84 424.5,75.5 416,70 424.5,64.5" />
    <circle cx="370" cy="40" r="7" fillOpacity="0.75" />
    <circle cx="495" cy="50" r="7" fillOpacity="0.75" />
    <circle cx="505" cy="110" r="7" fillOpacity="0.75" />
    <circle cx="390" cy="115" r="7" fillOpacity="0.75" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="310,151 315.5,159.5 324,165 315.5,170.5 310,179 304.5,170.5 296,165 304.5,159.5" />
    <circle cx="255" cy="190" r="7" fillOpacity="0.75" />
    <circle cx="365" cy="190" r="7" fillOpacity="0.75" />
    <circle cx="305" cy="210" r="7" fillOpacity="0.75" />
    <circle cx="350" cy="140" r="7" fillOpacity="0.75" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="220" cy="97" r="2.5" />
    <circle cx="196" cy="89" r="2.5" />
    <circle cx="127" cy="63" r="2.5" />
    <circle cx="149" cy="71" r="2.5" />
    <circle cx="480" cy="97" r="2.5" />
    <circle cx="455" cy="84" r="2.5" />
    <circle cx="390" cy="50" r="2.5" />
    <circle cx="410" cy="60" r="2.5" />
    <circle cx="337" cy="148" r="2.5" />
    <circle cx="324" cy="156" r="2.5" />
    <circle cx="273" cy="182" r="2.5" />
    <circle cx="291" cy="174" r="2.5" />
  </g>
</svg>
  ...
  tests={[
    {
      ...
      description: "Scaling preserves the 300x2 shape",
      code: `import numpy as np
assert X_scaled is not None, "X_scaled is still None"
assert np.asarray(X_scaled).shape == (300, 2), f"Expected (300, 2), got {np.asarray(X_scaled).shape}"`,
    },
    {
      id: "is_standardized",
...
assert len(labels) == 300, f"Expected 300 labels, got {len(labels)}"`,
    },
    {
      id: "sizes_sum",
      name: "Cluster sizes are correct",
      description: "Sizes are sorted ascending and sum to 300",
      code: `import numpy as np
cs = np.asarray(cluster_sizes)
assert cs.sum() == 300, f"Sizes should sum to 300, got {cs.sum()}"
