...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Layered translucent mountains with a dotted path climbing the tallest peak toward a small green flag, taller faint peaks waiting beyond — the course ends where the real climb begins"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="40,190 190,60 340,190" fillOpacity="0.1" />
    <polygon points="400,190 500,90 600,190" fillOpacity="0.12" />
    <polygon points="180,190 330,40 480,190" fillOpacity="0.22" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="40" y="190" width="560" height="4" rx="2" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="250" cy="182" r="3" />
    <circle cx="268" cy="166" r="3" />
    <circle cx="286" cy="150" r="3" />
    <circle cx="300" cy="132" r="3" />
    <circle cx="312" cy="112" r="3" />
    <circle cx="322" cy="90" r="3" />
    <circle cx="330" cy="68" r="3" />
  </g>
  <g fill="currentColor" opacity="0.5">
    <rect x="328" y="22" width="4" height="26" rx="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="332,22 356,29 332,36" />
    <circle cx="300" cy="132" r="7" />
  </g>
</svg>
...
<ChallengeCard
  ...
  instructions={`Pull together everything the course taught. The wine data is
loaded as \`X\`, \`y\`.
...
assert isinstance(pipe.named_steps["model"], RandomForestClassifier), "Step 'model' should be a RandomForestClassifier"`,
    },
    {
      ...
      code: `assert cv_mean is not None and 0.8 <= cv_mean <= 1.0, f"cv_mean {cv_mean} is not a believable accuracy"`,
    },
    {
      id: "test_valid",
