...
<svg
  viewBox="0 0 640 224"
  role="img"
  aria-label="A spiral of dots circles inward, growing larger and bolder with every pass, until it lands on the bright unexpected point at the center — plot, notice, sharpen, plot again"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="32" r="3.2" fillOpacity="0.22" />
    <circle cx="391" cy="67" r="3.5" fillOpacity="0.29" />
    <circle cx="400" cy="128" r="3.7" fillOpacity="0.35" />
    <circle cx="351" cy="168" r="4" fillOpacity="0.42" />
    <circle cx="288" cy="161" r="4.2" fillOpacity="0.48" />
    <circle cx="260" cy="121" r="4.5" fillOpacity="0.55" />
    <circle cx="280" cy="82" r="4.7" fillOpacity="0.61" />
    <circle cx="323" cy="74" r="5" fillOpacity="0.68" />
    <circle cx="353" cy="94" r="5.2" fillOpacity="0.74" />
    <circle cx="351" cy="120" r="5.5" fillOpacity="0.8" />
    <circle cx="329" cy="131" r="5.7" fillOpacity="0.87" />
    <circle cx="305" cy="122" r="6" fillOpacity="0.94" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="319" cy="110" r="13" fillOpacity="0.25" />
    <circle cx="319" cy="110" r="7" />
  </g>
</svg>
