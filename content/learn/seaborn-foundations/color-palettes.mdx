...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three fans of translucent swatch blades: one deepening through shades of a single blue, one passing from red through neutral to green, and one spreading four distinct hues — sequential, diverging, and categorical palettes"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="127" y="94" width="26" height="88" rx="13" fillOpacity="0.15" transform="rotate(-50 140 190)" />
    <rect x="127" y="94" width="26" height="88" rx="13" fillOpacity="0.32" transform="rotate(-25 140 190)" />
    <rect x="127" y="94" width="26" height="88" rx="13" fillOpacity="0.5" />
    <rect x="127" y="94" width="26" height="88" rx="13" fillOpacity="0.72" transform="rotate(25 140 190)" />
    <rect x="127" y="94" width="26" height="88" rx="13" transform="rotate(50 140 190)" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="307" y="94" width="26" height="88" rx="13" fillOpacity="0.8" transform="rotate(-50 320 190)" />
    <rect x="307" y="94" width="26" height="88" rx="13" fillOpacity="0.35" transform="rotate(-25 320 190)" />
  </g>
  <rect x="307" y="94" width="26" height="88" rx="13" fill="currentColor" opacity="0.18" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="307" y="94" width="26" height="88" rx="13" fillOpacity="0.35" transform="rotate(25 320 190)" />
    <rect x="307" y="94" width="26" height="88" rx="13" fillOpacity="0.8" transform="rotate(50 320 190)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="487" y="94" width="26" height="88" rx="13" fillOpacity="0.85" transform="rotate(-45 500 190)" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="487" y="94" width="26" height="88" rx="13" fillOpacity="0.85" transform="rotate(-15 500 190)" />
  </g>
  ...
  <g fill="currentColor" opacity="0.45">
    <circle cx="140" cy="190" r="4.5" />
    <circle cx="320" cy="190" r="4.5" />
