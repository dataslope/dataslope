...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="The same little bar chart drawn three times along one baseline, each version larger and chunkier than the last — a single context dial scaling every bar, marker, and gap from paper to notebook to poster"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="190" width="500" height="5" rx="2.5" fill="currentColor" opacity="0.3" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="160" width="12" height="30" rx="3" fillOpacity="0.85" />
    <rect x="108" y="136" width="12" height="54" rx="3" fillOpacity="0.85" />
    <rect x="126" y="150" width="12" height="40" rx="3" fillOpacity="0.85" />
    <rect x="220" y="145" width="18" height="45" rx="4" fillOpacity="0.85" />
    <rect x="247" y="109" width="18" height="81" rx="4" fillOpacity="0.85" />
    <rect x="274" y="130" width="18" height="60" rx="4" fillOpacity="0.85" />
    <rect x="400" y="130" width="28" height="60" rx="6" fillOpacity="0.85" />
    <rect x="442" y="82" width="28" height="108" rx="6" fillOpacity="0.85" />
    <rect x="484" y="110" width="28" height="80" rx="6" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="114" cy="126" r="2.5" />
    <circle cx="256" cy="97" r="4" />
    <circle cx="456" cy="66" r="6" />
  </g>
</svg>
