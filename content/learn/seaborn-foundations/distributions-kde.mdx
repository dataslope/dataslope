...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two smooth translucent density humps overlap above one shared baseline, each crest marked with a dot and each group's rug ticks clustered below — comparing two distributions where bars would collide"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="172" width="500" height="5" rx="2.5" fill="currentColor" opacity="0.3" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M 90 172 C 170 172 180 56 268 56 C 356 56 366 172 446 172 Z" fillOpacity="0.35" />
    <circle cx="268" cy="52" r="5" />
    <rect x="228" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="246" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="262" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="277" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="296" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M 218 172 C 294 172 304 80 384 80 C 464 80 474 172 550 172 Z" fillOpacity="0.35" />
    <circle cx="384" cy="76" r="5" />
    <rect x="352" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="370" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="387" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="404" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
    <rect x="424" y="184" width="3" height="11" rx="1.5" fillOpacity="0.6" />
  </g>
</svg>
