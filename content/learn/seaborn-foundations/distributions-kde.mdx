...
sns.displot(data=penguins, x="flipper_length_mm", kde=True, bins=20, height=4, aspect=1.3)
`}
/>
...
sns.displot(
    data=penguins, x="flipper_length_mm", kind="kde",
...
sns.displot(
    ...
    kind="kde", fill=True,   # fill=True shades under each curve
    height=4, aspect=1.4,
)
`}
/>
