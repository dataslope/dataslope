...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Above, dots rest at measured positions anywhere along one continuous ruler; below, dots live inside three separate colored buckets — a number on a scale versus a label naming a group"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="80" y="68" width="480" height="5" rx="2.5" fill="currentColor" opacity="0.3" />
  <g fill="currentColor" opacity="0.25">
    <rect x="110" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="170" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="230" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="290" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="350" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="410" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="470" y="78" width="2.5" height="8" rx="1.25" />
    <rect x="530" y="78" width="2.5" height="8" rx="1.25" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="123" cy="58" r="5.5" />
    <circle cx="186" cy="58" r="5.5" />
    <circle cx="207" cy="58" r="5.5" />
    <circle cx="333" cy="58" r="5.5" />
    <circle cx="421" cy="58" r="5.5" />
    <circle cx="544" cy="58" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="115" y="128" width="110" height="62" rx="13" fillOpacity="0.14" />
    <circle cx="150" cy="160" r="5.5" />
    <circle cx="172" cy="170" r="5.5" />
    <circle cx="188" cy="150" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="265" y="128" width="110" height="62" rx="13" fillOpacity="0.14" />
    <circle cx="296" cy="152" r="5.5" />
    <circle cx="318" cy="168" r="5.5" />
    <circle cx="336" cy="148" r="5.5" />
    <circle cx="322" cy="142" r="5.5" />
    <circle cx="346" cy="170" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="415" y="128" width="110" height="62" rx="13" fillOpacity="0.14" />
    <circle cx="455" cy="162" r="5.5" />
    <circle cx="482" cy="152" r="5.5" />
  </g>
</svg>
