...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A cluttered wall of single-purpose chart widgets — scatter, bars, line, pie, area, boxplot, histogram, lollipop — and a red question-mark box for the chart no function covers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="40" y="28" width="90" height="62" rx="9" opacity="0.08" />
    <rect x="146" y="40" width="86" height="56" rx="9" opacity="0.08" />
    <rect x="248" y="24" width="92" height="64" rx="9" opacity="0.08" />
    <rect x="356" y="38" width="88" height="58" rx="9" opacity="0.08" />
    <rect x="60" y="108" width="86" height="60" rx="9" opacity="0.08" />
    <rect x="162" y="120" width="90" height="56" rx="9" opacity="0.08" />
    <rect x="268" y="106" width="88" height="62" rx="9" opacity="0.08" />
    <rect x="372" y="118" width="86" height="56" rx="9" opacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="60" cy="70" r="5" />
    <circle cx="85" cy="48" r="5" />
    <circle cx="108" cy="60" r="5" />
    <circle cx="262" cy="74" r="3" />
    <circle cx="278" cy="66" r="3" />
    <circle cx="294" cy="58" r="3" />
    <circle cx="310" cy="62" r="3" />
    <circle cx="326" cy="48" r="3" />
    <circle cx="400" cy="66" r="20" fillOpacity="0.3" />
    <rect x="280" y="142" width="16" height="18" fillOpacity="0.35" />
    <rect x="298" y="126" width="16" height="34" fillOpacity="0.6" />
    <rect x="316" y="116" width="16" height="44" fillOpacity="0.85" />
    <rect x="334" y="134" width="16" height="26" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="158" y="70" width="14" height="22" rx="3" />
    <rect x="180" y="58" width="14" height="34" rx="3" />
    <rect x="202" y="76" width="14" height="16" rx="3" />
    <path d="M400,66 L400,46 A20 20 0 0 1 418,74 Z" />
    <polygon points="72,158 72,142 96,124 118,134 134,120 134,158" fillOpacity="0.45" />
    <rect x="396" y="138" width="5" height="28" rx="2.5" fillOpacity="0.5" />
    <rect x="424" y="128" width="5" height="38" rx="2.5" fillOpacity="0.5" />
    <circle cx="398.5" cy="132" r="6" />
    <circle cx="426.5" cy="122" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="202" y="124" width="4" height="14" rx="2" fillOpacity="0.5" />
    <rect x="188" y="138" width="32" height="18" rx="3" fillOpacity="0.5" />
    <rect x="188" y="145" width="32" height="4" />
    <rect x="202" y="156" width="4" height="12" rx="2" fillOpacity="0.5" />
  </g>
