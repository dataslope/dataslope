...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three numbered translucent panels overlap in draw order — points, then a trend, then styling — each painted over the previous, with an upward arrow marking the stacking direction"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="30" width="200" height="130" rx="14" fillOpacity="0.3" />
  ...
  <g fill="currentColor" opacity="0.35">
    ...
    <circle cx="560" cy="128" r="3" />
    <circle cx="560" cy="106" r="3" />
    <polygon points="552,96 568,96 560,80" />
  </g>
</svg>
