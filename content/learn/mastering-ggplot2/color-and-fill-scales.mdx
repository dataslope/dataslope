...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A legend sidebar with three colored keys tethered by dotted leaders to their matching dots inside the chart — every legend is a color scale showing its work"
...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="428" cy="72" r="2.5" fillOpacity="0.45" />
    <circle cx="380" cy="92" r="2.5" fillOpacity="0.45" />
    <circle cx="330" cy="112" r="2.5" fillOpacity="0.45" />
    <circle cx="280" cy="128" r="2.5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="130" cy="70" r="7" />
    <circle cx="250" cy="90" r="7" />
    <rect x="470" y="94" width="18" height="18" rx="5" />
    <circle cx="420" cy="101" r="2.5" fillOpacity="0.45" />
    <circle cx="370" cy="98" r="2.5" fillOpacity="0.45" />
    <circle cx="320" cy="95" r="2.5" fillOpacity="0.45" />
    <circle cx="285" cy="92" r="2.5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="300" cy="60" r="7" />
    <circle cx="330" cy="120" r="7" />
    <rect x="470" y="134" width="18" height="18" rx="5" />
    <circle cx="425" cy="138" r="2.5" fillOpacity="0.5" />
    <circle cx="395" cy="132" r="2.5" fillOpacity="0.5" />
    <circle cx="365" cy="126" r="2.5" fillOpacity="0.5" />
  </g>
