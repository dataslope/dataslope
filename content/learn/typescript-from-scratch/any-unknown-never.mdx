...
<CodeBlock
  adapter="typescript"
  initialCode={`function double(x: any): any {
  return x * 2;
}
...
<CodeBlock
  adapter="typescript"
  initialCode={`function process(value: unknown): void {
...
<CodeBlock
  adapter="typescript"
  initialCode={`function dangerousAny(x: any): number {
...
<CodeBlock
  adapter="typescript"
  initialCode={`function throwError(message: string): never {
...
<CodeBlock
  adapter="typescript"
  initialCode={`function assertNever(x: never): never {
...
<CodeBlock
  adapter="typescript"
  initialCode={`function returnsVoid(): void {
  // No return, or 'return;'
}
...
<ChallengeCard
  ...
  initialCode={`function parseJSON(text: string): unknown {
