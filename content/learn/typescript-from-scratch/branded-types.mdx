...
<CodeBlock
  adapter="typescript"
  initialCode={`type Cents = number & { readonly __brand: "Cents" };
type Dollars = number & { readonly __brand: "Dollars" };
...
<CodeBlock
  adapter="typescript"
  initialCode={`declare const CentsBrand: unique symbol;
...
<CodeBlock
  adapter="typescript"
  initialCode={`declare const UserIdBrand: unique symbol;
...
<CodeBlock
  adapter="typescript"
  initialCode={`declare const EmailBrand: unique symbol;
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { UserId, createUserId } from "./user-id";
...
`,
    ...
    {
      filename: "user-id.ts",
      initialContent: `declare const UserIdBrand: unique symbol;
...
`,
    },
    {
      ...
      initialContent: `declare const OrderIdBrand: unique symbol;
...
`}
  initialCode={`declare const CelsiusBrand: unique symbol;
declare const FahrenheitBrand: unique symbol;
...
The compiler should prevent passing a plain \`string\` to \`sendEmail\`.`}
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { createEmail } from "./email";
...
`,
    ...
    {
      filename: "email.ts",
      initialContent: `declare const EmailBrand: unique symbol;
...
`,
      solutionContent: `declare const EmailBrand: unique symbol;
export type Email = string & { readonly [EmailBrand]: true };
...
`,
    ...
    {
      filename: "mailer.ts",
      initialContent: `import { Email } from "./email";
