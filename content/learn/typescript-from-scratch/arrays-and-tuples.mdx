...
<CodeBlock
  adapter="typescript"
  initialCode={`const numbers: number[] = [1, 2, 3, 4, 5];
...
<CodeBlock
  adapter="typescript"
  initialCode={`const numbers: Array<number> = [10, 20, 30];
...
<CodeBlock
  adapter="typescript"
  initialCode={`// Inferred as number[]
...
<CodeBlock
  adapter="typescript"
  initialCode={`const fixed: readonly number[] = [1, 2, 3];
...
<CodeBlock
  adapter="typescript"
  initialCode={`const immutable: ReadonlyArray<string> = ["a", "b", "c"];
...
<CodeBlock
  adapter="typescript"
  initialCode={`function divmod(a: number, b: number): [number, number] {
...
<CodeBlock
  adapter="typescript"
  initialCode={`// Named tuple: [name, age]
...
<CodeBlock
  adapter="typescript"
  initialCode={`// A tuple with an optional third element
...
<CodeBlock
  adapter="typescript"
  initialCode={`// A tuple: [name, ...scores]
...
<CodeBlock
  adapter="typescript"
  initialCode={`// A function that prepends an element to a tuple
...
<CodeBlock
  adapter="typescript"
  initialCode={`const arr: number[] = [1, 2, 3];
