...
<CodeBlock
  adapter="typescript"
  initialCode={`type StringOrNumber = string | number;
...
<CodeBlock
  adapter="typescript"
  initialCode={`function printId(id: string | number): void {
  console.log("ID:", id);
}
...
<CodeBlock
  adapter="typescript"
  initialCode={`function printLength(value: string | number): void {
...
<CodeBlock
  adapter="typescript"
  initialCode={`type Impossible = string & number;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type Status = "success" | "failure" | "pending";
...
<CodeBlock
  adapter="typescript"
  initialCode={`type StringFunc = (x: string) => string;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type Positioned = { x: number; y: number };
...
<CodeBlock
  adapter="typescript"
  initialCode={`interface PositionedI { x: number; y: number }
interface ColoredI { color: string }
...
<CodeBlock
  adapter="typescript"
  initialCode={`type A = { value: string };
type B = { value: number };
type Conflict = A & B;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type Config = { host: string; port: number };
...
<ChallengeCard
  ...
  initialCode={`type Result<T> = { ok: true; value: T } | { ok: false; error: string };
