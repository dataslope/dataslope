...
<CodeBlock
  adapter="typescript"
  initialCode={`type UserId = string;
...
<CodeBlock
  ...
  files={[
    {
      filename: "client.ts",
      initialContent: `import { User, UserId } from "./types";
...
`,
    ...
    {
      filename: "types.ts",
      initialContent: `export type UserId = string;
...
<CodeBlock
  ...
  files={[
    {
      filename: "client.ts",
      initialContent: `import { GetUserRequest, GetUserResponse } from "./types";
...
`,
    ...
    {
      filename: "service.ts",
      initialContent: `import { GetUserRequest, GetUserResponse, User } from "./types";
...
<CodeBlock
  adapter="typescript"
  initialCode={`type ApiResponse<T> =
  | { status: "ok"; data: T }
...
`,
    },
    {
      ...
      initialContent: `import { User, ApiResponse } from "./types";
...
`,
    ...
    {
      filename: "domain.ts",
      initialContent: `import { User } from "./types";
...
**Error case**: \`"Error: Order not found"\``}
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { getOrder } from "./service";
...
`,
    ...
    {
      filename: "service.ts",
      initialContent: `import { Order, ApiResponse } from "./types";
...
`,
      solutionContent: `import { Order, ApiResponse } from "./types";
...
<CodeBlock
  adapter="typescript"
  initialCode={`type SearchRequest = {
  query: string;
  type: "user" | "order";
};
