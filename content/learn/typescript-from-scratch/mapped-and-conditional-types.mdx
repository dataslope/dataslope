...
<CodeBlock
  adapter="typescript"
  initialCode={`type User = { id: number; name: string; active: boolean };
...
<CodeBlock
  adapter="typescript"
  initialCode={`type OptionalUser = { id?: number; name?: string };
...
<CodeBlock
  adapter="typescript"
  initialCode={`type IsString<T> = T extends string ? "yes" : "no";
...
<CodeBlock
  adapter="typescript"
  initialCode={`type ToArray<T> = T extends any ? T[] : never;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type ToArrayNoDistribute<T> = [T] extends [any] ? T[] : never;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type NonNullable<T> = T extends null | undefined ? never : T;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type ReturnType<T> = T extends (...args: any[]) => infer R ? R : never;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type FirstArg<T> = T extends (first: infer F, ...rest: any[]) => any ? F : never;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type Unpack<T> = T extends (infer U)[] ? U : T;
...
<CodeBlock
  adapter="typescript"
  initialCode={`type OptionalFunctions<T> = {
...
`}
  initialCode={`type Mutable<T> = any;
