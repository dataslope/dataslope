...
<CodeBlock
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { getUserById } from "./application";
...
`,
    },
    {
      ...
      initialContent: `import { User } from "./domain";
...
`,
    ...
    {
      filename: "domain.ts",
      initialContent: `export type User = {
  id: string;
  name: string;
  email: string;
};
...
<CodeBlock
  adapter="typescript"
  initialCode={`// Application layer defines the contract
type Logger = {
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { createOrder } from "./application";
...
`,
    ...
    {
      filename: "domain.ts",
      initialContent: `export type Order = {
  orderId: string;
  total: number;
};
...
`,
    ...
    {
      filename: "application.ts",
      initialContent: `import { Order, buildOrder } from "./domain";
...
`,
    ...
    {
      filename: "infrastructure.ts",
      initialContent: `import { Order } from "./domain";
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { createUser } from "./user";
...
<CodeBlock
  adapter="typescript"
  initialCode={`declare const OrderBrand: unique symbol;
type Order = {
  orderId: string;
  total: number;
...
- \`main.ts\`: Create a todo, toggle it, and print the result.`}
  ...
  files={[
    {
      filename: "main.ts",
      initialContent: `import { toggleTodoById } from "./application";
...
`,
    ...
    {
      filename: "domain.ts",
      initialContent: `export type Todo = {
  id: string;
  title: string;
  done: boolean;
};
...
`,
      solutionContent: `export type Todo = {
  id: string;
  title: string;
  done: boolean;
};
...
`,
    ...
    {
      filename: "application.ts",
      initialContent: `import { Todo, toggleTodo } from "./domain";
...
`,
      solutionContent: `import { Todo, toggleTodo } from "./domain";
...
`,
    ...
    {
      filename: "infrastructure.ts",
      initialContent: `import { Todo } from "./domain";
