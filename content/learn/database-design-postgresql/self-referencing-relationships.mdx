...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A dotted arc leaves the right side of a table and loops back into its own top, while inside a manager dot links down to two report dots — a table pointing at itself"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="303" cy="127" r="2.5" />
    <circle cx="294" cy="137" r="2.5" />
    <circle cx="337" cy="127" r="2.5" />
    <circle cx="346" cy="137" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="428" cy="116" r="3.5" fillOpacity="0.55" />
    <circle cx="446" cy="96" r="3.5" fillOpacity="0.55" />
    <circle cx="452" cy="70" r="3.5" fillOpacity="0.55" />
    <circle cx="440" cy="46" r="3.5" fillOpacity="0.55" />
    <circle cx="414" cy="32" r="3.5" fillOpacity="0.55" />
    <circle cx="384" cy="28" r="3.5" fillOpacity="0.55" />
    <circle cx="354" cy="34" r="3.5" fillOpacity="0.55" />
    <circle cx="332" cy="50" r="3.5" fillOpacity="0.55" />
...
manager, and everyone else's `reports_to` chain ends at her.
