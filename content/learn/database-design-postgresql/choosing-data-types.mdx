...
INSERT INTO order_items (sku, quantity) VALUES ('PEN-1', 3);`}
  initialCode={`-- The type INTEGER rejects text that is not a number.
INSERT INTO order_items (sku, quantity) VALUES ('BOOK-1', 'many');

SELECT id, sku, quantity FROM order_items;`}
/>
