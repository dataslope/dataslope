...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A shape-sorter board with a round hole, a square hole, and a slot: matching pieces drop in while a red triangle hovers with nowhere to fit — types admit only their own kind of value"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="90" y="122" width="460" height="68" rx="16" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <path fillRule="evenodd" d="M180 156 a20 20 0 1 0 40 0 a20 20 0 1 0 -40 0 M186 156 a14 14 0 1 0 28 0 a14 14 0 1 0 -28 0" />
    <path fillRule="evenodd" d="M320 136 h40 v40 h-40 Z M326 142 h28 v28 h-28 Z" />
    <path fillRule="evenodd" d="M442 148 h56 v16 h-56 Z M448 152 h44 v8 h-44 Z" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="200" cy="44" r="13" />
    <circle cx="200" cy="76" r="3" fillOpacity="0.45" />
    <circle cx="200" cy="96" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="327" y="32" width="26" height="26" rx="5" />
    <circle cx="340" cy="76" r="3" fillOpacity="0.45" />
    <circle cx="340" cy="96" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="448" y="38" width="44" height="14" rx="7" />
    <circle cx="470" cy="76" r="3" fillOpacity="0.45" />
    <circle cx="470" cy="96" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="118,58 136,88 100,88" fillOpacity="0.85" />
    <circle cx="146" cy="100" r="3" fillOpacity="0.45" />
    <circle cx="156" cy="116" r="3" fillOpacity="0.35" />
  </g>
</svg>
