...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Scattered tilted notes and dots on the left drift through a dotted passage and settle into a tidy grid of cells on the right — loose records gaining one reliable shape"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="58" y="38" width="46" height="26" rx="6" fillOpacity="0.3" transform="rotate(-14 81 51)" />
    <circle cx="208" cy="138" r="8" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="88" y="128" width="52" height="22" rx="6" fillOpacity="0.3" transform="rotate(9 114 139)" />
    <circle cx="148" cy="92" r="10" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="142" y="28" width="26" height="26" rx="7" fillOpacity="0.25" transform="rotate(21 155 41)" />
    <circle cx="92" cy="86" r="6" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="206,58 222,86 190,86" fillOpacity="0.2" />
  </g>
  <g fill="currentColor" opacity="0.28">
    <circle cx="262" cy="100" r="3.5" />
    <circle cx="288" cy="100" r="3.5" />
    <circle cx="314" cy="100" r="3.5" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <rect x="356" y="42" width="58" height="34" rx="8" />
    <rect x="422" y="42" width="58" height="34" rx="8" />
    <rect x="488" y="42" width="58" height="34" rx="8" />
    <rect x="356" y="84" width="58" height="34" rx="8" />
    <rect x="422" y="84" width="58" height="34" rx="8" />
    <rect x="488" y="84" width="58" height="34" rx="8" />
    <rect x="356" y="126" width="58" height="34" rx="8" />
    <rect x="422" y="126" width="58" height="34" rx="8" />
    <rect x="488" y="126" width="58" height="34" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="385" cy="59" r="6" />
    <circle cx="385" cy="101" r="6" />
    <circle cx="385" cy="143" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="451" cy="59" r="6" />
    <circle cx="451" cy="101" r="6" />
    <circle cx="451" cy="143" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="517" cy="59" r="6" />
    <circle cx="517" cy="101" r="6" />
    <circle cx="517" cy="143" r="6" />
  </g>
</svg>
