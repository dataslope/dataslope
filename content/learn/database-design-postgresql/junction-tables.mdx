...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A small junction container sits between two entity tables, holding one dot of each side's color — every pairing becomes one tidy row in the bridge"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="58" y="50" width="150" height="86" rx="14" fillOpacity="0.3" />
    <circle cx="94" cy="80" r="8" />
    <rect x="82" y="104" width="100" height="10" rx="5" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="432" y="50" width="150" height="86" rx="14" fillOpacity="0.3" />
    <circle cx="468" cy="80" r="8" />
    <rect x="456" y="104" width="100" height="10" rx="5" fillOpacity="0.4" />
  </g>
  <g fill="currentColor" opacity="0.14">
    <rect x="266" y="66" width="108" height="54" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="298" cy="93" r="9" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="342" cy="93" r="9" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.32">
    <circle cx="222" cy="93" r="3" />
    <circle cx="238" cy="86" r="3" />
    <circle cx="238" cy="100" r="3" />
    <circle cx="418" cy="93" r="3" />
    <circle cx="402" cy="86" r="3" />
    <circle cx="402" cy="100" r="3" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <circle cx="298" cy="150" r="3" />
    <circle cx="320" cy="150" r="3" />
    <circle cx="342" cy="150" r="3" />
  </g>
</svg>
