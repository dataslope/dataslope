...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="One large blue dot fans out along dotted trails to many small green dots — a single parent row connected to many child rows"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="130" cy="100" r="27" />
    <circle cx="130" cy="100" r="38" fillOpacity="0.15" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="196" cy="84" r="3" />
    <circle cx="276" cy="62" r="3" />
    <circle cx="356" cy="46" r="3" />
    <circle cx="436" cy="38" r="3" />
    <circle cx="200" cy="93" r="3" />
    <circle cx="282" cy="83" r="3" />
    <circle cx="364" cy="76" r="3" />
    <circle cx="446" cy="73" r="3" />
    <circle cx="202" cy="102" r="3" />
    <circle cx="286" cy="104" r="3" />
    <circle cx="370" cy="106" r="3" />
    <circle cx="454" cy="108" r="3" />
    <circle cx="200" cy="111" r="3" />
    <circle cx="282" cy="125" r="3" />
    <circle cx="364" cy="136" r="3" />
    <circle cx="446" cy="143" r="3" />
    <circle cx="196" cy="119" r="3" />
    <circle cx="276" cy="143" r="3" />
    <circle cx="356" cy="158" r="3" />
    <circle cx="436" cy="166" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="510" cy="34" r="11" />
    <circle cx="520" cy="71" r="11" />
    <circle cx="524" cy="109" r="11" />
    <circle cx="520" cy="147" r="11" />
    <circle cx="510" cy="180" r="11" />
  </g>
</svg>
