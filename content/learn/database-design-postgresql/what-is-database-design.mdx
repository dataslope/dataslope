...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A small neat blue iceberg tip above the waterline hides a much larger red mass below — day-one ease concealing the real cost of poor design"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="80" y="92" width="480" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="320,36 358,92 282,92" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="270,98 372,98 414,138 352,208 266,170 236,128" fillOpacity="0.16" />
    <circle cx="318" cy="146" r="9" fillOpacity="0.3" />
    <circle cx="288" cy="124" r="5" fillOpacity="0.25" />
    <circle cx="354" cy="172" r="5" fillOpacity="0.25" />
  </g>
</svg>
...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="One table stands decided while a second is still a dashed outline holding a question mark — design answers questions before they are built"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
