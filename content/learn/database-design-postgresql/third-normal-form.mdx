...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Inside one table three columns form a chain: short thin hops run key to fact to fact, while a long crossed-out red arc shows the fact reaching the key only secondhand — a transitive dependency"
...
>
  ...
  <g
    ...
    opacity="0.35"
  >
    <path d="M188 118 C 220 98, 270 98, 302 118" />
    <path d="M338 118 C 370 98, 420 98, 452 118" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <path
      d="M200 100 C 240 44, 400 44, 440 100"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
