...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="186" cy="100" r="3" fillOpacity="0.4" />
    <circle cx="208" cy="100" r="3" fillOpacity="0.4" />
    <circle cx="430" cy="100" r="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="486" y="88" width="24" height="24" rx="7" />
    <circle cx="356" cy="100" r="3" fillOpacity="0.5" />
    <circle cx="378" cy="100" r="3" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="246,128 268,166 224,166" />
    <circle cx="276" cy="118" r="3" fillOpacity="0.5" />
    <circle cx="288" cy="106" r="3" fillOpacity="0.5" />
    <circle cx="262" cy="142" r="3" fillOpacity="0.4" />
  </g>
</svg>
