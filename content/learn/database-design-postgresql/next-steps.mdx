...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A traveler dot follows a thin path along the horizon toward a rising yellow sun with thin rays — the course ends where the next stretch of practice begins"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <g
      ...
      strokeOpacity="0.5"
    >
      <path d="M246 119 L 224 109" />
      <path d="M270 88 L 256 69" />
      <path d="M320 70 L 320 46" />
      <path d="M370 88 L 384 69" />
      <path d="M394 119 L 416 109" />
    </g>
  </g>
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      d="M84 198 C 140 190, 210 178, 260 166"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
