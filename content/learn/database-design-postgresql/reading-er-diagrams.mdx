...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four entity containers zigzag across the canvas like a constellation, joined by dotted links that fan into many dots at each many side — reading a whole model as one story"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="178" cy="102" r="3" />
    <circle cx="196" cy="113" r="3" />
    <circle cx="334" cy="113" r="3" />
    <circle cx="352" cy="102" r="3" />
    <circle cx="490" cy="102" r="3" />
    <circle cx="500" cy="113" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="216" cy="120" r="3.5" fillOpacity="0.7" />
    <circle cx="226" cy="114" r="3.5" fillOpacity="0.7" />
    <circle cx="236" cy="120" r="3.5" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="372" cy="100" r="3.5" fillOpacity="0.7" />
    <circle cx="382" cy="106" r="3.5" fillOpacity="0.7" />
    <circle cx="392" cy="100" r="3.5" fillOpacity="0.7" />
    <circle cx="446" cy="100" r="3.5" fillOpacity="0.7" />
    <circle cx="456" cy="106" r="3.5" fillOpacity="0.7" />
    <circle cx="466" cy="100" r="3.5" fillOpacity="0.7" />
  </g>
</svg>
