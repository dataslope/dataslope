...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A spiral of dots grows larger and bolder as it circles inward toward a solid green center — each pass of the design process refining the schema until it settles"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="408" cy="105" r="3" fillOpacity="0.25" />
    <circle cx="382" cy="157" r="3.2" fillOpacity="0.3" />
    <circle cx="333" cy="179" r="3.5" fillOpacity="0.35" />
    <circle cx="286" cy="164" r="3.8" fillOpacity="0.4" />
    <circle cx="262" cy="126" r="4.2" fillOpacity="0.45" />
    <circle cx="268" cy="86" r="4.6" fillOpacity="0.5" />
    <circle cx="296" cy="63" r="5" fillOpacity="0.6" />
    <circle cx="327" cy="63" r="5.5" fillOpacity="0.7" />
    <circle cx="348" cy="82" r="6" fillOpacity="0.8" />
    <circle cx="350" cy="105" r="6.5" fillOpacity="0.9" />
    <circle cx="338" cy="121" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="316" cy="103" r="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="452" cy="63" r="6" fillOpacity="0.7" />
  </g>
</svg>
