...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Three values squeezed into a single crowded cell separate along a dotted arrow into three cells holding one value each — first normal form making cells atomic"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="67" width="150" height="56" rx="12" fillOpacity="0.14" />
    <circle cx="136" cy="97" r="12" />
    <circle cx="430" cy="48" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="162" cy="89" r="12" />
    <circle cx="430" cy="95" r="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="188" cy="99" r="12" />
    <circle cx="430" cy="142" r="10" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="272" cy="95" r="3.5" />
    <circle cx="298" cy="95" r="3.5" />
    <circle cx="324" cy="95" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="344,86 362,95 344,104" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="398" y="28" width="150" height="40" rx="10" />
    <rect x="398" y="75" width="150" height="40" rx="10" />
    <rect x="398" y="122" width="150" height="40" rx="10" />
  </g>
</svg>
