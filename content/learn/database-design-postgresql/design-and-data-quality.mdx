...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A green shield arc curves in front of a table, deflecting red shards while the clean data inside stays intact — quality enforced by the design itself"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M330 18 A92 92 0 0 0 330 202 L330 180 A70 70 0 0 1 330 40 Z" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="392" y="68" width="170" height="84" rx="16" fillOpacity="0.22" />
    <rect x="452" y="90" width="84" height="10" rx="5" fillOpacity="0.4" />
    <rect x="418" y="120" width="74" height="10" rx="5" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="428" cy="95" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="142,60 164,74 144,90" fillOpacity="0.85" />
    <polygon points="130,138 156,146 136,164" fillOpacity="0.7" />
    <circle cx="192" cy="80" r="3.5" fillOpacity="0.5" />
    <circle cx="222" cy="88" r="3.5" fillOpacity="0.5" />
    <circle cx="186" cy="150" r="3.5" fillOpacity="0.45" />
    <circle cx="214" cy="144" r="3.5" fillOpacity="0.45" />
    <circle cx="240" cy="120" r="3.5" fillOpacity="0.4" />
  </g>
</svg>
