...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <rect x="166" y="57" width="190" height="6" rx="3" fillOpacity="0.4" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <rect x="166" y="112" width="190" height="6" rx="3" fillOpacity="0.4" />
    <polygon points="358,115 400,95 400,103" />
    <polygon points="358,115 400,112 400,120" />
    <polygon points="358,115 400,127 400,135" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <rect x="166" y="167" width="174" height="6" rx="3" fillOpacity="0.4" />
    <path fillRule="evenodd" d="M346 170 a11 11 0 1 0 22 0 a11 11 0 1 0 -22 0 M351 170 a6 6 0 1 0 12 0 a6 6 0 1 0 -12 0" />
