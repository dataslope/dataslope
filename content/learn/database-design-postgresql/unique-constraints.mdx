...
VALUES ('ada@example.com', 'ada');`}
  initialCode={`-- This email is already used by Ada.
INSERT INTO accounts (email, username)
VALUES ('ada@example.com', 'ada_2');
...
INSERT INTO enrollments (student_id, course_id) VALUES (1, 10);`}
  initialCode={`-- Same student, same course: duplicate pair.
INSERT INTO enrollments (student_id, course_id) VALUES (1, 10);

SELECT student_id, course_id, enrolled_on FROM enrollments;`}
/>
