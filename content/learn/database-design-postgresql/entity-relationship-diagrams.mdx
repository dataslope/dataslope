...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="On a faint whiteboard, two entity boxes are already linked by a thin line while a third is still being sketched as a dashed outline with a pen nib — drawing the schema before building it"
...
>
  ...
  <g style={{ color: "var(--ds-gray-400)" }}>
    <path
      d="M232 98 C 256 108, 274 116, 296 126"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
