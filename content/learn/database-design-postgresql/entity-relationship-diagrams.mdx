...
Crow's-foot notation puts symbols at both ends of the relationship
line. The symbols tell you how many rows may connect on each side.
...
INSERT INTO orders VALUES (101, 1, DATE '2025-02-01', 'placed');`}
  initialCode={`SELECT c.name, o.id AS order_id, o.status
FROM customers c
