...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An entity container lists three attribute rows, each tethered to a fenced set of allowed values on the right, with one red value left outside its fence — attributes and their domains"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.09">
    <rect x="64" y="35" width="190" height="140" rx="16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="98" cy="70" r="7" />
    <rect x="116" y="64" width="92" height="11" rx="5.5" fillOpacity="0.4" />
    <rect x="324" y="55" width="180" height="30" rx="15" fillOpacity="0.1" />
    <rect x="342" y="63" width="14" height="14" rx="4" />
    <rect x="368" y="63" width="14" height="14" rx="4" fillOpacity="0.7" />
    <rect x="394" y="63" width="14" height="14" rx="4" fillOpacity="0.45" />
    <rect x="420" y="63" width="14" height="14" rx="4" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="98" cy="105" r="7" />
    <rect x="116" y="99" width="74" height="11" rx="5.5" fillOpacity="0.4" />
    <rect x="324" y="90" width="180" height="30" rx="15" fillOpacity="0.1" />
    <circle cx="350" cy="105" r="7" />
    <circle cx="377" cy="105" r="7" fillOpacity="0.65" />
    <circle cx="404" cy="105" r="7" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="98" cy="140" r="7" />
    <rect x="116" y="134" width="84" height="11" rx="5.5" fillOpacity="0.4" />
    <rect x="324" y="125" width="180" height="30" rx="15" fillOpacity="0.1" />
    <rect x="342" y="133" width="14" height="14" rx="7" />
    <rect x="368" y="133" width="14" height="14" rx="7" fillOpacity="0.55" />
  </g>
  <g fill="currentColor" opacity="0.28">
    <circle cx="268" cy="70" r="3" />
    <circle cx="294" cy="70" r="3" />
    <circle cx="268" cy="105" r="3" />
    <circle cx="294" cy="105" r="3" />
    <circle cx="268" cy="140" r="3" />
    <circle cx="294" cy="140" r="3" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="540" y="133" width="14" height="14" rx="7" fillOpacity="0.8" />
  </g>
</svg>
