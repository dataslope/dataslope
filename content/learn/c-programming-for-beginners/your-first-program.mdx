...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A terminal window with a green prompt arrow, a blinking cursor block, and redacted output bars — a first program about to print its first words"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="120" y="40" width="400" height="170" rx="14" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="146" cy="64" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="168" cy="64" r="6" />
    <rect x="150" y="150" width="120" height="14" rx="7" />
    <rect x="282" y="150" width="60" height="14" rx="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="190" cy="64" r="6" />
    <polygon points="150,104 150,128 168,116" />
    <rect x="180" y="104" width="14" height="24" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="178" width="90" height="14" rx="7" />
  </g>
</svg>
