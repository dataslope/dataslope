...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Loose scattered shapes being gathered into one container that packs a square, a bar, a circle, and a small chip together — separate variables becoming one struct"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="70" width="28" height="28" rx="6" fillOpacity="0.3" />
    <rect x="205" y="75" width="40" height="40" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="60" y="120" width="70" height="20" rx="8" fillOpacity="0.3" />
    <rect x="205" y="130" width="180" height="34" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="85" cy="170" r="11" fillOpacity="0.3" />
    <circle cx="330" cy="95" r="17" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="395" y="82" width="26" height="26" rx="6" />
  </g>
  <g fill="currentColor">
    <rect x="180" y="50" width="280" height="140" rx="18" opacity="0.07" />
    <circle cx="140" cy="120" r="3" opacity="0.3" />
    <circle cx="160" cy="120" r="3" opacity="0.3" />
  </g>
</svg>
