...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="A row of character cells holding yellow dots, with the final cell holding a red square marked as the null terminator"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="120" y="60" width="56" height="56" rx="10" />
    <rect x="182" y="60" width="56" height="56" rx="10" />
    <rect x="244" y="60" width="56" height="56" rx="10" />
    <rect x="306" y="60" width="56" height="56" rx="10" />
    <rect x="368" y="60" width="56" height="56" rx="10" />
    <rect x="430" y="60" width="56" height="56" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="148" cy="88" r="11" />
    <circle cx="210" cy="88" r="11" />
    <circle cx="272" cy="88" r="11" />
    <circle cx="334" cy="88" r="11" />
    <circle cx="396" cy="88" r="11" />
  </g>
