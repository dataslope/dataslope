...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A pointer hopping cell to cell along an array in dotted yellow arcs, the visited dots growing solid, with a marker under the current cell"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="120" y="90" width="70" height="70" rx="12" />
    <rect x="204" y="90" width="70" height="70" rx="12" />
    <rect x="288" y="90" width="70" height="70" rx="12" />
    <rect x="372" y="90" width="70" height="70" rx="12" />
    <rect x="456" y="90" width="70" height="70" rx="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor" fillOpacity="0.7">
    <circle cx="172" cy="76" r="3.5" />
    <circle cx="197" cy="62" r="3.5" />
    <circle cx="222" cy="76" r="3.5" />
    <circle cx="256" cy="76" r="3.5" />
    <circle cx="281" cy="62" r="3.5" />
    <circle cx="306" cy="76" r="3.5" />
    <circle cx="340" cy="76" r="3.5" />
    <circle cx="365" cy="62" r="3.5" />
    <circle cx="390" cy="76" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="155" cy="125" r="12" fillOpacity="0.25" />
    <circle cx="239" cy="125" r="12" fillOpacity="0.45" />
    <circle cx="323" cy="125" r="12" fillOpacity="0.7" />
    <circle cx="407" cy="125" r="12" />
    <circle cx="491" cy="125" r="12" fillOpacity="0.12" />
    <polygon points="407,176 395,194 419,194" />
  </g>
</svg>
