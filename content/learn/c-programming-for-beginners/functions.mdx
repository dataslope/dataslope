...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Coins queue up and drop through a slot into a blue machine, which dispenses a green block down a short chute — call a function, get a value back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="252" cy="32" r="7" fillOpacity="0.35" />
    <circle cx="284" cy="32" r="9" fillOpacity="0.55" />
  ...
  <path
    d="M392 150 C 412 160, 426 169, 438 180"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
