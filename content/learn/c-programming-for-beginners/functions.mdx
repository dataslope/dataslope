...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Coins queue up and drop through a slot into a blue machine, which dispenses a green block from its side chute — call a function, get a value back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="210" cy="30" r="7" fillOpacity="0.35" />
    <circle cx="240" cy="30" r="9" fillOpacity="0.55" />
    <circle cx="320" cy="30" r="12" />
    <circle cx="320" cy="54" r="3" fillOpacity="0.6" />
    <circle cx="320" cy="66" r="3" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="250" y="80" width="140" height="80" rx="18" />
  </g>
  <rect x="296" y="74" width="48" height="12" rx="6" fill="currentColor" opacity="0.3" />
  <g fill="currentColor" opacity="0.3">
    <circle cx="410" cy="176" r="3" />
    <circle cx="428" cy="182" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="444" y="172" width="28" height="28" rx="8" />
  </g>
</svg>
