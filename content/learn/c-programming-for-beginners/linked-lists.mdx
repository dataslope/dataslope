...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three nodes, each a data square with a small pointer tab, chained by dotted arcs, ending in a red square for null — a linked list"
...
>
  ...
  <g fill="currentColor" opacity="0.35">
    <circle cx="198" cy="100" r="3.5" />
    <circle cx="222" cy="92" r="3.5" />
    <circle cx="246" cy="100" r="3.5" />
    <circle cx="378" cy="100" r="3.5" />
    <circle cx="402" cy="92" r="3.5" />
    <circle cx="426" cy="100" r="3.5" />
  </g>
