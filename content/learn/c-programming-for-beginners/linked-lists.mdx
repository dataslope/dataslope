...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three nodes, each a blue data box with a green pointer tab, chained by thin curved arrows, the last tab holding a red square for null — a linked list"
