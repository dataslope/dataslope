...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An assembly line: a source document, a toothed gear, a chip, and finally a runnable pill with a play triangle, joined by dotted conveyor segments"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="155" cy="105" r="3" />
    <circle cx="175" cy="105" r="3" />
    <circle cx="290" cy="105" r="3" />
    <circle cx="310" cy="105" r="3" />
    <circle cx="437" cy="105" r="3" />
    <circle cx="455" cy="105" r="3" />
  </g>
