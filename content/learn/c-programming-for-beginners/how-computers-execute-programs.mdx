...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Three circles in a triangle joined by dotted arcs — the endless fetch, decode, execute cycle — with a queue of instruction squares waiting on the left"
...
>
  <g fill="currentColor" opacity="0.25">
    ...
    <circle cx="255" cy="55" r="3" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="372" cy="84" r="3.5" />
    <circle cx="404" cy="112" r="3.5" />
    <circle cx="424" cy="142" r="3.5" />
    <circle cx="390" cy="195" r="3.5" />
    <circle cx="320" cy="205" r="3.5" />
    <circle cx="250" cy="195" r="3.5" />
    <circle cx="216" cy="142" r="3.5" />
    <circle cx="236" cy="112" r="3.5" />
    <circle cx="268" cy="84" r="3.5" />
  </g>
