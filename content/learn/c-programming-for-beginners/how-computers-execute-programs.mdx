...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Three colored circles joined in a triangle by thin curved arrows — the endless fetch, decode, execute cycle — with a queue of instruction squares feeding in from the left"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <rect x="60" y="40" width="16" height="16" rx="4" />
    <rect x="60" y="64" width="16" height="16" rx="4" />
    <rect x="60" y="88" width="16" height="16" rx="4" />
  </g>
  <path
    d="M86 60 C 150 58, 220 56, 278 55"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
  ...
  <g
    ...
    opacity="0.25"
  >
    <path d="M348 71 C 393 92, 418 116, 427 138" />
    <path d="M400 184 C 362 202, 278 202, 240 184" />
    <path d="M213 138 C 222 116, 247 92, 292 71" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="420,140 434,136 428,150" />
    <polygon points="248,178 244,192 232,182" />
    <polygon points="296,77 282,79 292,64" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="55" r="26" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="430" cy="170" r="26" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="210" cy="170" r="26" />
  </g>
</svg>
