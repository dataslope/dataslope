...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Nested translucent brackets halving a row of dots again and again until they close in on a single red dot — finding a bug by bisection"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="64" y="82" width="528" height="56" rx="28" fillOpacity="0.07" />
    <rect x="64" y="88" width="264" height="44" rx="22" fillOpacity="0.12" />
    <rect x="196" y="94" width="132" height="32" rx="16" fillOpacity="0.18" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="80" cy="110" r="5" />
    <circle cx="112" cy="110" r="5" />
    <circle cx="144" cy="110" r="5" />
    <circle cx="176" cy="110" r="5" />
    <circle cx="208" cy="110" r="5" />
    <circle cx="240" cy="110" r="5" />
    <circle cx="304" cy="110" r="5" />
    <circle cx="336" cy="110" r="5" />
    <circle cx="368" cy="110" r="5" />
    <circle cx="400" cy="110" r="5" />
    <circle cx="432" cy="110" r="5" />
    <circle cx="464" cy="110" r="5" />
    <circle cx="496" cy="110" r="5" />
    <circle cx="528" cy="110" r="5" />
    <circle cx="560" cy="110" r="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="272" cy="110" r="7" />
  </g>
</svg>
