...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A square grid of dots and its sheared copy joined by dotted tethers, with one green arrow pointing the same way in both — a matrix as a transformation of space, and the direction it preserves"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="160" y="117" width="38" height="6" rx="3" />
    <polygon points="198,112 198,128 212,120" />
    <rect x="464" y="117" width="38" height="6" rx="3" />
    <polygon points="502,112 502,128 516,120" />
  </g>
</svg>
