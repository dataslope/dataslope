...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A solid blue square equals a green lower triangle times a yellow upper triangle, each triangle backed by the faint ghost of a full square and dotted along its diagonal — a matrix factored into structured pieces"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="40" width="120" height="120" rx="10" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="262" y="90" width="28" height="7" rx="3.5" />
    <rect x="262" y="104" width="28" height="7" rx="3.5" />
    <circle cx="476" cy="100" r="4.5" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="330" y="40" width="120" height="120" rx="10" />
    <rect x="500" y="40" width="120" height="120" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="330,40 330,160 450,160" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="500,40 620,40 620,160" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" fillOpacity="0.75">
    <circle cx="352" cy="76" r="3" />
    <circle cx="376" cy="106" r="3" />
    <circle cx="400" cy="136" r="3" />
    <circle cx="538" cy="64" r="3" />
    <circle cx="562" cy="94" r="3" />
    <circle cx="586" cy="124" r="3" />
  </g>
</svg>
