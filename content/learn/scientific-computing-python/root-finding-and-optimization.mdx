...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A green ball has rolled down a translucent valley to its deep floor while a red ball sits trapped in a small side dip — global versus local minima in optimization"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M60 70 C120 160 200 190 260 188 C320 186 330 140 380 134 C430 128 440 152 480 150 C530 148 570 90 600 60 L600 210 L60 210 Z" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="110" cy="108" r="3.5" fillOpacity="0.45" />
    <circle cx="140" cy="134" r="3.5" fillOpacity="0.45" />
    <circle cx="172" cy="156" r="3.5" fillOpacity="0.45" />
    <circle cx="205" cy="172" r="3.5" fillOpacity="0.45" />
    <circle cx="262" cy="178" r="10" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="552" cy="96" r="3" fillOpacity="0.4" />
    <circle cx="528" cy="114" r="3" fillOpacity="0.4" />
    <circle cx="504" cy="128" r="3" fillOpacity="0.4" />
    <circle cx="480" cy="140" r="9" />
  </g>
</svg>
