...
plt.xlabel("position"); plt.ylabel("temperature"); plt.legend()
...
- [o] That discretizing a continuous physical problem onto a grid and stepping it forward in time was a viable scientific method
  > Yes. Even though the forecast was useless operationally, it proved the *pattern* — discretize + step + iterate — that now underlies every weather, climate, ocean, and atmospheric model.
