...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Above each ruler tick a faint exact dot is paired with a blue computed dot sitting slightly off it — every number on a computer is slightly wrong"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="70" y="106" width="500" height="5" rx="2.5" opacity="0.2" />
    <rect x="108" y="90" width="3" height="16" opacity="0.3" />
    <rect x="168" y="90" width="3" height="16" opacity="0.3" />
    <rect x="228" y="90" width="3" height="16" opacity="0.3" />
    <rect x="288" y="90" width="3" height="16" opacity="0.3" />
    <rect x="348" y="90" width="3" height="16" opacity="0.3" />
    <rect x="408" y="90" width="3" height="16" opacity="0.3" />
    <rect x="468" y="90" width="3" height="16" opacity="0.3" />
    <rect x="528" y="90" width="3" height="16" opacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" opacity="0.3">
    <circle cx="110" cy="68" r="7" />
    <circle cx="170" cy="68" r="7" />
    <circle cx="230" cy="68" r="7" />
    <circle cx="290" cy="68" r="7" />
    <circle cx="350" cy="68" r="7" />
    <circle cx="410" cy="68" r="7" />
    <circle cx="470" cy="68" r="7" />
    <circle cx="530" cy="68" r="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="116" cy="64" r="6" />
    <circle cx="165" cy="63" r="6" />
    <circle cx="238" cy="65" r="6" />
    <circle cx="285" cy="62" r="6" />
    <circle cx="358" cy="64" r="6" />
    <circle cx="404" cy="62" r="6" />
    <circle cx="476" cy="65" r="6" />
    <circle cx="526" cy="62" r="6" />
  </g>
</svg>
