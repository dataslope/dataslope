...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Translucent green columns stand packed under a smooth blue curve while a yellow tangent bar rests on its crest — integration as summed areas, differentiation as local slope"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M80 180 L80 140 C160 40 300 40 380 90 C440 127 500 130 560 120 L560 180 Z" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="104" y="102" width="48" height="78" fillOpacity="0.4" />
    <rect x="152" y="70" width="48" height="110" fillOpacity="0.25" />
    <rect x="200" y="56" width="48" height="124" fillOpacity="0.4" />
    <rect x="248" y="56" width="48" height="124" fillOpacity="0.25" />
    <rect x="296" y="64" width="48" height="116" fillOpacity="0.4" />
    <rect x="344" y="84" width="48" height="96" fillOpacity="0.25" />
    <rect x="392" y="102" width="48" height="78" fillOpacity="0.4" />
    <rect x="440" y="112" width="48" height="68" fillOpacity="0.25" />
    <rect x="488" y="118" width="48" height="62" fillOpacity="0.4" />
  </g>
  <g fill="currentColor">
    <rect x="70" y="180" width="500" height="5" rx="2.5" opacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="216" y="42" width="68" height="5" rx="2.5" fillOpacity="0.9" />
