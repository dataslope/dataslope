...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A green formula pill marked with a function glyph feeds along a dotted arrow into a punched card full of holes — FORTRAN translating the formula a scientist means into machine instructions"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="304" cy="100" r="3.5" />
    <circle cx="328" cy="100" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="346,90 346,110 364,100" />
    <polygon points="400,45 560,45 560,155 380,155 380,65" fillOpacity="0.12" />
  </g>
  <g fill="currentColor" opacity="0.45">
    <rect x="405" y="68" width="6" height="12" rx="1.5" />
    <rect x="455" y="68" width="6" height="12" rx="1.5" />
    <rect x="530" y="68" width="6" height="12" rx="1.5" />
    <rect x="405" y="94" width="6" height="12" rx="1.5" />
    <rect x="430" y="94" width="6" height="12" rx="1.5" />
    <rect x="505" y="94" width="6" height="12" rx="1.5" />
    <rect x="430" y="120" width="6" height="12" rx="1.5" />
    <rect x="480" y="120" width="6" height="12" rx="1.5" />
    <rect x="530" y="120" width="6" height="12" rx="1.5" />
    <rect x="480" y="68" width="6" height="12" rx="1.5" />
  </g>
</svg>
