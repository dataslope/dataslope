...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="A contiguous strip of memory cells flows down a dotted arrow and reappears as a three-by-four grid of the same cells, with a small shape tag reading 3 by 4 — one block of memory viewed as a multidimensional array"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="104" y="40" width="36" height="30" rx="5" fillOpacity="0.8" />
    <rect x="239" y="140" width="36" height="30" rx="5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="176" y="40" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="212" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="248" y="40" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="284" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="320" y="40" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="356" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="392" y="40" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="428" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="464" y="40" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="500" y="40" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="281" y="140" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="323" y="140" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="365" y="140" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="239" y="176" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="281" y="176" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="323" y="176" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="365" y="176" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="239" y="212" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="281" y="212" width="36" height="30" rx="5" fillOpacity="0.55" />
    <rect x="323" y="212" width="36" height="30" rx="5" fillOpacity="0.3" />
    <rect x="365" y="212" width="36" height="30" rx="5" fillOpacity="0.55" />
    <polygon points="312,116 328,116 320,130" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="320" cy="88" r="3" />
    <circle cx="320" cy="103" r="3" />
  </g>
...
print("A.reshape(2, 6) shares memory with A?", np.shares_memory(A, A.reshape(2, 6)))

# Reshaping a transposed (non-contiguous) array may force a copy
T = A.T
print("T.shape   =", T.shape, " contiguous?", T.flags["C_CONTIGUOUS"])
print("T.reshape(12) shares memory?", np.shares_memory(T, T.reshape(12)))
`,
    },
  ]}
/>
