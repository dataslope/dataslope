...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A large blue circle orbited by a constellation of smaller package circles joined by dotted edges — the SciPy ecosystem growing outward around Python"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="271" cy="93" r="3" />
    <circle cx="236" cy="80" r="3" />
    <circle cx="257" cy="120" r="3" />
    <circle cx="203" cy="128" r="3" />
    <circle cx="358" cy="89" r="3" />
    <circle cx="396" cy="68" r="3" />
    <circle cx="373" cy="124" r="3" />
    <circle cx="425" cy="139" r="3" />
    <circle cx="390" cy="103" r="3" />
    <circle cx="460" cy="96" r="3" />
    <circle cx="292" cy="136" r="3" />
    <circle cx="264" cy="161" r="3" />
    <circle cx="345" cy="138" r="3" />
    <circle cx="368" cy="164" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="110" r="30" />
    <circle cx="470" cy="150" r="18" fillOpacity="0.55" />
    <circle cx="240" cy="185" r="10" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="180" cy="60" r="16" />
    <circle cx="140" cy="140" r="12" fillOpacity="0.8" />
    <circle cx="530" cy="90" r="10" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="430" cy="50" r="14" />
    <circle cx="390" cy="190" r="8" fillOpacity="0.7" />
  </g>
</svg>
...
import matplotlib.pyplot as plt`,
      starterCode: `# Generate a noisy signal: a 2 Hz sine plus 20 Hz noise
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.py",
      starterCode: `# Example pyproject.toml metadata (for illustration; not executed)
example = """
[project]
