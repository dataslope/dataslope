...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A green formula pill marked with a function glyph feeds along a dotted arrow into a punched card full of holes — a formula being translated into machine instructions"
