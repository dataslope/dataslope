...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A sealed capsule holding data dots, a code chip, and a seed dot produces two identical mini bar charts joined by an equals sign — the same experiment giving the same result every time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="55" width="220" height="110" rx="55" fillOpacity="0.1" />
    <circle cx="120" cy="90" r="7" />
    <circle cx="150" cy="130" r="7" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="180" y="82" width="46" height="22" rx="8" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="200" cy="132" r="7" />
    <circle cx="288" cy="110" r="10" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="320" cy="84" r="3" />
    <circle cx="348" cy="72" r="3" />
    <circle cx="376" cy="62" r="3" />
    <circle cx="320" cy="136" r="3" />
    <circle cx="348" cy="148" r="3" />
    <circle cx="376" cy="158" r="3" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="404" y="34" width="170" height="70" rx="10" />
    <rect x="404" y="130" width="170" height="70" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.7">
    <rect x="424" y="76" width="18" height="20" rx="4" />
    <rect x="452" y="58" width="18" height="38" rx="4" />
    <rect x="480" y="66" width="18" height="30" rx="4" />
    <rect x="508" y="48" width="18" height="48" rx="4" />
    <rect x="424" y="172" width="18" height="20" rx="4" />
    <rect x="452" y="154" width="18" height="38" rx="4" />
    <rect x="480" y="162" width="18" height="30" rx="4" />
    <rect x="508" y="144" width="18" height="48" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.9">
    <rect x="588" y="106" width="24" height="6" rx="3" />
    <rect x="588" y="120" width="24" height="6" rx="3" />
  </g>
</svg>
