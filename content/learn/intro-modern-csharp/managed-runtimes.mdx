...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Bright shapes stand on a floor while faded ghost shapes linger further along; a small green sweeper dot rolls toward the ghosts to collect them — the garbage collector tidying memory"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="168" width="520" height="4" rx="2" fill="currentColor" opacity="0.18" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="146" r="20" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="180" y="126" width="40" height="40" rx="8" fillOpacity="0.75" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="258,166 302,166 280,126" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="350" cy="158" r="3" />
    <circle cx="372" cy="158" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="408" cy="156" r="11" />
    <circle cx="408" cy="128" r="3" fillOpacity="0.7" />
    <circle cx="418" cy="138" r="2.5" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <circle cx="470" cy="150" r="17" />
    <rect x="512" y="136" width="30" height="30" rx="6" />
    <circle cx="572" cy="154" r="12" />
  </g>
</svg>
