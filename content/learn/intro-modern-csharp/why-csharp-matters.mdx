...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Five pills of different colors and sizes tethered by dotted spokes to one solid blue hub — five practical reasons orbiting one language"
  style={{ display: "block", width: "100%", maxWidth: "600px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="272" cy="96" r="3" />
    <circle cx="235" cy="84" r="3" />
    <circle cx="198" cy="72" r="3" />
    <circle cx="320" cy="76" r="3" />
    <circle cx="320" cy="56" r="3" />
    <circle cx="366" cy="94" r="3" />
    <circle cx="404" cy="80" r="3" />
    <circle cx="440" cy="67" r="3" />
    <circle cx="362" cy="118" r="3" />
    <circle cx="404" cy="126" r="3" />
    <circle cx="446" cy="133" r="3" />
    <circle cx="276" cy="124" r="3" />
    <circle cx="238" cy="138" r="3" />
    <circle cx="202" cy="152" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="110" r="24" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="115" y="49" width="70" height="22" rx="11" />
    <rect x="130" y="157" width="60" height="22" rx="11" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="448" y="45" width="64" height="22" rx="11" />
    <rect x="291" y="19" width="58" height="22" rx="11" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="482" y="129" width="76" height="22" rx="11" fillOpacity="0.5" />
  </g>
</svg>
...
class Library
{
    ...
    public IEnumerable<Book> ByAuthor(string author) => books.Where(b => b.Author == author);
