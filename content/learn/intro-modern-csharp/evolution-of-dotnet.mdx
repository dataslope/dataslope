...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A dot held inside a solid frame, then inside a fading frame with its lid gone, then standing free among green community dots — .NET opening up from closed and Windows-only to open source"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.45">
    <rect x="90" y="58" width="80" height="8" rx="4" />
    <rect x="90" y="134" width="80" height="8" rx="4" />
    <rect x="90" y="58" width="8" height="84" rx="4" />
    <rect x="162" y="58" width="8" height="84" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="130" cy="100" r="12" fillOpacity="0.65" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="205" cy="100" r="3" />
    <circle cx="228" cy="100" r="3" />
    <circle cx="390" cy="100" r="3" />
    <circle cx="413" cy="100" r="3" />
  </g>
  <g fill="currentColor" opacity="0.16">
    <rect x="280" y="58" width="8" height="84" rx="4" />
    <rect x="352" y="58" width="8" height="84" rx="4" />
    <rect x="280" y="134" width="80" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="100" r="15" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="500" cy="100" r="19" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="545" cy="70" r="5" />
    <circle cx="552" cy="124" r="4" />
    <circle cx="462" cy="62" r="4" />
    <circle cx="455" cy="136" r="5" />
    <circle cx="514" cy="44" r="3.5" />
    <circle cx="588" cy="98" r="3.5" />
  </g>
</svg>
