...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A pencil finishing a bold blue circle marked with a sharp sign on a drafting sheet, with faint guide dots and two faded earlier sketches — a language shaped by its designer's taste"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="30" width="380" height="160" rx="10" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="130" cy="72" r="14" fillOpacity="0.12" />
    <rect x="118" y="128" width="26" height="26" rx="6" fillOpacity="0.12" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="294" cy="110" r="2.5" />
    <circle cx="281" cy="141" r="2.5" />
    <circle cx="250" cy="154" r="2.5" />
    <circle cx="219" cy="141" r="2.5" />
    <circle cx="206" cy="110" r="2.5" />
    <circle cx="219" cy="79" r="2.5" />
    <circle cx="250" cy="66" r="2.5" />
    <circle cx="281" cy="79" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="309" y="90" width="110" height="16" rx="7" transform="rotate(-37 309 98)" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="399" cy="31" r="7" fillOpacity="0.55" />
  </g>
</svg>
...
That perspective will help you read the rest of this course. C# is
not a *minimal* language. It is a *generous* one, deliberately
