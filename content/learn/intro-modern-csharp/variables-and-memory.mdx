...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A cabinet of three labeled drawers with the middle drawer slid open to reveal a green dot stored inside — a variable as a named box in memory"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="200" y="30" width="240" height="170" rx="12" fill="currentColor" opacity="0.08" />
  <g fill="currentColor" opacity="0.3">
    <circle cx="186" cy="68" r="2.5" />
    <circle cx="186" cy="118" r="2.5" />
    <circle cx="186" cy="168" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="220" y="46" width="200" height="44" rx="8" fillOpacity="0.18" />
    <rect x="232" y="56" width="36" height="10" rx="5" fillOpacity="0.5" />
    <rect x="220" y="146" width="200" height="44" rx="8" fillOpacity="0.18" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="232" y="156" width="36" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="354" cy="68" r="4" />
    <circle cx="354" cy="168" r="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="268" y="96" width="200" height="44" rx="8" fillOpacity="0.32" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="280" y="106" width="36" height="10" rx="5" fillOpacity="0.8" />
    <circle cx="396" cy="118" r="10" />
  </g>
  <circle cx="452" cy="118" r="4" fill="currentColor" opacity="0.4" />
</svg>
