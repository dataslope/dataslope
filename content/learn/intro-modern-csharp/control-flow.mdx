...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="A dotted track reaches a yellow decision diamond: one branch exits to a green circle, the other loops back around to run the track again — branching and repetition in one picture"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="72" cy="95" r="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="104" cy="95" r="3" />
    <circle cx="130" cy="95" r="3" />
    <circle cx="156" cy="95" r="3" />
    <circle cx="182" cy="95" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="250,63 282,95 250,127 218,95" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="306" cy="78" r="3" fillOpacity="0.5" />
    <circle cx="348" cy="62" r="3" fillOpacity="0.5" />
    <circle cx="390" cy="50" r="3" fillOpacity="0.5" />
    <circle cx="446" cy="44" r="13" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="300" cy="122" r="3" />
    <circle cx="316" cy="146" r="3" />
    <circle cx="296" cy="166" r="3" />
    <circle cx="260" cy="172" r="3" />
    <circle cx="224" cy="168" r="3" />
    <circle cx="196" cy="152" r="3" />
    <circle cx="180" cy="130" r="3" />
    <circle cx="178" cy="110" r="3" />
  </g>
  <polygon points="172,108 184,108 178,94" fill="currentColor" opacity="0.35" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="288" cy="146" r="6" fillOpacity="0.8" />
  </g>
</svg>
...
<ChallengeCard
  adapter="csharp"
  title="Count vowels"
  instructions={`Write code that counts the number of vowels (\`a\`, \`e\`, \`i\`, \`o\`, \`u\`, in upper or lower case) in the hard-coded string \`text\` and prints:
...
`,
  ...
  tests={[
    {
      id: "vowels",
      name: "Counts 5 vowels in 'Hello, World!'",
      expect: { stdoutEquals: "vowels = 3" },
    },
  ]}
/>

<Callout type="info" title="If your count is wrong">
