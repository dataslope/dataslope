...
The previous page ended with a problem: as programs grew, the
**procedural style** of "many functions over shared global data"
collapsed under its own weight. The fix was a different way of
organizing programs — **object-oriented programming**, or **OOP**.
...
assumption. C# was object-oriented from line one — and we will
spend a large part of this course learning to think in objects.
