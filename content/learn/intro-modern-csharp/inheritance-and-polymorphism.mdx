...
{
    public Dog(string name) : base(name) { }   // forward to the base constructor
...
{
    foreach (var n in names) Console.WriteLine(g.Greet(n));
}
...
`,
      solutionContent: `public abstract class Shape
{
...
`,
    ...
    {
      filename: "Circle.cs",
      initialContent: `public class Circle : Shape
{
    // TODO
...
`,
    },
    {
      ...
      initialContent: `public class Rectangle : Shape
{
    // TODO
    public override double Area() => 0;
}
`,
      solutionContent: `public class Rectangle : Shape
{
