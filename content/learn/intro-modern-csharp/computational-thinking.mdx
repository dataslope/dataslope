...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A messy translucent blob resolving through a dotted arrow into four crisp shapes — a vague real-world problem broken into concrete, computer-sized pieces"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M105 96 C95 62 140 38 178 50 C214 38 246 64 238 92 C260 116 226 152 192 144 C168 166 120 156 114 128 C92 122 96 108 105 96 Z" fillOpacity="0.3" />
  </g>
  ...
  <polygon points="344,91 344,109 362,100" fill="currentColor" opacity="0.35" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="420" y="46" width="36" height="36" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="522" cy="64" r="19" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="420,138 456,138 438,106" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="506" y="106" width="34" height="8" rx="4" fillOpacity="0.85" />
    <rect x="506" y="120" width="26" height="8" rx="4" fillOpacity="0.6" />
    <rect x="506" y="134" width="30" height="8" rx="4" fillOpacity="0.4" />
  </g>
</svg>
