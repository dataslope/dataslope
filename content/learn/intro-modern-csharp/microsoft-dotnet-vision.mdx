...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four different shapes — a circle, a square, a triangle, and a capsule — all standing on one wide translucent platform slab: many languages sharing a single runtime"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="150" width="440" height="26" rx="13" fillOpacity="0.18" />
  </g>
  <rect x="130" y="184" width="380" height="12" rx="6" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="172" cy="124" r="27" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="256" y="103" width="48" height="48" rx="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="366,150 414,150 390,106" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="452" y="102" width="28" height="49" rx="14" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="120" cy="62" r="3" />
    <circle cx="320" cy="48" r="3.5" />
    <circle cx="528" cy="66" r="3" />
  </g>
</svg>
