...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A skyline of office towers with lit windows, one tall blue tower standing far above the rest — the enterprise computing world that C# was born into"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="50" y="208" width="540" height="4" rx="2" fill="currentColor" opacity="0.2" />
  <g fill="currentColor" opacity="0.16">
    <rect x="90" y="128" width="60" height="80" rx="4" />
    <rect x="490" y="143" width="60" height="65" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="170" y="98" width="64" height="110" rx="4" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="402" y="112" width="64" height="96" rx="4" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="318" y="58" width="6" height="22" rx="3" fillOpacity="0.7" />
    <rect x="272" y="76" width="98" height="132" rx="5" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="292" y="94" width="11" height="11" rx="2" fillOpacity="0.85" />
    <rect x="338" y="94" width="11" height="11" rx="2" fillOpacity="0.85" />
    <rect x="292" y="128" width="11" height="11" rx="2" fillOpacity="0.85" />
    <rect x="338" y="128" width="11" height="11" rx="2" fillOpacity="0.85" />
    <rect x="292" y="162" width="11" height="11" rx="2" fillOpacity="0.85" />
    <rect x="338" y="162" width="11" height="11" rx="2" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="110" cy="150" r="3" />
    <circle cx="130" cy="150" r="3" />
    <circle cx="110" cy="172" r="3" />
    <circle cx="194" cy="122" r="3" />
    <circle cx="214" cy="122" r="3" />
    <circle cx="194" cy="146" r="3" />
    <circle cx="426" cy="136" r="3" />
    <circle cx="446" cy="160" r="3" />
    <circle cx="514" cy="166" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="92" cy="52" r="14" fillOpacity="0.45" />
  </g>
</svg>
