...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two monolithic slabs joined by a tangle of crossing wires, one of them red, while beside them three small cells connect through single tidy green sockets — the software crisis and the modular way out"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.22">
    <rect x="40" y="30" width="70" height="150" rx="10" />
    <rect x="200" y="30" width="70" height="150" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.32">
    <polygon points="110,43.5 110,46.5 200,141.5 200,138.5" />
    <polygon points="110,68.5 110,71.5 200,41.5 200,38.5" />
    <polygon points="110,93.5 110,96.5 200,166.5 200,163.5" />
    <polygon points="110,118.5 110,121.5 200,71.5 200,68.5" />
    <polygon points="110,148.5 110,151.5 200,106.5 200,103.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="110,163.5 110,166.5 200,46.5 200,43.5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="370" y="50" width="64" height="52" rx="11" fillOpacity="0.16" />
    <rect x="505" y="50" width="64" height="52" rx="11" fillOpacity="0.16" />
    <rect x="438" y="130" width="64" height="52" rx="11" fillOpacity="0.16" />
    <circle cx="402" cy="76" r="6" fillOpacity="0.7" />
    <circle cx="537" cy="76" r="6" fillOpacity="0.7" />
    <circle cx="470" cy="156" r="6" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="434" y="74" width="71" height="4" rx="2" fillOpacity="0.7" />
    <rect x="468" y="102" width="4" height="28" rx="2" fillOpacity="0.7" />
    <circle cx="434" cy="76" r="4.5" />
    <circle cx="505" cy="76" r="4.5" />
    <circle cx="470" cy="102" r="4.5" />
    <circle cx="470" cy="130" r="4.5" />
  </g>
</svg>
...
Engineering Conference**. The same conference is widely credited with
introducing the term *"software engineering"* itself — the idea that
building large systems was a discipline, not just typing.
</Callout>
