...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A selector dial whose needle can only rest on five fixed detent dots, while an extra value outside the dial is crossed out in red — an enum is a small, closed set of named instances"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <circle cx="320" cy="108" r="58" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="240" cy="108" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="263" cy="51" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="28" r="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="377" cy="51" r="8" />
    <circle cx="400" cy="108" r="8" fillOpacity="0.45" />
    <circle cx="320" cy="108" r="28" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="317,112 323,112 321.5,64 318.5,64" fillOpacity="0.9" />
    <circle cx="320" cy="108" r="5" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <circle cx="560" cy="158" r="7" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="546,172 542,168 572,142 576,146" fillOpacity="0.85" />
  </g>
</svg>
