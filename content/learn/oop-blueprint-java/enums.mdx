...
<CodeBlock
  ...
  starterCode={`public class Main {
    ...
    static void respond(String light) {
        if (light.equals("red"))    System.out.println("STOP");
        else if (light.equals("amber")) System.out.println("SLOW");
        else if (light.equals("green")) System.out.println("GO");
  ...
  starterCode={`public class Main {
    ...
    static void respond(Light light) {
        switch (light) {
            ...
            case AMBER: System.out.println("SLOW"); break;
...
enum Planet {
    ...
    Planet(double massKg, double radiusM) {     // enum constructor: package-private by default
        this.massKg  = massKg;
