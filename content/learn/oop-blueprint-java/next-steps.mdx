...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An open satchel packed with the shapes collected in this course, and a dotted path leading toward a rising dome on the horizon — carrying the object-oriented mental model onward"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="40" y="184" width="560" height="4" rx="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="122" cy="90" r="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="142" y="80" width="20" height="20" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.5">
    <polygon points="170,98 182,78 194,98" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="96" width="130" height="88" rx="16" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="155" cy="140" r="5" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="250" cy="172" r="3.5" />
    <circle cx="295" cy="163" r="3.5" />
    <circle cx="340" cy="153" r="3.5" />
    <circle cx="385" cy="142" r="3.5" />
    <circle cx="430" cy="131" r="3.5" />
    <circle cx="472" cy="121" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path fillOpacity="0.25" d="M480,184 a60,60 0 0 1 120,0 z" />
    <path fillOpacity="0.55" d="M506,184 a34,34 0 0 1 68,0 z" />
    <circle cx="510" cy="106" r="3" fillOpacity="0.4" />
    <circle cx="556" cy="98" r="3" fillOpacity="0.4" />
  </g>
</svg>
