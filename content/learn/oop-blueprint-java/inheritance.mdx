...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three concentric translucent rings with member dots scattered in each band and one green dot at the very center — a Dog is a Mammal is an Animal, inheritance as nested membership"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="115" r="100" fillOpacity="0.07" />
    <circle cx="320" cy="115" r="64" fillOpacity="0.12" />
    <circle cx="320" cy="115" r="32" fillOpacity="0.3" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="240" cy="62" r="5" />
    <circle cx="398" cy="90" r="5" />
    <circle cx="255" cy="170" r="5" />
    <circle cx="370" cy="180" r="5" />
  </g>
  <g fill="currentColor" opacity="0.45">
    <circle cx="290" cy="70" r="5" />
    <circle cx="365" cy="140" r="5" />
    <circle cx="272" cy="135" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="115" r="9" />
  </g>
</svg>
