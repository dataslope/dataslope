...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Three night-sky panels from different domains each contain the same four-star constellation traced with dotted lines — recurring design solutions appearing everywhere, waiting to be named"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="40" y="35" width="170" height="130" rx="14" fillOpacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="235" y="35" width="170" height="130" rx="14" fillOpacity="0.08" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="430" y="35" width="170" height="130" rx="14" fillOpacity="0.13" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="315" cy="110" r="4" />
    <circle cx="365" cy="130" r="4" />
    <circle cx="475" cy="70" r="4" />
    <circle cx="525" cy="60" r="4" />
    <circle cx="510" cy="110" r="4" />
    <circle cx="560" cy="130" r="4" />
  </g>
  <g fill="currentColor" opacity="0.32">
    <circle cx="102" cy="67" r="2" />
    <circle cx="118" cy="63" r="2" />
    <circle cx="130" cy="77" r="2" />
    <circle cx="125" cy="93" r="2" />
    <circle cx="137" cy="117" r="2" />
    <circle cx="153" cy="123" r="2" />
    <circle cx="297" cy="67" r="2" />
    <circle cx="313" cy="63" r="2" />
    <circle cx="325" cy="77" r="2" />
    <circle cx="320" cy="93" r="2" />
    <circle cx="332" cy="117" r="2" />
    <circle cx="348" cy="123" r="2" />
    <circle cx="492" cy="67" r="2" />
    <circle cx="508" cy="63" r="2" />
    <circle cx="520" cy="77" r="2" />
    <circle cx="515" cy="93" r="2" />
    <circle cx="527" cy="117" r="2" />
    <circle cx="543" cy="123" r="2" />
  </g>
