...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Three small lab stations each release a trail of idea dots that converge into one bright object — object-oriented programming assembled piece by piece between 1962 and 1980"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="40" width="54" height="36" rx="9" fillOpacity="0.2" />
    <circle cx="87" cy="58" r="7" fillOpacity="0.85" />
    <circle cx="140" cy="58" r="3.5" fillOpacity="0.5" />
    <circle cx="190" cy="66" r="3.5" fillOpacity="0.5" />
    <circle cx="240" cy="78" r="3.5" fillOpacity="0.5" />
    <circle cx="290" cy="90" r="3.5" fillOpacity="0.5" />
    <circle cx="340" cy="99" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="60" y="95" width="54" height="36" rx="9" fillOpacity="0.2" />
    <circle cx="87" cy="113" r="7" fillOpacity="0.85" />
    <circle cx="140" cy="113" r="3.5" fillOpacity="0.5" />
    <circle cx="200" cy="112" r="3.5" fillOpacity="0.5" />
    <circle cx="260" cy="111" r="3.5" fillOpacity="0.5" />
    <circle cx="320" cy="110" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="60" y="150" width="54" height="36" rx="9" fillOpacity="0.25" />
    <circle cx="87" cy="168" r="7" fillOpacity="0.9" />
    <circle cx="140" cy="168" r="3.5" fillOpacity="0.55" />
    <circle cx="190" cy="160" r="3.5" fillOpacity="0.55" />
    <circle cx="240" cy="148" r="3.5" fillOpacity="0.55" />
    <circle cx="290" cy="134" r="3.5" fillOpacity="0.55" />
    <circle cx="340" cy="121" r="3.5" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="470" cy="110" r="46" fillOpacity="0.12" />
    <circle cx="470" cy="110" r="34" />
  </g>
  <g style={{ color: "var(--ds-blue-50)" }} fill="currentColor">
    <circle cx="458" cy="100" r="4.5" fillOpacity="0.9" />
    <circle cx="483" cy="104" r="4.5" fillOpacity="0.75" />
    <circle cx="468" cy="124" r="4.5" fillOpacity="0.6" />
  </g>
</svg>
