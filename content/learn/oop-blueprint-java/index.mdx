...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A drafting sheet with a faint grid holds a small plan of three connected object nodes while a drawing compass stands beside it — designing software as a society of collaborating objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="32" width="380" height="158" rx="14" fillOpacity="0.08" />
  </g>
  <g fill="currentColor" opacity="0.14">
    <circle cx="110" cy="65" r="2.5" />
    <circle cx="180" cy="65" r="2.5" />
    <circle cx="250" cy="65" r="2.5" />
    <circle cx="390" cy="65" r="2.5" />
    <circle cx="110" cy="160" r="2.5" />
    <circle cx="250" cy="160" r="2.5" />
    <circle cx="320" cy="160" r="2.5" />
    <circle cx="390" cy="160" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="150,96.5 150,93.5 265,68.5 265,71.5" />
    <polygon points="266.5,71 263.5,70 348.5,139 351.5,138" />
    <polygon points="151,96.5 149,99 348,141.5 350,139" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g fill="currentColor" opacity="0.4">
    <polygon points="503,58 507,58 482,170 477,168" />
    <polygon points="503,58 507,58 533,168 528,170" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="505" cy="55" r="7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="488" cy="177" r="3" />
    <circle cx="505" cy="180" r="3" />
    <circle cx="522" cy="177" r="3" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="60" y="196" width="520" height="4" rx="2" />
  </g>
</svg>
