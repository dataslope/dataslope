...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A cell with a translucent membrane keeps its state dots inside; a yellow message enters only through a green gate while a red poke is stopped at the membrane — state hidden, methods exposed"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="118" r="70" fillOpacity="0.07" />
    <path fillRule="evenodd" fillOpacity="0.16" d="M232,118 a88,88 0 1 0 176,0 a88,88 0 1 0 -176,0 M250,118 a70,70 0 1 0 140,0 a70,70 0 1 0 -140,0" />
    <circle cx="300" cy="103" r="7" fillOpacity="0.9" />
    <circle cx="342" cy="131" r="6" fillOpacity="0.7" />
    <circle cx="310" cy="143" r="5" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="304" y="29" width="32" height="20" rx="8" />
    <rect x="388" y="102" width="20" height="32" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="560" cy="118" r="3.5" fillOpacity="0.55" />
    <circle cx="532" cy="118" r="3.5" fillOpacity="0.55" />
    <circle cx="504" cy="118" r="3.5" fillOpacity="0.55" />
    <circle cx="476" cy="118" r="3.5" fillOpacity="0.55" />
    <circle cx="448" cy="118" r="3.5" fillOpacity="0.55" />
    <circle cx="366" cy="118" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="180" cy="42" r="3.5" fillOpacity="0.7" />
    <circle cx="206" cy="47" r="3.5" fillOpacity="0.7" />
    <circle cx="232" cy="52" r="3.5" fillOpacity="0.7" />
    <circle cx="252" cy="56" r="5" />
  </g>
</svg>
