...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="One yellow command dot fans out along dotted paths to three differently shaped bells, and each bell answers with its own ring pattern — the same message producing different behavior at runtime"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="84" cy="115" r="10" />
    <circle cx="140" cy="103" r="3.5" fillOpacity="0.45" />
    <circle cx="196" cy="90" r="3.5" fillOpacity="0.45" />
    <circle cx="252" cy="77" r="3.5" fillOpacity="0.45" />
    <circle cx="308" cy="64" r="3.5" fillOpacity="0.45" />
    <circle cx="150" cy="115" r="3.5" fillOpacity="0.45" />
    <circle cx="210" cy="115" r="3.5" fillOpacity="0.45" />
    <circle cx="270" cy="115" r="3.5" fillOpacity="0.45" />
    <circle cx="330" cy="115" r="3.5" fillOpacity="0.45" />
    <circle cx="140" cy="128" r="3.5" fillOpacity="0.45" />
    <circle cx="196" cy="142" r="3.5" fillOpacity="0.45" />
    <circle cx="252" cy="156" r="3.5" fillOpacity="0.45" />
    <circle cx="308" cy="170" r="3.5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M360,78 a40,40 0 0 1 80,0 l0,4 l-80,0 z" />
    <circle cx="400" cy="90" r="4" />
    <circle cx="458" cy="48" r="3" fillOpacity="0.5" />
    <circle cx="462" cy="58" r="3" fillOpacity="0.5" />
    <circle cx="458" cy="68" r="3" fillOpacity="0.5" />
    <circle cx="476" cy="40" r="3" fillOpacity="0.5" />
    <circle cx="481" cy="58" r="3" fillOpacity="0.5" />
    <circle cx="476" cy="76" r="3" fillOpacity="0.5" />
    <circle cx="494" cy="32" r="3" fillOpacity="0.5" />
    <circle cx="500" cy="58" r="3" fillOpacity="0.5" />
    <circle cx="494" cy="84" r="3" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="382,96 418,96 432,136 368,136" />
    <circle cx="400" cy="142" r="4" />
    <rect x="452" y="112" width="14" height="6" rx="3" fillOpacity="0.6" />
    <rect x="474" y="112" width="10" height="6" rx="3" fillOpacity="0.45" />
    <rect x="492" y="112" width="7" height="6" rx="3" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="390" y="158" width="20" height="52" rx="9" fillOpacity="0.85" />
    <circle cx="442" cy="166" r="3.5" fillOpacity="0.5" />
    <circle cx="450" cy="184" r="3.5" fillOpacity="0.5" />
    <circle cx="442" cy="202" r="3.5" fillOpacity="0.5" />
    <circle cx="462" cy="158" r="3.5" fillOpacity="0.35" />
    <circle cx="471" cy="184" r="3.5" fillOpacity="0.35" />
    <circle cx="462" cy="206" r="3.5" fillOpacity="0.35" />
  </g>
</svg>
...
<CodeBlock
  ...
  public static void main(String[] args) {
    ...
    // Modern alternative (pattern matching instanceof, Java 16+):
...
modification**. Polymorphism is what makes that achievable.
