...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One large green ring emblem above a circle, a square, and a triangle that each wear a small copy of it — an interface as a capability badge worn by otherwise unrelated classes"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="252" cy="84" r="3" />
    <circle cx="212" cy="108" r="3" />
    <circle cx="320" cy="92" r="3" />
    <circle cx="320" cy="108" r="3" />
    <circle cx="390" cy="84" r="3" />
    <circle cx="430" cy="108" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="160" cy="152" r="36" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="284" y="116" width="72" height="72" rx="14" fillOpacity="0.9" />
  </g>
