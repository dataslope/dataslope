...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A small vehicle built from separate snap-together blocks with visible seams, while a green engine block hovers just above its slot — an object composed of smaller objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="80" y="194" width="480" height="4" rx="2" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="250" cy="177" r="17" />
    <circle cx="395" cy="177" r="17" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="250" cy="177" r="5" fillOpacity="0.9" />
    <circle cx="395" cy="177" r="5" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="180" y="140" width="280" height="32" rx="10" fillOpacity="0.9" />
    <rect x="220" y="76" width="108" height="60" rx="10" fillOpacity="0.55" />
    <rect x="336" y="98" width="120" height="38" rx="10" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="286" y="90" width="28" height="22" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="348" y="40" width="60" height="34" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="378" cy="82" r="3" />
    <circle cx="378" cy="90" r="3" />
  </g>
</svg>
