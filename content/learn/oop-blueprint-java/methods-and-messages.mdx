...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A yellow capsule travels through a pneumatic tube from one station to another while a small green capsule returns along a lower tube — a method call as a message sent and a value sent back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="68" width="90" height="74" rx="14" fillOpacity="0.2" />
    <circle cx="115" cy="105" r="11" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="480" y="68" width="90" height="74" rx="14" fillOpacity="0.2" />
    <circle cx="525" cy="105" r="11" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="160" y="86" width="320" height="34" rx="17" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="290" y="92" width="60" height="22" rx="11" fillOpacity="0.95" />
    <rect x="262" y="100" width="14" height="5" rx="2.5" fillOpacity="0.45" />
    <rect x="244" y="101" width="10" height="4" rx="2" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="312" cy="103" r="4.5" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="180" y="152" width="280" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="346" y="155" width="34" height="10" rx="5" fillOpacity="0.65" />
    <rect x="390" y="157" width="10" height="5" rx="2.5" fillOpacity="0.3" />
  </g>
</svg>
