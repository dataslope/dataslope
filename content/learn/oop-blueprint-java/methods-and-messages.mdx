...
class Printer {
    ...
    public void print(String s, int n)  { System.out.println("P: " + s + " x " + n); }
}
`}
/>
...
class Stopwatch {
    ...
    public void start() { this.running = true;  this.startNs = System.nanoTime(); }
    public void stop()  { this.stopNs  = System.nanoTime(); this.running = false; }
