...
section: [Spreadsheets vs. Databases](/learn/sqlite-for-beginners/spreadsheets-vs-databases)
(when each tool is the right one) and
[How Applications Store Information](/learn/sqlite-for-beginners/how-applications-store-information)
