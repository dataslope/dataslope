...
INSERT INTO orders (id, customer_id, amount) VALUES
  ...
  (103, 2, 99),
  (104, 7, 55);`}
  initialCode={`SELECT c.name, o.id AS order_id, o.amount
FROM customers c
...
INSERT INTO orders (id, customer_id, amount) VALUES (101, 1, 42), (102, 2, 99);`}
  initialCode={`SELECT c.name, o.amount
FROM customers c
...
INSERT INTO books (id, author_id, title) VALUES
  ...
  initialCode={`SELECT a.name AS author, b.title
FROM authors a
...
INSERT INTO orders (id, customer_id, product_id) VALUES
  ...
  (102, 1, 11),
  (103, 2, 10);`}
  initialCode={`SELECT c.name, p.title, p.price
FROM orders o
