...
INSERT INTO books (title, author, genre, price, pages) VALUES
  ...
  initialCode={`SELECT title, genre, price
FROM books
...
INSERT INTO books (title, author, genre, price, pages) VALUES
  ...
  ('SQL Street', 'Mina Park', 'Technology', 24.00, 320),
  ('Cloud Recipes', 'Ava Stone', 'Fiction', 18.25, 275);`}
  initialCode={`SELECT title, price
FROM books
WHERE price < 20;`}
/>
...
INSERT INTO books (title, author, genre, price, pages) VALUES
  ...
  ('SQL Street', 'Mina Park', 'Technology', 24.00, 320),
  ('Cloud Recipes', 'Ava Stone', 'Fiction', 18.25, 275);`}
  initialCode={`SELECT title, pages
FROM books
WHERE pages BETWEEN 200 AND 320;`}
/>
...
INSERT INTO books (title, author, genre, price, pages) VALUES
  ...
  ('SQL Street', 'Mina Park', 'Technology', 24.00, 320),
  ('Cloud Recipes', 'Ava Stone', 'Fiction', 18.25, 275);`}
  initialCode={`SELECT title, genre
FROM books
WHERE genre = 'Fiction' OR genre = 'Travel';`}
/>
...
INSERT INTO books (title, author, genre, price, pages) VALUES
  ...
  initialCode={`SELECT title, genre, price
FROM books
WHERE price < 20 AND (genre = 'Fiction' OR genre = 'Travel');`}
/>
