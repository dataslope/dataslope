...
INSERT INTO enrollments (student_id, course_id, enrolled_on) VALUES
  ...
  (2, 12, '2024-09-03'),
  (3, 11, '2024-09-02');`}
  initialCode={`SELECT * FROM enrollments ORDER BY student_id, course_id;`}
/>
...
INSERT INTO enrollments (student_id, course_id, enrolled_on) VALUES
  ...
  (2, 12, '2024-09-03'),
  (3, 11, '2024-09-02');`}
  initialCode={`SELECT s.name, c.title, e.enrolled_on
FROM enrollments e
...
INSERT INTO enrollments (student_id, course_id) VALUES
  ...
  initialCode={`SELECT c.title, COUNT(e.student_id) AS student_count
FROM courses c
...
INSERT INTO enrollments (student_id, course_id) VALUES
  (1, 10), (1, 11), (2, 10), (2, 12), (3, 11);`}
  initialCode={`SELECT s.name, COUNT(e.course_id) AS course_count
FROM students s
...
INSERT INTO enrollments (student_id, course_id, grade) VALUES
  ...
  (2, 12, 'A'),
  (3, 11, 'B');`}
  initialCode={`SELECT s.name, c.title, e.grade
FROM enrollments e
JOIN students s ON s.id = e.student_id
JOIN courses c ON c.id = e.course_id
ORDER BY s.name, c.title;`}
