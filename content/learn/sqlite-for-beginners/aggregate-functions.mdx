...
INSERT INTO orders (customer, amount) VALUES
  ...
  ('Linus', 42.75),
  ('Maya', 16.25);`}
  initialCode={`SELECT COUNT(*) AS order_count
FROM orders;`}
/>
...
INSERT INTO orders (customer, amount) VALUES
  ...
  ('Linus', 42.75),
  ('Maya', 16.25);`}
  initialCode={`SELECT SUM(amount) AS total_sales
FROM orders;`}
/>
...
INSERT INTO orders (customer, amount) VALUES
  ...
  ('Linus', 42.75),
  ('Maya', 16.25);`}
  initialCode={`SELECT ROUND(AVG(amount), 2) AS average_order
FROM orders;`}
/>
...
INSERT INTO orders (customer, amount) VALUES
  ...
  ('Ada', 42.75),
  ('Maya', 16.25);`}
  initialCode={`SELECT SUM(amount) AS ada_total
FROM orders
WHERE customer = 'Ada';`}
/>
