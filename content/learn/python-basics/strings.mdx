...
<CodeBlock
  adapter="python"
  initialCode={`d = '''also triple-quoted'''
print(d)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`print("hello".find("l"))    # 2 (first index) or -1 if not found
...
<MultipleChoice
  markdown={`What is the best way to build a string from a list of 1000 items?
