...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two knives drop at positions two and six along a loaf of character cells and the span between them lifts out as a fresh green copy — slicing reads from the first cut up to, not including, the second"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="102" y="120" width="44" height="44" fillOpacity="0.3" />
    <rect x="146" y="120" width="44" height="44" fillOpacity="0.2" />
    <rect x="190" y="120" width="44" height="44" fillOpacity="0.3" />
    <rect x="234" y="120" width="44" height="44" fillOpacity="0.2" />
    <rect x="278" y="120" width="44" height="44" fillOpacity="0.3" />
    <rect x="322" y="120" width="44" height="44" fillOpacity="0.2" />
    <rect x="366" y="120" width="44" height="44" fillOpacity="0.3" />
    <rect x="410" y="120" width="44" height="44" fillOpacity="0.2" />
    <rect x="454" y="120" width="44" height="44" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="190" y="42" width="44" height="44" rx="4" fillOpacity="0.9" />
    <rect x="234" y="42" width="44" height="44" rx="4" fillOpacity="0.7" />
    <rect x="278" y="42" width="44" height="44" rx="4" fillOpacity="0.9" />
    <rect x="322" y="42" width="44" height="44" rx="4" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="179" y="16" width="22" height="10" rx="5" />
    <polygon points="184,28 196,28 190,116" fillOpacity="0.9" />
    <rect x="355" y="16" width="22" height="10" rx="5" />
    <polygon points="360,28 372,28 366,116" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="212" cy="112" r="2.5" />
    <circle cx="212" cy="99" r="2.5" />
