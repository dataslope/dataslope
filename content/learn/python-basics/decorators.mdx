...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="The same blue ƒ box before and after the wrapping station: it comes out nested inside translucent green gift wrap with ribbon and bow, still visible within — a decorator wraps a function in new behavior without changing the function itself"
...
>
  ...
  <g fill="currentColor" opacity="0.35">
    ...
    <circle cx="236" cy="110" r="3" />
    <polygon points="254,102 270,110 254,118" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="280" y="44" width="80" height="132" rx="14" fillOpacity="0.15" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="376" cy="110" r="3" />
    <circle cx="396" cy="110" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="420" y="46" width="130" height="130" rx="20" fillOpacity="0.2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <rect x="420" y="103" width="130" height="16" fillOpacity="0.45" />
    <circle cx="471" cy="38" r="8" fillOpacity="0.7" />
    <circle cx="499" cy="38" r="8" fillOpacity="0.7" />
    <circle cx="485" cy="42" r="5" />
  </g>
</svg>
