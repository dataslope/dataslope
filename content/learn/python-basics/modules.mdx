...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four spice jars on a rack — two with lids off sprinkle dotted pinches down into the one mixing bowl below — import brings just what your program needs from each module"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="90" y="78" width="380" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="36" width="46" height="42" rx="10" fillOpacity="0.15" />
    <circle cx="123" cy="62" r="3.5" fillOpacity="0.5" />
    <circle cx="133" cy="56" r="3.5" fillOpacity="0.5" />
    <circle cx="143" cy="63" r="3.5" fillOpacity="0.5" />
    <rect x="118" y="8" width="30" height="10" rx="5" fillOpacity="0.8" transform="rotate(-15 133 13)" />
    <circle cx="160" cy="48" r="3" fillOpacity="0.45" />
    <circle cx="215" cy="76" r="3" fillOpacity="0.45" />
    <circle cx="270" cy="108" r="3" fillOpacity="0.45" />
    <circle cx="325" cy="138" r="3" fillOpacity="0.45" />
    <circle cx="380" cy="160" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="190" y="36" width="46" height="42" rx="10" fillOpacity="0.15" />
    <circle cx="203" cy="62" r="3.5" fillOpacity="0.5" />
    <circle cx="213" cy="56" r="3.5" fillOpacity="0.5" />
    <circle cx="223" cy="63" r="3.5" fillOpacity="0.5" />
    <rect x="198" y="6" width="30" height="10" rx="5" fillOpacity="0.8" transform="rotate(12 213 11)" />
    <circle cx="255" cy="60" r="3" fillOpacity="0.45" />
    <circle cx="300" cy="92" r="3" fillOpacity="0.45" />
    <circle cx="345" cy="124" r="3" fillOpacity="0.45" />
    <circle cx="390" cy="150" r="3" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="270" y="36" width="46" height="42" rx="10" fillOpacity="0.15" />
    <circle cx="283" cy="62" r="3.5" fillOpacity="0.5" />
    <circle cx="293" cy="56" r="3.5" fillOpacity="0.5" />
    <circle cx="303" cy="63" r="3.5" fillOpacity="0.5" />
    <rect x="278" y="28" width="30" height="10" rx="5" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="350" y="36" width="46" height="42" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <circle cx="363" cy="62" r="3.5" />
    <circle cx="373" cy="56" r="3.5" />
    <circle cx="383" cy="63" r="3.5" />
    <rect x="358" y="28" width="30" height="10" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="370" y="170" width="180" height="40" rx="20" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="415" cy="188" r="6" fillOpacity="0.8" />
    <circle cx="483" cy="190" r="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="450" cy="186" r="6" fillOpacity="0.8" />
    <circle cx="508" cy="187" r="5" fillOpacity="0.6" />
  </g>
</svg>
