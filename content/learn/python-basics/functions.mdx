...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A yellow boomerang sails from its thrower along a dotted arc into the ƒ block and comes back along the lower green path as a result — call a function, get a value back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="60" y="170" width="180" height="5" rx="2.5" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="190" cy="94" r="3" fillOpacity="0.5" />
    <circle cx="235" cy="74" r="3" fillOpacity="0.5" />
    <circle cx="280" cy="62" r="3" fillOpacity="0.5" />
    <circle cx="335" cy="56" r="3" fillOpacity="0.5" />
    <circle cx="390" cy="62" r="3" fillOpacity="0.5" />
    <circle cx="430" cy="74" r="3" fillOpacity="0.5" />
    <polygon points="298,46 308,22 332,32 328,40 314,34 306,48" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="430" cy="128" r="3" fillOpacity="0.5" />
    <circle cx="390" cy="142" r="3" fillOpacity="0.5" />
    <circle cx="350" cy="152" r="3" fillOpacity="0.5" />
    <circle cx="270" cy="160" r="3" fillOpacity="0.5" />
    <circle cx="230" cy="156" r="3" fillOpacity="0.5" />
    <circle cx="190" cy="148" r="3" fillOpacity="0.5" />
    <circle cx="155" cy="138" r="3" fillOpacity="0.5" />
