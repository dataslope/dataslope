...
<CodeBlock
  adapter="python"
  initialCode={`print(True == 1, False == 0)
...
<CodeBlock
  adapter="python"
  initialCode={`print(True + True + True)  # 3
print(False * 100)          # 0
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`print(None is None)
print(True is True)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`print(True and False)
print(True or False)
print(not True)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`print(True and "hello")   # 'hello'
...
<CodeBlock
  adapter="python"
  initialCode={`print(None or 0 or "first truthy")  # 'first truthy'
...
<CodeBlock
  adapter="python"
  initialCode={`# Careful: 0 is falsy, so 'or' replaces it
count = 0
...
<CodeBlock
  adapter="python"
  initialCode={`# Use a None check for cases where 0 is valid
count = 0
...
<ChallengeCard
  ...
  initialCode={`def all_truthy(items):
    # Your code here
    return False
