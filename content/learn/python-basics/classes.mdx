...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A faint master disc presses three records below it — identical grooves, but each wears its own center label — a class is the master, and every instance carries its own state"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="204" cy="122" r="3" />
    <circle cx="176" cy="140" r="3" />
    <circle cx="320" cy="112" r="3" />
    <circle cx="320" cy="128" r="3" />
    <circle cx="320" cy="144" r="3" />
    <circle cx="404" cy="104" r="3" />
    <circle cx="436" cy="122" r="3" />
    <circle cx="464" cy="140" r="3" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="150" cy="170" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="170" r="9" />
  </g>
