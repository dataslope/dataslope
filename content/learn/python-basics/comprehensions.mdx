...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Above, a faint assembly line nudges items through three separate stations; below, one bold machine carries the whole row through a single green pass — a comprehension does the loop-filter-append dance in one expression"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.1">
    <rect x="120" y="44" width="70" height="32" rx="8" />
    <rect x="250" y="44" width="70" height="32" rx="8" />
    <rect x="380" y="44" width="70" height="32" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.16">
    <circle cx="70" cy="60" r="8" />
    <circle cx="92" cy="60" r="8" />
    <rect x="470" y="52" width="16" height="16" rx="4" />
    <rect x="494" y="52" width="16" height="16" rx="4" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <circle cx="200" cy="60" r="2.5" />
    <circle cx="216" cy="60" r="2.5" />
    <circle cx="232" cy="60" r="2.5" />
    <circle cx="330" cy="60" r="2.5" />
    <circle cx="346" cy="60" r="2.5" />
    <circle cx="362" cy="60" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="128" width="360" height="58" rx="16" fillOpacity="0.22" />
    <circle cx="180" cy="157" r="11" />
    <circle cx="225" cy="157" r="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="303" y="136" width="30" height="42" rx="10" fillOpacity="0.85" />
    <rect x="352" y="146" width="22" height="22" rx="6" />
    <rect x="396" y="146" width="22" height="22" rx="6" />
    <rect x="440" y="146" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="180" y="200" width="260" height="8" rx="4" fillOpacity="0.5" />
    <polygon points="440,192 468,204 440,216" fillOpacity="0.75" />
  </g>
</svg>
