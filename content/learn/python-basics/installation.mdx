...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Two paddles rally a ball over a tiny net, the serve arcing one way and the instant reply returning beneath — the REPL's back-and-forth of prompt and answer"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.18">
    <rect x="70" y="150" width="500" height="6" rx="3" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <rect x="317" y="116" width="6" height="38" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="92" cy="118" r="13" />
    <rect x="67.5" y="127" width="9" height="26" rx="4" fillOpacity="0.8" transform="rotate(40 72 140)" />
    <circle cx="150" cy="92" r="3.5" fillOpacity="0.45" />
    <circle cx="205" cy="72" r="3.5" fillOpacity="0.45" />
    <circle cx="260" cy="60" r="3.5" fillOpacity="0.45" />
    <circle cx="315" cy="56" r="3.5" fillOpacity="0.45" />
    <circle cx="370" cy="60" r="3.5" fillOpacity="0.45" />
    <circle cx="425" cy="72" r="3.5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="548" cy="118" r="13" />
    <rect x="563.5" y="127" width="9" height="26" rx="4" fillOpacity="0.8" transform="rotate(-40 568 140)" />
    <circle cx="480" cy="104" r="3.5" fillOpacity="0.45" />
    <circle cx="420" cy="112" r="3.5" fillOpacity="0.45" />
    <circle cx="360" cy="116" r="3.5" fillOpacity="0.45" />
    <circle cx="300" cy="116" r="3.5" fillOpacity="0.45" />
    <circle cx="240" cy="112" r="3.5" fillOpacity="0.45" />
    <circle cx="180" cy="104" r="3.5" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="468" cy="82" r="8" />
  </g>
</svg>
