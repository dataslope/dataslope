...
<CodeBlock
  adapter="python"
  initialCode={`# Bind the same value to multiple names.
a = b = c = 0
print(a, b, c)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`# Unpack a sequence into multiple names.
x, y, z = [1, 2, 3]
print(x, y, z)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`# The Pythonic swap: no temporary variable needed.
x, y = 10, 20
x, y = y, x
print(x, y)
`}
