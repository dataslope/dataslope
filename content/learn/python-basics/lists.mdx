...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A coupled train of open wagons, each carrying its own shape, with one more wagon dropping into a gap mid-train — a list keeps order, holds anything, and accepts change anywhere"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="60" y="160" width="520" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="118" width="70" height="40" rx="10" fillOpacity="0.16" />
    <rect x="170" y="118" width="70" height="40" rx="10" fillOpacity="0.16" />
    <rect x="250" y="118" width="70" height="40" rx="10" fillOpacity="0.16" />
    <rect x="410" y="118" width="70" height="40" rx="10" fillOpacity="0.16" />
    <rect x="490" y="118" width="70" height="40" rx="10" fillOpacity="0.16" />
    <circle cx="125" cy="138" r="10" />
    <rect x="433" y="126" width="24" height="24" rx="6" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="330" y="118" width="70" height="40" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="108" cy="166" r="5.5" />
    <circle cx="142" cy="166" r="5.5" />
    <circle cx="188" cy="166" r="5.5" />
    <circle cx="222" cy="166" r="5.5" />
    <circle cx="268" cy="166" r="5.5" />
    <circle cx="302" cy="166" r="5.5" />
    <circle cx="428" cy="166" r="5.5" />
    <circle cx="462" cy="166" r="5.5" />
    <circle cx="508" cy="166" r="5.5" />
    <circle cx="542" cy="166" r="5.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="165" cy="140" r="3" />
    <circle cx="245" cy="140" r="3" />
    <circle cx="485" cy="140" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="193" y="126" width="24" height="24" rx="6" fillOpacity="0.9" />
    <rect x="330" y="36" width="70" height="40" rx="10" fillOpacity="0.3" />
    <circle cx="365" cy="86" r="3" fillOpacity="0.4" />
    <circle cx="365" cy="99" r="3" fillOpacity="0.4" />
    <circle cx="365" cy="112" r="3" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="285" cy="138" r="10" />
    <circle cx="365" cy="56" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="525" cy="138" r="10" />
  </g>
</svg>
