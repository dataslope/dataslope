...
<CodeBlock
  adapter="python"
  initialCode={`# Underscores for readability (Python 3.6+)
print(1_000_000)
print(0b1111_0000)
`}
/>
...
<CodeBlock
  adapter="python"
  initialCode={`print(7 / 2)   # 3.5 (float)
print(7 // 2)  # 3 (int)
`}
/>
...
<ChallengeCard
  ...
  initialCode={`def compound_interest(principal, rate, years):
    # Your code here
    return 0.0
