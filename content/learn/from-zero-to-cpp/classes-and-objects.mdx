...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A faint blueprint panel with outlined parts stamps out three crisp colored cards, each carrying the same dot and bar in its own color — one class, many objects built from it"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="40" width="200" height="150" rx="14" fillOpacity="0.12" />
    <path fillRule="evenodd" d="M104 90 a16 16 0 1 0 32 0 a16 16 0 1 0 -32 0 M109 90 a11 11 0 1 0 22 0 a11 11 0 1 0 -22 0" fillOpacity="0.4" />
    <rect x="100" y="130" width="120" height="10" rx="5" fillOpacity="0.3" />
    <rect x="100" y="150" width="86" height="10" rx="5" fillOpacity="0.3" />
    <circle cx="76" cy="56" r="3" fillOpacity="0.3" />
    <circle cx="244" cy="56" r="3" fillOpacity="0.3" />
    <circle cx="76" cy="174" r="3" fillOpacity="0.3" />
    <circle cx="244" cy="174" r="3" fillOpacity="0.3" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="288" cy="115" r="3.5" />
    <circle cx="312" cy="115" r="3.5" />
    <circle cx="336" cy="115" r="3.5" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <polygon points="354,107 354,123 370,115" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="396" y="36" width="120" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="396" y="96" width="120" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="396" y="156" width="120" height="50" rx="10" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="424" cy="61" r="8" fillOpacity="0.9" />
    <circle cx="424" cy="121" r="8" fillOpacity="0.9" />
    <circle cx="424" cy="181" r="8" fillOpacity="0.9" />
    <rect x="444" y="56" width="56" height="10" rx="5" fillOpacity="0.7" />
    <rect x="444" y="116" width="56" height="10" rx="5" fillOpacity="0.7" />
    <rect x="444" y="176" width="56" height="10" rx="5" fillOpacity="0.7" />
  </g>
</svg>
