...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Four glyph chips — a hash, double angle brackets, braces, and a zero — float around a small program card, joined to it by dotted leaders: Hello World exploded into its parts"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="248" y="76" width="144" height="68" rx="16" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="266" y="92" width="72" height="9" rx="4.5" />
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="216" cy="94" r="3" />
    <circle cx="470" cy="90" r="3" />
    <circle cx="440" cy="98" r="3" />
    <circle cx="410" cy="106" r="3" />
    <circle cx="162" cy="158" r="3" />
    <circle cx="192" cy="150" r="3" />
    <circle cx="222" cy="142" r="3" />
    <circle cx="480" cy="150" r="3" />
    <circle cx="450" cy="142" r="3" />
    <circle cx="420" cy="134" r="3" />
  </g>
</svg>
