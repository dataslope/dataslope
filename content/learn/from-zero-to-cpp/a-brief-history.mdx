...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Stacked strata of rounded layers grow sharper and bluer toward the top, where a green sprout emerges — each era of programming building on the lessons fossilized beneath it"
...
>
  ...
  <g fill="currentColor" opacity="0.2">
    <circle cx="150" cy="184" r="3.5" />
    <circle cx="260" cy="184" r="3.5" />
    <circle cx="420" cy="184" r="3.5" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="317" y="34" width="6" height="12" rx="3" />
    <circle cx="320" cy="26" r="7" />
  </g>
</svg>
