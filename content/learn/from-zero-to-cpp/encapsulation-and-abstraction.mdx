...
>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="320" cy="51" r="3.5" fillOpacity="0.5" />
    <circle cx="384" cy="115" r="3.5" fillOpacity="0.5" />
    <circle cx="320" cy="179" r="3.5" fillOpacity="0.5" />
    <circle cx="256" cy="115" r="3.5" fillOpacity="0.5" />
  </g>
