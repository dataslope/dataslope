...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two name tags tether down to one blue dot while a small pointer box on the left stores its address and aims a dotted arrow at it — references alias an object, pointers hold where it lives"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="400" cy="130" r="22" />
    <rect x="90" y="110" width="54" height="40" rx="8" fillOpacity="0.25" />
    <circle cx="117" cy="130" r="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="30" width="64" height="30" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="436" y="30" width="64" height="30" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="348" cy="76" r="3" />
    <circle cx="364" cy="92" r="3" />
    <circle cx="380" cy="106" r="3" />
    <circle cx="452" cy="78" r="3" />
    <circle cx="440" cy="94" r="3" />
    <circle cx="424" cy="108" r="3" />
    <circle cx="162" cy="130" r="3" />
    <circle cx="192" cy="130" r="3" />
    <circle cx="222" cy="130" r="3" />
    <circle cx="252" cy="130" r="3" />
    <circle cx="282" cy="130" r="3" />
    <circle cx="312" cy="130" r="3" />
    <circle cx="342" cy="130" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="360,122 360,138 374,130" fillOpacity="0.7" />
  </g>
</svg>
