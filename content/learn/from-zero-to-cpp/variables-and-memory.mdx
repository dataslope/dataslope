...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A chest of drawers with one blue drawer slid open, revealing the value 42 inside and a yellow handle to grab it by — a variable is a named drawer in memory"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="180" y="28" width="200" height="170" rx="14" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="196" y="44" width="168" height="38" rx="8" />
    <rect x="196" y="148" width="168" height="38" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="280" cy="63" r="5" />
    <circle cx="280" cy="167" r="5" />
  </g>
  ...
  <g fill="currentColor" opacity="0.25">
    <circle cx="510" cy="115" r="3" />
    <circle cx="530" cy="115" r="2.5" />
  </g>
</svg>
