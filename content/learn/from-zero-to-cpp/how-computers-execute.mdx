...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A blue CPU disc exchanges dotted read and write arrows with a column of memory pills while clock ticks pulse beneath it — processor, memory, and the beat that drives them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="200" cy="105" r="46" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="182" y="87" width="36" height="36" rx="8" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="200" cy="105" r="8" />
    <rect x="194" y="186" width="6" height="14" rx="3" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="420" y="28" width="130" height="24" rx="12" />
    <rect x="420" y="62" width="130" height="24" rx="12" />
    <rect x="420" y="130" width="130" height="24" rx="12" />
    <rect x="420" y="164" width="130" height="24" rx="12" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="420" y="96" width="130" height="24" rx="12" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="272" cy="78" r="3.5" />
    <circle cx="296" cy="78" r="3.5" />
    <circle cx="320" cy="78" r="3.5" />
    <circle cx="344" cy="78" r="3.5" />
    <circle cx="296" cy="132" r="3.5" />
    <circle cx="320" cy="132" r="3.5" />
    <circle cx="344" cy="132" r="3.5" />
    <circle cx="368" cy="132" r="3.5" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <polygon points="366,70 366,86 382,78" />
    <polygon points="274,132 290,124 290,140" />
    <rect x="150" y="186" width="6" height="14" rx="3" fillOpacity="0.5" />
    <rect x="172" y="186" width="6" height="14" rx="3" fillOpacity="0.5" />
    <rect x="216" y="186" width="6" height="14" rx="3" fillOpacity="0.5" />
    <rect x="238" y="186" width="6" height="14" rx="3" fillOpacity="0.5" />
    <rect x="260" y="186" width="6" height="14" rx="3" fillOpacity="0.5" />
  </g>
</svg>
