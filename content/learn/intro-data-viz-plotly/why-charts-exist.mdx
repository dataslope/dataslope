...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="On the left, rows of text you must read line by line; on the right, the same data as dots whose rising trend is visible at a glance, capped by a spark"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="70" y="52" width="180" height="10" rx="5" opacity="0.22" />
    <rect x="70" y="76" width="160" height="10" rx="5" opacity="0.18" />
    <rect x="70" y="100" width="174" height="10" rx="5" opacity="0.22" />
    <rect x="70" y="124" width="150" height="10" rx="5" opacity="0.18" />
    <rect x="70" y="148" width="168" height="10" rx="5" opacity="0.22" />
    <rect x="70" y="172" width="120" height="10" rx="5" opacity="0.18" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="370" y="180" width="200" height="4" rx="2" fillOpacity="0.25" />
    <circle cx="395" cy="160" r="5" />
    <circle cx="425" cy="148" r="5.5" />
    <circle cx="455" cy="132" r="6" />
    <circle cx="485" cy="118" r="6.5" />
    <circle cx="515" cy="100" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="545" cy="82" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="545,46 548,56 558,59 548,62 545,72 542,62 532,59 542,56" />
  </g>
</svg>
