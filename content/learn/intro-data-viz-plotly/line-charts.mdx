...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A dotted path climbs, flattens at milestone dots, then climbs steeply to a summit dot flying a green flag — a value evolving along time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="214" width="520" height="3" rx="1.5" fill="currentColor" opacity="0.15" />
  <g fill="currentColor" opacity="0.3">
    <circle cx="80" cy="200" r="3" />
    <circle cx="108" cy="194" r="3" />
    <circle cx="136" cy="186" r="3" />
    <circle cx="164" cy="176" r="3" />
    <circle cx="192" cy="168" r="3" />
    <circle cx="220" cy="158" r="3" />
    <circle cx="248" cy="152" r="3" />
    <circle cx="276" cy="148" r="3" />
    <circle cx="304" cy="146" r="3" />
    <circle cx="332" cy="142" r="3" />
    <circle cx="360" cy="132" r="3" />
    <circle cx="384" cy="116" r="3" />
    <circle cx="408" cy="98" r="3" />
    <circle cx="432" cy="80" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="234" cy="155" r="7" />
    <circle cx="346" cy="138" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="458" cy="62" r="11" />
    <polygon points="462,24 462,46 496,35" />
  </g>
  <rect x="459" y="26" width="4" height="32" rx="2" fill="currentColor" opacity="0.35" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="520" cy="48" r="4" fillOpacity="0.7" />
    <circle cx="546" cy="40" r="3" fillOpacity="0.5" />
  </g>
</svg>
