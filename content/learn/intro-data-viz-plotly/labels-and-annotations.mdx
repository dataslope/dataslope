...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A chart wearing its title and subtitle, with an annotation tag leading down a dotted line to the one yellow point it explains"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="200" y="30" width="240" height="16" rx="8" opacity="0.3" />
    <rect x="230" y="54" width="180" height="8" rx="4" opacity="0.15" />
    <rect x="110" y="80" width="3" height="130" rx="1.5" opacity="0.25" />
    <rect x="110" y="207" width="400" height="3" rx="1.5" opacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.75">
    <circle cx="160" cy="180" r="6" />
    <circle cx="220" cy="160" r="6" />
    <circle cx="280" cy="168" r="6" />
    <circle cx="400" cy="142" r="6" />
    <circle cx="460" cy="120" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="340" cy="130" r="8" />
    <rect x="380" y="76" width="120" height="30" rx="8" fillOpacity="0.25" />
    <rect x="394" y="87" width="92" height="8" rx="4" fillOpacity="0.7" />
    <circle cx="372" cy="96" r="2.5" fillOpacity="0.7" />
    <circle cx="360" cy="108" r="2.5" fillOpacity="0.7" />
    <circle cx="349" cy="120" r="2.5" fillOpacity="0.7" />
  </g>
</svg>
