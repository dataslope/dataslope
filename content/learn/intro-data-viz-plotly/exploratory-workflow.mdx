...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="Four station dots ride a circular loop with arrows showing its direction, the dataset square at the center — load, plot, look, refine, repeat"
  style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", margin: "2.5rem auto" }}
>
  <path d="M248 125 a72 72 0 1 0 144 0 a72 72 0 1 0 -144 0 Z M256 125 a64 64 0 1 0 128 0 a64 64 0 1 0 -128 0 Z" fillRule="evenodd" fill="currentColor" opacity="0.12" />
  <g fill="currentColor" opacity="0.35">
    <polygon points="0,-6 0,6 10,0" transform="translate(368 173) rotate(135)" />
    <polygon points="0,-6 0,6 10,0" transform="translate(272 173) rotate(225)" />
    <polygon points="0,-6 0,6 10,0" transform="translate(272 77) rotate(315)" />
    <polygon points="0,-6 0,6 10,0" transform="translate(368 77) rotate(45)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="53" r="13" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="392" cy="125" r="13" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="197" r="13" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="248" cy="125" r="13" fillOpacity="0.55" />
  </g>
  <rect x="302" y="107" width="36" height="36" rx="8" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="125" r="6" />
  </g>
</svg>
