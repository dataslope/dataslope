...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A yellow selection rectangle brushed over a small chart expands along dotted lines into a second panel where the selected dots appear magnified — zooming as a way of asking questions"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="50" width="220" height="150" rx="10" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.75">
    <circle cx="95" cy="172" r="4" />
    <circle cx="115" cy="152" r="4" />
    <circle cx="135" cy="162" r="4" />
    <circle cx="160" cy="120" r="4" />
    <circle cx="175" cy="108" r="4.5" />
    <circle cx="190" cy="125" r="4" />
    <circle cx="205" cy="112" r="4" />
    <circle cx="232" cy="82" r="4" />
    <circle cx="252" cy="95" r="4" />
    <circle cx="268" cy="70" r="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="148" y="93" width="72" height="52" rx="6" fillOpacity="0.25" />
  </g>
  <g fill="currentColor" opacity="0.28">
    <circle cx="255" cy="86" r="3" />
    <circle cx="292" cy="76" r="3" />
    <circle cx="329" cy="66" r="3" />
    <circle cx="255" cy="153" r="3" />
    <circle cx="292" cy="163" r="3" />
    <circle cx="329" cy="173" r="3" />
  </g>
  <rect x="370" y="40" width="210" height="170" rx="10" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="420" cy="142" r="11" />
    <circle cx="490" cy="152" r="10" />
    <circle cx="530" cy="105" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="455" cy="92" r="12" />
  </g>
</svg>
