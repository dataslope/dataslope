...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A small crane lowers the next data point on a cable toward its empty outlined slot in a half-built chart — building a chart one decision at a time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="60" y="200" width="520" height="4" rx="2" />
    <rect x="110" y="80" width="4" height="120" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="155" cy="178" r="8" />
    <circle cx="205" cy="158" r="8" />
    <circle cx="255" cy="140" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="480" y="60" width="10" height="140" rx="4" fillOpacity="0.85" />
    <rect x="290" y="56" width="200" height="10" rx="5" />
    <rect x="494" y="52" width="26" height="18" rx="4" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="485,38 485,56 504,47" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <rect x="298" y="66" width="3" height="42" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="299.5" cy="117" r="9" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <path d="M289 160 a11 11 0 1 0 22 0 a11 11 0 1 0 -22 0 Z M292 160 a8 8 0 1 0 16 0 a8 8 0 1 0 -16 0 Z" fillRule="evenodd" />
  </g>
</svg>
