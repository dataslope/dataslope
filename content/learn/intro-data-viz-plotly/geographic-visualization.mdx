...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two abstract landmasses shaded at different depths like a choropleth, dotted latitude lines behind them, and blue location dots scattered on top"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <circle cx="70" cy="65" r="2" />
    <circle cx="130" cy="65" r="2" />
    <circle cx="190" cy="65" r="2" />
    <circle cx="250" cy="65" r="2" />
    <circle cx="310" cy="65" r="2" />
    <circle cx="370" cy="65" r="2" />
    <circle cx="430" cy="65" r="2" />
    <circle cx="490" cy="65" r="2" />
    <circle cx="550" cy="65" r="2" />
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="100,80 170,60 230,75 250,120 220,170 150,185 95,150 80,110" fillOpacity="0.3" />
    <polygon points="330,95 420,70 500,85 545,130 515,180 430,195 355,165 330,130" fillOpacity="0.5" />
    <polygon points="420,70 500,85 545,130 515,180 470,150 430,110" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="150" cy="120" r="6" />
    <circle cx="205" cy="143" r="5" />
    <circle cx="445" cy="120" r="7" />
    <circle cx="487" cy="158" r="5" />
    <circle cx="390" cy="103" r="5" />
  </g>
</svg>
