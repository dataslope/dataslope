...
description: Reading and drawing ER diagrams — the standard picture of a database's tables, keys, and the relationships between them.
---
...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A miniature entity relationship diagram — three entity boxes with header bands and attribute bars, linked by relationship lines"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <rect x="250" y="72" width="140" height="5" rx="2.5" />
    <polygon points="178,116 182,116 302,142 298,142" />
    <polygon points="457,116 463,116 373,143 367,143" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="36" width="140" height="80" rx="10" fillOpacity="0.14" />
    <rect x="122" y="48" width="80" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="390" y="36" width="140" height="80" rx="10" fillOpacity="0.14" />
    <rect x="402" y="48" width="80" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="250" y="140" width="140" height="70" rx="10" fillOpacity="0.14" />
    <rect x="262" y="152" width="80" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="122" y="68" width="100" height="6" rx="3" />
    <rect x="122" y="80" width="76" height="6" rx="3" />
    <rect x="122" y="92" width="88" height="6" rx="3" />
    <rect x="402" y="68" width="100" height="6" rx="3" />
    <rect x="402" y="80" width="76" height="6" rx="3" />
    <rect x="402" y="92" width="88" height="6" rx="3" />
    <rect x="262" y="172" width="100" height="6" rx="3" />
    <rect x="262" y="184" width="76" height="6" rx="3" />
  </g>
</svg>
