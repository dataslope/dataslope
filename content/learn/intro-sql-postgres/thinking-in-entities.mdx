...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three crisp entity cards stamped out of an amorphous blob of real-world detail — spotting the distinct things a system is about"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <path d="M80 110 Q90 50 170 44 Q250 38 300 70 Q360 40 420 64 Q470 84 450 130 Q480 170 420 186 Q350 206 280 184 Q210 204 150 182 Q70 160 80 110 Z" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="64" width="120" height="76" rx="10" fillOpacity="0.25" />
    <rect x="132" y="76" width="70" height="9" rx="4.5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="280" y="96" width="120" height="76" rx="10" fillOpacity="0.25" />
    <rect x="292" y="108" width="70" height="9" rx="4.5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="440" y="56" width="120" height="76" rx="10" fillOpacity="0.25" />
    <rect x="452" y="68" width="70" height="9" rx="4.5" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <rect x="132" y="98" width="90" height="6" rx="3" />
    <rect x="132" y="112" width="70" height="6" rx="3" />
    <rect x="292" y="130" width="90" height="6" rx="3" />
    <rect x="292" y="144" width="70" height="6" rx="3" />
    <rect x="452" y="90" width="90" height="6" rx="3" />
    <rect x="452" y="104" width="70" height="6" rx="3" />
  </g>
</svg>
