...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A green flag planted on the nearest peak of a mountain range at sunrise — the foundation climbed, with higher summits waiting ahead"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="320" cy="78" r="48" fillOpacity="0.15" />
    <circle cx="320" cy="78" r="34" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <polygon points="60,166 200,90 340,166" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <polygon points="220,166 370,76 530,166" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="80,190 240,100 410,190" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="300,190 460,96 620,190" fillOpacity="0.25" />
  </g>
  <g fill="currentColor" opacity="0.5">
    <rect x="238" y="64" width="4" height="38" rx="2" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="242,64 280,74 242,84" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="60" y="190" width="520" height="5" rx="2.5" />
  </g>
</svg>
...
[Spreadsheets vs. Databases](/learn/intro-sql-postgres/spreadsheets-vs-databases)
and [How Applications Use
Databases](/learn/intro-sql-postgres/how-applications-use-databases)
