...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A faint grid of cells with colored value dots; a yellow band highlights one row and a green band highlights one column, crossing at a single cell"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="132" y="72" width="376" height="42" rx="10" fillOpacity="0.15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="204" y="28" width="88" height="170" rx="10" fillOpacity="0.15" />
  </g>
  <g fill="currentColor" opacity="0.08">
    <rect x="144" y="40" width="64" height="30" rx="6" />
    <rect x="216" y="40" width="64" height="30" rx="6" />
    <rect x="288" y="40" width="64" height="30" rx="6" />
    <rect x="360" y="40" width="64" height="30" rx="6" />
    <rect x="432" y="40" width="64" height="30" rx="6" />
    <rect x="144" y="78" width="64" height="30" rx="6" />
    <rect x="216" y="78" width="64" height="30" rx="6" />
    <rect x="288" y="78" width="64" height="30" rx="6" />
    <rect x="360" y="78" width="64" height="30" rx="6" />
    <rect x="432" y="78" width="64" height="30" rx="6" />
    <rect x="144" y="116" width="64" height="30" rx="6" />
    <rect x="216" y="116" width="64" height="30" rx="6" />
    <rect x="288" y="116" width="64" height="30" rx="6" />
    <rect x="360" y="116" width="64" height="30" rx="6" />
    <rect x="432" y="116" width="64" height="30" rx="6" />
    <rect x="144" y="154" width="64" height="30" rx="6" />
    <rect x="216" y="154" width="64" height="30" rx="6" />
    <rect x="288" y="154" width="64" height="30" rx="6" />
    <rect x="360" y="154" width="64" height="30" rx="6" />
    <rect x="432" y="154" width="64" height="30" rx="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="176" cy="55" r="5.5" />
    <circle cx="176" cy="93" r="5.5" />
    <circle cx="176" cy="131" r="5.5" />
    <circle cx="176" cy="169" r="5.5" />
    <circle cx="248" cy="93" r="7.5" />
    <circle cx="392" cy="55" r="5.5" fillOpacity="0.55" />
    <circle cx="320" cy="131" r="5.5" fillOpacity="0.55" />
    <circle cx="464" cy="169" r="5.5" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="55" r="5.5" fillOpacity="0.55" />
    <circle cx="248" cy="131" r="5.5" fillOpacity="0.55" />
    <circle cx="392" cy="93" r="5.5" fillOpacity="0.55" />
    <circle cx="248" cy="169" r="5.5" fillOpacity="0.55" />
    <circle cx="464" cy="131" r="5.5" fillOpacity="0.55" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="464" cy="55" r="5.5" fillOpacity="0.55" />
    <circle cx="464" cy="93" r="5.5" fillOpacity="0.55" />
    <circle cx="392" cy="131" r="5.5" fillOpacity="0.55" />
    <circle cx="320" cy="93" r="5.5" fillOpacity="0.55" />
    <circle cx="320" cy="169" r="5.5" fillOpacity="0.55" />
    <circle cx="392" cy="169" r="5.5" fillOpacity="0.55" />
  </g>
</svg>
