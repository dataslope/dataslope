...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A bar chart of group totals measured against a dotted threshold line — only the groups whose summary clears the line stay colored"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <rect x="120" y="180" width="400" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="150" y="70" width="56" height="110" rx="8" fillOpacity="0.8" />
    <rect x="310" y="50" width="56" height="130" rx="8" fillOpacity="0.8" />
    <rect x="470" y="95" width="56" height="85" rx="8" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="230" y="120" width="56" height="60" rx="8" />
    <rect x="390" y="140" width="56" height="40" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="132" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="158" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="184" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="210" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="236" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="262" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="288" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="314" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="340" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="366" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="392" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="418" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="444" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="470" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="496" cy="105" r="3" fillOpacity="0.7" />
    <circle cx="522" cy="105" r="3" fillOpacity="0.7" />
  </g>
</svg>
