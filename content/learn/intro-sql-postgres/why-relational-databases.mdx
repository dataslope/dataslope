...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Four mini table cards floating like stars in a constellation, linked to each other by dotted edges of shared values"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="40" width="90" height="64" rx="8" fillOpacity="0.14" />
    <rect x="98" y="48" width="74" height="10" rx="5" fillOpacity="0.6" />
    <rect x="240" y="128" width="90" height="64" rx="8" fillOpacity="0.14" />
    <rect x="248" y="136" width="74" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="300" y="28" width="90" height="64" rx="8" fillOpacity="0.14" />
    <rect x="308" y="36" width="74" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="480" y="70" width="90" height="64" rx="8" fillOpacity="0.14" />
    <rect x="488" y="78" width="74" height="10" rx="5" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="98" y="66" width="60" height="6" rx="3" />
    <rect x="98" y="78" width="44" height="6" rx="3" />
    <rect x="308" y="54" width="60" height="6" rx="3" />
    <rect x="308" y="66" width="44" height="6" rx="3" />
    <rect x="488" y="96" width="60" height="6" rx="3" />
    <rect x="488" y="108" width="44" height="6" rx="3" />
    <rect x="248" y="154" width="60" height="6" rx="3" />
    <rect x="248" y="166" width="44" height="6" rx="3" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="200" cy="64" r="3" />
    <circle cx="225" cy="60" r="3" />
    <circle cx="250" cy="57" r="3" />
    <circle cx="275" cy="54" r="3" />
    <circle cx="405" cy="72" r="3" />
    <circle cx="430" cy="78" r="3" />
    <circle cx="455" cy="85" r="3" />
    <circle cx="175" cy="110" r="3" />
    <circle cx="200" cy="116" r="3" />
    <circle cx="228" cy="122" r="3" />
    <circle cx="355" cy="156" r="3" />
    <circle cx="385" cy="150" r="3" />
    <circle cx="415" cy="145" r="3" />
    <circle cx="445" cy="140" r="3" />
  </g>
</svg>
