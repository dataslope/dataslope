...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three table columns each accept only one shape of value — round numbers, bar text, diamond dates — while a mismatched red bar bounces off the number column"
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="70" y="100" width="48" height="12" rx="6" fillOpacity="0.85" />
    <circle cx="136" cy="98" r="3.5" fillOpacity="0.4" />
    <circle cx="148" cy="88" r="3.5" fillOpacity="0.3" />
    <circle cx="154" cy="74" r="3.5" fillOpacity="0.2" />
  </g>
</svg>
...
This is the database doing one of its five core jobs from earlier:
