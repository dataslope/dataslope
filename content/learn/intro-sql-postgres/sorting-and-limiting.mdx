...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Unsorted bars on the left are reordered by length on the right along dotted swap trails, and a translucent green band keeps only the top three"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="34" width="90" height="24" rx="8" fillOpacity="0.7" />
    <rect x="90" y="71" width="150" height="24" rx="8" fillOpacity="0.7" />
    <rect x="90" y="108" width="60" height="24" rx="8" fillOpacity="0.7" />
    <rect x="90" y="145" width="180" height="24" rx="8" fillOpacity="0.7" />
    <rect x="90" y="182" width="120" height="24" rx="8" fillOpacity="0.7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="290" cy="150" r="3" />
    <circle cx="318" cy="124" r="3" />
    <circle cx="346" cy="96" r="3" />
    <circle cx="374" cy="68" r="3" />
    <circle cx="290" cy="56" r="3" />
    <circle cx="318" cy="86" r="3" />
    <circle cx="346" cy="118" r="3" />
    <circle cx="374" cy="148" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="392" y="26" width="206" height="114" rx="12" fillOpacity="0.12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="400" y="34" width="180" height="24" rx="8" fillOpacity="0.85" />
    <rect x="400" y="71" width="150" height="24" rx="8" fillOpacity="0.85" />
    <rect x="400" y="108" width="120" height="24" rx="8" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="400" y="145" width="90" height="24" rx="8" />
    <rect x="400" y="182" width="60" height="24" rx="8" />
  </g>
</svg>
