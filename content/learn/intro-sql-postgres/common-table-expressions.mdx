...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Deeply nested query boxes unroll into a straight pipeline of steps — the first step wears a yellow name tag that later steps simply refer to"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="80" y="24" width="210" height="76" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.09">
    <rect x="96" y="38" width="178" height="48" rx="8" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="112" y="50" width="140" height="24" rx="6" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="312" cy="62" r="3" />
    <circle cx="340" cy="74" r="3" />
    <circle cx="366" cy="90" r="3" />
    <circle cx="388" cy="108" r="3" />
    <polygon points="396,112 410,124 392,130" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="146" width="140" height="54" rx="10" fillOpacity="0.12" />
    <rect x="270" y="146" width="140" height="54" rx="10" fillOpacity="0.12" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="104" y="164" width="80" height="7" rx="3.5" />
    <rect x="104" y="178" width="60" height="7" rx="3.5" />
    <rect x="284" y="162" width="70" height="7" rx="3.5" />
    <rect x="496" y="170" width="70" height="7" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="102" y="138" width="64" height="16" rx="8" fillOpacity="0.9" />
    <rect x="284" y="176" width="44" height="12" rx="6" fillOpacity="0.75" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="450" y="146" width="140" height="54" rx="10" fillOpacity="0.15" />
    <circle cx="480" cy="173" r="7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="236,166 236,182 250,174" />
    <polygon points="416,166 416,182 430,174" />
  </g>
</svg>
