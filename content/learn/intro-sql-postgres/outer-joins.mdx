...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A LEFT JOIN keeps every left half-row solid blue; where no partner exists the right half remains a pale ghost instead of disappearing"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="36" width="160" height="30" rx="9" fillOpacity="0.8" />
    <rect x="150" y="80" width="160" height="30" rx="9" fillOpacity="0.8" />
    <rect x="150" y="124" width="160" height="30" rx="9" fillOpacity="0.8" />
    <rect x="150" y="168" width="160" height="30" rx="9" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="320" y="36" width="160" height="30" rx="9" fillOpacity="0.8" />
    <rect x="320" y="124" width="160" height="30" rx="9" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.07">
    <rect x="320" y="80" width="160" height="30" rx="9" />
    <rect x="320" y="168" width="160" height="30" rx="9" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="174" cy="51" r="3.5" />
    <circle cx="196" cy="51" r="3.5" />
    <circle cx="174" cy="95" r="3.5" />
    <circle cx="196" cy="95" r="3.5" />
    <circle cx="174" cy="139" r="3.5" />
    <circle cx="196" cy="139" r="3.5" />
    <circle cx="174" cy="183" r="3.5" />
    <circle cx="196" cy="183" r="3.5" />
    <circle cx="344" cy="51" r="3.5" />
    <circle cx="366" cy="51" r="3.5" />
    <circle cx="344" cy="139" r="3.5" />
    <circle cx="366" cy="139" r="3.5" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="344" y="92" width="44" height="6" rx="3" />
    <rect x="344" y="180" width="44" height="6" rx="3" />
  </g>
</svg>
...
INSERT INTO customers (name) VALUES ('Ada'), ('Grace'), ('Linus'), ('Mae');
INSERT INTO orders (customer_id, amount) VALUES
  (1, 42.00), (2, 99.00), (2, 15.00);`}
  starterCode={`SELECT
  c.name
FROM
  customers c
