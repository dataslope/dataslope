...
This is the duplication cure from the **Spreadsheets vs. Databases**
page, now given a precise mechanism.
...
INSERT INTO customers (name) VALUES ('Ada'), ('Grace');`}
  initialCode={`-- Customer 1 (Ada) exists, so this is fine:
INSERT INTO orders (customer_id, amount) VALUES (1, 42);

-- Customer 99 does NOT exist; the foreign key blocks this:
INSERT INTO orders (customer_id, amount) VALUES (99, 17);
