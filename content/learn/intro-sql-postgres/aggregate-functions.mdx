...
INSERT INTO employees (name, dept, salary) VALUES
  ...
  starterCode={`SELECT COUNT(*) AS employee_count
FROM employees;`}
/>
...
INSERT INTO employees (name, dept, salary) VALUES
  ('Alice','Engineering',120000),('Bob','Engineering',95000),
  ('Carol','Sales',80000),('Dave','Sales',72000),('Eve','Marketing',68000);`}
  starterCode={`SELECT ROUND(AVG(salary)) AS avg_eng_salary
FROM employees
...
FROM payments;
`}
  solutionSql={`SELECT COUNT(*) AS n, SUM(amount) AS total, AVG(amount) AS avg FROM payments;`}
  tests={[
    {
      id: "columns",
