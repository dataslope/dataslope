...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three rows with identical values are told apart only by the numbered key badges on the left — each row has its own identity"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="170" y="30" width="320" height="44" rx="12" />
    <rect x="170" y="88" width="320" height="44" rx="12" />
    <rect x="170" y="146" width="320" height="44" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="260" cy="52" r="8" fillOpacity="0.7" />
    <circle cx="260" cy="110" r="8" fillOpacity="0.7" />
    <circle cx="260" cy="168" r="8" fillOpacity="0.7" />
    <circle cx="140" cy="52" r="16" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="296" y="47" width="70" height="10" rx="5" fillOpacity="0.5" />
    <rect x="296" y="105" width="70" height="10" rx="5" fillOpacity="0.5" />
    <rect x="296" y="163" width="70" height="10" rx="5" fillOpacity="0.5" />
    <circle cx="140" cy="110" r="16" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="430" cy="52" r="8" fillOpacity="0.7" />
    <circle cx="430" cy="110" r="8" fillOpacity="0.7" />
    <circle cx="430" cy="168" r="8" fillOpacity="0.7" />
