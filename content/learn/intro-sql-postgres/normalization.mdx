...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="One wide table divides into two smaller ones — a fact repeated as three identical green dots collapses into a single green dot stored once"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="170" y="24" width="300" height="68" rx="10" />
    <rect x="120" y="136" width="190" height="64" rx="10" />
    <rect x="380" y="148" width="150" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="196" cy="40" r="5" />
    <circle cx="196" cy="58" r="5" />
    <circle cx="196" cy="76" r="5" />
    <circle cx="142" cy="152" r="5" />
    <circle cx="142" cy="168" r="5" />
    <circle cx="142" cy="184" r="5" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <rect x="212" y="37" width="52" height="6" rx="3" />
    <rect x="212" y="55" width="52" height="6" rx="3" />
    <rect x="212" y="73" width="52" height="6" rx="3" />
    <rect x="316" y="37" width="120" height="6" rx="3" />
    <rect x="316" y="55" width="120" height="6" rx="3" />
    <rect x="316" y="73" width="120" height="6" rx="3" />
    <rect x="156" y="149" width="60" height="6" rx="3" />
    <rect x="156" y="165" width="60" height="6" rx="3" />
    <rect x="156" y="181" width="60" height="6" rx="3" />
    <rect x="420" y="167" width="80" height="6" rx="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="300" cy="40" r="5" />
    <circle cx="300" cy="58" r="5" />
    <circle cx="300" cy="76" r="5" />
    <circle cx="404" cy="170" r="6.5" />
    <circle cx="318" cy="94" r="3" fillOpacity="0.4" />
    <circle cx="338" cy="110" r="3" fillOpacity="0.35" />
    <circle cx="358" cy="126" r="3" fillOpacity="0.3" />
    <circle cx="378" cy="142" r="3" fillOpacity="0.25" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="240" cy="152" r="5" />
    <circle cx="240" cy="168" r="5" />
    <circle cx="240" cy="184" r="5" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <polygon points="226,100 236,100 200,130 190,130" />
  </g>
</svg>
...
whole key, and nothing but the key."** That phrasing comes from a
1983 paper by William Kent that translated the normal forms into
plain English — and database folk traditionally complete it with a
wink: *"…so help me Codd,"* in honor of Edgar Codd, who defined the
normal forms in the first place.
