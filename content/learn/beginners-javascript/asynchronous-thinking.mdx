...
<svg
  viewBox="0 0 640 215"
  role="img"
  aria-label="A clock beside two timelines: the top one blocked by a single long red bar, the bottom one filled with many small colorful bars in the same span"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <circle cx="90" cy="60" r="26" opacity="0.1" />
    <rect x="88" y="40" width="4" height="22" rx="2" opacity="0.5" />
    <rect x="90" y="58" width="16" height="4" rx="2" opacity="0.5" />
    <rect x="150" y="86" width="4" height="38" rx="2" opacity="0.15" />
    <rect x="150" y="156" width="4" height="38" rx="2" opacity="0.15" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="160" y="90" width="240" height="30" rx="15" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="412" y="90" width="100" height="30" rx="15" />
    <rect x="160" y="160" width="70" height="30" rx="15" />
    <rect x="386" y="160" width="50" height="30" rx="15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="242" y="160" width="56" height="30" rx="15" />
    <rect x="448" y="160" width="64" height="30" rx="15" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="310" y="160" width="64" height="30" rx="15" />
  </g>
</svg>
