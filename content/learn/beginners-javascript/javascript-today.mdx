...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A row of rounded bars rising from left to right, the tallest in blue, with an even taller faint bar still ahead"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="80" y="190" width="480" height="4" rx="2" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="120" y="116" width="56" height="70" rx="12" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="212" y="86" width="56" height="100" rx="12" />
    <circle cx="424" cy="16" r="7" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="304" y="56" width="56" height="130" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="396" y="30" width="56" height="156" rx="12" />
    <rect x="488" y="10" width="56" height="176" rx="12" fillOpacity="0.22" />
  </g>
</svg>
