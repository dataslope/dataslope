...
<svg
  viewBox="0 0 640 260"
  role="img"
  aria-label="Circles, squares, and triangles bursting outward in rings from a central circle — an ecosystem exploding"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.2">
    <circle cx="560" cy="130" r="3" />
    <circle cx="80" cy="130" r="3" />
    <circle cx="525" cy="38" r="3" />
    <circle cx="115" cy="222" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="130" r="26" />
    <circle cx="250" cy="130" r="10" />
    <circle cx="435" cy="130" r="7" />
    <rect x="233" y="205" width="12" height="12" rx="3" />
    <circle cx="450" cy="55" r="4" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="390" cy="130" r="10" />
    <rect x="276" y="182" width="18" height="18" rx="4" />
    <rect x="395" y="43" width="12" height="12" rx="3" />
    <circle cx="205" cy="130" r="7" />
    <circle cx="320" cy="245" r="5" />
    <circle cx="450" cy="205" r="4" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="346" y="60" width="18" height="18" rx="4" />
    <circle cx="355" cy="191" r="9" />
    <circle cx="320" cy="15" r="6" />
    <circle cx="401" cy="211" r="6" />
    <circle cx="190" cy="55" r="4" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="285,58 296,78 274,78" />
    <circle cx="239" cy="49" r="5" />
    <circle cx="170" cy="205" r="3" fillOpacity="0.6" />
  </g>
</svg>
...
section](/learn/beginners-javascript/javascript-beyond-the-browser)
...
2. **The platform APIs** — what your code can *do* depends on
   where it runs. Browsers add the DOM and `fetch`; Node.js adds
