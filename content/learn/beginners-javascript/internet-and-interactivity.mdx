...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A constellation of colored dots joined by faint dotted lines — pages linked into a web"
...
>
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="305" cy="130" r="3" />
    <circle cx="360" cy="127" r="3" />
    <circle cx="390" cy="105" r="3" />
    <circle cx="420" cy="82" r="3" />
    <circle cx="478" cy="77" r="3" />
    <circle cx="505" cy="95" r="3" />
    <circle cx="532" cy="112" r="3" />
    <circle cx="312" cy="160" r="3" />
    <circle cx="295" cy="170" r="3" />
    <circle cx="278" cy="180" r="3" />
    <circle cx="378" cy="162" r="3" />
    <circle cx="425" cy="175" r="3" />
    <circle cx="472" cy="187" r="3" />
    <circle cx="285" cy="67" r="3" />
    <circle cx="340" cy="65" r="3" />
    <circle cx="395" cy="62" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="110" cy="150" r="16" />
    <circle cx="230" cy="70" r="12" />
    <circle cx="450" cy="60" r="14" />
    <circle cx="520" cy="200" r="8" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="330" cy="150" r="20" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="560" cy="130" r="12" />
  </g>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.js",
      starterCode: `// Pretend this is form input from the user.
