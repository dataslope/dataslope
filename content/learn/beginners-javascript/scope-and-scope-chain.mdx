...
<CodeBlock
  adapter="javascript"
  initialCode={`const outside = "I am global";
...
<CodeBlock
  adapter="javascript"
  initialCode={`const country = "Wonderland";
...
<CodeBlock
  adapter="javascript"
  initialCode={`// Bad style: a global counter modified from anywhere
let count = 0;
...
<CodeBlock
  adapter="javascript"
  initialCode={`// This works because of function hoisting:
...
<CodeBlock
  adapter="javascript"
  initialCode={`const planet = "Earth";
