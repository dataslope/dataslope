...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Three nested translucent layers, each holding a colored dot, with a dotted trail leading from the innermost dot outward through every layer"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="30" width="500" height="180" rx="24" fillOpacity="0.12" />
    <rect x="130" y="62" width="330" height="120" rx="20" fillOpacity="0.2" />
    <rect x="180" y="92" width="180" height="64" rx="16" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="230" cy="124" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="425" cy="150" r="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="520" cy="60" r="10" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="270" cy="130" r="3" />
    <circle cx="310" cy="136" r="3" />
    <circle cx="350" cy="141" r="3" />
    <circle cx="390" cy="146" r="3" />
    <circle cx="450" cy="128" r="3" />
    <circle cx="472" cy="106" r="3" />
    <circle cx="494" cy="83" r="3" />
  </g>
</svg>
