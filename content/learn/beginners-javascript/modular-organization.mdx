...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Building bricks with studs in two interlocking rows, and a red brick hovering above a dashed outline showing where it snaps in — modules fitting together"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="150" r="9" />
    <circle cx="240" cy="150" r="9" />
    <circle cx="300" cy="150" r="9" />
    <rect x="140" y="150" width="200" height="52" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="392" cy="150" r="9" />
    <circle cx="452" cy="150" r="9" />
    <circle cx="512" cy="150" r="9" />
    <rect x="352" y="150" width="200" height="52" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="236" cy="88" r="9" />
    <circle cx="304" cy="88" r="9" />
    <circle cx="372" cy="88" r="9" />
    <rect x="196" y="88" width="216" height="52" rx="10" />
  </g>
  <rect
    x="424"
    y="88"
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="464" cy="24" r="9" />
    <circle cx="512" cy="24" r="9" />
    <rect x="424" y="24" width="128" height="52" rx="10" />
  </g>
</svg>
