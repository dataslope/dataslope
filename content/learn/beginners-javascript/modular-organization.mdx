...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Four file cards with faded code lines inside, joined by thin dependency lines — one entry module importing from the others"
...
>
  <g
    ...
    opacity="0.25"
  >
    <path d="M185 108 C 178 122, 170 136, 163 146" />
    <path d="M250 108 C 285 122, 318 136, 342 146" />
    <path d="M290 72 C 350 72, 408 80, 466 90" />
    <path d="M402 146 C 440 138, 472 132, 502 124" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="140" y="36" width="150" height="72" rx="14" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="156" y="54" width="60" height="8" rx="4" />
    <rect x="156" y="70" width="44" height="8" rx="4" />
    <rect x="156" y="86" width="52" height="8" rx="4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="90" y="150" width="124" height="56" rx="12" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="104" y="166" width="44" height="7" rx="3.5" />
    <rect x="104" y="180" width="32" height="7" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="150" width="124" height="56" rx="12" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="314" y="166" width="44" height="7" rx="3.5" />
    <rect x="314" y="180" width="56" height="7" rx="3.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="470" y="70" width="110" height="52" rx="12" />
  </g>
  <g fill="currentColor" opacity="0.4">
    <rect x="484" y="86" width="40" height="7" rx="3.5" />
    <rect x="484" y="100" width="28" height="7" rx="3.5" />
  </g>
</svg>
