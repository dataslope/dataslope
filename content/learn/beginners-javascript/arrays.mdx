...
<svg
  viewBox="0 0 640 165"
  role="img"
  aria-label="Five soft cells in a row holding colored circles, numbered from zero to four underneath"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <rect x="90" y="40" width="80" height="80" rx="16" />
    <rect x="182" y="40" width="80" height="80" rx="16" />
    <rect x="274" y="40" width="80" height="80" rx="16" />
    <rect x="366" y="40" width="80" height="80" rx="16" />
    <rect x="458" y="40" width="80" height="80" rx="16" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="130" cy="80" r="24" />
    <circle cx="498" cy="80" r="24" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="222" cy="80" r="24" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="314" cy="80" r="24" />
  </g>
  ...
  <g fill="currentColor" opacity="0.55" fontFamily="ui-monospace, monospace" fontSize="17" textAnchor="middle">
    ...
    <text x="406" y="148">3</text>
    <text x="498" y="148">4</text>
  </g>
</svg>
