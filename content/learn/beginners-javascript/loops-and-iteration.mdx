...
<svg
  viewBox="0 0 640 235"
  role="img"
  aria-label="Dots spiralling outward from a center, growing as the four colors repeat in a cycle — each pass of a loop building on the last"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="336" cy="130" r="3" />
    <circle cx="326" cy="154" r="3.5" />
    <circle cx="281" cy="145" r="4" />
    <circle cx="287" cy="92" r="4.6" />
    <circle cx="367" cy="87" r="5.1" />
    <circle cx="393" cy="164" r="5.6" />
    <circle cx="291" cy="206" r="6.1" />
    <circle cx="209" cy="121" r="6.6" />
    <circle cx="305" cy="28" r="7.2" />
    <circle cx="451" cy="94" r="7.7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="338" cy="135" r="3.1" />
    <circle cx="316" cy="157" r="3.7" />
    <circle cx="274" cy="133" r="4.2" />
    <circle cx="303" cy="83" r="4.7" />
    <circle cx="384" cy="100" r="5.2" />
    <circle cx="377" cy="184" r="5.7" />
    <circle cx="259" cy="196" r="6.3" />
    <circle cx="216" cy="90" r="6.8" />
    <circle cx="348" cy="28" r="7.3" />
    <circle cx="462" cy="132" r="7.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="338" cy="142" r="3.3" />
    <circle cx="304" cy="157" r="3.8" />
    <circle cx="272" cy="120" r="4.3" />
    <circle cx="323" cy="78" r="4.8" />
    <circle cx="396" cy="120" r="5.3" />
    <circle cx="353" cy="199" r="5.9" />
    <circle cx="233" cy="177" r="6.4" />
    <circle cx="237" cy="61" r="6.9" />
    <circle cx="391" cy="39" r="7.4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="334" cy="148" r="3.4" />
    <circle cx="291" cy="153" r="3.9" />
    <circle cx="276" cy="105" r="4.4" />
    <circle cx="345" cy="79" r="5" />
    <circle cx="399" cy="142" r="5.5" />
    <circle cx="323" cy="207" r="6" />
    <circle cx="215" cy="151" r="6.5" />
    <circle cx="266" cy="41" r="7" />
    <circle cx="427" cy="63" r="7.6" />
  </g>
</svg>
