...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Three labelled boxes holding colored balls; in the last box a faded ball is being replaced by a new one arriving from outside"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="80" y="60" width="120" height="90" rx="16" opacity="0.07" />
    <rect x="260" y="60" width="120" height="90" rx="16" opacity="0.07" />
    <rect x="440" y="60" width="120" height="90" rx="16" opacity="0.07" />
    <rect x="112" y="42" width="56" height="14" rx="7" opacity="0.15" />
    <rect x="292" y="42" width="56" height="14" rx="7" opacity="0.15" />
    <rect x="472" y="42" width="56" height="14" rx="7" opacity="0.15" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="105" r="24" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="105" r="24" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="478" cy="105" r="16" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="516" cy="105" r="20" />
    <circle cx="560" cy="28" r="4" fillOpacity="0.5" />
    <circle cx="548" cy="42" r="5" fillOpacity="0.65" />
    <circle cx="536" cy="56" r="6" fillOpacity="0.8" />
  </g>
</svg>
