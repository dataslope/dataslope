...
<CodeBlock
  adapter="javascript"
  initialCode={`let x;             // declaration only — x is undefined
...
<CodeBlock
  adapter="javascript"
  initialCode={`// Bad: one-letter names everywhere
const a = 84.5;
const b = 0.18;
const c = a + a * b;
console.log(c);
...
<CodeBlock
  adapter="javascript"
  initialCode={`const outside = "I am global to this script";
...
balance += 50; deposits += 50;
balance += 30; deposits += 30;
balance -= 40; withdrawals += 40;
balance -= 10; withdrawals += 10;
