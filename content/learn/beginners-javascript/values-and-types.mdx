...
<svg
  viewBox="0 0 640 190"
  role="img"
  aria-label="Round number blobs, long string bars, a green and red boolean pair, and faint ghost shapes lined up on a shelf — the different kinds of values"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="150" width="500" height="4" rx="2" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="112" cy="130" r="20" />
    <circle cx="156" cy="137" r="13" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="210" y="126" width="90" height="24" rx="12" />
    <rect x="222" y="98" width="60" height="20" rx="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="382" cy="133" r="17" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="426" cy="133" r="17" />
  </g>
  <g fill="currentColor">
    <circle cx="500" cy="134" r="16" opacity="0.1" />
    <circle cx="537" cy="140" r="10" opacity="0.1" />
  </g>
</svg>
