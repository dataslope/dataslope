...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Clusters of circles, rounded bars, paired dots, and faint ghost shapes arranged like specimens on a shelf — the different kinds of values"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="240" y="60" width="80" height="22" rx="11" />
    <rect x="250" y="95" width="56" height="18" rx="9" />
    <rect x="326" y="68" width="44" height="18" rx="9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="430" cy="70" r="13" />
    <circle cx="450" cy="106" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="472" cy="70" r="13" />
  </g>
  <g fill="currentColor">
    <circle cx="560" cy="75" r="16" opacity="0.1" />
    <circle cx="585" cy="108" r="9" opacity="0.1" />
    <rect x="70" y="150" width="500" height="4" rx="2" opacity="0.1" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="180" r="3.5" />
    <circle cx="360" cy="178" r="3.5" />
    <circle cx="540" cy="186" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="240" cy="176" r="3.5" />
    <circle cx="480" cy="176" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="300" cy="188" r="3.5" />
  </g>
</svg>
