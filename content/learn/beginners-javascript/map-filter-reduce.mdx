...
<svg
  viewBox="0 0 640 215"
  role="img"
  aria-label="A pipeline: circles pass through a green gate and become squares, a yellow gate drops some of them, and a funnel merges the rest into one large circle"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="60" cy="40" r="11" />
    <circle cx="60" cy="80" r="11" />
    <circle cx="60" cy="120" r="11" />
    <circle cx="60" cy="160" r="11" />
    <polygon points="350,30 350,180 426,105" />
    <circle cx="484" cy="105" r="26" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="104" y="28" width="34" height="152" rx="12" />
    <rect x="168" y="29" width="22" height="22" rx="6" />
    <rect x="168" y="69" width="22" height="22" rx="6" />
    <rect x="168" y="109" width="22" height="22" rx="6" />
    <rect x="168" y="149" width="22" height="22" rx="6" />
    <rect x="292" y="49" width="22" height="22" rx="6" />
    <rect x="292" y="119" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="228" y="28" width="34" height="152" rx="12" />
    <circle cx="516" cy="78" r="5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="240" y="186" width="18" height="18" rx="5" fillOpacity="0.4" />
    <rect x="266" y="194" width="14" height="14" rx="4" fillOpacity="0.3" />
  </g>
</svg>
