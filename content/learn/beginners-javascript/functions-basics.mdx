...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Yellow circles funnel into a blue machine marked with a function symbol, and green squares come out the other side"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="80" cy="60" r="11" />
    <circle cx="80" cy="100" r="11" />
    <circle cx="80" cy="140" r="11" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="124" cy="74" r="3" />
    <circle cx="152" cy="87" r="3" />
    <circle cx="124" cy="100" r="3" />
    <circle cx="152" cy="100" r="3" />
    <circle cx="124" cy="126" r="3" />
    <circle cx="152" cy="113" r="3" />
    <circle cx="376" cy="100" r="3" />
