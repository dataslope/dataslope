...
<CodeBlock
  adapter="javascript"
  initialCode={`console.log(5 === 5);     // true
...
<CodeBlock
  adapter="javascript"
  initialCode={`const isAdmin = true;
...
<CodeBlock
  adapter="javascript"
  initialCode={`function expensive() {
...
<CodeBlock
  adapter="javascript"
  initialCode={`function withDefault(value) {
...
<CodeBlock
  adapter="javascript"
  initialCode={`function describeNumber(n) {
...
<CodeBlock
  adapter="javascript"
  initialCode={`function canComment(user, article) {
...
console.log(canComment({ id: 7,  role: "member" }, { ...article, closedToComments: true })); // false
console.log(canComment({ id: 42, role: "member" }, { ...article, closedToComments: true })); // true (author can comment even when closed)
console.log(canComment({ id: 7,  role: "admin"  }, { ...article, closedToComments: true })); // true
`}
/>
