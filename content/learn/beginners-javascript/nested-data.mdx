...
<CodeBlock
  ...
  items: [
    { sku: "BK-001", title: "Notebook",  qty: 2, price: 4.50 },
    { sku: "PN-014", title: "Fountain pen", qty: 1, price: 35.00 },
    { sku: "IK-002", title: "Black ink",   qty: 3, price: 8.00 },
  ],
  status: "paid",
};
...
<CodeBlock
  adapter="javascript"
  initialCode={`const noisy = { user: { profile: { name: "Ada" } } };
...
<CodeBlock
  ...
  id: 101,
  items: [
    { sku: "BK-001", qty: 2, price: 4.50 },
    { sku: "PN-014", qty: 1, price: 35.00 },
    { sku: "IK-002", qty: 3, price: 8.00 },
  ],
};
...
- \`getPath({}, "x", "n/a")\` → \`"n/a"\``}
  initialCode={`function getPath(obj, path, defaultValue) {
  // your code here
  return defaultValue;
}
