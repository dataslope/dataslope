...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="30" width="480" height="170" rx="24" fillOpacity="0.1" />
    <circle cx="532" cy="52" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="110" y="60" width="180" height="110" rx="18" fillOpacity="0.18" />
    <rect x="320" y="60" width="210" height="110" rx="18" fillOpacity="0.18" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="140" y="80" width="24" height="24" rx="7" />
    <rect x="345" y="85" width="70" height="60" rx="12" fillOpacity="0.35" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="150" cy="140" r="11" />
    <circle cx="186" cy="140" r="11" />
    <circle cx="222" cy="140" r="11" />
    <circle cx="470" cy="115" r="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="380" cy="115" r="10" />
  </g>
</svg>
