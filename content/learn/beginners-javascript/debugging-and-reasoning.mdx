...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A grid of identical blue dots with one red dot out of place, examined under a translucent magnifying lens"
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.75">
    ...
    <circle cx="340" cy="50" r="9" />
    <circle cx="400" cy="50" r="9" />
    <circle cx="460" cy="50" r="9" />
    <circle cx="520" cy="50" r="9" />
    <circle cx="100" cy="94" r="9" />
    <circle cx="160" cy="94" r="9" />
    <circle cx="220" cy="94" r="9" />
    <circle cx="280" cy="94" r="9" />
    <circle cx="340" cy="94" r="9" />
    <circle cx="460" cy="94" r="9" />
    <circle cx="520" cy="94" r="9" />
    <circle cx="100" cy="138" r="9" />
    <circle cx="160" cy="138" r="9" />
    <circle cx="220" cy="138" r="9" />
    <circle cx="280" cy="138" r="9" />
    <circle cx="340" cy="138" r="9" />
    <circle cx="400" cy="138" r="9" />
    <circle cx="460" cy="138" r="9" />
    <circle cx="520" cy="138" r="9" />
    <circle cx="100" cy="182" r="9" />
    <circle cx="160" cy="182" r="9" />
    <circle cx="220" cy="182" r="9" />
    <circle cx="280" cy="182" r="9" />
    <circle cx="340" cy="182" r="9" />
    <circle cx="400" cy="182" r="9" />
    <circle cx="460" cy="182" r="9" />
    <circle cx="520" cy="182" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="404" cy="90" r="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="404" cy="92" r="58" fillOpacity="0.07" />
    <circle cx="404" cy="92" r="48" fillOpacity="0.2" />
    <rect x="441" y="122" width="14" height="62" rx="7" transform="rotate(-45 448 126)" fillOpacity="0.85" />
  </g>
</svg>
