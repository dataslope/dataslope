...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Stepping stones across water grow brighter from left to right; above each dotted hop a small yellow event pill drops in, and every earlier stone stays in place — each event yields a new state value while old states persist"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="40" y="150" width="560" height="30" rx="15" fillOpacity="0.08" />
    <circle cx="110" cy="150" r="20" fillOpacity="0.35" />
    <circle cx="250" cy="150" r="20" fillOpacity="0.55" />
    <circle cx="390" cy="150" r="20" fillOpacity="0.8" />
  </g>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="212" cy="120" r="3" />
    <circle cx="290" cy="120" r="3" />
    <circle cx="320" cy="110" r="3" />
    <circle cx="352" cy="120" r="3" />
    <circle cx="430" cy="120" r="3" />
    <circle cx="460" cy="110" r="3" />
    <circle cx="492" cy="120" r="3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="166" y="38" width="28" height="14" rx="7" />
    <rect x="306" y="38" width="28" height="14" rx="7" />
    <rect x="446" y="38" width="28" height="14" rx="7" />
    <circle cx="180" cy="68" r="3" fillOpacity="0.5" />
    <circle cx="180" cy="84" r="3" fillOpacity="0.5" />
    <circle cx="320" cy="68" r="3" fillOpacity="0.5" />
    <circle cx="320" cy="84" r="3" fillOpacity="0.5" />
    <circle cx="460" cy="68" r="3" fillOpacity="0.5" />
    <circle cx="460" cy="84" r="3" fillOpacity="0.5" />
  </g>
</svg>
