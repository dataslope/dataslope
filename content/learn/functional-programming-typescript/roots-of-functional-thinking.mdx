...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A lambda glyph in a circle on the left branches through dotted generations of nodes into a column of green squares — a century-old intellectual lineage flowing into today's languages"
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="400" cy="95" r="10" fillOpacity="0.7" />
    <circle cx="400" cy="160" r="10" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="138" cy="91" r="3" />
    <circle cx="172" cy="81" r="3" />
    <circle cx="206" cy="70" r="3" />
    <circle cx="138" cy="119" r="3" />
    <circle cx="172" cy="129" r="3" />
    <circle cx="206" cy="140" r="3" />
    <circle cx="295" cy="53" r="3" />
    <circle cx="350" cy="46" r="3" />
    <circle cx="295" cy="72" r="3" />
    <circle cx="350" cy="84" r="3" />
    <circle cx="295" cy="153" r="3" />
    <circle cx="350" cy="157" r="3" />
    <circle cx="447" cy="37" r="3" />
    <circle cx="494" cy="33" r="3" />
    <circle cx="447" cy="88" r="3" />
    <circle cx="494" cy="82" r="3" />
    <circle cx="447" cy="103" r="3" />
    <circle cx="494" cy="112" r="3" />
    <circle cx="447" cy="162" r="3" />
    <circle cx="494" cy="164" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="531" y="21" width="18" height="18" rx="5" />
    <rect x="531" y="66" width="18" height="18" rx="5" />
    <rect x="531" y="111" width="18" height="18" rx="5" />
    <rect x="531" y="156" width="18" height="18" rx="5" />
  </g>
</svg>
