...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A perfectly level balance scale weighing a small ƒ capsule with its input dot against a plain green value circle — an expression and the value it evaluates to are interchangeable"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <rect x="140" y="66" width="360" height="10" rx="5" />
    <rect x="314" y="76" width="12" height="92" rx="6" />
    <polygon points="320,164 284,200 356,200" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="180" cy="88" r="3" />
    <circle cx="180" cy="102" r="3" />
    <circle cx="180" cy="116" r="3" />
    <circle cx="460" cy="88" r="3" />
    <circle cx="460" cy="102" r="3" />
    <circle cx="460" cy="116" r="3" />
