...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Interchangeable chips marked lambda, f, and plus hover over a slot in a machine that turns an input dot into an output dot — higher-order functions accept behavior as a pluggable value"
...
>
  ...
  <rect x="292" y="124" width="56" height="20" rx="6" style={{ fill: "var(--ds-gray-900)" }} fillOpacity="0.35" />
  <g fill="currentColor" opacity="0.3">
    <circle cx="160" cy="162" r="3" />
    <circle cx="178" cy="162" r="3" />
    <circle cx="462" cy="162" r="3" />
    <circle cx="480" cy="162" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="502" cy="162" r="8" />
  </g>
</svg>
