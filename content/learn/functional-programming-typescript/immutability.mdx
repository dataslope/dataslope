...
<CodeBlock
  adapter="typescript"
  starterCode={`type User = { readonly id: string; readonly name: string; readonly age: number };
...
<CodeBlock
  adapter="typescript"
  starterCode={`type Todo = { readonly id: number; readonly text: string; readonly done: boolean };
