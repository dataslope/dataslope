...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A queue of circles, triangles, and squares meets a diamond marked with a question mark and is routed along dotted paths into three bins that each hold only one shape — every case goes to its own handler"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="90" cy="40" r="11" />
    <circle cx="222" cy="40" r="11" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="130,29 152,40 130,51" />
    <polygon points="252,29 274,40 252,51" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="170" y="29" width="22" height="22" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="298" cy="52" r="3" />
    <circle cx="316" cy="68" r="3" />
  </g>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="212" cy="162" r="3" />
    <circle cx="336" cy="142" r="3" />
    <circle cx="332" cy="158" r="3" />
    <circle cx="384" cy="136" r="3" />
    <circle cx="426" cy="150" r="3" />
    <circle cx="468" cy="162" r="3" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="110" y="172" width="120" height="46" rx="10" />
    <rect x="260" y="172" width="120" height="46" rx="10" />
    <rect x="410" y="172" width="120" height="46" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="155" cy="195" r="9" />
    <circle cx="185" cy="195" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="300,184 322,195 300,206" />
    <polygon points="335,184 357,195 335,206" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="445" y="185" width="20" height="20" rx="5" />
    <rect x="475" y="185" width="20" height="20" rx="5" />
  </g>
</svg>
