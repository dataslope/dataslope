...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two stacks of slabs: on the left a red dot leaps over the whole stack along a dashed arc, on the right the red dot rides inside a green carrier straight through every layer — exceptions bypass your functions while Result passes failure through them as a value"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="95" y="150" width="150" height="34" rx="9" />
    <rect x="395" y="150" width="150" height="34" rx="9" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <rect x="95" y="105" width="150" height="34" rx="9" />
    <rect x="395" y="105" width="150" height="34" rx="9" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <rect x="95" y="60" width="150" height="34" rx="9" />
    <rect x="395" y="60" width="150" height="34" rx="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="170" cy="167" r="6" />
    <circle cx="255" cy="150" r="4" fillOpacity="0.45" />
    <circle cx="270" cy="112" r="4" fillOpacity="0.45" />
    <circle cx="274" cy="74" r="4" fillOpacity="0.45" />
    <circle cx="266" cy="42" r="4" fillOpacity="0.45" />
    <circle cx="246" cy="24" r="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="470" cy="206" r="3" />
    <circle cx="470" cy="192" r="3" />
    <circle cx="470" cy="144" r="3" />
    <circle cx="470" cy="99" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="448" y="112" width="44" height="20" rx="10" />
    <circle cx="470" cy="40" r="6" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="470" cy="122" r="6" />
  </g>
</svg>
...
The error type is *generic*. You can use a string, an enum, a
discriminated union of structured errors — anything. We'll see in
[Functional Error Handling](./functional-error-handling) how
structured error types let you express your domain's failure modes
precisely.
