...
FROM range(1, 401) t(i);`}
  initialCode={`SELECT id, order_date, amount
FROM orders
...
INSERT INTO products VALUES
  ...
  initialCode={`SELECT name, category, price
FROM products
...
INSERT INTO people VALUES
  ...
  initialCode={`SELECT name, email
FROM people
WHERE name ILIKE 'a%'          -- name starts with A or a
  AND email LIKE '%.gov';      -- email ends in .gov`}
/>
...
INSERT INTO orders VALUES
  ...
  initialCode={`-- "Big orders, but only from West or East."
