...
INSERT INTO products VALUES
  ...
  initialCode={`SELECT id, name, sales
FROM products
ORDER BY sales DESC, id ASC   -- id breaks ties → reproducible order
LIMIT 3;`}
/>
...
<SqlCodeBlock
  ...
  initialCode={`-- Run this block twice — it never errors, and the result is identical.
...
INSERT INTO orders VALUES
  ...
  initialCode={`CREATE OR REPLACE VIEW paid_revenue_by_region AS
...
SELECT * FROM paid_revenue_by_region
