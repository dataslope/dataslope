...
INSERT INTO orders VALUES
  ...
  id,
  amount,
  (SELECT ROUND(AVG(amount), 1) FROM orders) AS overall_avg,
...
INSERT INTO customers VALUES
  ...
  initialCode={`SELECT id, customer_id, amount
FROM orders
...
INSERT INTO orders VALUES
  ...
  o.region,
  o.amount,
  (SELECT ROUND(AVG(x.amount), 1)
   FROM orders x
   WHERE x.region = o.region) AS region_avg   -- correlated on o.region
FROM orders o
