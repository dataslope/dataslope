...
INSERT INTO trips VALUES
  ...
  initialCode={`-- Always start by *looking*. LIMIT keeps it cheap.
SELECT *
FROM trips
LIMIT 5;`}
/>
...
INSERT INTO trips VALUES
  ...
  initialCode={`SELECT rider, minutes, fare
FROM trips
WHERE city = 'Seattle'
  AND minutes >= 20
...
INSERT INTO trips VALUES
  ...
  (5,'Portland','Di',14,11.00),(6,'Boise','Eli',19,13.50),
  (7,'Seattle','Bo',6,5.00),(8,'Portland','Cy',22,16.25);`}
  initialCode={`SELECT city, rider, fare
FROM trips
ORDER BY fare DESC
LIMIT 3;`}
/>
