...
INSERT INTO sales VALUES
  ('West','Q1',100),('West','Q2',140),('West','Q1',20),
  ('East','Q1',200),('East','Q2',90),('North','Q2',75);`}
  initialCode={`PIVOT sales
ON quarter                 -- values of this column become columns
...
INSERT INTO wide_sales VALUES
  ('West', 100, 140, 90),
  ('East', 200,  60, 120);`}
  initialCode={`UNPIVOT wide_sales
ON jan, feb, mar           -- these columns become rows
INTO
  NAME month               -- new column holding 'jan'/'feb'/'mar'
