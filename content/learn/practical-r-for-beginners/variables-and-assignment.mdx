...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three name capsules each receive a shape along a bold left-pointing arrow — assignment in R writes the value on the right into the name on the left"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="130" y="58" width="110" height="30" rx="15" fillOpacity="0.15" />
    <circle cx="165" cy="73" r="8" />
    <polygon points="256,73 282,61 282,85" />
    <rect x="282" y="70" width="158" height="6" rx="3" />
    <circle cx="478" cy="73" r="15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="130" y="103" width="110" height="30" rx="15" fillOpacity="0.15" />
    <polygon points="256,118 282,106 282,130" />
    <rect x="282" y="115" width="158" height="6" rx="3" />
    <circle cx="370" cy="118" r="5" fillOpacity="0.7" />
    <rect x="462" y="102" width="30" height="30" rx="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="130" y="148" width="110" height="30" rx="15" fillOpacity="0.15" />
    <polygon points="256,163 282,151 282,175" />
    <rect x="282" y="160" width="158" height="6" rx="3" />
    <circle cx="390" cy="163" r="5" fillOpacity="0.7" />
    <polygon points="478,147 496,178 460,178" />
  </g>
</svg>
