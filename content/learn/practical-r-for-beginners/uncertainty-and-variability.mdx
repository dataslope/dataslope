...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Eight repeated measurements of the same quantity wobble above and below a faint green band of the true value, with a yellow bracket spanning their spread — variability shows up even when nothing has changed"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="110" y="98" width="420" height="8" rx="4" fillOpacity="0.18" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="148" y="88" width="4" height="14" rx="2" />
    <rect x="198" y="102" width="4" height="14" rx="2" />
    <rect x="248" y="95" width="4" height="7" rx="2" />
    <rect x="298" y="102" width="4" height="16" rx="2" />
    <rect x="348" y="84" width="4" height="18" rx="2" />
    <rect x="398" y="102" width="4" height="10" rx="2" />
    <rect x="448" y="99" width="4" height="3" rx="1.5" />
    <rect x="498" y="102" width="4" height="14" rx="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="150" cy="86" r="7" />
    <circle cx="200" cy="118" r="7" />
    <circle cx="250" cy="93" r="7" />
    <circle cx="300" cy="120" r="7" />
    <circle cx="350" cy="82" r="7" />
    <circle cx="400" cy="114" r="7" />
    <circle cx="450" cy="97" r="7" />
    <circle cx="500" cy="118" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="552" y="74" width="4" height="52" rx="2" fillOpacity="0.8" />
    <rect x="544" y="74" width="20" height="4" rx="2" fillOpacity="0.8" />
    <rect x="544" y="122" width="20" height="4" rx="2" fillOpacity="0.8" />
  </g>
</svg>
