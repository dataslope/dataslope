...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A wide two-row table and a tall two-column table hold exactly the same colored cells, three of which tumble through the air mid-move — reshaping changes the shape, never the values"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="60" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="95" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="130" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="165" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="200" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="235" y="70" width="30" height="24" rx="5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="60" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="95" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="130" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="165" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="200" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="235" y="99" width="30" height="24" rx="5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="315" y="68" width="30" height="24" rx="5" transform="rotate(25 330 80)" fillOpacity="0.65" />
    <rect x="410" y="58" width="30" height="24" rx="5" transform="rotate(40 425 70)" fillOpacity="0.65" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="365" y="108" width="30" height="24" rx="5" transform="rotate(-18 380 120)" fillOpacity="0.65" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="300" cy="96" r="2.5" />
    <circle cx="355" cy="100" r="2.5" />
    <circle cx="405" cy="96" r="2.5" />
    <circle cx="450" cy="86" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="480" y="30" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="480" y="59" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="480" y="88" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="480" y="117" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="480" y="146" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="480" y="175" width="30" height="24" rx="5" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="515" y="30" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="515" y="59" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="515" y="88" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="515" y="117" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="515" y="146" width="30" height="24" rx="5" fillOpacity="0.8" />
    <rect x="515" y="175" width="30" height="24" rx="5" fillOpacity="0.8" />
  </g>
</svg>
