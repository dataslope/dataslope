...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A script page runs top to bottom — finished lines carry green checks, a runner dot sits on the current line, and dotted paths emit a small chart and a small table to the side — work anyone can rerun from the first line to the last"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="200" y="28" width="180" height="190" rx="12" fill="currentColor" opacity="0.06" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="218" y="50" width="130" height="7" rx="3.5" fillOpacity="0.5" />
    <rect x="218" y="76" width="110" height="7" rx="3.5" fillOpacity="0.5" />
    <rect x="218" y="102" width="140" height="7" rx="3.5" fillOpacity="0.5" />
    <circle cx="186" cy="53" r="4" />
    <circle cx="186" cy="79" r="4" />
    <circle cx="186" cy="105" r="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="218" y="128" width="120" height="7" rx="3.5" fillOpacity="0.85" />
    <circle cx="186" cy="131" r="6" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <rect x="218" y="154" width="135" height="7" rx="3.5" />
    <rect x="218" y="180" width="100" height="7" rx="3.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="396" cy="80" r="3" />
    <circle cx="420" cy="80" r="3" />
    <circle cx="396" cy="132" r="3" />
    <circle cx="420" cy="132" r="3" />
  </g>
  <rect x="440" y="56" width="74" height="50" rx="8" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="452" y="86" width="11" height="12" rx="3" fillOpacity="0.8" />
    <rect x="469" y="76" width="11" height="22" rx="3" fillOpacity="0.8" />
    <rect x="486" y="66" width="11" height="32" rx="3" fillOpacity="0.8" />
  </g>
  <rect x="440" y="118" width="74" height="44" rx="8" fill="currentColor" opacity="0.07" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="456" cy="133" r="3" fillOpacity="0.6" />
    <circle cx="472" cy="133" r="3" fillOpacity="0.6" />
    <circle cx="488" cy="133" r="3" fillOpacity="0.6" />
    <circle cx="456" cy="148" r="3" fillOpacity="0.6" />
    <circle cx="472" cy="148" r="3" fillOpacity="0.6" />
    <circle cx="488" cy="148" r="3" fillOpacity="0.6" />
  </g>
</svg>
...
<CodeBlock
  ...
  files={[
    {
      filename: "main.r",
      starterCode: `# In a real RStudio project, the 'here' package finds the project root automatically:
