...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A translucent hump rises over a rug of dots that trail off to the right, with a green median tick and a yellow mean tick pulled apart by the long tail — center and spread at a glance"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="100" y="172" width="440" height="5" rx="2.5" fill="currentColor" opacity="0.15" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <path d="M105,172 C140,88 175,56 215,56 C258,56 285,118 330,146 C390,170 470,172 535,172 Z" fillOpacity="0.15" />
    <rect x="219" y="92" width="6" height="80" rx="3" fillOpacity="0.9" />
    <circle cx="222" cy="84" r="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="262" y="92" width="6" height="80" rx="3" fillOpacity="0.9" />
    <circle cx="265" cy="84" r="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.6">
    <circle cx="150" cy="162" r="4" />
    <circle cx="164" cy="162" r="4" />
    <circle cx="177" cy="162" r="4" />
    <circle cx="189" cy="162" r="4" />
    <circle cx="200" cy="162" r="4" />
    <circle cx="211" cy="162" r="4" />
    <circle cx="222" cy="162" r="4" />
    <circle cx="233" cy="162" r="4" />
    <circle cx="245" cy="162" r="4" />
    <circle cx="258" cy="162" r="4" />
    <circle cx="272" cy="162" r="4" />
    <circle cx="290" cy="162" r="4" />
    <circle cx="312" cy="162" r="4" />
    <circle cx="340" cy="162" r="4" />
    <circle cx="378" cy="162" r="4" />
    <circle cx="425" cy="162" r="4" />
    <circle cx="478" cy="162" r="4" />
    <circle cx="183" cy="150" r="4" />
