...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A chain of solid blue values meets one hazy yellow bubble of NA, and every value downstream fades gray inside a spreading haze — one missing value infects everything it touches"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="105" cy="105" r="12" />
    <circle cx="175" cy="105" r="12" />
    <rect x="117" y="102" width="46" height="6" rx="3" fillOpacity="0.4" />
    <rect x="187" y="102" width="46" height="6" rx="3" fillOpacity="0.4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="529" cy="105" r="23" fillOpacity="0.05" />
  </g>
  <g fill="currentColor">
    <rect x="265" y="102" width="42" height="6" rx="3" opacity="0.15" />
    <rect x="331" y="102" width="46" height="6" rx="3" opacity="0.13" />
    <rect x="401" y="102" width="46" height="6" rx="3" opacity="0.11" />
    <rect x="471" y="102" width="46" height="6" rx="3" opacity="0.09" />
    <circle cx="319" cy="105" r="12" opacity="0.2" />
    <circle cx="389" cy="105" r="12" opacity="0.16" />
    <circle cx="459" cy="105" r="12" opacity="0.12" />
    <circle cx="529" cy="105" r="12" opacity="0.09" />
  </g>
</svg>
