...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Above, a yellow dot hops cell to cell transforming one value at a time; below, one wide plus-one bar presses down on every cell of the row at once — vectorized computation replaces the loop"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="168" cy="58" r="6" fillOpacity="0.9" />
    <circle cx="216" cy="58" r="6" fillOpacity="0.9" />
    <circle cx="264" cy="58" r="6" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="312" cy="58" r="6" fillOpacity="0.3" />
    <circle cx="360" cy="58" r="6" fillOpacity="0.3" />
    <circle cx="408" cy="58" r="6" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="312" cy="24" r="6.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="268" cy="32" r="2.5" />
    <circle cx="282" cy="20" r="2.5" />
    <circle cx="298" cy="17" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
