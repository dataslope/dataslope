...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Circles, squares, and triangles each settle into their own labeled column while one stray triangle follows a dotted path toward the single empty slot — every variable a column, every observation a row"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.06">
    <rect x="188" y="76" width="64" height="130" rx="12" />
    <rect x="288" y="76" width="64" height="130" rx="12" />
    <rect x="388" y="76" width="64" height="130" rx="12" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="220" cy="50" r="9" fillOpacity="0.4" />
    <circle cx="220" cy="108" r="11" />
    <circle cx="220" cy="144" r="11" />
    <circle cx="220" cy="180" r="11" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="311" y="41" width="18" height="18" rx="5" fillOpacity="0.4" />
    <rect x="309" y="97" width="22" height="22" rx="6" />
    <rect x="309" y="133" width="22" height="22" rx="6" />
    <rect x="309" y="169" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="408,59 432,59 420,39" fillOpacity="0.4" />
    <polygon points="408,119 432,119 420,99" />
    <polygon points="408,155 432,155 420,135" />
    <polygon points="118,214 144,210 128,192" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="170" cy="207" r="3" />
    <circle cx="215" cy="212" r="3" />
    <circle cx="262" cy="213" r="3" />
    <circle cx="308" cy="209" r="3" />
    <circle cx="352" cy="202" r="3" />
    <circle cx="392" cy="192" r="3" />
  </g>
</svg>
