...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Two seed dots in a small pot send up a sprout that branches into leaves and keeps climbing in dotted steps far beyond the pot — a weekend teaching project that would not stop growing"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="140" y="226" width="360" height="5" rx="2.5" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="284,192 356,192 346,228 294,228" fillOpacity="0.3" />
    <rect x="276" y="180" width="88" height="14" rx="7" fillOpacity="0.45" />
    <circle cx="305" cy="208" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="335" cy="208" r="6" />
    <rect x="317" y="88" width="6" height="94" rx="3" fillOpacity="0.85" />
    <rect x="303" y="106" width="5" height="42" rx="2.5" transform="rotate(35 305 148)" fillOpacity="0.7" />
    <rect x="332" y="92" width="5" height="46" rx="2.5" transform="rotate(-38 334 138)" fillOpacity="0.7" />
    <circle cx="278" cy="112" r="9" fillOpacity="0.55" />
    <circle cx="364" cy="96" r="9" fillOpacity="0.55" />
    <circle cx="320" cy="74" r="4" fillOpacity="0.8" />
    <circle cx="324" cy="56" r="3.4" fillOpacity="0.6" />
    <circle cx="329" cy="40" r="2.8" fillOpacity="0.45" />
    <circle cx="322" cy="52" r="36" fillOpacity="0.08" />
  </g>
</svg>
