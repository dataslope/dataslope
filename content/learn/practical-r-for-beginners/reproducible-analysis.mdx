...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="An upside-down tower of ever wider slabs balances precariously on one tiny red cell, with two yellow fragments slipping off the top — trillion-dollar conclusions resting on a single unchecked spreadsheet error"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="140" y="216" width="360" height="4" rx="2" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="312" y="196" width="16" height="16" rx="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" transform="rotate(-2 320 200)">
    <rect x="275" y="172" width="90" height="18" rx="6" fillOpacity="0.25" />
    <rect x="235" y="146" width="170" height="20" rx="7" fillOpacity="0.4" />
    <rect x="190" y="118" width="260" height="22" rx="8" fillOpacity="0.55" />
    <rect x="145" y="88" width="350" height="24" rx="9" fillOpacity="0.75" />
    <rect x="100" y="56" width="440" height="26" rx="10" fillOpacity="0.95" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="548" y="46" width="14" height="14" rx="4" transform="rotate(24 555 53)" fillOpacity="0.9" />
    <rect x="572" y="74" width="11" height="11" rx="3" transform="rotate(-18 577 79)" fillOpacity="0.7" />
  </g>
</svg>
...
This is the last chapter in our "story" section. Starting next
page, we step into actually *doing* the work — beginning with
**computational thinking**, which is the mental shift you need to
make to think like a data analyst at a computer.
