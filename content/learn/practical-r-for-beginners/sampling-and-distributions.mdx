...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A small scoop lifts a few bright dots out of a jar packed with faint ones and tips them along a dotted arc into a little dish — a sample drawn from a population"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="90" y="64" width="220" height="150" rx="18" fill="currentColor" opacity="0.07" />
  <rect x="82" y="54" width="236" height="12" rx="6" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" fillOpacity="0.3">
    <circle cx="116" cy="96" r="5" />
    <circle cx="148" cy="88" r="5" />
    <circle cx="182" cy="98" r="5" />
    <circle cx="216" cy="90" r="5" />
    <circle cx="250" cy="99" r="5" />
    <circle cx="284" cy="92" r="5" />
    <circle cx="130" cy="126" r="5" />
    <circle cx="164" cy="120" r="5" />
    <circle cx="198" cy="129" r="5" />
    <circle cx="232" cy="122" r="5" />
    <circle cx="266" cy="130" r="5" />
    <circle cx="116" cy="158" r="5" />
    <circle cx="150" cy="152" r="5" />
    <circle cx="184" cy="160" r="5" />
    <circle cx="218" cy="154" r="5" />
    <circle cx="252" cy="161" r="5" />
    <circle cx="286" cy="156" r="5" />
    <circle cx="132" cy="190" r="5" />
    <circle cx="200" cy="190" r="5" />
    <circle cx="268" cy="190" r="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <path d="M350,92 A29,29 0 0 0 408,92 Z" fillOpacity="0.35" />
    <circle cx="366" cy="100" r="6" />
    <circle cx="381" cy="105" r="6" />
    <circle cx="394" cy="99" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="404" y="44" width="8" height="52" rx="4" transform="rotate(-42 408 92)" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="306" cy="74" r="3" />
    <circle cx="326" cy="66" r="3" />
    <circle cx="344" cy="70" r="3" />
    <circle cx="428" cy="116" r="3" />
    <circle cx="446" cy="130" r="3" />
    <circle cx="462" cy="144" r="3" />
  </g>
  <rect x="478" y="138" width="120" height="72" rx="14" fill="currentColor" opacity="0.06" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="502" cy="176" r="6" />
    <circle cx="528" cy="176" r="6" />
    <circle cx="554" cy="176" r="6" />
    <circle cx="578" cy="176" r="6" />
  </g>
</svg>
