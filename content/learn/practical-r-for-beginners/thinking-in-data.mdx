...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Scattered faint dots on the left gather into one solid arrow-shaped flock flying right — the shift from thinking about single values to thinking about whole collections moving together"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.22">
    <circle cx="62" cy="58" r="4" />
    <circle cx="98" cy="120" r="3.4" />
    <circle cx="74" cy="172" r="4" />
    <circle cx="130" cy="44" r="3.4" />
    <circle cx="150" cy="96" r="4" />
    <circle cx="122" cy="146" r="3.4" />
    <circle cx="168" cy="186" r="4" />
    <circle cx="196" cy="60" r="3.4" />
    <circle cx="204" cy="132" r="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="252" cy="84" r="4.2" fillOpacity="0.35" />
    <circle cx="288" cy="142" r="4.2" fillOpacity="0.45" />
    <circle cx="326" cy="98" r="4.4" fillOpacity="0.6" />
    <circle cx="360" cy="126" r="4.4" fillOpacity="0.75" />
    <circle cx="436" cy="64" r="4.6" fillOpacity="0.9" />
    <circle cx="464" cy="79" r="4.6" />
    <circle cx="492" cy="94" r="4.6" />
    <circle cx="436" cy="156" r="4.6" fillOpacity="0.9" />
    <circle cx="464" cy="141" r="4.6" />
    <circle cx="492" cy="126" r="4.6" />
    <circle cx="520" cy="110" r="5.4" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="408" cy="49" r="4.6" fillOpacity="0.8" />
    <circle cx="408" cy="171" r="4.6" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="545" cy="110" r="3" />
    <circle cx="563" cy="110" r="2.6" />
    <circle cx="579" cy="110" r="2.2" />
  </g>
</svg>
