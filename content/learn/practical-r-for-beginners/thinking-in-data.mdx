...
<CodeBlock
  adapter="r"
  initialCode={`# A collection of widths and a collection of heights
widths  <- c(5, 7, 2)
heights <- c(4, 3, 8)
...
<CodeBlock
  adapter="r"
  initialCode={`# 1,000 random widths and heights, all between 1 and 10
set.seed(42)
...
<CodeBlock
  adapter="r"
  initialCode={`# 12 monthly sales numbers (in thousands of dollars)
months <- c("Jan","Feb","Mar","Apr","May","Jun",
            "Jul","Aug","Sep","Oct","Nov","Dec")
sales  <- c(120, 132, 101, 134, 90, 110,
...
<ChallengeCard
  ...
  initialCode={`temps_c <- NA  # TODO: vectorized expression
