...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Three translucent panes — one holding data dots, one holding axes, one holding a trend mark — overlap diagonally with plus signs between them, layering into a single chart the way ggplot adds components"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="30" width="240" height="140" rx="14" fillOpacity="0.08" />
    <circle cx="138" cy="64" r="6" />
    <circle cx="176" cy="98" r="6" />
    <circle cx="214" cy="74" r="6" />
    <circle cx="252" cy="124" r="6" />
    <circle cx="288" cy="94" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="170" y="60" width="240" height="140" rx="14" fillOpacity="0.08" />
    <rect x="196" y="82" width="5" height="96" rx="2.5" fillOpacity="0.6" />
    <rect x="196" y="173" width="186" height="5" rx="2.5" fillOpacity="0.6" />
    <rect x="246" y="180" width="4" height="8" rx="2" fillOpacity="0.5" />
    <rect x="306" y="180" width="4" height="8" rx="2" fillOpacity="0.5" />
    <rect x="366" y="180" width="4" height="8" rx="2" fillOpacity="0.5" />
  </g>
