...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A recipe card titled with the function symbol takes two ingredient dots in at the top, runs them through faint instruction lines, and serves a green result on a plate — a function is a named, reusable recipe"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="190" y="40" width="260" height="160" rx="16" fillOpacity="0.1" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="390" cy="64" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="418" cy="14" r="7" fillOpacity="0.5" />
    <circle cx="418" cy="64" r="8" />
    <circle cx="545" cy="178" r="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="390" cy="38" r="2.5" />
    <circle cx="390" cy="50" r="2.5" />
    <circle cx="418" cy="34" r="2.5" />
    <circle cx="418" cy="48" r="2.5" />
    <circle cx="466" cy="166" r="3" />
    <circle cx="490" cy="174" r="3" />
    <circle cx="514" cy="180" r="3" />
  </g>
  <g fill="currentColor" opacity="0.2">
    <rect x="210" y="100" width="180" height="8" rx="4" />
    <rect x="210" y="126" width="150" height="8" rx="4" />
    <rect x="210" y="152" width="170" height="8" rx="4" />
  </g>
  <ellipse cx="545" cy="194" rx="28" ry="8" fill="currentColor" opacity="0.15" />
</svg>
