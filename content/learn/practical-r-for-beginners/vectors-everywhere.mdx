...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A lone number five linked by dots to its true form — a capsule holding one element — beside longer capsules of three and six elements; in R every value is already a vector"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="190" cy="67" r="3" />
    <circle cx="208" cy="66" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="124" width="128" height="44" rx="15" fillOpacity="0.12" />
    <circle cx="164" cy="146" r="9" />
    <circle cx="204" cy="146" r="9" />
    <circle cx="244" cy="146" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="300" y="124" width="236" height="44" rx="15" fillOpacity="0.12" />
    <circle cx="324" cy="146" r="9" />
    <circle cx="362" cy="146" r="9" />
    <circle cx="400" cy="146" r="9" />
    <circle cx="438" cy="146" r="9" />
    <circle cx="476" cy="146" r="9" />
    <circle cx="514" cy="146" r="9" />
  </g>
</svg>
