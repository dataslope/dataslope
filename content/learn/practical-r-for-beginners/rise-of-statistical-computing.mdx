...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Punched cards drift along a dotted path toward the slot of a mainframe cabinet with two tape reels and a row of status lights — statisticians lining up to speak the computer's language"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="370" y="28" width="180" height="174" rx="14" fillOpacity="0.12" />
    <circle cx="418" cy="76" r="24" fillOpacity="0.3" />
    <circle cx="502" cy="76" r="24" fillOpacity="0.3" />
    <circle cx="418" cy="76" r="7" />
    <circle cx="502" cy="76" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="404" cy="126" r="4" />
    <circle cx="436" cy="126" r="4" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="420" cy="126" r="4" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="452" cy="126" r="4" fillOpacity="0.7" />
  </g>
  <rect x="396" y="160" width="128" height="12" rx="6" fill="currentColor" opacity="0.25" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="98,142 138,142 138,172 90,172 90,150" fillOpacity="0.45" />
    <polygon points="178,148 218,148 218,178 170,178 170,156" fillOpacity="0.65" />
    <polygon points="258,154 298,154 298,184 250,184 250,162" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.45">
    <circle cx="102" cy="158" r="2.5" />
    <circle cx="114" cy="164" r="2.5" />
    <circle cx="126" cy="158" r="2.5" />
    <circle cx="182" cy="164" r="2.5" />
    <circle cx="194" cy="170" r="2.5" />
    <circle cx="206" cy="164" r="2.5" />
    <circle cx="262" cy="170" r="2.5" />
    <circle cx="274" cy="176" r="2.5" />
    <circle cx="286" cy="170" r="2.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="316" cy="168" r="3" />
    <circle cx="340" cy="167" r="3" />
    <circle cx="364" cy="166" r="3" />
  </g>
</svg>
