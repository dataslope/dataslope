...
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`print("Shape:", df.shape)            # rows, columns
print()
print("Dtypes:")
print(df.dtypes)
print()
...
<CodeBlock
  ...
  initCode={`import pandas as pd
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`missing = df.isna().sum()
...
<CodeBlock
  ...
  initCode={`import pandas as pd
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`print(df.describe().T)
`}
/>
...
<CodeBlock
  ...
  initCode={`import pandas as pd
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`print(df.groupby("salary")["satisfaction_level"].describe().round(2))
`}
/>
