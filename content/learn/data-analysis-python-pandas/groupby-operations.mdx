...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Mixed colored dots in one box split into three single-color boxes, and each box collapses into one summary row of its color — groupby's split, apply, combine"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="55" width="130" height="120" rx="16" fill="currentColor" opacity="0.08" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="90" cy="85" r="7" />
    <circle cx="130" cy="115" r="7" />
    <circle cx="162" cy="150" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="120" cy="80" r="7" />
    <circle cx="160" cy="125" r="7" />
    <circle cx="100" cy="152" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="150" cy="90" r="7" />
    <circle cx="95" cy="120" r="7" />
    <circle cx="135" cy="150" r="7" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="205" cy="115" r="3" />
    <circle cx="220" cy="115" r="3" />
    <polygon points="232,107 248,115 232,123" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="270" y="35" width="110" height="46" rx="12" fillOpacity="0.12" />
    <circle cx="292" cy="58" r="6" />
    <circle cx="320" cy="58" r="6" />
    <circle cx="348" cy="58" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="270" y="92" width="110" height="46" rx="12" fillOpacity="0.12" />
    <circle cx="292" cy="115" r="6" />
    <circle cx="320" cy="115" r="6" />
    <circle cx="348" cy="115" r="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="270" y="149" width="110" height="46" rx="12" fillOpacity="0.12" />
    <circle cx="292" cy="172" r="6" />
    <circle cx="320" cy="172" r="6" />
    <circle cx="348" cy="172" r="6" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="405" cy="70" r="3" />
    <circle cx="422" cy="82" r="3" />
    <circle cx="405" cy="115" r="3" />
    <circle cx="422" cy="115" r="3" />
    <circle cx="405" cy="160" r="3" />
    <circle cx="422" cy="148" r="3" />
  </g>
  <rect x="440" y="75" width="140" height="80" rx="14" fill="currentColor" opacity="0.08" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="465" cy="95" r="6" />
    <rect x="480" y="89" width="70" height="12" rx="6" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="465" cy="115" r="6" />
    <rect x="480" y="109" width="50" height="12" rx="6" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="465" cy="135" r="6" />
    <rect x="480" y="129" width="62" height="12" rx="6" fillOpacity="0.6" />
  </g>
</svg>
