...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A faint data grid flows through an arrow and becomes a chart — axes, blue scatter dots, a rising green trend line, and one yellow outlier suddenly visible to the eye"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="262" cy="100" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="278,90 296,100 278,110" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="358,158 558,64 562,70 362,164" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="370" cy="150" r="6" fillOpacity="0.85" />
    <circle cx="400" cy="130" r="6" fillOpacity="0.85" />
    <circle cx="425" cy="140" r="6" fillOpacity="0.85" />
    <circle cx="455" cy="105" r="6" fillOpacity="0.85" />
    <circle cx="485" cy="92" r="6" fillOpacity="0.85" />
    <circle cx="515" cy="100" r="6" fillOpacity="0.85" />
    <circle cx="545" cy="70" r="6" fillOpacity="0.85" />
  </g>
