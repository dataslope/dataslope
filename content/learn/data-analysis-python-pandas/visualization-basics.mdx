...
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`fig = px.histogram(df, x="satisfaction_level", nbins=30,
...
import plotly.express as px
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`fig = px.box(df, x="salary", y="satisfaction_level",
...
import plotly.express as px
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`fig = px.scatter(df, x="average_montly_hours", y="satisfaction_level",
...
import plotly.express as px
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`fig = px.histogram(df, x="satisfaction_level", facet_col="salary",
