...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A blue root folder with a small readme page branches into tidy green, yellow, and blue subfolders, each holding its own dots of content — a little structure keeping a project survivable"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <circle cx="348" cy="120" r="5" fillOpacity="0.6" />
    <circle cx="366" cy="120" r="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="258,144 258,138 280,138 286,144" />
    <rect x="258" y="144" width="64" height="32" rx="5" fillOpacity="0.75" />
    <circle cx="348" cy="160" r="5" fillOpacity="0.6" />
    <circle cx="366" cy="160" r="5" fillOpacity="0.6" />
    <circle cx="384" cy="160" r="5" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="258,184 258,178 280,178 286,184" />
    <rect x="258" y="184" width="64" height="32" rx="5" fillOpacity="0.5" />
    <circle cx="348" cy="200" r="5" fillOpacity="0.5" />
    <circle cx="366" cy="200" r="5" fillOpacity="0.5" />
  </g>
</svg>
