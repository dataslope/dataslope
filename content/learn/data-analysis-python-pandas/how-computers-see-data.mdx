...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A letter, a digit, and a colored pixel each dissolve downward into a row of on-off dots — everything a computer stores becomes patterns of bits"
...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <circle cx="160" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="174" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="188" cy="130" r="6" fillOpacity="0.15" />
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="320" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="334" cy="130" r="6" />
    <circle cx="348" cy="130" r="6" />
    <circle cx="362" cy="130" r="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="480" cy="50" r="14" />
    <circle cx="438" cy="130" r="6" />
    <circle cx="452" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="466" cy="130" r="6" />
    <circle cx="480" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="494" cy="130" r="6" fillOpacity="0.15" />
    <circle cx="508" cy="130" r="6" />
    <circle cx="522" cy="130" r="6" fillOpacity="0.15" />
  </g>
...
The simplest data format in the world: each line is a row, each
value is separated by a comma, the first line is often a header.
