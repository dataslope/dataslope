...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Five bright stars of different colors joined by thin lines into a constellation against a few dim background stars — separate habits of mind forming one analyst's outlook"
...
>
  ...
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M128 141 L 222 69" />
    <path d="M239 69 L 322 121" />
    <path d="M338 121 L 432 59" />
    <path d="M448 59 L 532 111" />
  </g>
