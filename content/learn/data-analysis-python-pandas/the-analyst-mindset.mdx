...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Five bright stars of different colors joined by faint dotted lines into a constellation against a few dim background stars — separate habits of mind forming one analyst's outlook"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="175" cy="105" r="2.5" />
    <circle cx="202" cy="82" r="2.5" />
    <circle cx="255" cy="78" r="2.5" />
    <circle cx="280" cy="95" r="2.5" />
    <circle cx="305" cy="112" r="2.5" />
    <circle cx="358" cy="110" r="2.5" />
    <circle cx="385" cy="90" r="2.5" />
    <circle cx="412" cy="70" r="2.5" />
    <circle cx="465" cy="68" r="2.5" />
    <circle cx="490" cy="85" r="2.5" />
    <circle cx="515" cy="102" r="2.5" />
    <circle cx="172" cy="145" r="2.5" />
    <circle cx="225" cy="140" r="2.5" />
    <circle cx="278" cy="135" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="120" cy="150" r="9" />
    <circle cx="440" cy="50" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="230" cy="60" r="11" />
  </g>
