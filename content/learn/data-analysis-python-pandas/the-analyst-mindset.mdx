...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A simple balance scale weighing two solid colored dots on one pan against a single faint one on the other — the analyst habit of weighing evidence before trusting a number"
...
>
  <g
    ...
    strokeLinecap="round"
  >
    <path d="M190 70 H 450" strokeWidth="3" />
    <path d="M320 70 V 168" strokeWidth="3" />
    <path d="M190 70 L 172 106" strokeWidth="2" />
    <path d="M190 70 L 208 106" strokeWidth="2" />
    <path d="M450 70 L 432 106" strokeWidth="2" />
    <path d="M450 70 L 468 106" strokeWidth="2" />
    <path d="M160 106 A 30 30 0 0 0 220 106" strokeWidth="3" />
    <path d="M420 106 A 30 30 0 0 0 480 106" strokeWidth="3" />
  </g>
  <g style={{ color: "var(--ds-gray-300)" }} fill="currentColor">
    <rect x="282" y="168" width="76" height="9" rx="4.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="179" cy="98" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="202" cy="101" r="8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="450" cy="98" r="12" fillOpacity="0.4" />
  </g>
</svg>
