...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Rows pass a checkpoint column of green and red mask cells; only the rows beside green cells continue onward with a green badge — a boolean mask filtering a DataFrame"
