...
That is a real HR dataset with about 15,000 employees. In a few
chapters you will be slicing it by department, comparing salaries,
flagging employees at risk of leaving, and building charts that
explain what you found — all in code that you can re-run tomorrow
on next month's data without changing a single line.
