...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A notebook page of alternating cells — blue code blocks each followed by their green output, one of which is a tiny chart, with small yellow run dots down the margin"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <circle cx="192" cy="127" r="5" />
    <circle cx="192" cy="198" r="4" />
  </g>
</svg>
