...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A grid of faint cells with one full row highlighted green and one full column highlighted blue, meeting at a single yellow cell — every value lives where a record crosses an attribute"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.1">
    <rect x="140" y="45" width="62" height="28" rx="5" />
    <rect x="212" y="45" width="62" height="28" rx="5" />
    <rect x="356" y="45" width="62" height="28" rx="5" />
    <rect x="428" y="45" width="62" height="28" rx="5" />
    <rect x="140" y="81" width="62" height="28" rx="5" />
    <rect x="212" y="81" width="62" height="28" rx="5" />
    <rect x="356" y="81" width="62" height="28" rx="5" />
    <rect x="428" y="81" width="62" height="28" rx="5" />
    <rect x="140" y="153" width="62" height="28" rx="5" />
    <rect x="212" y="153" width="62" height="28" rx="5" />
    <rect x="356" y="153" width="62" height="28" rx="5" />
    <rect x="428" y="153" width="62" height="28" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="284" y="45" width="62" height="28" rx="5" fillOpacity="0.5" />
    <rect x="284" y="81" width="62" height="28" rx="5" fillOpacity="0.5" />
    <rect x="284" y="153" width="62" height="28" rx="5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="140" y="117" width="62" height="28" rx="5" fillOpacity="0.5" />
    <rect x="212" y="117" width="62" height="28" rx="5" fillOpacity="0.5" />
    <rect x="356" y="117" width="62" height="28" rx="5" fillOpacity="0.5" />
    <rect x="428" y="117" width="62" height="28" rx="5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="284" y="117" width="62" height="28" rx="5" />
  </g>
</svg>
...
employees = pd.DataFrame({
    ...
    "tenure_yrs": [3, 6, 7, 2, 4],
      ...
      starterCode: `# Filter: rows where the department attribute equals "Eng"
