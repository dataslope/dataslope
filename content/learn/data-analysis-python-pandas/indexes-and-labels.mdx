...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two rows of cells reach toward each other with little label tags between them; matching tags connect straight down except one crossed pair — pandas lines values up by label, not by position"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="150" y="50" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="220" y="50" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="290" y="50" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="360" y="50" width="60" height="28" rx="6" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="172" y="86" width="16" height="10" rx="5" />
    <rect x="238" y="86" width="24" height="10" rx="5" />
    <rect x="304" y="86" width="32" height="10" rx="5" />
    <rect x="370" y="86" width="40" height="10" rx="5" />
    <rect x="172" y="114" width="16" height="10" rx="5" />
    <rect x="238" y="114" width="24" height="10" rx="5" />
    <rect x="370" y="114" width="32" height="10" rx="5" />
    <rect x="300" y="114" width="40" height="10" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="180" cy="101" r="2.5" />
    <circle cx="180" cy="109" r="2.5" />
    <circle cx="250" cy="101" r="2.5" />
    <circle cx="250" cy="109" r="2.5" />
    <circle cx="338" cy="100" r="2.5" />
    <circle cx="355" cy="105" r="2.5" />
    <circle cx="372" cy="110" r="2.5" />
    <circle cx="372" cy="100" r="2.5" />
    <circle cx="338" cy="110" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="150" y="132" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="220" y="132" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="290" y="132" width="60" height="28" rx="6" fillOpacity="0.6" />
    <rect x="360" y="132" width="60" height="28" rx="6" fillOpacity="0.6" />
  </g>
</svg>
