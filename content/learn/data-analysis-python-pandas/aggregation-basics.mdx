...
df = pd.read_csv("https://raw.githubusercontent.com/bdi475/datasets/main/HR-dataset-v14.csv")`}
  initialCode={`print("Distinct job roles:", df["JobRole"].nunique())
print()
...
- 14.0
- [o] 23.33 (= (10+20+40) / 3)
  > Right. Pandas' aggregations skip NaN by default. Pass \`skipna=False\` to make NaN propagate.
- 70.0
...
- The sum
- [o] The median
  > Yes. Medians are computed by position, not magnitude — they barely move when an extreme value is added.
- The max
