...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three colored roads from three separate starting circles taper and merge into one large node that carries all three colors inside it — statistics, computing, and business converging into data science"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="80" cy="50" r="16" />
    <polygon points="104,44 398,104 398,114 104,58" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="80" cy="110" r="16" />
    <polygon points="104,104 398,105 398,115 104,116" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="80" cy="170" r="16" />
    <polygon points="104,162 398,106 398,116 104,176" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="430" cy="110" r="34" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="420" cy="102" r="5" fillOpacity="0.9" />
    <circle cx="440" cy="102" r="5" fillOpacity="0.9" />
    <circle cx="430" cy="122" r="5" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="478" cy="110" r="3" />
    <circle cx="496" cy="110" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="512,102 528,110 512,118" />
  </g>
</svg>
