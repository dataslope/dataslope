...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A stack of jumbled bars passes through an arrow and reorders into a neat descending stack with small yellow rank medals beside the leaders — sort_values and rank at work"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="270" cy="118" r="3" />
    <circle cx="293" cy="118" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="312,108 330,118 312,128" />
  </g>
...
print(
    df.nlargest(5, "MonthlyIncome")[["Age", "JobRole", "Department", "MonthlyIncome"]]
)
print()

# Bottom 5 by income
print(
    df.nsmallest(5, "MonthlyIncome")[["Age", "JobRole", "Department", "MonthlyIncome"]]
)
`,
    },
  ]}
...
top3 = (
    ...
    .groupby("Department")
    .head(3)[["Department", "JobRole", "MonthlyIncome"]]
)
