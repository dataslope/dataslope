...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A few dots sit calmly inside a small box while an ever-widening flood of larger and larger dots streams out beyond it — datasets outgrowing the tools built to hold them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="65" y="80" width="115" height="80" rx="10" fill="currentColor" opacity="0.1" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="92" cy="105" r="5" />
    <circle cx="118" cy="105" r="5" />
    <circle cx="92" cy="135" r="5" />
    <circle cx="118" cy="135" r="5" />
    <circle cx="148" cy="120" r="5" fillOpacity="0.6" />
    <circle cx="208" cy="104" r="4" />
    <circle cx="212" cy="138" r="4" fillOpacity="0.7" />
    <circle cx="248" cy="88" r="5" />
    <circle cx="252" cy="120" r="5" fillOpacity="0.7" />
    <circle cx="256" cy="152" r="5" />
    <circle cx="296" cy="70" r="6" fillOpacity="0.7" />
    <circle cx="300" cy="104" r="6" />
    <circle cx="304" cy="138" r="6" fillOpacity="0.7" />
    <circle cx="298" cy="170" r="6" />
    <circle cx="352" cy="56" r="7" />
    <circle cx="356" cy="94" r="7" fillOpacity="0.7" />
    <circle cx="360" cy="132" r="7" />
    <circle cx="354" cy="168" r="7" fillOpacity="0.7" />
    <circle cx="420" cy="42" r="7" fillOpacity="0.7" />
    <circle cx="424" cy="84" r="8" />
    <circle cx="428" cy="128" r="8" fillOpacity="0.7" />
    <circle cx="422" cy="170" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="490" cy="60" r="8" />
    <circle cx="496" cy="148" r="8" />
    <circle cx="556" cy="106" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="492" cy="104" r="8" />
    <circle cx="552" cy="54" r="8" />
    <circle cx="554" cy="158" r="8" />
  </g>
</svg>
