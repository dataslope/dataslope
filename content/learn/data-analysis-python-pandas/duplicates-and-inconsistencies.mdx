...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="In a stack of records one row is an exact twin sliding out toward a red cross, while on the right two pills of the same shape but different shades sit around an approximately-equals sign — duplicates and inconsistent labels"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="35" width="160" height="24" rx="12" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="115" cy="47" r="4" fillOpacity="0.9" />
    <circle cx="135" cy="47" r="4" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="90" y="67" width="160" height="24" rx="12" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="120" y="99" width="160" height="24" rx="12" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="145" cy="111" r="4" fillOpacity="0.9" />
    <circle cx="165" cy="111" r="4" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="96" cy="111" r="2.5" />
    <circle cx="108" cy="111" r="2.5" />
  </g>
  ...
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="163" width="160" height="24" rx="12" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
