...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A ruled paper ledger with a red margin line and green amount entries stands beside an early computer monitor showing the same figures as a glowing spreadsheet grid"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="70" y="40" width="170" height="150" rx="8" fill="currentColor" opacity="0.08" />
  <rect x="85" y="70" width="120" height="3" rx="1.5" fill="currentColor" opacity="0.12" />
  <rect x="85" y="95" width="120" height="3" rx="1.5" fill="currentColor" opacity="0.12" />
  <rect x="85" y="120" width="120" height="3" rx="1.5" fill="currentColor" opacity="0.12" />
  <rect x="85" y="145" width="120" height="3" rx="1.5" fill="currentColor" opacity="0.12" />
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="110" y="52" width="3" height="126" rx="1.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="165" y="61" width="40" height="10" rx="5" fillOpacity="0.8" />
    <rect x="175" y="86" width="30" height="10" rx="5" fillOpacity="0.5" />
    <rect x="160" y="111" width="45" height="10" rx="5" fillOpacity="0.65" />
    <rect x="170" y="136" width="35" height="10" rx="5" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="262" cy="115" r="3" />
    <circle cx="282" cy="115" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="300,107 316,115 300,123" />
  </g>
  <rect x="350" y="45" width="210" height="140" rx="14" fill="currentColor" opacity="0.1" />
  <rect x="435" y="185" width="40" height="10" rx="4" fill="currentColor" opacity="0.15" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="366" y="60" width="178" height="104" rx="8" fillOpacity="0.12" />
    <rect x="376" y="70" width="50" height="26" rx="4" fillOpacity="0.5" />
    <rect x="432" y="70" width="50" height="26" rx="4" fillOpacity="0.3" />
    <rect x="488" y="70" width="50" height="26" rx="4" fillOpacity="0.5" />
    <rect x="376" y="102" width="50" height="26" rx="4" fillOpacity="0.3" />
    <rect x="432" y="102" width="50" height="26" rx="4" fillOpacity="0.5" />
    <rect x="488" y="102" width="50" height="26" rx="4" fillOpacity="0.3" />
    <rect x="376" y="134" width="50" height="26" rx="4" fillOpacity="0.5" />
    <rect x="432" y="134" width="50" height="26" rx="4" fillOpacity="0.3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="488" y="134" width="50" height="26" rx="4" fillOpacity="0.9" />
  </g>
</svg>
