...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A thin trail climbs from clay tally marks through a grid of spreadsheet cells and a tiny bar chart to an arrow pointing onward — the journey from ancient counting to modern data analysis"
