...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A scatter of many dots passes between two converging funnel walls and emerges as one large green circle trailed by small satellite values — a whole distribution compressed into a few summary numbers"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="85" cy="70" r="5" fillOpacity="0.6" />
    <circle cx="120" cy="52" r="4" fillOpacity="0.5" />
    <circle cx="150" cy="84" r="6" fillOpacity="0.7" />
    <circle cx="95" cy="120" r="7" fillOpacity="0.8" />
    <circle cx="135" cy="140" r="5" fillOpacity="0.55" />
    <circle cx="180" cy="60" r="5" fillOpacity="0.6" />
    <circle cx="190" cy="118" r="7" fillOpacity="0.75" />
    <circle cx="160" cy="170" r="4" fillOpacity="0.5" />
    <circle cx="110" cy="170" r="5" fillOpacity="0.6" />
    <circle cx="220" cy="90" r="6" fillOpacity="0.7" />
    <circle cx="215" cy="150" r="5" fillOpacity="0.55" />
    <circle cx="75" cy="155" r="4" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <polygon points="255,42 372,104 369,112 252,50" />
    <polygon points="252,170 369,108 372,116 255,178" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="440" cy="110" r="28" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="472" cy="88" r="2.5" />
    <circle cx="484" cy="79" r="2.5" />
    <circle cx="476" cy="122" r="2.5" />
    <circle cx="492" cy="126" r="2.5" />
    <circle cx="463" cy="142" r="2.5" />
    <circle cx="470" cy="156" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="510" cy="68" r="9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="516" cy="130" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="482" cy="170" r="7" fillOpacity="0.6" />
  </g>
</svg>
