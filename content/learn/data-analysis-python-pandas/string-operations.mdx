...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Ragged text bars trailing faint whitespace chunks pass a vertical trim blade and come out clean, even, and green — string methods cleaning a whole column at once"
...
>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="290" y="28" width="8" height="148" rx="4" />
    <polygon points="282,18 306,18 294,34" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="330" cy="104" r="3" />
    <circle cx="348" cy="104" r="3" />
  </g>
