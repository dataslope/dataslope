...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Side by side: a spreadsheet grid with one hand-edited yellow cell under a mouse pointer, versus stacked lines of code with a green run button — manual clicks against a rerunnable script"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="318" y="30" width="4" height="170" rx="2" fill="currentColor" opacity="0.08" />
  <g fill="currentColor" opacity="0.12">
    <rect x="70" y="50" width="48" height="28" rx="5" />
    <rect x="126" y="50" width="48" height="28" rx="5" />
    <rect x="182" y="50" width="48" height="28" rx="5" />
    <rect x="70" y="86" width="48" height="28" rx="5" />
    <rect x="182" y="86" width="48" height="28" rx="5" />
    <rect x="70" y="122" width="48" height="28" rx="5" />
    <rect x="126" y="122" width="48" height="28" rx="5" />
    <rect x="182" y="122" width="48" height="28" rx="5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="126" y="86" width="48" height="28" rx="5" fillOpacity="0.9" />
  </g>
  <polygon points="160,108 160,134 167,127 172,138 178,135 173,125 181,124" fill="currentColor" opacity="0.55" />
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="370" y="54" width="150" height="12" rx="6" fillOpacity="0.8" />
    <rect x="370" y="78" width="110" height="12" rx="6" fillOpacity="0.5" />
    <rect x="390" y="102" width="120" height="12" rx="6" fillOpacity="0.65" />
    <rect x="390" y="126" width="90" height="12" rx="6" fillOpacity="0.5" />
    <rect x="370" y="150" width="130" height="12" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="560" cy="160" r="18" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <polygon points="554,151 554,169 569,160" fillOpacity="0.95" />
  </g>
</svg>
