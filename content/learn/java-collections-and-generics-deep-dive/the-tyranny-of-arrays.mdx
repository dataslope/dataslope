...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A welded row of six fixed cells with capped ends turns a waiting yellow dot away, while below a flexible chain of green beads simply links in a new one"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="126" y="34" width="8" height="52" rx="3" fillOpacity="0.8" />
    <rect x="134" y="38" width="52" height="44" fillOpacity="0.55" />
    <rect x="186" y="38" width="52" height="44" fillOpacity="0.3" />
    <rect x="238" y="38" width="52" height="44" fillOpacity="0.55" />
    <rect x="290" y="38" width="52" height="44" fillOpacity="0.3" />
    <rect x="342" y="38" width="52" height="44" fillOpacity="0.55" />
    <rect x="394" y="38" width="52" height="44" fillOpacity="0.3" />
    <rect x="446" y="34" width="8" height="52" rx="3" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="492" cy="60" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="482" y="36" width="20" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="140" cy="158" r="10" />
    <circle cx="205" cy="146" r="10" />
    <circle cx="270" cy="160" r="10" />
    <circle cx="335" cy="170" r="10" />
    <circle cx="400" cy="158" r="10" />
    <circle cx="465" cy="146" r="10" />
    <circle cx="525" cy="140" r="10" fillOpacity="0.4" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="162" cy="154" r="3" />
    <circle cx="183" cy="150" r="3" />
    <circle cx="227" cy="151" r="3" />
    <circle cx="248" cy="155" r="3" />
    <circle cx="292" cy="163" r="3" />
    <circle cx="313" cy="167" r="3" />
    <circle cx="357" cy="166" r="3" />
    <circle cx="378" cy="162" r="3" />
    <circle cx="422" cy="154" r="3" />
    <circle cx="443" cy="150" r="3" />
    <circle cx="487" cy="144" r="3" />
    <circle cx="506" cy="142" r="3" />
  </g>
</svg>
