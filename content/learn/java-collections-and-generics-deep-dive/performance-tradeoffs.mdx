...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three stacks of steps under three dots: the green dot needs one step, the blue dot three, the yellow dot seven — the same operation costs differently in different containers"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="100" y="202" width="440" height="6" rx="3" fill="currentColor" opacity="0.2" />
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="145" y="176" width="70" height="16" rx="6" fillOpacity="0.55" />
    <circle cx="180" cy="158" r="9" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="285" y="176" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="285" y="154" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="285" y="132" width="70" height="16" rx="6" fillOpacity="0.55" />
    <circle cx="320" cy="114" r="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="425" y="176" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="154" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="132" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="110" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="88" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="66" width="70" height="16" rx="6" fillOpacity="0.55" />
    <rect x="425" y="44" width="70" height="16" rx="6" fillOpacity="0.55" />
    <circle cx="460" cy="26" r="9" />
  </g>
</svg>
