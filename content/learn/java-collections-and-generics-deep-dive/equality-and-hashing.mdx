...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Two equal dots with matching green badge rings land in one shared bucket, but an equal-looking pair whose rings disagree fall into two different buckets — equals and hashCode must match"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="135" cy="70" r="15" />
    <circle cx="235" cy="70" r="15" />
    <circle cx="405" cy="70" r="15" />
    <circle cx="505" cy="70" r="15" />
  </g>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="205" cy="138" r="3" />
    <circle cx="407" cy="118" r="3" />
    <circle cx="411" cy="136" r="3" />
    <circle cx="507" cy="118" r="3" />
    <circle cx="511" cy="136" r="3" />
  </g>
  <g fill="currentColor" opacity="0.1">
    <rect x="135" y="160" width="100" height="44" rx="10" />
    <rect x="375" y="160" width="80" height="44" rx="10" />
    <rect x="475" y="160" width="80" height="44" rx="10" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="185" cy="182" r="9" />
    <circle cx="415" cy="182" r="9" />
    <circle cx="515" cy="182" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <rect x="456" y="179.5" width="18" height="5" rx="2.5" transform="rotate(45 465 182)" />
    <rect x="456" y="179.5" width="18" height="5" rx="2.5" transform="rotate(-45 465 182)" />
  </g>
</svg>
