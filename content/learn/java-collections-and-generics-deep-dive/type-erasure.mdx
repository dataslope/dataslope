...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A container stamped with a solid green type seal crosses a tall wall and comes out the other side intact — except the seal has faded to a ghost, evaporating in little green puffs"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="75" y="70" width="150" height="90" rx="14" fillOpacity="0.14" />
    <circle cx="110" cy="118" r="9" />
    <circle cx="150" cy="118" r="9" />
    <circle cx="190" cy="118" r="9" />
    <rect x="405" y="70" width="150" height="90" rx="14" fillOpacity="0.14" />
    <circle cx="440" cy="118" r="9" />
    <circle cx="480" cy="118" r="9" />
    <circle cx="520" cy="118" r="9" />
  </g>
