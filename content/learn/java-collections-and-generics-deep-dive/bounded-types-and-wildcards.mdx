...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A container with a narrow spout lets dots climb out but bars one from entering, while its neighbor's wide hopper welcomes dots in yet only offers a question mark back"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="85" y="130" width="170" height="70" rx="14" fillOpacity="0.15" />
    <polygon points="150,130 190,130 178,86 162,86" fillOpacity="0.3" />
    <circle cx="120" cy="166" r="8" />
    <circle cx="160" cy="166" r="6" />
    <circle cx="200" cy="166" r="10" />
    <circle cx="170" cy="64" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <polygon points="162,46 178,46 170,30" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="228" cy="64" r="7" fillOpacity="0.5" />
    <rect x="219" y="80" width="18" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="385" y="130" width="170" height="70" rx="14" fillOpacity="0.15" />
    <polygon points="410,130 530,130 556,72 384,72" fillOpacity="0.3" />
    <polygon points="462,60 478,60 470,76" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="470" cy="48" r="8" />
    <circle cx="430" cy="172" r="7" fillOpacity="0.5" />
    <circle cx="510" cy="172" r="6" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="470" cy="92" r="3" />
