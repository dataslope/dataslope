...
public class Main {
    public static void main(String[] args) {
        ...
        // List<Number> nums = ints;     // compile error — would let us add a Double
...
public class Main {
    ...
    static void printAll(List<?> xs) {
        for (Object o : xs) System.out.println(o);
...
public class Main {
    public static void main(String[] args) {
        List<Integer> ints = new ArrayList<>();
        ints.add(3); ints.add(9); ints.add(1);
