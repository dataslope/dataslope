...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A translucent container bears a green rosette seal stamped with the letter T, and the tagged dot that enters on one side leaves the other still wearing the same tag"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="230" y="58" width="180" height="104" rx="16" fillOpacity="0.12" />
    <circle cx="275" cy="122" r="10" />
    <circle cx="320" cy="122" r="10" />
    <circle cx="365" cy="122" r="10" />
    <circle cx="105" cy="110" r="10" />
    <circle cx="530" cy="110" r="10" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="434" cy="58" r="5.5" />
    <circle cx="427" cy="75" r="5.5" />
    <circle cx="410" cy="82" r="5.5" />
    <circle cx="393" cy="75" r="5.5" />
    <circle cx="386" cy="58" r="5.5" />
    <circle cx="393" cy="41" r="5.5" />
    <circle cx="410" cy="34" r="5.5" />
    <circle cx="427" cy="41" r="5.5" />
    <circle cx="410" cy="58" r="19" />
    <rect x="113" y="96" width="12" height="8" rx="2" />
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="435" cy="110" r="3" />
    <circle cx="460" cy="110" r="3" />
    <circle cx="485" cy="110" r="3" />
  </g>
</svg>
