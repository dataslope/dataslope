...
- You are doing many `addFirst` / `removeFirst` and need an *eqaure*
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ArrayList  append " + n + " : " + (a / 1_000_000) + " ms");
        System.out.println("LinkedList append " + n + " : " + (l / 1_000_000) + " ms");
    }
}
`}
/>
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10_000; i++) xs.add(i);
