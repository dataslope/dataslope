...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A full row of four cells has no room for the waiting yellow dot, so below it a doubled row of eight appears — old cells copied, the newcomer in green, three faint ghost cells in reserve"
...
>
  ...
  <g fill="currentColor" opacity="0.35">
    <circle cx="320" cy="96" r="3" />
    <circle cx="320" cy="110" r="3" />
    <polygon points="312,122 328,122 320,134" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
