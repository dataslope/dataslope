...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="An open container freely lets dots flow in and out, while the green container beside it wears a lid and padlock and a red dot simply bounces away — immutable collections refuse change"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="75" y="92" width="170" height="88" rx="14" fillOpacity="0.12" />
    <circle cx="115" cy="140" r="9" />
    <circle cx="157" cy="140" r="9" />
    <circle cx="199" cy="140" r="9" />
    <circle cx="120" cy="40" r="8" />
    <polygon points="112,80 128,80 120,92" fillOpacity="0.5" />
    <circle cx="282" cy="128" r="8" fillOpacity="0.7" />
    <polygon points="296,120 296,136 310,128" fillOpacity="0.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="120" cy="58" r="3" />
    <circle cx="120" cy="72" r="3" />
    <circle cx="252" cy="132" r="3" />
    <circle cx="266" cy="130" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="395" y="92" width="170" height="88" rx="14" fillOpacity="0.15" />
    <circle cx="435" cy="140" r="9" />
    <circle cx="477" cy="140" r="9" />
    <circle cx="519" cy="140" r="9" />
    <rect x="395" y="78" width="170" height="14" rx="7" fillOpacity="0.55" />
    <path d="M467 46 a13 13 0 1 0 26 0 a13 13 0 1 0 -26 0 Z M472 46 a8 8 0 1 1 16 0 a8 8 0 1 1 -16 0 Z" fillRule="evenodd" />
    <rect x="460" y="46" width="40" height="28" rx="7" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="480" cy="58" r="3.5" />
    <rect x="478" y="60" width="4" height="7" rx="2" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="566" cy="64" r="3" fillOpacity="0.5" />
    <circle cx="578" cy="52" r="3" fillOpacity="0.6" />
    <circle cx="590" cy="44" r="3" fillOpacity="0.7" />
    <circle cx="602" cy="36" r="8" />
  </g>
</svg>
