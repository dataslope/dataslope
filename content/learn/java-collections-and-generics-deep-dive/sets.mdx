...
public class Main {
    public static void main(String[] args) {
        ...
        for (String url : visited) System.out.println(url);
    }
}
`}
/>
...
public class Main {
    public static void main(String[] args) {
        ...
        sorted.add(3); sorted.add(1); sorted.add(4); sorted.add(1); sorted.add(5);

        System.out.println(sorted);            // [1, 3, 4, 5] — sorted, no dupes

        TreeSet<String> words = new TreeSet<>();
        words.add("zeta"); words.add("alpha"); words.add("mu");
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("intersection = " + new java.util.TreeSet<>(intersection));
...
`,
    },
    {
      ...
      initialContent: `import java.util.LinkedHashSet;
import java.util.Set;
