...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Four translucent vessels of different shapes sit on one shelf, all holding identical gray dots; one dot lifted out trails a yellow question mark — every early container held anonymous Objects"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="100" y="78" width="70" height="80" rx="10" fillOpacity="0.14" />
    <rect x="210" y="98" width="70" height="60" rx="10" fillOpacity="0.14" />
    <rect x="320" y="88" width="110" height="70" rx="12" fillOpacity="0.14" />
    <rect x="470" y="112" width="60" height="46" rx="10" fillOpacity="0.14" />
  </g>
  <rect x="70" y="158" width="500" height="8" rx="4" fill="currentColor" opacity="0.25" />
  <g fill="currentColor" opacity="0.45">
    <circle cx="120" cy="140" r="5" />
    <circle cx="140" cy="140" r="5" />
    <circle cx="130" cy="118" r="5" />
    <circle cx="245" cy="142" r="5" />
    <circle cx="245" cy="124" r="5" />
    <circle cx="350" cy="138" r="5" />
    <circle cx="378" cy="138" r="5" />
    <circle cx="406" cy="138" r="5" />
    <circle cx="490" cy="140" r="5" />
    <circle cx="510" cy="140" r="5" />
    <circle cx="135" cy="46" r="5" />
  </g>
