...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A tray of three labeled molds: poured values harden into exactly the shape of their cavity, with one still being filled from a ladle — every Java value cast into a declared type"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.1">
    <rect x="90" y="130" width="460" height="70" rx="14" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="180" cy="165" r="26" />
    <rect x="300" y="139" width="52" height="52" rx="8" />
    <polygon points="414,191 466,191 440,143" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="165" r="20" />
    <rect x="164" y="113" width="32" height="12" rx="6" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="306" y="145" width="40" height="40" rx="6" />
    <rect x="310" y="113" width="32" height="12" rx="6" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="424" y="113" width="32" height="12" rx="6" fillOpacity="0.5" />
    <rect x="470" y="52" width="44" height="16" rx="8" fillOpacity="0.8" transform="rotate(24 492 60)" />
    <circle cx="462" cy="76" r="4" />
    <circle cx="456" cy="92" r="4" />
    <circle cx="450" cy="108" r="4" />
    <circle cx="446" cy="124" r="4" />
    <polygon points="424,191 456,191 440,173" />
  </g>
</svg>
