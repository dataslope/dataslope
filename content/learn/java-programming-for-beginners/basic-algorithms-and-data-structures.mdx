...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="A pocket multi-tool fanned open: one blade dotted for scanning one by one, one notched for halving, and one stepped for sorting — classic algorithms as tools you learn to reach for"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor" transform="rotate(-40 290 172)">
    <rect x="282" y="40" width="16" height="132" rx="8" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor" transform="rotate(-40 290 172)">
    <circle cx="290" cy="62" r="3.5" fillOpacity="0.9" />
    <circle cx="290" cy="80" r="3.5" fillOpacity="0.9" />
    <circle cx="290" cy="98" r="3.5" fillOpacity="0.9" />
    <circle cx="290" cy="116" r="3.5" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" transform="rotate(0 290 172)">
    <rect x="282" y="40" width="16" height="132" rx="8" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <rect x="284" y="54" width="5" height="20" rx="2" fillOpacity="0.85" />
    <rect x="291" y="54" width="5" height="20" rx="2" fillOpacity="0.85" />
    <circle cx="290" cy="92" r="3" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor" transform="rotate(40 290 172)">
    <rect x="282" y="40" width="16" height="132" rx="8" fillOpacity="0.9" />
    <rect x="283" y="64" width="4" height="10" rx="1.5" fillOpacity="0.95" />
    <rect x="288" y="58" width="4" height="16" rx="1.5" fillOpacity="0.95" />
    <rect x="293" y="52" width="4" height="22" rx="1.5" fillOpacity="0.95" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="240" y="150" width="160" height="44" rx="20" />
  </g>
  <g style={{ color: "var(--ds-white)" }} fill="currentColor">
    <circle cx="290" cy="172" r="6" fillOpacity="0.9" />
    <rect x="320" y="168" width="56" height="8" rx="4" fillOpacity="0.4" />
  </g>
