...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A faint parent chassis on wheels branches into two vehicles that inherit the identical blue base but carry different bodies, and the same incoming call makes each respond with its own shapes — inheritance and polymorphism"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="270" y="46" width="100" height="18" rx="9" fillOpacity="0.25" />
    <circle cx="292" cy="70" r="9" fillOpacity="0.25" />
    <circle cx="348" cy="70" r="9" fillOpacity="0.25" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="282" cy="96" r="3" />
    <circle cx="252" cy="106" r="3" />
    <circle cx="222" cy="116" r="3" />
    <circle cx="358" cy="96" r="3" />
    <circle cx="388" cy="106" r="3" />
    <circle cx="418" cy="116" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="120" y="116" width="90" height="34" rx="6" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M420 152A40 40 0 0 1 500 152Z" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="110" y="152" width="120" height="18" rx="9" />
    <circle cx="138" cy="180" r="10" />
    <circle cx="202" cy="180" r="10" />
    <rect x="400" y="152" width="120" height="18" rx="9" />
    <circle cx="428" cy="180" r="10" />
    <circle cx="492" cy="180" r="10" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="56" cy="160" r="3" />
    <circle cx="74" cy="160" r="3" />
    <circle cx="90" cy="160" r="3" />
    <polygon points="98,154 110,160 98,166" />
    <circle cx="584" cy="160" r="3" />
    <circle cx="566" cy="160" r="3" />
    <circle cx="550" cy="160" r="3" />
    <polygon points="542,154 530,160 542,166" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="240" y="128" width="9" height="9" rx="2" fillOpacity="0.6" />
    <rect x="254" y="116" width="8" height="8" rx="2" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="386" cy="132" r="5" fillOpacity="0.6" />
    <circle cx="372" cy="120" r="4" fillOpacity="0.45" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="80" y="192" width="480" height="4" rx="2" />
  </g>
</svg>
...
- [o] It tells the compiler "this method is supposed to override a parent's method," so a typo or signature mismatch becomes a compile error instead of a silently-new method
  > The annotation is a compile-time check; it catches mistakes that would otherwise create an unrelated new method.
...
`,
      solutionCode: `public abstract class Animal {
...
`,
      solutionCode: `public class Dog extends Animal {
  @Override
  public String speak() {
    return "Woof!";
  }
