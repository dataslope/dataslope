...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Inside an irregular, quirky real computer sits a perfectly round idealized machine with even tick marks and a green core — the JVM, an imaginary computer your program can rely on"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.08">
    <polygon points="150,60 420,48 500,70 520,150 470,196 200,204 120,160 110,90" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <rect x="514" y="100" width="18" height="8" rx="3" />
    <rect x="512" y="128" width="18" height="8" rx="3" />
    <rect x="240" y="198" width="8" height="16" rx="3" />
    <rect x="300" y="200" width="8" height="16" rx="3" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="168" y="92" width="26" height="18" rx="3" transform="rotate(-12 181 101)" />
    <rect x="438" y="84" width="20" height="20" rx="3" transform="rotate(9 448 94)" />
    <rect x="428" y="164" width="24" height="14" rx="3" transform="rotate(-7 440 171)" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="320" cy="128" r="56" fillOpacity="0.12" />
    <circle cx="366" cy="128" r="3.5" />
    <circle cx="352.5" cy="160.5" r="3.5" />
    <circle cx="320" cy="174" r="3.5" />
    <circle cx="287.5" cy="160.5" r="3.5" />
    <circle cx="274" cy="128" r="3.5" />
    <circle cx="287.5" cy="95.5" r="3.5" />
    <circle cx="320" cy="82" r="3.5" />
    <circle cx="352.5" cy="95.5" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="320" cy="128" r="14" />
  </g>
</svg>
