...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A steady pulse line with one alarming red beat, a stethoscope resting calmly beneath it and green checks under the beats already ruled out — debugging as unhurried diagnosis, not panic"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.12">
    <rect x="70" y="120" width="500" height="3" rx="1.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="110,121 120,86 130,121" fillOpacity="0.6" />
    <polygon points="190,121 200,86 210,121" fillOpacity="0.6" />
    <polygon points="270,121 280,86 290,121" fillOpacity="0.6" />
    <polygon points="430,121 440,86 450,121" fillOpacity="0.6" />
    <polygon points="510,121 520,86 530,121" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="344,121 354,58 360,96 366,70 374,121" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="120" cy="146" r="4" fillOpacity="0.55" />
    <circle cx="200" cy="146" r="4" fillOpacity="0.55" />
    <circle cx="280" cy="146" r="4" fillOpacity="0.55" />
    <circle cx="360" cy="162" r="24" fillOpacity="0.35" />
    <circle cx="360" cy="162" r="9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="392" cy="154" r="3" />
    <circle cx="420" cy="138" r="3" />
    <circle cx="444" cy="116" r="3" />
    <circle cx="458" cy="90" r="3" />
    <circle cx="462" cy="64" r="3" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="452" cy="46" r="5" fillOpacity="0.7" />
    <circle cx="478" cy="52" r="5" fillOpacity="0.7" />
  </g>
</svg>
