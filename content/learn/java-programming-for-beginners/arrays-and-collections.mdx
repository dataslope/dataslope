...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A five-slot egg carton is full and turns the next egg away with a red mark, while the stretchy green bag beside it simply bulges to catch one more — fixed arrays versus growable lists"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="80" y="90" width="220" height="70" rx="12" fillOpacity="0.12" />
  </g>
  <g fill="currentColor" opacity="0.15">
    <circle cx="118" cy="125" r="14" />
    <circle cx="158" cy="125" r="14" />
    <circle cx="198" cy="125" r="14" />
    <circle cx="238" cy="125" r="14" />
    <circle cx="278" cy="125" r="14" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="118" cy="125" r="9" />
    <circle cx="158" cy="125" r="9" />
    <circle cx="198" cy="125" r="9" />
    <circle cx="238" cy="125" r="9" />
    <circle cx="278" cy="125" r="9" />
    <circle cx="322" cy="68" r="9" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="344,54 352,62 344,70 336,62" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="422" y="68" width="146" height="126" rx="46" fillOpacity="0.07" />
    <rect x="430" y="76" width="130" height="110" rx="40" fillOpacity="0.16" />
    <rect x="458" y="64" width="74" height="14" rx="7" fillOpacity="0.35" />
    <circle cx="470" cy="120" r="8" />
    <circle cx="500" cy="108" r="8" />
    <circle cx="528" cy="126" r="8" />
    <circle cx="484" cy="150" r="8" />
    <circle cx="514" cy="156" r="8" />
    <circle cx="495" cy="38" r="8" />
    <circle cx="495" cy="54" r="3" fillOpacity="0.5" />
  </g>
</svg>
