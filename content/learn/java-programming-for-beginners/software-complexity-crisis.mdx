...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Ever-heavier blocks pile onto a bridge deck that sags and cracks in red while one piece falls away — the programs of the 1960s outgrowing the engineering beneath them"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <rect x="120" y="80" width="22" height="110" rx="4" />
    <rect x="498" y="80" width="22" height="110" rx="4" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <polygon points="80,118 200,128 320,140 440,128 560,118 560,132 440,142 320,156 200,142 80,132" fillOpacity="0.45" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="150" y="104" width="20" height="20" rx="4" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="244" y="107" width="26" height="26" rx="5" />
    <rect x="304" y="82" width="40" height="24" rx="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="298" y="106" width="50" height="32" rx="5" fillOpacity="0.7" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <polygon points="364,126 372,140 366,140 376,156 360,144 367,144" fillOpacity="0.9" />
    <rect x="392" y="176" width="16" height="16" rx="3" transform="rotate(18 400 184)" fillOpacity="0.8" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="382" cy="150" r="3" />
    <circle cx="388" cy="163" r="3" />
    <circle cx="160" cy="205" r="3" />
    <circle cx="240" cy="208" r="3" />
    <circle cx="320" cy="210" r="3" />
    <circle cx="400" cy="208" r="3" />
    <circle cx="480" cy="205" r="3" />
  </g>
</svg>
