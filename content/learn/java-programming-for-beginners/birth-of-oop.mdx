...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="An early plugboard: rows of faint sockets with three colored patch cables looped between them, one draping below the board — programs wired by hand, one connection at a time"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.07">
    <rect x="110" y="50" width="420" height="150" rx="16" />
  </g>
  <g fill="currentColor" opacity="0.18">
    <circle cx="150" cy="85" r="5" />
    <circle cx="220" cy="85" r="5" />
    <circle cx="290" cy="85" r="5" />
    <circle cx="360" cy="85" r="5" />
    <circle cx="430" cy="85" r="5" />
    <circle cx="500" cy="85" r="5" />
    <circle cx="150" cy="135" r="5" />
    <circle cx="220" cy="135" r="5" />
    <circle cx="290" cy="135" r="5" />
    <circle cx="360" cy="135" r="5" />
    <circle cx="430" cy="135" r="5" />
    <circle cx="500" cy="135" r="5" />
    <circle cx="150" cy="185" r="5" />
    <circle cx="220" cy="185" r="5" />
    <circle cx="290" cy="185" r="5" />
    <circle cx="360" cy="185" r="5" />
    <circle cx="430" cy="185" r="5" />
    <circle cx="500" cy="185" r="5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="220" cy="85" r="8" />
    <circle cx="430" cy="185" r="8" />
    <circle cx="258" cy="64" r="3.5" fillOpacity="0.5" />
    <circle cx="300" cy="54" r="3.5" fillOpacity="0.5" />
    <circle cx="345" cy="58" r="3.5" fillOpacity="0.5" />
    <circle cx="385" cy="82" r="3.5" fillOpacity="0.5" />
    <circle cx="412" cy="122" r="3.5" fillOpacity="0.5" />
    <circle cx="424" cy="156" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="290" cy="185" r="8" />
    <circle cx="500" cy="85" r="8" />
    <circle cx="330" cy="196" r="3.5" fillOpacity="0.5" />
    <circle cx="372" cy="196" r="3.5" fillOpacity="0.5" />
    <circle cx="412" cy="180" r="3.5" fillOpacity="0.5" />
    <circle cx="448" cy="150" r="3.5" fillOpacity="0.5" />
    <circle cx="478" cy="116" r="3.5" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="150" cy="185" r="8" />
    <circle cx="360" cy="135" r="8" />
    <circle cx="172" cy="212" r="3.5" fillOpacity="0.6" />
    <circle cx="210" cy="222" r="3.5" fillOpacity="0.6" />
    <circle cx="252" cy="224" r="3.5" fillOpacity="0.6" />
    <circle cx="295" cy="214" r="3.5" fillOpacity="0.6" />
    <circle cx="330" cy="186" r="3.5" fillOpacity="0.6" />
    <circle cx="350" cy="158" r="3.5" fillOpacity="0.6" />
  </g>
</svg>
