...
{
    Console.WriteLine("  Source: yielding 1");  yield return 1;
    Console.WriteLine("  Source: yielding 2");  yield return 2;
    Console.WriteLine("  Source: yielding 3");  yield return 3;
}

var seq = Source();

Console.WriteLine("First pass:");
foreach (var n in seq) Console.WriteLine($"  got {n}");
