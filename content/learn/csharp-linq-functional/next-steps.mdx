...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A night-sky route traced along thin lines between colored stars, ending at a bright ringed star with a sparkle beside it — the map of what to learn next"
...
>
  ...
  <g
    ...
    opacity="0.25"
  >
    <path d="M162 116 L 288 74" />
    <path d="M312 73 L 436 107" />
    <path d="M460 118 L 534 158" />
  </g>
