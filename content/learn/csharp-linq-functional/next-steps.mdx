...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A night-sky route traced dot to dot through colored stars, ending at a bright ringed star with a sparkle beside it — the map of what to learn next"
...
>
  ...
  <g fill="currentColor" opacity="0.35">
    <circle cx="185" cy="108" r="3.5" />
    <circle cx="220" cy="96" r="3.5" />
    <circle cx="258" cy="83" r="3.5" />
    <circle cx="336" cy="80" r="3.5" />
    <circle cx="372" cy="90" r="3.5" />
    <circle cx="408" cy="100" r="3.5" />
    <circle cx="478" cy="125" r="3.5" />
    <circle cx="510" cy="140" r="3.5" />
    <circle cx="528" cy="155" r="3.5" />
  </g>
  ...
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    ...
    <polygon points="590,128 594,136 602,140 594,144 590,152 586,144 578,140 586,136" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="450" cy="110" r="12" />
    <circle cx="550" cy="170" r="18" />
    <circle cx="550" cy="170" r="28" fillOpacity="0.15" />
  </g>
</svg>
