...
var pairs = company.SelectMany(
    d => d.Employees,                   // for each department, take its employees
...
var customers = new[]
{
    new Customer("Ada", new List<Order>
    {
        new(1, new List<string> { "rush", "vip" }),
        new(2, new List<string> { "vip" }),
    }),
    new Customer("Bilal", new List<Order>
    {
