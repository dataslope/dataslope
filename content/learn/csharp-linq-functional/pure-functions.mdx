...
<svg
  viewBox="0 0 640 250"
  role="img"
  aria-label="Two identical runs through a blue box give identical outputs, while a third run through a red box gives a different shape and drips below — pure versus impure"
...
>
  ...
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    ...
    <path
      d="M214 228 C 220 236, 228 242, 238 246"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
