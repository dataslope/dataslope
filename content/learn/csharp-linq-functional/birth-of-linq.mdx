...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Three different sources — a database cylinder, a stack of objects, and angle brackets — flow as dotted streams into one junction and leave as a single stream"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="70" y="40" width="70" height="44" rx="8" />
    <ellipse cx="105" cy="40" rx="35" ry="10" />
    <circle cx="160" cy="62" r="4" fillOpacity="0.6" />
    <circle cx="205" cy="85" r="4" fillOpacity="0.6" />
    <circle cx="250" cy="108" r="4" fillOpacity="0.6" />
    <circle cx="320" cy="130" r="24" />
    <circle cx="370" cy="130" r="5" />
    <circle cx="400" cy="130" r="5" />
    <circle cx="430" cy="130" r="5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="75" y="110" width="60" height="16" rx="8" />
    <rect x="75" y="132" width="60" height="16" rx="8" />
    <rect x="75" y="154" width="60" height="16" rx="8" />
    <circle cx="160" cy="135" r="4" fillOpacity="0.6" />
    <circle cx="205" cy="133" r="4" fillOpacity="0.6" />
    <circle cx="250" cy="131" r="4" fillOpacity="0.6" />
    <rect x="470" y="112" width="36" height="36" rx="9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="88,192 70,207 88,222 95,215 85,207 95,199" />
    <polygon points="118,192 136,207 118,222 111,215 121,207 111,199" />
    <circle cx="160" cy="200" r="4" fillOpacity="0.6" />
    <circle cx="205" cy="178" r="4" fillOpacity="0.6" />
    <circle cx="250" cy="155" r="4" fillOpacity="0.6" />
    <circle cx="530" cy="98" r="5" />
  </g>
</svg>
