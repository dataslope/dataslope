...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="170" cy="125" r="7" />
    <circle cx="140" cy="125" r="6" fillOpacity="0.7" />
    <circle cx="112" cy="125" r="5" fillOpacity="0.5" />
    <rect x="240" y="70" width="160" height="110" rx="20" />
  </g>
  <rect x="296" y="62" width="48" height="14" rx="7" fill="currentColor" opacity="0.3" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="306" y="18" width="28" height="28" rx="8" />
    <circle cx="320" cy="54" r="3" fillOpacity="0.6" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="416" cy="125" r="3" />
    <circle cx="438" cy="125" r="3" />
  </g>
