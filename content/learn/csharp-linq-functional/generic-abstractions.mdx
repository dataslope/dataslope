...
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    ...
    <rect x="125" y="50" width="30" height="12" rx="6" />
    <rect x="305" y="50" width="30" height="12" rx="6" />
    <rect x="485" y="50" width="30" height="12" rx="6" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="140" cy="105" r="18" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <polygon points="320,85 300,125 340,125" />
  </g>
