...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A yellow sun rising over the horizon carrying a lambda symbol, its rays dotted around the sky — old functional ideas dawning on mainstream languages"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <rect x="60" y="170" width="520" height="4" rx="2" fill="currentColor" opacity="0.15" />
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <path d="M230 170 A90 90 0 0 1 410 170 Z" />
    <circle cx="320" cy="60" r="5" />
    <circle cx="375" cy="75" r="4" />
    <circle cx="265" cy="75" r="4" />
    <circle cx="415" cy="115" r="4" />
    <circle cx="225" cy="115" r="4" />
  </g>
  <text x="320" y="152" fontFamily="Georgia, serif" fontStyle="italic" fontSize="56" textAnchor="middle" style={{ fill: "var(--ds-gray-900)" }} fillOpacity="0.8">λ</text>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="150" cy="80" r="6" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="490" cy="80" r="6" />
  </g>
