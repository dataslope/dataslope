...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two parallel rails — one of rounded bars, one of chained circles — converge on the same yellow diamond station: two syntaxes, one meaning"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="215" cy="160" r="3" />
    <circle cx="235" cy="160" r="3" />
    <circle cx="335" cy="160" r="3" />
    <circle cx="355" cy="160" r="3" />
    <circle cx="470" cy="85" r="3" />
    <circle cx="490" cy="97" r="3" />
    <circle cx="455" cy="148" r="3" />
    <circle cx="485" cy="128" r="3" />
  </g>
