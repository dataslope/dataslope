...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A quilt of small colored feature chips connecting by dots to one large blue pill bearing a lambda arrow — many language features serving one idea"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="90" y="50" width="40" height="40" rx="10" />
    <rect x="202" y="106" width="40" height="40" rx="10" />
    <rect x="146" y="162" width="40" height="40" rx="10" />
    <rect x="340" y="86" width="180" height="68" rx="34" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="146" y="50" width="40" height="40" rx="10" />
    <rect x="90" y="106" width="40" height="40" rx="10" />
    <rect x="202" y="162" width="40" height="40" rx="10" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="202" y="50" width="40" height="40" rx="10" />
    <rect x="146" y="106" width="40" height="40" rx="10" />
    <rect x="90" y="162" width="40" height="40" rx="10" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="266" cy="120" r="3" />
