...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A chain of shapes shrinking and changing along dotted links — a large circle refined step by step into a precise diamond"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="140" cy="110" r="70" fillOpacity="0.14" />
    <circle cx="160" cy="110" r="32" />
    <polygon points="520,74 556,110 520,146 484,110" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="210" cy="110" r="3.5" />
    <circle cx="232" cy="110" r="3.5" />
    <circle cx="350" cy="110" r="3.5" />
    <circle cx="372" cy="110" r="3.5" />
    <circle cx="458" cy="110" r="3.5" />
    <circle cx="472" cy="110" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="254" y="88" width="84" height="44" rx="22" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="390" y="86" width="48" height="48" rx="12" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="600" cy="56" r="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
...
Two programs that solve the same problem: *"From a list of numbers,
keep the even ones, square them, and sum the result."* The first uses
the classic imperative approach. The second uses LINQ.
...
Start with [The Limits of Imperative Programming](./limits-of-imperative)
to understand the historical pressure that made LINQ inevitable. Then
proceed through the menu on the left in order — each section builds
