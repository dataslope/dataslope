...
<svg
  viewBox="0 0 640 260"
  role="img"
  aria-label="Shapes fall through two sieve bars: the first catches some circles on top while others pass, the second turns everything that passes into squares"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="40" r="11" />
    <circle cx="360" cy="40" r="11" />
    <rect x="169" y="209" width="22" height="22" rx="6" />
    <rect x="349" y="209" width="22" height="22" rx="6" />
    <rect x="140" y="170" width="360" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="240" cy="78" r="11" />
    <circle cx="420" cy="40" r="11" />
    <circle cx="420" cy="130" r="11" />
    <rect x="409" y="209" width="22" height="22" rx="6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="300" cy="78" r="11" />
    <rect x="140" y="90" width="360" height="16" rx="8" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="180" cy="130" r="11" />
    <circle cx="360" cy="130" r="11" />
  </g>
</svg>
