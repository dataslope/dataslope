...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="Three small panels of miniature patterns: a value that may be present or absent, a path that forks to success or failure, and many dots folding into one"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="318" cy="102" r="3" />
    <circle cx="308" cy="124" r="3" />
    <circle cx="342" cy="102" r="3" />
    <circle cx="352" cy="124" r="3" />
    <circle cx="478" cy="102" r="3" />
    <circle cx="500" cy="106" r="3" />
    <circle cx="522" cy="102" r="3" />
  </g>
