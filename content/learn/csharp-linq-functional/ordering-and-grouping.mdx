...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A random scatter of dots in three colors and sizes, an arrow, and the same dots regrouped into tidy columns by color and sorted by size"
...
>
  ...
  <polygon points="300,95 300,125 330,110" fill="currentColor" opacity="0.25" />
