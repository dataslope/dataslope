...
var people = new[]
{
    ...
    new Person("Dmitri", 52, "Paris"),
    new Person("Esther", 33, "London"),
};
...
var people = new[]
{
    ...
    new Person("Dmitri", 52, "Paris"),
    new Person("Esther", 33, "London"),
    new Person("Farah",  41, "Berlin"),   // same age as Bilal
};
...
var sales = new[]
{
    new Sale("EU",   "Widget", 10m),
    new Sale("EU",   "Widget", 20m),
    new Sale("EU",   "Gadget", 30m),
    new Sale("APAC", "Widget", 40m),
    new Sale("APAC", "Gadget", 50m),
    new Sale("APAC", "Gadget", 60m),
};

var totals = sales
    .GroupBy(s => new { s.Region, s.Product })
    .Select(g => new { g.Key.Region, g.Key.Product, Total = g.Sum(s => s.Amount) })
    .OrderBy(r => r.Region).ThenBy(r => r.Product);
