...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Two routes to the same destination: a zigzag of many tiny steps reaching a faded circle, and below it a single bold bar arriving at the same circle, solid"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.3">
    <circle cx="80" cy="70" r="3" />
    <circle cx="110" cy="58" r="3" />
    <circle cx="138" cy="72" r="3" />
    <circle cx="164" cy="58" r="3" />
    <circle cx="190" cy="72" r="3" />
    <circle cx="216" cy="58" r="3" />
    <circle cx="242" cy="72" r="3" />
    <circle cx="268" cy="58" r="3" />
    <circle cx="294" cy="72" r="3" />
    <circle cx="320" cy="58" r="3" />
    <circle cx="346" cy="72" r="3" />
    <circle cx="372" cy="58" r="3" />
    <circle cx="398" cy="68" r="3" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="450" cy="66" r="14" fillOpacity="0.3" />
    <circle cx="450" cy="158" r="14" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="80" y="140" width="340" height="36" rx="18" />
  </g>
