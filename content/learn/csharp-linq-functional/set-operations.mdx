...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Two translucent circles overlap like a Venn diagram, with dots in each lobe, yellow dots in the shared lens, and one red dot outside both"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="250" cy="110" r="70" fillOpacity="0.3" />
    <circle cx="215" cy="95" r="8" />
    <circle cx="225" cy="140" r="7" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="350" cy="110" r="70" fillOpacity="0.3" />
    <circle cx="382" cy="90" r="8" />
    <circle cx="375" cy="142" r="7" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="298" cy="95" r="8" />
    <circle cx="302" cy="130" r="7" />
  </g>
