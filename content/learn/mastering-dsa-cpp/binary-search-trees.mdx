...
int main() {
    TreeNode n1{1, nullptr, nullptr}, n7{7, nullptr, nullptr}, n4{4, nullptr, nullptr};
    TreeNode n6{6, &n4, &n7}, n3{3, &n1, &n6}, n10{10, nullptr, nullptr}, n8{8, &n3, &n10};
...
int main() {
    TreeNode n1{1, nullptr, nullptr}, n6{6, nullptr, nullptr}, n10{10, nullptr, nullptr}, n8{8, &n1, &n10};
    n1.right = &n6;
...
TreeNode* erase(TreeNode* root, int value) {
    ...
    if (value < root->val) root->left = erase(root->left, value);
    else if (value > root->val) root->right = erase(root->right, value);
    else {
        if (!root->left) {
...
int main() {
    TreeNode* root = new TreeNode{5, new TreeNode{3, nullptr, nullptr}, new TreeNode{7, nullptr, nullptr}};
    root = erase(root, 3);
...
int main() {
    ...
    names[2] = "two";
    names[1] = "one";
    for (const auto& [k, v] : names) std::cout << k << ":" << v << "\n";
    return 0;
}
`}
/>
...
int main() {
    TreeNode n1{1, nullptr, nullptr}, n4{4, nullptr, nullptr}, n7{7, nullptr, nullptr};
...
int main() {
    TreeNode n2{2, nullptr, nullptr}, n4{4, nullptr, nullptr}, n6{6, nullptr, nullptr}, n8{8, nullptr, nullptr};
