...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="Two routes between the same vertices — a tempting direct edge whose single weight is huge, and a longer green three-hop path whose small weights add up to less — why shortest paths weigh edges"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <circle cx="163" cy="87" r="4.5" />
    <circle cx="215" cy="78" r="4.5" />
    <circle cx="268" cy="72" r="4.5" />
    <circle cx="320" cy="70" r="4.5" />
    <circle cx="373" cy="72" r="4.5" />
    <circle cx="425" cy="78" r="4.5" />
    <circle cx="478" cy="87" r="4.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="320" cy="44" r="9" fillOpacity="0.85" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor" fillOpacity="0.6">
    <circle cx="145" cy="113" r="3" />
    <circle cx="180" cy="125" r="3" />
    <circle cx="215" cy="138" r="3" />
    <circle cx="285" cy="150" r="3" />
    <circle cx="320" cy="150" r="3" />
    <circle cx="355" cy="150" r="3" />
    <circle cx="425" cy="138" r="3" />
    <circle cx="460" cy="125" r="3" />
    <circle cx="495" cy="113" r="3" />
  </g>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <circle cx="178" cy="140" r="8" fillOpacity="0.9" />
