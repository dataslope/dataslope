...
using namespace std;`,
  ...
  int questions = 0;
  while (candidates > 1) {
    candidates /= 2; // each yes/no question halves the field
    questions++;
  }
...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="Four small exhibits float above faint pedestals — an array of cells, a linked chain, a tree, and a graph constellation — the structures this course teaches you to build and use"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.15">
    <rect x="70" y="140" width="84" height="7" rx="3.5" />
    <rect x="210" y="140" width="84" height="7" rx="3.5" />
    <rect x="350" y="140" width="84" height="7" rx="3.5" />
    <rect x="492" y="140" width="84" height="7" rx="3.5" />
  </g>
