...
<svg
  viewBox="0 0 640 240"
  role="img"
  aria-label="Plates drop down a translucent vertical tube and settle in a stack, with a green push arrow pointing into the opening and a yellow pop arrow pointing back out of it — last in, first out"
  style={{ display: "block", width: "100%", maxWidth: "560px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="274" y="30" width="92" height="12" rx="6" opacity="0.12" />
    <rect x="280" y="36" width="80" height="180" rx="16" opacity="0.08" />
    <rect x="262" y="216" width="116" height="8" rx="4" opacity="0.15" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="246" y="42" width="8" height="28" rx="4" />
    <polygon points="240,70 260,70 250,86" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="384" y="48" width="8" height="28" rx="4" />
    <polygon points="378,48 398,48 388,32" />
  </g>
