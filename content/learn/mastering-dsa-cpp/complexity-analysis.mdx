...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="Three dotted curves race across one chart as input grows — a green one stays flat, a blue one rises gently, and a red one explodes upward off the top"
...
>
  ...
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    ...
    <circle cx="180" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="215" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="250" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="285" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="320" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="355" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="390" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="425" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="460" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="495" cy="170" r="3.5" fillOpacity="0.55" />
    <circle cx="534" cy="170" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="110" cy="176" r="3.5" fillOpacity="0.55" />
    <circle cx="170" cy="166" r="3.5" fillOpacity="0.55" />
    <circle cx="230" cy="154" r="3.5" fillOpacity="0.55" />
    <circle cx="290" cy="140" r="3.5" fillOpacity="0.55" />
    <circle cx="350" cy="124" r="3.5" fillOpacity="0.55" />
    <circle cx="410" cy="106" r="3.5" fillOpacity="0.55" />
    <circle cx="470" cy="86" r="3.5" fillOpacity="0.55" />
    <circle cx="534" cy="64" r="5.5" />
  </g>
  <g style={{ color: "var(--ds-red-500)" }} fill="currentColor">
    <circle cx="110" cy="174" r="3" fillOpacity="0.55" />
    <circle cx="146" cy="160" r="3.5" fillOpacity="0.6" />
    <circle cx="178" cy="138" r="4" fillOpacity="0.65" />
    <circle cx="206" cy="108" r="4.5" fillOpacity="0.7" />
    <circle cx="228" cy="74" r="5" fillOpacity="0.8" />
    <circle cx="246" cy="38" r="6" />
    <polygon points="252,26 258,12 263,24 274,18 266,32 258,30" fillOpacity="0.7" />
  </g>
</svg>
