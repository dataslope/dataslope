...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="A microscope lens hovers over a strip of memory cells and the bytes inside the magnified cells become visible — C++ as a microscope onto memory layout"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.14">
    <rect x="160" y="148" width="39" height="28" rx="5" />
    <rect x="200" y="148" width="39" height="28" rx="5" />
    <rect x="240" y="148" width="39" height="28" rx="5" />
    <rect x="280" y="148" width="39" height="28" rx="5" />
    <rect x="320" y="148" width="39" height="28" rx="5" />
    <rect x="360" y="148" width="39" height="28" rx="5" />
    <rect x="400" y="148" width="39" height="28" rx="5" />
    <rect x="440" y="148" width="39" height="28" rx="5" />
  </g>
  <g fill="currentColor" opacity="0.25">
    <circle cx="180" cy="188" r="2" />
    <circle cx="220" cy="188" r="2" />
    <circle cx="260" cy="188" r="2" />
    <circle cx="300" cy="188" r="2" />
    <circle cx="340" cy="188" r="2" />
    <circle cx="380" cy="188" r="2" />
    <circle cx="420" cy="188" r="2" />
    <circle cx="460" cy="188" r="2" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="311" y="12" width="18" height="20" rx="8" fillOpacity="0.7" />
    <rect x="302" y="28" width="36" height="56" rx="12" />
    <circle cx="320" cy="126" r="46" fillOpacity="0.12" />
    <circle cx="320" cy="126" r="38" fillOpacity="0.1" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="288" cy="162" r="3.5" />
    <circle cx="298" cy="162" r="3.5" />
    <circle cx="308" cy="162" r="3.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="328" cy="162" r="3.5" />
    <circle cx="338" cy="162" r="3.5" />
    <circle cx="348" cy="162" r="3.5" />
  </g>
</svg>
