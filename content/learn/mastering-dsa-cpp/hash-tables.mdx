...
int main() {
  ...
  std::cout << "size = " << score.size()
            << "
               ";
      std::cout
            << "buckets = " << score.bucket_count()
            << "
               ";
      std::cout
            << "load = " << score.load_factor()
            << "
               ";
      return 0;
}
...
int main() {
  ...
  if (ages.find("Grace") != ages.end())
    std::cout << "Grace found
                 ";
        std::cout
              << "Ada count? " << ages.count("Ada")
              << "
                 ";
        for (const auto &[name, age] : ages) std::cout
              << name << " " << age
              << "
                 ";
                 ages.erase("Grace");
...
int main() {
  ...
  std::cout << "map order:
               ";
      for (const auto &[k, v] : ordered) std::cout
            << k << "=" << v
            << "
               ";
      std::cout
            << "unordered_map order:
               ";
      for (const auto &[k, v] : hashed) std::cout
            << k << "=" << v
            << "
               ";
      return 0;
