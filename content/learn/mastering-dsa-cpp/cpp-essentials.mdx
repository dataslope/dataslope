...
<svg
  viewBox="0 0 640 170"
  role="img"
  aria-label="A toolbelt with four hanging pouches marked with a template T, a lambda, a reference ampersand, and vector brackets — the small reliable slice of C++ these lessons use"
...
>
  ...
  <g fill="currentColor" opacity="0.3">
    <circle cx="468" cy="61" r="2.5" />
    <circle cx="490" cy="61" r="2.5" />
    <circle cx="512" cy="61" r="2.5" />
  </g>
