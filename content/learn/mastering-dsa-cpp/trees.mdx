...
int main() {
    ...
    std::cout << root.val << " has children " << root.left->val << " and " << root.right->val << "\n";
    return 0;
}
`}
/>
...
int main() {
    ...
    for (int i = 0; i < static_cast<int>(tree.size()); i++) {
        ...
        int right = 2 * i + 2;
        std::cout << tree[i] << ":";
        if (left < static_cast<int>(tree.size())) std::cout << " L=" << tree[left];
        if (right < static_cast<int>(tree.size())) std::cout << " R=" << tree[right];
        std::cout << "\n";
    }
    return 0;
}
...
int main() {
    TreeNode n4{4, nullptr, nullptr}, n5{5, nullptr, nullptr}, n3{3, nullptr, nullptr};
    TreeNode n2{2, &n4, &n5};
    TreeNode n1{1, &n2, &n3};
    preorder(&n1); std::cout << "\n";
    inorder(&n1); std::cout << "\n";
    postorder(&n1); std::cout << "\n";
    return 0;
}
`}
/>
...
int main() {
    TreeNode n4{4, nullptr, nullptr}, n5{5, nullptr, nullptr}, n2{2, &n4, &n5}, n3{3, nullptr, nullptr}, n1{1, &n2, &n3};
    std::cout << height(&n1) << "\n";
...
int main() {
    TreeNode n4{4, nullptr, nullptr}, n5{5, nullptr, nullptr}, n6{6, nullptr, nullptr};
