...
<svg
  viewBox="0 0 640 200"
  role="img"
  aria-label="A horizontal timeline with labeled milestone dots rising and falling, from a question-mark badge on the left to a small vector-space cluster on the right"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.14">
    <rect x="40" y="150" width="560" height="5" rx="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="90" cy="150" r="7" fillOpacity="0.9" />
    <circle cx="190" cy="150" r="7" fillOpacity="0.9" />
    <circle cx="300" cy="150" r="7" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <circle cx="400" cy="150" r="7" fillOpacity="0.9" />
    <circle cx="500" cy="150" r="7" fillOpacity="0.9" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="575" cy="120" r="3.5" />
    <circle cx="590" cy="132" r="3.5" />
    <circle cx="601" cy="118" r="3.5" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="90" cy="150" r="13" fillOpacity="0" stroke="currentColor" strokeWidth="1.5" />
  </g>
</svg>
