...
>
  <g fill="currentColor" opacity="0.14">
    <rect x="70" y="112" width="500" height="34" rx="17" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="148" y="104" width="5" height="50" rx="2.5" fillOpacity="0.9" />
    <rect x="318" y="104" width="5" height="50" rx="2.5" fillOpacity="0.9" />
    <rect x="488" y="104" width="5" height="50" rx="2.5" fillOpacity="0.9" />
  </g>
  ...
  <g fill="currentColor" opacity="0.3">
    ...
    <circle cx="230.5" cy="98" r="2.5" />
    <circle cx="410.5" cy="88" r="3" />
    <circle cx="410.5" cy="98" r="2.5" />
  </g>
</svg>
