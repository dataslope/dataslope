...
<svg
  viewBox="0 0 640 210"
  role="img"
  aria-label="Word-count columns of stacked dots fall away in a long tail: the two tallest stacks are faint gray stopwords, blue content words follow, and single yellow dots mark words seen only once"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor" opacity="0.25">
    <circle cx="110" cy="172" r="7" />
    <circle cx="110" cy="154" r="7" />
    <circle cx="110" cy="136" r="7" />
    <circle cx="110" cy="118" r="7" />
    <circle cx="110" cy="100" r="7" />
    <circle cx="110" cy="82" r="7" />
    <circle cx="110" cy="64" r="7" />
    <circle cx="110" cy="46" r="7" />
    <circle cx="170" cy="172" r="7" />
    <circle cx="170" cy="154" r="7" />
    <circle cx="170" cy="136" r="7" />
    <circle cx="170" cy="118" r="7" />
    <circle cx="170" cy="100" r="7" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <circle cx="230" cy="172" r="7" fillOpacity="0.85" />
    <circle cx="230" cy="154" r="7" fillOpacity="0.85" />
    <circle cx="230" cy="136" r="7" fillOpacity="0.85" />
    <circle cx="290" cy="172" r="7" fillOpacity="0.85" />
    <circle cx="290" cy="154" r="7" fillOpacity="0.85" />
    <circle cx="350" cy="172" r="7" fillOpacity="0.85" />
    <circle cx="350" cy="154" r="7" fillOpacity="0.85" />
    <circle cx="410" cy="172" r="7" fillOpacity="0.6" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <circle cx="470" cy="172" r="7" fillOpacity="0.85" />
    <circle cx="530" cy="172" r="7" fillOpacity="0.85" />
  </g>
  <g fill="currentColor" opacity="0.12">
    <rect x="80" y="186" width="480" height="5" rx="2.5" />
  </g>
</svg>
