...
<svg
  viewBox="0 0 640 230"
  role="img"
  aria-label="A balance scale tips toward a pan stacked with green positive word chips while lighter red negative chips ride high on the other side — the tilt of the beam is the sentence's sentiment"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <polygon points="320,150 298,200 342,200" opacity="0.3" />
    <rect x="262" y="200" width="116" height="8" rx="4" opacity="0.15" />
    <polygon points="180,166 460,118 460,128 180,176" opacity="0.45" />
    <circle cx="320" cy="147" r="6" opacity="0.5" />
    <rect x="124" y="200" width="112" height="11" rx="5.5" opacity="0.3" />
    <rect x="404" y="150" width="112" height="11" rx="5.5" opacity="0.3" />
  </g>
  <g fill="currentColor" opacity="0.35">
    <circle cx="180" cy="184" r="2.5" />
    <circle cx="180" cy="193" r="2.5" />
    <circle cx="460" cy="134" r="2.5" />
    <circle cx="460" cy="143" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-green-500)" }} fill="currentColor">
    <rect x="130" y="178" width="46" height="20" rx="10" fillOpacity="0.9" />
    <rect x="182" y="178" width="50" height="20" rx="10" fillOpacity="0.75" />
    <rect x="152" y="156" width="48" height="20" rx="10" fillOpacity="0.9" />
    <circle cx="560" cy="58" r="16" fillOpacity="0.15" />
  </g>
