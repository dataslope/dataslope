...
<svg
  viewBox="0 0 640 220"
  role="img"
  aria-label="A translucent yellow window slides along a row of word chips capturing two at a time, ghost rectangles marking its earlier positions and the captured pair echoed below"
  style={{ display: "block", width: "100%", maxWidth: "640px", height: "auto", margin: "2.5rem auto" }}
>
  <g fill="currentColor">
    <rect x="74" y="84" width="186" height="54" rx="14" opacity="0.06" />
    <rect x="152" y="84" width="222" height="54" rx="14" opacity="0.09" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="84" y="96" width="64" height="30" rx="12" fillOpacity="0.8" />
    <rect x="162" y="96" width="88" height="30" rx="12" fillOpacity="0.8" />
    <rect x="264" y="96" width="100" height="30" rx="12" fillOpacity="0.8" />
    <rect x="378" y="96" width="56" height="30" rx="12" fillOpacity="0.8" />
    <rect x="448" y="96" width="76" height="30" rx="12" fillOpacity="0.8" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="254" y="84" width="190" height="54" rx="14" fillOpacity="0.2" />
    <rect x="334" y="70" width="30" height="10" rx="5" fillOpacity="0.9" />
    <polygon points="560,103 560,121 578,112" fillOpacity="0.9" />
  </g>
  <g fill="currentColor" opacity="0.3">
    <circle cx="536" cy="112" r="3" />
    <circle cx="548" cy="112" r="3" />
    <circle cx="349" cy="146" r="2.5" />
    <circle cx="349" cy="155" r="2.5" />
  </g>
  <g style={{ color: "var(--ds-blue-500)" }} fill="currentColor">
    <rect x="294" y="164" width="64" height="22" rx="10" fillOpacity="0.5" />
    <rect x="366" y="164" width="44" height="22" rx="10" fillOpacity="0.5" />
  </g>
  <g style={{ color: "var(--ds-yellow-500)" }} fill="currentColor">
    <rect x="294" y="194" width="116" height="5" rx="2.5" fillOpacity="0.8" />
  </g>
</svg>
