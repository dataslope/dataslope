...
[JavaScript](/fumadocs-dev/challenge-cards-javascript) ·
[TypeScript](/fumadocs-dev/challenge-cards-typescript) ·
[R](/fumadocs-dev/challenge-cards-r) ·
[PHP](/fumadocs-dev/challenge-cards-php) ·
[C](/fumadocs-dev/challenge-cards-c) ·
[C++](/fumadocs-dev/challenge-cards-cpp) ·
[Java](/fumadocs-dev/challenge-cards-java) ·
[C#](/fumadocs-dev/challenge-cards-csharp) ·
[SQLite](/fumadocs-dev/sql-challenge-cards-sqlite) ·
[DuckDB](/fumadocs-dev/sql-challenge-cards-duckdb) ·
[PostgreSQL](/fumadocs-dev/sql-challenge-cards-postgres)
...
`,
      starterCode: `# df is already loaded, explore it first
print(df.head())
print()
...
`,
      starterCode: `# values is already loaded.
...
`,
      starterCode: `for i in range(start, end + 1):
    # your code here
    print(i)
`,
...
`,
      starterCode: `from utils import greet\n\nprint(greet(target_name))\n`,
    },
    {
      filename: "utils.py",
